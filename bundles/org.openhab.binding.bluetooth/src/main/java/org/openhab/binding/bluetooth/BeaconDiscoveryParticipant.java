...
/**
 * This class implements the BluetoothDiscoveryParticipant for beacon devices.
 *
 * @author Peter Rosenberg - Initial contribution
 */
@NonNullByDefault
@Component(service = BluetoothDiscoveryParticipant.class)
public class BeaconDiscoveryParticipant implements BluetoothDiscoveryParticipant {
    private final Logger logger = LoggerFactory.getLogger(BeaconDiscoveryParticipant.class);

    @Override
    public Set<ThingTypeUID> getSupportedThingTypeUIDs() {
        return Set.of(BluetoothBindingConstants.THING_TYPE_BEACON);
    }
    ...
    public @Nullable ThingUID getThingUID(BluetoothDiscoveryDevice device) {
        return new ThingUID(BluetoothBindingConstants.THING_TYPE_BEACON, device.getAdapter().getUID(),
