...
public class DetailedInformation {
    ...
    public static DetailedInformation parse(String response) {
        ...
        detailedInformation.name = jsonObject.get("name").getAsString();
        detailedInformation.state = jsonObject.get("state").getAsString();
        ...
        detailedInformation.charging_state = chargeStateJsonObject.get("charging_state").getAsString();
