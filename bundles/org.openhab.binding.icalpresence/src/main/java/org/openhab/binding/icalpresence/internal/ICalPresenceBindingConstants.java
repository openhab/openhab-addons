...
/**
 * The {@link ICalPresenceBindingConstants} class defines common constants, which are
 * used across the whole binding.
 *
 * @author Michael Wodniok - Initial contribution
 */
@NonNullByDefault
public class ICalPresenceBindingConstants {

    public static final String BINDING_ID = "icalpresence";
