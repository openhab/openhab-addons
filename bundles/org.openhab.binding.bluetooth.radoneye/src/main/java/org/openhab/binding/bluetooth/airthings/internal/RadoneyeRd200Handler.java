...
import static org.openhab.binding.bluetooth.airthings.internal.RadoneyeBindingConstants.*;
...
/**
 * The {@link RadoneyeRd200Handler} is responsible for handling commands, which are
 ...
 */
@NonNullByDefault
public class RadoneyeRd200Handler extends AbstractRadoneyeHandler {
    ...
    public RadoneyeRd200Handler(Thing thing) {
        super(thing);
    }

    private final Logger logger = LoggerFactory.getLogger(RadoneyeRd200Handler.class);
