...
public class SceneTest {
     ...
     */
    @Test
    public void testIsApplicableTo_HasGroupId_MatchingGroup() {
     ...
     */
    @Test
    public void testIsApplicableTo_HasGroupId_NotMatchingGroup() {
        String groupId = "groupId";
     ...
     */
    @Test
    public void testIsApplicableTo_NoGroupId_SceneLightsContainedInGroup() {
        List<String> lights = Arrays.asList("1", "2");
     ...
     */
    @Test
    public void testIsApplicableTo_NoGroupId_SceneLightsNotContainedInGroup() {
        List<String> lights = Arrays.asList("1", "2");
