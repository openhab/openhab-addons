 ...
 */
package org.openhab.binding.unifi.internal.protect.api.pub.client;
...
import org.openhab.binding.unifi.internal.protect.api.pub.dto.ChannelQuality;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.Chime;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.FileSchema;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.GenericError;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.Light;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.Liveview;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.Nvr;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.ProtectVersionInfo;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.RtspsStreams;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.Sensor;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.TalkbackSession;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.Viewer;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.ws.DeviceAdd;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.ws.DeviceRemove;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.ws.DeviceUpdate;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.ws.EventAdd;
import org.openhab.binding.unifi.internal.protect.api.pub.dto.ws.EventUpdate;
...
public class UniFiProtectPublicClient implements Closeable {
    ...
    private CompletableFuture<Session> connectWebSocket(String path, Consumer<String> onText, Runnable onOpen,
        ...
        try {
            ...
            future.complete(wsClient.connect(new Session.Listener.AutoDemanding() {
