...
public class UniFiSiteActions implements ThingActions {
    ...
    @RuleAction(label = "@text/generateVouchersLabel", description = "@text/generateVouchersDescription")
    ...
    @RuleAction(label = "@text/revokeVouchersLabel", description = "@text/revokeVouchersDescription")
    public @ActionOutput(name = "success", type = "java.lang.Boolean") Boolean revokeVoucher(
    /* @formatter:off */
            @ActionInput(name = "voucherCodes", label = "@text/vouchersInputVoucherCodesLabel",
                description = "@text/vouchersInputVoucherCodesDescription") String voucherCode) {
    /* @formatter:on */
    ...
    /* @formatter:off */
            @ActionInput(name = "voucherCodes", label = "@text/vouchersInputVoucherCodesLabel",
                description = "@text/vouchersInputVoucherCodesDescription") List<String> voucherCodes) {
    /* @formatter:on */
        UniFiSiteThingHandler handler = this.handler;
        if (handler == null) {
    ...
    @RuleAction(label = "@text/revokeAllVouchersLabel", description = "@text/revokeAllVouchersDescription")
    ...
    @RuleAction(label = "@text/listVouchersLabel", description = "@text/listVouchersDescription")
