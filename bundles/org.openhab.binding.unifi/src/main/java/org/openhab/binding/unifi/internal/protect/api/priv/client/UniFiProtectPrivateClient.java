...
import org.openhab.binding.unifi.internal.protect.api.priv.dto.system.UserCertificate;
...
import org.openhab.binding.unifi.internal.protect.api.priv.exception.BadRequestException;
import org.openhab.binding.unifi.internal.protect.api.priv.exception.NvrException;
...
public class UniFiProtectPrivateClient {
     ...
     * @return CompletableFuture with updated Camera
     */
    public CompletableFuture<org.openhab.binding.unifi.internal.protect.api.priv.dto.devices.Camera> setCameraRecordingMode(
    ...
    private CompletableFuture<Camera> setSmartDetectType(String cameraId, String detectType, boolean enabled) {
        return getBootstrap().thenCompose(bootstrap -> {
            ...
            List<org.openhab.binding.unifi.internal.protect.api.priv.dto.types.SmartDetectObjectType> objectTypes = new ArrayList<>(
