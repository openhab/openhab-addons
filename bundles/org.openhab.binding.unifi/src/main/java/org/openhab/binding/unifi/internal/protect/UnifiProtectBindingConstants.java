...
public class UnifiProtectBindingConstants {
    ...
    // Legacy Thing Type UIDs (pre-merge unifiprotect:* binding ID, kept so existing things keep working)
    public static final String LEGACY_BINDING_ID = "unifiprotect";
    public static final ThingTypeUID THING_TYPE_NVR_LEGACY = new ThingTypeUID(LEGACY_BINDING_ID, "nvr");
    public static final ThingTypeUID THING_TYPE_CAMERA_LEGACY = new ThingTypeUID(LEGACY_BINDING_ID, "camera");
    public static final ThingTypeUID THING_TYPE_LIGHT_LEGACY = new ThingTypeUID(LEGACY_BINDING_ID, "light");
    public static final ThingTypeUID THING_TYPE_SENSOR_LEGACY = new ThingTypeUID(LEGACY_BINDING_ID, "sensor");
    public static final ThingTypeUID THING_TYPE_DOORLOCK_LEGACY = new ThingTypeUID(LEGACY_BINDING_ID, "doorlock");
    public static final ThingTypeUID THING_TYPE_CHIME_LEGACY = new ThingTypeUID(LEGACY_BINDING_ID, "chime");
