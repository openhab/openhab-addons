...
public class MappingJsonReader extends JsonReaderDelegate {
    ...
    static {
        ...
        ABBREVIATIONS.put("hum_val_tpl", "target_humidity_state_template");
        ...
        ABBREVIATIONS.put("pct_state_t", "percentage_state_topic");
        ...
        ABBREVIATIONS.put("pl_dir_rev", "paylaod_direction_reverse");
