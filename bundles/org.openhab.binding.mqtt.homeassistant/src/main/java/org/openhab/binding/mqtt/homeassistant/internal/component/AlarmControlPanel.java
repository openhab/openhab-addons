...
public class AlarmControlPanel extends AbstractComponent<AlarmControlPanel.ChannelConfiguration> {
    ...
    public AlarmControlPanel(ComponentFactory.ComponentConfiguration componentConfiguration) {
        ...
        buildChannel(STATE_CHANNEL_ID, MqttBindingConstants.CHANNEL_TYPE_UID_STRING, new TextValue(stateEnum),
        ...
        if (commandTopic != null) {
            buildChannel(SWITCH_DISARM_CHANNEL_ID, MqttBindingConstants.CHANNEL_TYPE_UID_STRING,
            ...
            buildChannel(SWITCH_ARM_HOME_CHANNEL_ID, MqttBindingConstants.CHANNEL_TYPE_UID_STRING,
                    new TextValue(new String[] { channelConfiguration.payloadArmHome }), getName(),
                    componentConfiguration.getUpdateListener())
                    .commandTopic(commandTopic, channelConfiguration.isRetain(), channelConfiguration.getQos()).build();

            buildChannel(SWITCH_ARM_AWAY_CHANNEL_ID, MqttBindingConstants.CHANNEL_TYPE_UID_STRING,
