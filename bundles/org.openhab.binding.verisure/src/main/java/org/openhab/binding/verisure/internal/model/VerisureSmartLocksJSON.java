...
public class VerisureSmartLocksJSON extends VerisureBaseThingJSON {
	...
	public boolean equals(@Nullable Object other) {
		...
		if ((other instanceof VerisureSmartLocksJSON) == false) {
			return false;
		}
	...
	public static class Doorlock {
		 ...
		 * @param userString
		 */
		public Doorlock(@Nullable String typename, @Nullable String currentLockState, @Nullable Device device, @Nullable String eventTime, @Nullable String method,
				@Nullable Boolean motorJam, @Nullable Boolean secureModeActive, @Nullable String userString) {
			super();
			this.typename = typename;
		...
		public boolean equals(@Nullable Object other) {
			...
			if ((other instanceof Doorlock) == false) {
				return false;
			}
