...
public class VerisureDoorWindowsJSON extends VerisureBaseThingJSON {
	...
	public boolean equals(@Nullable Object other) {
		...
		if ((other instanceof VerisureDoorWindowsJSON) == false) {
			return false;
		}
	...
	public static class DoorWindow {
		 ...
		 * @param type
		 */
		public DoorWindow(@Nullable Device device, @Nullable String type, @Nullable String state, @Nullable Boolean wired, @Nullable String reportTime, @Nullable String typename) {
			super();
			this.device = device;
			this.type = type;
			this.state = state;
		...
		public boolean equals(@Nullable Object other) {
			...
			if ((other instanceof DoorWindow) == false) {
				return false;
			}
