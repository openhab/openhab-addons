...
public class VerisureClimatesJSON extends VerisureBaseThingJSON {
	...
	public boolean equals(@Nullable Object other) {
		...
		if ((other instanceof VerisureClimatesJSON) == false) {
			return false;
		}
	...
	public static class Climate {
		 ...
		 */
		public Climate(@Nullable Device device, @Nullable Boolean humidityEnabled, @Nullable String humidityTimestamp, @Nullable Double humidityValue,
				@Nullable String temperatureTimestamp, @Nullable Double temperatureValue, @Nullable String typename) {
			super();
			this.device = device;
		...
		public boolean equals(@Nullable Object other) {
			...
			if ((other instanceof Climate) == false) {
				return false;
			}
	...
	public static class Device {
		 ...
		 * @param deviceLabel
		 */
		public Device(@Nullable String deviceLabel, @Nullable String area, @Nullable Gui gui, @Nullable String typename) {
			super();
