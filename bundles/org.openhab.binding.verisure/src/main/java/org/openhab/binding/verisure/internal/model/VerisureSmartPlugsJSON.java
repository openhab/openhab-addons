...
public class VerisureSmartPlugsJSON extends VerisureBaseThingJSON {
	...
	public boolean equals(@Nullable Object other) {
		...
		if ((other instanceof VerisureSmartPlugsJSON) == false) {
			return false;
		}
	...
	public static class Smartplug {
		 ...
		 * @param isHazardous
		 */
		public Smartplug(@Nullable Device device, @Nullable String currentState, @Nullable String icon, @Nullable Boolean isHazardous, @Nullable String typename) {
			super();
			this.device = device;
		...
		public boolean equals(@Nullable Object other) {
			...
			if ((other instanceof Smartplug) == false) {
				return false;
			}
