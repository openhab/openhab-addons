...
public class VerisureUserPresencesJSON extends VerisureBaseThingJSON {
	...
	public boolean equals(@Nullable Object other) {
		...
		if ((other instanceof VerisureUserPresencesJSON) == false) {
			return false;
		}
	...
	public static class UserTracking {
		...
		*/
		 ...
		 * @param deviceId
		 */
		public UserTracking(@Nullable Boolean isCallingUser, @Nullable String webAccount, @Nullable String status, @Nullable String xbnContactId,
				@Nullable String currentLocationName, @Nullable String deviceId, @Nullable String name, @Nullable String currentLocationTimestamp,
				@Nullable String deviceName, @Nullable String currentLocationId, @Nullable String typename) {
			super();
		...
		public boolean equals(@Nullable Object other) {
			...
			if ((other instanceof UserTracking) == false) {
				return false;
			}
