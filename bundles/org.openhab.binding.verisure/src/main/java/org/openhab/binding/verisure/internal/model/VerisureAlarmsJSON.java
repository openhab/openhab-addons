...
public class VerisureAlarmsJSON extends VerisureBaseThingJSON {
	...
	public boolean equals(@Nullable Object other) {
		...
		if ((other instanceof VerisureAlarmsJSON) == false) {
			return false;
		}
	...
	public static class ArmState {
		 ...
		 * @param changedVia
		 */
		public ArmState(@Nullable String type, @Nullable String statusType, @Nullable String date, @Nullable String name, @Nullable String changedVia,
				@Nullable Boolean allowedForFirstLine, @Nullable Boolean allowed, @Nullable List<Object> errorCodes, @Nullable String typename) {
			super();
			this.type = type;
		...
		public boolean equals(@Nullable Object other) {
			...
			if ((other instanceof ArmState) == false) {
				return false;
			}
