...
/**
 * Converts the native LCN value of LCN-WIH to the wind speed value.
 *
 * @author Fabian Wolter - Initial Contribution
 */
@NonNullByDefault
public class WindspeedConverter extends AbstractVariableValueConverter {
    @Override
    protected Unit<?> getUnitType() {
        return SmartHomeUnits.METRE_PER_SECOND;
    }
