...
class JsonResponseVehicleStatusTest {
    ...
    @BeforeEach
    public void setUp() {
        this.gson = new GsonBuilder().registerTypeAdapterFactory(new GeometryAdapterFactory())
    ...
    void testGetVehicleStatus() {
        final VehicleStatus vehicleStatus = this.gson.fromJson(API_RESPONSE, VehicleStatus.class);
