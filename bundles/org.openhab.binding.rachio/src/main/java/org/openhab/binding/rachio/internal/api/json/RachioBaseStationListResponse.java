...
/**
 * Smart Hose base-station list response.
 *
 * @author Kovacs Istvan - Initial contribution
 */
@NonNullByDefault
public class RachioBaseStationListResponse {
    ...
    public static RachioBaseStationListResponse fromJson(String json) {
        ...
        response.baseStations.addAll(RachioSmartHoseJsonParser.parseArray(json, RachioBaseStation.class, "baseStations",
                "items", "data", "results"));
        return response;
    }
}
