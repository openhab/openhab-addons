...
class RachioQuantityCommandHandlerTest {
    ...
    void controllerRuntimeAcceptsQuantityTypeSecondsForMultiZonePayload() throws Exception {
        ...
        assertMultiZoneDuration(bridgeHandler, 120);
    }
    ...
    void controllerRuntimeStillAcceptsPlainNumericSecondsForMultiZonePayload() throws Exception {
        ...
        assertMultiZoneDuration(bridgeHandler, 30);
    }
    ...
    private void assertMultiZoneDuration(RachioBridgeHandler bridgeHandler, int expectedDuration)
            throws RachioApiException {
        ArgumentCaptor<String> payloadCaptor = ArgumentCaptor.forClass(String.class);
        verify(bridgeHandler).runMultipleZones(payloadCaptor.capture());
        JsonArray zones = JsonParser.parseString(payloadCaptor.getValue()).getAsJsonObject().getAsJsonArray("zones");
        assertThat(zones.size(), is(1));
        JsonObject zone = zones.get(0).getAsJsonObject();
