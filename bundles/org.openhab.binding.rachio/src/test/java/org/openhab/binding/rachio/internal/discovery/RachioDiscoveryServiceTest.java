...
class RachioDiscoveryServiceTest {
    ...
    void scheduleDiscoveryResultContainsStableScheduleIdentity() {
        ...
        ScheduleSnapshot scheduleRule = scheduleRule("schedule-id", "Morning", "FIXED");
    ...
    void flexScheduleDiscoveryResultContainsStableFlexScheduleIdentity() {
        DeviceSnapshot device = device();
        ScheduleSnapshot scheduleRule = scheduleRule("flex-id", "Flex", "FLEX");
    ...
    private DeviceSnapshot device() {
        return new DeviceSnapshot("device-id", "Controller", "controller", "ONLINE", true, false, Map.of(), List.of(),
                List.of(), List.of());
    }

    private ScheduleSnapshot scheduleRule(String id, String name, String type) {
        return new ScheduleSnapshot(id, name, type);
    }
