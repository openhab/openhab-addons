...
class RachioHandlerFactoryTest {
    ...
    void webhookSignatureValidationUsesBridgeMatchedByExternalId() throws Exception {
        ...
        bridgeList(factory).put("first", firstBridgeHandler);
        bridgeList(factory).put("second", secondBridgeHandler);
    ...
    private Map<String, RachioBridgeHandler> bridgeList(RachioHandlerFactory factory)
            throws ReflectiveOperationException {
        Field field = RachioHandlerFactory.class.getDeclaredField("bridgeList");
        field.setAccessible(true);
        return Objects.requireNonNull((Map<String, RachioBridgeHandler>) field.get(factory));
    }
