...
class RachioScheduleHandlerStatusTest {
    ...
    @Test
    void flexScheduleHandlerDoesNotTreatThingUidAsRuleUuidDuringInitialization() {
        ...
        assertThat(handler.loadedFlexScheduleRuleId, is(""));
        verify(callback).statusUpdated(eq(thing), argThat(status -> status.getStatus() == ThingStatus.OFFLINE
    ...
    private static class ResponseScheduleHandler extends RachioScheduleHandler {
        ...
        @Override
        protected RachioScheduleRuleResponse loadScheduleRule(RachioBridgeHandler handler,
    ...
    private static class RetryingScheduleHandler extends RachioScheduleHandler {
        ...
        @Override
        protected RachioScheduleRuleResponse loadScheduleRule(RachioBridgeHandler handler,
                String requestedScheduleRuleId) throws RachioApiException {
            if (firstLoad) {
                firstLoad = false;
