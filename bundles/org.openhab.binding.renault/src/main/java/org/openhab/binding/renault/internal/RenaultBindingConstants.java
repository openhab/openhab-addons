...
public class RenaultBindingConstants {
    ...
    public static final String CHANNEL_SOC_LEVEL_UPDATED = "soclevelupdated";
    public static final String CHANNEL_SOC_LEVEL_MIN = "soclevelmin";
    public static final String CHANNEL_SOC_LEVEL_MAX = "soclevelmax";
    ...
    public static final List<String> SOC_LEVEL_CHANNELS = List.of(CHANNEL_SOC_LEVEL_UPDATED, CHANNEL_SOC_LEVEL_MIN,
            CHANNEL_SOC_LEVEL_MAX);
    public static final List<String> ALL_CHANNELS = List.of(CHANNEL_IMAGE, CHANNEL_LOCATION, CHANNEL_LOCATION_UPDATED,
            ...
            CHANNEL_BATTERY_STATUS_UPDATED, CHANNEL_CHARGING_MODE, CHANNEL_SOC_LEVEL_UPDATED, CHANNEL_SOC_LEVEL_MIN,
            CHANNEL_SOC_LEVEL_MAX);
}
