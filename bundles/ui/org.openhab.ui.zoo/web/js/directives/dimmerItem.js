...
'use strict';
angular.module('ZooLib.directives.dimmerItem', []).directive('dimmerItem', function($log, $timeout, itemService, $rootScope) {
  ...
  return {
    ...
    link: function(scope, elem, attrs) {
      ...
      updateItem = function(newState) {
        ...
        return scope.options.cssIconClass = getIconClassByTags(scope.item);
      };
