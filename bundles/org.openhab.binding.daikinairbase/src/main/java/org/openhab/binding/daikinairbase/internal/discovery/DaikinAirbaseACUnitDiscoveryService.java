 ...
 */
package org.openhab.binding.daikinairbase.internal.discovery;
...
/**
 * Discovery service for Daikin Airbase AC units.
 *
 * @author Tim Waterhouse <tim@timwaterhouse.com> - Initial contribution
 *
 */
@Component(service = DiscoveryService.class)
public class DaikinAirbaseACUnitDiscoveryService extends AbstractDiscoveryService {
    ...
    private Logger logger = LoggerFactory.getLogger(DaikinAirbaseACUnitDiscoveryService.class);

    private final Runnable scanner;
    private ScheduledFuture<?> backgroundFuture;

    public DaikinAirbaseACUnitDiscoveryService() {
        super(Collections.singleton(DaikinAirbaseBindingConstants.THING_TYPE_AC_UNIT), 600, true);
