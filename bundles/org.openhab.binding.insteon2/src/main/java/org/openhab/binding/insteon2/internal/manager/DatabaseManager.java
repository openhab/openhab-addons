...
import org.openhab.binding.insteon2.internal.database.LinkDBReader;
import org.openhab.binding.insteon2.internal.database.LinkDBWriter;
import org.openhab.binding.insteon2.internal.database.ModemDBReader;
import org.openhab.binding.insteon2.internal.database.ModemDBWriter;
...
public class DatabaseManager {
    ...
    private static class DatabaseOperation {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return device.getAddress().equals(other.getDevice().getAddress()) && type == other.type;
        }
        ...
        public int hashCode() {
            final int prime = 31;
            int result = 1;
            result = prime * result + device.getAddress().hashCode();
