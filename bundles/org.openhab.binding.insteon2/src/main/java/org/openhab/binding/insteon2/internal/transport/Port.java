 ...
 */
package org.openhab.binding.insteon2.internal.transport;
...
import org.openhab.binding.insteon2.internal.listener.PortListener;
import org.openhab.binding.insteon2.internal.transport.message.Msg;
import org.openhab.binding.insteon2.internal.transport.message.MsgFactory;
    ...
    public void stop() {
        ...
        if (readThread != null) {
            try {
                ...
                logger.debug("got interrupted waiting for reader thread to exit.");
            }
        ...
        if (writeThread != null) {
            try {
                ...
                logger.debug("got interrupted waiting for writer thread to exit.");
            }
