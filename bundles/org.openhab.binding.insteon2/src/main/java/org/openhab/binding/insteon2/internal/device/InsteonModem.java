...
import org.openhab.binding.insteon2.internal.manager.DatabaseManager;
import org.openhab.binding.insteon2.internal.manager.LinkManager;
import org.openhab.binding.insteon2.internal.manager.PollManager;
import org.openhab.binding.insteon2.internal.manager.RequestManager;
import org.openhab.binding.insteon2.internal.transport.Port;
...
public class InsteonModem extends BaseDevice<InsteonAddress, InsteonBridgeHandler> implements PortListener {
    ...
    public InsteonModem(InsteonBridgeConfiguration config, ScheduledExecutorService scheduler,
        ...
        this.poller = new PollManager(config.getId());
        this.requester = new RequestManager(config.getId());
    }
