...
public abstract class IOStream {
    ...
    public static IOStream create(InsteonBridgeConfiguration config, ScheduledExecutorService scheduler,
        ...
        if (config instanceof InsteonHubConfiguration hubConfig) {
            return makeHubIOStream(hubConfig, scheduler);
        } else if (config instanceof InsteonHubLegacyConfiguration hubLegacyConfig) {
            return makeHubLegacyIOStream(hubLegacyConfig);
        } else if (config instanceof InsteonPLMConfiguration plmConfig) {
            return makePLMIOStream(plmConfig, serialPortManager);
        } else {
