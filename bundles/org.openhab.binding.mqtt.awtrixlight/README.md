...
| `autoscale`           | RW         | Enable/disable autoscaling for bar and linechart.                                                                                                                                                                                  |
| `background`          | RW         | Sets a background color.                                                                                                                                                                                                           |
| `bar`                 | RW         | Shows a bar chart: Send a string with values separated by commas (e.g. "value1,value2,value3"). Only the last 16 values will be displayed.                                                                                         |
| `blink`               | RW         | Blink text: Blink the text in the specified interval. Ignored if gradientColor or rainbow are set.                                                                                                                                 |
| `center`              | RW         | Center short text horizontally and disable scrolling.                                                                                                                                                                              |
| `color`               | RW         | Text, bar or line chart color.                                                                                                                                                                                                     |
| `duration`            | RW         | Display duration in seconds.                                                                                                                                                                                                       |
| `effect`              | RW         | Display effect (see https://blueforcer.github.io/awtrix3/#/effects for possible values).                                                                                                                                           |
| `effect-blend`        | RW         | Enable smoother effect transitions. Only to be used with effect.                                                                                                                                                                   |
| `effect-palette`      | RW         | Color palette for effects (see https://blueforcer.github.io/awtrix3/#/effects for possible values and how to create custom palettes). Only to be used with effect.                                                                 |
| `effect-speed`        | RW         | Effect animation speed: Higher means faster (see https://blueforcer.github.io/awtrix3/#/effects). Only to be used with effect.                                                                                                     |
| `fade`                | RW         | Fade text: Fades the text in and out in the specified interval. Ignored if gradientColor or rainbow are set.                                                                                                                       |
| `gradient-color`      | RW         | Secondary color for gradient effects. Use color for setting the primary color.                                                                                                                                                     |
| `icon`                | RW         | Icon name to display: Install icons on the clock device first.                                                                                                                                                                     |
| `lifetime`\*          | RW         | App lifetime: Define how long the app will remain active on the clock.                                                                                                                                                             |
| `lifetime-mode`\*     | RW         | Lifetime mode: Define if the app should be deleted (Command DELETE) or marked as stale (Command STALE) after lifetime.                                                                                                             |
| `line`                | RW         | Shows a line chart: Send a string with values separated by commas (e.g. "value1,value2,value3"). Only the last 16 values will be displayed.                                                                                        |
| `overlay`             | RW         | Enable overlay mode: Shows a weather overlay effect (can be any of clear, snow, rain, drizzle, storm, thunder, frost).                                                                                                             |
| `progress`            | RW         | Progress value: Shows a progress bar at the bottom of the app with the specified percentage value.                                                                                                                                 |
| `progress-background` | RW         | Progress bar background color: Background color for the progress bar.                                                                                                                                                              |
| `progress-color`      | RW         | Progress bar color: Color for the progress bar.                                                                                                                                                                                    |
| `push-icon`           | RW         | Push icon animation (STATIC=Icon doesn't move, PUSHOUT=Icon moves with text and will not appear again, PUSHOUTRETURN=Icon moves with text but appears again when the text starts to scroll again).                                 |
| `rainbow`             | RW         | Enable rainbow effect: Uses a rainbow effect for the displayed text.                                                                                                                                                               |
| `reset`\*             | RW         | Reset app to default state: All channels will be reset to their default values.                                                                                                                                                    |
| `scroll`              | RW         | Scroll text: Scroll the text in the specified interval. Ignored if gradientColor or rainbow are set.                                                                                                                               |
| `scroll-speed`        | RW         | Text scrolling speed: Provide as percentage value. The original speed is 100%. Values above 100% will increase the scrolling speed, values below 100% will decrease it. Setting this value to 0 will disable scrolling completely. |
| `text`                | RW         | Text to display.                                                                                                                                                                                                                   |
| `text-case`           | RW         | Set text case (0=normal, 1=uppercase, 2=lowercase).                                                                                                                                                                                |
| `text-offset`         | RW         | Text offset position: Horizontal offset of the text in pixels.                                                                                                                                                                     |
| `top-text`            | RW         | Draws the text on the top of the display.                                                                                                                                                                                          |
