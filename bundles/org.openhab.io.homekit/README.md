...
| Valve                  |                              |                           |                       | Valve. additional configuration: homekitValveType = ["Generic", "Irrigation", "Shower", "Faucet"] and homekitDefaultDuration = <default duration in seconds> and homekitTimer =<true/false>           
|                        | ActiveStatus                 |                           | Switch                | accessory current working status. A value of "ON"/"OPEN" indicate that the accessory is active and is functioning without any errors.                                                                                       |                                                                                                             
