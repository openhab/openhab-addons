...
|                        |                              |  Duration                 | Number                | defines how long a valve should be set to ʼIn Useʼ in second. Integration starts a timer and will stop the valve after that time. You can define the default duration via configuration homekitDefaultDuration = <default duration in seconds>
