...
| startLevel               | The openHAB Start Level at which to start the Homekit Bridge. You many want to set this to a higher value if you have scripts that create HomeKit-tagged Items, or you want to wait for item states to be restored from persistence. See [StartLevelService](https://www.openhab.org/javadoc/latest/org/openhab/core/service/startlevelservice) for details on the available levels. | 30 (States restores) |
