...
import io.github.hapjava.accessories.BasicWindow;
 ...
 *
 */
public class HomekitWindowImpl extends AbstractHomekitAccessoryImpl<RollershutterItem> implements BasicWindow {

    public HomekitWindowImpl(HomekitTaggedItem taggedItem, ItemRegistry itemRegistry, HomekitAccessoryUpdater updater) {
