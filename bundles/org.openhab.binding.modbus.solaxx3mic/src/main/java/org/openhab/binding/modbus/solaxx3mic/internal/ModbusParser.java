...
public final class ModbusParser {
     ...
     */
    public static Long extractInt32(ModbusRegisterArray raw, int index, boolean littleEndian, long def) {
        return extractOptionalInt32(raw, index, littleEndian).orElse(def);
    }
}
