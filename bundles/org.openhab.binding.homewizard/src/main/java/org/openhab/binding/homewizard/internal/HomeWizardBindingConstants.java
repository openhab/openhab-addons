...
public class HomeWizardBindingConstants {
    ...
    public static final String CHANNEL_POWER_IMPORT_T1 = "total_power_import_t1";
    public static final String CHANNEL_POWER_IMPORT_T2 = "total_power_import_t2";
    public static final String CHANNEL_POWER_EXPORT_T1 = "total_power_export_t1";
    public static final String CHANNEL_POWER_EXPORT_T2 = "total_power_export_t2";
