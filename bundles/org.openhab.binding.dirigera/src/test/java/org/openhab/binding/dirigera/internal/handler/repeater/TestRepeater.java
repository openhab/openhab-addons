...
/**
 * {@link TestRepeater} Tests device handler creation, initializing and refresh of channels
 *
...
class TestRepeater {
    ...
    void checkRepeaterStates(CallbackMock callback) {
