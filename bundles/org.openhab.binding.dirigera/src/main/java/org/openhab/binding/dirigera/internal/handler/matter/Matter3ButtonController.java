 ...
 */
@NonNullByDefault
public class Matter3ButtonController extends BaseMatterHandler {
    ...
    private final Logger logger = LoggerFactory.getLogger(Matter3ButtonController.class);
    ...
    public Matter3ButtonController(Thing thing) {
        super(thing);
    ...
    public void handleUpdate(JSONObject update) {
        ...
        if (attributes != null) {
            ...
            logger.trace("handleUpdate: deviceId={}, controlMode={}", deviceId, controlMode);
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        ...
        if (group == null) {
            logger.debug("handleCommand: group is null for channelUID={}", channelUID);
            return;
        }
        ...
        if (CHANNEL_CONTROL_MODE.equals(channelId)) {
            ...
            if (linkHandler == null) {
                logger.warn("No link handler found for controller {}", targetController);
                return;
            } else {
