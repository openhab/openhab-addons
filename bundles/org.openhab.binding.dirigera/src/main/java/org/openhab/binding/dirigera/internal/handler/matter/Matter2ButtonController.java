...
/**
 * The {@link Matter2ButtonController} handles a Matter 2-Button Controller device e.g. BILRESA from IKEA.
 *
 * @author Bernd Weymann - Initial contribution
 */
@NonNullByDefault
public class Matter2ButtonController extends BaseMatterHandler {
    ...
    private final Logger logger = LoggerFactory.getLogger(Matter2ButtonController.class);
    ...
    public Matter2ButtonController(Thing thing) {
        super(thing);
