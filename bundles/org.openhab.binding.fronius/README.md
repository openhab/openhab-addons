...
| `schema`          | Set the protocol schema that is used to connect to your device (default:http)  | No       |
...
```java
Bridge fronius:bridge:mybridge [hostname="192.168.66.148", refreshInterval=5, username="customer", password="someSecretPassword", schema="http"] {
