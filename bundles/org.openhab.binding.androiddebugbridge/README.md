...
As I can not find other android a way to identify other android devices in the network the manual discovery scan will try to connect through adb to all the reachable ip in the defined range.
