...
/**
 * The {@link InfokeyMosfetDinV1Handler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author Themistoklis Anastasopoulos - Initial contribution
 */
// @NonNullByDefault
public class InfokeyMosfetDinV1Handler extends BaseThingHandler {
    ...
    public InfokeyMosfetDinV1Handler(Thing thing) {
        super(thing);
    }
