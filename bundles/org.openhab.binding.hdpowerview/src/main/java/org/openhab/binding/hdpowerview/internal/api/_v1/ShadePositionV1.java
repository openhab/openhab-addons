...
/**
 * The position of a single shade, as returned by an HD PowerView hub of Generation 1/2
 *
 * @author Andy Lintner - Initial contribution
 * @author Andrew Fiddian-Green - Added support for secondary rail positions
 */
@NonNullByDefault
public class ShadePositionV1 extends ShadePosition {

    private final transient Logger logger = LoggerFactory.getLogger(ShadePositionV1.class);
