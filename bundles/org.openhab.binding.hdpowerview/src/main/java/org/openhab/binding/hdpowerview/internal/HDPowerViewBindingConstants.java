...
public class HDPowerViewBindingConstants {
    ...
    public static final String PROPERTY_SECONDARY_RAIL_DETECTED = "secondaryRailDetected"; // hidden
    public static final String PROPERTY_TILT_ANYWHERE_DETECTED = "tiltAnywhereDetected"; // hidden
