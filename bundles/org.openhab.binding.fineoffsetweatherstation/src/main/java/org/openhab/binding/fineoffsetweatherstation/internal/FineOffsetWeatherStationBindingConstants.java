...
public class FineOffsetWeatherStationBindingConstants {
    ...
    public static final ChannelTypeUID CHANNEL_PM10 = new ChannelTypeUID(BINDING_ID, "pm10");
    public static final ChannelTypeUID CHANNEL_CO2 = new ChannelTypeUID(BINDING_ID, "co2");
