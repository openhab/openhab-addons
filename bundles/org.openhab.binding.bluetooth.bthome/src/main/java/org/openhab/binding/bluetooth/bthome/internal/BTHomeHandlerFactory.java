...
/**
 * The {@link Bluetooth.BTHomeHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
 * @author Markus Michels - Initial contribution
 */
@NonNullByDefault
@Component(configurationPid = "binding.bluetooth.bthome", service = ThingHandlerFactory.class)
public class BTHomeHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_SAMPLE.equals(thingTypeUID)) {
            return new BTHomeHandler(thing);
        }
