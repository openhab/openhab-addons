 ...
 */
@NonNullByDefault
public class SomfyTahomaCurtainHandler extends SomfyTahomaBaseThingHandler {

    private final Logger logger = LoggerFactory.getLogger(SomfyTahomaCurtainHandler.class);
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        ...
        if (RefreshType.REFRESH.equals(command)) {
            ...
            if (COMMAND_MY.equals(cmd)) {
                ...
                if (executionId != null) {
                    //Check if the curtain is moving and MY is sent => STOP it
    ...
    private String getTahomaCommand(String command) {
        switch (command) {
            case "OFF":
            case "DOWN":
            case "CLOSE":   return COMMAND_CLOSE;
            case "ON":
            case "UP":
            case "OPEN":    return COMMAND_OPEN;
            case "MY":
            case "STOP":    return COMMAND_MY;
            default:
