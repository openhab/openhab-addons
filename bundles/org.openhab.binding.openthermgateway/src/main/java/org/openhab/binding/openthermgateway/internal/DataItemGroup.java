...
public class DataItemGroup {
    ...
    private static Map<Integer, DataItem[]> createDataItemGroups() {
        ...
        g.put(0, new DataItem[] { new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 0, "ch_enable", CodeType.B),
                ...
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 5, "reserved_5", CodeType.B),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 6, "reserved_6", CodeType.B),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 7, "reserved_7", CodeType.B),
                ...
                new FlagDataItem(Msg.READ, ByteType.LOWBYTE, 7, "reserved_7", CodeType.B) });
        ...
        g.put(2, new DataItem[] { new FlagDataItem(Msg.WRITE, ByteType.HIGHBYTE, 0, "reserved_0"),
                new FlagDataItem(Msg.WRITE, ByteType.HIGHBYTE, 1, "reserved_1"),
                new FlagDataItem(Msg.WRITE, ByteType.HIGHBYTE, 2, "reserved_2"),
                new FlagDataItem(Msg.WRITE, ByteType.HIGHBYTE, 3, "reserved_3"),
                new FlagDataItem(Msg.WRITE, ByteType.HIGHBYTE, 4, "reserved_4"),
                new FlagDataItem(Msg.WRITE, ByteType.HIGHBYTE, 5, "reserved_5"),
                new FlagDataItem(Msg.WRITE, ByteType.HIGHBYTE, 6, "reserved_6"),
                new FlagDataItem(Msg.WRITE, ByteType.HIGHBYTE, 7, "reserved_7"),
        ...
        g.put(3, new DataItem[] { new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 0, "dhwpresent"),
                ...
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 6, "reserved_6"),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 7, "reserved_7"),
        ...
        g.put(6, new DataItem[] { new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 0, "reserved_h0"),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 1, "reserved_h1"),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 2, "reserved_h2"),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 3, "reserved_h3"),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 4, "reserved_h4"),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 5, "reserved_h5"),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 6, "reserved_h6"),
                new FlagDataItem(Msg.READ, ByteType.HIGHBYTE, 7, "reserved_h7"),
                new FlagDataItem(Msg.READ, ByteType.LOWBYTE, 0, "reserved_l0"),
                new FlagDataItem(Msg.READ, ByteType.LOWBYTE, 1, "reserved_l1"),
                new FlagDataItem(Msg.READ, ByteType.LOWBYTE, 2, "reserved_l2"),
                new FlagDataItem(Msg.READ, ByteType.LOWBYTE, 3, "reserved_l3"),
                new FlagDataItem(Msg.READ, ByteType.LOWBYTE, 4, "reserved_l4"),
                new FlagDataItem(Msg.READ, ByteType.LOWBYTE, 5, "reserved_l5"),
                new FlagDataItem(Msg.READ, ByteType.LOWBYTE, 6, "reserved_l6"),
                new FlagDataItem(Msg.READ, ByteType.LOWBYTE, 7, "reserved_l7") });
