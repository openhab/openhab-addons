...
/**
 * SAIC Translation Provider
 * 
 * @author Doug Culnane - Initial contribution
 */
@NonNullByDefault
public class SAICTranslationProvider {

    private final Bundle bundle;
    private final TranslationProvider i18nProvider;
    private final LocaleProvider localeProvider;

    public SAICTranslationProvider(TranslationProvider i18nProvider, LocaleProvider localeProvider) {
