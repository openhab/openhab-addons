...
/**
 * The {@link UpdateEntity} class represents an update entity type in the Home Assistant binding.
 * Maps software or firmware update availability to openHAB Contact and String channels.
 *
 * @author Jimmy Tanagra - Initial contribution
 */
@NonNullByDefault
public class UpdateEntity implements EntityType {
    ...
    public List<ChannelSpec> getChannelSpecs(EntityState entityState, EntityContext context) {
        return ChannelSpecsBuilder.create(entityState, context) //
                ...
                .addAttr("installed_version", ItemType.STRING) //
                .addAttr("latest_version", ItemType.STRING) //
                .build();
    }
    ...
    public Map<String, ParsedData> parseState(EntityState entityState, EntityContext context) {
        return StateMapBuilder.create(entityState, context) //
                ...
                .putString("installed_version") //
                .putString("latest_version") //
                .build();
    }
}
