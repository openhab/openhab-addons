...
/**
 * The {@link DateEntity} class represents a date entity type in the Home Assistant binding.
 * Maps date selection controls to openHAB String channels and handles setting date values.
 *
 * @author Jimmy Tanagra - Initial contribution
 */
@NonNullByDefault
public class DateEntity implements EntityType {
    ...
    public Optional<ServiceCall> toServiceCall(String entityId, String attribute, Command command,
        ...
        if (EntityType.isPrimary(attribute)) {
            return CommandMapper.onDateTimeToDate(command, getType(), "set_value", "value", entityId);
        }
