...
/**
 * The {@link SwitchEntity} class represents a switch entity type in the Home Assistant binding.
 * It provides methods to build channels and update states specific to switch devices.
 *
 * @author Jimmy Tanagra - Initial contribution
 */
@NonNullByDefault
public class SwitchEntity implements EntityType {
