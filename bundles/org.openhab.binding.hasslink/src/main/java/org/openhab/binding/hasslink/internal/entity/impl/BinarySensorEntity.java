...
/**
 * The {@link BinarySensorEntity} class represents a binary sensor entity type in the Home Assistant binding.
 * It provides methods to build channels and update states specific to binary sensors.
 *
 * @author Jimmy Tanagra - Initial contribution
 */
@NonNullByDefault
public class BinarySensorEntity implements EntityType {
    ...
    public List<ChannelSpec> getChannelSpecs(EntityState entityState, EntityContext context) {
        // We want to infer the primary channel since it can be a Switch or Contact depending on the device_class
    ...
    public @Nullable StateDescriptionFragment getStateDescriptionFragment(EntityState entityState, String attribute,
        ...
        return StateDescriptionFragmentBuilder.create().withReadOnly(true).build();
    }
