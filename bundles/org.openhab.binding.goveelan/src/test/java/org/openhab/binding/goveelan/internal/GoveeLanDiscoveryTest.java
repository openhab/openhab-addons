...
public class GoveeLanDiscoveryTest {
    ...
    public void testProcessScanMessage() {
        ...
        assertEquals(deviceProperties.get(GoveeLanBindingConstants.DEVICE_TYPE), "H6076");
        assertEquals(deviceProperties.get(GoveeLanBindingConstants.IP_ADDRESS), "192.168.178.171");
        assertEquals(deviceProperties.get(GoveeLanBindingConstants.MAC_ADDRESS), "7D:31:C3:35:33:33:44:15");
    }
}
