...
public class Notification {
    ...
    public static class RemoteViewData {
        ...
        /**
         * Returns true if this is a Request-to-Enter (REN) doorbell event rather than a regular doorbell ring.
         * REN events are indicated by a non-zero reason code.
         */
