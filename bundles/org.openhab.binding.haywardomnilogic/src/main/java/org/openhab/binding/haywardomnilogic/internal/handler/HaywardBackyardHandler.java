 ...
 */
@NonNullByDefault
public class HaywardBackyardHandler extends BaseThingHandler {
    ...
    public void updateBackyardData(String systemID, String channelID, String data) {
        ...
        if (chan != null) {
            ...
            if (acceptedItemType != null) {
                ...
                logger.trace("Updated Hayward Backyard {} {} to: {}", systemID, channelID, data);
            }
        }
    }
