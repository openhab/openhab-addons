 ...
 */
@NonNullByDefault
public class HaywardChlorinatorHandler extends BaseThingHandler {
    ...
    public void updateChlorinatorData(String systemID, String channelID, String data) {
        Channel chan = getThing().getChannel(channelID);
        if (chan != null) {
            updateState(chan.getUID(), new DecimalType(data));
            logger.trace("Updated Hayward Chlorinator {} {} to: {}", systemID, channelID, data);
        }
    }
