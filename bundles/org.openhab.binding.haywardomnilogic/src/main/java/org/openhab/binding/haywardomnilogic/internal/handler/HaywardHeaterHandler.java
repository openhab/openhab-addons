 ...
 */
@NonNullByDefault
public class HaywardHeaterHandler extends BaseThingHandler {
    ...
    public void updateHeaterData(String systemID, String channelID, String data) {
        ...
        if (chan != null) {
            ...
            logger.trace("Updated Hayward Heater {} {} to: {}", systemID, channelID, data);
        }
    }
