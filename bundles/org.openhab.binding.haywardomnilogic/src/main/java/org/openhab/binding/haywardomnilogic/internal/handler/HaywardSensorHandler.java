 ...
 */
@NonNullByDefault
public class HaywardSensorHandler extends BaseThingHandler {
    ...
    public void updateSensorData(String systemID, String channelID, String data) {
        Channel chan = getThing().getChannel(channelID);
        if (chan != null) {
            updateState(chan.getUID(), new DecimalType(data));
            logger.trace("Updated Hayward Sensor {} {} to: {}", systemID, channelID, data);
        }
    }
