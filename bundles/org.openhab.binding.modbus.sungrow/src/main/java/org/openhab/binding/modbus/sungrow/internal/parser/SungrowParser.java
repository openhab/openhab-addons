...
/**
 * General interface for sungrow parsers
 *
 * Parsers are responsible to take the raw register array
 * that was read from the device and to parse them into a SungrowMessageBlock
 ...
 */
@NonNullByDefault
public interface SungrowParser<T> {

    /**
     * This method should parser an incoming register array and
     * return a not-null sungrow block
     */
