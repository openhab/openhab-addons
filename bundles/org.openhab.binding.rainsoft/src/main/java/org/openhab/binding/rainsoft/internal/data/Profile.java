...
public class Profile {
     ...
     *
     * @param jsonProfile the JSON profile retrieved from the RainSoft API.
     ...
     * the user when configuring the RainSoft Account thing. It is not clear from the
     * reverse engineering done whether the hardware id is really used by RainSoft. It
    ...
    /**
     * Get the email address of the RainSoft user account. The email is also used
     * as the username.
     *
    ...
    /**
     * Return the value retrieved from the RainSoft API.
     *
