...
| Parameter               | Type      | Required | Default | Description                                                                             |
|-------------------------|-----------|----------|---------|-----------------------------------------------------------------------------------------|
| `playerId`              | `integer` | yes      | —       | The player's id in the Live Tennis API; look it up with `GET /players?search=name`      |
...
| `live#opponent`          | `String`   | Name of the opponent                                                                                                 |
...
The API answers requests over quota with HTTP 429; the bridge then goes `OFFLINE` with a communication error until a later poll succeeds.
