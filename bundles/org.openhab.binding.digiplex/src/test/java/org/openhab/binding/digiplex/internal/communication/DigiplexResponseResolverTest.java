...
public class DigiplexResponseResolverTest {
    ...
    void resolveResponseReturnsUnknownResponseWhenMessageIsMalformed(String message) {
        DigiplexResponse actual = DigiplexResponseResolver.resolveResponse(message);
        assertThat(actual, is(instanceOf(UnknownResponse.class)));
        if (actual instanceof UnknownResponse unknownResponse) {
            assertThat(unknownResponse.message, is(equalTo(message)));
        }
    }

    private static Stream<Arguments> provideTestCasesForResolveResponseReturnsUnknownResponseWhenMessageIsMalformed() {
        return Stream.of( //
                ...
                Arguments.of("AA&fail"), Arguments.of("UL  "), Arguments.of("PG  "), Arguments.of("GGGGGGGGGGGG"),
                Arguments.of("G1234567890"), Arguments.of("ZZZZ"));
    }
