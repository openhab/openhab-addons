...
| ------------------ | --------------------| --------------------------------------------------- |
| Lambda Heat Pump   | lambda-heatpump     | A lambda heat pump visible in the local network     |
...
| buffer1-maximum-buffer-temperature      | Number:Temperature | false     | [0.1 °C] | Setting for maximum buffer temperature (min = 25.0°C; max = 65.0°C)    |
