...
import static org.openhab.binding.modbus.lambda.internal.LambdaBindingConstants.THING_TYPE_BOILER;
import static org.openhab.binding.modbus.lambda.internal.LambdaBindingConstants.THING_TYPE_BUFFER;
import static org.openhab.binding.modbus.lambda.internal.LambdaBindingConstants.THING_TYPE_GENERAL;
import static org.openhab.binding.modbus.lambda.internal.LambdaBindingConstants.THING_TYPE_HEATING_CIRCUIT;
import static org.openhab.binding.modbus.lambda.internal.LambdaBindingConstants.THING_TYPE_HEATPUMP;
...
public class LambdaHandlerFactory extends BaseThingHandlerFactory {
    ...
    private static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Set.of(THING_TYPE_GENERAL, THING_TYPE_HEATPUMP,
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_GENERAL.equals(thingTypeUID)) {
            return new GeneralHandler(thing);
        } else if (THING_TYPE_HEATPUMP.equals(thingTypeUID)) {
