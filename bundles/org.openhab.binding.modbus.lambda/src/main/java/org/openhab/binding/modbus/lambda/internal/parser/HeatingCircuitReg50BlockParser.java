...
public class HeatingCircuitReg50BlockParser extends AbstractBaseParser {
    ...
    public HeatingCircuitReg50Block parse(ModbusRegisterArray raw) {
        ...
        block.heating_circuitOffsetFlowLineTemperature = extractInt16(raw, 0, (short) 0);
        block.heating_circuitRoomHeatingTemperature = extractInt16(raw, 1, (short) 0);
        block.heating_circuitRoomCoolingTemperature = extractInt16(raw, 2, (short) 0);
        return block;
    }
}
