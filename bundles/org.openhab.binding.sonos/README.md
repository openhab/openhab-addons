...
| firmware             | String    | R           | Software version of the Zone Player, as shown in the Sonos app                                                               | all                                                                                     |
...
| playlinein           | String    | W           | Play audio from the line-in of the zoneplayer identified by the Thing UID or UPnP UDN.                                       | All                                                                                     |
