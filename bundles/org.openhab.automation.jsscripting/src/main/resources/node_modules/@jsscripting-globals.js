...
(function (global) {
  ...
  function getDefaultIdentifier () {
    let identifier = 'org.openhab.automation.jsscripting.';
    const filename = globalThis['javax.script.filename'];
    ...
    if (filename) {
        ...
        identifier += engineIdentifier.replaceAll('openhab-transformation-script-', 'transformation.');
    }
    return identifier;
  }
  ...
  function getLogger (name) {
    ...
    if (log === null) {
      loggerName = getDefaultIdentifier();
      log = Java.type('org.slf4j.LoggerFactory').getLogger(loggerName);
    }
    return log;
  }
