...
import static org.openhab.automation.module.script.graaljs.commonjs.internal.AssertUtils.*;
...
public class FilesystemFolderTest {
  private File file = new File("src/test/resources/" + getClass().getPackage().getName().replace(".","/") + "/test1");
