...
public class ModuleTest {
  @Mock(answer = Answers.CALLS_REAL_METHODS) AbstractFolder root;
  @Mock(answer = Answers.CALLS_REAL_METHODS) AbstractFolder rootnm;
  @Mock(answer = Answers.CALLS_REAL_METHODS) AbstractFolder sub1;
  @Mock(answer = Answers.CALLS_REAL_METHODS) AbstractFolder sub1nm;
  @Mock(answer = Answers.CALLS_REAL_METHODS) AbstractFolder sub1sub1;
  @Mock(answer = Answers.CALLS_REAL_METHODS) AbstractFolder nmsub1;
  ...
  public void itCanLoadModulesFromSubFoldersInNodeModules() {
    assertEquals(
        "nmsub1file1", loadFromAndGet("nmsub1/nmsub1file1.js", "nmsub1file1"));
  }
  ...
  public void itCanLoadModulesFromSubSubFolders() {
    assertEquals(
        "sub1sub1file1",
        loadFromAndGet("./sub1/sub1/sub1sub1file1.js", "sub1sub1file1"));
  }

  @Test
  public void itCanLoadModulesFromParentFolders() {
    when(sub1.tryReadFile("sub1file1.js")).thenReturn(Optional.of("exports.sub1file1 = require('../file1').file1;"));
  ...
  public void itCanGoUpAndDownInFolders() {
    when(sub1.tryReadFile("sub1file1.js")).thenReturn(Optional.of("exports.sub1file1 = require('../file1').file1;"));
    assertEquals(
        "file1", loadFromAndGet("./sub1/../sub1/sub1file1.js", "sub1file1"));
  }
  ...
  public void itCanGoUpAndDownInNodeModulesFolders() {
    assertEquals(
        "nmsub1file1",
        loadFromAndGet("nmsub1/../nmsub1/nmsub1file1.js", "nmsub1file1"));
  }
  ...
  public void itUsesNodeModulesFromSubFolderForSubRequiresFromModuleInSubFolder() {
    ...
    assertEquals(
        "sub1nmfile1", loadFromAndGet("./sub1/sub1file1", "sub1nmfile1"));
  }
  ...
  public void itCanUseDotAndDoubleDotsToGoBackAndForward() {
    assertEquals(
        "file1", loadFromAndGet("./sub1/.././sub1/../file1.js", "file1"));
  }
  ...
  public void thePathOfModulesContainsNoDots() {
    ...
    assertEquals(
        "/file1.js", loadFromAndGet("./sub1/.././sub1/../file1.js", "path"));
  }
  ...
  public void theExceptionThrownForAnUnknownFileCanBeCaughtInJavaScriptAndHasTheProperCode()
      {
    String code = engine.eval("js",
                "(function() { try { require('./invalid'); } catch (ex) { return ex.code; } })();").asString();
  ...
  public void subModulesExposeTheExpectedFields() {
    when(sub1.tryReadFile("sub1file1.js"))
        .thenReturn(
                Optional.of("exports._module = module; exports._exports = exports; exports._main = require.main; exports._filename = __filename; exports._dirname = __dirname"));
  ...
  public void requireInRequiredModuleYieldExpectedParentAndChildren() {
    when(root.tryReadFile("file1.js")).thenReturn(Optional.of("exports._module = module; exports.sub = require('./sub1/sub1file1');"));
  ...
  public void loadingTheSameModuleFromASubPathYieldsTheSameObject() {
    ...
    Value first = engine.eval("js","require('./file1');");
    Value second =
        engine.eval("js","require('./sub1/sub1file1').sub;");
    AssertUtils.assertValueEquals(first, second);
  }
  ...
  public void anotherCheckForIssueNumber3() {
    when(root.tryReadFile("file1.js"))
        .thenReturn(
                Optional.of("var a = require('./file2'); function b() {}; b.prototype = Object.create(a.prototype, {});"));
    when(root.tryReadFile("file2.js"))
        .thenReturn(
