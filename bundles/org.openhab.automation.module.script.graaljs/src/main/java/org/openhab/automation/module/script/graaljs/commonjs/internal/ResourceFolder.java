...
/**
 * Folder implementation allowing loading from Resource folders (via a
 * classloader)
 *
...
public class ResourceFolder extends AbstractFolder {
    ...
    public Optional<Folder> getFolder(String name) {
        return Optional
                .of(new ResourceFolder(loader, resourcePath + "/" + name, Optional.of(this), getPath() + name + "/",
                        encoding));
    }

    private ResourceFolder(ClassLoader loader, String resourcePath, Optional<Folder> parent, String displayPath,
            String encoding) {
