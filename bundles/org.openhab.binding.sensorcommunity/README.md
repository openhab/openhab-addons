...
| Conditions Sensor  | condition     | Sensor to measure Temperature and Humidity conditions    |
...
| Channel ID            | Item Type                             | Description                                          |
|-----------------------|---------------------------------------|------------------------------------------------------|
| radiation             | Number:Number:RadiationDoseEffective  | Radiation measure in micro Sievert per hour          |
...
If these values are derivating too much from period to period it's an indication of a hardware problem.
