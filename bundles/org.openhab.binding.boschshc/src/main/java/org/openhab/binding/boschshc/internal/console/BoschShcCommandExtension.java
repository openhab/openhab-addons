...
public class BoschShcCommandExtension extends AbstractConsoleCommandExtension implements ConsoleCommandCompleter {
    ...
    List<String> getAllBoschShcServices() {
        return List.of("airqualitylevel", "alarm", "batterylevel", "binaryswitch", "bypass", "cameranotification",
                "childlock", "childprotection", "communicationquality", "displaydirection", "hsbcoloractuator",
                "humiditylevel", "illuminance", "impulseswitch", "intrusion", "keypad", "latestmotion",
                "multilevelswitch", "powermeter", "powerswitch", "presence", "privacymode", "roomclimatecontrol",
                "shuttercontact", "shuttercontrol", "silentmode", "smokedetectorcheck", "temperaturelevel", "userstate",
                "valvetappet", "vibrationsensor", "waterleakagesensor", "waterleakagesensorcheck",
