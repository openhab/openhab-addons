...
public class WizLightingHandler extends BaseThingHandler {
     ...
     * @param receivedParam The received {@link WizLightingSyncState}
     */
    private void updateLightStatesFromParams(final WizLightingSyncState receivedParam) {
     ...
     * @param receivedParam The received {@link WizLightingSyncState}
     */
    private void updateFanStatesFromParams(final WizLightingSyncState receivedParam) {
