...
```
Thing wizlighting:bulb:lamp "My Lamp" @ "Living Room" [ macAddress="accf23343cxx", ipAddress="192.168.0.xx" ]
```
...
```
Color LivingRoom_Light_Color "Living Room Lamp" (gLivingroom) {channel="wizlighting:color-bulb:accf23343cxx:color"}
```
