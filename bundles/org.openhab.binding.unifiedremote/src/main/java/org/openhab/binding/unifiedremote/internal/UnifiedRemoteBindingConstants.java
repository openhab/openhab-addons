...
public class UnifiedRemoteBindingConstants {
    ...
    public static final ThingTypeUID THING_TYPE_UNIFIED_SERVER = new ThingTypeUID(BINDING_ID, "server");

    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES = Collections.singleton(THING_TYPE_UNIFIED_SERVER);
