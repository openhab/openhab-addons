...
```
To setup the values for the next days follow the schema from above. For day 4 one example:
<pre>
<code>// ----------------- Day4 ------------------------------------------------------
Number:Temperature	<b>day4</b>TempL			"Low Temp [%.2f °F]"				<temperature>	(weather<b>Day4</b>)		{channel="meteoblue:weather:metBridge:A51:forecast<b>Day4</b>#minTemperature"}</code>
</pre>
