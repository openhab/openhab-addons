 ...
 */
@NonNullByDefault
@Component(service = { OnectaTranslationProvider.class })
public class OnectaTranslationProvider {
    private final TranslationProvider i18nProvider;
    private final LocaleProvider localeProvider;
    private final @Nullable Bundle bundle;

    @Activate
    public OnectaTranslationProvider(final @Reference TranslationProvider i18nProvider,
     ...
     * @return the translated text (can be null or empty)
     */
    public @NonNullByDefault String getText(String key, Object @Nullable... arguments) {
     ...
     */
    public @Nullable String getTextDefault(String key, @Nullable String defaultText, Object @Nullable... arguments) {
     ...
     * @return the translated text or the default text (can be null or empty)
     */
    public @Nullable String getTextDefault(String key, @Nullable String defaultText) {
