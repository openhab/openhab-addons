...
The binding operates via Modbus to read and write values towards the E3DC device. Please refer to the [official Modbus documentation](doc/ModBus_E3DC_Speichersysteme_V1.70_2020-06-18) for more details.  
...
See [official Modbus documentation](doc/ModBus_E3DC_Speichersysteme_V1.70_2020-06-18) for more details
