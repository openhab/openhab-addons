...
public final class VinEvents extends com.google.protobuf.GeneratedFile {
  private VinEvents() {}
  static {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                ensureAddedVINsIsMutable();
                addedVINs_.add(input.readStringRequireUtf8());
                break;
              } // case 10
              case 18: {
                ensureDeletedVINsIsMutable();
                deletedVINs_.add(input.readStringRequireUtf8());
                break;
              } // case 18
              default: {
