...
public class ShellyThingCreatorTest {
    ...
    private static Stream<Arguments> provideTestCasesForGetThingUIDReturnsThingUidByDeviceType() {
        return Stream.of( //
                ...
                // Plus Mini Series
                Arguments.of(SHELLYDT_MINI_1, "", THING_TYPE_SHELLYMINI_1_STR), //
                Arguments.of(SHELLYDT_MINI_1G3, "", THING_TYPE_SHELLYMINI_1_STR), //
                Arguments.of(SHELLYDT_MINI_1G3, "", THING_TYPE_SHELLYMINI_1_STR), //
                Arguments.of(SHELLYDT_MINI_1PM, "", THING_TYPE_SHELLYMINI_1PM_STR), //
                Arguments.of(SHELLYDT_MINI_1PMG3, "", THING_TYPE_SHELLYMINI_1PM_STR), //
                Arguments.of(SHELLYDT_MINI_1PMG4, "", THING_TYPE_SHELLYMINI_1PM_STR), //
                Arguments.of(SHELLYDT_MINI_PM, "", THING_TYPE_SHELLYMINI_PM_STR), //
                Arguments.of(SHELLYDT_MINI_PMG3, "", THING_TYPE_SHELLYMINI_PM_STR), //
                Arguments.of(SHELLYDT_MINI_EM, "", THING_TYPE_SHELLYMINI_PM_STR), //
