 ...
 * Supported BLU Devices: BLU Button 1, BLU Button Though, BLU Wall Switch 4, BLU RC Button 4,
 * BLU Door/Window, BLU Motion, BLU H&T, BLU Distance, BLU Remote Control
 * 
 * Version 0.9
 * 10.08.2025
 */

let ALLTERCO_DEVICE_NAME_PREFIX = ["SBBT", "SBDW", "SBMO", "SBHT", "SBRC", "SBDI"];
