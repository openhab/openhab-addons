...
public class ShellyChannelMigration {
    ...
    private static List<ChannelMigrationRule> buildChannelMigrationRules() {
        List<ChannelMigrationRule> rules = new ArrayList<>(List.of(
                ...
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_COLOR_CONTROL, CHANNEL_COLOR_PICKER), null, true),
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_COLOR_CONTROL, CHANNEL_COLOR_FULL), null, true),
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_COLOR_CONTROL, CHANNEL_COLOR_RED), null, true),
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_COLOR_CONTROL, CHANNEL_COLOR_GREEN), null, true),
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_COLOR_CONTROL, CHANNEL_COLOR_BLUE), null, true),
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_COLOR_CONTROL, CHANNEL_COLOR_WHITE), null, true),
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_COLOR_CONTROL, CHANNEL_COLOR_GAIN), null, true),

                // PR #21286: white group: refresh/promote brightness, refresh temperature, add temperature-pct
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_WHITE_CONTROL, CHANNEL_BRIGHTNESS), null, true),
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_WHITE_CONTROL, CHANNEL_COLOR_TEMP), CHANNEL_COLOR_TEMP_PCT, true),
                
                // PR #21286: control group: promote secondary channels to advanced
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_LIGHT_CONTROL, CHANNEL_LIGHT_COLOR_MODE), null, true),
                new ChannelMigrationRule(7, mkChannelId(CHANNEL_GROUP_LIGHT_CONTROL, CHANNEL_LIGHT_POWER), null, true)
                // @formatter:on
        ));
        for (int i = 1; i <= 4; i++) {
    ...
    private static List<ChannelMigrationRule> lightGroupMigrationRules(int index) {
        ...
        return List.of(
                ...
                // @formatter:off
                // PR #21286: white group: refresh/promote brightness, refresh temperature, add temperature-pct
                new ChannelMigrationRule(7, mkChannelId(newGroup, CHANNEL_BRIGHTNESS), null, true),
                new ChannelMigrationRule(7, mkChannelId(newGroup, CHANNEL_COLOR_TEMP), mkChannelId(newGroup, CHANNEL_COLOR_TEMP_PCT), true)
                // @formatter:on
        );
    }
