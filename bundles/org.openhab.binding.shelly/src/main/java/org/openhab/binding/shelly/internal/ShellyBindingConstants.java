...
public class ShellyBindingConstants {
    ...
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.unmodifiableSet(Stream.of(
            ...
            THING_TYPE_SHELLYPRO1, THING_TYPE_SHELLYPRO1PM, THING_TYPE_SHELLYPRO2_RELAY, THING_TYPE_SHELLYPRO2PM_RELAY,
            THING_TYPE_SHELLYPRO2PM_ROLLER, THING_TYPE_SHELLYPRO3, THING_TYPE_SHELLYPRO4PM, THING_TYPE_SHELLYPLUSI4,
            THING_TYPE_SHELLYPLUSI4DC, THING_TYPE_SHELLYPLUSHT, THING_TYPE_SHELLYPLUSPLUGUS, THING_TYPE_SHELLYPROTECTED,
