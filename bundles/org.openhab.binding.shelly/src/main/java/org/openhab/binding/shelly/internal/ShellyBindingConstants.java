...
public class ShellyBindingConstants {
    ...
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES = Set.of(THING_TYPE_SHELLY1, THING_TYPE_SHELLY1L,
            ...
            // Shelly Plus
            THING_TYPE_SHELLYPLUS1, THING_TYPE_SHELLYPLUS1PM, THING_TYPE_SHELLYPLUS1L, THING_TYPE_SHELLYPLUS2PM_RELAY,
            THING_TYPE_SHELLYPLUS2PM_ROLLER, THING_TYPE_SHELLYPLUS2L, THING_TYPE_SHELLYPLUSSHUTTER,
            THING_TYPE_SHELLYPLUSI4, THING_TYPE_SHELLYPLUSI4DC, THING_TYPE_SHELLYPLUSDIMMER10V,
            THING_TYPE_SHELLYPLUSUNI, THING_TYPE_SHELLYPLUSHT, THING_TYPE_SHELLYPLUSHTG3, THING_TYPE_SHELLYPLUSSMOKE,
            THING_TYPE_SHELLYPLUSPLUGS, THING_TYPE_SHELLYPLUSPLUGUS, THING_TYPE_SHELLYPLUSDIMMERUS,
            THING_TYPE_SHELLYPLUSRGBWPM, THING_TYPE_SHELLYPLUSEM, THING_TYPE_SHELLYPLUS3EM63,
