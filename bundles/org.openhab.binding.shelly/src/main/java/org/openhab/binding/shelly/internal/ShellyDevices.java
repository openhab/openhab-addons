...
public class ShellyDevices {
    ...
    // Thing type classes to group set of devices
    public static final Map<String, ThingTypeUID> THING_TYPE_CLASS_RELAYBY_DEVICE_TYPE = Map.ofEntries(
            // Plus Series
    ...
    public static final Set<ThingTypeUID> THING_TYPE_CLASS_BLU_SENSOR = Set.of(THING_TYPE_SHELLYBLUBUTTON,
    ...
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES = Set.of(THING_TYPE_SHELLY1, THING_TYPE_SHELLY1L,
            ...
            THING_TYPE_SHELLYPRO4PM, THING_TYPE_SHELLYPRO3EM, THING_TYPE_SHELLYPROEM50, THING_TYPE_SHELLYPRO3EM63,
            THING_TYPE_SHELLYPRO3EM400,
