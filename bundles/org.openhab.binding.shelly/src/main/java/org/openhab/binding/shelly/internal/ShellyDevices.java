...
public class ShellyDevices {
    ...
    public static final Map<String, ThingTypeUID> THING_TYPE_BY_DEVICE_TYPE = Map.ofEntries(
            ...
            Map.entry(SHELLYDT_PLUS2L, THING_TYPE_SHELLYPLUS2L), Map.entry(SHELLYDT_PLUS2LG4, THING_TYPE_SHELLYPLUS2L),
    ...
    public static final Map<String, ThingTypeUID> THING_TYPE_BY_SERVICE_NAME = Map.ofEntries(
            ...
            Map.entry("shellyplus1lg4", THING_TYPE_SHELLYPLUS1L), //
            ...
            Map.entry("shellyplus2lg4", THING_TYPE_SHELLYPLUS2L), //
