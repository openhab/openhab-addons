...
public class ShellyDevices {
    ...
    public static final String SHELLYDT_PLUSPLUGM_G3 = "S3PL-30110EU"; // Shelly Plug M Gen 3
    ...
    public static final ThingTypeUID THING_TYPE_SHELLYPLUSPLUGM = new ThingTypeUID(BINDING_ID, "shellyplusplug");
    ...
    public static final Set<ThingTypeUID> GROUP_BUTTON_THING_TYPES = Set.of( //
            THING_TYPE_SHELLYBUTTON1, THING_TYPE_SHELLYBUTTON2, THING_TYPE_SHELLYBLUBUTTON1);
    ...
    public static final Map<String, ThingTypeUID> THING_TYPE_BY_DEVICE_TYPE = Map.ofEntries(
            ...
            Map.entry(SHELLYDT_PLUSPLUGM_G3, THING_TYPE_SHELLYPLUSPLUGM), // Shelly Plug M G3
    ...
    public static final Map<String, ThingTypeUID> THING_TYPE_BY_SERVICE_NAME = Map.ofEntries(
            ...
            Map.entry("shellyplugmg3", THING_TYPE_SHELLYPLUSPLUGM),
