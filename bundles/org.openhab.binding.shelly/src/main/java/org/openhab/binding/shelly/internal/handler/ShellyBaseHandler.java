...
public abstract class ShellyBaseHandler extends BaseThingHandler
    ...
    protected ShellyDeviceProfile profile; // init empty profile to avoid NPE
    ...
    public void updateProperties(ShellyDeviceProfile profile, ShellySettingsStatus status) {
        ...
        properties.putAll(fillDeviceProperties(profile)); // requires fillDeviceProperties to return Map<String, String>
    ...
    public void flushProperties(Map<String, @Nullable String> propertyUpdates) {
        Map<String, @Nullable String> thingProperties = new HashMap<>(editProperties());
