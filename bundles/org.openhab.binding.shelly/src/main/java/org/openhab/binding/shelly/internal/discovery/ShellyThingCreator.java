...
public class ShellyThingCreator {
    ...
    // Shelly Plus Mini Series
    public static final ThingTypeUID THING_TYPE_SHELLYMINI1 = new ThingTypeUID(BINDING_ID, THING_TYPE_SHELLYMINI_1_STR);
    ...
    static {
        ...
        // Plus Mini Series
        THING_TYPE_MAPPING.put(SHELLYDT_MINI_1, THING_TYPE_SHELLYMINI_1_STR);
        THING_TYPE_MAPPING.put(SHELLYDT_MINIG3_1, THING_TYPE_SHELLYMINI_1_STR);
        THING_TYPE_MAPPING.put(SHELLYDT_MINI_PM, THING_TYPE_SHELLYMINI_PM_STR);
        THING_TYPE_MAPPING.put(SHELLYDT_MINIG3_PM, THING_TYPE_SHELLYMINI_PM_STR);
        THING_TYPE_MAPPING.put(SHELLYDT_MINI_1PM, THING_TYPE_SHELLYMINI_1PM_STR);
        THING_TYPE_MAPPING.put(SHELLYDT_MINIG3_1PM, THING_TYPE_SHELLYMINI_1PM_STR);
        ...
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYMINI_1_STR, THING_TYPE_SHELLYMINI_1_STR);
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYMINI_1G3_STR, THING_TYPE_SHELLYMINI_1_STR);
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYMINI_PM_STR, THING_TYPE_SHELLYMINI_PM_STR);
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYMINI_PMG3_STR, THING_TYPE_SHELLYMINI_PM_STR);
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYMINI_1PM_STR, THING_TYPE_SHELLYMINI_1PM_STR);
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYMINI_1PMG3_STR, THING_TYPE_SHELLYMINI_PM_STR);
