...
public class ShellyThingCreator {
    ...
    // Shelly Plus Mini Series
    public static final ThingTypeUID THING_TYPE_SHELLY1MINI = new ThingTypeUID(BINDING_ID, "shelly1mini");
    public static final ThingTypeUID THING_TYPE_SHELLYPMMINI = new ThingTypeUID(BINDING_ID, "shellypmmini");
    public static final ThingTypeUID THING_TYPE_SHELLY1PMMINI = new ThingTypeUID(BINDING_ID, "shelly1pmmini");
    ...
    private static final Map<String, ThingTypeUID> THING_TYPE_BY_SERVICE_NAME = Map.ofEntries(
            ...
            Map.entry("shelly0110dimg3", THING_TYPE_SHELLYPLUSDIMMER10V),
            Map.entry("shellyplusrgbwpm", THING_TYPE_SHELLYPLUSRGBWPM),
            Map.entry("shellywalldisplay", THING_TYPE_SHELLYPLUSWALLDISPLAY),

            // Shelly Plus Mini Series
            Map.entry("shelly1mini", THING_TYPE_SHELLY1MINI), //
            Map.entry("shelly1minig3", THING_TYPE_SHELLY1MINI), //
            Map.entry("shelly1minig4", THING_TYPE_SHELLY1MINI), //
            Map.entry("shellypmmini", THING_TYPE_SHELLYPMMINI), //
            Map.entry("shellypmminig3", THING_TYPE_SHELLYPMMINI), //
            Map.entry("shellypmminig4", THING_TYPE_SHELLYPMMINI), //
            Map.entry("shelly1pmmini", THING_TYPE_SHELLY1PMMINI),
