...
public class ShellyThingCreator {
    ...
    public static final String THING_TYPE_SHELLYMINIPMG3_STR = "shellypmminig3";
    ...
    static {
        ...
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYMINIPMG3_STR, THING_TYPE_SHELLYMINIPM_STR);
