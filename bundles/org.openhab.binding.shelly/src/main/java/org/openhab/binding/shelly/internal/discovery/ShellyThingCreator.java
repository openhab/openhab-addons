...
public class ShellyThingCreator {
    ...
    // Thing names
    private static final String THING_TYPE_SHELLY1_STR = "shelly1";
    private static final String THING_TYPE_SHELLY1L_STR = "shelly1l";
    private static final String THING_TYPE_SHELLY1PM_STR = "shelly1pm";
    private static final String THING_TYPE_SHELLYEM_STR = "shellyem";
    private static final String THING_TYPE_SHELLY3EM_STR = "shellyem3"; // bad: misspelled product name, it's 3EM
    private static final String THING_TYPE_SHELLY2_PREFIX = "shellyswitch";
    private static final String THING_TYPE_SHELLY2_RELAY_STR = "shelly2-relay";
    private static final String THING_TYPE_SHELLY2_ROLLER_STR = "shelly2-roller";
    private static final String THING_TYPE_SHELLY25_PREFIX = "shellyswitch25";
    private static final String THING_TYPE_SHELLY25_RELAY_STR = "shelly25-relay";
    private static final String THING_TYPE_SHELLY25_ROLLER_STR = "shelly25-roller";
    private static final String THING_TYPE_SHELLY4PRO_STR = "shelly4pro";
    private static final String THING_TYPE_SHELLYPLUG_STR = "shellyplug";
    private static final String THING_TYPE_SHELLYPLUGS_STR = "shellyplugs";
    private static final String THING_TYPE_SHELLYPLUGU1_STR = "shellyplugu1"; // Shelly Plug US
    private static final String THING_TYPE_SHELLYDIMMER_STR = "shellydimmer";
    private static final String THING_TYPE_SHELLYDIMMER2_STR = "shellydimmer2";
    private static final String THING_TYPE_SHELLYIX3_STR = "shellyix3";
    private static final String THING_TYPE_SHELLYBULB_STR = "shellybulb";
    private static final String THING_TYPE_SHELLYDUO_STR = "shellybulbduo";
    private static final String THING_TYPE_SHELLYVINTAGE_STR = "shellyvintage";
    private static final String THING_TYPE_SHELLYRGBW2_PREFIX = "shellyrgbw2";
    private static final String THING_TYPE_SHELLYRGBW2_COLOR_STR = THING_TYPE_SHELLYRGBW2_PREFIX + "-color";
    private static final String THING_TYPE_SHELLYRGBW2_WHITE_STR = THING_TYPE_SHELLYRGBW2_PREFIX + "-white";
    private static final String THING_TYPE_SHELLYDUORGBW_STR = "shellycolorbulb";
    private static final String THING_TYPE_SHELLYHT_STR = "shellyht";
    private static final String THING_TYPE_SHELLYSMOKE_STR = "shellysmoke";
    private static final String THING_TYPE_SHELLYGAS_STR = "shellygas";
    private static final String THING_TYPE_SHELLYFLOOD_STR = "shellyflood";
    private static final String THING_TYPE_SHELLYDOORWIN_STR = "shellydw";
    private static final String THING_TYPE_SHELLYDOORWIN2_STR = "shellydw2";
    private static final String THING_TYPE_SHELLYEYE_STR = "shellyseye";
    private static final String THING_TYPE_SHELLYSENSE_STR = "shellysense";
    private static final String THING_TYPE_SHELLYTRV_STR = "shellytrv";
    private static final String THING_TYPE_SHELLYMOTION_STR = "shellymotion";
    private static final String THING_TYPE_SHELLYMOTION2_STR = "shellymotion2";
    private static final String THING_TYPE_SHELLYBUTTON1_STR = "shellybutton1";
    private static final String THING_TYPE_SHELLYBUTTON2_STR = "shellybutton2";
    private static final String THING_TYPE_SHELLYUNI_STR = "shellyuni";

    // Shelly Plus Series
    private static final String THING_TYPE_SHELLYPLUS1_STR = "shellyplus1";
    private static final String THING_TYPE_SHELLYPLUS1G3_STR = "shelly1g3";
    private static final String THING_TYPE_SHELLYPLUS1G4_STR = "shelly1g4";
    private static final String THING_TYPE_SHELLYPLUS1PM_STR = "shellyplus1pm";
    private static final String THING_TYPE_SHELLYPLUS1PMG3_STR = "shelly1pmg3";
    private static final String THING_TYPE_SHELLYPLUS1PMG4_STR = "shelly1pmg4";
    private static final String THING_TYPE_SHELLYPLUS2PM_RELAY_STR = "shellyplus2pm-relay";
    private static final String THING_TYPE_SHELLYPLUS2PM_ROLLER_STR = "shellyplus2pm-roller";
    private static final String THING_TYPE_SHELLYPLUSI4_STR = "shellyplusi4";
    private static final String THING_TYPE_SHELLYPLUSI4G3_STR = "shellyi4g3";
    private static final String THING_TYPE_SHELLYPLUSI4DC_STR = "shellyplusi4dc";
    private static final String THING_TYPE_SHELLYPLUSHT_STR = "shellyplusht";
    private static final String THING_TYPE_SHELLYPLUSHTG3_STR = "shellyhtg3";
    private static final String THING_TYPE_SHELLYPLUSSMOKE_STR = "shellyplussmoke";
    private static final String THING_TYPE_SHELLYPLUSUNI_STR = "shellyplusuni";
    private static final String THING_TYPE_SHELLYPLUSPLUGS_STR = "shellyplusplug";
    private static final String SVC_TYPE_SHELLYPLUSPLUGUS_STR = "shellyplugus";
    private static final String THING_TYPE_SHELLYPLUSPLUGUS_STR = "shellyplusplugus";
    private static final String THING_TYPE_SHELLYPLUSDIMMERUS_STR = "shellypluswdus";
    private static final String THING_TYPE_SHELLYPLUSDIMMER10V_STR = "shellyplus10v";
    private static final String THING_TYPE_SHELLYPLUSDIMMER0110VG3_STR = "shelly0110dimg3";
    private static final String THING_TYPE_SHELLYPLUSRGBWPM_STR = "shellyplusrgbwpm";
    private static final String THING_TYPE_SHELLYPLUSSTRIP_STR = "shellyplusstrip";

    // Shelly Wall Display
    private static final String THING_TYPE_SHELLYPLUSWALLDISPLAY_STR = "shellywalldisplay";

    // Shelly Plus Mini Series
    private static final String THING_TYPE_SHELLYMINI_1_STR = "shelly1mini";
    private static final String THING_TYPE_SHELLYMINI_1G3_STR = "shelly1minig3";
    private static final String THING_TYPE_SHELLYMINI_1G4_STR = "shelly1minig4";
    private static final String THING_TYPE_SHELLYMINI_PM_STR = "shellypmmini";
    private static final String THING_TYPE_SHELLYMINI_PMG3_STR = "shellypmminig3";
    private static final String THING_TYPE_SHELLYMINI_PMG4_STR = "shellypmminig4";
    private static final String THING_TYPE_SHELLYMINI_EM_STR = "shellyemmini"; // G4 device was renamed to EM
    private static final String THING_TYPE_SHELLYMINI_1PM_STR = "shelly1pmmini";
    private static final String THING_TYPE_SHELLYMINI_1PMG3_STR = "shelly1pmminig3";
    private static final String THING_TYPE_SHELLYMINI_1PMG4_STR = "shelly1pmminig4";

    // Shelly Pro Series
    private static final String THING_TYPE_SHELLYPRO1_STR = "shellypro1";
    private static final String THING_TYPE_SHELLYPRO1PM_STR = "shellypro1pm";
    private static final String THING_TYPE_SHELLYPRO1CB_STR = "shellypro1cb";
    private static final String THING_TYPE_SHELLYPRO2_STR = "shellypro2";
    private static final String THING_TYPE_SHELLYPRO2PM_RELAY_STR = "shellypro2pm-relay";
    private static final String THING_TYPE_SHELLYPRO2PM_ROLLER_STR = "shellypro2pm-roller";
    private static final String THING_TYPE_SHELLYPRO3_STR = "shellypro3";
    private static final String THING_TYPE_SHELLYPRO3EM_STR = "shellypro3em";
    private static final String THING_TYPE_SHELLYPROEM50_STR = "shellyproem50";
    private static final String THING_TYPE_SHELLYPRO4PM_STR = "shellypro4pm";

    // Shelly BLU Series
    public static final String THING_TYPE_SHELLYBLU_PREFIX = "shellyblu";
    private static final String THING_TYPE_SHELLYBLUBUTTON_STR = THING_TYPE_SHELLYBLU_PREFIX + "button";
    private static final String THING_TYPE_SHELLYBLUDW_STR = THING_TYPE_SHELLYBLU_PREFIX + "dw";
    private static final String THING_TYPE_SHELLYBLUMOTION_STR = THING_TYPE_SHELLYBLU_PREFIX + "motion";
    private static final String THING_TYPE_SHELLYBLUHT_STR = THING_TYPE_SHELLYBLU_PREFIX + "ht";
    private static final String THING_TYPE_SHELLYBLUGW_STR = THING_TYPE_SHELLYBLU_PREFIX + "gw";
    private static final String THING_TYPE_SHELLYBLUGWG3_STR = THING_TYPE_SHELLYBLU_PREFIX + "gwg3";
