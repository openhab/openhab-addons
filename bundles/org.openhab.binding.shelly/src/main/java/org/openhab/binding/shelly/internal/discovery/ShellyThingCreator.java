...
public class ShellyThingCreator {
    ...
    public static final String THING_TYPE_SHELLY1PMINIG4_STR = "shelly1pmminig4";
    ...
    static {
        ...
        THING_TYPE_MAPPING.put(SHELLYDT_MINIG4_EM, THING_TYPE_SHELLYEMMINI_STR);
        ...
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLY1PMINIG4_STR, THING_TYPE_SHELLY1PMMINI_STR);
        ...
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYEMMINI_STR, THING_TYPE_SHELLYEMMINI_STR);
