...
public class ShellyThingCreator {
    ...
    static {
        ...
        THING_TYPE_MAPPING.put(SHELLYDT_PRODIMMER1PM, THING_TYPE_SHELLYPRODIMMER1PM_STR);
        THING_TYPE_MAPPING.put(SHELLYDT_PRODIMMER2PM, THING_TYPE_SHELLYPRODIMMER2PM_STR);
