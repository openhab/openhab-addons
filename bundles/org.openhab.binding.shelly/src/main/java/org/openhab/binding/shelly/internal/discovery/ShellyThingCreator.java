...
public class ShellyThingCreator {
    ...
    public static final ThingTypeUID THING_TYPE_SHELLYPLUSDIMMERG3 = new ThingTypeUID(BINDING_ID,
            THING_TYPE_SHELLYPLUSDIMMERG3_STR);
    ...
    static {
        ...
        THING_TYPE_MAPPING.put(SHELLYDT_PLUSDIMMERG3, THING_TYPE_SHELLYPLUSDIMMERG3_STR);
        ...
        THING_TYPE_MAPPING.put(THING_TYPE_SHELLYPLUSDIMMERG3_STR, THING_TYPE_SHELLYPLUSDIMMERG3_STR);
