...
public class ShellyThingCreator {
    ...
    // Shelly Plus Mini Series
    private static final String THING_TYPE_SHELLY1MINI_STR = "shelly1mini";
    private static final String THING_TYPE_SHELLYMINI1G3_STR = "shelly1minig3";
    private static final String THING_TYPE_SHELLYMINI1G4_STR = "shelly1minig4";
    private static final String THING_TYPE_SHELLYPMMINI_STR = "shellypmmini";
    private static final String THING_TYPE_SHELLYPMMINIG3_STR = "shellypmminig3";
    private static final String THING_TYPE_SHELLYPMMINIG4_STR = "shellypmminig4";
    private static final String THING_TYPE_SHELLY1PMMINI_STR = "shelly1pmmini";
    ...
    // Shelly BLU Series
    private static final String THING_TYPE_SHELLYBLU_PREFIX = "shellyblu";
