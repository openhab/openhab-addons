...
import org.openhab.binding.midea.internal.MideaConfiguration;
import org.openhab.binding.midea.internal.cloud.Cloud;
import org.openhab.binding.midea.internal.cloud.CloudProvider;
import org.openhab.binding.midea.internal.connection.ConnectionManager;
import org.openhab.binding.midea.internal.discovery.DiscoveryHandler;
import org.openhab.binding.midea.internal.discovery.MideaDiscoveryService;
import org.openhab.binding.midea.internal.security.TokenKey;
...
public abstract class AbstractMideaHandler extends BaseThingHandler implements DiscoveryHandler {
    ...
    protected MideaConfiguration config = new MideaConfiguration();
    protected Map<String, String> properties = new HashMap<>();
    // Default parameters are the same as in the MideaConfiguration class
    ...
    public void initialize() {
        config = getConfigAs(MideaConfiguration.class);
    ...
    private boolean ensureConfigOrStartDiscovery() {
        ...
        MideaDiscoveryService discoveryService = new MideaDiscoveryService();
    ...
    private void initConnectionManagerFromConfig() {
        connectionManager = new org.openhab.binding.midea.internal.connection.ConnectionManager(config.ipAddress,
