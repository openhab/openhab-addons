...
/**
 * The {@link MideaDiscoveryServiceTest} tests the discovery byte arrays
 * (reply string already decrypted - See SecurityTest)
 * against the methods in the MideaDiscoveryService for correctness
 *
 * @author Robert Eckhoff - Initial contribution
 */
@NonNullByDefault
public class MideaDiscoveryServiceTest {
