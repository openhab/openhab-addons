...
```java
Thing midea:ac:air_conditioner "myAC" @ "Room" [ ipAddress="192.168.1.200", ipPort=6444, deviceId="deviceId", cloud="your cloud (e.g NetHome Plus)", email="yourclouduser@email.com", password="yourcloudpassword", token="token", key ="key", pollingTime = 60, keyTokenUpdate = 0, energyPoll = 0, timeout=4, promptTone="false", version="3", energyDecode="true", deviceType="ac"] 
Thing midea:a1:dehumidifier "myDehumidifier" @ "Room" [ ipAddress="192.168.1.200", ipPort=6444, deviceId="deviceId", cloud="your cloud (e.g NetHome Plus)", email="yourclouduser@email.com", password="yourcloudpassword", token="token", key ="key", pollingTime = 60, keyTokenUpdate = 0, energyPoll = 0, timeout=4, promptTone="false", version="3", deviceType="a1"] 
```

Minimal IP Address Option to use the built-in defaults.

```java
Thing midea:ac:air_conditioner "myAC" @ "myRoom" [ ipAddress="192.168.0.200"] or
Thing midea:a1:dehumidifier "myDehumidifier" @ "myRoom" [ ipAddress="192.168.0.200"]
```

### `demo.items` AC Example

```java
Switch power "Power"                                                        { channel="midea:ac:air_conditioner:power" }
Number:Temperature target_temperature "Target Temperature [%.1f °F]"        { channel="midea:ac:air_conditioner:target-temperature" }
String operational_mode "Operational Mode"                                  { channel="midea:ac:air_conditioner:operational-mode" }
String fan_speed "Fan Speed"                                                { channel="midea:ac:air_conditioner:fan-speed" }
String swing_mode "Swing Mode"                                              { channel="midea:ac:air_conditioner:dehumidifier-swing" }
Number:Temperature indoor_temperature "Indoor Temperature [%.1f °F]"        { channel="midea:ac:air_conditioner:indoor-temperature" }
Switch eco_mode "Eco Mode"                                                  { channel="midea:ac:air_conditioner:eco-mode" }
Switch turbo_mode "Turbo Mode"                                              { channel="midea:ac:air_conditioner:turbo-mode" }
Switch sleep_function "Sleep function"                                      { channel="midea:ac:air_conditioner:sleep-function" }
Switch temperature_unit "Fahrenheit or Celsius"                             { channel="midea:ac:air_conditioner:temperature-unit" }
```

### `demo.items` Dehumidifier Example

```java
Switch power "Power"                                                        { channel="midea:a1:dehumidifier:power" }
Number maximum-humidity "Maximim Humidity"                                  { channel="midea:a1:dehumidifier:maximum-humidity" }
String dehumidifier-mode "Dehumidifier Mode"                                { channel="midea:a1:dehumidifier:dehumidifier-mode" }
String dh-fan-speed "Dehumidifier Fan Speed"                                { channel="midea:a1:dehumidifier:dh-fan-speed" }
String dehumidifier-swing "Dehumidifier Swing Mode"                         { channel="midea:a1:dehumidifier:dehumidifier-swing" }
Number:Temperature indoor-temperature "Indoor Temperature [%.1f °F]"        { channel="midea:a1:dehumidifier:indoor-temperature" }
Number humidity "Humidity in Room"                                          { channel="midea:a1:dehumidifier:humidity" }
```
