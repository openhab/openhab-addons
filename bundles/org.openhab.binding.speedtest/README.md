...
Number:DataTransferRate   Speedtest_Download_Bandwidth     "Download Bandwith"     { channel="speedtest:speedtest:myspeedtest:downloadBandwidth" }
...
Number:DataTransferRate   Speedtest_Upload_Bandwidth       "Upload Bandwith"       { channel="speedtest:speedtest:myspeedtest:uploadBandwidth" }
