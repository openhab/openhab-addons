...
/**
 * The {@link AnkerSolixHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
...
public class AnkerSolixHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_SMART_PLUG.equals(thingTypeUID)) {
            return new AnkerSolixSmartPlugHandler(thing);
        }
        if (THING_TYPE_EV_CHARGER.equals(thingTypeUID)) {
            return new AnkerSolixWallboxHandler(thing);
        }
