...
public abstract class RouterosInterfaceBase {
    ...
    public String getType(){ return propMap.get("type"); }
    public String getName(){ return propMap.get("name"); }
    public String getComment(){ return propMap.get("comment"); }
    public String getMacAddress(){ return propMap.get("mac-address"); }
    public boolean isEnabled(){ return propMap.get("disabled").equals("false"); }
    public boolean isConnected(){ return propMap.get("running").equals("true"); }

    public int getLinkDowns(){ return Integer.parseInt(propMap.get("link-downs")); }
    public DateTime getLastLinkDownTime(){ return Converter.fromRouterosTime(propMap.get("last-link-down-time")); }
    public DateTime getLastLinkUpTime(){ return Converter.fromRouterosTime(propMap.get("last-link-up-time")); }
    ...
    public BigInteger getTxDrops(){ return new BigInteger(propMap.get("tx-drop")); }
    public BigInteger getRxDrops(){ return new BigInteger(propMap.get("rx-drop")); }
    public BigInteger getTxErrors(){ return new BigInteger(propMap.get("tx-error")); }
    public BigInteger getRxErrors(){ return new BigInteger(propMap.get("rx-error")); }
