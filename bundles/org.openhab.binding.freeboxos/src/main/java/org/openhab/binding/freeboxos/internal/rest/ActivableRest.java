...
/**
 * The {@link ActivableRest} is the Java class used to handle portions of the Api that accept to get and set
 * configuration
 *
 * @author Gaël L'hopital - Initial contribution
 */
@NonNullByDefault
public class ActivableRest<T extends ActivableConfigIntf, Y extends Response<T>> extends ConfigurableRest<T, Y> {
