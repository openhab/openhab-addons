...
import org.openhab.binding.freeboxos.internal.api.system.SystemModelInfo;
 ...
 */
@NonNullByDefault
public class PlayerSystemConfiguration {
    ...
    public @Nullable SystemModelInfo getModelInfo() {
        return modelInfo;
    }
