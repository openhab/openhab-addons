...
public class DanfossAirUnit {
    ...
    private short getWord(Parameter parameter) throws IOException {
        byte[] resultBytes = communicationController.sendRobustRequest(parameter);
    ...
    private ZonedDateTime getTimestamp(Parameter parameter) throws IOException, UnexpectedResponseValueException {
        byte[] result = communicationController.sendRobustRequest(parameter);
    ...
    public QuantityType<Frequency> getSupplyFanSpeed() throws IOException {
        return new QuantityType<>(BigDecimal.valueOf(getWord(Parameter.SUPPLY_FAN_SPEED)), Units.RPM);
    }

    public QuantityType<Frequency> getExtractFanSpeed() throws IOException {
        return new QuantityType<>(BigDecimal.valueOf(getWord(Parameter.EXTRACT_FAN_SPEED)), Units.RPM);
    }
    ...
    public DateTimeType getCurrentTime() throws IOException, UnexpectedResponseValueException {
        ZonedDateTime timestamp = getTimestamp(Parameter.CURRENT_TIME);
