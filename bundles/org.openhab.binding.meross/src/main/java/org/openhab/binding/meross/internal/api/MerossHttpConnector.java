...
public class MerossHttpConnector {
    ...
    /**
     * @param deviceFile The credentials' file to be written once devices are fetched from cloud
     */
    ...
    public @Nullable CloudCredentials readCredentials() throws IOException {
        ...
        try {
            CloudCredentials cloudCredentials = new Gson().fromJson(readFile(file), CloudCredentials.class);
    ...
    public @Nullable ArrayList<Device> readDevices() throws IOException {
        ...
        try {
            ArrayList<Device> devices = new Gson().fromJson(readFile(file), type);
            return devices;
        } catch (JsonSyntaxException e) {
            throw new IOException();
