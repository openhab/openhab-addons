...
public class MerossBindingConstants {
    ...
    static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Set.of(THING_TYPE_BRIDGE, THING_TYPE_LIGHT);
    ...
    public static final Set<String> DISCOVERABLE_LIGHT_HARDWARE_TYPES = Stream.of("msl", "mss")
