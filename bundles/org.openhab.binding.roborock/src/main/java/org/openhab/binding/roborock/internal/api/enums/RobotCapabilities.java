...
public enum RobotCapabilities {
    ...
    SEGMENT_STATUS("", "status#segment-status", "roborock:segment-status", "get_segment_status"),
    MAP_STATUS("", "status#map-status", "roborock:map-status", "get_map_status"),
    LED_STATUS("", "status#led-status", "roborock:led-status", "get_led_status"),
    CARPET_MODE("", "info#carpet-mode", "roborock:carpet-mode", "get_carpet_mode"),
    FW_FEATURES("", "info#fw-features", "roborock:fw-features", "get_fw_features"),
    ROOM_MAPPING("", "info#room-mapping", "roborock:room-mapping", "get_room_mapping"),
    MULTI_MAP_LIST("", "info#multi-maps-list", "roborock:multi-maps-list", "get_multi_maps_list"),
    CUSTOMIZE_CLEAN_MODE("", "info#customize-clean-mode", "roborock:customize-clean-mode", "get_customize_clean_mode"),
