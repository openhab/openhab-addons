...
class SyslogParserTest {
    ...
    void testParseStandardDhcpAck() {
        ...
        SyslogEvent event = parser.parseLine(line, null);
    ...
    void testDevicePatternTakesPriority() {
        ...
        SyslogEvent event = parser.parseLine(line, owrtPattern);
        assertThat(event, is(notNullValue()));
        event = Objects.requireNonNull(event);
    ...
    void testEmptyLineReturnsNull() {
        SyslogEvent event = parser.parseLine("", null);
        assertThat(event, is(nullValue()));
    }

    @Test
    void testUnparseableLineReturnsNull() {
        SyslogEvent event = parser.parseLine("this is not a syslog line", null);
        assertThat(event, is(nullValue()));
    }
