 ...
 * <LI>{@link #runScene} for manipulation of a set of devices behind the bridge which are tied together as
 * scene,</LI>
 * <LI>{@link #setHouseStatusMonitor} for activation or deactivation of the house monitoring mode to be
