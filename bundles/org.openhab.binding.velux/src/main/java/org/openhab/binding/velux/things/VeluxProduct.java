...
public class VeluxProduct {
     ...
     */
    public boolean setState(int newState) { // NO_UCD (use default)
     ...
     */
    public boolean setCurrentPosition(int newCurrentPosition) { // NO_UCD (use default)
     ...
     * @return <b>modified</b> as boolean to signal a real modification.
     */
    public boolean setTarget(int newTarget) { // NO_UCD (use default)
