...
class SCgetLimitation extends GetProductLimitation implements SlipBridgeCommunicationProtocol {
    ...
    public byte[] getRequestDataAsArrayOfBytes() {
        ...
        request.setOneByteValue(26, reqLimitationType);
    ...
    public void setResponse(short responseCommand, byte[] thisResponseData, boolean isSequentialEnforced) {
        ...
        switch (Command.get(responseCommand)) {
            ...
            case GW_LIMITATION_STATUS_NTF:
                ...
                logger.info("setResponse(): nodeId={}.", ntfNodeID);
                logger.info("setResponse(): ntfParameterID={}.", ntfParameterID);
                logger.info("setResponse(): ntfMinValue={}.", ntfMinValue);
                logger.info("setResponse(): ntfMaxValue={}.", ntfMaxValue);
                logger.info("setResponse(): ntfLimitationOriginator={}.", ntfLimitationOriginator);
                logger.info("setResponse(): ntfLimitationTime={}.", ntfLimitationTime);
