...
public class VeluxExistingProducts {
    ...
    public boolean isRegistered(ProductBridgeIndex bridgeProductIndex) { // NO_UCD (use private)
    ...
    public VeluxProduct get(ProductBridgeIndex bridgeProductIndex) { // NO_UCD (use private)
