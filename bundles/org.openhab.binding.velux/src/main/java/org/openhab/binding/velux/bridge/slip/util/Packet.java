...
public class Packet {
     ...
     *         of type int.
     */
    public int length() { // NO_UCD (unused code)
        return data.length;
    }
     ...
     */
    public String toString(String separator) { // NO_UCD (use default)
     ...
     * @param value of type int.
     */
    public void setFourByteValue(int position, int value) { // NO_UCD (unused code)
     ...
     */
    public void setString(int position, String text) { // NO_UCD (unused code)
    ...
    static int byteArrayToInt(byte[] data) { // NO_UCD (unused code)
