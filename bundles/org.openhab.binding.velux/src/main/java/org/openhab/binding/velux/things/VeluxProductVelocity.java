...
public enum VeluxProductVelocity {
    ...
    public static VeluxProductVelocity get(int velocity) { // NO_UCD (unused code)
        return LOOKUPTYPEID2ENUM.getOrDefault(velocity, VeluxProductVelocity.UNDEFTYPE);
    }

    public static VeluxProductVelocity getByName(String velocityName) { // NO_UCD (unused code)
    ...
    public static String dump() { // NO_UCD (unused code)
