...
public enum VeluxItemType {
    ...
    ROLLERSHUTTER_TILT_POSITION(VeluxBindingConstants.THING_TYPE_VELUX_ROLLERSHUTTER,VeluxBindingConstants.CHANNEL_VANE_POSITION,    TypeFlavor.MANIPULATOR_SHUTTER),
    //
