 ...
 */
@NonNullByDefault
abstract class VeluxChannelHandler {
     ...
     */
    static @Nullable State handleRefresh(ChannelUID channelUID, String channelId, // NO_UCD (unused code)
     ...
     * @return newValue ...
     */
    static @Nullable Command handleCommand(ChannelUID channelUID, String channelId, Command command, // NO_UCD (unused
                                                                                                     // code)
            VeluxBridgeHandler thisBridgeHandler) {
        throw new IllegalStateException("handleRefresh hasn't been set up in the subclass");
    }
