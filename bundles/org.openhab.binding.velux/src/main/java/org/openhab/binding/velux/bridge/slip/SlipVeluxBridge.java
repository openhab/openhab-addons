...
import org.openhab.binding.velux.bridge.slip.io.Connection;
 ...
 * {@link org.openhab.binding.velux.bridge.slip.SlipBridgeAPI SlipBridgeAPI}.</LI>
 * </UL>
 *
...
public class SlipVeluxBridge extends VeluxBridge {
    ...
    private synchronized boolean bridgeDirectCommunicate(SlipBridgeCommunicationProtocol communication,
        ...
        logger.debug("bridgeDirectCommunicate({},{}authenticated) called.", commandString,
                useAuthentication ? "" : "un");
                ...
                switch (Command.get(responseCommand)) {
                    ...
                    case GW_SESSION_FINISHED_NTF:
                        if (!isSequentialEnforced) {
                            logger.trace("bridgeDirectCommunicate(): response ignored due to activated parallelism.");
                            logger.trace("bridgeDirectCommunicate(): continue with receiving.");
                            continue;
                        }
