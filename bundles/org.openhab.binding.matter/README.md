...
| valve-duration                                                      | Number:Time              | Valve Open Duration          | The default duration the valve remains open before automatically closing. Set to 0 to remain open until closed.                                                                                                                                                      | Time             |          | %d %unit%   |                                                                                                                                                                      |
| valve-remaining-duration                                            | Number:Time              | Valve Remaining Duration     | The remaining time until the valve automatically closes                                                                                                                                                                                                              | Time             | true     | %d %unit%   |                                                                                                                                                                      |
