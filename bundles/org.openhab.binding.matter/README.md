...
| carbondioxideconcentrationmeasurement-measuredvalue         | Number:Dimensionless     | CO2 Concentration            | The measured carbon dioxide concentration in parts per million                                                                                                                                                                                                       | CarbonDioxide    | true     | %.0f ppm    |
| carbonmonoxideconcentrationmeasurement-measuredvalue        | Number:Dimensionless     | CO Concentration             | The measured carbon monoxide concentration in parts per million                                                                                                                                                                                                      | Alarm            | true     | %.0f ppm    |
