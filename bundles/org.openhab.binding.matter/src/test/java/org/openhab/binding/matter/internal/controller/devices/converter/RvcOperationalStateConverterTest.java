...
import org.openhab.binding.matter.internal.client.dto.cluster.gen.OperationalStateCluster.OperationalStateEnum;
...
class RvcOperationalStateConverterTest extends BaseMatterConverterTest {
    ...
    void setUp() {
        super.setUp();
        mockCluster.operationalState = OperationalStateEnum.ERROR;
    ...
    void testInitState() {
        ...
        verify(mockHandler, times(1)).updateState(eq(1), eq("rvcoperationalstate-state"),
                eq(new DecimalType(OperationalStateEnum.ERROR.value)));
    }
}
