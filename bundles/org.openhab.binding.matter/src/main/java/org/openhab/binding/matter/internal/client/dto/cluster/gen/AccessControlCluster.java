...
This field SHOULD be set if resources are adequate for it; otherwise it shall be set to NULL if resources are scarce.
        */
        ...
        public AccessControlEntryChanged(BigInteger adminNodeId, Integer adminPasscodeId, ChangeTypeEnum changeType, AccessControlEntryStruct latestValue, Integer fabricIndex) {
...
This field SHOULD be set if resources are adequate for it; otherwise it shall be set to NULL if resources are scarce.
        */
        ...
        public Integer fabricIndex; // FabricIndex
        public AccessControlExtensionChanged(BigInteger adminNodeId, Integer adminPasscodeId, ChangeTypeEnum changeType, AccessControlExtensionStruct latestValue, Integer fabricIndex) {
            this.adminNodeId = adminNodeId;
            this.adminPasscodeId = adminPasscodeId;
            this.changeType = changeType;
            this.latestValue = latestValue;
    ...
    /**
    * The cluster shall generate a FabricRestrictionReviewUpdate event to indicate completion of a fabric restriction review. Due to the requirement to generate this event within a bound time frame of successful receipt of the ReviewFabricRestrictions command, this event may include additional steps that the client may present to the user in order to help the user locate the user interface for the Managed Device feature.
    */
  ...
  • Invalid URL, due to MTza&#x3D;79 key/value pair in reserved MT-prefixed keys reserved for future use:
    ◦ https://company.domain.example/matter/arl?vid&#x3D;FFF1&amp;pid&#x3D;1234&amp;MTop&#x3D;_&amp;MTza&#x3D;79
        */
        ...
        public Integer fabricIndex; // FabricIndex
        public FabricRestrictionReviewUpdate(BigInteger token, String instruction, String arlRequestFlowUrl, Integer fabricIndex) {
            this.token = token;
...
This list shall NOT be empty.
        */
        ...
        public Integer fabricIndex; // FabricIndex
        public AccessRestrictionEntryStruct(Integer endpoint, Integer cluster, List<AccessRestrictionStruct> restrictions, Integer fabricIndex) {
            this.endpoint = endpoint;
            this.cluster = cluster;
...
This list shall NOT be empty.
        */
        public List<AccessRestrictionStruct> restrictions; // list
        public CommissioningAccessRestrictionEntryStruct(Integer endpoint, Integer cluster, List<AccessRestrictionStruct> restrictions) {
            this.endpoint = endpoint;
            this.cluster = cluster;
            this.restrictions = restrictions;
        }
