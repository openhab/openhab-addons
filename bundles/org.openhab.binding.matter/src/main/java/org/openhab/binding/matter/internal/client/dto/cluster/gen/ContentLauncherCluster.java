    ...
    */
     public class BrandingInformationStruct {
        ...
        */
        ...
        public BrandingInformationStruct(String providerName, StyleInformationStruct background, StyleInformationStruct logo, StyleInformationStruct progressBar, StyleInformationStruct splash, StyleInformationStruct waterMark) {
    ...
    */
     public class PlaybackPreferencesStruct {
        ...
        */
        ...
        public PlaybackPreferencesStruct(BigInteger playbackPosition, TrackPreferenceStruct textTrack, List<TrackPreferenceStruct> audioTracks) {
...
If the track is an audio track, this field MUST be present. A value of null shall indicate that the server can choose the audio output(s) to play the Audio Track on.
        */
        ...
        public TrackPreferenceStruct(String languageCode, List<MediaPlaybackCluster.CharacteristicEnum> characteristics, Integer audioOutputIndex) {
    ...
    public static class FeatureMap {
        ...
        */
        ...
        public FeatureMap(boolean contentSearch, boolean urlPlayback, boolean advancedSeek, boolean textTracks, boolean audioTracks){
    ...
    */
    public static ClusterCommand launchContent(ContentSearchStruct search, Boolean autoPlay, String data, PlaybackPreferencesStruct playbackPreferences, Boolean useCurrentContext) {
...
This command returns a Launch Response.
    */
    public static ClusterCommand launchUrl(String contentUrl, String displayString, BrandingInformationStruct brandingInformation, PlaybackPreferencesStruct playbackPreferences) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (contentUrl != null) {
