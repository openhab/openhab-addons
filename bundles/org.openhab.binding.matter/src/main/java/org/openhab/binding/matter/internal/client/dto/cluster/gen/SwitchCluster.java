...
CurrentPosition value 0 shall be assigned to the default position of the switch: for example the &quot;open&quot; state of a rocker switch, or the &quot;idle&quot; state of a push button switch.
    */
    ...
    /**
    * Indicates how many consecutive presses can be detected and reported by a momentary switch which supports multi-press (MSM feature flag set).
    ...
    */
    ...
    public static class FeatureMap {
        ...
        */
        ...
        /**
        * ActionSwitch
        * This feature flag indicates simplified handling of events for multi-press-capable switches. See Multi Press Details.
        */
        public boolean actionSwitch;
        public FeatureMap(boolean latchingSwitch, boolean momentarySwitch, boolean momentarySwitchRelease, boolean momentarySwitchLongPress, boolean momentarySwitchMultiPress, boolean actionSwitch){
