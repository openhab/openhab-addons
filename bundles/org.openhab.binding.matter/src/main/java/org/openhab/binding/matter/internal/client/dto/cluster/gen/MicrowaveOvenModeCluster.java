 ...
 */
public class MicrowaveOvenModeCluster extends ModeBaseCluster {

    public static final int CLUSTER_ID = 0x005E;
    public static final String CLUSTER_NAME = "MicrowaveOvenMode";
    public static final String CLUSTER_PREFIX = "microwaveOvenMode";
    ...
    protected MicrowaveOvenModeCluster(BigInteger nodeId, int endpointId, int clusterId, String clusterName) {
