 ...
 */
public class Pm10ConcentrationMeasurementCluster extends ConcentrationMeasurementCluster {
    ...
    protected Pm10ConcentrationMeasurementCluster(BigInteger nodeId, int endpointId, int clusterId,
            String clusterName) {
