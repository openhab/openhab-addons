 ...
 */
public class RefrigeratorAndTemperatureControlledCabinetModeCluster extends ModeBaseCluster {
    ...
    public static final String CLUSTER_PREFIX = "refrigeratorAndTemperatureControlledCabinetMode";
    ...
    protected RefrigeratorAndTemperatureControlledCabinetModeCluster(BigInteger nodeId, int endpointId, int clusterId,
            String clusterName) {
