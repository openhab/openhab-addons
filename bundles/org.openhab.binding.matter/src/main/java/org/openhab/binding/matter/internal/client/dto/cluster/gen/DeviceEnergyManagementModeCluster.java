 ...
 */
public class DeviceEnergyManagementModeCluster extends ModeBaseCluster {
    ...
    protected DeviceEnergyManagementModeCluster(BigInteger nodeId, int endpointId, int clusterId, String clusterName) {
