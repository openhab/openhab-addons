...
public class DeviceEnergyManagementModeCluster extends BaseCluster {
    ...
    public static final String CLUSTER_PREFIX = "deviceEnergyManagementMode";
     ...
     * field.
     * At least one entry in the SupportedModes attribute shall include the LocalOptimization mode tag in the ModeTags
     * field list.
     * At least one entry in the SupportedModes attribute shall include the GridOptimization mode tag in the ModeTags
     * field list.
