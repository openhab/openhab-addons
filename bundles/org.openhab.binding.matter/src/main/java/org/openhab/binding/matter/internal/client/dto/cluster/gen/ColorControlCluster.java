...
Changes to this attribute shall only be marked as reportable in the following cases:
  ...
  • At the end of the movement/transition.
    */
    ...
    /**
    * Indicates the current saturation value of the light. It is updated as fast as practical during commands that change the saturation.
...
Changes to this attribute shall only be marked as reportable in the following cases:
  ...
  • At the end of the movement/transition.
    */
    ...
    /**
    * Indicates the time remaining, in 1/10ths of a second, until transitions due to the currently active command will be complete.
Changes to this attribute shall only be marked as reportable in the following cases:
...
As this attribute is not being reported during a regular countdown, clients SHOULD NOT rely on the reporting of this attribute in order to keep track of the remaining duration.
    */
    ...
    /**
    * Indicates the current value of the normalized chromaticity value x, as defined in the CIE xyY Color Space. It is updated as fast as practical during commands that change the color.
...
Changes to this attribute shall only be marked as reportable in the following cases:
  ...
  • At the end of the movement/transition.
    */
    ...
    /**
    * Indicates the current value of the normalized chromaticity value y, as defined in the CIE xyY Color Space. It is updated as fast as practical during commands that change the color.
...
Changes to this attribute shall only be marked as reportable in the following cases:
  ...
  • At the end of the movement/transition.
    ...
    */
    ...
    /**
    * Indicates a scaled inverse of the current value of the color temperature. The unit of ColorTemperatureMireds is the mired (micro reciprocal degree), a.k.a. mirek (micro reciprocal kelvin). It is updated as fast as practical during commands that change the color.
Changes to this attribute shall only be marked as reportable in the following cases:
  • At most once per second or
  • At the end of the movement/transition.
...
Command execution shall NOT continue beyond the Options processing if all of these criteria are true:
  ...
  • The value of the ExecuteIfOff bit is 0.
    */
    ...
    /**
    * Indicates the number of color primaries implemented on this device. A value of null shall indicate that the number of primaries is unknown.
...
The value of y shall be related to the Primary1Y attribute by the relationship y &#x3D; Primary1Y / 65536 (Primary1Y in the range 0 to 65279 inclusive)
    */
    ...
    /**
    * Indicates a representation of the maximum intensity of this primary as defined in the Dimming Light Curve in the Ballast Configuration cluster (see Ballast Configuration Cluster), normalized such that the primary with the highest maximum intensity contains the value 254.
...
These attributes shall represent the capabilities of the 2nd, 3rd, 4th, 5th and 6th primaries, where present, in the same way as for the Primary1X, Primary1Y and Primary1Intensity attributes.
    */
    ...
    /**
    * Indicates the normalized chromaticity value x, as defined in the CIE xyY Color Space, of the current white point of the device.
The value of x shall be related to the WhitePointX attribute by the relationship x &#x3D; WhitePointX / 65536 (WhitePointX in the range 0 to 65279 inclusive)
    */
    ...
    /**
    * Indicates the normalized chromaticity value y, as defined in the CIE xyY Color Space, of the current white point of the device.
The value of y shall be related to the WhitePointY attribute by the relationship y &#x3D; WhitePointY / 65536 (WhitePointY in the range 0 to 65279 inclusive)
    */
    ...
    /**
    * Indicates the normalized chromaticity value x, as defined in the CIE xyY Color Space, of the red color point of the device.
The value of x shall be related to the ColorPointRX attribute by the relationship x &#x3D; ColorPointRX / 65536 (ColorPointRX in the range 0 to 65279 inclusive)
    */
    ...
    /**
    * Indicates the normalized chromaticity value y, as defined in the CIE xyY Color Space, of the red color point of the device.
The value of y shall be related to the ColorPointRY attribute by the relationship y &#x3D; ColorPointRY / 65536 (ColorPointRY in the range 0 to 65279 inclusive)
    */
    ...
    /**
    * Indicates a representation of the relative intensity of the red color point as defined in the Dimming Light Curve in the Ballast Configuration cluster (see Ballast Configuration Cluster), normalized such that the color point with the highest relative intensity contains the value 254.
...
To provide compatibility with clients not supporting EHUE, the original ColorMode attribute shall indicate CurrentHue and CurrentSaturation when the light uses the EnhancedCurrentHue attribute. If the ColorMode attribute is changed, its new value shall be copied to the EnhancedColorMode attribute.
    */
    ...
    /**
    * Indicates the current active status of the color loop. If this attribute has the value 0, the color loop shall NOT be active. If this attribute has the value 1, the color loop shall be active.
    */
    public ColorLoopActive colorLoopActive; // 16386 enum16 R V
    /**
    * Indicates the current direction of the color loop. If this attribute has the value 0, the EnhancedCurrentHue attribute shall be decremented. If this attribute has the value 1, the EnhancedCurrentHue attribute shall be incremented.
    */
    public ColorLoopDirectionEnum colorLoopDirection; // 16387 ColorLoopDirectionEnum R V
    /**
    * Indicates the number of seconds it shall take to perform a full color loop, i.e., to cycle all values of the EnhancedCurrentHue attribute (between 0 and 65534).
    */
    ...
    */
    ...
    /**
    * Indicates the value of the EnhancedCurrentHue attribute before the color loop was started. Once the color loop is complete, the EnhancedCurrentHue attribute shall be restored to this value.
    */
...
Bits 0-4 of the ColorCapabilities attribute shall have the same values as the corresponding bits of the FeatureMap attribute. All other bits in ColorCapabilities shall be 0.
    */
    ...
    /**
    * Indicates the minimum mired value supported by the hardware. ColorTempPhysicalMinMireds corresponds to the maximum color temperature in kelvins supported by the hardware.
ColorTempPhysicalMinMireds &lt;&#x3D; ColorTemperatureMireds.
    */
    public Integer colorTempPhysicalMinMireds; // 16395 uint16 R V
    /**
    * Indicates the maximum mired value supported by the hardware. ColorTempPhysicalMaxMireds corresponds to the minimum color temperature in kelvins supported by the hardware.
ColorTemperatureMireds &lt;&#x3D; ColorTempPhysicalMaxMireds.
    */
    public Integer colorTempPhysicalMaxMireds; // 16396 uint16 R V
    /**
    * Indicates a lower bound on the value of the ColorTemperatureMireds attribute for the purposes of coupling the ColorTemperatureMireds attribute to the CurrentLevel attribute when the CoupleColorTempToLevel bit of the Options attribute of the Level Control cluster is equal to 1. When coupling the ColorTemperatureMireds attribute to the CurrentLevel attribute, this value shall correspond to a CurrentLevel value of 254 (100%).
...
Bits 0-4 of the ColorCapabilities attribute shall have the same values as the corresponding bits of the FeatureMap attribute. All other bits in ColorCapabilities shall be 0.
  ...
  • 1 &#x3D; Device shall update the value of the ColorLoopStartEnhancedHue attribute with the value of     the StartHue field.
        */
        ...
        public UpdateFlagsBitmap(boolean updateAction, boolean updateDirection, boolean updateTime, boolean updateStartHue){
    ...
    public static class FeatureMap {
        ...
        */
        public boolean colorTemperature;
        public FeatureMap(boolean hueSaturation, boolean enhancedHue, boolean colorLoop, boolean xy, boolean colorTemperature){
            this.hueSaturation = hueSaturation;
            this.enhancedHue = enhancedHue;
            this.colorLoop = colorLoop;
            this.xy = xy;
    ...
    //commands
    public static ClusterCommand moveToHue(Integer hue, DirectionEnum direction, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
    ...
    public static ClusterCommand moveHue(MoveModeEnum moveMode, Integer rate, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (moveMode != null) {
    ...
    public static ClusterCommand stepHue(StepModeEnum stepMode, Integer stepSize, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (stepMode != null) {
    ...
    public static ClusterCommand moveToSaturation(Integer saturation, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (saturation != null) {
    ...
    public static ClusterCommand moveSaturation(MoveModeEnum moveMode, Integer rate, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (moveMode != null) {
            map.put("moveMode", moveMode);
        }
    ...
    public static ClusterCommand stepSaturation(StepModeEnum stepMode, Integer stepSize, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (stepMode != null) {
            map.put("stepMode", stepMode);
        }
    ...
    public static ClusterCommand moveToHueAndSaturation(Integer hue, Integer saturation, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (hue != null) {
            map.put("hue", hue);
        }
    ...
    public static ClusterCommand moveToColor(Integer colorX, Integer colorY, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (colorX != null) {
    ...
    public static ClusterCommand moveColor(Integer rateX, Integer rateY, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (rateX != null) {
            map.put("rateX", rateX);
        }
    ...
    public static ClusterCommand stepColor(Integer stepX, Integer stepY, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (stepX != null) {
            map.put("stepX", stepX);
        }
    ...
    public static ClusterCommand moveToColorTemperature(Integer colorTemperatureMireds, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    */
    public static ClusterCommand enhancedMoveToHue(Integer enhancedHue, DirectionEnum direction, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (enhancedHue != null) {
    ...
    */
    public static ClusterCommand enhancedMoveHue(MoveModeEnum moveMode, Integer rate, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (moveMode != null) {
            map.put("moveMode", moveMode);
        }
    ...
    */
    public static ClusterCommand enhancedStepHue(StepModeEnum stepMode, Integer stepSize, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (stepMode != null) {
            map.put("stepMode", stepMode);
        }
    ...
    */
    public static ClusterCommand enhancedMoveToHueAndSaturation(Integer enhancedHue, Integer saturation, Integer transitionTime, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (enhancedHue != null) {
            map.put("enhancedHue", enhancedHue);
        }
    ...
    */
    public static ClusterCommand colorLoopSet(UpdateFlagsBitmap updateFlags, ColorLoopActionEnum action, ColorLoopDirectionEnum direction, Integer time, Integer startHue, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (updateFlags != null) {
...
NOTE The StopMoveStep command has no effect on an active color loop.
    ...
    */
    public static ClusterCommand moveColorTemperature(MoveModeEnum moveMode, Integer rate, Integer colorTemperatureMinimumMireds, Integer colorTemperatureMaximumMireds, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (moveMode != null) {
            map.put("moveMode", moveMode);
        }
    ...
    */
    public static ClusterCommand stepColorTemperature(StepModeEnum stepMode, Integer stepSize, Integer transitionTime, Integer colorTemperatureMinimumMireds, Integer colorTemperatureMaximumMireds, OptionsBitmap optionsMask, OptionsBitmap optionsOverride) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (stepMode != null) {
            map.put("stepMode", stepMode);
        }
