 ...
 */
public abstract class ConcentrationMeasurementCluster extends BaseCluster {

    public static final String CLUSTER_NAME = "ConcentrationMeasurement";
    public static final String CLUSTER_PREFIX = "concentrationMeasurement";
    ...
    protected ConcentrationMeasurementCluster(BigInteger nodeId, int endpointId, int clusterId, String clusterName) {
