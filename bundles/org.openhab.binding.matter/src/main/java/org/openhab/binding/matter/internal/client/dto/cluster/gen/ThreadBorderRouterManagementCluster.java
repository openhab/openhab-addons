...
public static final int CLUSTER_ID = 0x0452;
    ...
    /**
    * Indicates a user-friendly name identifying the device model or product of the Border Router in MeshCOP (DNS-SD service name) as defined in the Thread specification, and has the following recommended format: &lt;VendorName&gt; &lt;ProductName&gt;._meshcop._udp. An example name would be ACME Border Router (74be)._meshcop._udp.
    */
    public String borderRouterName; // 0 string R V
    /**
    * Indicates a 16-byte globally unique ID for a Thread Border Router device. This ID is manufacturer-specific, and it is created and managed by the border router’s implementation.
    */
