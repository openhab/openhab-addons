...
public class SoftwareDiagnosticsCluster extends BaseCluster {
    ...
    /**
     * Indicates the current amount of heap memory, in bytes, that are free for allocation. The effective amount may be
     * smaller due to heap fragmentation or other reasons.
     */
    ...
    /**
     * Indicates the maximum amount of heap memory, in bytes, that has been used by the Node. This value shall only be
     * reset upon a Node reboot or upon receiving of the ResetWatermarks command.
     */
