...
A value of true does not guarantee that audio can be heard by the user since the speaker may be muted, turned down to a low level and/or unplugged.
        */
        ...
        public StateChanged(PlaybackStateEnum currentState, BigInteger startTime, BigInteger duration, PlaybackPositionStruct sampledPosition, Float playbackSpeed, BigInteger seekRangeEnd, BigInteger seekRangeStart, String data, Boolean audioAdvanceUnmuted) {
...
A cluster implementing AA shall implement AS.
        */
        ...
        public FeatureMap(boolean advancedSeek, boolean variableSpeed, boolean textTracks, boolean audioTracks, boolean audioAdvance){
