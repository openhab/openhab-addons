...
interface and contain the current extended MAC address for a 802.15.4 interface. The byte order of the octstr shall be in wire byte order. For addresses values less than 64 bits, the first two bytes shall be zero.
        ...
        */
        ...
        public NetworkInterface(String name, Boolean isOperational, Boolean offPremiseServicesReachableIPv4, Boolean offPremiseServicesReachableIPv6, String hardwareAddress, List<String> iPv4Addresses, List<String> iPv6Addresses, InterfaceTypeEnum type) {
            this.name = name;
