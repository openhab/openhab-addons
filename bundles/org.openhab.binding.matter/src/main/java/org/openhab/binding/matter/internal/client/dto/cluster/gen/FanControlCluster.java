...
If this is successfully written to 0, the server shall set the FanMode attribute value to Off.
    */
    ...
    /**
    * Indicates the actual currently operating fan speed, or zero to indicate that the fan is off. There may be a temporary mismatch between the value of this attribute and the value of the PercentSetting attribute due to other system requirements that would not allow the fan to operate at the requested setting. See Section 4.4.6.3.1 for more details.
    */
...
See Section 4.4.6.6.1 for more details.
        ...
        */
        ...
        public FeatureMap(boolean multiSpeed, boolean auto, boolean rocking, boolean wind, boolean step, boolean airflowDirection){
