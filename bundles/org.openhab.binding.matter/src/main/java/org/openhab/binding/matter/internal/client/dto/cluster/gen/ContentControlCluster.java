...
This attribute shall be updated when the AddBonusTime command is received and processed successfully (with the correct PIN).
    */
    ...
    /**
    * Indicates whether the playback of unrated content is allowed when the Content Control feature is activated. If this attribute equals FALSE, then playback of unrated content shall be permitted. Otherwise, the media device shall prevent the playback of unrated content.
When this attribute changes, the device SHOULD make the user aware of any limits of this feature. For example, if the feature does not control content within apps, then the device should make this clear to the user when the attribute changes.
    */
...
Content App Platform providers will have their own catalog vendor ID (set to their own Vendor ID) and will assign an ApplicationID to each Content App.
    ...
    public static class DayOfWeekBitmap {
        ...
        public DayOfWeekBitmap(boolean sunday, boolean monday, boolean tuesday, boolean wednesday, boolean thursday, boolean friday, boolean saturday){
            this.sunday = sunday;
            this.monday = monday;
    ...
    public static class FeatureMap {
        ...
        */
        ...
        public FeatureMap(boolean screenTime, boolean pinManagement, boolean blockUnrated, boolean onDemandContentRating, boolean scheduledContentRating, boolean blockChannels, boolean blockApplications, boolean blockContentTimeWindow){
