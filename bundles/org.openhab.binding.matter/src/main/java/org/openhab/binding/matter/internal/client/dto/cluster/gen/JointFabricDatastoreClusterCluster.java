    ...
    //Structs
     ...
     public class DatastoreGroupInformationEntry {
        ...
        */
        ...
        public Integer fabricIndex; // FabricIndex
        public DatastoreGroupInformationEntry(BigInteger groupId, String friendlyName, Integer groupKeySetId, Integer groupCat, Integer groupCatVersion, AccessControlCluster.AccessControlEntryPrivilegeEnum groupPermission, Integer fabricIndex) {
     ...
     public class DatastoreBindingEntry {
        ...
        */
        public DatastoreStatusEntry statusEntry; // DatastoreStatusEntry
        public Integer fabricIndex; // FabricIndex
        public DatastoreBindingEntry(Integer listId, BindingCluster.TargetStruct binding, DatastoreStatusEntry statusEntry, Integer fabricIndex) {
            this.listId = listId;
     ...
     public class DatastoreEndpointEntry {
        ...
        */
        ...
        public Integer fabricIndex; // FabricIndex
        public DatastoreEndpointEntry(Integer endpointId, BigInteger nodeId, String friendlyName, DatastoreStatusEntry statusEntry, List<DatastoreGroupIDEntry> groupIdList, List<DatastoreBindingEntry> bindingList, Integer fabricIndex) {
     ...
     public class DatastoreACLEntry {
        ...
        */
        public DatastoreStatusEntry statusEntry; // DatastoreStatusEntry
        public Integer fabricIndex; // FabricIndex
        public DatastoreACLEntry(Integer listId, AccessControlCluster.AccessControlEntryStruct aclEntry, DatastoreStatusEntry statusEntry, Integer fabricIndex) {
            this.listId = listId;
     ...
     public class DatastoreNodeInformationEntry {
        ...
        */
        ...
        public Integer fabricIndex; // FabricIndex
        public DatastoreNodeInformationEntry(BigInteger nodeId, String friendlyName, DatastoreStatusEntry commissioningStatusEntry, List<DatastoreNodeKeyEntry> nodeKeySetList, List<DatastoreACLEntry> aclList, List<DatastoreEndpointEntry> endpointList, Integer fabricIndex) {
            this.nodeId = nodeId;
            this.friendlyName = friendlyName;
     ...
     public class DatastoreAdministratorInformationEntry {
        ...
        */
        ...
        public Integer fabricIndex; // FabricIndex
        public DatastoreAdministratorInformationEntry(BigInteger nodeId, String friendlyName, Integer vendorId, String icac, Integer fabricIndex) {
            this.nodeId = nodeId;
            this.friendlyName = friendlyName;
