...
public static final int CLUSTER_ID = 0x0201;
  ...
  • Otherwise, if the LTNE feature is supported, there is no feedback externally available for the     LocalTemperatureCalibration. In that case, the LocalTemperature attribute shall always report     null.
    ...
    */
    ...
    /**
    * Indicates the absolute minimum level that the heating setpoint may be set to. This is a limitation imposed by the manufacturer.
...
The purpose of this attribute is to provide Thermostat clients the ability to configure rapid heating when a setpoint is of a specified amount greater than the measured temperature. This allows the heated space to be quickly heated to the desired level set by the user.
    ...
    */
    ...
    /**
    * Indicates the supported PresetScenarioEnum values, limits on how many presets can be created for each PresetScenarioEnum, and whether or not a thermostat can transition automatically to a given scenario.
    */
    public List<PresetTypeStruct> presetTypes; // 72 list R V
    /**
    * Indicates the supported SystemMode values for Schedules, limits on how many schedules can be created for each SystemMode value, and whether or not a given SystemMode value supports transitions to Presets, target setpoints, or both.
    */
    ...
    */
    ...
    /**
    * Indicates the ScheduleHandle of the active schedule. A null value in this attribute indicates that there is no active schedule.
    */
...
Within each subset of presets sharing the same PresetScenario field value, there shall NOT be any presets with the same value, including null as a value, in the Name field.
        ...
        */
        ...
        /**
        * This field shall indicate whether the preset is marked as &quot;built-in&quot;, meaning that it can be modified, but it cannot be deleted.
        */
        public Boolean builtIn; // bool
        public PresetStruct(String presetHandle, PresetScenarioEnum presetScenario, String name, Integer coolingSetpoint, Integer heatingSetpoint, Boolean builtIn) {
     ...
     public class PresetTypeStruct {
        ...
        */
        ...
        public PresetTypeStruct(PresetScenarioEnum presetScenario, Integer numberOfPresets, PresetTypeFeaturesBitmap presetTypeFeatures) {
            this.presetScenario = presetScenario;
...
If the current time is less than every ScheduleTransitionStruct whose DayOfWeek field also matches the current day of the week, the server shall attempt the same process to identify the active ScheduleTransitionStruct for the day preceding the previously attempted day of the week, repeating until an active ScheduleTransitionStruct is found or the attempted day is the current day of the week again. If no active ScheduleTransitionStruct is found, then the active ScheduleTransitionStruct shall be the ScheduleTransitionStruct with the largest TransitionTime field from the set of ScheduleTransitionStructs whose DayOfWeek field matches the current day of the week.
        ...
        */
        public Boolean builtIn; // bool
        public ScheduleStruct(String scheduleHandle, SystemModeEnum systemMode, String name, String presetHandle, List<ScheduleTransitionStruct> transitions, Boolean builtIn) {
...
Handling of transitions during the changeover of Daylight Saving Time is implementation-dependent.
        ...
        */
        public Integer heatingSetpoint; // temperature
        public ScheduleTransitionStruct(ScheduleDayOfWeekBitmap dayOfWeek, Integer transitionTime, String presetHandle, SystemModeEnum systemMode, Integer coolingSetpoint, Integer heatingSetpoint) {
     ...
     public class ScheduleTypeStruct {
        ...
        */
        ...
        public ScheduleTypeStruct(SystemModeEnum systemMode, Integer numberOfSchedules, ScheduleTypeFeaturesBitmap scheduleTypeFeatures) {
            this.systemMode = systemMode;
...
Systems which support cooling or heating, requiring external intervention to change modes or where the whole building must be in the same mode, SHOULD report CoolingOnly or HeatingOnly based on the current capability.
  ...
  • 1 &#x3D; Uses fuel
        */
        ...
        public HVACSystemTypeBitmap(short coolingStage, short heatingStage, boolean heatingIsHeatPump, boolean heatingUsesFuel){
    ...
    public static class ScheduleTypeFeaturesBitmap {
        ...
        */
        ...
        public ScheduleTypeFeaturesBitmap(boolean supportsPresets, boolean supportsSetpoints, boolean supportsNames, boolean supportsOff){
    ...
    public static class FeatureMap {
        ...
        */
        ...
        public FeatureMap(boolean heating, boolean cooling, boolean occupancy, boolean scheduleConfiguration, boolean setback, boolean autoMode, boolean localTemperatureNotExposed, boolean matterScheduleConfiguration, boolean presets){
