...
public static final int CLUSTER_ID = 0x0751;
    ...
    /**
    * Indicates the device categories specified in SupportedDeviceCategoryBitmap that are supported by this Commissioner Control Cluster server.
...
proval command.
    */
     public class CommissioningRequestResult {
        ...
        public CommissioningRequestResult(BigInteger requestId, BigInteger clientNodeId, Integer statusCode, Integer fabricIndex) {
...
The parameters for RequestCommissioningApproval command are as follows:
    */
    public static ClusterCommand requestCommissioningApproval(BigInteger requestId, Integer vendorId, Integer productId, String label) {
