...
Note that if bi-directional discharging occurs during the session, then this value shall only include the sum of energy transferred from the EV to the EVSE, and shall NOT be a net value of charging and discharging energy.
        */
        ...
        public EvNotDetected(Integer sessionId, StateEnum state, Integer sessionDuration, BigInteger sessionEnergyCharged, BigInteger sessionEnergyDischarged) {
            this.sessionId = sessionId;
            this.state = state;
...
A non-zero value indicates that the EV has been enabled for discharging and the value is taken directly from the MaximumDischargeCurrent attribute. A zero value indicates that the EV has not been enabled for discharging.
        */
        ...
        public EnergyTransferStarted(Integer sessionId, StateEnum state, BigInteger maximumCurrent, BigInteger maximumDischargeCurrent) {
            this.sessionId = sessionId;
            this.state = state;
    ...
    */
     public class EnergyTransferStopped {
        ...
        */
        ...
        public EnergyTransferStopped(Integer sessionId, StateEnum state, EnergyTransferStoppedReasonEnum reason, BigInteger energyTransferred, BigInteger energyDischarged) {
            this.sessionId = sessionId;
            this.state = state;
            this.reason = reason;
    ...
    */
     public class Fault {
        ...
        */
        ...
        public Fault(Integer sessionId, StateEnum state, FaultStateEnum faultStatePreviousState, FaultStateEnum faultStateCurrentState) {
            this.sessionId = sessionId;
            this.state = state;
...
The charging and discharging may be controlled by a home Energy Management System (EMS) using the Device Energy Management cluster of the associated Device Energy Management device. For example, an EMS may use the PA (Power Adjustment) feature to continually adjust the charge/discharge current to/from the EV so as to minimise the energy flow from/to the grid as the demand in the home and the solar supply to the home both fluctuate.
        */
        public boolean v2X;
        public FeatureMap(boolean chargingPreferences, boolean soCReporting, boolean plugAndCharge, boolean rfid, boolean v2X){
