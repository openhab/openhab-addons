 ...
 */
public abstract class ModeBaseCluster extends BaseCluster {

    public static final String CLUSTER_NAME = "ModeBase";
    public static final String CLUSTER_PREFIX = "modeBase";
    ...
    protected ModeBaseCluster(BigInteger nodeId, int endpointId, int clusterId, String clusterName) {
