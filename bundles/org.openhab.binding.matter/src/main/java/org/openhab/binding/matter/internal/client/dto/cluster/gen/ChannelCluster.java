    ...
    */
     public class ChannelInfoStruct {
        ...
        */
        ...
        public ChannelInfoStruct(Integer majorNumber, Integer minorNumber, String name, String callSign, String affiliateCallSign, String identifier, ChannelTypeEnum type) {
    ...
    */
     public class LineupInfoStruct {
        ...
        */
        ...
        public LineupInfoStruct(String operatorName, String lineupName, String postalCode, LineupInfoTypeEnum lineupInfoType) {
    ...
    */
     public class ProgramStruct {
        ...
        */
        ...
        /**
        * This field shall represent the recording status of the program. This field is required if the RecordProgram feature is set.
        */
        ...
        */
        ...
        public ProgramStruct(String identifier, ChannelInfoStruct channel, Integer startTime, Integer endTime, String title, String subtitle, String description, List<String> audioLanguages, List<String> ratings, String thumbnailUrl, String posterArtUrl, String dvbiUrl, String releaseDate, String parentalGuidanceText, RecordingFlagBitmap recordingFlag, SeriesInfoStruct seriesInfo, List<ProgramCategoryStruct> categoryList, List<ProgramCastStruct> castList, List<ContentLauncherCluster.AdditionalInfoStruct> externalIdList) {
            this.identifier = identifier;
...
When the value of the increase or decrease is larger than the number of channels remaining in the given direction, then the behavior shall be to return to the beginning (or end) of the channel list and continue. For example, if the current channel is at index 0 and count value of -1 is given, then the current channel should change to the last channel.
    ...
    */
    public static ClusterCommand getProgramGuide(Integer startTime, Integer endTime, List<ChannelInfoStruct> channelList, PageTokenStruct pageToken, RecordingFlagBitmap recordingFlag, List<ContentLauncherCluster.AdditionalInfoStruct> externalIdList, String data) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (startTime != null) {
    ...
    */
    public static ClusterCommand recordProgram(String programIdentifier, Boolean shouldRecordSeries, List<ContentLauncherCluster.AdditionalInfoStruct> externalIdList, String data) {
        Map<String, Object> map = new LinkedHashMap<>();
    ...
    */
    public static ClusterCommand cancelRecordProgram(String programIdentifier, Boolean shouldRecordSeries, List<ContentLauncherCluster.AdditionalInfoStruct> externalIdList, String data) {
        Map<String, Object> map = new LinkedHashMap<>();
        if (programIdentifier != null) {
            map.put("programIdentifier", programIdentifier);
        }
