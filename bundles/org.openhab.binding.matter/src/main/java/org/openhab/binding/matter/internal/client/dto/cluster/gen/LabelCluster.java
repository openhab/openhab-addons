 ...
 */
public abstract class LabelCluster extends BaseCluster {

    public static final String CLUSTER_NAME = "Label";
    public static final String CLUSTER_PREFIX = "label";
    ...
    protected LabelCluster(BigInteger nodeId, int endpointId, int clusterId, String clusterName) {
