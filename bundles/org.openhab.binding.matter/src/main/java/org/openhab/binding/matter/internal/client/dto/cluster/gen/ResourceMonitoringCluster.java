 ...
 */
public abstract class ResourceMonitoringCluster extends BaseCluster {

    public static final String CLUSTER_NAME = "ResourceMonitoring";
    public static final String CLUSTER_PREFIX = "resourceMonitoring";
    ...
    protected ResourceMonitoringCluster(BigInteger nodeId, int endpointId, int clusterId, String clusterName) {
