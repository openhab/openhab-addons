...
It shall contain at least 1 entry, and a maximum of 10.
        ...
        */
        ...
        public ForecastStruct(Integer forecastId, Integer activeSlotNumber, Integer startTime, Integer endTime, Integer earliestStartTime, Integer latestEndTime, Boolean isPausable, List<SlotStruct> slots, ForecastUpdateReasonEnum forecastUpdateReason) {
...
For example, if the slot indicates a NominalPower of 0W (indicating it is expecting to be off), this allows an ESA to specify the maximum time it could be switched on for. This may allow a battery or water heater to indicate the maximum duration that it can charge for before becoming full. In the case of a battery inverter which can be discharged, it may equally indicate the maximum time the battery could be discharged for (at the MaxPowerAdjustment power level).
        */
        ...
        public SlotStruct(Integer minDuration, Integer maxDuration, Integer defaultDuration, Integer elapsedSlotTime, Integer remainingSlotTime, Boolean slotIsPausable, Integer minPauseDuration, Integer maxPauseDuration, Integer manufacturerEsaState, BigInteger nominalPower, BigInteger minPower, BigInteger maxPower, BigInteger nominalEnergy, List<CostStruct> costs, BigInteger minPowerAdjustment, BigInteger maxPowerAdjustment, Integer minDurationAdjustment, Integer maxDurationAdjustment) {
            this.minDuration = minDuration;
            this.maxDuration = maxDuration;
     ...
     public class SlotAdjustmentStruct {
        ...
        */
        ...
        /**
        * This field shall indicate the new requested power that the ESA shall operate at. It MUST be between the AbsMinPower and AbsMaxPower attributes as advertised by the ESA if it supports PFR.
...
It does this by sending a RequestConstraintBasedForecast to the EVSE and asks it to run at a higher NominalPower consumption during the constraint period, which may require it to decrease its charge rate outside the constraint period to achieve its required energy demand.
        */
        ...
        public FeatureMap(boolean powerAdjustment, boolean powerForecastReporting, boolean stateForecastReporting, boolean startTimeAdjustment, boolean pausable, boolean forecastAdjustment, boolean constraintBasedAdjustment){
