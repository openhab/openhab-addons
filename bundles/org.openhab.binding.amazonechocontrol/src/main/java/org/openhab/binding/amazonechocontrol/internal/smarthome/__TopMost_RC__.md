...
Please jump to the [Preview and Beta: Amazon Echo Control](https://community.openhab.org/t/preview-and-beta-amazon-echo-control/81721) Binding thread to get the latest features if you want do a beta test. 
