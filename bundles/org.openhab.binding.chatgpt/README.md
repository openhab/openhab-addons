...
| reasoningEffort | text    | Controls effort on reasoning for reasoning models (`none`, `low`, `medium`, `high`, `xhigh`, `max`).                                                                                                                                                                                                                                   | none                        | no       | yes      |
...
| reasoningEffort | text    | Controls effort on reasoning for reasoning models (`none`, `low`, `medium`, `high`, `xhigh`, `max`).                                                                                                                                                                                                                                   | Inherited from Thing         | no       | yes      |
