...
| reasoningEffort | text    | Controls effort on reasoning for reasoning models (`none`, `low`, `medium`, `high`).                                                                                                                                                                                                                                                   | none                        | no       | yes      |
...
| reasoningEffort | text    | Controls effort on reasoning for reasoning models (`none`, `low`, `medium`, `high`).                                                                                                                                                                                                                                                   | Inherited from Thing         | no       | yes      |
