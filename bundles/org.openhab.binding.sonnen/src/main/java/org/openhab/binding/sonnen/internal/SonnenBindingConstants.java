...
public class SonnenBindingConstants {
    ...
    public static final String CHANNEL_BATTERY_DISCHARGE_RATE = "batteryDischargeRate";
    ...
    public static final String CHANNEL_BATTERY_CHARGE_RATE = "batteryChargeRate";
}
