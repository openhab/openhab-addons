...
public class AirthingsBindingConstants {
    ...
    public static final ThingTypeUID THING_TYPE_AIRTHINGS_WAVE_PLUS = new ThingTypeUID(BluetoothBindingConstants.BINDING_ID,
            "airthings_wave_plus");
    ...
    public static final String CHANNEL_ID_VOC = "voc";
