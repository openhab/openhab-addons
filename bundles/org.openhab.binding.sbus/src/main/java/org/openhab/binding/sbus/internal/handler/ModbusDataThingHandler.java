...
import static org.openhab.binding.sbus.internal.ModbusBindingConstantsInternal.WRITE_TYPE_COIL;
import static org.openhab.binding.sbus.internal.ModbusBindingConstantsInternal.WRITE_TYPE_HOLDING;
...
import org.openhab.binding.sbus.internal.CascadedValueTransformationImpl;
...
import org.openhab.binding.sbus.internal.SingleValueTransformation;
import org.openhab.binding.sbus.internal.ValueTransformation;
import org.openhab.binding.sbus.internal.config.ModbusDataConfiguration;
...
import org.openhab.core.io.transport.sbus.AsyncModbusWriteResult;
import org.openhab.core.io.transport.sbus.BitArray;
import org.openhab.core.io.transport.sbus.ModbusBitUtilities;
...
import org.openhab.core.io.transport.sbus.ModbusConstants.ValueType;
...
import org.openhab.core.io.transport.sbus.exception.ModbusTransportException;
import org.openhab.core.io.transport.sbus.json.WriteRequestJsonUtilities;
...
public class ModbusDataThingHandler extends BaseThingHandler {
    ...
    private @Nullable ModbusWriteRequestBlueprint requestFromCommand(ChannelUID channelUID, Command origCommand,
        ...
        if (writeType.equals(WRITE_TYPE_COIL)) {
            ...
            request = new ModbusWriteCoilRequestBlueprint(subnetId, slaveId, writeStart, data, writeMultiple,
            ...
            request = new ModbusWriteRegisterRequestBlueprint(subnetId, slaveId, writeStart, data, writeMultiple,
                    config.getWriteMaxTries());
        } else {
    ...
    private void processJsonTransform(Command command, String transformOutput) {
        ...
        try {
            requests = WriteRequestJsonUtilities.fromJson(subnetId, slaveId, transformOutput);
    ...
    public synchronized void initialize() {
        ...
        try {
            ...
            if (bridgeHandler instanceof ModbusEndpointThingHandler endpointHandler) {
                subnetId = endpointHandler.getSubnetId();
                ...
                subnetId = localReadRequest.getSubnetID();
