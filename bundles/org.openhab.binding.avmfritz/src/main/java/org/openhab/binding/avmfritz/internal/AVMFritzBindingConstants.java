...
public class AVMFritzBindingConstants {
    ...
    public static final Set<ThingTypeUID> SUPPORTED_DEVICE_THING_TYPES_UIDS = Collections
            .unmodifiableSet(Stream.of(DECT100_THING_TYPE, DECT200_THING_TYPE, DECT210_THING_TYPE, DECT300_THING_TYPE,
                    DECT301_THING_TYPE, DECT400_THING_TYPE, PL546E_THING_TYPE, COMETDECT_THING_TYPE,
                    HAN_FUN_CONTACT_THING_TYPE, HAN_FUN_SWITCH_THING_TYPE).collect(Collectors.toSet()));
