...
```
org.openhab.voice.googletts:url=http://localhost:59125
org.openhab.voice.googletts:speakingRate=1
org.openhab.voice.googletts:audioVolatility=0.667
org.openhab.voice.googletts:phonemeVolatility=0.8
```
