...
public abstract class AbstractDishWasherCapabilityFactory extends AbstractCapabilityFactory<DishWasherCapability> {
    ...
    public DishWasherCapability create(JsonNode rootNode) throws LGThinqException {
        DishWasherCapability wdCap = super.create(rootNode);
        ...
        wdCap.setFeatureDefinitionMap(
                Map.of(getTemperatureFeatureNodeName(), new DishWasherCapability.TemperatureFeatureFunction(),
                        getRinseFeatureNodeName(), new DishWasherCapability.RinseFeatureFunction(),
                        getSpinFeatureNodeName(), new DishWasherCapability.SpinFeatureFunction()));
