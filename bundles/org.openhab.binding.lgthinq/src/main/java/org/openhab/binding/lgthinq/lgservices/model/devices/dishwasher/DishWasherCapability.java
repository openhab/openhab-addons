...
public class DishWasherCapability extends AbstractCapability<DishWasherCapability> {
    ...
    static class RinseFeatureFunction implements Function<DishWasherCapability, FeatureDefinition> {
        @Override
        public FeatureDefinition apply(DishWasherCapability c) {
            return c.getRinseFeat();
        }
    }

    static class TemperatureFeatureFunction implements Function<DishWasherCapability, FeatureDefinition> {
        @Override
        public FeatureDefinition apply(DishWasherCapability c) {
    ...
    static class SpinFeatureFunction implements Function<DishWasherCapability, FeatureDefinition> {
        @Override
        public FeatureDefinition apply(DishWasherCapability c) {
