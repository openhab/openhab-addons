...
import static org.openhab.binding.lgthinq.internal.LGThinqBindingConstants.GATEWAY_SERVICE_PATH;
...
class LGBridgeTests {
    ...
    void initialize() throws IOException {
        ...
        doReturn(new LGThinqConfiguration("someone@some.url", "somepassword", "BR", "pt-BR", 60)).when(spyBridge)
    ...
    public void testDiscoveryThings() {
       stubFor(get(GATEWAY_SERVICE_PATH).willReturn(ok()));
