...
|------------------------------|-----------------|--------|--------------------------------------------------------------------|
| Sense Energy Cloud Connector | cloud-connector | Bridge | This represents the cloud account to interface with the Sense Ener |
| Sense Monitor Device         | monitor         | Bridge | This interfaces to a specific Sense energy monitor associated with |
