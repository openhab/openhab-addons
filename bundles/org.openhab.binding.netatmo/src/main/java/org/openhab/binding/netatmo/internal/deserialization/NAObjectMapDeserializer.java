...
public class NAObjectMapDeserializer implements JsonDeserializer<NAObjectMap<?>> {
    @Override
    public @Nullable NAObjectMap<?> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
            throws JsonParseException {
        ParameterizedType parameterized = (ParameterizedType) typeOfT;
