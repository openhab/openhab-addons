...
/**
 * The {@link NAHomeEnergyChannelHelper} handle specific behavior
 ...
 */
@NonNullByDefault
public class NAHomeEnergyChannelHelper extends AbstractChannelHelper {

    public NAHomeEnergyChannelHelper(Thing thing, TimeZoneProvider timeZoneProvider) {
