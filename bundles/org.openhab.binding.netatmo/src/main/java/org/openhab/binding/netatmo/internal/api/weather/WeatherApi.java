...
public class WeatherApi extends RestManager {
    ...
    // public boolean getMeasurements(String deviceId, @Nullable String moduleId, MeasureScale scale, String type,
    // Map<String, Double> channelMeasurements) throws NetatmoException {
    // List<String> types = new ArrayList<>();
    // types.add(type);
    // List<NAMeasureBodyElem> result = getmeasure(deviceId, moduleId, scale, types, 0, 0, 0, true, false);
    // NAMeasureBodyElem a = result.get(0);
    // List<Double> b = a.getValue().get(0);
    // return true;
    // }
}
