 ...
 */
@NonNullByDefault
class Capability<T extends RestManager> {
    ...
    protected @Nullable NetatmoHandler getNAHandler() {
        BridgeHandler handler = bridge.getHandler();
        return handler instanceof NetatmoHandler ? ((NetatmoHandler) handler) : null;
    }

    protected Stream<NetatmoHandler> getActiveChildren() {
        NetatmoHandler naHandler = getNAHandler();
        return naHandler != null ? naHandler.getActiveChildren() : Stream.empty();
    }
