...
/**
 * The {@link NACameraChannelHelper} handle specific behavior
 ...
 */
@NonNullByDefault
public class NACameraChannelHelper extends AbstractChannelHelper {
    private static final String LIVE_PICTURE = "/live/snapshot_720.jpg";

    public NACameraChannelHelper(Thing thing, TimeZoneProvider timeZoneProvider) {
