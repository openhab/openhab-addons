...
/**
 * The {@link NATherm1PropsChannelHelper} handle specific behavior
 ...
 */
@NonNullByDefault
public class NATherm1PropsChannelHelper extends AbstractChannelHelper {

    public NATherm1PropsChannelHelper(Thing thing, TimeZoneProvider timeZoneProvider) {
