...
/**
 * The {@link HealthIndexChannelHelper} handle specific behavior
 ...
 */
@NonNullByDefault
public class HealthIndexChannelHelper extends AbstractChannelHelper {

    public HealthIndexChannelHelper(Thing thing, TimeZoneProvider timeZoneProvider) {
