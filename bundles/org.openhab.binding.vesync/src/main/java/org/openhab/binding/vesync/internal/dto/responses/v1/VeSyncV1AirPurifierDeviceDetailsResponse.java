...
/**
 * The {@link VeSyncV1AirPurifierDeviceDetailsResponse} class is used as a DTO to hold the Vesync's V1 API's
 * common response data, with regard to an Air Purifier device.
 *
