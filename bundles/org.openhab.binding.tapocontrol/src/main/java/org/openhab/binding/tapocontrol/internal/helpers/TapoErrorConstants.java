...
public class TapoErrorConstants {
    ...
    public static final String ERR_SESSION_TIMEOUT_MSG = ""; // 9999;
    ...
    public static final String ERR_HAND_SHAKE_FAILED_MSG = ""; // 1100;
    ...
    public static final String ERR_JSON_DECODE_FAIL_MSG = ""; // -1003;
    public static final String ERR_JSON_ENCODE_FAIL_MSG = ""; // -1004;
