...
public class TapoThingConstants {
    ...
    public static final Set<ThingTypeUID> CHANNEL_GROUP_THING_SET = Collections.unmodifiableSet(Stream
            .of(SUPPORTED_BRIDGE_UIDS, SUPPORTED_HUB_UIDS, SUPPORTED_SOCKET_UIDS, SUPPORTED_WHITE_BULB_UIDS,
                    SUPPORTED_COLOR_BULB_UIDS, SUPPORTED_LIGHT_STRIP_UIDS, SUPPORTED_SMART_CONTACTS,
                    SUPPORTED_MOTION_SENSORS, SUPPORTED_WHEATHER_SENSORS)
            .flatMap(Set::stream).collect(Collectors.toSet()));
