...
Number:Temperature     Biostar_BlrTargetTemp             "Boiler Target Temp"                   { channel="guntamatic:biostar:mybiostar:blrTargetTemp" }
...
Number:Dimensionless   Biostar_Co2Content                "C02 Content"                          { channel="guntamatic:biostar:mybiostar:co2Content" }
