...
| remainingWaterTime | Number    | R  | The time the station remains to be open, in seconds.    |
...
Switch Station01RaminingTime { channel="opensprinkler:station:http:01:remainingWaterTime" }
