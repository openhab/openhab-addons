...
public class SolcastBridgeHandler extends BaseBridgeHandler implements SolarForecastProvider {
    ...
    private synchronized void getData() {
        ...
        for (Iterator<SolcastPlaneHandler> iterator = parts.iterator(); iterator.hasNext();) {
            ...
            todaySum += fo.getDayTotal(nowDate);
            day1Sum += fo.getDayTotal(nowDate.plusDays(1));
            day1SumLow += fo.getPessimisticDayTotal(nowDate.plusDays(1));
            day1SumHigh += fo.getOptimisticDayTotal(nowDate.plusDays(1));
            day2Sum += fo.getDayTotal(nowDate.plusDays(2));
            day2SumLow += fo.getPessimisticDayTotal(nowDate.plusDays(2));
            day2SumHigh += fo.getOptimisticDayTotal(nowDate.plusDays(2));
            day3Sum += fo.getDayTotal(nowDate.plusDays(3));
            day3SumLow += fo.getPessimisticDayTotal(nowDate.plusDays(3));
            day3SumHigh += fo.getOptimisticDayTotal(nowDate.plusDays(3));
            day4Sum += fo.getDayTotal(nowDate.plusDays(4));
            day4SumLow += fo.getPessimisticDayTotal(nowDate.plusDays(4));
            day4SumHigh += fo.getOptimisticDayTotal(nowDate.plusDays(4));
            day5Sum += fo.getDayTotal(nowDate.plusDays(5));
            day5SumLow += fo.getPessimisticDayTotal(nowDate.plusDays(5));
            day5SumHigh += fo.getOptimisticDayTotal(nowDate.plusDays(5));
            day6Sum += fo.getDayTotal(nowDate.plusDays(6));
            day6SumLow += fo.getPessimisticDayTotal(nowDate.plusDays(6));
            day6SumHigh += fo.getOptimisticDayTotal(nowDate.plusDays(6));
        }
