...
public class EvChargerDataParser implements RawDataParser {
    ...
    private static final Set<String> EV_CHARGER_SUPPORTED_CHANNELS = Set.of(CHANNEL_RAW_DATA, CHANNEL_CHARGER_MODE,
            CHANNEL_CHARGER_STATE, CHANNEL_CHARGER_EQ_SINGLE_SESSION, CHANNEL_CHARGER_EQ_TOTAL,
            CHANNEL_CHARGER_OUTPUT_POWER_PHASE1, CHANNEL_CHARGER_OUTPUT_POWER_PHASE2,
            CHANNEL_CHARGER_OUTPUT_POWER_PHASE3, CHANNEL_CHARGER_TOTAL_OUTPUT_POWER,
            CHANNEL_CHARGER_OUTPUT_CURRENT_PHASE1, CHANNEL_CHARGER_OUTPUT_CURRENT_PHASE2,
            CHANNEL_CHARGER_OUTPUT_CURRENT_PHASE3, CHANNEL_CHARGER_OUTPUT_VOLTAGE_PHASE1,
            CHANNEL_CHARGER_OUTPUT_VOLTAGE_PHASE2, CHANNEL_CHARGER_OUTPUT_VOLTAGE_PHASE3,
            CHANNEL_CHARGER_EXTERNAL_CURRENT_PHASE1, CHANNEL_CHARGER_EXTERNAL_CURRENT_PHASE2,
            CHANNEL_CHARGER_EXTERNAL_CURRENT_PHASE3, CHANNEL_CHARGER_EXTERNAL_POWER_PHASE1,
