...
```java
Thing kaleidescape:player:myzone1 "M500 Living Rm" [componentType="Player", host="192.168.1.10", port="10000", updatePeriod=0, volumeEnabled=true, initialVolume=20]
Thing kaleidescape:player:myzone2 "My Cinema One" [componentType="Cinema One", host="192.168.1.11", port="10000", updatePeriod=0, volumeEnabled=true, initialVolume=20]
```
