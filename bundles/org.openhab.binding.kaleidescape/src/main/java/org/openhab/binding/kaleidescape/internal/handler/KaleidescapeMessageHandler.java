        ...
        public void handleMessage(String message, KaleidescapeHandler handler) {
            ...
            try {
                ...
                handler.updateChannel(KaleidescapeBindingConstants.PLAY_MODE,
                                        new StringType(KaleidescapeStatusCodes.playMode.get(matcher.group(1))));
                
                handler.updateChannel(KaleidescapeBindingConstants.PLAY_SPEED, 
                                        new StringType(matcher.group(2)));
                ...
                handler.updateChannel(KaleidescapeBindingConstants.TITLE_LENGTH, 
                                        new QuantityType<Time>(Integer.parseInt(matcher.group(4)), handler.API_SECOND_UNIT));
                
                handler.updateChannel(KaleidescapeBindingConstants.TITLE_LOC, 
                                        new QuantityType<Time>(Integer.parseInt(matcher.group(5)), handler.API_SECOND_UNIT));
                ...
                handler.updateChannel(KaleidescapeBindingConstants.CHAPTER_LENGTH, 
                                        new QuantityType<Time>(Integer.parseInt(matcher.group(7)), handler.API_SECOND_UNIT));

                handler.updateChannel(KaleidescapeBindingConstants.CHAPTER_LOC, 
                                        new QuantityType<Time>(Integer.parseInt(matcher.group(8)), handler.API_SECOND_UNIT));
    ...
    MOVIE_MEDIA_TYPE {
        ...
        public void handleMessage(String message, KaleidescapeHandler handler) {
            handler.updateChannel(KaleidescapeBindingConstants.MOVIE_MEDIA_TYPE,
                                    new StringType(KaleidescapeStatusCodes.mediaType.get(message)));
        }
    },
    MOVIE_LOCATION {
        @Override
        public void handleMessage(String message, KaleidescapeHandler handler) {
            handler.updateChannel(KaleidescapeBindingConstants.MOVIE_LOCATION,
                                    new StringType(KaleidescapeStatusCodes.movieLocation.get(message)));
        }
    },
    VIDEO_MODE {
        @Override
        public void handleMessage(String message, KaleidescapeHandler handler) {
            ...
            try {
                ...
                handler.updateChannel(KaleidescapeBindingConstants.VIDEO_MODE_COMPOSITE,
                                        new StringType(KaleidescapeStatusCodes.videoMode.get(matcher.group(1))));
                
                handler.updateChannel(KaleidescapeBindingConstants.VIDEO_MODE_COMPONENT, 
                                        new StringType(KaleidescapeStatusCodes.videoMode.get(matcher.group(2))));
                
                handler.updateChannel(KaleidescapeBindingConstants.VIDEO_MODE_HDMI,  
                                        new StringType(KaleidescapeStatusCodes.videoMode.get(matcher.group(3))));
    ...
    MUSIC_TITLE {
        ...
        public void handleMessage(String message, KaleidescapeHandler handler) {
            ...
            try {
                ...
                handler.updateChannel(KaleidescapeBindingConstants.MUSIC_TRACK_HANDLE, new StringType(matcher.group(4)));
                
                handler.updateChannel(KaleidescapeBindingConstants.MUSIC_ALBUM_HANDLE, new StringType(matcher.group(5)));
                
                handler.updateChannel(KaleidescapeBindingConstants.MUSIC_NOWPLAY_HANDLE, new StringType(matcher.group(6)));
    ...
    MUSIC_PLAY_STATUS {
        ...
        public void handleMessage(String message, KaleidescapeHandler handler) {
            ...
            try {
                ...
                handler.updateChannel(KaleidescapeBindingConstants.MUSIC_PLAY_SPEED, 
                                        new StringType(matcher.group(2)));
                
                handler.updateChannel(KaleidescapeBindingConstants.MUSIC_TRACK_LENGTH, 
                                        new QuantityType<Time>(Integer.parseInt(matcher.group(3)), handler.API_SECOND_UNIT));
            ...
            try {
                ...
                if ("1".equals(matcher.group(1))) {
                    if (("content_handle").equals(metaType)) {
                        ...
                        handler.updateDetailChannel(KaleidescapeBindingConstants.DETAIL_COLOR_DESCRIPTION, UnDefType.NULL);
                ...
                // otherwise update the channel if it is one we care about
                    ...
                    // special case for running time to create a QuantityType<Time>
                        ...
                        handler.updateDetailChannel(KaleidescapeBindingConstants.DETAIL_RUNNING_TIME, 
                                new QuantityType<Time>(Integer.parseInt(value) * handler.metaRuntimeMultiple, handler.API_SECOND_UNIT));
    ...
    SYSTEM_READINESS_STATE {
        ...
        public void handleMessage(String message, KaleidescapeHandler handler) {
            ...
            handler.updateChannel(KaleidescapeBindingConstants.SYSTEM_READINESS_STATE,
                                    new StringType(KaleidescapeStatusCodes.readinessState.get(message)));
        }
    },
    SYSTEM_VERSION {
        public void handleMessage(String message, KaleidescapeHandler handler) {
            ...
            try {
                ...
                handler.updateChannel(KaleidescapeBindingConstants.PROTOCOL_VERSION,
                                        new StringType(matcher.group(1)));
                
                handler.updateChannel(KaleidescapeBindingConstants.SYSTEM_VERSION, 
                                        new StringType(matcher.group(2)));
