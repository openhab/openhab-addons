...
public final class VVM320Channels extends BaseChannels {
    ...
    public static final NibeChannel CH_47011 = INSTANCE.addChannel(
            new NibeChannel("47011", "Heat Offset S1", ChannelGroup.GENERAL, "/Manage/1.9.1.1-S1", "[-1]*[0-9]"));
    public static final NibeChannel CH_47394 = INSTANCE
            .addChannel(new SwitchChannel("47394", "Room Sensor", ChannelGroup.GENERAL, "/Manage/1.9.4"));
    public static final NibeChannel CH_47402 = INSTANCE.addChannel(new ScaledChannel("47402", "Room sensor factor",
    ...
    // Compressor
    public static final NibeChannel CH_44362 = INSTANCE.addChannel(new QuantityChannel("44362",
            "EB101-EP14-BT28 Outdoor Temp", ChannelGroup.COMPRESSOR, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_44396 = INSTANCE.addChannel(
            new QuantityChannel("44396", "EB101 Speed charge pump", ChannelGroup.COMPRESSOR, SmartHomeUnits.PERCENT));
    public static final NibeChannel CH_44703 = INSTANCE
            .addChannel(new NibeChannel("44703", "EB101-EP14 Defrosting Outdoor Unit", ChannelGroup.COMPRESSOR));
    public static final NibeChannel CH_44073 = INSTANCE.addChannel(new QuantityChannel("44073",
            "EB101-EP14 Tot. HW op.time compr", ChannelGroup.COMPRESSOR, SmartHomeUnits.HOUR));
    public static final NibeChannel CH_40737 = INSTANCE.addChannel(new QuantityChannel("40737",
            "EB101-EP14 Tot. Cooling op.time compr", ChannelGroup.COMPRESSOR, SmartHomeUnits.HOUR));
    public static final NibeChannel CH_44071 = INSTANCE.addChannel(new QuantityChannel("44071",
    ...
    public static final NibeChannel CH_44058 = INSTANCE.addChannel(new QuantityChannel("44058",
            "EB101-EP14-BT12 Condensor Out", ChannelGroup.COMPRESSOR, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_44055 = INSTANCE.addChannel(new QuantityChannel("44055",
            "EB101-EP14-BT3 Return Temp.", ChannelGroup.COMPRESSOR, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_44363 = INSTANCE.addChannel(new QuantityChannel("44363",
            "EB101-EP14-BT16 Evaporator", ChannelGroup.COMPRESSOR, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_44699 = INSTANCE.addChannel(new QuantityChannel("44699",
            "EB101-EP14-BP4 Pressure Sensor", ChannelGroup.COMPRESSOR, ScaleFactor.DIV_10, SmartHomeUnits.BAR));
    public static final NibeChannel CH_40782 = INSTANCE.addChannel(new QuantityChannel("40782",
            "EB101 Cpr Frequency Desired F2040", ChannelGroup.COMPRESSOR, SmartHomeUnits.HERTZ));
    public static final NibeChannel CH_44701 = INSTANCE
    ...
    public static final NibeChannel CH_44702 = INSTANCE.addChannel(
            new SwitchChannel("44702", "EB101-EP14 Protection Status Register Outdoor Unit", ChannelGroup.COMPRESSOR));
    public static final NibeChannel CH_44700 = INSTANCE
    ...
    public static final NibeChannel CH_44457 = INSTANCE
    ...
    public static final NibeChannel CH_40311 = INSTANCE.addChannel(new QuantityChannel("40311",
            "External ERS accessory GQ2 speed", ChannelGroup.AIRSUPPLY, SmartHomeUnits.PERCENT));
    public static final NibeChannel CH_40312 = INSTANCE.addChannel(new QuantityChannel("40312",
