...
public final class F730Channels extends BaseChannels {
    ...
    // Compressor
    public static final NibeChannel CH_43181 = INSTANCE.addChannel(
    ...
    public static final NibeChannel CH_40020 = INSTANCE.addChannel(new QuantityChannel("40020",
    ...
    public static final NibeChannel CH_43124 = INSTANCE
            .addChannel(new ScaledChannel("43124", "Air flow ref.", ChannelGroup.AIRSUPPLY, ScaleFactor.DIV_10));
    public static final NibeChannel CH_41026 = INSTANCE
            .addChannel(new NibeChannel("41026", "EB100-Adjusted BS1 Air flow", ChannelGroup.AIRSUPPLY));
    public static final NibeChannel CH_43125 = INSTANCE
            .addChannel(new NibeChannel("43125", "Air flow reduction", ChannelGroup.AIRSUPPLY));
    public static final NibeChannel CH_40919 = INSTANCE.addChannel(
            new QuantityChannel("40919", "Air mix", ChannelGroup.AIRSUPPLY, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_40101 = INSTANCE.addChannel(new QuantityChannel("40101", "BT28 Air mix Temp",
