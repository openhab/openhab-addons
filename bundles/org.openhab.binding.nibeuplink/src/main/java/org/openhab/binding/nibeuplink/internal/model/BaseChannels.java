...
public class BaseChannels extends AbstractChannels {
    ...
    public Set<NibeChannel> getChannels() {
        Set<NibeChannel> allChannels = new HashSet<>();
    ...
    public static final NibeChannel CH_43009 = INSTANCE.addChannel(
            new QuantityChannel("43009", "Calc. Supply S1", ChannelGroup.BASE, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_40071 = INSTANCE.addChannel(
            new QuantityChannel("40071", "BT25 Ext. Supply", ChannelGroup.BASE, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_40033 = INSTANCE.addChannel(
            new QuantityChannel("40033", "BT50 Room Temp S1", ChannelGroup.BASE, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_43161 = INSTANCE
            .addChannel(new SwitchChannel("43161", "External adjustment activated via input S1", ChannelGroup.BASE));
    public static final NibeChannel CH_40008 = INSTANCE.addChannel(
            new QuantityChannel("40008", "BT2 Supply temp S1", ChannelGroup.BASE, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_40012 = INSTANCE.addChannel(new QuantityChannel("40012",
            "EB100-EP14-BT3 Return temp", ChannelGroup.BASE, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_40072 = INSTANCE.addChannel(new QuantityChannel("40072", "BF1 EP14 Flow",
            ChannelGroup.BASE, ScaleFactor.DIV_10, SmartHomeUnits.LITRE.divide(SIUnits.METRE)));
    public static final NibeChannel CH_43437 = INSTANCE.addChannel(
            new QuantityChannel("43437", "Supply Pump Speed EP14", ChannelGroup.BASE, SmartHomeUnits.PERCENT));
    public static final NibeChannel CH_40079 = INSTANCE.addChannel(new QuantityChannel("40079", "EB100-BE3 Current",
            ChannelGroup.BASE, ScaleFactor.DIV_10, SmartHomeUnits.AMPERE));
    public static final NibeChannel CH_40081 = INSTANCE.addChannel(new QuantityChannel("40081", "EB100-BE2 Current",
            ChannelGroup.BASE, ScaleFactor.DIV_10, SmartHomeUnits.AMPERE));
    public static final NibeChannel CH_40083 = INSTANCE.addChannel(new QuantityChannel("40083", "EB100-BE1 Current",
            ChannelGroup.BASE, ScaleFactor.DIV_10, SmartHomeUnits.AMPERE));
    public static final NibeChannel CH_10033 = INSTANCE
            .addChannel(new SwitchChannel("10033", "Int. el.add. blocked", ChannelGroup.BASE));

    // additional heater
    public static final NibeChannel CH_43081 = INSTANCE.addChannel(new QuantityChannel("43081", "Tot. op.time add.",
            ChannelGroup.BASE, ScaleFactor.DIV_10, SmartHomeUnits.HOUR));
    public static final NibeChannel CH_43084 = INSTANCE.addChannel(new QuantityChannel("43084", "Int. el.add. Power",
            ChannelGroup.BASE, ScaleFactor.DIV_100, MetricPrefix.KILO(SmartHomeUnits.WATT)));
    public static final NibeChannel CH_47212 = INSTANCE.addChannel(new QuantityChannel("47212", "Max int add. power",
            ChannelGroup.BASE, ScaleFactor.DIV_100, MetricPrefix.KILO(SmartHomeUnits.WATT)));
    public static final NibeChannel CH_48914 = INSTANCE
    ...
    // heat meters
    public static final NibeChannel CH_44308 = INSTANCE
    ...
    public static final NibeChannel CH_44298 = INSTANCE
            .addChannel(new QuantityChannel("44298", "Heat Meter - HW Cpr and Add EP14", ChannelGroup.HOTWATER,
                    ScaleFactor.DIV_10, MetricPrefix.KILO(SmartHomeUnits.WATT_HOUR)));
    public static final NibeChannel CH_48132 = INSTANCE
            .addChannel(new NibeChannel("48132", "Temporary Lux", ChannelGroup.HOTWATER, "/Manage/2.1", "[01234]"));
    public static final NibeChannel CH_47041 = INSTANCE
            .addChannel(new NibeChannel("47041", "Hot water mode", ChannelGroup.HOTWATER, "/Manage/2.2", "[012]"));
    public static final NibeChannel CH_47045 = INSTANCE.addChannel(new QuantityChannel("47045",
            "Start temperature HW Economy", ChannelGroup.HOTWATER, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_47049 = INSTANCE.addChannel(new QuantityChannel("47049",
            "Stop temperature HW Economy", ChannelGroup.HOTWATER, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_47044 = INSTANCE.addChannel(new QuantityChannel("47044",
            "Start temperature HW Normal", ChannelGroup.HOTWATER, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_47048 = INSTANCE.addChannel(new QuantityChannel("47048",
            "Stop temperature HW Normal", ChannelGroup.HOTWATER, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_47043 = INSTANCE.addChannel(new QuantityChannel("47043",
            "Start temperature HW Luxury", ChannelGroup.HOTWATER, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_47047 = INSTANCE.addChannel(new QuantityChannel("47047",
            "Stop temperature HW Luxury", ChannelGroup.HOTWATER, ScaleFactor.DIV_10, SIUnits.CELSIUS));
    public static final NibeChannel CH_47046 = INSTANCE.addChannel(new QuantityChannel("47046",
            "Stop temperature periodic HW", ChannelGroup.HOTWATER, ScaleFactor.DIV_10, SIUnits.CELSIUS));

    // Compressor
    public static final NibeChannel CH_10012 = INSTANCE
