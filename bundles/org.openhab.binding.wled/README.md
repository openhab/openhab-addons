...
| `macAddress`          | The hardware MAC address of your WLED device, example: `AB:CD:EF:12:34:56` (optional, but automatically filled by discovery to avoid creating discovery results for existing `thing`s.)                                                              | Y        |         |
