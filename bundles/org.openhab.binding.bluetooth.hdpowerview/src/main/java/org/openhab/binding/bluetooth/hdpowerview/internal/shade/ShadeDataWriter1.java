 ...
 */
@NonNullByDefault
public class ShadeDataWriter1 implements ShadeDataWriter {
     ...
     */
    private int calculatePrimaryNibble0(int position) {
     ...
     * Reverse engineered from observing Bluetooth traffic between the HD App and a shade.
     */
    private int calculatePrimaryNibble1(int position) {
     ...
     * Reverse engineered from observing Bluetooth traffic between the HD App and a shade.
     */
    private int calculatePrimaryNibble2(int position) {
     ...
     * Reverse engineered from observing Bluetooth traffic between the HD App and a shade.
     */
    private int calculatePrimaryNibble3(int position) {
