...
public enum LinkyChannel {
    ...
    SINST1(ValueType.INTEGER, LINKY_LOCAL_3PHASE_GROUP, CHANNEL_SINSTS1, Units.VOLT_AMPERE),
    SINST2(ValueType.INTEGER, LINKY_LOCAL_3PHASE_GROUP, CHANNEL_SINSTS2, Units.VOLT_AMPERE),
    SINST3(ValueType.INTEGER, LINKY_LOCAL_3PHASE_GROUP, CHANNEL_SINSTS3, Units.VOLT_AMPERE),
