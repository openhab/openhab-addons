...
public enum LinkyChannelRegistry {
    ...
    SINST1(ValueType.INTEGER, LINKY_LOCAL_3PHASE_GROUP, CHANNEL_SINST1, Units.VOLT_AMPERE),
    SINST2(ValueType.INTEGER, LINKY_LOCAL_3PHASE_GROUP, CHANNEL_SINST2, Units.VOLT_AMPERE),
    SINST3(ValueType.INTEGER, LINKY_LOCAL_3PHASE_GROUP, CHANNEL_SINST3, Units.VOLT_AMPERE),
