...
import org.openhab.binding.openweathermap.internal.handler.OpenWeatherMapCombinedForecastHandler;
...
public class OpenWeatherMapHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        } else if (THING_TYPE_COMBINED_FORECAST.equals(thingTypeUID)) {
            return new OpenWeatherMapCombinedForecastHandler(thing);
        }
