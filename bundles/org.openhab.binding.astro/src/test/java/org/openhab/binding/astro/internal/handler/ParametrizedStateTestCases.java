...
public final class ParametrizedStateTestCases {
    ...
    public static final Location AMSTERDAM_LOC = new Location(52.367607, 4.8978293);
    ...
    public final List<StateTestCase> zodiacCases = List.of(
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-04-05T12:00:00Z"),
                    new StringType("ARIES"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-05-05T12:00:00Z"),
                    new StringType("TAURUS"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-06-05T12:00:00Z"),
                    new StringType("GEMINI"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-07-05T12:00:00Z"),
                    new StringType("CANCER"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-08-05T12:00:00Z"),
                    new StringType("LEO"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-09-05T12:00:00Z"),
                    new StringType("VIRGO"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-10-05T12:00:00Z"),
                    new StringType("LIBRA"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-11-05T12:00:00Z"),
                    new StringType("SCORPIO"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-12-05T12:00:00Z"),
                    new StringType("SAGITTARIUS"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-01-10T12:00:00Z"),
                    new StringType("CAPRICORN"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-02-05T12:00:00Z"),
                    new StringType("AQUARIUS"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "zodiac#sign", Instant.parse("2025-03-05T12:00:00Z"),
                    new StringType("PISCES"), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_MOON_THING_ID, "zodiac#sign", Instant.parse("2019-02-27T01:00:00Z"),
                    new StringType("SAGITTARIUS"), AMSTERDAM_ZONE, AMSTERDAM_LOC));
...
=======
    public final List<StateTestCase> eclipseCases = List.of( // Total Solar Eclipse on August 21, 2017
            new StateTestCase(TEST_SUN_THING_ID, "eclipse#total", Instant.parse("2017-01-01T00:00:00Z"),
                    new DateTimeType("2017-08-21T18:27:10+00:00"), BAGHDAD_ZONE, SHAYBAH_LOC),
            // Partial Solar Eclipse on August 11, 2018
            new StateTestCase(TEST_SUN_THING_ID, "eclipse#partial", Instant.parse("2018-07-15T00:00:00Z"),
    ...
    public final List<StateTestCase> circadianCases = List.of(
            new StateTestCase(TEST_SUN_THING_ID, CHANNEL_ID_SUN_CIRCADIAN_BRIGHTNESS, MARCH_16_2022_UA,
                    new PercentType(93), KYIV_ZONE, MARIUPOL_LOC),
            new StateTestCase(TEST_SUN_THING_ID, CHANNEL_ID_SUN_CIRCADIAN_TEMPERATURE, MARCH_16_2022_UA,
                    new QuantityType<>(5290, Units.KELVIN), KYIV_ZONE, MARIUPOL_LOC),
    ...
    public final List<StateTestCase> otherCases = List.of(
            new StateTestCase(TEST_SUN_THING_ID, "rise#start", LEAP_DAY_2016_SA,
                    new DateTimeType("2016-02-29T05:46:07+03:00"), BAGHDAD_ZONE, SHAYBAH_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "rise#end", LEAP_DAY_2016_SA,
                    new DateTimeType("2016-02-29T05:48:26+03:00"), BAGHDAD_ZONE, SHAYBAH_LOC),
            ...
            new StateTestCase(TEST_SUN_THING_ID, "noon#end", LEAP_DAY_2016_SA,
                    new DateTimeType("2016-02-29T11:37:41+03:00"), BAGHDAD_ZONE, SHAYBAH_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "noon#duration", LEAP_DAY_2016_SA, new QuantityType<>(1, Units.MINUTE),
                    BAGHDAD_ZONE, SHAYBAH_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "night#start", LEAP_DAY_2016_SA,
                    new DateTimeType("2016-02-29T18:41:51+03:00"), BAGHDAD_ZONE, SHAYBAH_LOC),
            new StateTestCase(TEST_SUN_THING_ID, "night#end", LEAP_DAY_2016_SA,
                    new DateTimeType("2016-03-01T04:30:44+03:00"), BAGHDAD_ZONE, SHAYBAH_LOC),
            ...
            new StateTestCase(TEST_MOON_THING_ID, "rise#duration", LEAP_DAY_2016_SA,
                    new QuantityType<>(0, Units.MINUTE), BAGHDAD_ZONE, SHAYBAH_LOC));
>>>>>>> 8a0658e Copilot code review

    public List<StateTestCase> getCases() {
        List<StateTestCase> allTests = new ArrayList<>();
        allTests.addAll(zodiacCases);
        allTests.addAll(eclipseCases);
        allTests.addAll(circadianCases);
        allTests.addAll(otherCases);
        return allTests;
    }
}
