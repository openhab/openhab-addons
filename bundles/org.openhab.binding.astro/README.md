...
- **thing** `sun`
  ...
  - **group** `phase`
    - **channel**
      - `name` (String), values: `SUN_RISE, ASTRO_DAWN, NAUTIC_DAWN, CIVIL_DAWN, CIVIL_DUSK, NAUTIC_DUSK, ASTRO_DUSK, SUN_SET, DAYLIGHT, NOON, NIGHT, MORNING_NIGHT, EVENING_NIGHT`
- **thing** `moon`
  - **group** `rise, set`
    - **channel**
      - `start, end` (DateTime)
