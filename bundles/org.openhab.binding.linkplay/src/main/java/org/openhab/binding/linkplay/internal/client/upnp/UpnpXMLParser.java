...
public class UpnpXMLParser {
    ...
    private static SAXParser createSecureSAXParser() throws SAXException, ParserConfigurationException {
    ...
    public static @Nullable PlayList getPlayListFromBrowseQueueResponse(String xml) {
        ...
        try {
            ...
            // This should never happen - we're not performing I/O!
            LOGGER.debug("Could not parse BrowseQueueResponse from XML", e);
            return null;
        } catch (SAXException | ParserConfigurationException s) {
