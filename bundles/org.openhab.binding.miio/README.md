...
| Channel          | Type    | Description                         | Comment    |
|------------------|---------|-------------------------------------|------------|
| Fault            | Number  | Curtain Fault                       |            |
| CurrentPosition  | Number  | Curtain Position                    |            |
| Status           | Number  | Curtain Status                      |            |
| TargetPosition   | Number  | Curtain Target Position             |            |
...
Number Fault "Curtain Fault" (G_curtain) {channel="miio:basic:curtain:Fault"}
Number CurrentPosition "Curtain Position" (G_curtain) {channel="miio:basic:curtain:CurrentPosition"}
Number Status "Curtain Status" (G_curtain) {channel="miio:basic:curtain:Status"}
Number TargetPosition "Curtain Target Position" (G_curtain) {channel="miio:basic:curtain:TargetPosition"}
