...
| humidity_set         | Number               | Humidity Setting                         |            |
| ked                  | Number               | LED                                      |            |
| sound                | String               | TipSound_State                           |            |
| wet_and_protect      | Number               | wet_and_protect                          |            |
...
Number humidity_set "Humidity Setting" (G_humidifier) {channel="miio:basic:humidifier:humidity_set"}
Number ked "LED" (G_humidifier) {channel="miio:basic:humidifier:ked"}
String sound "TipSound_State" (G_humidifier) {channel="miio:basic:humidifier:sound"}
Number wet_and_protect "wet_and_protect" (G_humidifier) {channel="miio:basic:humidifier:wet_and_protect"}
