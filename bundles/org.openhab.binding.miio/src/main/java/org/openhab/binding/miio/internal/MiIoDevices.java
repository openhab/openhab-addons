...
public enum MiIoDevices {
    ...
    HUAYI_LIGHT_FANWY("huayi.light.fanwy", "huayi.light.fanwy", THING_TYPE_BASIC),
    HUAYI_LIGHT_FANWY2("huayi.light.fanwy2", "huayi.light.fanwy2", THING_TYPE_BASIC),
    ...
    HUAYI_LIGHT_WY200("huayi.light.wy200", "huayi.light.wy200", THING_TYPE_BASIC),
    HUAYI_LIGHT_WY201("huayi.light.wy201", "huayi.light.wy201", THING_TYPE_BASIC),
    HUAYI_LIGHT_WY202("huayi.light.wy202", "huayi.light.wy202", THING_TYPE_BASIC),
    HUAYI_LIGHT_WY203("huayi.light.wy203", "huayi.light.wy203", THING_TYPE_BASIC),
    HUAYI_LIGHT_WY204("huayi.light.wy204", "huayi.light.wy204", THING_TYPE_BASIC),
    HUAYI_LIGHT_WYHEAT("huayi.light.wyheat", "huayi.light.wyheat", THING_TYPE_BASIC),
