...
public enum OutputChannelEnum {
	...
	*| 24  | Power Level                           | powerLevel                                                           | 0   | 100   | percent              |
	...
	BRIGHTNESS(1, "brightness"), HUE(2, "hue"), SATURATION(3, "saturation"), COLORTEMP(4, "colortemp"), X(5, "x"),
	Y(6, "y"), SHADE_POSITION_OUTSIDE(7, "shadePositionOutside"), SHADE_POSITION_INDOOR(8, "shadePositionIndoor"),
	SHADE_OPENING_ANGLE_OUTSIDE(9, "shadeOpeningAngleOutside"),
	SHADE_OPENING_ANGLE_INDOOR(10, "shadeOpeningAngleIndoor"), TRANSPARENCY(11, "transparency"),
	AIR_FLOW_INTENSITY(12, "airFlowIntensity"), AIR_FLOW_DIRECTION(13, "airFlowDirection"),
	AIR_FLAP_POSITION(14, "airFlapPosition"), AIR_LOUVER_POSITION(15, "airLouverPosition"),
	HEATING_POWER(16, "heatingPower"), COOLING_CAPACITY(17, "coolingCapacity"), AUDIO_VOLUME(18, "audioVolume"),
	POWER_STATE(19, "powerState"), AIR_LOUVER_AUTO(20, "airLouverAuto"), AIR_FLOW_AUTO(21, "airFlowAuto"),
	WATER_TEMPERATURE(22, "waterTemperature"), WATER_FLOW(23, "waterFlow"), POWER_LEVEL(24, "powerLevel");
