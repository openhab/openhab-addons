...
public class RFXComInterfaceControlMessage extends RFXComBaseMessage {
    ...
    public RFXComInterfaceControlMessage(RFXComInterfaceMessage.TransceiverType transceiverType,
        ...
        data[8] = (byte) ((configuration.enableBlindsT1T2T3T4 ? 0x80 : 0x00)
                ...
                | (configuration.enableFS20 ? 0x10 : 0x00) | (configuration.enableLaCrosse ? 0x08 : 0x00)
                | (configuration.enableHidekiUPM ? 0x04 : 0x00) | (configuration.enableADLightwaveRF ? 0x02 : 0x00)
        ...
        data[10] = (byte) ((configuration.enableHomeConfort ? 0x02 : 0x00)
