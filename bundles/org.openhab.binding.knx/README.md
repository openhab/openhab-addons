...
| ipAddress           | for `*TUNNEL`| Network address of the KNX/IP gateway. Only relevant for `TUNNEL` and `SECURETUNNEL`.                                            | -                                                         |
| portNumber          | for `*TUNNEL`| Port number of the KNX/IP gateway                                                                                                | 3671                                                      |
| multicastAddress    | No           | IPv4 Multicast Address for `ROUTER` and `SECUREROUTER`. Only needed if it deviates from default 224.0.23.12.                     |                                                           |
