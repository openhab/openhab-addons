...
public class KNXSecurityTest {
    ...
    public void testSecurityHelpers() {
        ...
        // secure group adresses should contain at least one address marked as "surrogate"
        final String secureAdresses = KNXBridgeBaseThingHandler.secHelperGetSecureGroupAdresses(openhabSecurity);
        assertTrue(secureAdresses.contains("(S)"));
        assertTrue(secureAdresses.contains("8/4/0"));
    }
}
