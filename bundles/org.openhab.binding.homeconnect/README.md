...
| laundry_care_washer_pre_wash | Switch | true | TThis status indicates whether the pre-wash is activated for a washer program of the home appliance. | washer, washerdryer | 
