...
/**
 * The {@link PowerwallListener} interface can be implemented by classes that want to be informed about
 * existing powerwalls of a given account. They need to register on an {@link TeslaAccountHandler}.
 *
 * @author Kai Kreuzer - Initial contribution
 */
public interface PowerwallListener {
