...
| driverfrontwindow        | Contact                  | Driver Front Window         | Indicates if the front window at the driver's side is open                                                                                         |
| driverreardoor           | Contact                  | Driver Rear Door            | Indicates if the rear door at the driver's side is open                                                                                            |
| driverrearwindow         | Contact                  | Driver Rear Window          | Indicates if the rear window at the driver's side is open                                                                                          |
...
| minutestofullcharge      | Number:Time              | Minutes To Full Charge      | Number of minutes to fully charge the battery                                                                                                      |
...
| passengerfrontwindow     | Contact                  | Passenger Front Window      | Indicates if the front window at the passenger's side is open                                                                                      |
| passengerreardoor        | Contact                  | Passenger Rear Door         | Indicates if the rear door at the passenger's side is opened                                                                                       |
| passengerrearwindow      | Contact                  | Passenger Rear Window       | Indicates if the rear window at the passenger's side is open                                                                                       |
...
| tirepressurefrontleft    | Number:Pressure          | Tire Pressure Front Left    | Pressure of the front left tire                                                                                                                    |
| tirepressurefrontright   | Number:Pressure          | Tire Pressure Front Right   | Pressure of the front right tire                                                                                                                   |
| tirepressurerearleft     | Number:Pressure          | Tire Pressure Rear Left     | Pressure of the rear left tire                                                                                                                     |
| tirepressurerearright    | Number:Pressure          | Tire Pressure Rear Right    | Pressure of the rear right tire                                                                                                                    |
| tirepressurewarning      | Switch                   | Tire Pressure Warning       | Indicates if the vehicle reports a pressure warning for any tire                                                                                   |
...
| userpresent              | Switch                   | User Present                | Indicates if a person is present in the vehicle                                                                                                    |
