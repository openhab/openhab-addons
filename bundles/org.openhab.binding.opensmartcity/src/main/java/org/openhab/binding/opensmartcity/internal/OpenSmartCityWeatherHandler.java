...
public class OpenSmartCityWeatherHandler extends BaseThingHandler {
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        if (org.openhab.binding.opensmartcity.internal.OpenSmartCityBindingConstants.CHANNEL_TEMPERATURE
                .equals(channelUID.getId())) {
    ...
    public void initialize() {
        config = getConfigAs(OpenSmartCityConfiguration.class);
