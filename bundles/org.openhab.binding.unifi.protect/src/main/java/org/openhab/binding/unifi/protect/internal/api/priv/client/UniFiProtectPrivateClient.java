...
import org.openhab.binding.unifi.protect.internal.api.priv.dto.system.ApiKeyResponse;
...
import org.openhab.binding.unifi.protect.internal.api.priv.dto.system.UserCertificate;
...
public class UniFiProtectPrivateClient {
     ...
     * @return CompletableFuture with updated Camera
     */
    public CompletableFuture<org.openhab.binding.unifi.protect.internal.api.priv.dto.devices.Camera> setCameraRecordingMode(
    ...
    private CompletableFuture<Camera> setSmartDetectType(String cameraId, String detectType, boolean enabled) {
        return getBootstrap().thenCompose(bootstrap -> {
            ...
            List<org.openhab.binding.unifi.protect.internal.api.priv.dto.types.SmartDetectObjectType> objectTypes = new ArrayList<>(
     ...
     */
    public CompletableFuture<org.openhab.binding.unifi.protect.internal.api.priv.dto.system.ApiKey> getOrCreateApiKey(
