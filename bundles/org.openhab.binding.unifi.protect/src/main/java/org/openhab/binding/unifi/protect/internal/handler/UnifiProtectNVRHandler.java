...
import org.openhab.binding.unifi.protect.internal.UnifiProtectBindingConstants;
import org.openhab.binding.unifi.protect.internal.UnifiProtectDiscoveryService;
...
import org.openhab.binding.unifi.protect.internal.api.priv.client.UniFiProtectPrivateWebSocket.WebSocketUpdate;
...
import org.openhab.binding.unifi.protect.internal.api.priv.dto.system.ApiKey;
...
import org.openhab.binding.unifi.protect.internal.api.pub.dto.gson.DeviceTypeAdapterFactory;
import org.openhab.binding.unifi.protect.internal.api.pub.dto.gson.EventTypeAdapterFactory;
import org.openhab.binding.unifi.protect.internal.config.UnifiProtectNVRConfiguration;
import org.openhab.binding.unifi.protect.internal.handler.UnifiProtectAbstractDeviceHandler.WSEventType;
...
public class UnifiProtectNVRHandler extends BaseBridgeHandler {
    ...
    private void initializeWithSession(UnifiProtectNVRConfiguration config, HttpClient httpClient, String host,
        ...
        try {
            ...
            // Auto-create API key if not provided, reusing the parent bridge's already-authenticated session.
            if (apiToken == null || apiToken.isBlank()) {
                logger.debug("No API token provided, auto-creating via Private API...");
                try {
                    UniFiProtectPrivateClient tempClient = new UniFiProtectPrivateClient(httpClient, scheduler, baseUrl,
                            session);
