...
> **Bridge hierarchy.** The `unifiprotect:nvr` bridge is a **child of the shared `unifi:controller` bridge** from the parent `org.openhab.binding.unifi` binding.
...
Bridge unifi:controller:myConsole "UniFi Console" [ host="192.168.1.10", username="localadmin", password="your_password" ] {
    ...
    Bridge unifiprotect:nvr myNvr "UniFi Protect NVR" [] {
