...
/**
 *
 * The {@link InsteonV2ChannelConfiguration} is the configuration for an insteon channel.
 *
 * @author Rob Nielsen - Initial contribution
 * @author Jeremy Setton - Rewrite insteon binding
 */
@NonNullByDefault
public class InsteonV2ChannelConfiguration {
    ...
    public static InsteonV2ChannelConfiguration copyOf(InsteonV2ChannelConfiguration original, int onLevel,
            RampRate rampRate) {
        InsteonV2ChannelConfiguration config = new InsteonV2ChannelConfiguration();
