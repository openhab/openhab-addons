...
public class InsteonLegacyDeviceHandler extends BaseThingHandler {
    ...
    private static final Set<String> ALL_CHANNEL_IDS = Collections.unmodifiableSet(Stream.of(
            InsteonBindingLegacyConstants.AC_DELAY, InsteonBindingLegacyConstants.BACKLIGHT_DURATION,
            InsteonBindingLegacyConstants.BATTERY_LEVEL, InsteonBindingLegacyConstants.BATTERY_PERCENT,
            InsteonBindingLegacyConstants.BATTERY_WATERMARK_LEVEL, InsteonBindingLegacyConstants.BEEP,
            InsteonBindingLegacyConstants.BOTTOM_OUTLET, InsteonBindingLegacyConstants.BUTTON_A,
            InsteonBindingLegacyConstants.BUTTON_B, InsteonBindingLegacyConstants.BUTTON_C,
            InsteonBindingLegacyConstants.BUTTON_D, InsteonBindingLegacyConstants.BUTTON_E,
            InsteonBindingLegacyConstants.BUTTON_F, InsteonBindingLegacyConstants.BUTTON_G,
            InsteonBindingLegacyConstants.BUTTON_H, InsteonBindingLegacyConstants.BROADCAST_ON_OFF,
            InsteonBindingLegacyConstants.CONTACT, InsteonBindingLegacyConstants.COOL_SET_POINT,
            InsteonBindingLegacyConstants.DIMMER, InsteonBindingLegacyConstants.FAN,
            InsteonBindingLegacyConstants.FAN_MODE, InsteonBindingLegacyConstants.FAST_ON_OFF,
            InsteonBindingLegacyConstants.FAST_ON_OFF_BUTTON_A, InsteonBindingLegacyConstants.FAST_ON_OFF_BUTTON_B,
            InsteonBindingLegacyConstants.FAST_ON_OFF_BUTTON_C, InsteonBindingLegacyConstants.FAST_ON_OFF_BUTTON_D,
            InsteonBindingLegacyConstants.FAST_ON_OFF_BUTTON_E, InsteonBindingLegacyConstants.FAST_ON_OFF_BUTTON_F,
            InsteonBindingLegacyConstants.FAST_ON_OFF_BUTTON_G, InsteonBindingLegacyConstants.FAST_ON_OFF_BUTTON_H,
            InsteonBindingLegacyConstants.HEAT_SET_POINT, InsteonBindingLegacyConstants.HUMIDITY,
            InsteonBindingLegacyConstants.HUMIDITY_HIGH, InsteonBindingLegacyConstants.HUMIDITY_LOW,
            InsteonBindingLegacyConstants.IS_COOLING, InsteonBindingLegacyConstants.IS_HEATING,
            InsteonBindingLegacyConstants.KEYPAD_BUTTON_A, InsteonBindingLegacyConstants.KEYPAD_BUTTON_B,
            InsteonBindingLegacyConstants.KEYPAD_BUTTON_C, InsteonBindingLegacyConstants.KEYPAD_BUTTON_D,
            InsteonBindingLegacyConstants.KEYPAD_BUTTON_E, InsteonBindingLegacyConstants.KEYPAD_BUTTON_F,
            InsteonBindingLegacyConstants.KEYPAD_BUTTON_G, InsteonBindingLegacyConstants.KEYPAD_BUTTON_H,
            InsteonBindingLegacyConstants.KWH, InsteonBindingLegacyConstants.LAST_HEARD_FROM,
            InsteonBindingLegacyConstants.LED_BRIGHTNESS, InsteonBindingLegacyConstants.LED_ONOFF,
            InsteonBindingLegacyConstants.LIGHT_DIMMER, InsteonBindingLegacyConstants.LIGHT_LEVEL,
            InsteonBindingLegacyConstants.LIGHT_LEVEL_ABOVE_THRESHOLD, InsteonBindingLegacyConstants.LOAD_DIMMER,
            InsteonBindingLegacyConstants.LOAD_SWITCH, InsteonBindingLegacyConstants.LOAD_SWITCH_FAST_ON_OFF,
            InsteonBindingLegacyConstants.LOAD_SWITCH_MANUAL_CHANGE, InsteonBindingLegacyConstants.LOWBATTERY,
            InsteonBindingLegacyConstants.MANUAL_CHANGE, InsteonBindingLegacyConstants.MANUAL_CHANGE_BUTTON_A,
            InsteonBindingLegacyConstants.MANUAL_CHANGE_BUTTON_B, InsteonBindingLegacyConstants.MANUAL_CHANGE_BUTTON_C,
            InsteonBindingLegacyConstants.MANUAL_CHANGE_BUTTON_D, InsteonBindingLegacyConstants.MANUAL_CHANGE_BUTTON_E,
            InsteonBindingLegacyConstants.MANUAL_CHANGE_BUTTON_F, InsteonBindingLegacyConstants.MANUAL_CHANGE_BUTTON_G,
            InsteonBindingLegacyConstants.MANUAL_CHANGE_BUTTON_H, InsteonBindingLegacyConstants.NOTIFICATION,
            InsteonBindingLegacyConstants.ON_LEVEL, InsteonBindingLegacyConstants.RAMP_DIMMER,
            InsteonBindingLegacyConstants.RAMP_RATE, InsteonBindingLegacyConstants.RESET,
            InsteonBindingLegacyConstants.STAGE1_DURATION, InsteonBindingLegacyConstants.SWITCH,
            InsteonBindingLegacyConstants.SYSTEM_MODE, InsteonBindingLegacyConstants.TAMPER_SWITCH,
            InsteonBindingLegacyConstants.TEMPERATURE, InsteonBindingLegacyConstants.TEMPERATURE_LEVEL,
            InsteonBindingLegacyConstants.TOP_OUTLET, InsteonBindingLegacyConstants.UPDATE,
            InsteonBindingLegacyConstants.WATTS).collect(Collectors.toSet()));
    ...
    public void initialize() {
        ...
        scheduler.execute(() -> {
            ...
            InsteonLegacyDevice device = insteonBinding.makeNewDevice(insteonAddress, productKey, deviceConfigMap);
            if (device == null) {
            ...
            for (String channelId : ALL_CHANNEL_IDS) {
                ...
                if (productKey.equals(HIDDEN_DOOR_SENSOR_PRODUCT_KEY)) {
                    if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_LEVEL)
                            || feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_WATERMARK_LEVEL)) {
                        feature = DATA;
                    }
                } else if (productKey.equals(MOTION_SENSOR_PRODUCT_KEY)) {
                    if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_LEVEL)
                            || feature.equalsIgnoreCase(InsteonBindingLegacyConstants.LIGHT_LEVEL)) {
                        feature = DATA;
                    }
                } else if (productKey.equals(MOTION_SENSOR_II_PRODUCT_KEY)) {
                    if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_LEVEL)
                            || feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_PERCENT)
                            || feature.equalsIgnoreCase(InsteonBindingLegacyConstants.LIGHT_LEVEL)
                            || feature.equalsIgnoreCase(InsteonBindingLegacyConstants.TEMPERATURE_LEVEL)) {
                        feature = DATA;
                    }
                } else if (productKey.equals(PLM_PRODUCT_KEY)) {
                    String[] parts = feature.split("#");
                    if (parts.length == 2 && parts[0].equalsIgnoreCase(InsteonBindingLegacyConstants.BROADCAST_ON_OFF)
                            && parts[1].matches("^\\d+$")) {
                        feature = BROADCAST_ON_OFF;
                    }
                } else if (productKey.equals(POWER_METER_PRODUCT_KEY)) {
                    if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.KWH)
                            || feature.equalsIgnoreCase(InsteonBindingLegacyConstants.RESET)
                            || feature.equalsIgnoreCase(InsteonBindingLegacyConstants.UPDATE)
                            || feature.equalsIgnoreCase(InsteonBindingLegacyConstants.WATTS)) {
                        feature = METER;
                    }
                }
                ...
                if (f != null) {
                    if (!f.isFeatureGroup()) {
                        if (channelId.equals(InsteonBindingLegacyConstants.BROADCAST_ON_OFF)) {
                            Set<String> broadcastChannels = new HashSet<>();
                            for (Channel channel : thing.getChannels()) {
                                String id = channel.getUID().getId();
                                if (id.startsWith(InsteonBindingLegacyConstants.BROADCAST_ON_OFF)) {
                                ...
                                if (groups instanceof List<?> list) {
                                    ...
                                    for (Object o : list) {
                                        if (o instanceof Double && (Double) o % 1 == 0) {
                                            String id = InsteonBindingLegacyConstants.BROADCAST_ON_OFF + "#"
                                                    + ((Double) o).intValue();
                                            if (!broadcastChannels.contains(id)) {
                                                ...
                                                ChannelTypeUID channelTypeUID = new ChannelTypeUID(
                                                        ...
                                                        InsteonBindingLegacyConstants.SWITCH);
    ...
    public void channelLinked(ChannelUID channelUID) {
        ...
        if (productKey.equals(HIDDEN_DOOR_SENSOR_PRODUCT_KEY)) {
            if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_LEVEL)) {
                ...
                feature = DATA;
            } else if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_WATERMARK_LEVEL)) {
            ...
            if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_LEVEL)) {
                params.put(FIELD, FIELD_BATTERY_LEVEL);
                feature = DATA;
            } else if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.LIGHT_LEVEL)) {
            ...
            if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_LEVEL)) {
                params.put(FIELD, FIELD_BATTERY_LEVEL);
                feature = DATA;
            } else if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.BATTERY_PERCENT)) {
                params.put(FIELD, FIELD_BATTERY_PERCENTAGE);
                feature = DATA;
            } else if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.LIGHT_LEVEL)) {
                params.put(FIELD, FIELD_LIGHT_LEVEL);
                feature = DATA;
            } else if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.TEMPERATURE_LEVEL)) {
            ...
            } else if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.WATTS)) {
                params.put(FIELD, FIELD_WATTS);
            } else if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.RESET)) {
                params.put(CMD, CMD_RESET);
            } else if (feature.equalsIgnoreCase(InsteonBindingLegacyConstants.UPDATE)) {
