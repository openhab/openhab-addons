...
public class InsteonChannelHandler implements FeatureListener {
    ...
    private InsteonV2ChannelConfiguration config;
    private DeviceFeature feature;
    private InsteonThingHandler handler;

    public InsteonChannelHandler(ChannelUID channelUID, InsteonV2ChannelConfiguration config, DeviceFeature feature,
    ...
    public static InsteonChannelHandler makeHandler(Channel channel, DeviceFeature feature,
        ...
        InsteonV2ChannelConfiguration config = channel.getConfiguration().as(InsteonV2ChannelConfiguration.class);
