...
public class InsteonLegacyCommandExtension extends AbstractConsoleCommandExtension implements MsgListener {
    ...
    private void sendMessage(Console console, MessageType messageType, String[] args) {
        InsteonLegacyDevice device = new InsteonLegacyDevice();
