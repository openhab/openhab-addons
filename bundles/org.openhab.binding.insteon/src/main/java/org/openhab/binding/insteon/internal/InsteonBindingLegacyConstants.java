...
/**
 * The {@link InsteonBindingLegacyConstants} class defines common constants, which are
 * used across the legacy part of the binding.
 *
 * @author Rob Nielsen - Initial contribution
 */
@NonNullByDefault
public class InsteonBindingLegacyConstants {

    // List of all Thing Type UIDs
    public static final ThingTypeUID DEVICE_THING_TYPE = new ThingTypeUID(InsteonBindingConstants.BINDING_ID, "device");
    public static final ThingTypeUID NETWORK_THING_TYPE = new ThingTypeUID(InsteonBindingConstants.BINDING_ID,
            "network");

    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Set.of(DEVICE_THING_TYPE, NETWORK_THING_TYPE);
