...
public abstract class CommandHandler extends FeatureBaseHandler {
     ...
     */
    public abstract void handleCommand(InsteonV2ChannelConfiguration config, Command cmd);
    ...
    public abstract static class OnOffCommandHandler extends CommandHandler {
        ...
        protected int getCommandCode(InsteonV2ChannelConfiguration config, Command cmd) {
            return OnOffType.OFF.equals(cmd) ? getParameterAsInteger("off", 0x13) : getParameterAsInteger("on", 0x11);
        }

        protected int getLevel(InsteonV2ChannelConfiguration config, Command cmd) {
            return OnOffType.OFF.equals(cmd) ? 0x00 : getOnLevel(config);
        }

        protected int getGroup(InsteonV2ChannelConfiguration config) {
            return -1;
        }

        private int getOnLevel(InsteonV2ChannelConfiguration config) {
    ...
    public static class DimmerOnOffCommandHandler extends OnOffCommandHandler {
        ...
        protected PercentType getState(InsteonV2ChannelConfiguration config, Command cmd) {
        ...
        private void setInstantDimmer(InsteonV2ChannelConfiguration config, Command cmd) {
        ...
        private void setRampDimmer(InsteonV2ChannelConfiguration config, Command cmd) {
    ...
    public static class RampDimmerCommandHandler extends InstantDimmerCommandHandler {
        ...
        private RampRate getRampRate(InsteonV2ChannelConfiguration config) {
    ...
    public static class KeypadButtonOnOffCommandHandler extends CustomBitmaskCommandHandler {
        ...
        private void sendBroadcastOnOff(InsteonV2ChannelConfiguration config, Command cmd) {
    ...
    public static class LEDBrightnessCommandHandler extends CommandHandler {
        ...
        private void setLEDOnOff(InsteonV2ChannelConfiguration config, Command cmd) {
    ...
    public static class IMLEDOnOffCommandHandler extends IMCommandHandler {
        ...
        private void setLEDControl(InsteonV2ChannelConfiguration config) {
