...
import org.openhab.binding.smsmodem.internal.smslib.modem.Capabilities;
...
import org.openhab.binding.smsmodem.internal.smslib.modem.ModemResponse;
...
public abstract class AbstractModemDriver {
    ...
    PollReader pollReader = new PollReader();
    ...
    public class PollReader extends Thread {
        ...
        public void run() {
            ...
            while (!this.shouldCancel) {
                ...
                countSheeps(Integer.valueOf(getModemSettings("poll_reader")));
            }
