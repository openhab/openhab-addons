...
/**
 * Set a "relax" effect on a device.
 *
 * @author Mike Jagdis - Initial contribution
 */
@NonNullByDefault
public final class LightifyEffectRelax extends LightifyEffect {

    public LightifyEffectRelax(LightifyBridgeHandler bridgeHandler, LightifyDeviceHandler deviceHandler, String name) {
    ...
    public void start() {
        ...
        deviceHandler.setTemperature(bridgeHandler, new DecimalType(2700));
    }
}
