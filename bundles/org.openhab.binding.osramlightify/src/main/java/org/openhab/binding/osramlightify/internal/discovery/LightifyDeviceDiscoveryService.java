...
public final class LightifyDeviceDiscoveryService extends AbstractDiscoveryService {
    ...
    private final static LightifyListGroupsMessage listGroups = new LightifyListGroupsMessage();
    private final static LightifyListPairedDevicesMessage listPaired = new LightifyListPairedDevicesMessage();
    ...
    protected void startScan() {
        ...
        bridgeHandler.sendMessage(listPaired);
    }
