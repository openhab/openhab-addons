...
public class EndpointRegistry implements Serializable {
    ...
    private final Map<Endpoint, org.openhab.binding.httphook.internal.endpoint.Endpoint> registry = new HashMap<>();

    public Optional<org.openhab.binding.httphook.internal.endpoint.Endpoint> find(String path,
    ...
    public void register(String path, DispatcherServlet.Method method,
            org.openhab.binding.httphook.internal.endpoint.Endpoint endpoint) throws RegistrationException {
        lock.writeLock().lock();
        try {
