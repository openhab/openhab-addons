...
class AuthorizationServiceTest {
    @Mock
    private HttpHookBinding httpHookBinding;
    ...
    void authorizeAcceptsMatchingRequiredBasicAuthorization() {
        ...
        verify(httpHookBinding, times(1)).getConfig();
    }
    ...
    void authorizeUsesDefaultBasicWhenEndpointAuthorizationMissing() {
        // Given
        var config = new HttpHookBindingConfig(false, "john:secret", null);
        when(httpHookBinding.getConfig()).thenReturn(config);
    ...
    void authorizeUsesDefaultBearerWhenEndpointAuthorizationMissing() {
        // Given
        var config = new HttpHookBindingConfig(false, null, "token-123");
        when(httpHookBinding.getConfig()).thenReturn(config);
    ...
    void authorizeFailsWhenEffectiveAuthorizationMissingAndEnforced() {
        assertMissingEffectiveAuthorizationEnforced(new HttpHookBindingConfig(true, null, null), null);
        assertMissingEffectiveAuthorizationEnforced(new HttpHookBindingConfig(true, null, null), "Digest something");
        assertMissingEffectiveAuthorizationEnforced(new HttpHookBindingConfig(true, "invalid-format", null),
                basicHeader("john", "secret"));
        assertMissingEffectiveAuthorizationEnforced(new HttpHookBindingConfig(true, null, null),
                Authorization.BEARER_PREFIX + "token-123");
    }

    @Test
    void authorizeAllowsWhenEffectiveAuthorizationMissingAndNotEnforced() {
        assertMissingEffectiveAuthorizationNotEnforced(new HttpHookBindingConfig(false, null, null), null);
        assertMissingEffectiveAuthorizationNotEnforced(new HttpHookBindingConfig(false, null, null),
                "Digest something");
        assertMissingEffectiveAuthorizationNotEnforced(new HttpHookBindingConfig(false, "invalid-format", null),
                basicHeader("john", "secret"));
        assertMissingEffectiveAuthorizationNotEnforced(new HttpHookBindingConfig(false, null, null),
                Authorization.BEARER_PREFIX + "token-123");
    }
    ...
    private void assertMissingEffectiveAuthorizationEnforced(HttpHookBindingConfig config, String provided) {
        // Given
        when(httpHookBinding.getConfig()).thenReturn(config);
    ...
    private void assertMissingEffectiveAuthorizationNotEnforced(HttpHookBindingConfig config, String provided) {
        // Given
        when(httpHookBinding.getConfig()).thenReturn(config);
