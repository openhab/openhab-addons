...
public class WallThermostatStateMsg extends BaseMsg
    ...
    private static final int WALL_THERMOSTAT_STATE_SHORT_PAYLOAD_LEN = 3; /*
                                                                           * in
                                                                           * bytes
                                                                           * -
                                                                           * status
                                                                           ...
                                                                           * temp
                                                                           */
    private static final int WALL_THERMOSTAT_STATE_PAIR_THERM_PAYLOAD_LEN = 5; /*
                                                                                * in
                                                                                * bytes
                                                                                * -
                                                                                * same
                                                                                ...
                                                                                * temp
                                                                                */
    private static final int WALL_THERMOSTAT_STATE_UNTIL_PAYLOAD_LEN = 6; /*
                                                                           * in
                                                                           * bytes
                                                                           * -
                                                                           * same
                                                                           ...
                                                                           * until
                                                                           */
    private static final int WALL_THERMOSTAT_STATE_TEMP_PAYLOAD_LEN = 7; /*
                                                                          * in
                                                                          * bytes
                                                                          * -
                                                                          * same
    ...
    private final Logger logger = LoggerFactory.getLogger(WallThermostatStateMsg.class);
    ...
    public WallThermostatStateMsg(String rawMsg) throws MaxCulProtocolException {
        super(rawMsg);
