...
public class ConfigWeekProfileMsg extends BaseMsg {
    ...
    private static final int CONFIG_WEEK_PROFILE_LONG_PAYLOAD_LEN = 15; /* in bytes */
    private static final int CONFIG_WEEK_PROFILE_SHORT_PAYLOAD_LEN = 13; /* in bytes */

    private final Logger logger = LoggerFactory.getLogger(ConfigWeekProfileMsg.class);

    public static final MaxCulWeekProfile DEFAULT_WEEK_PROFILE;

    private final MaxCulWeekProfilePart weekProfile;
    ...
    static {
        ...
        {
            MaxCulWeekProfilePart saturday = new MaxCulWeekProfilePart(MaxCulWeekdays.SATURDAY);
        ...
        {
            MaxCulWeekProfilePart sunday = new MaxCulWeekProfilePart(MaxCulWeekdays.SUNDAY);
        ...
        {
            MaxCulWeekProfilePart monday = new MaxCulWeekProfilePart(MaxCulWeekdays.MONDAY);
        ...
        {
            MaxCulWeekProfilePart tuesday = new MaxCulWeekProfilePart(MaxCulWeekdays.TUESDAY);
        ...
        {
            MaxCulWeekProfilePart wendsday = new MaxCulWeekProfilePart(MaxCulWeekdays.WENDSDAY);
        ...
        {
            MaxCulWeekProfilePart thursday = new MaxCulWeekProfilePart(MaxCulWeekdays.THURSDAY);
        ...
        {
            MaxCulWeekProfilePart friday = new MaxCulWeekProfilePart(MaxCulWeekdays.FRIDAY);
    ...
    public ConfigWeekProfileMsg(String rawMsg) throws MaxCulProtocolException {
        super(rawMsg);
        ...
        throw new MaxCulProtocolException("Invalid length for " + this.msgType.name());
    }
    ...
    private MaxCulWeekProfilePart parseWeekProfile() {
        ...
        MaxCulWeekProfilePart result = new MaxCulWeekProfilePart(MaxCulWeekdays.getWeekDayFromInt(day));
        ...
        for (int j = 1; j < (secondHalf ? 12 : 14); j += 2) {
            ...
            int currentControlPoint = payload[j];
            currentControlPoint = currentControlPoint << 8;
            currentControlPoint |= payload[j + 1] & 0xFF;
