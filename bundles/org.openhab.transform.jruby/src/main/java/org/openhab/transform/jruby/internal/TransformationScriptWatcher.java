 ...
 * detected, the script is passed to the {@link JRubyEngineManager}.
 *
...
public class TransformationScriptWatcher extends AbstractWatchService {
    ...
    @Activate
    public TransformationScriptWatcher(final @Reference JRubyEngineManager manager) {
    ...
    protected void processWatchEvent(WatchEvent<?> event, Kind<?> kind, Path path) {
        ...
        logger.debug("Reloading Ruby file {}.", filename);
