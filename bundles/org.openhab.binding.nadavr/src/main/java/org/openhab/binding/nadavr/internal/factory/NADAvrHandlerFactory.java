...
import static org.openhab.binding.nadavr.internal.NADAvrBindingConstants.THING_TYPE_AVR;
...
public class NADAvrHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_AVR.equals(thingTypeUID)) {
            return new NADAvrHandler(thing);
        }
