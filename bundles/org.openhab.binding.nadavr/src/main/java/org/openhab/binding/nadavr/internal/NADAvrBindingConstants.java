...
public class NADAvrBindingConstants {
    ...
    public static final String CHANNEL_MAIN_LISTENING_MODE = "main#listeningMode";
    public static final String CHANNEL_MAIN_VOLUME = "main#volume";
    public static final String CHANNEL_MAIN_VOLUME_DB = "main#volumeDB";
    public static final String CHANNEL_MAIN_MUTE = "main#mute";
