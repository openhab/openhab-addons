...
/**
 * The {@link VigieCruesBindingConstants} class defines common constants, which are
 * used across the whole binding.
 *
 * @author Gaël L'hopital - Initial contribution
 */
@NonNullByDefault
public class VigieCruesBindingConstants {

    public static final String BINDING_ID = "vigiecrues";

    // List of all Thing Type UIDs
    public static final ThingTypeUID THING_TYPE_VIGIE_CRUES = new ThingTypeUID(BINDING_ID, "station");
    ...
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(THING_TYPE_VIGIE_CRUES);
}
