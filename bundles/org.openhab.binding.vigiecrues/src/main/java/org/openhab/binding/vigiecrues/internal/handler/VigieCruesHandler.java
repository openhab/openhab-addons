 ...
 */
package org.openhab.binding.vigiecrues.internal.handler;
...
import org.openhab.binding.vigiecrues.internal.VigieCruesConfiguration;
import org.openhab.binding.vigiecrues.internal.json.ApiResponse;
...
/**
 * The {@link VigieCruesHandler} is responsible for updating channels
 * and querying the API
 *
 * @author Gaël L'hopital - Initial contribution
 */
@NonNullByDefault
public class VigieCruesHandler extends BaseThingHandler {
    ...
    private final Logger logger = LoggerFactory.getLogger(VigieCruesHandler.class);
    ...
    public VigieCruesHandler(Thing thing, TimeZoneProvider timeZoneProvider) {
        super(thing);
    ...
    public void initialize() {
        ...
        VigieCruesConfiguration config = getConfigAs(VigieCruesConfiguration.class);
        logger.debug("config station = {}", config.station);
        logger.debug("config refresh = {}", config.refresh);

        updateStatus(ThingStatus.UNKNOWN);
        queryUrl = URL + config.station;
