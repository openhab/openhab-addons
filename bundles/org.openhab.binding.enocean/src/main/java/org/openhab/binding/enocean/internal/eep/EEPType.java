...
public enum EEPType {
    ...
    MultiFunctionSensor_30(RORG.VLD, 0x14, 0x30, false, D2_14_30.class, THING_TYPE_MULTFUNCTIONSMOKEDETECTOR, CHANNEL_SMOKEDETECTION,
            CHANNEL_SENSORFAULT, CHANNEL_TIMESINCELASTMAINTENANCE, CHANNEL_BATTERY_LEVEL, CHANNEL_REMAININGPLT, CHANNEL_TEMPERATURE,
            CHANNEL_HUMIDITY, CHANNEL_HYGROCOMFORTINDEX, CHANNEL_INDOORAIRANALYSIS);
