...
| Uptimes                            |                          |                                 |                                                                                             | true      | yes      |
| times#level0Time                   | Number:Time              | Level 0 duration                | Uptime at level 0 (away)                                                                    | true      | no       |
| times#level1Time                   | Number:Time              | Level 1 duration                | Uptime at level 1                                                                           | true      | no       |
| times#level2Time                   | Number:Time              | Level 2 duration                | Uptime at level 2                                                                           | true      | no       |
| times#level3Time                   | Number:Time              | Level 3 duration                | Uptime at level 3                                                                           | true      | no       |
| times#freezeTime                   | Number:Time              | Antifrost Duration              | Uptime of antifrost                                                                         | true      | no       |
| times#preheaterTime                | Number:Time              | Preheater Duration              | Uptime of preheater                                                                         | true      | no       |
| times#bypassTime                   | Number:Time              | Bypass Duration                 | Hours of bypass open                                                                        | true      | no       |
...
| Error States                       |                          |                                 |                                                                                             |           |          |
| errors#filterError                 | Switch                   | Filter Error                    | Filter full                                                                                 | false     | no       |
| errors#errorMessage                | String                   | Error Message                   | Current errors                                                                              | false     | no       |
| errors#errorACurrent               | String                   | Error A Current                 | Current error A                                                                             | true      | no       |
| errors#errorECurrent               | String                   | Error E Current                 | Current error E                                                                             | true      | no       |
| errors#errorALast                  | String                   | Error A Last                    | Last error A                                                                                | true      | no       |
| errors#errorELast                  | String                   | Error E Last                    | Last error E                                                                                | true      | no       |
| errors#errorAPrelast               | String                   | Error A Prelast                 | Prelast error A                                                                             | true      | no       |
| errors#errorEPrelast               | String                   | Error E Prelast                 | Prelast error E                                                                             | true      | no       |
| errors#errorAPrePrelast            | String                   | Error A Pre-Prelast             | Pre-Prelast error A                                                                         | true      | no       |
| errors#errorEPrePrelast            | String                   | Error E Pre-Prelast             | Pre-Prelast error E                                                                         | true      | no       |
| errors#errorEACurrent              | String                   | Error EA Current                | Current error EA                                                                            | true      | no       |
| errors#errorEALast                 | String                   | Error EA Last                   | Last error EA                                                                               | true      | no       |
| errors#errorEAPrelast              | String                   | Error EA Prelast                | Prelast error EA                                                                            | true      | no       |
| errors#errorEAPrePrelast           | String                   | Error EA Pre-Prelast            | Pre-Prelast error EA                                                                        | true      | no       |
| errors#errorAHighCurrent           | String                   | Error A (high) Current          | Current error A (high)                                                                      | true      | no       |
| errors#errorAHighLast              | String                   | Error A (high) Last             | Last error A (high)                                                                         | true      | no       |
| errors#errorAHighPrelast           | String                   | Error A (high) Prelast          | Prelast error A (high)                                                                      | true      | no       |
| errors#errorAHighPrePrelast        | String                   | Error A (high) Pre-Prelast      | Pre-Prelast error A (high)                                                                  | true      | no       |
