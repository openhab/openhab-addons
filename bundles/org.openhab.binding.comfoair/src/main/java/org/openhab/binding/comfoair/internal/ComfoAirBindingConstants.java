...
public class ComfoAirBindingConstants {
    ...
    public static final String CG_ANALOG_PREFIX = "analog#";
    ...
    // Analog channels
    public static final String CHANNEL_IS_ANALOG1 = "isAnalog1";
    public static final String CHANNEL_IS_ANALOG2 = "isAnalog2";
    public static final String CHANNEL_IS_ANALOG3 = "isAnalog3";
    public static final String CHANNEL_IS_ANALOG4 = "isAnalog4";
    public static final String CHANNEL_IS_RF = "isRF";
    public static final String CHANNEL_ANALOG1_MODE = "analog1Mode";
    public static final String CHANNEL_ANALOG2_MODE = "analog2Mode";
    public static final String CHANNEL_ANALOG3_MODE = "analog3Mode";
    public static final String CHANNEL_ANALOG4_MODE = "analog4Mode";
    public static final String CHANNEL_RF_MODE = "RFMode";
    public static final String CHANNEL_ANALOG1_NEGATIVE = "analog1Negative";
    public static final String CHANNEL_ANALOG2_NEGATIVE = "analog2Negative";
    public static final String CHANNEL_ANALOG3_NEGATIVE = "analog3Negative";
    public static final String CHANNEL_ANALOG4_NEGATIVE = "analog4Negative";
    public static final String CHANNEL_RF_NEGATIVE = "RFNegative";
    public static final String CHANNEL_ANALOG1_VOLT = "analog1Volt";
    public static final String CHANNEL_ANALOG1_MIN = "analog1Min";
    public static final String CHANNEL_ANALOG1_MAX = "analog1Max";
    public static final String CHANNEL_ANALOG1_VALUE = "analog1Value";
    public static final String CHANNEL_ANALOG2_VOLT = "analog2Volt";
    public static final String CHANNEL_ANALOG2_MIN = "analog2Min";
    public static final String CHANNEL_ANALOG2_MAX = "analog2Max";
    public static final String CHANNEL_ANALOG2_VALUE = "analog2Value";
    public static final String CHANNEL_ANALOG3_VOLT = "analog3Volt";
    public static final String CHANNEL_ANALOG3_MIN = "analog3Min";
    public static final String CHANNEL_ANALOG3_MAX = "analog3Max";
    public static final String CHANNEL_ANALOG3_VALUE = "analog3Value";
    public static final String CHANNEL_ANALOG4_VOLT = "analog4Volt";
    public static final String CHANNEL_ANALOG4_MIN = "analog4Min";
    public static final String CHANNEL_ANALOG4_MAX = "analog4Max";
    public static final String CHANNEL_ANALOG4_VALUE = "analog4Value";
