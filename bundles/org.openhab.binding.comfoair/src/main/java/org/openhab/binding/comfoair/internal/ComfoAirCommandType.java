...
public enum ComfoAirCommandType {
    ...
    BATHROOM_START_DELAY(ComfoAirBindingConstants.CG_MENUP2_PREFIX + ComfoAirBindingConstants.CHANNEL_BR_START_DELAY,
            DataTypeNumber.getInstance(), Constants.REQUEST_SET_DELAYS, 8, 0,
            new String[] { ComfoAirBindingConstants.CG_MENUP1_PREFIX + ComfoAirBindingConstants.CHANNEL_MENU21_MODE },
    ...
    BATHROOM_END_DELAY(ComfoAirBindingConstants.CG_MENUP2_PREFIX + ComfoAirBindingConstants.CHANNEL_BR_END_DELAY,
            DataTypeNumber.getInstance(), Constants.REQUEST_SET_DELAYS, 8, 1,
            new String[] { ComfoAirBindingConstants.CG_MENUP1_PREFIX + ComfoAirBindingConstants.CHANNEL_MENU22_MODE },
    ...
    L1_END_DELAY(ComfoAirBindingConstants.CG_MENUP2_PREFIX + ComfoAirBindingConstants.CHANNEL_L1_END_DELAY,
            DataTypeNumber.getInstance(), Constants.REQUEST_SET_DELAYS, 8, 2,
            new String[] { ComfoAirBindingConstants.CG_MENUP1_PREFIX + ComfoAirBindingConstants.CHANNEL_MENU27_MODE },
    ...
    PULSE_VENTILATION(ComfoAirBindingConstants.CG_MENUP2_PREFIX + ComfoAirBindingConstants.CHANNEL_PULSE_VENTILATION,
            DataTypeNumber.getInstance(), Constants.REQUEST_SET_DELAYS, 8, 3,
            new String[] { ComfoAirBindingConstants.CG_MENUP1_PREFIX + ComfoAirBindingConstants.CHANNEL_MENU23_MODE },
    ...
    FILTER_WEEKS(ComfoAirBindingConstants.CG_MENUP2_PREFIX + ComfoAirBindingConstants.CHANNEL_FILTER_WEEKS,
            ...
            new String[] { ComfoAirBindingConstants.CG_MENUP1_PREFIX + ComfoAirBindingConstants.CHANNEL_MENU24_MODE },
    ...
    RF_SHORT_DELAY(ComfoAirBindingConstants.CG_MENUP2_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_SHORT_DELAY,
            DataTypeNumber.getInstance(), Constants.REQUEST_SET_DELAYS, 8, 5,
            new String[] { ComfoAirBindingConstants.CG_MENUP1_PREFIX + ComfoAirBindingConstants.CHANNEL_MENU25_MODE },
    ...
    RF_LONG_DELAY(ComfoAirBindingConstants.CG_MENUP2_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_LONG_DELAY,
            DataTypeNumber.getInstance(), Constants.REQUEST_SET_DELAYS, 8, 6,
            new String[] { ComfoAirBindingConstants.CG_MENUP1_PREFIX + ComfoAirBindingConstants.CHANNEL_MENU26_MODE },
    ...
    COOKERHOOD_DELAY(ComfoAirBindingConstants.CG_MENUP2_PREFIX + ComfoAirBindingConstants.CHANNEL_COOKERHOOD_DELAY,
            DataTypeNumber.getInstance(), Constants.REQUEST_SET_DELAYS, 8, 7,
            new String[] { ComfoAirBindingConstants.CG_MENUP1_PREFIX + ComfoAirBindingConstants.CHANNEL_MENU20_MODE },
    ...
    FAN_OUT_0(ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_0,
            ...
            new String[] {
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_RPM },
            Constants.REQUEST_GET_FAN_LEVEL, Constants.REPLY_GET_FAN_LEVEL, new int[] { 0 }),
    FAN_OUT_1(ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_1,
            ...
            new String[] {
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_RPM },
            Constants.REQUEST_GET_FAN_LEVEL, Constants.REPLY_GET_FAN_LEVEL, new int[] { 1 }),
    FAN_OUT_2(ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_2,
            ...
            new String[] {
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_RPM },
            Constants.REQUEST_GET_FAN_LEVEL, Constants.REPLY_GET_FAN_LEVEL, new int[] { 2 }),
    FAN_OUT_3(ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_3,
            ...
            new String[] {
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_RPM },
            Constants.REQUEST_GET_FAN_LEVEL, Constants.REPLY_GET_FAN_LEVEL, new int[] { 10 }),
    FAN_IN_0(ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_0,
            ...
            new String[] {
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_RPM },
            Constants.REQUEST_GET_FAN_LEVEL, Constants.REPLY_GET_FAN_LEVEL, new int[] { 3 }),
    FAN_IN_1(ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_1,
            ...
            new String[] {
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_RPM },
            Constants.REQUEST_GET_FAN_LEVEL, Constants.REPLY_GET_FAN_LEVEL, new int[] { 4 }),
    FAN_IN_2(ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_2,
            ...
            new String[] {
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_RPM },
            Constants.REQUEST_GET_FAN_LEVEL, Constants.REPLY_GET_FAN_LEVEL, new int[] { 5 }),
    FAN_IN_3(ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_3,
            ...
            new String[] {
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_RPM },
            Constants.REQUEST_GET_FAN_LEVEL, Constants.REPLY_GET_FAN_LEVEL, new int[] { 11 }),
    ...
    FAN_OÚT_PERCENT(ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_PERCENT,
    ...
    TARGET_TEMPERATUR(ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_TARGET,
            DataTypeTemperature.getInstance(), Constants.REQUEST_SET_TEMPS, 1, 0,
            new String[] { ComfoAirBindingConstants.CG_BYPASS_PREFIX + ComfoAirBindingConstants.CHANNEL_BYPASS_FACTOR,
                    ComfoAirBindingConstants.CG_BYPASS_PREFIX + ComfoAirBindingConstants.CHANNEL_BYPASS_LEVEL,
                    ComfoAirBindingConstants.CG_BYPASS_PREFIX + ComfoAirBindingConstants.CHANNEL_BYPASS_SUMMER },
    ...
    IS_COOKERHOOD_SENSOR(
            ...
            DataTypeBoolean.getInstance(), Constants.REQUEST_GET_TEMPS, Constants.REPLY_GET_TEMPS, new int[] { 5 },
            0x40),
    EWT_TEMPERATUR(ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_EWT,
            DataTypeTemperature.getInstance(), Constants.REQUEST_GET_TEMPS, Constants.REPLY_GET_TEMPS, new int[] { 6 }),
    HEATER_TEMPERATUR(ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_HEATER,
            DataTypeTemperature.getInstance(), Constants.REQUEST_GET_TEMPS, Constants.REPLY_GET_TEMPS, new int[] { 7 }),
    COOKERHOOD_TEMPERATUR(ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_COOKERHOOD,
            DataTypeTemperature.getInstance(), Constants.REQUEST_GET_TEMPS, Constants.REPLY_GET_TEMPS, new int[] { 8 }),
    IS_PREHEATER(ComfoAirBindingConstants.PROPERTY_OPTION_PREHEATER,
            DataTypeBoolean.getInstance(), Constants.REQUEST_SET_STATES, 8, 0,
            new String[] { ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_OUTDOOR_IN,
                    ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_INDOOR_IN,
                    ComfoAirBindingConstants.CG_PREHEATER_PREFIX
                            + ComfoAirBindingConstants.CHANNEL_PREHEATER_FROST_PROTECT,
                    ComfoAirBindingConstants.CG_PREHEATER_PREFIX
                            + ComfoAirBindingConstants.CHANNEL_PREHEATER_FROST_TIME,
                    ComfoAirBindingConstants.CG_PREHEATER_PREFIX + ComfoAirBindingConstants.CHANNEL_PREHEATER_HEATING,
                    ComfoAirBindingConstants.CG_MENUP9_PREFIX + ComfoAirBindingConstants.CHANNEL_FROST_STATE,
                    ComfoAirBindingConstants.CG_PREHEATER_PREFIX + ComfoAirBindingConstants.CHANNEL_PREHEATER_SAFETY,
                    ComfoAirBindingConstants.CG_TIMES_PREFIX + ComfoAirBindingConstants.CHANNEL_TIME_PREHEATER,
                    ComfoAirBindingConstants.CG_PREHEATER_PREFIX + ComfoAirBindingConstants.CHANNEL_PREHEATER_VALVE },
            Constants.REQUEST_GET_STATES, Constants.REPLY_GET_STATES, new int[] { 0 }),
    IS_BYPASS(ComfoAirBindingConstants.PROPERTY_OPTION_BYPASS,
            DataTypeBoolean.getInstance(), Constants.REQUEST_SET_STATES, 8, 1,
            new String[] { ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_INDOOR_IN,
                    ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_OUTDOOR_OUT },
            Constants.REQUEST_GET_STATES, Constants.REPLY_GET_STATES, new int[] { 1 }),
    RECU_TYPE(ComfoAirBindingConstants.PROPERTY_OPTION_RECU_TYPE,
            ...
            new String[] {
                    ...
                    ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_INDOOR_IN,
                    ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_OUTDOOR_OUT,
                    ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_INDOOR_OUT,
                    ComfoAirBindingConstants.CG_TEMPS_PREFIX + ComfoAirBindingConstants.CHANNEL_TEMP_OUTDOOR_IN },
            Constants.REQUEST_GET_STATES, Constants.REPLY_GET_STATES, new int[] { 2 }),
    RECU_SIZE(ComfoAirBindingConstants.PROPERTY_OPTION_RECU_SIZE,
            DataTypeNumber.getInstance(), new int[] { 0x01, 0x02 }, Constants.REQUEST_SET_STATES, 8, 3,
            new String[] {
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_PERCENT,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_0,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_1,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_2,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_OUT_3,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_0,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_1,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_2,
                    ComfoAirBindingConstants.CG_VENTILATION_PREFIX + ComfoAirBindingConstants.CHANNEL_FAN_IN_3 },
            Constants.REQUEST_GET_STATES, Constants.REPLY_GET_STATES, new int[] { 3 }),
    IS_CHIMNEY(ComfoAirBindingConstants.PROPERTY_OPTION_CHIMNEY,
            ...
            0x01),
    IS_COOKERHOOD(ComfoAirBindingConstants.PROPERTY_OPTION_COOKERHOOD,
            DataTypeBoolean.getInstance(), new int[] { 0x02 }, Constants.REQUEST_SET_STATES, 8, 4,
            new String[] {
                    ComfoAirBindingConstants.CG_MENUP2_PREFIX + ComfoAirBindingConstants.CHANNEL_COOKERHOOD_DELAY,
                    ComfoAirBindingConstants.CG_MENUP9_PREFIX + ComfoAirBindingConstants.CHANNEL_COOKERHOOD_STATE,
                    ComfoAirBindingConstants.CG_COOKERHOOD_PREFIX + ComfoAirBindingConstants.CHANNEL_COOKERHOOD_SPEED,
    ...
    IS_HEATER(ComfoAirBindingConstants.PROPERTY_OPTION_HEATER,
            ...
            new String[] {
                    ...
                    ComfoAirBindingConstants.CG_HEATER_PREFIX + ComfoAirBindingConstants.CHANNEL_HEATER_POWER_I,
    ...
    IS_ENTHALPY(ComfoAirBindingConstants.PROPERTY_OPTION_ENTHALPY,
            DataTypeNumber.getInstance(), new int[] { 0x00, 0x01, 0x02 }, Constants.REQUEST_SET_STATES, 8, 6,
            new String[] { ComfoAirBindingConstants.CG_ENTHALPY_PREFIX + ComfoAirBindingConstants.CHANNEL_ENTHALPY_TEMP,
                    ComfoAirBindingConstants.CG_ENTHALPY_PREFIX + ComfoAirBindingConstants.CHANNEL_ENTHALPY_HUMIDITY,
                    ComfoAirBindingConstants.CG_ENTHALPY_PREFIX + ComfoAirBindingConstants.CHANNEL_ENTHALPY_LEVEL,
                    ComfoAirBindingConstants.CG_MENUP9_PREFIX + ComfoAirBindingConstants.CHANNEL_ENTHALPY_STATE,
                    ComfoAirBindingConstants.CG_ENTHALPY_PREFIX + ComfoAirBindingConstants.CHANNEL_ENTHALPY_TIME },
            Constants.REQUEST_GET_STATES, Constants.REPLY_GET_STATES, new int[] { 9 }),
    IS_EWT(ComfoAirBindingConstants.PROPERTY_OPTION_EWT,
            DataTypeNumber.getInstance(), new int[] { 0x00, 0x01, 0x02 }, Constants.REQUEST_SET_STATES, 8, 7,
            new String[] { ComfoAirBindingConstants.CG_EWT_PREFIX + ComfoAirBindingConstants.CHANNEL_EWT_SPEED,
                    ComfoAirBindingConstants.CG_EWT_PREFIX + ComfoAirBindingConstants.CHANNEL_EWT_TEMP_LOW,
                    ComfoAirBindingConstants.CG_MENUP9_PREFIX + ComfoAirBindingConstants.CHANNEL_EWT_STATE,
                    ComfoAirBindingConstants.CG_EWT_PREFIX + ComfoAirBindingConstants.CHANNEL_EWT_TEMP_HIGH,
    ...
    ENTHALPY_TEMPERATUR(ComfoAirBindingConstants.CG_ENTHALPY_PREFIX + ComfoAirBindingConstants.CHANNEL_ENTHALPY_TEMP,
    ...
    IS_ANALOG1(ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_IS_ANALOG1,
            ...
            new String[] { ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG1_MODE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG1_NEGATIVE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG1_MIN,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG1_MAX,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG1_VALUE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG1_VOLT },
    ...
    IS_ANALOG2(ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_IS_ANALOG2,
            ...
            new String[] { ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG2_MODE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG2_NEGATIVE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG2_MIN,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG2_MAX,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG2_VALUE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG2_VOLT },
    ...
    IS_ANALOG3(ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_IS_ANALOG3,
            ...
            new String[] { ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG3_MODE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG3_NEGATIVE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG3_MIN,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG3_MAX,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG3_VALUE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG3_VOLT },
    ...
    IS_ANALOG4(ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_IS_ANALOG4,
            ...
            new String[] { ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG4_MODE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG4_NEGATIVE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG4_MIN,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG4_MAX,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG4_VALUE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_ANALOG4_VOLT },
    ...
    IS_RF(ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_IS_RF,
            ...
            new String[] { ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_MODE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_NEGATIVE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_MIN,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_MAX,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_VALUE },
    ...
    RF_MODE(ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_MODE,
            ...
            new String[] { ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_NEGATIVE,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_MIN,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_MAX,
                    ComfoAirBindingConstants.CG_ANALOG_PREFIX + ComfoAirBindingConstants.CHANNEL_RF_VALUE },
