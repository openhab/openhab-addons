...
public interface SmartThingsConfigDescriptionProvider extends ConfigDescriptionProvider {
     ...
     * smartthings binding. Other than {@link #getConfigDescription(URI, Locale)}
     ...
     *            e.g. <i>thing-type:smartthings:switchLevel</i>
     * @return ConfigDescription that was added to SmartThingsConfigDescriptionProvider,
     *         identified by its config-description-uri<br>
     *         <i>null</i> if no ConfigDescription with the given URI was added before
     */
    @Nullable
