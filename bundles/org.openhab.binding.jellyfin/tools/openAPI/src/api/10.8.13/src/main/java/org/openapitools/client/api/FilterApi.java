...
public class FilterApi {
     ...
     */
    public okhttp3.Call getQueryFiltersLegacyCall(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes, List<String> mediaTypes, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getQueryFiltersLegacyValidateBeforeCall(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes, List<String> mediaTypes, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getQueryFiltersLegacyAsync(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes, List<String> mediaTypes, final ApiCallback<QueryFiltersLegacy> _callback) throws ApiException {
