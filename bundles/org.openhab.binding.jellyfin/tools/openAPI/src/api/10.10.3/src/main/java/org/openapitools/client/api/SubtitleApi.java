...
public class SubtitleApi {
     ...
     */
    public okhttp3.Call getRemoteSubtitlesCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRemoteSubtitlesValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getRemoteSubtitles(Async)");
        }

        return getRemoteSubtitlesCall(id, _callback);
    ...
    public File getRemoteSubtitles(String id) throws ApiException {
        ApiResponse<File> localVarResp = getRemoteSubtitlesWithHttpInfo(id);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<File> getRemoteSubtitlesWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getRemoteSubtitlesValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getRemoteSubtitlesAsync(String id, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRemoteSubtitlesValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
