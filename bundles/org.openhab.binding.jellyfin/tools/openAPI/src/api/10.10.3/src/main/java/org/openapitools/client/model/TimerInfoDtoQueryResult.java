...
public class TimerInfoDtoQueryResult {
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimerInfoDtoQueryResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimerInfoDtoQueryResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TimerInfoDtoQueryResult is not found in the empty JSON string", TimerInfoDtoQueryResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimerInfoDtoQueryResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TimerInfoDtoQueryResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Items") != null && !jsonObj.get("Items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            TimerInfoDto.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TimerInfoDtoQueryResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TimerInfoDtoQueryResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TimerInfoDtoQueryResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TimerInfoDtoQueryResult.class));

       return (TypeAdapter<T>) new TypeAdapter<TimerInfoDtoQueryResult>() {
           @Override
           public void write(JsonWriter out, TimerInfoDtoQueryResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TimerInfoDtoQueryResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TimerInfoDtoQueryResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TimerInfoDtoQueryResult
   * @throws IOException if the JSON string is invalid with respect to TimerInfoDtoQueryResult
   */
  public static TimerInfoDtoQueryResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TimerInfoDtoQueryResult.class);
  }

  /**
   * Convert an instance of TimerInfoDtoQueryResult to an JSON string
   *
   * @return JSON string
   */
