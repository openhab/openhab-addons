...
public class MusicVideoInfoRemoteSearchQuery {
    ...
    public MusicVideoInfoRemoteSearchQuery searchInfo(@org.eclipse.jdt.annotation.NonNull MusicVideoInfo searchInfo) {
    ...
    @JsonProperty(value = JSON_PROPERTY_SEARCH_INFO, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSearchInfo(@org.eclipse.jdt.annotation.NonNull MusicVideoInfo searchInfo) {
        this.searchInfo = searchInfo;
    }

    public MusicVideoInfoRemoteSearchQuery itemId(@org.eclipse.jdt.annotation.NonNull UUID itemId) {
        this.itemId = itemId;
        return this;
    }
