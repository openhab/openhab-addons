...
public class TimerCancelledMessage {
    ...
    public TimerCancelledMessage data(@org.eclipse.jdt.annotation.Nullable TimerEventInfo data) {
        this.data = data;
        return this;
    }
    ...
    public TimerCancelledMessage messageId(@org.eclipse.jdt.annotation.Nullable UUID messageId) {
