...
public class LiveStreamResponse {
    ...
    public LiveStreamResponse mediaSource(@org.eclipse.jdt.annotation.Nullable MediaSourceInfo mediaSource) {
    ...
    @JsonProperty(value = JSON_PROPERTY_MEDIA_SOURCE, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setMediaSource(@org.eclipse.jdt.annotation.Nullable MediaSourceInfo mediaSource) {
        this.mediaSource = mediaSource;
    }
