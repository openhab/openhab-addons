...
public class BrandingOptions {
    ...
    public BrandingOptions loginDisclaimer(@org.eclipse.jdt.annotation.Nullable String loginDisclaimer) {
    ...
    public BrandingOptions customCss(@org.eclipse.jdt.annotation.Nullable String customCss) {
    ...
    public BrandingOptions splashscreenEnabled(@org.eclipse.jdt.annotation.Nullable Boolean splashscreenEnabled) {
