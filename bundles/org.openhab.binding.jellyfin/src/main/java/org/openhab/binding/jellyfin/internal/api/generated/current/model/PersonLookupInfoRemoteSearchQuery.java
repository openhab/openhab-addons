...
public class PersonLookupInfoRemoteSearchQuery {
    ...
    public PersonLookupInfoRemoteSearchQuery searchInfo(
            @org.eclipse.jdt.annotation.NonNull PersonLookupInfo searchInfo) {
    ...
    @JsonProperty(value = JSON_PROPERTY_SEARCH_INFO, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSearchInfo(@org.eclipse.jdt.annotation.NonNull PersonLookupInfo searchInfo) {
        this.searchInfo = searchInfo;
    }

    public PersonLookupInfoRemoteSearchQuery itemId(@org.eclipse.jdt.annotation.NonNull UUID itemId) {
        this.itemId = itemId;
        return this;
    }
