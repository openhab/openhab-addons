...
public class VideoAttachmentsApi {
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<File> getAttachmentWithHttpInfo(UUID videoId, String mediaSourceId, Integer index)
            throws ApiException {
    ...
    private HttpRequest.Builder getAttachmentRequestBuilder(UUID videoId, String mediaSourceId, Integer index)
            throws ApiException {
