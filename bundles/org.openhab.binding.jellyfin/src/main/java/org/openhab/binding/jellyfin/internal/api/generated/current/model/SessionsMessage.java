...
public class SessionsMessage {
    ...
    public SessionsMessage data(@org.eclipse.jdt.annotation.NonNull List<SessionInfoDto> data) {
        this.data = data;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(@org.eclipse.jdt.annotation.NonNull List<SessionInfoDto> data) {
        this.data = data;
    }

    public SessionsMessage messageId(@org.eclipse.jdt.annotation.NonNull UUID messageId) {
