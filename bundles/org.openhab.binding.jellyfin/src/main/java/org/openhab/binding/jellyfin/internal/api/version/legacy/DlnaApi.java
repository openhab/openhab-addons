...
public class DlnaApi {
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<Void> updateProfileWithHttpInfo(String profileId, DeviceProfile deviceProfile)
            throws ApiException {
    ...
    private HttpRequest.Builder updateProfileRequestBuilder(String profileId, DeviceProfile deviceProfile)
            throws ApiException {
        // verify the required parameter 'profileId' is set
        if (profileId == null) {
