...
public class NotificationsSummaryDto {
    ...
    public NotificationsSummaryDto unreadCount(@org.eclipse.jdt.annotation.Nullable Integer unreadCount) {
    ...
    @JsonProperty(JSON_PROPERTY_UNREAD_COUNT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setUnreadCount(@org.eclipse.jdt.annotation.Nullable Integer unreadCount) {
        this.unreadCount = unreadCount;
    }

    public NotificationsSummaryDto maxUnreadNotificationLevel(
            @org.eclipse.jdt.annotation.Nullable NotificationLevel maxUnreadNotificationLevel) {
