...
public class DlnaServerApi {
    ...
    private HttpRequest.Builder processConnectionManagerControlRequestRequestBuilder(String serverId)
            throws ApiException {
        // verify the required parameter 'serverId' is set
        if (serverId == null) {
            throw new ApiException(400,
    ...
    private HttpRequest.Builder processContentDirectoryControlRequestRequestBuilder(String serverId)
            throws ApiException {
        // verify the required parameter 'serverId' is set
        if (serverId == null) {
            throw new ApiException(400,
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<File> processMediaReceiverRegistrarControlRequestWithHttpInfo(String serverId)
            throws ApiException {
    ...
    private HttpRequest.Builder processMediaReceiverRegistrarControlRequestRequestBuilder(String serverId)
            throws ApiException {
        // verify the required parameter 'serverId' is set
        if (serverId == null) {
            throw new ApiException(400,
