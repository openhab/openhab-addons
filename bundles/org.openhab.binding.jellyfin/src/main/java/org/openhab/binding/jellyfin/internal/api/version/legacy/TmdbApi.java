...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.ConfigImageTypes;
...
public class TmdbApi {
    ...
    private ResponseSpec tmdbClientConfigurationRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Tmdb/ClientConfiguration", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<ConfigImageTypes>> tmdbClientConfigurationWithHttpInfo() throws WebClientResponseException {
        ParameterizedTypeReference<ConfigImageTypes> localVarReturnType = new ParameterizedTypeReference<ConfigImageTypes>() {};
