...
public class BrandingOptionsDto {
    ...
    public BrandingOptionsDto loginDisclaimer(@org.eclipse.jdt.annotation.NonNull String loginDisclaimer) {
    ...
    public BrandingOptionsDto customCss(@org.eclipse.jdt.annotation.NonNull String customCss) {
    ...
    public BrandingOptionsDto splashscreenEnabled(@org.eclipse.jdt.annotation.NonNull Boolean splashscreenEnabled) {
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getLoginDisclaimer() != null) {
            joiner.add(String.format(Locale.ROOT, "%sLoginDisclaimer%s=%s", prefix, suffix,
                    ApiClient.urlEncode(ApiClient.valueToString(getLoginDisclaimer()))));
        }

        // add `CustomCss` to the URL query string
        if (getCustomCss() != null) {
            joiner.add(String.format(Locale.ROOT, "%sCustomCss%s=%s", prefix, suffix,
        ...
        if (getSplashscreenEnabled() != null) {
            joiner.add(String.format(Locale.ROOT, "%sSplashscreenEnabled%s=%s", prefix, suffix,
