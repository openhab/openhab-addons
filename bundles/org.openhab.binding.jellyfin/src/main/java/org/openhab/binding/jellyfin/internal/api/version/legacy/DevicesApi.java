...
public class DevicesApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<DeviceOptions>> getDeviceOptionsWithHttpInfo(String id) throws WebClientResponseException {
        ParameterizedTypeReference<DeviceOptions> localVarReturnType = new ParameterizedTypeReference<DeviceOptions>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getDevicesRequestCreation(Boolean supportsSync, UUID userId) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<DeviceInfoQueryResult>> getDevicesWithHttpInfo(Boolean supportsSync, UUID userId) throws WebClientResponseException {
        ParameterizedTypeReference<DeviceInfoQueryResult> localVarReturnType = new ParameterizedTypeReference<DeviceInfoQueryResult>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getDevicesWithResponseSpec(Boolean supportsSync, UUID userId) throws WebClientResponseException {
