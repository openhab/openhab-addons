...
public class BaseItemDto {
    ...
    public BaseItemDto trickplay(
            @org.eclipse.jdt.annotation.Nullable Map<String, Map<String, TrickplayInfo>> trickplay) {
    ...
    @JsonProperty(JSON_PROPERTY_TRICKPLAY)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTrickplay(@org.eclipse.jdt.annotation.Nullable Map<String, Map<String, TrickplayInfo>> trickplay) {
        this.trickplay = trickplay;
    }
