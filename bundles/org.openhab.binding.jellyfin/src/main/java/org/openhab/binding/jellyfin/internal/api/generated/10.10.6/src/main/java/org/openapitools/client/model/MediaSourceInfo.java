...
public class MediaSourceInfo {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getUseMostCompatibleTranscodingProfile() != null) {
      joiner.add(String.format("%sUseMostCompatibleTranscodingProfile%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUseMostCompatibleTranscodingProfile()))));
    }
    ...
    if (getFallbackMaxStreamingBitrate() != null) {
      joiner.add(String.format("%sFallbackMaxStreamingBitrate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getFallbackMaxStreamingBitrate()))));
    }
    ...
    if (getHasSegments() != null) {
      joiner.add(String.format("%sHasSegments%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getHasSegments()))));
    }
