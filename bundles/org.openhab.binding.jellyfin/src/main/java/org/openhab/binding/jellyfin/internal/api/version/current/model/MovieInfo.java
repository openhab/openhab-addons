 ...
 */
@JsonPropertyOrder({
  MovieInfo.JSON_PROPERTY_NAME,
  MovieInfo.JSON_PROPERTY_ORIGINAL_TITLE,
  MovieInfo.JSON_PROPERTY_PATH,
  MovieInfo.JSON_PROPERTY_METADATA_LANGUAGE,
  MovieInfo.JSON_PROPERTY_METADATA_COUNTRY_CODE,
  MovieInfo.JSON_PROPERTY_PROVIDER_IDS,
  MovieInfo.JSON_PROPERTY_YEAR,
  MovieInfo.JSON_PROPERTY_INDEX_NUMBER,
  MovieInfo.JSON_PROPERTY_PARENT_INDEX_NUMBER,
  MovieInfo.JSON_PROPERTY_PREMIERE_DATE,
...
public class MovieInfo {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, movieInfo.name) &&
        equalsNullable(this.originalTitle, movieInfo.originalTitle) &&
        ...
        equalsNullable(this.providerIds, movieInfo.providerIds) &&
        equalsNullable(this.year, movieInfo.year) &&
