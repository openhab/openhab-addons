...
public class HlsSegmentApi {
     ...
     * 
     * <p>
     * <b>200</b> - Hls audio segment returned.
     * 
     ...
     */
    private ResponseSpec getHlsAudioSegmentLegacyAacRequestCreation(String itemId, String segmentId)
        ...
        return apiClient.invokeAPI("/Audio/{itemId}/hls/{segmentId}/stream.aac", HttpMethod.GET, pathParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<File>> getHlsAudioSegmentLegacyAacWithHttpInfo(String itemId, String segmentId)
            throws WebClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<File>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getHlsAudioSegmentLegacyAacWithResponseSpec(String itemId, String segmentId)
            throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getHlsAudioSegmentLegacyMp3RequestCreation(String itemId, String segmentId)
            throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
        ...
        return apiClient.invokeAPI("/Audio/{itemId}/hls/{segmentId}/stream.mp3", HttpMethod.GET, pathParams,
                queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<File>> getHlsAudioSegmentLegacyMp3WithHttpInfo(String itemId, String segmentId)
            throws WebClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<File>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getHlsAudioSegmentLegacyMp3WithResponseSpec(String itemId, String segmentId)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>200</b> - Hls video playlist returned.
     * <p>
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getHlsPlaylistLegacyRequestCreation(String itemId, String playlistId)
            throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'itemId' when calling getHlsPlaylistLegacy",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/Videos/{itemId}/hls/{playlistId}/stream.m3u8", HttpMethod.GET, pathParams,
                queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<File>> getHlsPlaylistLegacyWithHttpInfo(String itemId, String playlistId)
            throws WebClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<File>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getHlsPlaylistLegacyWithResponseSpec(String itemId, String playlistId)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>200</b> - Hls video segment returned.
     * <p>
     * <b>404</b> - Hls segment not found.
     * 
     * @param itemId The item id.
     * @param playlistId The playlist id.
     * @param segmentId The segment id.
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getHlsVideoSegmentLegacyRequestCreation(String itemId, String playlistId, String segmentId,
            String segmentContainer) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException(
        ...
        return apiClient.invokeAPI("/Videos/{itemId}/hls/{playlistId}/{segmentId}.{segmentContainer}", HttpMethod.GET,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<File> getHlsVideoSegmentLegacy(String itemId, String playlistId, String segmentId,
            String segmentContainer) throws WebClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<File>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<File>> getHlsVideoSegmentLegacyWithHttpInfo(String itemId, String playlistId,
            String segmentId, String segmentContainer) throws WebClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<File>() {
        };
        return getHlsVideoSegmentLegacyRequestCreation(itemId, playlistId, segmentId, segmentContainer)
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getHlsVideoSegmentLegacyWithResponseSpec(String itemId, String playlistId, String segmentId,
            String segmentContainer) throws WebClientResponseException {
        return getHlsVideoSegmentLegacyRequestCreation(itemId, playlistId, segmentId, segmentContainer);
    }
     ...
     * 
     * <p>
     * <b>204</b> - Encoding stopped successfully.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec stopEncodingProcessRequestCreation(String deviceId, String playSessionId)
            throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'deviceId' is set
        if (deviceId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'deviceId' when calling stopEncodingProcess",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/Videos/ActiveEncodings", HttpMethod.DELETE, pathParams, queryParams, postBody,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> stopEncodingProcessWithHttpInfo(String deviceId, String playSessionId)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec stopEncodingProcessWithResponseSpec(String deviceId, String playSessionId)
            throws WebClientResponseException {
