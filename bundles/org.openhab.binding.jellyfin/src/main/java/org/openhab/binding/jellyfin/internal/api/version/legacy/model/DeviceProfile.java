...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.CodecProfile;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.ContainerProfile;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.DeviceIdentification;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.DirectPlayProfile;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.ResponseProfile;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.SubtitleProfile;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.TranscodingProfile;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.XmlAttribute;
  ...
  */
  public DeviceProfile.Builder toBuilder() {
    return new DeviceProfile.Builder()
      ...
      .enableAlbumArtInDidl(getEnableAlbumArtInDidl())
      .enableSingleAlbumArtLimit(getEnableSingleAlbumArtLimit())
      .enableSingleSubtitleLimit(getEnableSingleSubtitleLimit())
      .supportedMediaTypes(getSupportedMediaTypes())
      .userId(getUserId())
      .albumArtPn(getAlbumArtPn())
      .maxAlbumArtWidth(getMaxAlbumArtWidth())
      .maxAlbumArtHeight(getMaxAlbumArtHeight())
      .maxIconWidth(getMaxIconWidth())
      .maxIconHeight(getMaxIconHeight())
      ...
      .sonyAggregationFlags(getSonyAggregationFlags())
      .protocolInfo(getProtocolInfo())
      .timelineOffsetSeconds(getTimelineOffsetSeconds())
      .requiresPlainVideoItems(getRequiresPlainVideoItems())
      .requiresPlainFolders(getRequiresPlainFolders())
      ...
      .xmlRootAttributes(getXmlRootAttributes())
