...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.PackageInfo;
...
public class PackageApi {
     ...
     * 
     * <p>
     * <b>204</b> - Installation cancelled.
     * <p>
    ...
    private ResponseSpec cancelPackageInstallationRequestCreation(UUID packageId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Packages/Installing/{packageId}", HttpMethod.DELETE, pathParams, queryParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> cancelPackageInstallationWithHttpInfo(UUID packageId)
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getPackageInfoRequestCreation(String name, UUID assemblyGuid)
            throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new WebClientResponseException("Missing the required parameter 'name' when calling getPackageInfo",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Packages/{name}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<PackageInfo>> getPackageInfoWithHttpInfo(String name, UUID assemblyGuid)
            throws WebClientResponseException {
        ParameterizedTypeReference<PackageInfo> localVarReturnType = new ParameterizedTypeReference<PackageInfo>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getPackageInfoWithResponseSpec(String name, UUID assemblyGuid)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>200</b> - Available packages returned.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
    ...
    private ResponseSpec getPackagesRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Packages", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * 
     * <p>
     * <b>200</b> - Package repositories returned.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
    ...
    private ResponseSpec getRepositoriesRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Repositories", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * 
     * <p>
     * <b>204</b> - Package found.
     * <p>
     * <b>404</b> - Package not found.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec installPackageRequestCreation(String name, UUID assemblyGuid, String version,
            String repositoryUrl) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new WebClientResponseException("Missing the required parameter 'name' when calling installPackage",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Packages/Installed/{name}", HttpMethod.POST, pathParams, queryParams, postBody,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> installPackage(String name, UUID assemblyGuid, String version, String repositoryUrl)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> installPackageWithHttpInfo(String name, UUID assemblyGuid, String version,
            String repositoryUrl) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec installPackageWithResponseSpec(String name, UUID assemblyGuid, String version,
            String repositoryUrl) throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>204</b> - Package repositories saved.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec setRepositoriesRequestCreation(List<RepositoryInfo> repositoryInfo)
            throws WebClientResponseException {
        Object postBody = repositoryInfo;
        // verify the required parameter 'repositoryInfo' is set
        if (repositoryInfo == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'repositoryInfo' when calling setRepositories",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Repositories", HttpMethod.POST, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> setRepositoriesWithHttpInfo(List<RepositoryInfo> repositoryInfo)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec setRepositoriesWithResponseSpec(List<RepositoryInfo> repositoryInfo)
            throws WebClientResponseException {
