...
public class ChannelsApi {
  ...
  private HttpRequest.Builder getChannelItemsRequestBuilder(UUID channelId, UUID folderId, UUID userId, Integer startIndex, Integer limit, List<SortOrder> sortOrder, List<ItemFilter> filters, List<String> sortBy, List<ItemFields> fields) throws ApiException {
    // verify the required parameter 'channelId' is set
    if (channelId == null) {
