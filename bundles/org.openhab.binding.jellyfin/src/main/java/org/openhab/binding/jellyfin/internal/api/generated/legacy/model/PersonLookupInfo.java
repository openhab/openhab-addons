...
public class PersonLookupInfo {
    ...
    public PersonLookupInfo name(@org.eclipse.jdt.annotation.NonNull String name) {
        this.name = name;
        return this;
    }
    ...
    public PersonLookupInfo originalTitle(@org.eclipse.jdt.annotation.NonNull String originalTitle) {
    ...
    public PersonLookupInfo path(@org.eclipse.jdt.annotation.NonNull String path) {
        this.path = path;
        return this;
    }
    ...
    public PersonLookupInfo metadataLanguage(@org.eclipse.jdt.annotation.NonNull String metadataLanguage) {
    ...
    public PersonLookupInfo metadataCountryCode(@org.eclipse.jdt.annotation.NonNull String metadataCountryCode) {
    ...
    public PersonLookupInfo providerIds(@org.eclipse.jdt.annotation.NonNull Map<String, String> providerIds) {
    ...
    public PersonLookupInfo year(@org.eclipse.jdt.annotation.NonNull Integer year) {
        this.year = year;
        return this;
    }
    ...
    public PersonLookupInfo indexNumber(@org.eclipse.jdt.annotation.NonNull Integer indexNumber) {
    ...
    public PersonLookupInfo parentIndexNumber(@org.eclipse.jdt.annotation.NonNull Integer parentIndexNumber) {
    ...
    public PersonLookupInfo premiereDate(@org.eclipse.jdt.annotation.NonNull OffsetDateTime premiereDate) {
    ...
    public PersonLookupInfo isAutomated(@org.eclipse.jdt.annotation.NonNull Boolean isAutomated) {
