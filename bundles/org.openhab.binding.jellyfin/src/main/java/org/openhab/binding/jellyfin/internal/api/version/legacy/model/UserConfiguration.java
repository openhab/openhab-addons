...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.SubtitlePlaybackMode;
...
public class UserConfiguration {
  ...
  public UserConfiguration groupedFolders(@javax.annotation.Nullable List<String> groupedFolders) {
  ...
  public UserConfiguration orderedViews(@javax.annotation.Nullable List<String> orderedViews) {
  ...
  public UserConfiguration latestItemsExcludes(@javax.annotation.Nullable List<String> latestItemsExcludes) {
  ...
  public UserConfiguration myMediaExcludes(@javax.annotation.Nullable List<String> myMediaExcludes) {
  ...
  */
  public UserConfiguration.Builder toBuilder() {
    return new UserConfiguration.Builder()
      .audioLanguagePreference(getAudioLanguagePreference())
      .playDefaultAudioTrack(getPlayDefaultAudioTrack())
      .subtitleLanguagePreference(getSubtitleLanguagePreference())
      .displayMissingEpisodes(getDisplayMissingEpisodes())
      .groupedFolders(getGroupedFolders())
      .subtitleMode(getSubtitleMode())
      .displayCollectionsView(getDisplayCollectionsView())
      .enableLocalPassword(getEnableLocalPassword())
      .orderedViews(getOrderedViews())
      .latestItemsExcludes(getLatestItemsExcludes())
      .myMediaExcludes(getMyMediaExcludes())
      .hidePlayedInLatest(getHidePlayedInLatest())
      .rememberAudioSelections(getRememberAudioSelections())
