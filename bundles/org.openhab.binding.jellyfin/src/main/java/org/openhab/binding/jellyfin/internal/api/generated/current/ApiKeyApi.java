...
public class ApiKeyApi {
    ...
    public ApiResponse<Void> createKeyWithHttpInfo(@org.eclipse.jdt.annotation.Nullable String app)
        ...
        // Query parameters
        List<Pair> localVarQueryParams = new ArrayList<>(apiClient.parameterToPairs("", "app", app));

        String localVarAccept = apiClient.selectHeaderAccept();
        String localVarContentType = apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] { "CustomAuthentication" };
        return apiClient.invokeAPI("ApiKeyApi.createKey", "/Auth/Keys", "POST", localVarQueryParams, null,
    ...
    public AuthenticationInfoQueryResult getKeys() throws ApiException {
        return getKeysWithHttpInfo().getData();
    }
    ...
    public ApiResponse<AuthenticationInfoQueryResult> getKeysWithHttpInfo() throws ApiException {
        ...
        String localVarContentType = apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] { "CustomAuthentication" };
        GenericType<AuthenticationInfoQueryResult> localVarReturnType = new GenericType<AuthenticationInfoQueryResult>() {
        };
        return apiClient.invokeAPI("ApiKeyApi.getKeys", "/Auth/Keys", "GET", new ArrayList<>(), null,
                new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept,
    ...
    public ApiResponse<Void> revokeKeyWithHttpInfo(@org.eclipse.jdt.annotation.Nullable String key)
        ...
        // Path parameters
        String localVarPath = "/Auth/Keys/{key}".replaceAll("\\{key}", apiClient.escapeString(key.toString()));

        String localVarAccept = apiClient.selectHeaderAccept();
        String localVarContentType = apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] { "CustomAuthentication" };
        return apiClient.invokeAPI("ApiKeyApi.revokeKey", localVarPath, "DELETE", new ArrayList<>(), null,
                new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept,
                localVarContentType, localVarAuthNames, null, false);
    }
}
