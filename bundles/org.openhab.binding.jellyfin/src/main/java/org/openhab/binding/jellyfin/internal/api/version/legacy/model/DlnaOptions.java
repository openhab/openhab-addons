...
public class DlnaOptions {
  ...
  */
  public DlnaOptions.Builder toBuilder() {
    return new DlnaOptions.Builder()
      .enablePlayTo(getEnablePlayTo())
      .enableServer(getEnableServer())
      .enableDebugLog(getEnableDebugLog())
      .enablePlayToTracing(getEnablePlayToTracing())
      ...
      .autoCreatePlayToProfiles(getAutoCreatePlayToProfiles())
      .blastAliveMessages(getBlastAliveMessages())
      .sendOnlyMatchedHost(getSendOnlyMatchedHost());
  }
