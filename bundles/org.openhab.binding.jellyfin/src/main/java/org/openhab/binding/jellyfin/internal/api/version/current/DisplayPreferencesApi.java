...
public class DisplayPreferencesApi {
     ...
     */
    private ResponseSpec getDisplayPreferencesRequestCreation(String displayPreferencesId, String client, UUID userId)
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<DisplayPreferencesDto> getDisplayPreferences(String displayPreferencesId, String client, UUID userId)
            throws WebClientResponseException {
        ParameterizedTypeReference<DisplayPreferencesDto> localVarReturnType = new ParameterizedTypeReference<DisplayPreferencesDto>() {
        };
    ...
    public Mono<ResponseEntity<DisplayPreferencesDto>> getDisplayPreferencesWithHttpInfo(String displayPreferencesId,
            String client, UUID userId) throws WebClientResponseException {
        ParameterizedTypeReference<DisplayPreferencesDto> localVarReturnType = new ParameterizedTypeReference<DisplayPreferencesDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getDisplayPreferencesWithResponseSpec(String displayPreferencesId, String client, UUID userId)
            throws WebClientResponseException {
        return getDisplayPreferencesRequestCreation(displayPreferencesId, client, userId);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec updateDisplayPreferencesRequestCreation(String displayPreferencesId, String client,
            DisplayPreferencesDto displayPreferencesDto, UUID userId) throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> updateDisplayPreferences(String displayPreferencesId, String client,
            DisplayPreferencesDto displayPreferencesDto, UUID userId) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> updateDisplayPreferencesWithHttpInfo(String displayPreferencesId, String client,
            DisplayPreferencesDto displayPreferencesDto, UUID userId) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
        return updateDisplayPreferencesRequestCreation(displayPreferencesId, client, displayPreferencesDto, userId)
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec updateDisplayPreferencesWithResponseSpec(String displayPreferencesId, String client,
            DisplayPreferencesDto displayPreferencesDto, UUID userId) throws WebClientResponseException {
        return updateDisplayPreferencesRequestCreation(displayPreferencesId, client, displayPreferencesDto, userId);
    }
}
