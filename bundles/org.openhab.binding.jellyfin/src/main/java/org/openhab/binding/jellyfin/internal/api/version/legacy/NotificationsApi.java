...
public class NotificationsApi {
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<Void> createAdminNotificationWithHttpInfo(AdminNotificationDto adminNotificationDto)
            throws ApiException {
    ...
    private HttpRequest.Builder createAdminNotificationRequestBuilder(AdminNotificationDto adminNotificationDto)
            throws ApiException {
        ...
        try {
            ...
            try {
                ...
                return new ApiResponse<NotificationResultDto>(localVarResponse.statusCode(),
                        ...
                        responseBody.isBlank() ? null
                                : memberVarObjectMapper.readValue(responseBody,
                                        new TypeReference<NotificationResultDto>() {
                                        }));
            } finally {
            }
        } catch (IOException e) {
        ...
        try {
            ...
            try {
                ...
                return new ApiResponse<NotificationsSummaryDto>(localVarResponse.statusCode(),
                        ...
                        responseBody.isBlank() ? null
                                : memberVarObjectMapper.readValue(responseBody,
                                        new TypeReference<NotificationsSummaryDto>() {
                                        }));
            } finally {
            }
        } catch (IOException e) {
