  ...
  */
  public NetworkConfiguration.Builder toBuilder() {
    return new NetworkConfiguration.Builder()
      ...
      .httpServerPortNumber(getHttpServerPortNumber())
      .httpsPortNumber(getHttpsPortNumber())
      .enableHttps(getEnableHttps())
      .publicPort(getPublicPort())
      .upnPCreateHttpPortMap(getUpnPCreateHttpPortMap())
      .udPPortRange(getUdPPortRange())
      .enableIPV6(getEnableIPV6())
      .enableIPV4(getEnableIPV4())
      .enableSSDPTracing(getEnableSSDPTracing())
      .ssDPTracingFilter(getSsDPTracingFilter())
      .udPSendCount(getUdPSendCount())
      ...
      .gatewayMonitorPeriod(getGatewayMonitorPeriod())
      .enableMultiSocketBinding(getEnableMultiSocketBinding())
      .trustAllIP6Interfaces(getTrustAllIP6Interfaces())
      .hdHomerunPortRange(getHdHomerunPortRange())
      .publishedServerUriBySubnet(getPublishedServerUriBySubnet())
      .autoDiscoveryTracing(getAutoDiscoveryTracing())
