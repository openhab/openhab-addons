...
public class BookInfoRemoteSearchQuery {
    ...
    public BookInfoRemoteSearchQuery searchInfo(@org.eclipse.jdt.annotation.Nullable BookInfo searchInfo) {
    ...
    @JsonProperty(value = JSON_PROPERTY_SEARCH_INFO, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSearchInfo(@org.eclipse.jdt.annotation.Nullable BookInfo searchInfo) {
        this.searchInfo = searchInfo;
    }

    public BookInfoRemoteSearchQuery itemId(@org.eclipse.jdt.annotation.Nullable UUID itemId) {
        this.itemId = itemId;
        return this;
    }
    ...
    public BookInfoRemoteSearchQuery searchProviderName(
