...
public class PersonLookupInfo {
    ...
    public PersonLookupInfo name(@org.eclipse.jdt.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public PersonLookupInfo originalTitle(@org.eclipse.jdt.annotation.Nullable String originalTitle) {
    ...
    public PersonLookupInfo path(@org.eclipse.jdt.annotation.Nullable String path) {
        this.path = path;
        return this;
    }
    ...
    public PersonLookupInfo metadataLanguage(@org.eclipse.jdt.annotation.Nullable String metadataLanguage) {
    ...
    public PersonLookupInfo metadataCountryCode(@org.eclipse.jdt.annotation.Nullable String metadataCountryCode) {
    ...
    public PersonLookupInfo providerIds(@org.eclipse.jdt.annotation.Nullable Map<String, String> providerIds) {
    ...
    public PersonLookupInfo year(@org.eclipse.jdt.annotation.Nullable Integer year) {
        this.year = year;
        return this;
    }
    ...
    public PersonLookupInfo indexNumber(@org.eclipse.jdt.annotation.Nullable Integer indexNumber) {
    ...
    public PersonLookupInfo parentIndexNumber(@org.eclipse.jdt.annotation.Nullable Integer parentIndexNumber) {
    ...
    public PersonLookupInfo premiereDate(@org.eclipse.jdt.annotation.Nullable OffsetDateTime premiereDate) {
    ...
    public PersonLookupInfo isAutomated(@org.eclipse.jdt.annotation.Nullable Boolean isAutomated) {
