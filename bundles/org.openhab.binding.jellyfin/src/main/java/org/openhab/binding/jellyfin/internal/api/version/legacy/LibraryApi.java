...
public class LibraryApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getLibraryOptionsInfoRequestCreation(String libraryContentType, Boolean isNewLibrary)
            throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<LibraryOptionsResultDto> getLibraryOptionsInfo(String libraryContentType, Boolean isNewLibrary)
            throws WebClientResponseException {
        ParameterizedTypeReference<LibraryOptionsResultDto> localVarReturnType = new ParameterizedTypeReference<LibraryOptionsResultDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<LibraryOptionsResultDto>> getLibraryOptionsInfoWithHttpInfo(String libraryContentType,
            Boolean isNewLibrary) throws WebClientResponseException {
        ParameterizedTypeReference<LibraryOptionsResultDto> localVarReturnType = new ParameterizedTypeReference<LibraryOptionsResultDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getLibraryOptionsInfoWithResponseSpec(String libraryContentType, Boolean isNewLibrary)
            throws WebClientResponseException {
    ...
    public Mono<ResponseEntity<AllThemeMediaResult>> getThemeMediaWithHttpInfo(UUID itemId, UUID userId,
            Boolean inheritFromParent) throws WebClientResponseException {
        ParameterizedTypeReference<AllThemeMediaResult> localVarReturnType = new ParameterizedTypeReference<AllThemeMediaResult>() {
        };
