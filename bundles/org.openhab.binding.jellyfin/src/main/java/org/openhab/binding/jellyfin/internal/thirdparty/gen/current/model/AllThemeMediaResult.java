...
public class AllThemeMediaResult {
    ...
    public AllThemeMediaResult themeVideosResult(
            @org.eclipse.jdt.annotation.Nullable ThemeMediaResult themeVideosResult) {
    ...
    @JsonProperty(value = JSON_PROPERTY_THEME_VIDEOS_RESULT, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setThemeVideosResult(@org.eclipse.jdt.annotation.Nullable ThemeMediaResult themeVideosResult) {
        this.themeVideosResult = themeVideosResult;
    }

    public AllThemeMediaResult themeSongsResult(
            @org.eclipse.jdt.annotation.Nullable ThemeMediaResult themeSongsResult) {
    ...
    @JsonProperty(value = JSON_PROPERTY_THEME_SONGS_RESULT, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setThemeSongsResult(@org.eclipse.jdt.annotation.Nullable ThemeMediaResult themeSongsResult) {
        this.themeSongsResult = themeSongsResult;
    }

    public AllThemeMediaResult soundtrackSongsResult(
            @org.eclipse.jdt.annotation.Nullable ThemeMediaResult soundtrackSongsResult) {
    ...
    @JsonProperty(value = JSON_PROPERTY_SOUNDTRACK_SONGS_RESULT, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSoundtrackSongsResult(@org.eclipse.jdt.annotation.Nullable ThemeMediaResult soundtrackSongsResult) {
        this.soundtrackSongsResult = soundtrackSongsResult;
    }
