...
public class LibraryApi {
  ...
  private HttpRequest.Builder getLibraryOptionsInfoRequestBuilder(String libraryContentType, Boolean isNewLibrary) throws ApiException {
  ...
  private HttpRequest.Builder getThemeMediaRequestBuilder(UUID itemId, UUID userId, Boolean inheritFromParent) throws ApiException {
    // verify the required parameter 'itemId' is set
    if (itemId == null) {
  ...
  private HttpRequest.Builder getThemeSongsRequestBuilder(UUID itemId, UUID userId, Boolean inheritFromParent) throws ApiException {
    // verify the required parameter 'itemId' is set
    if (itemId == null) {
  ...
  private HttpRequest.Builder getThemeVideosRequestBuilder(UUID itemId, UUID userId, Boolean inheritFromParent) throws ApiException {
    // verify the required parameter 'itemId' is set
    if (itemId == null) {
