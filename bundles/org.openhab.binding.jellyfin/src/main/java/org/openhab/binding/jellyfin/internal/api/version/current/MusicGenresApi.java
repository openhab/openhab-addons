...
public class MusicGenresApi {
    ...
    private ResponseSpec getMusicGenreRequestCreation(String genreName, UUID userId) throws WebClientResponseException {
        ...
        if (genreName == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'genreName' when calling getMusicGenre",
        ...
        return apiClient.invokeAPI("/MusicGenres/{genreName}", HttpMethod.GET, pathParams, queryParams, postBody,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDto>> getMusicGenreWithHttpInfo(String genreName, UUID userId)
     ...
     */
    @Deprecated
    private ResponseSpec getMusicGenresRequestCreation(Integer startIndex, Integer limit, String searchTerm,
        ...
        return apiClient.invokeAPI("/MusicGenres", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getMusicGenres(Integer startIndex, Integer limit, String searchTerm,
            UUID parentId, List<ItemFields> fields, List<BaseItemKind> excludeItemTypes,
            List<BaseItemKind> includeItemTypes, Boolean isFavorite, Integer imageTypeLimit,
            List<ImageType> enableImageTypes, UUID userId, String nameStartsWithOrGreater, String nameStartsWith,
            String nameLessThan, List<ItemSortBy> sortBy, List<SortOrder> sortOrder, Boolean enableImages,
        ...
        return getMusicGenresRequestCreation(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getMusicGenresWithHttpInfo(Integer startIndex, Integer limit,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getMusicGenresWithResponseSpec(Integer startIndex, Integer limit, String searchTerm,
            UUID parentId, List<ItemFields> fields, List<BaseItemKind> excludeItemTypes,
            List<BaseItemKind> includeItemTypes, Boolean isFavorite, Integer imageTypeLimit,
            List<ImageType> enableImageTypes, UUID userId, String nameStartsWithOrGreater, String nameStartsWith,
            String nameLessThan, List<ItemSortBy> sortBy, List<SortOrder> sortOrder, Boolean enableImages,
