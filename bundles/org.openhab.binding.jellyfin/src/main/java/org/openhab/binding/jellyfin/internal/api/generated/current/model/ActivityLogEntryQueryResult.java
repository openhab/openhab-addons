...
public class ActivityLogEntryQueryResult {
    ...
    public ActivityLogEntryQueryResult items(@org.eclipse.jdt.annotation.NonNull List<ActivityLogEntry> items) {
        this.items = items;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_ITEMS, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setItems(@org.eclipse.jdt.annotation.NonNull List<ActivityLogEntry> items) {
        this.items = items;
    }

    public ActivityLogEntryQueryResult totalRecordCount(@org.eclipse.jdt.annotation.NonNull Integer totalRecordCount) {
    ...
    public ActivityLogEntryQueryResult startIndex(@org.eclipse.jdt.annotation.NonNull Integer startIndex) {
