...
public class ImageApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec deleteUserImageRequestCreation(UUID userId) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec deleteUserImageWithResponseSpec(UUID userId) throws WebClientResponseException {
        return deleteUserImageRequestCreation(userId);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec postUserImageRequestCreation(UUID userId, File body) throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec postUserImageWithResponseSpec(UUID userId, File body) throws WebClientResponseException {
        return postUserImageRequestCreation(userId, body);
    }
