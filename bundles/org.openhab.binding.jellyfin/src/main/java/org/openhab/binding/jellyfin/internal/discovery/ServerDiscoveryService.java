...
// TODO: Implement logger instead of System.out/err
// TODO: Consider binding configuration to only scan specific interfaces or subnets

/**
 * The {@link ServerDiscoveryService} discover Jellyfin servers in the network.
 * 
 * @author Miguel Álvarez - Initial contribution
 * @author Patrik Gfeller - Refactored be independent of Jellyfin SDK
 */
@NonNullByDefault
@Component(scope = ServiceScope.PROTOTYPE, service = ServerDiscoveryService.class)
public class ServerDiscoveryService extends AbstractThingHandlerDiscoveryService<JellyfinServerHandler> {
    protected static class DiscoveryHelper {
        ...
        private void sendDiscoveryPacket(InetAddress broadcastAddress) {
            try (DatagramSocket socket = new DatagramSocket()) {
                ...
                DatagramPacket sendPacket = new DatagramPacket(sendData, sendData.length, broadcastAddress,
                        DISCOVERY_PORT);
                socket.send(sendPacket);

                System.out.println(
                        "Sent discovery packet to " + broadcastAddress.getHostAddress() + ":" + DISCOVERY_PORT);
    ...
    protected ServerDiscoveryService(Class<JellyfinServerHandler> thingClazz,
        ...
        super(thingClazz, supportedThingTypes, timeout, backgroundDiscoveryEnabledByDefault, scanInputLabel,
                scanInputDescription);
        // TODO Auto-generated constructor stub
    }

    public static void main(String[] args) {
        DiscoveryHelper discoverer = new DiscoveryHelper();
