...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.BrandingOptions;
...
public class BrandingApi {
     ...
     * 
     * <p>
     * <b>200</b> - Branding css returned.
     * <p>
     * <b>204</b> - No branding css configured.
     * 
     * @return String
    ...
    private ResponseSpec getBrandingCssRequestCreation() throws WebClientResponseException {
        ...
        final String[] localVarAccepts = { "text/css", "application/json", "application/json; profile=CamelCase",
        ...
        return apiClient.invokeAPI("/Branding/Css", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
    ...
    private ResponseSpec getBrandingCss2RequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Branding/Css.css", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * 
     * <p>
     * <b>200</b> - Branding configuration returned.
     * 
    ...
    private ResponseSpec getBrandingOptionsRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Branding/Configuration", HttpMethod.GET, pathParams, queryParams, postBody,
