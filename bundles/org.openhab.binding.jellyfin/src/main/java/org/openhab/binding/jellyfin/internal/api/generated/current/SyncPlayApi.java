...
public class SyncPlayApi {
     ...
     * @throws ApiException if fails to make API call
     */
    public void syncPlayCreateGroup(@org.eclipse.jdt.annotation.NonNull NewGroupRequestDto newGroupRequestDto)
            throws ApiException {
    ...
    private HttpRequest.Builder syncPlayPingRequestBuilder(
            @org.eclipse.jdt.annotation.NonNull PingRequestDto pingRequestDto) throws ApiException {
    ...
    private HttpRequest.Builder syncPlaySeekRequestBuilder(
            @org.eclipse.jdt.annotation.NonNull SeekRequestDto seekRequestDto) throws ApiException {
