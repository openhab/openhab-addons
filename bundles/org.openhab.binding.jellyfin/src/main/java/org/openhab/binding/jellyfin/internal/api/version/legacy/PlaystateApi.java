...
public class PlaystateApi {
     ...
     */
    private ResponseSpec markPlayedItemRequestCreation(UUID userId, UUID itemId, OffsetDateTime datePlayed)
            throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException("Missing the required parameter 'userId' when calling markPlayedItem",
        ...
        return apiClient.invokeAPI("/Users/{userId}/PlayedItems/{itemId}", HttpMethod.POST, pathParams, queryParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<UserItemDataDto> markPlayedItem(UUID userId, UUID itemId, OffsetDateTime datePlayed)
            throws WebClientResponseException {
        ParameterizedTypeReference<UserItemDataDto> localVarReturnType = new ParameterizedTypeReference<UserItemDataDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<UserItemDataDto>> markPlayedItemWithHttpInfo(UUID userId, UUID itemId,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec markPlayedItemWithResponseSpec(UUID userId, UUID itemId, OffsetDateTime datePlayed)
            throws WebClientResponseException {
    ...
    private ResponseSpec markUnplayedItemRequestCreation(UUID userId, UUID itemId) throws WebClientResponseException {
        ...
        if (userId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userId' when calling markUnplayedItem",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
        ...
        return apiClient.invokeAPI("/Users/{userId}/PlayedItems/{itemId}", HttpMethod.DELETE, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<UserItemDataDto>> markUnplayedItemWithHttpInfo(UUID userId, UUID itemId)
            throws WebClientResponseException {
        ParameterizedTypeReference<UserItemDataDto> localVarReturnType = new ParameterizedTypeReference<UserItemDataDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec onPlaybackProgressRequestCreation(UUID userId, UUID itemId, String mediaSourceId,
        ...
        if (userId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userId' when calling onPlaybackProgress",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
        ...
        return apiClient.invokeAPI("/Users/{userId}/PlayingItems/{itemId}/Progress", HttpMethod.POST, pathParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> onPlaybackProgress(UUID userId, UUID itemId, String mediaSourceId, Long positionTicks,
        ...
        return onPlaybackProgressRequestCreation(userId, itemId, mediaSourceId, positionTicks, audioStreamIndex,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> onPlaybackProgressWithHttpInfo(UUID userId, UUID itemId, String mediaSourceId,
            Long positionTicks, Integer audioStreamIndex, Integer subtitleStreamIndex, Integer volumeLevel,
            PlayMethod playMethod, String liveStreamId, String playSessionId, RepeatMode repeatMode, Boolean isPaused,
            Boolean isMuted) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec onPlaybackProgressWithResponseSpec(UUID userId, UUID itemId, String mediaSourceId,
            Long positionTicks, Integer audioStreamIndex, Integer subtitleStreamIndex, Integer volumeLevel,
            PlayMethod playMethod, String liveStreamId, String playSessionId, RepeatMode repeatMode, Boolean isPaused,
            Boolean isMuted) throws WebClientResponseException {
        return onPlaybackProgressRequestCreation(userId, itemId, mediaSourceId, positionTicks, audioStreamIndex,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec onPlaybackStartRequestCreation(UUID userId, UUID itemId, String mediaSourceId,
        ...
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException("Missing the required parameter 'userId' when calling onPlaybackStart",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
        ...
        return apiClient.invokeAPI("/Users/{userId}/PlayingItems/{itemId}", HttpMethod.POST, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> onPlaybackStart(UUID userId, UUID itemId, String mediaSourceId, Integer audioStreamIndex,
        ...
        return onPlaybackStartRequestCreation(userId, itemId, mediaSourceId, audioStreamIndex, subtitleStreamIndex,
                playMethod, liveStreamId, playSessionId, canSeek).bodyToMono(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> onPlaybackStartWithHttpInfo(UUID userId, UUID itemId, String mediaSourceId,
            Integer audioStreamIndex, Integer subtitleStreamIndex, PlayMethod playMethod, String liveStreamId,
            String playSessionId, Boolean canSeek) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
        return onPlaybackStartRequestCreation(userId, itemId, mediaSourceId, audioStreamIndex, subtitleStreamIndex,
                playMethod, liveStreamId, playSessionId, canSeek).toEntity(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec onPlaybackStartWithResponseSpec(UUID userId, UUID itemId, String mediaSourceId,
            Integer audioStreamIndex, Integer subtitleStreamIndex, PlayMethod playMethod, String liveStreamId,
            String playSessionId, Boolean canSeek) throws WebClientResponseException {
        return onPlaybackStartRequestCreation(userId, itemId, mediaSourceId, audioStreamIndex, subtitleStreamIndex,
                playMethod, liveStreamId, playSessionId, canSeek);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec onPlaybackStoppedRequestCreation(UUID userId, UUID itemId, String mediaSourceId,
        ...
        if (userId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userId' when calling onPlaybackStopped",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
        ...
        return apiClient.invokeAPI("/Users/{userId}/PlayingItems/{itemId}", HttpMethod.DELETE, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> onPlaybackStopped(UUID userId, UUID itemId, String mediaSourceId, String nextMediaType,
            Long positionTicks, String liveStreamId, String playSessionId) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
        return onPlaybackStoppedRequestCreation(userId, itemId, mediaSourceId, nextMediaType, positionTicks,
                liveStreamId, playSessionId).bodyToMono(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> onPlaybackStoppedWithHttpInfo(UUID userId, UUID itemId, String mediaSourceId,
            String nextMediaType, Long positionTicks, String liveStreamId, String playSessionId)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
        return onPlaybackStoppedRequestCreation(userId, itemId, mediaSourceId, nextMediaType, positionTicks,
                liveStreamId, playSessionId).toEntity(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec onPlaybackStoppedWithResponseSpec(UUID userId, UUID itemId, String mediaSourceId,
            String nextMediaType, Long positionTicks, String liveStreamId, String playSessionId)
            throws WebClientResponseException {
        return onPlaybackStoppedRequestCreation(userId, itemId, mediaSourceId, nextMediaType, positionTicks,
                liveStreamId, playSessionId);
    }
