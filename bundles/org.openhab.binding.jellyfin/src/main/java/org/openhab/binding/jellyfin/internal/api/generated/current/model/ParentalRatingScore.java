...
public class ParentalRatingScore {
    ...
    public ParentalRatingScore score(@org.eclipse.jdt.annotation.NonNull Integer score) {
        this.score = score;
        return this;
    }
    ...
    public ParentalRatingScore subScore(@org.eclipse.jdt.annotation.NonNull Integer subScore) {
    ...
    @JsonProperty(value = JSON_PROPERTY_SUB_SCORE, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSubScore(@org.eclipse.jdt.annotation.NonNull Integer subScore) {
        this.subScore = subScore;
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getSubScore() != null) {
            joiner.add(String.format(Locale.ROOT, "%ssubScore%s=%s", prefix, suffix,
