...
public class UtcTimeResponse {
    ...
    public UtcTimeResponse requestReceptionTime(
            @org.eclipse.jdt.annotation.Nullable OffsetDateTime requestReceptionTime) {
    ...
    @JsonProperty(value = JSON_PROPERTY_REQUEST_RECEPTION_TIME, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRequestReceptionTime(@org.eclipse.jdt.annotation.Nullable OffsetDateTime requestReceptionTime) {
        this.requestReceptionTime = requestReceptionTime;
    }

    public UtcTimeResponse responseTransmissionTime(
            @org.eclipse.jdt.annotation.Nullable OffsetDateTime responseTransmissionTime) {
