...
public class MediaPathInfo {
    ...
    public MediaPathInfo networkPath(@org.eclipse.jdt.annotation.Nullable String networkPath) {
    ...
    @JsonProperty(JSON_PROPERTY_NETWORK_PATH)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setNetworkPath(@org.eclipse.jdt.annotation.Nullable String networkPath) {
        this.networkPath = networkPath;
    }
