...
public class UniversalAudioApi {
    ...
    private ResponseSpec getUniversalAudioStreamRequestCreation(UUID itemId, List<String> container,
            ...
            String transcodingContainer, MediaStreamProtocol transcodingProtocol, Integer maxAudioSampleRate,
            Integer maxAudioBitDepth, Boolean enableRemoteMedia, Boolean enableAudioVbrEncoding,
        ...
        final String[] localVarAccepts = { "audio/*", "application/json", "application/json; profile=CamelCase",
    ...
    public Mono<File> getUniversalAudioStream(UUID itemId, List<String> container, String mediaSourceId,
            ...
            MediaStreamProtocol transcodingProtocol, Integer maxAudioSampleRate, Integer maxAudioBitDepth,
            Boolean enableRemoteMedia, Boolean enableAudioVbrEncoding, Boolean breakOnNonKeyFrames,
            Boolean enableRedirection) throws WebClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<File>() {
        };
