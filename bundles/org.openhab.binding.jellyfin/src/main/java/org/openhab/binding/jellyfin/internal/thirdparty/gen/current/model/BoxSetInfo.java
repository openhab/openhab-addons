...
public class BoxSetInfo {
    ...
    public BoxSetInfo name(@org.eclipse.jdt.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public BoxSetInfo originalTitle(@org.eclipse.jdt.annotation.Nullable String originalTitle) {
    ...
    public BoxSetInfo path(@org.eclipse.jdt.annotation.Nullable String path) {
        this.path = path;
        return this;
    }
    ...
    public BoxSetInfo metadataLanguage(@org.eclipse.jdt.annotation.Nullable String metadataLanguage) {
    ...
    public BoxSetInfo metadataCountryCode(@org.eclipse.jdt.annotation.Nullable String metadataCountryCode) {
    ...
    public BoxSetInfo providerIds(@org.eclipse.jdt.annotation.Nullable Map<String, String> providerIds) {
    ...
    public BoxSetInfo year(@org.eclipse.jdt.annotation.Nullable Integer year) {
        this.year = year;
        return this;
    }
    ...
    public BoxSetInfo indexNumber(@org.eclipse.jdt.annotation.Nullable Integer indexNumber) {
    ...
    public BoxSetInfo parentIndexNumber(@org.eclipse.jdt.annotation.Nullable Integer parentIndexNumber) {
    ...
    public BoxSetInfo premiereDate(@org.eclipse.jdt.annotation.Nullable OffsetDateTime premiereDate) {
    ...
    public BoxSetInfo isAutomated(@org.eclipse.jdt.annotation.Nullable Boolean isAutomated) {
