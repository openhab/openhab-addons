...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.TaskInfo;
...
public class ScheduledTasksApi {
     ...
     * 
     * <p>
     * <b>200</b> - Task retrieved.
     * <p>
     * <b>404</b> - Task not found.
     * <p>
    ...
    private ResponseSpec getTaskRequestCreation(String taskId) throws WebClientResponseException {
        ...
        if (taskId == null) {
            throw new WebClientResponseException("Missing the required parameter 'taskId' when calling getTask",
        ...
        return apiClient.invokeAPI("/ScheduledTasks/{taskId}", HttpMethod.GET, pathParams, queryParams, postBody,
     ...
     * 
     * <p>
     * <b>200</b> - Scheduled tasks retrieved.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getTasksRequestCreation(Boolean isHidden, Boolean isEnabled)
        ...
        return apiClient.invokeAPI("/ScheduledTasks", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<List<TaskInfo>>> getTasksWithHttpInfo(Boolean isHidden, Boolean isEnabled)
            throws WebClientResponseException {
        ParameterizedTypeReference<TaskInfo> localVarReturnType = new ParameterizedTypeReference<TaskInfo>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getTasksWithResponseSpec(Boolean isHidden, Boolean isEnabled)
            throws WebClientResponseException {
    ...
    private ResponseSpec startTaskRequestCreation(String taskId) throws WebClientResponseException {
        ...
        // verify the required parameter 'taskId' is set
        if (taskId == null) {
            throw new WebClientResponseException("Missing the required parameter 'taskId' when calling startTask",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/ScheduledTasks/Running/{taskId}", HttpMethod.POST, pathParams, queryParams,
    ...
    private ResponseSpec stopTaskRequestCreation(String taskId) throws WebClientResponseException {
        ...
        // verify the required parameter 'taskId' is set
        if (taskId == null) {
            throw new WebClientResponseException("Missing the required parameter 'taskId' when calling stopTask",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/ScheduledTasks/Running/{taskId}", HttpMethod.DELETE, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec updateTaskRequestCreation(String taskId, List<TaskTriggerInfo> taskTriggerInfo)
            throws WebClientResponseException {
        Object postBody = taskTriggerInfo;
        // verify the required parameter 'taskId' is set
        if (taskId == null) {
            throw new WebClientResponseException("Missing the required parameter 'taskId' when calling updateTask",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'taskTriggerInfo' is set
        if (taskTriggerInfo == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'taskTriggerInfo' when calling updateTask",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/ScheduledTasks/{taskId}/Triggers", HttpMethod.POST, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> updateTask(String taskId, List<TaskTriggerInfo> taskTriggerInfo)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> updateTaskWithHttpInfo(String taskId, List<TaskTriggerInfo> taskTriggerInfo)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec updateTaskWithResponseSpec(String taskId, List<TaskTriggerInfo> taskTriggerInfo)
            throws WebClientResponseException {
