...
public class BookInfo {
    ...
    public BookInfo name(@org.eclipse.jdt.annotation.NonNull String name) {
        this.name = name;
        return this;
    }
    ...
    public BookInfo originalTitle(@org.eclipse.jdt.annotation.NonNull String originalTitle) {
    ...
    public BookInfo path(@org.eclipse.jdt.annotation.NonNull String path) {
        this.path = path;
        return this;
    }
    ...
    public BookInfo metadataLanguage(@org.eclipse.jdt.annotation.NonNull String metadataLanguage) {
    ...
    public BookInfo metadataCountryCode(@org.eclipse.jdt.annotation.NonNull String metadataCountryCode) {
    ...
    public BookInfo providerIds(@org.eclipse.jdt.annotation.NonNull Map<String, String> providerIds) {
    ...
    public BookInfo year(@org.eclipse.jdt.annotation.NonNull Integer year) {
        this.year = year;
        return this;
    }
    ...
    public BookInfo indexNumber(@org.eclipse.jdt.annotation.NonNull Integer indexNumber) {
    ...
    public BookInfo parentIndexNumber(@org.eclipse.jdt.annotation.NonNull Integer parentIndexNumber) {
    ...
    public BookInfo premiereDate(@org.eclipse.jdt.annotation.NonNull OffsetDateTime premiereDate) {
    ...
    public BookInfo isAutomated(@org.eclipse.jdt.annotation.NonNull Boolean isAutomated) {
    ...
    public BookInfo seriesName(@org.eclipse.jdt.annotation.NonNull String seriesName) {
