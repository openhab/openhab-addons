...
import org.openhab.binding.jellyfin.internal.api.version.current.model.AllThemeMediaResult;
...
import org.openhab.binding.jellyfin.internal.api.version.current.model.ItemCounts;
...
import org.openhab.binding.jellyfin.internal.api.version.current.model.LibraryOptionsResultDto;
import org.openhab.binding.jellyfin.internal.api.version.current.model.MediaUpdateInfoDto;
...
public class LibraryApi {
    ...
    private ResponseSpec deleteItemRequestCreation(UUID itemId) throws WebClientResponseException {
        ...
        if (itemId == null) {
            throw new WebClientResponseException("Missing the required parameter 'itemId' when calling deleteItem",
        ...
        return apiClient.invokeAPI("/Items/{itemId}", HttpMethod.DELETE, pathParams, queryParams, postBody,
    ...
    private ResponseSpec deleteItemsRequestCreation(List<UUID> ids) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Items", HttpMethod.DELETE, pathParams, queryParams, postBody, headerParams,
    ...
    private ResponseSpec getAncestorsRequestCreation(UUID itemId, UUID userId) throws WebClientResponseException {
        ...
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException("Missing the required parameter 'itemId' when calling getAncestors",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Items/{itemId}/Ancestors", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<List<BaseItemDto>>> getAncestorsWithHttpInfo(UUID itemId, UUID userId)
     ...
     * 
     * <p>
     * <b>200</b> - Critic reviews returned.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
    ...
    private ResponseSpec getCriticReviewsRequestCreation(String itemId) throws WebClientResponseException {
        ...
        if (itemId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'itemId' when calling getCriticReviews",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Items/{itemId}/CriticReviews", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getCriticReviewsWithHttpInfo(String itemId)
            throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
    ...
    private ResponseSpec getDownloadRequestCreation(UUID itemId) throws WebClientResponseException {
        ...
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException("Missing the required parameter 'itemId' when calling getDownload",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        final String[] localVarAccepts = { "video/*", "audio/*", "application/json",
        ...
        return apiClient.invokeAPI("/Items/{itemId}/Download", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
    ...
    private ResponseSpec getFileRequestCreation(UUID itemId) throws WebClientResponseException {
        ...
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException("Missing the required parameter 'itemId' when calling getFile",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Items/{itemId}/File", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getItemCountsRequestCreation(UUID userId, Boolean isFavorite)
            throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Items/Counts", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<ItemCounts>> getItemCountsWithHttpInfo(UUID userId, Boolean isFavorite)
            throws WebClientResponseException {
        ParameterizedTypeReference<ItemCounts> localVarReturnType = new ParameterizedTypeReference<ItemCounts>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getItemCountsWithResponseSpec(UUID userId, Boolean isFavorite)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>200</b> - Library options info returned.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getLibraryOptionsInfoRequestCreation(CollectionType libraryContentType, Boolean isNewLibrary)
            throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Libraries/AvailableOptions", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<LibraryOptionsResultDto> getLibraryOptionsInfo(CollectionType libraryContentType, Boolean isNewLibrary)
            throws WebClientResponseException {
        ParameterizedTypeReference<LibraryOptionsResultDto> localVarReturnType = new ParameterizedTypeReference<LibraryOptionsResultDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<LibraryOptionsResultDto>> getLibraryOptionsInfoWithHttpInfo(
            CollectionType libraryContentType, Boolean isNewLibrary) throws WebClientResponseException {
        ParameterizedTypeReference<LibraryOptionsResultDto> localVarReturnType = new ParameterizedTypeReference<LibraryOptionsResultDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getLibraryOptionsInfoWithResponseSpec(CollectionType libraryContentType, Boolean isNewLibrary)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>200</b> - Media folders returned.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
    ...
    private ResponseSpec getMediaFoldersRequestCreation(Boolean isHidden) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Library/MediaFolders", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getMediaFoldersWithHttpInfo(Boolean isHidden)
            throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * 
     * <p>
     * <b>200</b> - Physical paths returned.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
    ...
    private ResponseSpec getPhysicalPathsRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Library/PhysicalPaths", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * 
     * <p>
     * <b>200</b> - Similar items returned.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getSimilarAlbumsRequestCreation(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'itemId' when calling getSimilarAlbums",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Albums/{itemId}/Similar", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getSimilarAlbums(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getSimilarAlbumsWithHttpInfo(UUID itemId,
            List<UUID> excludeArtistIds, UUID userId, Integer limit, List<ItemFields> fields)
            throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
        return getSimilarAlbumsRequestCreation(itemId, excludeArtistIds, userId, limit, fields)
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getSimilarAlbumsWithResponseSpec(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        return getSimilarAlbumsRequestCreation(itemId, excludeArtistIds, userId, limit, fields);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getSimilarArtistsRequestCreation(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'itemId' when calling getSimilarArtists",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Artists/{itemId}/Similar", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getSimilarArtists(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getSimilarArtistsWithHttpInfo(UUID itemId,
            List<UUID> excludeArtistIds, UUID userId, Integer limit, List<ItemFields> fields)
            throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getSimilarArtistsWithResponseSpec(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        return getSimilarArtistsRequestCreation(itemId, excludeArtistIds, userId, limit, fields);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getSimilarItemsRequestCreation(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException("Missing the required parameter 'itemId' when calling getSimilarItems",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Items/{itemId}/Similar", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getSimilarItems(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getSimilarItemsWithHttpInfo(UUID itemId,
            List<UUID> excludeArtistIds, UUID userId, Integer limit, List<ItemFields> fields)
            throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getSimilarItemsWithResponseSpec(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        return getSimilarItemsRequestCreation(itemId, excludeArtistIds, userId, limit, fields);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getSimilarMoviesRequestCreation(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'itemId' when calling getSimilarMovies",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Movies/{itemId}/Similar", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getSimilarMovies(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getSimilarMoviesWithHttpInfo(UUID itemId,
            List<UUID> excludeArtistIds, UUID userId, Integer limit, List<ItemFields> fields)
            throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getSimilarMoviesWithResponseSpec(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        return getSimilarMoviesRequestCreation(itemId, excludeArtistIds, userId, limit, fields);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getSimilarShowsRequestCreation(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException("Missing the required parameter 'itemId' when calling getSimilarShows",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Shows/{itemId}/Similar", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getSimilarShows(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getSimilarShowsWithHttpInfo(UUID itemId,
            List<UUID> excludeArtistIds, UUID userId, Integer limit, List<ItemFields> fields)
            throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getSimilarShowsWithResponseSpec(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        return getSimilarShowsRequestCreation(itemId, excludeArtistIds, userId, limit, fields);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getSimilarTrailersRequestCreation(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'itemId' when calling getSimilarTrailers",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Trailers/{itemId}/Similar", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getSimilarTrailers(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getSimilarTrailersWithHttpInfo(UUID itemId,
            List<UUID> excludeArtistIds, UUID userId, Integer limit, List<ItemFields> fields)
            throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getSimilarTrailersWithResponseSpec(UUID itemId, List<UUID> excludeArtistIds, UUID userId,
            Integer limit, List<ItemFields> fields) throws WebClientResponseException {
        return getSimilarTrailersRequestCreation(itemId, excludeArtistIds, userId, limit, fields);
    }
     ...
     * 
     * <p>
     * <b>200</b> - Theme songs and videos returned.
     * <p>
     * <b>404</b> - Item not found.
     * <p>
     * <b>401</b> - Unauthorized
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getThemeMediaRequestCreation(UUID itemId, UUID userId, Boolean inheritFromParent,
            List<ItemSortBy> sortBy, List<SortOrder> sortOrder) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException("Missing the required parameter 'itemId' when calling getThemeMedia",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Items/{itemId}/ThemeMedia", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<AllThemeMediaResult> getThemeMedia(UUID itemId, UUID userId, Boolean inheritFromParent,
            List<ItemSortBy> sortBy, List<SortOrder> sortOrder) throws WebClientResponseException {
        ParameterizedTypeReference<AllThemeMediaResult> localVarReturnType = new ParameterizedTypeReference<AllThemeMediaResult>() {
        };
        return getThemeMediaRequestCreation(itemId, userId, inheritFromParent, sortBy, sortOrder)
                .bodyToMono(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<AllThemeMediaResult>> getThemeMediaWithHttpInfo(UUID itemId, UUID userId,
            Boolean inheritFromParent, List<ItemSortBy> sortBy, List<SortOrder> sortOrder)
            throws WebClientResponseException {
        ParameterizedTypeReference<AllThemeMediaResult> localVarReturnType = new ParameterizedTypeReference<AllThemeMediaResult>() {
        };
        return getThemeMediaRequestCreation(itemId, userId, inheritFromParent, sortBy, sortOrder)
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getThemeMediaWithResponseSpec(UUID itemId, UUID userId, Boolean inheritFromParent,
            List<ItemSortBy> sortBy, List<SortOrder> sortOrder) throws WebClientResponseException {
        return getThemeMediaRequestCreation(itemId, userId, inheritFromParent, sortBy, sortOrder);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getThemeSongsRequestCreation(UUID itemId, UUID userId, Boolean inheritFromParent,
            List<ItemSortBy> sortBy, List<SortOrder> sortOrder) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException("Missing the required parameter 'itemId' when calling getThemeSongs",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Items/{itemId}/ThemeSongs", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ThemeMediaResult> getThemeSongs(UUID itemId, UUID userId, Boolean inheritFromParent,
            List<ItemSortBy> sortBy, List<SortOrder> sortOrder) throws WebClientResponseException {
        ParameterizedTypeReference<ThemeMediaResult> localVarReturnType = new ParameterizedTypeReference<ThemeMediaResult>() {
        };
        return getThemeSongsRequestCreation(itemId, userId, inheritFromParent, sortBy, sortOrder)
                .bodyToMono(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<ThemeMediaResult>> getThemeSongsWithHttpInfo(UUID itemId, UUID userId,
            Boolean inheritFromParent, List<ItemSortBy> sortBy, List<SortOrder> sortOrder)
            throws WebClientResponseException {
        ParameterizedTypeReference<ThemeMediaResult> localVarReturnType = new ParameterizedTypeReference<ThemeMediaResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getThemeSongsWithResponseSpec(UUID itemId, UUID userId, Boolean inheritFromParent,
            List<ItemSortBy> sortBy, List<SortOrder> sortOrder) throws WebClientResponseException {
        return getThemeSongsRequestCreation(itemId, userId, inheritFromParent, sortBy, sortOrder);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getThemeVideosRequestCreation(UUID itemId, UUID userId, Boolean inheritFromParent,
            List<ItemSortBy> sortBy, List<SortOrder> sortOrder) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
            throw new WebClientResponseException("Missing the required parameter 'itemId' when calling getThemeVideos",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Items/{itemId}/ThemeVideos", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ThemeMediaResult> getThemeVideos(UUID itemId, UUID userId, Boolean inheritFromParent,
            List<ItemSortBy> sortBy, List<SortOrder> sortOrder) throws WebClientResponseException {
        ParameterizedTypeReference<ThemeMediaResult> localVarReturnType = new ParameterizedTypeReference<ThemeMediaResult>() {
        };
        return getThemeVideosRequestCreation(itemId, userId, inheritFromParent, sortBy, sortOrder)
                .bodyToMono(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<ThemeMediaResult>> getThemeVideosWithHttpInfo(UUID itemId, UUID userId,
            Boolean inheritFromParent, List<ItemSortBy> sortBy, List<SortOrder> sortOrder)
            throws WebClientResponseException {
        ParameterizedTypeReference<ThemeMediaResult> localVarReturnType = new ParameterizedTypeReference<ThemeMediaResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getThemeVideosWithResponseSpec(UUID itemId, UUID userId, Boolean inheritFromParent,
            List<ItemSortBy> sortBy, List<SortOrder> sortOrder) throws WebClientResponseException {
        return getThemeVideosRequestCreation(itemId, userId, inheritFromParent, sortBy, sortOrder);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec postAddedMoviesRequestCreation(String tmdbId, String imdbId)
            throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Library/Movies/Added", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> postAddedMoviesWithHttpInfo(String tmdbId, String imdbId)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec postAddedMoviesWithResponseSpec(String tmdbId, String imdbId)
            throws WebClientResponseException {
    ...
    private ResponseSpec postAddedSeriesRequestCreation(String tvdbId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Library/Series/Added", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec postUpdatedMediaRequestCreation(MediaUpdateInfoDto mediaUpdateInfoDto)
            throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Library/Media/Updated", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> postUpdatedMediaWithHttpInfo(MediaUpdateInfoDto mediaUpdateInfoDto)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec postUpdatedMediaWithResponseSpec(MediaUpdateInfoDto mediaUpdateInfoDto)
            throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec postUpdatedMoviesRequestCreation(String tmdbId, String imdbId)
            throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Library/Movies/Updated", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> postUpdatedMoviesWithHttpInfo(String tmdbId, String imdbId)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec postUpdatedMoviesWithResponseSpec(String tmdbId, String imdbId)
            throws WebClientResponseException {
    ...
    private ResponseSpec postUpdatedSeriesRequestCreation(String tvdbId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Library/Series/Updated", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
    ...
    private ResponseSpec refreshLibraryRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Library/Refresh", HttpMethod.POST, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
