...
public class CastReceiverApplication {
    ...
    public CastReceiverApplication id(@org.eclipse.jdt.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public CastReceiverApplication name(@org.eclipse.jdt.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
