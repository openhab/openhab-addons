...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.ChannelItemSortField;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.ChannelMediaContentType;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.ChannelMediaType;
  ...
  */
  public ChannelFeatures.Builder toBuilder() {
    return new ChannelFeatures.Builder()
      ...
      .autoRefreshLevels(getAutoRefreshLevels())
      .defaultSortFields(getDefaultSortFields())
      .supportsSortOrderToggle(getSupportsSortOrderToggle())
      .supportsLatestMedia(getSupportsLatestMedia())
      .canFilter(getCanFilter())
      .supportsContentDownloading(getSupportsContentDownloading());
  }
