...
public class MusicVideoInfo {
    ...
    public MusicVideoInfo name(@org.eclipse.jdt.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public MusicVideoInfo originalTitle(@org.eclipse.jdt.annotation.Nullable String originalTitle) {
    ...
    public MusicVideoInfo path(@org.eclipse.jdt.annotation.Nullable String path) {
        this.path = path;
        return this;
    }
    ...
    public MusicVideoInfo metadataLanguage(@org.eclipse.jdt.annotation.Nullable String metadataLanguage) {
    ...
    public MusicVideoInfo metadataCountryCode(@org.eclipse.jdt.annotation.Nullable String metadataCountryCode) {
    ...
    public MusicVideoInfo providerIds(@org.eclipse.jdt.annotation.Nullable Map<String, String> providerIds) {
    ...
    public MusicVideoInfo year(@org.eclipse.jdt.annotation.Nullable Integer year) {
        this.year = year;
        return this;
    }
    ...
    public MusicVideoInfo indexNumber(@org.eclipse.jdt.annotation.Nullable Integer indexNumber) {
    ...
    public MusicVideoInfo parentIndexNumber(@org.eclipse.jdt.annotation.Nullable Integer parentIndexNumber) {
    ...
    public MusicVideoInfo premiereDate(@org.eclipse.jdt.annotation.Nullable OffsetDateTime premiereDate) {
    ...
    public MusicVideoInfo isAutomated(@org.eclipse.jdt.annotation.Nullable Boolean isAutomated) {
    ...
    public MusicVideoInfo artists(@org.eclipse.jdt.annotation.Nullable List<String> artists) {
