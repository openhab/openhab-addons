...
public class UserViewsApi {
  ...
  private HttpRequest.Builder getUserViewsRequestBuilder(UUID userId, Boolean includeExternalContent, List<String> presetViews, Boolean includeHidden) throws ApiException {
    // verify the required parameter 'userId' is set
    if (userId == null) {
