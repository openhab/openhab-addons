...
@JsonPropertyOrder({ SystemInfo.JSON_PROPERTY_LOCAL_ADDRESS, SystemInfo.JSON_PROPERTY_SERVER_NAME,
        ...
        SystemInfo.JSON_PROPERTY_TRANSCODING_TEMP_PATH, SystemInfo.JSON_PROPERTY_HAS_UPDATE_AVAILABLE,
        SystemInfo.JSON_PROPERTY_ENCODER_LOCATION, SystemInfo.JSON_PROPERTY_SYSTEM_ARCHITECTURE })
...
public class SystemInfo {
    ...
    public SystemInfo encoderLocation(@javax.annotation.Nullable FFmpegLocation encoderLocation) {
    ...
    @JsonProperty(JSON_PROPERTY_ENCODER_LOCATION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setEncoderLocation(@javax.annotation.Nullable FFmpegLocation encoderLocation) {
        this.encoderLocation = encoderLocation;
    }

    public SystemInfo systemArchitecture(@javax.annotation.Nullable Architecture systemArchitecture) {
    ...
    @JsonProperty(JSON_PROPERTY_SYSTEM_ARCHITECTURE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSystemArchitecture(@javax.annotation.Nullable Architecture systemArchitecture) {
        this.systemArchitecture = systemArchitecture;
    }
    ...
    public int hashCode() {
        return Objects.hash(hashCodeNullable(localAddress), hashCodeNullable(serverName), hashCodeNullable(version),
                ...
                hashCodeNullable(transcodingTempPath), hasUpdateAvailable, encoderLocation, systemArchitecture);
    }
    ...
    public static class Builder {
        ...
        public SystemInfo.Builder encoderLocation(FFmpegLocation encoderLocation) {
            this.instance.encoderLocation = encoderLocation;
            return this;
        }

        public SystemInfo.Builder systemArchitecture(Architecture systemArchitecture) {
    ...
    public SystemInfo.Builder toBuilder() {
        return new SystemInfo.Builder().localAddress(getLocalAddress()).serverName(getServerName())
                ...
                .transcodingTempPath(getTranscodingTempPath()).hasUpdateAvailable(getHasUpdateAvailable())
                .encoderLocation(getEncoderLocation()).systemArchitecture(getSystemArchitecture());
    }
}
