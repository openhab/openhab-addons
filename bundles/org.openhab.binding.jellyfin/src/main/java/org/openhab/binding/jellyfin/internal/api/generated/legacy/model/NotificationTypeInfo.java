...
public class NotificationTypeInfo {
    ...
    public NotificationTypeInfo type(@org.eclipse.jdt.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public NotificationTypeInfo name(@org.eclipse.jdt.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public NotificationTypeInfo enabled(@org.eclipse.jdt.annotation.Nullable Boolean enabled) {
    ...
    public NotificationTypeInfo category(@org.eclipse.jdt.annotation.Nullable String category) {
    ...
    public NotificationTypeInfo isBasedOnUserEvent(@org.eclipse.jdt.annotation.Nullable Boolean isBasedOnUserEvent) {
    ...
    @JsonProperty(JSON_PROPERTY_IS_BASED_ON_USER_EVENT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setIsBasedOnUserEvent(@org.eclipse.jdt.annotation.Nullable Boolean isBasedOnUserEvent) {
        this.isBasedOnUserEvent = isBasedOnUserEvent;
    }
