...
public class SessionApi {
  ...
  public List<SessionInfoDto> getSessions(UUID controllableByUserId, String deviceId, Integer activeWithinSeconds) throws ApiException {
    ApiResponse<List<SessionInfoDto>> localVarResponse = getSessionsWithHttpInfo(controllableByUserId, deviceId, activeWithinSeconds);
    return localVarResponse.getData();
  }
  ...
  public ApiResponse<List<SessionInfoDto>> getSessionsWithHttpInfo(UUID controllableByUserId, String deviceId, Integer activeWithinSeconds) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        if (localVarResponse.body() == null) {
          return new ApiResponse<List<SessionInfoDto>>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<List<SessionInfoDto>>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<SessionInfoDto>>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  public ApiResponse<Void> postCapabilitiesWithHttpInfo(String id, List<MediaType> playableMediaTypes, List<GeneralCommandType> supportedCommands, Boolean supportsMediaControl, Boolean supportsPersistentIdentifier) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = postCapabilitiesRequestBuilder(id, playableMediaTypes, supportedCommands, supportsMediaControl, supportsPersistentIdentifier);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder postCapabilitiesRequestBuilder(String id, List<MediaType> playableMediaTypes, List<GeneralCommandType> supportedCommands, Boolean supportsMediaControl, Boolean supportsPersistentIdentifier) throws ApiException {
