...
public class PluginInstallationCancelledMessage {
    ...
    public PluginInstallationCancelledMessage data(@org.eclipse.jdt.annotation.Nullable InstallationInfo data) {
        this.data = data;
        return this;
    }
    ...
    public PluginInstallationCancelledMessage messageId(@org.eclipse.jdt.annotation.Nullable UUID messageId) {
    ...
    public PluginInstallationCancelledMessage.Builder toBuilder() {
        return new PluginInstallationCancelledMessage.Builder().data(getData()).messageId(getMessageId())
