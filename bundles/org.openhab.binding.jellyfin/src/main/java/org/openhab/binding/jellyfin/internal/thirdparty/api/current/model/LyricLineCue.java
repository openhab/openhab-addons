...
public class LyricLineCue {
    ...
    public LyricLineCue position(@org.eclipse.jdt.annotation.Nullable Integer position) {
    ...
    @JsonProperty(value = JSON_PROPERTY_POSITION, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setPosition(@org.eclipse.jdt.annotation.Nullable Integer position) {
        this.position = position;
    }

    public LyricLineCue endPosition(@org.eclipse.jdt.annotation.Nullable Integer endPosition) {
    ...
    @JsonProperty(value = JSON_PROPERTY_END_POSITION, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setEndPosition(@org.eclipse.jdt.annotation.Nullable Integer endPosition) {
        this.endPosition = endPosition;
    }

    public LyricLineCue start(@org.eclipse.jdt.annotation.Nullable Long start) {
        this.start = start;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_START, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setStart(@org.eclipse.jdt.annotation.Nullable Long start) {
        this.start = start;
    }

    public LyricLineCue end(@org.eclipse.jdt.annotation.Nullable Long end) {
        this.end = end;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_END, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setEnd(@org.eclipse.jdt.annotation.Nullable Long end) {
        this.end = end;
    }
