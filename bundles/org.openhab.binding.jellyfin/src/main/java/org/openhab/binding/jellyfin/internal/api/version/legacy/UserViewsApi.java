...
public class UserViewsApi {
    ...
    private ResponseSpec getGroupingOptionsRequestCreation(UUID userId) throws WebClientResponseException {
        ...
        if (userId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userId' when calling getGroupingOptions",
        ...
        return apiClient.invokeAPI("/Users/{userId}/GroupingOptions", HttpMethod.GET, pathParams, queryParams, postBody,
    ...
    private ResponseSpec getUserViewsRequestCreation(UUID userId, Boolean includeExternalContent,
            List<String> presetViews, Boolean includeHidden) throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException("Missing the required parameter 'userId' when calling getUserViews",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Users/{userId}/Views", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
    ...
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getUserViewsWithHttpInfo(UUID userId,
            Boolean includeExternalContent, List<String> presetViews, Boolean includeHidden)
            throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {
        };
        return getUserViewsRequestCreation(userId, includeExternalContent, presetViews, includeHidden)
