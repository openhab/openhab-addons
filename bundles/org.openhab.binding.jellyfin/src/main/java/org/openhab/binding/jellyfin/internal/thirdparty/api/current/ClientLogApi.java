...
import org.openhab.binding.jellyfin.internal.thirdparty.api.current.model.ClientLogDocumentResponseDto;
...
public class ClientLogApi {
     ...
     */
    public ClientLogDocumentResponseDto logFile(@org.eclipse.jdt.annotation.Nullable File body) throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public ClientLogDocumentResponseDto logFile(@org.eclipse.jdt.annotation.Nullable File body,
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<ClientLogDocumentResponseDto> logFileWithHttpInfo(@org.eclipse.jdt.annotation.Nullable File body)
            throws ApiException {
    ...
    private HttpRequest.Builder logFileRequestBuilder(@org.eclipse.jdt.annotation.Nullable File body,
            Map<String, String> headers) throws ApiException {
