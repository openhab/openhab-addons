...
public class GenresApi {
    ...
    private ResponseSpec getGenresRequestCreation(Integer startIndex, Integer limit, String searchTerm, UUID parentId,
            ...
            String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan, List<String> sortBy,
    ...
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getGenresWithHttpInfo(Integer startIndex, Integer limit,
            ...
            String nameLessThan, List<String> sortBy, List<SortOrder> sortOrder, Boolean enableImages,
