...
public class ServerConfiguration {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getInactiveSessionThreshold() != null) {
      joiner.add(String.format("%sInactiveSessionThreshold%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getInactiveSessionThreshold()))));
    }
    ...
    if (getLibraryUpdateDuration() != null) {
      joiner.add(String.format("%sLibraryUpdateDuration%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLibraryUpdateDuration()))));
    }
    ...
    if (getDummyChapterDuration() != null) {
      joiner.add(String.format("%sDummyChapterDuration%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDummyChapterDuration()))));
    }

    // add `ChapterImageResolution` to the URL query string
    if (getChapterImageResolution() != null) {
      joiner.add(String.format("%sChapterImageResolution%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getChapterImageResolution()))));
    }

    // add `ParallelImageEncodingLimit` to the URL query string
    if (getParallelImageEncodingLimit() != null) {
      joiner.add(String.format("%sParallelImageEncodingLimit%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getParallelImageEncodingLimit()))));
    }
