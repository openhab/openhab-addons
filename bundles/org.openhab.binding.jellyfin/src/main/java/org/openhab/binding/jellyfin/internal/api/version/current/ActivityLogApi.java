...
public class ActivityLogApi {
     ...
     */
    public ActivityLogEntryQueryResult getLogEntries(Integer startIndex, Integer limit, OffsetDateTime minDate,
            Boolean hasUserId) throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<ActivityLogEntryQueryResult> getLogEntriesWithHttpInfo(Integer startIndex, Integer limit,
            OffsetDateTime minDate, Boolean hasUserId) throws ApiException {
    ...
    private HttpRequest.Builder getLogEntriesRequestBuilder(Integer startIndex, Integer limit, OffsetDateTime minDate,
            Boolean hasUserId) throws ApiException {
