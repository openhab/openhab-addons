...
public class ActivityLogApi {
     ...
     */
    private ResponseSpec getLogEntriesRequestCreation(Integer startIndex, Integer limit, OffsetDateTime minDate,
            Boolean hasUserId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/System/ActivityLog/Entries", HttpMethod.GET, pathParams, queryParams, postBody,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ActivityLogEntryQueryResult> getLogEntries(Integer startIndex, Integer limit, OffsetDateTime minDate,
            Boolean hasUserId) throws WebClientResponseException {
        ParameterizedTypeReference<ActivityLogEntryQueryResult> localVarReturnType = new ParameterizedTypeReference<ActivityLogEntryQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<ActivityLogEntryQueryResult>> getLogEntriesWithHttpInfo(Integer startIndex,
            Integer limit, OffsetDateTime minDate, Boolean hasUserId) throws WebClientResponseException {
        ParameterizedTypeReference<ActivityLogEntryQueryResult> localVarReturnType = new ParameterizedTypeReference<ActivityLogEntryQueryResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getLogEntriesWithResponseSpec(Integer startIndex, Integer limit, OffsetDateTime minDate,
            Boolean hasUserId) throws WebClientResponseException {
