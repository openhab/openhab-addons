...
public class MovieInfoRemoteSearchQuery {
    ...
    public MovieInfoRemoteSearchQuery searchInfo(@org.eclipse.jdt.annotation.Nullable MovieInfo searchInfo) {
    ...
    @JsonProperty(value = JSON_PROPERTY_SEARCH_INFO, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSearchInfo(@org.eclipse.jdt.annotation.Nullable MovieInfo searchInfo) {
        this.searchInfo = searchInfo;
    }

    public MovieInfoRemoteSearchQuery itemId(@org.eclipse.jdt.annotation.Nullable UUID itemId) {
        this.itemId = itemId;
        return this;
    }
