...
public class NetworkConfiguration {
    ...
    public NetworkConfiguration baseUrl(@org.eclipse.jdt.annotation.NonNull String baseUrl) {
    ...
    public NetworkConfiguration enableHttps(@org.eclipse.jdt.annotation.NonNull Boolean enableHttps) {
    ...
    public NetworkConfiguration requireHttps(@org.eclipse.jdt.annotation.NonNull Boolean requireHttps) {
    ...
    public NetworkConfiguration certificatePath(@org.eclipse.jdt.annotation.NonNull String certificatePath) {
    ...
    public NetworkConfiguration certificatePassword(@org.eclipse.jdt.annotation.NonNull String certificatePassword) {
    ...
    public NetworkConfiguration internalHttpPort(@org.eclipse.jdt.annotation.NonNull Integer internalHttpPort) {
    ...
    public NetworkConfiguration internalHttpsPort(@org.eclipse.jdt.annotation.NonNull Integer internalHttpsPort) {
    ...
    public NetworkConfiguration publicHttpPort(@org.eclipse.jdt.annotation.NonNull Integer publicHttpPort) {
    ...
    public NetworkConfiguration publicHttpsPort(@org.eclipse.jdt.annotation.NonNull Integer publicHttpsPort) {
    ...
    public NetworkConfiguration autoDiscovery(@org.eclipse.jdt.annotation.NonNull Boolean autoDiscovery) {
    ...
    public NetworkConfiguration enableUPnP(@org.eclipse.jdt.annotation.NonNull Boolean enableUPnP) {
    ...
    public NetworkConfiguration enableIPv4(@org.eclipse.jdt.annotation.NonNull Boolean enableIPv4) {
    ...
    public NetworkConfiguration enableIPv6(@org.eclipse.jdt.annotation.NonNull Boolean enableIPv6) {
    ...
    public NetworkConfiguration enableRemoteAccess(@org.eclipse.jdt.annotation.NonNull Boolean enableRemoteAccess) {
    ...
    public NetworkConfiguration localNetworkSubnets(
            @org.eclipse.jdt.annotation.NonNull List<String> localNetworkSubnets) {
    ...
    public NetworkConfiguration localNetworkAddresses(
            @org.eclipse.jdt.annotation.NonNull List<String> localNetworkAddresses) {
    ...
    public NetworkConfiguration knownProxies(@org.eclipse.jdt.annotation.NonNull List<String> knownProxies) {
    ...
    public NetworkConfiguration ignoreVirtualInterfaces(
            @org.eclipse.jdt.annotation.NonNull Boolean ignoreVirtualInterfaces) {
    ...
    public NetworkConfiguration virtualInterfaceNames(
            @org.eclipse.jdt.annotation.NonNull List<String> virtualInterfaceNames) {
    ...
    public NetworkConfiguration remoteIPFilter(@org.eclipse.jdt.annotation.NonNull List<String> remoteIPFilter) {
    ...
    public NetworkConfiguration isRemoteIPFilterBlacklist(
            @org.eclipse.jdt.annotation.NonNull Boolean isRemoteIPFilterBlacklist) {
