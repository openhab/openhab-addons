...
public class ItemRefreshApi {
  ...
  public ApiResponse<Void> refreshItemWithHttpInfo(UUID itemId, MetadataRefreshMode metadataRefreshMode, MetadataRefreshMode imageRefreshMode, Boolean replaceAllMetadata, Boolean replaceAllImages) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = refreshItemRequestBuilder(itemId, metadataRefreshMode, imageRefreshMode, replaceAllMetadata, replaceAllImages);
    try {
  ...
  private HttpRequest.Builder refreshItemRequestBuilder(UUID itemId, MetadataRefreshMode metadataRefreshMode, MetadataRefreshMode imageRefreshMode, Boolean replaceAllMetadata, Boolean replaceAllImages) throws ApiException {
