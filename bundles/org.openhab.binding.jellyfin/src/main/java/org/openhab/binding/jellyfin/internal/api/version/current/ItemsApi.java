...
public class ItemsApi {
     ...
     * @throws ApiException if fails to make API call
     */
    public BaseItemDtoQueryResult getItems(UUID userId, String maxOfficialRating, Boolean hasThemeSong,
            ...
            List<UUID> genreIds, Boolean enableTotalRecordCount, Boolean enableImages) throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<BaseItemDtoQueryResult> getItemsWithHttpInfo(UUID userId, String maxOfficialRating,
    ...
    private HttpRequest.Builder getItemsRequestBuilder(UUID userId, String maxOfficialRating, Boolean hasThemeSong,
            Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, UUID adjacentTo,
            Integer indexNumber, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHd, Boolean is4K,
            List<LocationType> locationTypes, List<LocationType> excludeLocationTypes, Boolean isMissing,
            Boolean isUnaired, Double minCommunityRating, Double minCriticRating, OffsetDateTime minPremiereDate,
     ...
     * @throws ApiException if fails to make API call
     */
    public BaseItemDtoQueryResult getResumeItems(UUID userId, Integer startIndex, Integer limit, String searchTerm,
            UUID parentId, List<ItemFields> fields, List<MediaType> mediaTypes, Boolean enableUserData,
            ...
            Boolean excludeActiveSessions) throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<BaseItemDtoQueryResult> getResumeItemsWithHttpInfo(UUID userId, Integer startIndex,
            ...
            Boolean enableImages, Boolean excludeActiveSessions) throws ApiException {
    ...
    private HttpRequest.Builder getResumeItemsRequestBuilder(UUID userId, Integer startIndex, Integer limit,
     ...
     * @throws ApiException if fails to make API call
     */
    public UserItemDataDto updateItemUserData(UUID itemId, UpdateUserItemDataDto updateUserItemDataDto, UUID userId)
            throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<UserItemDataDto> updateItemUserDataWithHttpInfo(UUID itemId,
            UpdateUserItemDataDto updateUserItemDataDto, UUID userId) throws ApiException {
    ...
    private HttpRequest.Builder updateItemUserDataRequestBuilder(UUID itemId,
            UpdateUserItemDataDto updateUserItemDataDto, UUID userId) throws ApiException {
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
