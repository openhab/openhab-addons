...
public class TvShowsApi {
    ...
    public ApiResponse<BaseItemDtoQueryResult> getEpisodesWithHttpInfo(UUID seriesId, UUID userId,
            ...
            List<ImageType> enableImageTypes, Boolean enableUserData, String sortBy) throws ApiException {
    ...
    private HttpRequest.Builder getEpisodesRequestBuilder(UUID seriesId, UUID userId, List<ItemFields> fields,
            Integer season, UUID seasonId, Boolean isMissing, String adjacentTo, UUID startItemId, Integer startIndex,
            Integer limit, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes,
            Boolean enableUserData, String sortBy) throws ApiException {
    ...
    public BaseItemDtoQueryResult getNextUp(UUID userId, Integer startIndex, Integer limit, List<ItemFields> fields,
            String seriesId, UUID parentId, Boolean enableImages, Integer imageTypeLimit,
            List<ImageType> enableImageTypes, Boolean enableUserData, OffsetDateTime nextUpDateCutoff,
            Boolean enableTotalRecordCount, Boolean disableFirstEpisode, Boolean enableRewatching) throws ApiException {
        ApiResponse<BaseItemDtoQueryResult> localVarResponse = getNextUpWithHttpInfo(userId, startIndex, limit, fields,
                ...
                enableTotalRecordCount, disableFirstEpisode, enableRewatching);
        return localVarResponse.getData();
    }
