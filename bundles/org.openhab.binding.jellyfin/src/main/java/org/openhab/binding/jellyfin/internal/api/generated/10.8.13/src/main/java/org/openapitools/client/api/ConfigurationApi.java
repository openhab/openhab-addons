...
public class ConfigurationApi {
  ...
  public ApiResponse<Void> updateMediaEncoderPathWithHttpInfo(MediaEncoderPathDto mediaEncoderPathDto) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = updateMediaEncoderPathRequestBuilder(mediaEncoderPathDto);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder updateMediaEncoderPathRequestBuilder(MediaEncoderPathDto mediaEncoderPathDto) throws ApiException {
    // verify the required parameter 'mediaEncoderPathDto' is set
    if (mediaEncoderPathDto == null) {
      throw new ApiException(400, "Missing the required parameter 'mediaEncoderPathDto' when calling updateMediaEncoderPath");
    }
