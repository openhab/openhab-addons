...
public class BackupRestoreRequestDto {
    ...
    public BackupRestoreRequestDto archiveFileName(@org.eclipse.jdt.annotation.NonNull String archiveFileName) {
    ...
    @JsonProperty(value = JSON_PROPERTY_ARCHIVE_FILE_NAME, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setArchiveFileName(@org.eclipse.jdt.annotation.NonNull String archiveFileName) {
        this.archiveFileName = archiveFileName;
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getArchiveFileName() != null) {
            joiner.add(String.format(Locale.ROOT, "%sArchiveFileName%s=%s", prefix, suffix,
