...
public class ItemsApi {
     ...
     */
    public UserItemDataDto getItemUserData(@org.eclipse.jdt.annotation.NonNull UUID itemId,
            @org.eclipse.jdt.annotation.Nullable UUID userId) throws ApiException {
        return getItemUserData(itemId, userId, null);
    }
    ...
    public UserItemDataDto getItemUserData(@org.eclipse.jdt.annotation.NonNull UUID itemId,
        ...
        ApiResponse<UserItemDataDto> localVarResponse = getItemUserDataWithHttpInfo(itemId, userId, headers);
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<UserItemDataDto> getItemUserDataWithHttpInfo(@org.eclipse.jdt.annotation.NonNull UUID itemId,
            @org.eclipse.jdt.annotation.Nullable UUID userId) throws ApiException {
        return getItemUserDataWithHttpInfo(itemId, userId, null);
    }
    ...
    public ApiResponse<UserItemDataDto> getItemUserDataWithHttpInfo(@org.eclipse.jdt.annotation.NonNull UUID itemId,
            @org.eclipse.jdt.annotation.Nullable UUID userId, Map<String, String> headers) throws ApiException {
        HttpRequest.Builder localVarRequestBuilder = getItemUserDataRequestBuilder(itemId, userId, headers);
        try {
    ...
    private HttpRequest.Builder getItemUserDataRequestBuilder(@org.eclipse.jdt.annotation.NonNull UUID itemId,
            @org.eclipse.jdt.annotation.Nullable UUID userId, Map<String, String> headers) throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public BaseItemDtoQueryResult getItems(@org.eclipse.jdt.annotation.Nullable UUID userId,
            ...
            @org.eclipse.jdt.annotation.Nullable Integer indexNumber,
        ...
        return getItems(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature,
                hasTrailer, adjacentTo, indexNumber, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes,
    ...
    public BaseItemDtoQueryResult getItems(@org.eclipse.jdt.annotation.Nullable UUID userId,
        ...
        ApiResponse<BaseItemDtoQueryResult> localVarResponse = getItemsWithHttpInfo(userId, maxOfficialRating,
                ...
                enableTotalRecordCount, enableImages, headers);
        return localVarResponse.getData();
    }
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<BaseItemDtoQueryResult> getItemsWithHttpInfo(@org.eclipse.jdt.annotation.Nullable UUID userId,
            @org.eclipse.jdt.annotation.Nullable String maxOfficialRating,
            @org.eclipse.jdt.annotation.Nullable Boolean hasThemeSong,
            @org.eclipse.jdt.annotation.Nullable Boolean hasThemeVideo,
            @org.eclipse.jdt.annotation.Nullable Boolean hasSubtitles,
    ...
    private HttpRequest.Builder getItemsRequestBuilder(@org.eclipse.jdt.annotation.Nullable UUID userId,
            @org.eclipse.jdt.annotation.Nullable String maxOfficialRating,
            @org.eclipse.jdt.annotation.Nullable Boolean hasThemeSong,
            @org.eclipse.jdt.annotation.Nullable Boolean hasThemeVideo,
            @org.eclipse.jdt.annotation.Nullable Boolean hasSubtitles,
    ...
    public BaseItemDtoQueryResult getResumeItems(@org.eclipse.jdt.annotation.Nullable UUID userId,
            ...
            @org.eclipse.jdt.annotation.Nullable Boolean excludeActiveSessions) throws ApiException {
    ...
    public BaseItemDtoQueryResult getResumeItems(@org.eclipse.jdt.annotation.Nullable UUID userId,
            ...
            @org.eclipse.jdt.annotation.Nullable Boolean enableTotalRecordCount,
            @org.eclipse.jdt.annotation.Nullable Boolean enableImages,
            @org.eclipse.jdt.annotation.Nullable Boolean excludeActiveSessions, Map<String, String> headers)
            throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public UserItemDataDto updateItemUserData(@org.eclipse.jdt.annotation.NonNull UUID itemId,
            @org.eclipse.jdt.annotation.NonNull UpdateUserItemDataDto updateUserItemDataDto,
            @org.eclipse.jdt.annotation.Nullable UUID userId) throws ApiException {
        return updateItemUserData(itemId, updateUserItemDataDto, userId, null);
    }
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<UserItemDataDto> updateItemUserDataWithHttpInfo(@org.eclipse.jdt.annotation.NonNull UUID itemId,
            @org.eclipse.jdt.annotation.NonNull UpdateUserItemDataDto updateUserItemDataDto,
            @org.eclipse.jdt.annotation.Nullable UUID userId) throws ApiException {
        return updateItemUserDataWithHttpInfo(itemId, updateUserItemDataDto, userId, null);
    }
    ...
    private HttpRequest.Builder updateItemUserDataRequestBuilder(@org.eclipse.jdt.annotation.NonNull UUID itemId,
            @org.eclipse.jdt.annotation.NonNull UpdateUserItemDataDto updateUserItemDataDto,
            @org.eclipse.jdt.annotation.Nullable UUID userId, Map<String, String> headers) throws ApiException {
        // verify the required parameter 'itemId' is set
        if (itemId == null) {
