...
public class UserApi {
  ...
  private HttpRequest.Builder authenticateUserRequestBuilder(UUID userId, String pw, String password) throws ApiException {
  ...
  private HttpRequest.Builder updateUserConfigurationRequestBuilder(UUID userId, UserConfiguration userConfiguration) throws ApiException {
    // verify the required parameter 'userId' is set
    if (userId == null) {
  ...
  public ApiResponse<Void> updateUserEasyPasswordWithHttpInfo(UUID userId, UpdateUserEasyPassword updateUserEasyPassword) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = updateUserEasyPasswordRequestBuilder(userId, updateUserEasyPassword);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder updateUserEasyPasswordRequestBuilder(UUID userId, UpdateUserEasyPassword updateUserEasyPassword) throws ApiException {
    // verify the required parameter 'userId' is set
    if (userId == null) {
    ...
    if (updateUserEasyPassword == null) {
      throw new ApiException(400, "Missing the required parameter 'updateUserEasyPassword' when calling updateUserEasyPassword");
    }
  ...
  private HttpRequest.Builder updateUserPasswordRequestBuilder(UUID userId, UpdateUserPassword updateUserPassword) throws ApiException {
    // verify the required parameter 'userId' is set
    if (userId == null) {
