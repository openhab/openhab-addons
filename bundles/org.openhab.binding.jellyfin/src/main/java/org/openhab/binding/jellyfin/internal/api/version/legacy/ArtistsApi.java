...
public class ArtistsApi {
    ...
    private ResponseSpec getAlbumArtistsRequestCreation(Double minCommunityRating, Integer startIndex, Integer limit,
            ...
            List<String> genres, List<UUID> genreIds, List<String> officialRatings, List<String> tags,
            List<Integer> years, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes,
            String person, List<UUID> personIds, List<String> personTypes, List<String> studios, List<UUID> studioIds,
            UUID userId, String nameStartsWithOrGreater, String nameStartsWith, String nameLessThan,
            List<String> sortBy, List<SortOrder> sortOrder, Boolean enableImages, Boolean enableTotalRecordCount)
    ...
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getAlbumArtistsWithHttpInfo(Double minCommunityRating,
            ...
            Boolean isFavorite, List<String> mediaTypes, List<String> genres, List<UUID> genreIds,
