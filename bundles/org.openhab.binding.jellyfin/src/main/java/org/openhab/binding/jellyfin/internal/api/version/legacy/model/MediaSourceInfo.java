...
@JsonPropertyOrder({ MediaSourceInfo.JSON_PROPERTY_PROTOCOL, MediaSourceInfo.JSON_PROPERTY_ID,
        ...
        MediaSourceInfo.JSON_PROPERTY_IS_INFINITE_STREAM, MediaSourceInfo.JSON_PROPERTY_REQUIRES_OPENING,
        MediaSourceInfo.JSON_PROPERTY_OPEN_TOKEN, MediaSourceInfo.JSON_PROPERTY_REQUIRES_CLOSING,
        MediaSourceInfo.JSON_PROPERTY_LIVE_STREAM_ID, MediaSourceInfo.JSON_PROPERTY_BUFFER_MS,
        MediaSourceInfo.JSON_PROPERTY_REQUIRES_LOOPING, MediaSourceInfo.JSON_PROPERTY_SUPPORTS_PROBING,
        MediaSourceInfo.JSON_PROPERTY_VIDEO_TYPE, MediaSourceInfo.JSON_PROPERTY_ISO_TYPE,
        MediaSourceInfo.JSON_PROPERTY_VIDEO3_D_FORMAT, MediaSourceInfo.JSON_PROPERTY_MEDIA_STREAMS,
        MediaSourceInfo.JSON_PROPERTY_MEDIA_ATTACHMENTS, MediaSourceInfo.JSON_PROPERTY_FORMATS,
        MediaSourceInfo.JSON_PROPERTY_BITRATE, MediaSourceInfo.JSON_PROPERTY_TIMESTAMP,
...
public class MediaSourceInfo {
    ...
    public MediaSourceInfo.Builder toBuilder() {
        return new MediaSourceInfo.Builder().protocol(getProtocol()).id(getId()).path(getPath())
                ...
                .timestamp(getTimestamp()).requiredHttpHeaders(getRequiredHttpHeaders())
                .transcodingUrl(getTranscodingUrl()).transcodingSubProtocol(getTranscodingSubProtocol())
                .transcodingContainer(getTranscodingContainer()).analyzeDurationMs(getAnalyzeDurationMs())
