...
public class OpenLiveStreamDto {
  ...
  public static class Builder {
    ...
    public OpenLiveStreamDto.Builder alwaysBurnInSubtitleWhenTranscoding(Boolean alwaysBurnInSubtitleWhenTranscoding) {
      this.instance.alwaysBurnInSubtitleWhenTranscoding = JsonNullable.<Boolean>of(alwaysBurnInSubtitleWhenTranscoding);
      return this;
    }
    public OpenLiveStreamDto.Builder alwaysBurnInSubtitleWhenTranscoding(JsonNullable<Boolean> alwaysBurnInSubtitleWhenTranscoding) {
