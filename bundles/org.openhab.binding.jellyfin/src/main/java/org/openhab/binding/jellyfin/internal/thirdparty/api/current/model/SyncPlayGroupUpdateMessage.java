...
public class SyncPlayGroupUpdateMessage {
    ...
    public SyncPlayGroupUpdateMessage data(@org.eclipse.jdt.annotation.Nullable GroupUpdate data) {
        this.data = data;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(@org.eclipse.jdt.annotation.Nullable GroupUpdate data) {
        this.data = data;
    }

    public SyncPlayGroupUpdateMessage messageId(@org.eclipse.jdt.annotation.Nullable UUID messageId) {
