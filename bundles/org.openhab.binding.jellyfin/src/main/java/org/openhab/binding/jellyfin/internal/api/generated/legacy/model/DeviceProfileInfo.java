...
public class DeviceProfileInfo {
    ...
    public DeviceProfileInfo id(@org.eclipse.jdt.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public DeviceProfileInfo name(@org.eclipse.jdt.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public DeviceProfileInfo type(@org.eclipse.jdt.annotation.Nullable DeviceProfileType type) {
        this.type = type;
        return this;
    }
    ...
    @JsonProperty(JSON_PROPERTY_TYPE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setType(@org.eclipse.jdt.annotation.Nullable DeviceProfileType type) {
        this.type = type;
    }
