...
public class ArtistInfoRemoteSearchQuery {
    ...
    public ArtistInfoRemoteSearchQuery searchInfo(@org.eclipse.jdt.annotation.NonNull ArtistInfo searchInfo) {
    ...
    @JsonProperty(JSON_PROPERTY_SEARCH_INFO)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSearchInfo(@org.eclipse.jdt.annotation.NonNull ArtistInfo searchInfo) {
        this.searchInfo = searchInfo;
    }

    public ArtistInfoRemoteSearchQuery itemId(@org.eclipse.jdt.annotation.NonNull UUID itemId) {
        this.itemId = itemId;
        return this;
    }
