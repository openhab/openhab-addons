...
public class BaseItemPerson {
    ...
    public boolean equals(Object o) {
        ...
        return equalsNullable(this.name, baseItemPerson.name) && Objects.equals(this.id, baseItemPerson.id)
                && equalsNullable(this.role, baseItemPerson.role) && equalsNullable(this.type, baseItemPerson.type)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(hashCodeNullable(name), id, hashCodeNullable(role), hashCodeNullable(type),
                hashCodeNullable(primaryImageTag), hashCodeNullable(imageBlurHashes));
    }
    ...
    public static class Builder {
        ...
        public BaseItemPerson.Builder type(JsonNullable<String> type) {
