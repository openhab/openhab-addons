...
public class BaseItemDtoImageBlurHashes {
    ...
    public BaseItemDtoImageBlurHashes primary(@org.eclipse.jdt.annotation.Nullable Map<String, String> primary) {
    ...
    public BaseItemDtoImageBlurHashes art(@org.eclipse.jdt.annotation.Nullable Map<String, String> art) {
        this.art = art;
        return this;
    }
    ...
    public BaseItemDtoImageBlurHashes backdrop(@org.eclipse.jdt.annotation.Nullable Map<String, String> backdrop) {
    ...
    public BaseItemDtoImageBlurHashes banner(@org.eclipse.jdt.annotation.Nullable Map<String, String> banner) {
        this.banner = banner;
        return this;
    }
    ...
    public BaseItemDtoImageBlurHashes logo(@org.eclipse.jdt.annotation.Nullable Map<String, String> logo) {
        this.logo = logo;
        return this;
    }
    ...
    public BaseItemDtoImageBlurHashes thumb(@org.eclipse.jdt.annotation.Nullable Map<String, String> thumb) {
        this.thumb = thumb;
        return this;
    }
    ...
    public BaseItemDtoImageBlurHashes disc(@org.eclipse.jdt.annotation.Nullable Map<String, String> disc) {
        this.disc = disc;
        return this;
    }
    ...
    public BaseItemDtoImageBlurHashes box(@org.eclipse.jdt.annotation.Nullable Map<String, String> box) {
        this.box = box;
        return this;
    }
    ...
    public BaseItemDtoImageBlurHashes screenshot(@org.eclipse.jdt.annotation.Nullable Map<String, String> screenshot) {
    ...
    public BaseItemDtoImageBlurHashes menu(@org.eclipse.jdt.annotation.Nullable Map<String, String> menu) {
        this.menu = menu;
        return this;
    }
    ...
    public BaseItemDtoImageBlurHashes chapter(@org.eclipse.jdt.annotation.Nullable Map<String, String> chapter) {
    ...
    public BaseItemDtoImageBlurHashes boxRear(@org.eclipse.jdt.annotation.Nullable Map<String, String> boxRear) {
    ...
    public BaseItemDtoImageBlurHashes profile(@org.eclipse.jdt.annotation.Nullable Map<String, String> profile) {
