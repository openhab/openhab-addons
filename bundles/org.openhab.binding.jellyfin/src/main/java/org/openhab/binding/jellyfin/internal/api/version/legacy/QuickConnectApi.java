...
public class QuickConnectApi {
    ...
    private ResponseSpec authorizeRequestCreation(String code) throws WebClientResponseException {
        ...
        if (code == null) {
            throw new WebClientResponseException("Missing the required parameter 'code' when calling authorize",
    ...
    private ResponseSpec connectRequestCreation(String secret) throws WebClientResponseException {
        ...
        if (secret == null) {
            throw new WebClientResponseException("Missing the required parameter 'secret' when calling connect",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<QuickConnectResult>> connectWithHttpInfo(String secret)
    ...
    private ResponseSpec initiateRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/QuickConnect/Initiate", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
