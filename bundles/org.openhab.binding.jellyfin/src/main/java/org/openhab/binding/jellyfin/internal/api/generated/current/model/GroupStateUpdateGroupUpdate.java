...
public class GroupStateUpdateGroupUpdate {
    ...
    public GroupStateUpdateGroupUpdate type(@org.eclipse.jdt.annotation.Nullable GroupUpdateType type) {
        this.type = type;
        return this;
    }
    ...
    public GroupStateUpdateGroupUpdate data(@org.eclipse.jdt.annotation.Nullable GroupStateUpdate data) {
        this.data = data;
        return this;
    }
    ...
    @JsonProperty(JSON_PROPERTY_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(@org.eclipse.jdt.annotation.Nullable GroupStateUpdate data) {
        this.data = data;
    }
