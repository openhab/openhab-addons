...
public class LibraryOptions {
    ...
    public LibraryOptions enabled(@org.eclipse.jdt.annotation.NonNull Boolean enabled) {
    ...
    public LibraryOptions enablePhotos(@org.eclipse.jdt.annotation.NonNull Boolean enablePhotos) {
    ...
    public LibraryOptions enableRealtimeMonitor(@org.eclipse.jdt.annotation.NonNull Boolean enableRealtimeMonitor) {
    ...
    public LibraryOptions enableLUFSScan(@org.eclipse.jdt.annotation.NonNull Boolean enableLUFSScan) {
    ...
    public LibraryOptions pathInfos(@org.eclipse.jdt.annotation.NonNull List<MediaPathInfo> pathInfos) {
    ...
    public LibraryOptions saveLocalMetadata(@org.eclipse.jdt.annotation.NonNull Boolean saveLocalMetadata) {
    ...
    public LibraryOptions enableInternetProviders(@org.eclipse.jdt.annotation.NonNull Boolean enableInternetProviders) {
    ...
    public LibraryOptions enableEmbeddedTitles(@org.eclipse.jdt.annotation.NonNull Boolean enableEmbeddedTitles) {
    ...
    public LibraryOptions enableEmbeddedExtrasTitles(
            @org.eclipse.jdt.annotation.NonNull Boolean enableEmbeddedExtrasTitles) {
    ...
    public LibraryOptions enableEmbeddedEpisodeInfos(
            @org.eclipse.jdt.annotation.NonNull Boolean enableEmbeddedEpisodeInfos) {
    ...
    public LibraryOptions metadataCountryCode(@org.eclipse.jdt.annotation.NonNull String metadataCountryCode) {
    ...
    public LibraryOptions seasonZeroDisplayName(@org.eclipse.jdt.annotation.NonNull String seasonZeroDisplayName) {
    ...
    public LibraryOptions metadataSavers(@org.eclipse.jdt.annotation.NonNull List<String> metadataSavers) {
    ...
    public LibraryOptions disabledSubtitleFetchers(
            @org.eclipse.jdt.annotation.NonNull List<String> disabledSubtitleFetchers) {
    ...
    public LibraryOptions subtitleFetcherOrder(@org.eclipse.jdt.annotation.NonNull List<String> subtitleFetcherOrder) {
    ...
    public LibraryOptions saveSubtitlesWithMedia(@org.eclipse.jdt.annotation.NonNull Boolean saveSubtitlesWithMedia) {
    ...
    public LibraryOptions saveLyricsWithMedia(@org.eclipse.jdt.annotation.NonNull Boolean saveLyricsWithMedia) {
    ...
    public LibraryOptions saveTrickplayWithMedia(@org.eclipse.jdt.annotation.NonNull Boolean saveTrickplayWithMedia) {
    ...
    public LibraryOptions disabledLyricFetchers(
            @org.eclipse.jdt.annotation.NonNull List<String> disabledLyricFetchers) {
    ...
    public LibraryOptions lyricFetcherOrder(@org.eclipse.jdt.annotation.NonNull List<String> lyricFetcherOrder) {
    ...
    public LibraryOptions useCustomTagDelimiters(@org.eclipse.jdt.annotation.NonNull Boolean useCustomTagDelimiters) {
    ...
    public LibraryOptions customTagDelimiters(@org.eclipse.jdt.annotation.NonNull List<String> customTagDelimiters) {
    ...
    public LibraryOptions delimiterWhitelist(@org.eclipse.jdt.annotation.NonNull List<String> delimiterWhitelist) {
    ...
    public LibraryOptions typeOptions(@org.eclipse.jdt.annotation.NonNull List<TypeOptions> typeOptions) {
