...
public class Example {
  public static void main(String[] args) {
    ...
    UUID userId = UUID.randomUUID(); // UUID | The user id supplied as query parameter.
    ...
    List<BaseItemKind> includeItemTypes = Arrays.asList(); // List<BaseItemKind> | Optional. If specified, results will be filtered based on the item type. This allows multiple, comma delimited.
...
|------------- | ------------- | ------------- | -------------|
| **userId** | **UUID**| The user id supplied as query parameter. | [optional] |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ItemsApi#getItemsByUserId");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **userId** | **UUID**| The user id supplied as query parameter. | |
| **maxOfficialRating** | **String**| Optional filter by maximum official rating (PG, PG-13, TV-MA, etc). | [optional] |
| **hasThemeSong** | **Boolean**| Optional filter by items with theme songs. | [optional] |
| **hasThemeVideo** | **Boolean**| Optional filter by items with theme videos. | [optional] |
| **hasSubtitles** | **Boolean**| Optional filter by items with subtitles. | [optional] |
