...
public class LibraryUpdateInfo {
  ...
  */
  public LibraryUpdateInfo.Builder toBuilder() {
    return new LibraryUpdateInfo.Builder()
      .foldersAddedTo(getFoldersAddedTo())
      .foldersRemovedFrom(getFoldersRemovedFrom())
      .itemsAdded(getItemsAdded())
      .itemsRemoved(getItemsRemoved())
      .itemsUpdated(getItemsUpdated())
      .collectionFolders(getCollectionFolders())
      .isEmpty(getIsEmpty());
  }
