...
public class MediaSourceInfo {
    ...
    public MediaSourceInfo transcodingSubProtocol(@org.eclipse.jdt.annotation.Nullable String transcodingSubProtocol) {
    ...
    @JsonProperty(JSON_PROPERTY_TRANSCODING_SUB_PROTOCOL)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTranscodingSubProtocol(@org.eclipse.jdt.annotation.Nullable String transcodingSubProtocol) {
        this.transcodingSubProtocol = transcodingSubProtocol;
    }
