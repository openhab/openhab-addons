...
public class TvShowsApi {
  ...
  private HttpRequest.Builder getEpisodesRequestBuilder(UUID seriesId, UUID userId, List<ItemFields> fields, Integer season, UUID seasonId, Boolean isMissing, String adjacentTo, UUID startItemId, Integer startIndex, Integer limit, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, String sortBy) throws ApiException {
  ...
  public BaseItemDtoQueryResult getNextUp(UUID userId, Integer startIndex, Integer limit, List<ItemFields> fields, String seriesId, UUID parentId, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, OffsetDateTime nextUpDateCutoff, Boolean enableTotalRecordCount, Boolean disableFirstEpisode, Boolean enableRewatching) throws ApiException {
    ApiResponse<BaseItemDtoQueryResult> localVarResponse = getNextUpWithHttpInfo(userId, startIndex, limit, fields, seriesId, parentId, enableImages, imageTypeLimit, enableImageTypes, enableUserData, nextUpDateCutoff, enableTotalRecordCount, disableFirstEpisode, enableRewatching);
    return localVarResponse.getData();
  }
  ...
  public ApiResponse<BaseItemDtoQueryResult> getNextUpWithHttpInfo(UUID userId, Integer startIndex, Integer limit, List<ItemFields> fields, String seriesId, UUID parentId, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, OffsetDateTime nextUpDateCutoff, Boolean enableTotalRecordCount, Boolean disableFirstEpisode, Boolean enableRewatching) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getNextUpRequestBuilder(userId, startIndex, limit, fields, seriesId, parentId, enableImages, imageTypeLimit, enableImageTypes, enableUserData, nextUpDateCutoff, enableTotalRecordCount, disableFirstEpisode, enableRewatching);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getNextUpRequestBuilder(UUID userId, Integer startIndex, Integer limit, List<ItemFields> fields, String seriesId, UUID parentId, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData, OffsetDateTime nextUpDateCutoff, Boolean enableTotalRecordCount, Boolean disableFirstEpisode, Boolean enableRewatching) throws ApiException {
  ...
  private HttpRequest.Builder getSeasonsRequestBuilder(UUID seriesId, UUID userId, List<ItemFields> fields, Boolean isSpecialSeason, Boolean isMissing, String adjacentTo, Boolean enableImages, Integer imageTypeLimit, List<ImageType> enableImageTypes, Boolean enableUserData) throws ApiException {
    // verify the required parameter 'seriesId' is set
    if (seriesId == null) {
