...
public class PluginUninstalledMessage {
    ...
    public PluginUninstalledMessage data(@org.eclipse.jdt.annotation.NonNull PluginInfo data) {
        this.data = data;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(@org.eclipse.jdt.annotation.NonNull PluginInfo data) {
        this.data = data;
    }

    public PluginUninstalledMessage messageId(@org.eclipse.jdt.annotation.NonNull UUID messageId) {
