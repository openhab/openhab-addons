...
public class SubtitleApi {
    ...
    private ResponseSpec getRemoteSubtitlesRequestCreation(String subtitleId) throws WebClientResponseException {
        ...
        if (subtitleId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'subtitleId' when calling getRemoteSubtitles",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Providers/Subtitles/Subtitles/{subtitleId}", HttpMethod.GET, pathParams,
                queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<File>> getRemoteSubtitlesWithHttpInfo(String subtitleId)
            throws WebClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<File>() {
        };
