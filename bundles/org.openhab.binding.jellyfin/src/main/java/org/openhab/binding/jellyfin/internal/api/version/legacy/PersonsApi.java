...
public class PersonsApi {
     ...
     * Get person by name.
     * 
     * <p><b>200</b> - Person returned.
     * <p><b>404</b> - Person not found.
    ...
    private ResponseSpec getPersonRequestCreation(String name, UUID userId) throws WebClientResponseException {
        ...
        if (name == null) {
            throw new WebClientResponseException("Missing the required parameter 'name' when calling getPerson", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/Persons/{name}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDto>> getPersonWithHttpInfo(String name, UUID userId) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDto> localVarReturnType = new ParameterizedTypeReference<BaseItemDto>() {};
    ...
    private ResponseSpec getPersonsRequestCreation(Integer limit, String searchTerm, List<ItemFields> fields, List<ItemFilter> filters, Boolean isFavorite, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, List<String> excludePersonTypes, List<String> personTypes, UUID appearsInItemId, UUID userId, Boolean enableImages) throws WebClientResponseException {
        ...
        queryParams.putAll(apiClient.parameterToMultiValueMap(ApiClient.CollectionFormat.valueOf("multi".toUpperCase(Locale.ROOT)), "excludePersonTypes", excludePersonTypes));
        ...
        return apiClient.invokeAPI("/Persons", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getPersons(Integer limit, String searchTerm, List<ItemFields> fields, List<ItemFilter> filters, Boolean isFavorite, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, List<String> excludePersonTypes, List<String> personTypes, UUID appearsInItemId, UUID userId, Boolean enableImages) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {};
        return getPersonsRequestCreation(limit, searchTerm, fields, filters, isFavorite, enableUserData, imageTypeLimit, enableImageTypes, excludePersonTypes, personTypes, appearsInItemId, userId, enableImages).bodyToMono(localVarReturnType);
    }
    ...
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getPersonsWithHttpInfo(Integer limit, String searchTerm, List<ItemFields> fields, List<ItemFilter> filters, Boolean isFavorite, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, List<String> excludePersonTypes, List<String> personTypes, UUID appearsInItemId, UUID userId, Boolean enableImages) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {};
        return getPersonsRequestCreation(limit, searchTerm, fields, filters, isFavorite, enableUserData, imageTypeLimit, enableImageTypes, excludePersonTypes, personTypes, appearsInItemId, userId, enableImages).toEntity(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getPersonsWithResponseSpec(Integer limit, String searchTerm, List<ItemFields> fields, List<ItemFilter> filters, Boolean isFavorite, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, List<String> excludePersonTypes, List<String> personTypes, UUID appearsInItemId, UUID userId, Boolean enableImages) throws WebClientResponseException {
        return getPersonsRequestCreation(limit, searchTerm, fields, filters, isFavorite, enableUserData, imageTypeLimit, enableImageTypes, excludePersonTypes, personTypes, appearsInItemId, userId, enableImages);
    }
}
