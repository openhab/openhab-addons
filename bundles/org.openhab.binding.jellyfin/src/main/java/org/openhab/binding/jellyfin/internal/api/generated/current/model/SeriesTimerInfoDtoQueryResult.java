...
public class SeriesTimerInfoDtoQueryResult {
    ...
    public SeriesTimerInfoDtoQueryResult items(@org.eclipse.jdt.annotation.NonNull List<SeriesTimerInfoDto> items) {
        this.items = items;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_ITEMS, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setItems(@org.eclipse.jdt.annotation.NonNull List<SeriesTimerInfoDto> items) {
        this.items = items;
    }
    ...
    public SeriesTimerInfoDtoQueryResult startIndex(@org.eclipse.jdt.annotation.NonNull Integer startIndex) {
