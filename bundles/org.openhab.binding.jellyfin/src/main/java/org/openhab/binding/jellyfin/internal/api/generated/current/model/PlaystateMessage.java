...
public class PlaystateMessage {
    ...
    public PlaystateMessage data(@org.eclipse.jdt.annotation.NonNull PlaystateRequest data) {
        this.data = data;
        return this;
    }
    ...
    public PlaystateMessage messageId(@org.eclipse.jdt.annotation.NonNull UUID messageId) {
