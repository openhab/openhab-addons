...
public class DevicesApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<DeviceOptionsDto>> getDeviceOptionsWithHttpInfo(String id)
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<DeviceInfoDtoQueryResult>> getDevicesWithHttpInfo(UUID userId)
            throws WebClientResponseException {
        ParameterizedTypeReference<DeviceInfoDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<DeviceInfoDtoQueryResult>() {
        };
