...
public class StartupApi {
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<Void> setRemoteAccessWithHttpInfo(StartupRemoteAccessDto startupRemoteAccessDto)
            throws ApiException {
    ...
    private HttpRequest.Builder setRemoteAccessRequestBuilder(StartupRemoteAccessDto startupRemoteAccessDto)
            throws ApiException {
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<Void> updateInitialConfigurationWithHttpInfo(StartupConfigurationDto startupConfigurationDto)
            throws ApiException {
