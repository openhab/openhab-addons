...
public class GroupInfoDtoGroupUpdate {
    ...
    public GroupInfoDtoGroupUpdate type(@org.eclipse.jdt.annotation.Nullable GroupUpdateType type) {
        this.type = type;
        return this;
    }
    ...
    public GroupInfoDtoGroupUpdate data(@org.eclipse.jdt.annotation.Nullable GroupInfoDto data) {
        this.data = data;
        return this;
    }
    ...
    @JsonProperty(JSON_PROPERTY_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(@org.eclipse.jdt.annotation.Nullable GroupInfoDto data) {
        this.data = data;
    }
