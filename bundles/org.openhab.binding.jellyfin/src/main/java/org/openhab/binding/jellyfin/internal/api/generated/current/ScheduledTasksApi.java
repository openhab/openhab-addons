...
public class ScheduledTasksApi {
    ...
    public ApiResponse<TaskInfo> getTaskWithHttpInfo(@org.eclipse.jdt.annotation.Nullable String taskId)
        ...
        // Path parameters
        String localVarPath = "/ScheduledTasks/{taskId}".replaceAll("\\{taskId}",
        ...
        GenericType<TaskInfo> localVarReturnType = new GenericType<TaskInfo>() {
        };
        return apiClient.invokeAPI("ScheduledTasksApi.getTask", localVarPath, "GET", new ArrayList<>(), null,
     ...
     *                        <tr>
     *                        <td>200</td>
     *                        <td>Scheduled tasks retrieved.</td>
     *                        <td>-</td>
     *                        </tr>
     *                        <tr>
     *                        <td>401</td>
    ...
    public List<TaskInfo> getTasks(@org.eclipse.jdt.annotation.NonNull Boolean isHidden,
        ...
        return getTasksWithHttpInfo(isHidden, isEnabled).getData();
    }
    ...
    public ApiResponse<List<TaskInfo>> getTasksWithHttpInfo(@org.eclipse.jdt.annotation.NonNull Boolean isHidden,
        ...
        String localVarContentType = apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] { "CustomAuthentication" };
        GenericType<List<TaskInfo>> localVarReturnType = new GenericType<List<TaskInfo>>() {
        };
        return apiClient.invokeAPI("ScheduledTasksApi.getTasks", "/ScheduledTasks", "GET", localVarQueryParams, null,
                new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept,
                localVarContentType, localVarAuthNames, localVarReturnType, false);
    }
    ...
    public ApiResponse<Void> startTaskWithHttpInfo(@org.eclipse.jdt.annotation.Nullable String taskId)
        ...
        // Path parameters
        String localVarPath = "/ScheduledTasks/Running/{taskId}".replaceAll("\\{taskId}",
                apiClient.escapeString(taskId.toString()));
        ...
        String localVarContentType = apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] { "CustomAuthentication" };
        return apiClient.invokeAPI("ScheduledTasksApi.startTask", localVarPath, "POST", new ArrayList<>(), null,
                new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept,
    ...
    public ApiResponse<Void> stopTaskWithHttpInfo(@org.eclipse.jdt.annotation.Nullable String taskId)
        ...
        String localVarContentType = apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] { "CustomAuthentication" };
        return apiClient.invokeAPI("ScheduledTasksApi.stopTask", localVarPath, "DELETE", new ArrayList<>(), null,
                new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept,
                localVarContentType, localVarAuthNames, null, false);
    }
    ...
    public ApiResponse<Void> updateTaskWithHttpInfo(@org.eclipse.jdt.annotation.Nullable String taskId,
        ...
        // Path parameters
        String localVarPath = "/ScheduledTasks/{taskId}/Triggers".replaceAll("\\{taskId}",
                apiClient.escapeString(taskId.toString()));
        ...
        String localVarContentType = apiClient.selectHeaderContentType("application/json", "text/json",
                "application/*+json");
        String[] localVarAuthNames = new String[] { "CustomAuthentication" };
        return apiClient.invokeAPI("ScheduledTasksApi.updateTask", localVarPath, "POST", new ArrayList<>(),
                taskTriggerInfo, new LinkedHashMap<>(), new LinkedHashMap<>(), new LinkedHashMap<>(), localVarAccept,
                localVarContentType, localVarAuthNames, null, false);
    }
}
