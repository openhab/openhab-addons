...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.ConfigurationPageInfo;
...
public class DashboardApi {
     ...
     * 
     * <p>
     * <b>200</b> - ConfigurationPages returned.
     * <p>
     * <b>404</b> - Server still loading.
     * <p>
     ...
     */
    private ResponseSpec getConfigurationPagesRequestCreation(Boolean enableInMainMenu)
        ...
        return apiClient.invokeAPI("/web/ConfigurationPages", HttpMethod.GET, pathParams, queryParams, postBody,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Flux<ConfigurationPageInfo> getConfigurationPages(Boolean enableInMainMenu)
            throws WebClientResponseException {
        ParameterizedTypeReference<ConfigurationPageInfo> localVarReturnType = new ParameterizedTypeReference<ConfigurationPageInfo>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<List<ConfigurationPageInfo>>> getConfigurationPagesWithHttpInfo(Boolean enableInMainMenu)
            throws WebClientResponseException {
        ParameterizedTypeReference<ConfigurationPageInfo> localVarReturnType = new ParameterizedTypeReference<ConfigurationPageInfo>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getConfigurationPagesWithResponseSpec(Boolean enableInMainMenu)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>200</b> - ConfigurationPage returned.
     * <p>
     * <b>404</b> - Plugin configuration page not found.
     * 
    ...
    private ResponseSpec getDashboardConfigurationPageRequestCreation(String name) throws WebClientResponseException {
        ...
        final String[] localVarAccepts = { "text/html", "application/x-javascript", "application/json",
        ...
        return apiClient.invokeAPI("/web/ConfigurationPage", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<File>> getDashboardConfigurationPageWithHttpInfo(String name)
            throws WebClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<File>() {
        };
