...
public class UserViewsApi {
    ...
    private ResponseSpec getGroupingOptionsRequestCreation(UUID userId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/UserViews/GroupingOptions", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getUserViewsRequestCreation(UUID userId, Boolean includeExternalContent, List<CollectionType> presetViews, Boolean includeHidden) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/UserViews", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getUserViews(UUID userId, Boolean includeExternalContent, List<CollectionType> presetViews, Boolean includeHidden) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getUserViewsWithHttpInfo(UUID userId, Boolean includeExternalContent, List<CollectionType> presetViews, Boolean includeHidden) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getUserViewsWithResponseSpec(UUID userId, Boolean includeExternalContent, List<CollectionType> presetViews, Boolean includeHidden) throws WebClientResponseException {
