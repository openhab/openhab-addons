...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.PluginInfo;
...
public class PluginsApi {
     ...
     * 
     * <p>
     * <b>204</b> - Plugin disabled.
     * <p>
     * <b>404</b> - Plugin not found.
     * <p>
    ...
    private ResponseSpec disablePluginRequestCreation(UUID pluginId, String version) throws WebClientResponseException {
        ...
        if (pluginId == null) {
            throw new WebClientResponseException("Missing the required parameter 'pluginId' when calling disablePlugin",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'version' is set
        if (version == null) {
            throw new WebClientResponseException("Missing the required parameter 'version' when calling disablePlugin",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/Plugins/{pluginId}/{version}/Disable", HttpMethod.POST, pathParams, queryParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> disablePluginWithHttpInfo(UUID pluginId, String version)
    ...
    private ResponseSpec enablePluginRequestCreation(UUID pluginId, String version) throws WebClientResponseException {
        ...
        // verify the required parameter 'pluginId' is set
        if (pluginId == null) {
            throw new WebClientResponseException("Missing the required parameter 'pluginId' when calling enablePlugin",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'version' is set
        if (version == null) {
            throw new WebClientResponseException("Missing the required parameter 'version' when calling enablePlugin",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Plugins/{pluginId}/{version}/Enable", HttpMethod.POST, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> enablePluginWithHttpInfo(UUID pluginId, String version)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * 
     * <p>
     * <b>200</b> - Plugin configuration returned.
     * <p>
     * <b>404</b> - Plugin not found or plugin configuration not found.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
    ...
    private ResponseSpec getPluginConfigurationRequestCreation(UUID pluginId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Plugins/{pluginId}/Configuration", HttpMethod.GET, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Object>> getPluginConfigurationWithHttpInfo(UUID pluginId)
            throws WebClientResponseException {
        ParameterizedTypeReference<Object> localVarReturnType = new ParameterizedTypeReference<Object>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getPluginImageRequestCreation(UUID pluginId, String version)
            throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'pluginId' is set
        if (pluginId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'pluginId' when calling getPluginImage",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'version' is set
        if (version == null) {
            throw new WebClientResponseException("Missing the required parameter 'version' when calling getPluginImage",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Plugins/{pluginId}/{version}/Image", HttpMethod.GET, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<File>> getPluginImageWithHttpInfo(UUID pluginId, String version)
            throws WebClientResponseException {
        ParameterizedTypeReference<File> localVarReturnType = new ParameterizedTypeReference<File>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getPluginImageWithResponseSpec(UUID pluginId, String version)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>204</b> - Plugin manifest returned.
     * <p>
     * <b>404</b> - Plugin not found.
     * <p>
     * <b>401</b> - Unauthorized
    ...
    private ResponseSpec getPluginManifestRequestCreation(UUID pluginId) throws WebClientResponseException {
        ...
        if (pluginId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'pluginId' when calling getPluginManifest",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Plugins/{pluginId}/Manifest", HttpMethod.POST, pathParams, queryParams, postBody,
     ...
     * 
     * <p>
     * <b>200</b> - Installed plugins returned.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
    ...
    private ResponseSpec getPluginsRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Plugins", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
    ...
    private ResponseSpec uninstallPluginRequestCreation(UUID pluginId) throws WebClientResponseException {
        ...
        if (pluginId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'pluginId' when calling uninstallPlugin",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Plugins/{pluginId}", HttpMethod.DELETE, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec uninstallPluginByVersionRequestCreation(UUID pluginId, String version)
            throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'pluginId' is set
        if (pluginId == null) {
        ...
        return apiClient.invokeAPI("/Plugins/{pluginId}/{version}", HttpMethod.DELETE, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> uninstallPluginByVersionWithHttpInfo(UUID pluginId, String version)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec uninstallPluginByVersionWithResponseSpec(UUID pluginId, String version)
            throws WebClientResponseException {
     ...
     * <p>
     * <b>204</b> - Plugin configuration updated.
     * <p>
     * <b>404</b> - Plugin not found or plugin does not have configuration.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
    ...
    private ResponseSpec updatePluginConfigurationRequestCreation(UUID pluginId) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Plugins/{pluginId}/Configuration", HttpMethod.POST, pathParams, queryParams,
                postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType,
                localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> updatePluginConfigurationWithHttpInfo(UUID pluginId)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
