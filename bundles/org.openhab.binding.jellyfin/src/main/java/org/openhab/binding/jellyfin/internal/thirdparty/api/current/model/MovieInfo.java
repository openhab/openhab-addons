...
public class MovieInfo {
    ...
    public MovieInfo name(@org.eclipse.jdt.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public MovieInfo originalTitle(@org.eclipse.jdt.annotation.Nullable String originalTitle) {
    ...
    public MovieInfo path(@org.eclipse.jdt.annotation.Nullable String path) {
        this.path = path;
        return this;
    }
    ...
    public MovieInfo metadataLanguage(@org.eclipse.jdt.annotation.Nullable String metadataLanguage) {
    ...
    public MovieInfo metadataCountryCode(@org.eclipse.jdt.annotation.Nullable String metadataCountryCode) {
    ...
    public MovieInfo providerIds(@org.eclipse.jdt.annotation.Nullable Map<String, String> providerIds) {
    ...
    public MovieInfo year(@org.eclipse.jdt.annotation.Nullable Integer year) {
        this.year = year;
        return this;
    }
    ...
    public MovieInfo indexNumber(@org.eclipse.jdt.annotation.Nullable Integer indexNumber) {
    ...
    public MovieInfo parentIndexNumber(@org.eclipse.jdt.annotation.Nullable Integer parentIndexNumber) {
    ...
    public MovieInfo premiereDate(@org.eclipse.jdt.annotation.Nullable OffsetDateTime premiereDate) {
    ...
    public MovieInfo isAutomated(@org.eclipse.jdt.annotation.Nullable Boolean isAutomated) {
