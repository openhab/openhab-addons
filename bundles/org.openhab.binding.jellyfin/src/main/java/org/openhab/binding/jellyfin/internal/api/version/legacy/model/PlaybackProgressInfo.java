...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.QueueItem;
...
public class PlaybackProgressInfo {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(canSeek, hashCodeNullable(item), itemId, hashCodeNullable(sessionId), hashCodeNullable(mediaSourceId), hashCodeNullable(audioStreamIndex), hashCodeNullable(subtitleStreamIndex), isPaused, isMuted, hashCodeNullable(positionTicks), hashCodeNullable(playbackStartTimeTicks), hashCodeNullable(volumeLevel), hashCodeNullable(brightness), hashCodeNullable(aspectRatio), playMethod, hashCodeNullable(liveStreamId), hashCodeNullable(playSessionId), repeatMode, hashCodeNullable(nowPlayingQueue), hashCodeNullable(playlistItemId));
  }
