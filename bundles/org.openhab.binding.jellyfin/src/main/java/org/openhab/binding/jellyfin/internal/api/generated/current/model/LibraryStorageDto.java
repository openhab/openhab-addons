...
public class LibraryStorageDto {
    ...
    public LibraryStorageDto id(@org.eclipse.jdt.annotation.NonNull UUID id) {
        this.id = id;
        return this;
    }
    ...
    public LibraryStorageDto name(@org.eclipse.jdt.annotation.NonNull String name) {
        this.name = name;
        return this;
    }
    ...
    public LibraryStorageDto folders(@org.eclipse.jdt.annotation.NonNull List<FolderStorageDto> folders) {
    ...
    @JsonProperty(value = JSON_PROPERTY_FOLDERS, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setFolders(@org.eclipse.jdt.annotation.NonNull List<FolderStorageDto> folders) {
        this.folders = folders;
    }
        ...
        if (getFolders() != null) {
            for (int i = 0; i < getFolders().size(); i++) {
                if (getFolders().get(i) != null) {
                    joiner.add(getFolders().get(i).toUrlQueryString(
                            String.format(Locale.ROOT, "%sFolders%s%s", prefix, suffix, "".equals(suffix) ? ""
