...
public class BufferRequestDto {
    ...
    public BufferRequestDto when(@org.eclipse.jdt.annotation.NonNull OffsetDateTime when) {
        this.when = when;
        return this;
    }
    ...
    public BufferRequestDto positionTicks(@org.eclipse.jdt.annotation.NonNull Long positionTicks) {
    ...
    public BufferRequestDto isPlaying(@org.eclipse.jdt.annotation.NonNull Boolean isPlaying) {
    ...
    public BufferRequestDto playlistItemId(@org.eclipse.jdt.annotation.NonNull UUID playlistItemId) {
