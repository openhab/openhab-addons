...
import org.openhab.binding.jellyfin.internal.api.version.current.model.AccessSchedule;
import org.openhab.binding.jellyfin.internal.api.version.current.model.SyncPlayUserAccessType;
import org.openhab.binding.jellyfin.internal.api.version.current.model.UnratedItem;
...
public class UserPolicy {
  ...
  public static class Builder {
    ...
    public UserPolicy.Builder allowedTags(List<String> allowedTags) {
      this.instance.allowedTags = JsonNullable.<List<String>>of(allowedTags);
      return this;
    }
    public UserPolicy.Builder allowedTags(JsonNullable<List<String>> allowedTags) {
