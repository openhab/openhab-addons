...
public class SessionApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Flux<SessionInfoDto> getSessions(UUID controllableByUserId, String deviceId, Integer activeWithinSeconds)
            throws WebClientResponseException {
        ParameterizedTypeReference<SessionInfoDto> localVarReturnType = new ParameterizedTypeReference<SessionInfoDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<List<SessionInfoDto>>> getSessionsWithHttpInfo(UUID controllableByUserId,
            String deviceId, Integer activeWithinSeconds) throws WebClientResponseException {
        ParameterizedTypeReference<SessionInfoDto> localVarReturnType = new ParameterizedTypeReference<SessionInfoDto>() {
        };
        return getSessionsRequestCreation(controllableByUserId, deviceId, activeWithinSeconds)
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec postCapabilitiesRequestCreation(String id, List<MediaType> playableMediaTypes,
            List<GeneralCommandType> supportedCommands, Boolean supportsMediaControl,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> postCapabilities(String id, List<MediaType> playableMediaTypes,
            List<GeneralCommandType> supportedCommands, Boolean supportsMediaControl,
            Boolean supportsPersistentIdentifier) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
        return postCapabilitiesRequestCreation(id, playableMediaTypes, supportedCommands, supportsMediaControl,
                supportsPersistentIdentifier).bodyToMono(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> postCapabilitiesWithHttpInfo(String id, List<MediaType> playableMediaTypes,
            List<GeneralCommandType> supportedCommands, Boolean supportsMediaControl,
            Boolean supportsPersistentIdentifier) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
        return postCapabilitiesRequestCreation(id, playableMediaTypes, supportedCommands, supportsMediaControl,
                supportsPersistentIdentifier).toEntity(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec postCapabilitiesWithResponseSpec(String id, List<MediaType> playableMediaTypes,
            List<GeneralCommandType> supportedCommands, Boolean supportsMediaControl,
            Boolean supportsPersistentIdentifier) throws WebClientResponseException {
        return postCapabilitiesRequestCreation(id, playableMediaTypes, supportedCommands, supportsMediaControl,
