...
public class MovieInfo {
    ...
    public MovieInfo name(@org.eclipse.jdt.annotation.NonNull String name) {
        this.name = name;
        return this;
    }
    ...
    public MovieInfo originalTitle(@org.eclipse.jdt.annotation.NonNull String originalTitle) {
    ...
    public MovieInfo path(@org.eclipse.jdt.annotation.NonNull String path) {
        this.path = path;
        return this;
    }
    ...
    public MovieInfo metadataLanguage(@org.eclipse.jdt.annotation.NonNull String metadataLanguage) {
    ...
    public MovieInfo metadataCountryCode(@org.eclipse.jdt.annotation.NonNull String metadataCountryCode) {
    ...
    public MovieInfo providerIds(@org.eclipse.jdt.annotation.NonNull Map<String, String> providerIds) {
    ...
    public MovieInfo year(@org.eclipse.jdt.annotation.NonNull Integer year) {
        this.year = year;
        return this;
    }
    ...
    public MovieInfo indexNumber(@org.eclipse.jdt.annotation.NonNull Integer indexNumber) {
    ...
    public MovieInfo parentIndexNumber(@org.eclipse.jdt.annotation.NonNull Integer parentIndexNumber) {
    ...
    public MovieInfo premiereDate(@org.eclipse.jdt.annotation.NonNull OffsetDateTime premiereDate) {
    ...
    public MovieInfo isAutomated(@org.eclipse.jdt.annotation.NonNull Boolean isAutomated) {
