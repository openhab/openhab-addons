...
public class YearsApi {
    ...
    private ResponseSpec getYearsRequestCreation(Integer startIndex, Integer limit, List<SortOrder> sortOrder,
            ...
            List<BaseItemKind> includeItemTypes, List<MediaType> mediaTypes, List<ItemSortBy> sortBy,
            Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId,
            Boolean recursive, Boolean enableImages) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
