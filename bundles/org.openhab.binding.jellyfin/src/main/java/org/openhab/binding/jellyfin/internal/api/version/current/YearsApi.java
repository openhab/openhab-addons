...
public class YearsApi {
     ...
     * Gets a year.
     * 
     * <p><b>200</b> - Year returned.
     * <p><b>404</b> - Year not found.
    ...
    private ResponseSpec getYearRequestCreation(Integer year, UUID userId) throws WebClientResponseException {
        ...
        if (year == null) {
            throw new WebClientResponseException("Missing the required parameter 'year' when calling getYear", HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/Years/{year}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDto>> getYearWithHttpInfo(Integer year, UUID userId) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDto> localVarReturnType = new ParameterizedTypeReference<BaseItemDto>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getYearsRequestCreation(Integer startIndex, Integer limit, List<SortOrder> sortOrder, UUID parentId, List<ItemFields> fields, List<BaseItemKind> excludeItemTypes, List<BaseItemKind> includeItemTypes, List<MediaType> mediaTypes, List<ItemSortBy> sortBy, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, Boolean recursive, Boolean enableImages) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Years", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<BaseItemDtoQueryResult> getYears(Integer startIndex, Integer limit, List<SortOrder> sortOrder, UUID parentId, List<ItemFields> fields, List<BaseItemKind> excludeItemTypes, List<BaseItemKind> includeItemTypes, List<MediaType> mediaTypes, List<ItemSortBy> sortBy, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, Boolean recursive, Boolean enableImages) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {};
        return getYearsRequestCreation(startIndex, limit, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, mediaTypes, sortBy, enableUserData, imageTypeLimit, enableImageTypes, userId, recursive, enableImages).bodyToMono(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<BaseItemDtoQueryResult>> getYearsWithHttpInfo(Integer startIndex, Integer limit, List<SortOrder> sortOrder, UUID parentId, List<ItemFields> fields, List<BaseItemKind> excludeItemTypes, List<BaseItemKind> includeItemTypes, List<MediaType> mediaTypes, List<ItemSortBy> sortBy, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, Boolean recursive, Boolean enableImages) throws WebClientResponseException {
        ParameterizedTypeReference<BaseItemDtoQueryResult> localVarReturnType = new ParameterizedTypeReference<BaseItemDtoQueryResult>() {};
        return getYearsRequestCreation(startIndex, limit, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, mediaTypes, sortBy, enableUserData, imageTypeLimit, enableImageTypes, userId, recursive, enableImages).toEntity(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getYearsWithResponseSpec(Integer startIndex, Integer limit, List<SortOrder> sortOrder, UUID parentId, List<ItemFields> fields, List<BaseItemKind> excludeItemTypes, List<BaseItemKind> includeItemTypes, List<MediaType> mediaTypes, List<ItemSortBy> sortBy, Boolean enableUserData, Integer imageTypeLimit, List<ImageType> enableImageTypes, UUID userId, Boolean recursive, Boolean enableImages) throws WebClientResponseException {
        return getYearsRequestCreation(startIndex, limit, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, mediaTypes, sortBy, enableUserData, imageTypeLimit, enableImageTypes, userId, recursive, enableImages);
    }
}
