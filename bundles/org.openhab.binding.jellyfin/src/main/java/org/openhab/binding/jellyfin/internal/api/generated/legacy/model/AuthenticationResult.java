...
public class AuthenticationResult {
    ...
    public AuthenticationResult sessionInfo(@org.eclipse.jdt.annotation.Nullable SessionInfo sessionInfo) {
    ...
    @JsonProperty(JSON_PROPERTY_SESSION_INFO)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSessionInfo(@org.eclipse.jdt.annotation.Nullable SessionInfo sessionInfo) {
        this.sessionInfo = sessionInfo;
    }
