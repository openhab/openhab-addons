...
public class MediaSourceInfo {
    ...
    public int hashCode() {
        return Objects.hash(protocol, hashCodeNullable(id), hashCodeNullable(path), hashCodeNullable(encoderPath),
                ...
                supportsDirectPlay, isInfiniteStream, useMostCompatibleTranscodingProfile, requiresOpening,
                hashCodeNullable(openToken), requiresClosing, hashCodeNullable(liveStreamId),
                hashCodeNullable(bufferMs), requiresLooping, supportsProbing, hashCodeNullable(videoType),
                hashCodeNullable(isoType), hashCodeNullable(video3DFormat), hashCodeNullable(mediaStreams),
                hashCodeNullable(mediaAttachments), hashCodeNullable(formats), hashCodeNullable(bitrate),
                hashCodeNullable(fallbackMaxStreamingBitrate), hashCodeNullable(timestamp),
                hashCodeNullable(requiredHttpHeaders), hashCodeNullable(transcodingUrl), transcodingSubProtocol,
