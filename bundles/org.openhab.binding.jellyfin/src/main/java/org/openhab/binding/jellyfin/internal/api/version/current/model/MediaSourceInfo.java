...
import org.openhab.binding.jellyfin.internal.api.version.current.model.MediaAttachment;
import org.openhab.binding.jellyfin.internal.api.version.current.model.MediaProtocol;
import org.openhab.binding.jellyfin.internal.api.version.current.model.MediaSourceType;
import org.openhab.binding.jellyfin.internal.api.version.current.model.MediaStream;
import org.openhab.binding.jellyfin.internal.api.version.current.model.MediaStreamProtocol;
import org.openhab.binding.jellyfin.internal.api.version.current.model.TransportStreamTimestamp;
...
@JsonPropertyOrder({
  ...
  MediaSourceInfo.JSON_PROPERTY_HAS_SEGMENTS
})
...
public class MediaSourceInfo {
  ...
  @javax.annotation.Nullable
  private JsonNullable<Integer> fallbackMaxStreamingBitrate = JsonNullable.<Integer>undefined();
  ...
  public MediaSourceInfo useMostCompatibleTranscodingProfile(@javax.annotation.Nullable Boolean useMostCompatibleTranscodingProfile) {
  ...
  @JsonProperty(JSON_PROPERTY_USE_MOST_COMPATIBLE_TRANSCODING_PROFILE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUseMostCompatibleTranscodingProfile(@javax.annotation.Nullable Boolean useMostCompatibleTranscodingProfile) {
    this.useMostCompatibleTranscodingProfile = useMostCompatibleTranscodingProfile;
  }
  ...
  public MediaSourceInfo fallbackMaxStreamingBitrate(@javax.annotation.Nullable Integer fallbackMaxStreamingBitrate) {
    this.fallbackMaxStreamingBitrate = JsonNullable.<Integer>of(fallbackMaxStreamingBitrate);
  ...
  public Integer getFallbackMaxStreamingBitrate() {
        return fallbackMaxStreamingBitrate.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_FALLBACK_MAX_STREAMING_BITRATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Integer> getFallbackMaxStreamingBitrate_JsonNullable() {
    return fallbackMaxStreamingBitrate;
  }
  
  @JsonProperty(JSON_PROPERTY_FALLBACK_MAX_STREAMING_BITRATE)
  public void setFallbackMaxStreamingBitrate_JsonNullable(JsonNullable<Integer> fallbackMaxStreamingBitrate) {
  ...
  public MediaSourceInfo transcodingSubProtocol(@javax.annotation.Nullable MediaStreamProtocol transcodingSubProtocol) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.protocol, mediaSourceInfo.protocol) &&
        ...
        Objects.equals(this.useMostCompatibleTranscodingProfile, mediaSourceInfo.useMostCompatibleTranscodingProfile) &&
        ...
        equalsNullable(this.fallbackMaxStreamingBitrate, mediaSourceInfo.fallbackMaxStreamingBitrate) &&
  ...
  public static class Builder {
    ...
    public MediaSourceInfo.Builder useMostCompatibleTranscodingProfile(Boolean useMostCompatibleTranscodingProfile) {
    ...
    public MediaSourceInfo.Builder fallbackMaxStreamingBitrate(Integer fallbackMaxStreamingBitrate) {
      this.instance.fallbackMaxStreamingBitrate = JsonNullable.<Integer>of(fallbackMaxStreamingBitrate);
      return this;
    }
    public MediaSourceInfo.Builder fallbackMaxStreamingBitrate(JsonNullable<Integer> fallbackMaxStreamingBitrate) {
  ...
  */
  public MediaSourceInfo.Builder toBuilder() {
    return new MediaSourceInfo.Builder()
      ...
      .encoderProtocol(getEncoderProtocol())
      .type(getType())
      ...
      .readAtNativeFramerate(getReadAtNativeFramerate())
      .ignoreDts(getIgnoreDts())
      .ignoreIndex(getIgnoreIndex())
      .genPtsInput(getGenPtsInput())
      .supportsTranscoding(getSupportsTranscoding())
      .supportsDirectStream(getSupportsDirectStream())
      .supportsDirectPlay(getSupportsDirectPlay())
      .isInfiniteStream(getIsInfiniteStream())
      .useMostCompatibleTranscodingProfile(getUseMostCompatibleTranscodingProfile())
      .requiresOpening(getRequiresOpening())
      .openToken(getOpenToken())
      .requiresClosing(getRequiresClosing())
      .liveStreamId(getLiveStreamId())
      .bufferMs(getBufferMs())
      .requiresLooping(getRequiresLooping())
      .supportsProbing(getSupportsProbing())
      ...
      .requiredHttpHeaders(getRequiredHttpHeaders())
      .transcodingUrl(getTranscodingUrl())
      .transcodingSubProtocol(getTranscodingSubProtocol())
      .transcodingContainer(getTranscodingContainer())
      .analyzeDurationMs(getAnalyzeDurationMs())
      .defaultAudioStreamIndex(getDefaultAudioStreamIndex())
      .defaultSubtitleStreamIndex(getDefaultSubtitleStreamIndex())
      .hasSegments(getHasSegments());
  }
