...
import org.openhab.binding.jellyfin.internal.api.generated.legacy.model.ItemFilter;
import org.openhab.binding.jellyfin.internal.api.generated.legacy.model.LocationType;
import org.openhab.binding.jellyfin.internal.api.generated.legacy.model.SeriesStatus;
import org.openhab.binding.jellyfin.internal.api.generated.legacy.model.SortOrder;
import org.openhab.binding.jellyfin.internal.api.generated.legacy.model.VideoType;
...
public class ItemsApi {
     ...
     * 
     * @param userId The user id supplied as query parameter. (optional)
    ...
    public BaseItemDtoQueryResult getItems(@org.eclipse.jdt.annotation.NonNull UUID userId,
            ...
            @org.eclipse.jdt.annotation.NonNull Boolean hasTrailer,
            @org.eclipse.jdt.annotation.NonNull String adjacentTo,
            ...
            @org.eclipse.jdt.annotation.NonNull List<String> mediaTypes,
            @org.eclipse.jdt.annotation.NonNull List<ImageType> imageTypes,
            @org.eclipse.jdt.annotation.NonNull List<String> sortBy,
        ...
        return getItems(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature,
                ...
                searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, filters, isFavorite,
                mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, years, enableUserData,
                imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, artists, excludeArtistIds,
                artistIds, albumArtistIds, contributingArtistIds, albums, albumIds, ids, videoTypes, minOfficialRating,
                isLocked, isPlaceHolder, hasOfficialRating, collapseBoxSetItems, minWidth, minHeight, maxWidth,
                maxHeight, is3D, seriesStatus, nameStartsWithOrGreater, nameStartsWith, nameLessThan, studioIds,
                genreIds, enableTotalRecordCount, enableImages, null);
    }
    ...
    public ApiResponse<BaseItemDtoQueryResult> getItemsWithHttpInfo(@org.eclipse.jdt.annotation.NonNull UUID userId,
        ...
        return getItemsWithHttpInfo(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles,
                ...
                studioIds, genreIds, enableTotalRecordCount, enableImages, null);
    }
     ...
     * Gets items based on a query.
     * 
     * @param userId The user id supplied as query parameter. (required)
     * @param maxOfficialRating Optional filter by maximum official rating (PG, PG-13, TV-MA, etc). (optional)
     * @param hasThemeSong Optional filter by items with theme songs. (optional)
     * @param hasThemeVideo Optional filter by items with theme videos. (optional)
     * @param hasSubtitles Optional filter by items with subtitles. (optional)
     ...
     * @throws ApiException if fails to make API call
     */
    public BaseItemDtoQueryResult getItemsByUserId(@org.eclipse.jdt.annotation.Nullable UUID userId,
            @org.eclipse.jdt.annotation.NonNull String maxOfficialRating,
            @org.eclipse.jdt.annotation.NonNull Boolean hasThemeSong,
            @org.eclipse.jdt.annotation.NonNull Boolean hasThemeVideo,
            @org.eclipse.jdt.annotation.NonNull Boolean hasSubtitles,
            ...
            @org.eclipse.jdt.annotation.NonNull Boolean enableTotalRecordCount,
            @org.eclipse.jdt.annotation.NonNull Boolean enableImages) throws ApiException {
        return getItemsByUserId(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature,
                hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K, locationTypes,
                excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating, minPremiereDate,
                minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId,
                hasTvdbId, isMovie, isSeries, isNews, isKids, isSports, excludeItemIds, startIndex, limit, recursive,
    ...
    public BaseItemDtoQueryResult getItemsByUserId(@org.eclipse.jdt.annotation.Nullable UUID userId,
            ...
            @org.eclipse.jdt.annotation.NonNull Boolean enableTotalRecordCount,
            @org.eclipse.jdt.annotation.NonNull Boolean enableImages, Map<String, String> headers) throws ApiException {
        ApiResponse<BaseItemDtoQueryResult> localVarResponse = getItemsByUserIdWithHttpInfo(userId, maxOfficialRating,
                hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber,
                hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired,
                minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser,
                maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, isMovie, isSeries, isNews, isKids,
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<BaseItemDtoQueryResult> getItemsByUserIdWithHttpInfo(
            ...
            @org.eclipse.jdt.annotation.NonNull Boolean enableTotalRecordCount,
            @org.eclipse.jdt.annotation.NonNull Boolean enableImages) throws ApiException {
        return getItemsByUserIdWithHttpInfo(userId, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles,
                hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber, hasParentalRating, isHd, is4K,
                locationTypes, excludeLocationTypes, isMissing, isUnaired, minCommunityRating, minCriticRating,
                minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId,
                hasTmdbId, hasTvdbId, isMovie, isSeries, isNews, isKids, isSports, excludeItemIds, startIndex, limit,
    ...
    public ApiResponse<BaseItemDtoQueryResult> getItemsByUserIdWithHttpInfo(
            ...
            @org.eclipse.jdt.annotation.NonNull Boolean enableTotalRecordCount,
            @org.eclipse.jdt.annotation.NonNull Boolean enableImages, Map<String, String> headers) throws ApiException {
        HttpRequest.Builder localVarRequestBuilder = getItemsByUserIdRequestBuilder(userId, maxOfficialRating,
                hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, adjacentTo, parentIndexNumber,
                hasParentalRating, isHd, is4K, locationTypes, excludeLocationTypes, isMissing, isUnaired,
                minCommunityRating, minCriticRating, minPremiereDate, minDateLastSaved, minDateLastSavedForUser,
                maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, isMovie, isSeries, isNews, isKids,
        ...
        try {
            ...
            try {
                if (localVarResponse.statusCode() / 100 != 2) {
                    throw getApiException("getItemsByUserId", localVarResponse);
                }
                if (localVarResponse.body() == null) {
                    return new ApiResponse<BaseItemDtoQueryResult>(localVarResponse.statusCode(),
                            localVarResponse.headers().map(), null);
    ...
    private HttpRequest.Builder getItemsByUserIdRequestBuilder(@org.eclipse.jdt.annotation.Nullable UUID userId,
            @org.eclipse.jdt.annotation.NonNull String maxOfficialRating,
            @org.eclipse.jdt.annotation.NonNull Boolean hasThemeSong,
            @org.eclipse.jdt.annotation.NonNull Boolean hasThemeVideo,
            @org.eclipse.jdt.annotation.NonNull Boolean hasSubtitles,
        ...
        if (userId == null) {
            throw new ApiException(400, "Missing the required parameter 'userId' when calling getItemsByUserId");
        }

        HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

        String localVarPath = "/Users/{userId}/Items".replace("{userId}", ApiClient.urlEncode(userId.toString()));
     ...
     * @param enableTotalRecordCount Optional. Enable the total record count. (optional, default to true)
     * @param enableImages Optional. Include image information in output. (optional, default to true)
     * @param excludeActiveSessions Optional. Whether to exclude the currently active sessions. (optional, default to
     *            false)
     * @return BaseItemDtoQueryResult
     * @throws ApiException if fails to make API call
     */
    public BaseItemDtoQueryResult getResumeItems(@org.eclipse.jdt.annotation.Nullable UUID userId,
            @org.eclipse.jdt.annotation.NonNull Integer startIndex, @org.eclipse.jdt.annotation.NonNull Integer limit,
        ...
        return getResumeItems(userId, startIndex, limit, searchTerm, parentId, fields, mediaTypes, enableUserData,
                imageTypeLimit, enableImageTypes, excludeItemTypes, includeItemTypes, enableTotalRecordCount,
                enableImages, excludeActiveSessions, null);
    }
    ...
    public BaseItemDtoQueryResult getResumeItems(@org.eclipse.jdt.annotation.Nullable UUID userId,
            ...
            @org.eclipse.jdt.annotation.NonNull Boolean enableTotalRecordCount,
            @org.eclipse.jdt.annotation.NonNull Boolean enableImages,
            @org.eclipse.jdt.annotation.NonNull Boolean excludeActiveSessions, Map<String, String> headers)
            throws ApiException {
    ...
    public ApiResponse<BaseItemDtoQueryResult> getResumeItemsWithHttpInfo(
        ...
        return getResumeItemsWithHttpInfo(userId, startIndex, limit, searchTerm, parentId, fields, mediaTypes,
                ...
                enableTotalRecordCount, enableImages, excludeActiveSessions, null);
    }
    ...
    public ApiResponse<BaseItemDtoQueryResult> getResumeItemsWithHttpInfo(
        ...
        HttpRequest.Builder localVarRequestBuilder = getResumeItemsRequestBuilder(userId, startIndex, limit, searchTerm,
                ...
                includeItemTypes, enableTotalRecordCount, enableImages, excludeActiveSessions, headers);
        try {
            HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(localVarRequestBuilder.build(),
                    HttpResponse.BodyHandlers.ofInputStream());
            if (memberVarResponseInterceptor != null) {
    ...
    private HttpRequest.Builder getResumeItemsRequestBuilder(@org.eclipse.jdt.annotation.Nullable UUID userId,
            @org.eclipse.jdt.annotation.NonNull Integer startIndex, @org.eclipse.jdt.annotation.NonNull Integer limit,
            @org.eclipse.jdt.annotation.NonNull String searchTerm, @org.eclipse.jdt.annotation.NonNull UUID parentId,
            @org.eclipse.jdt.annotation.NonNull List<ItemFields> fields,
            @org.eclipse.jdt.annotation.NonNull List<String> mediaTypes,
        ...
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException(400, "Missing the required parameter 'userId' when calling getResumeItems");
        }

        HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

        String localVarPath = "/Users/{userId}/Items/Resume".replace("{userId}",
