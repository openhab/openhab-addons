...
public class BoxSetInfo {
  ...
  public BoxSetInfo name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public BoxSetInfo originalTitle(@javax.annotation.Nullable String originalTitle) {
  ...
  public BoxSetInfo path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public BoxSetInfo metadataLanguage(@javax.annotation.Nullable String metadataLanguage) {
  ...
  public BoxSetInfo metadataCountryCode(@javax.annotation.Nullable String metadataCountryCode) {
  ...
  public BoxSetInfo providerIds(@javax.annotation.Nullable Map<String, String> providerIds) {
  ...
  public BoxSetInfo year(@javax.annotation.Nullable Integer year) {
    this.year = year;
    return this;
  }
  ...
  public BoxSetInfo indexNumber(@javax.annotation.Nullable Integer indexNumber) {
  ...
  public BoxSetInfo parentIndexNumber(@javax.annotation.Nullable Integer parentIndexNumber) {
  ...
  public BoxSetInfo premiereDate(@javax.annotation.Nullable OffsetDateTime premiereDate) {
  ...
  public BoxSetInfo isAutomated(@javax.annotation.Nullable Boolean isAutomated) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BoxSetInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BoxSetInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BoxSetInfo is not found in the empty JSON string", BoxSetInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BoxSetInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BoxSetInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BoxSetInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BoxSetInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BoxSetInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BoxSetInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<BoxSetInfo>() {
           @Override
           public void write(JsonWriter out, BoxSetInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BoxSetInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BoxSetInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BoxSetInfo
   * @throws IOException if the JSON string is invalid with respect to BoxSetInfo
   */
  public static BoxSetInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BoxSetInfo.class);
  }

  /**
   * Convert an instance of BoxSetInfo to an JSON string
   *
   * @return JSON string
   */
