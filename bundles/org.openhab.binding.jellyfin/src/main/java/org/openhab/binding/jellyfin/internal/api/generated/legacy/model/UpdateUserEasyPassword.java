...
public class UpdateUserEasyPassword {
    ...
    public UpdateUserEasyPassword newPassword(@org.eclipse.jdt.annotation.Nullable String newPassword) {
    ...
    @JsonProperty(JSON_PROPERTY_NEW_PASSWORD)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setNewPassword(@org.eclipse.jdt.annotation.Nullable String newPassword) {
        this.newPassword = newPassword;
    }

    public UpdateUserEasyPassword newPw(@org.eclipse.jdt.annotation.Nullable String newPw) {
        this.newPw = newPw;
        return this;
    }
    ...
    public UpdateUserEasyPassword resetPassword(@org.eclipse.jdt.annotation.Nullable Boolean resetPassword) {
