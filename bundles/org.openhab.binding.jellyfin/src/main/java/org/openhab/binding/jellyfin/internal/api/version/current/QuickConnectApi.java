...
public class QuickConnectApi {
     ...
     * 
     * <p>
     * <b>200</b> - Quick connect result authorized successfully.
     * <p>
     * <b>403</b> - Unknown user id.
     * <p>
     ...
     */
    private ResponseSpec authorizeQuickConnectRequestCreation(String code, UUID userId)
            throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'code' when calling authorizeQuickConnect",
        ...
        return apiClient.invokeAPI("/QuickConnect/Authorize", HttpMethod.POST, pathParams, queryParams, postBody,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Boolean>> authorizeQuickConnectWithHttpInfo(String code, UUID userId)
            throws WebClientResponseException {
        ParameterizedTypeReference<Boolean> localVarReturnType = new ParameterizedTypeReference<Boolean>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec authorizeQuickConnectWithResponseSpec(String code, UUID userId)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>200</b> - Quick connect state returned.
     * 
     * @return Boolean
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getQuickConnectEnabledRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/QuickConnect/Enabled", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * 
     * <p>
     * <b>200</b> - Quick connect result returned.
     * <p>
     * <b>404</b> - Unknown quick connect secret.
     * 
    ...
    private ResponseSpec getQuickConnectStateRequestCreation(String secret) throws WebClientResponseException {
        ...
        if (secret == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'secret' when calling getQuickConnectState",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/QuickConnect/Connect", HttpMethod.GET, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<QuickConnectResult>> getQuickConnectStateWithHttpInfo(String secret)
            throws WebClientResponseException {
        ParameterizedTypeReference<QuickConnectResult> localVarReturnType = new ParameterizedTypeReference<QuickConnectResult>() {
        };
     ...
     * 
     * <p>
     * <b>200</b> - Quick connect request successfully created.
     * <p>
     * <b>401</b> - Quick connect is not active on this server.
     * 
     * @return QuickConnectResult
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec initiateQuickConnectRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/QuickConnect/Initiate", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<QuickConnectResult>> initiateQuickConnectWithHttpInfo()
            throws WebClientResponseException {
        ParameterizedTypeReference<QuickConnectResult> localVarReturnType = new ParameterizedTypeReference<QuickConnectResult>() {
        };
