...
import org.openhab.binding.jellyfin.internal.api.version.current.model.AudioSpatialFormat;
import org.openhab.binding.jellyfin.internal.api.version.current.model.MediaStreamType;
import org.openhab.binding.jellyfin.internal.api.version.current.model.SubtitleDeliveryMethod;
import org.openhab.binding.jellyfin.internal.api.version.current.model.VideoRange;
import org.openhab.binding.jellyfin.internal.api.version.current.model.VideoRangeType;
...
public class MediaStream {
  ...
  public MediaStream(
    ...
    this.referenceFrameRate = referenceFrameRate == null ? JsonNullable.<Float>undefined() : JsonNullable.of(referenceFrameRate);
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(codec), hashCodeNullable(codecTag), hashCodeNullable(language), hashCodeNullable(colorRange), hashCodeNullable(colorSpace), hashCodeNullable(colorTransfer), hashCodeNullable(colorPrimaries), hashCodeNullable(dvVersionMajor), hashCodeNullable(dvVersionMinor), hashCodeNullable(dvProfile), hashCodeNullable(dvLevel), hashCodeNullable(rpuPresentFlag), hashCodeNullable(elPresentFlag), hashCodeNullable(blPresentFlag), hashCodeNullable(dvBlSignalCompatibilityId), hashCodeNullable(rotation), hashCodeNullable(comment), hashCodeNullable(timeBase), hashCodeNullable(codecTimeBase), hashCodeNullable(title), videoRange, videoRangeType, hashCodeNullable(videoDoViTitle), audioSpatialFormat, hashCodeNullable(localizedUndefined), hashCodeNullable(localizedDefault), hashCodeNullable(localizedForced), hashCodeNullable(localizedExternal), hashCodeNullable(localizedHearingImpaired), hashCodeNullable(displayTitle), hashCodeNullable(nalLengthSize), isInterlaced, hashCodeNullable(isAVC), hashCodeNullable(channelLayout), hashCodeNullable(bitRate), hashCodeNullable(bitDepth), hashCodeNullable(refFrames), hashCodeNullable(packetLength), hashCodeNullable(channels), hashCodeNullable(sampleRate), isDefault, isForced, isHearingImpaired, hashCodeNullable(height), hashCodeNullable(width), hashCodeNullable(averageFrameRate), hashCodeNullable(realFrameRate), hashCodeNullable(referenceFrameRate), hashCodeNullable(profile), type, hashCodeNullable(aspectRatio), index, hashCodeNullable(score), isExternal, hashCodeNullable(deliveryMethod), hashCodeNullable(deliveryUrl), hashCodeNullable(isExternalUrl), isTextSubtitleStream, supportsExternalStream, hashCodeNullable(path), hashCodeNullable(pixelFormat), hashCodeNullable(level), hashCodeNullable(isAnamorphic));
  }
