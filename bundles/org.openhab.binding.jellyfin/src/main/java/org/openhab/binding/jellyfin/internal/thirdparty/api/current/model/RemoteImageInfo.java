...
public class RemoteImageInfo {
    ...
    public RemoteImageInfo providerName(@org.eclipse.jdt.annotation.Nullable String providerName) {
    ...
    public RemoteImageInfo url(@org.eclipse.jdt.annotation.Nullable String url) {
        this.url = url;
        return this;
    }
    ...
    public RemoteImageInfo thumbnailUrl(@org.eclipse.jdt.annotation.Nullable String thumbnailUrl) {
    ...
    @JsonProperty(value = JSON_PROPERTY_THUMBNAIL_URL, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setThumbnailUrl(@org.eclipse.jdt.annotation.Nullable String thumbnailUrl) {
        this.thumbnailUrl = thumbnailUrl;
    }

    public RemoteImageInfo height(@org.eclipse.jdt.annotation.Nullable Integer height) {
        this.height = height;
        return this;
    }
    ...
    public RemoteImageInfo width(@org.eclipse.jdt.annotation.Nullable Integer width) {
        this.width = width;
        return this;
    }
    ...
    public RemoteImageInfo communityRating(@org.eclipse.jdt.annotation.Nullable Double communityRating) {
    ...
    @JsonProperty(value = JSON_PROPERTY_COMMUNITY_RATING, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setCommunityRating(@org.eclipse.jdt.annotation.Nullable Double communityRating) {
        this.communityRating = communityRating;
    }

    public RemoteImageInfo voteCount(@org.eclipse.jdt.annotation.Nullable Integer voteCount) {
    ...
    @JsonProperty(value = JSON_PROPERTY_VOTE_COUNT, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setVoteCount(@org.eclipse.jdt.annotation.Nullable Integer voteCount) {
        this.voteCount = voteCount;
    }

    public RemoteImageInfo language(@org.eclipse.jdt.annotation.Nullable String language) {
    ...
    public RemoteImageInfo type(@org.eclipse.jdt.annotation.Nullable ImageType type) {
        this.type = type;
        return this;
    }
    ...
    public RemoteImageInfo ratingType(@org.eclipse.jdt.annotation.Nullable RatingType ratingType) {
    ...
    @JsonProperty(value = JSON_PROPERTY_RATING_TYPE, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRatingType(@org.eclipse.jdt.annotation.Nullable RatingType ratingType) {
        this.ratingType = ratingType;
    }
