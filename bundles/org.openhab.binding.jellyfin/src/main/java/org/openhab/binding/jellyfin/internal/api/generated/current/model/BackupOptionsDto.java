...
public class BackupOptionsDto {
    ...
    public BackupOptionsDto metadata(@org.eclipse.jdt.annotation.NonNull Boolean metadata) {
    ...
    @JsonProperty(value = JSON_PROPERTY_METADATA, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setMetadata(@org.eclipse.jdt.annotation.NonNull Boolean metadata) {
        this.metadata = metadata;
    }

    public BackupOptionsDto trickplay(@org.eclipse.jdt.annotation.NonNull Boolean trickplay) {
    ...
    @JsonProperty(value = JSON_PROPERTY_TRICKPLAY, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setTrickplay(@org.eclipse.jdt.annotation.NonNull Boolean trickplay) {
        this.trickplay = trickplay;
    }

    public BackupOptionsDto subtitles(@org.eclipse.jdt.annotation.NonNull Boolean subtitles) {
    ...
    @JsonProperty(value = JSON_PROPERTY_SUBTITLES, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSubtitles(@org.eclipse.jdt.annotation.NonNull Boolean subtitles) {
        this.subtitles = subtitles;
    }

    public BackupOptionsDto database(@org.eclipse.jdt.annotation.NonNull Boolean database) {
    ...
    @JsonProperty(value = JSON_PROPERTY_DATABASE, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setDatabase(@org.eclipse.jdt.annotation.NonNull Boolean database) {
        this.database = database;
    }
