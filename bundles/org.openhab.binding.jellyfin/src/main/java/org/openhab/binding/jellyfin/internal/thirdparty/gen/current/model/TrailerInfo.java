...
public class TrailerInfo {
    ...
    public TrailerInfo name(@org.eclipse.jdt.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public TrailerInfo originalTitle(@org.eclipse.jdt.annotation.Nullable String originalTitle) {
    ...
    public TrailerInfo path(@org.eclipse.jdt.annotation.Nullable String path) {
        this.path = path;
        return this;
    }
    ...
    public TrailerInfo metadataLanguage(@org.eclipse.jdt.annotation.Nullable String metadataLanguage) {
    ...
    public TrailerInfo metadataCountryCode(@org.eclipse.jdt.annotation.Nullable String metadataCountryCode) {
    ...
    public TrailerInfo providerIds(@org.eclipse.jdt.annotation.Nullable Map<String, String> providerIds) {
    ...
    public TrailerInfo year(@org.eclipse.jdt.annotation.Nullable Integer year) {
        this.year = year;
        return this;
    }
    ...
    public TrailerInfo indexNumber(@org.eclipse.jdt.annotation.Nullable Integer indexNumber) {
    ...
    public TrailerInfo parentIndexNumber(@org.eclipse.jdt.annotation.Nullable Integer parentIndexNumber) {
    ...
    public TrailerInfo premiereDate(@org.eclipse.jdt.annotation.Nullable OffsetDateTime premiereDate) {
    ...
    public TrailerInfo isAutomated(@org.eclipse.jdt.annotation.Nullable Boolean isAutomated) {
    ...
    public TrailerInfo.Builder toBuilder() {
        return new TrailerInfo.Builder().name(getName()).originalTitle(getOriginalTitle()).path(getPath())
