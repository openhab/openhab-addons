...
public class UserUpdatedMessage {
    ...
    public UserUpdatedMessage data(@org.eclipse.jdt.annotation.Nullable UserDto data) {
        this.data = data;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(@org.eclipse.jdt.annotation.Nullable UserDto data) {
        this.data = data;
    }

    public UserUpdatedMessage messageId(@org.eclipse.jdt.annotation.Nullable UUID messageId) {
