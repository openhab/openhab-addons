...
public class ExternalIdInfo {
    ...
    public ExternalIdInfo urlFormatString(@org.eclipse.jdt.annotation.Nullable String urlFormatString) {
    ...
    @JsonProperty(JSON_PROPERTY_URL_FORMAT_STRING)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setUrlFormatString(@org.eclipse.jdt.annotation.Nullable String urlFormatString) {
        this.urlFormatString = urlFormatString;
    }
