...
import org.openhab.binding.jellyfin.internal.api.version.current.model.LocalizationOption;
...
public class LocalizationApi {
     ...
     * 
     * <p><b>200</b> - Known countries returned.
    ...
    private ResponseSpec getCountriesRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Localization/Countries", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * Gets known cultures.
     * 
     * <p><b>200</b> - Known cultures returned.
     * <p><b>401</b> - Unauthorized
     * <p><b>403</b> - Forbidden
    ...
    private ResponseSpec getCulturesRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Localization/Cultures", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * 
     * <p><b>200</b> - Localization options returned.
     * <p><b>401</b> - Unauthorized
     * <p><b>403</b> - Forbidden
    ...
    private ResponseSpec getLocalizationOptionsRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Localization/Options", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<List<LocalizationOption>>> getLocalizationOptionsWithHttpInfo() throws WebClientResponseException {
        ParameterizedTypeReference<LocalizationOption> localVarReturnType = new ParameterizedTypeReference<LocalizationOption>() {};
     ...
     * 
     * <p><b>200</b> - Known parental ratings returned.
     * <p><b>401</b> - Unauthorized
     * <p><b>403</b> - Forbidden
    ...
    private ResponseSpec getParentalRatingsRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Localization/ParentalRatings", HttpMethod.GET, pathParams, queryParams, postBody, headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<List<ParentalRating>>> getParentalRatingsWithHttpInfo() throws WebClientResponseException {
        ParameterizedTypeReference<ParentalRating> localVarReturnType = new ParameterizedTypeReference<ParentalRating>() {};
