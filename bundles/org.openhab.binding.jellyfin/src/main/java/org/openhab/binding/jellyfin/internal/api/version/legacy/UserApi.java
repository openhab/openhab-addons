...
public class UserApi {
     ...
     * 
     * <p>
     * <b>200</b> - User authenticated.
     * <p>
     * <b>403</b> - Sha1-hashed password only is not allowed.
     * <p>
     ...
     */
    private ResponseSpec authenticateUserRequestCreation(UUID userId, String pw, String password)
            throws WebClientResponseException {
        Object postBody = null;
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userId' when calling authenticateUser",
        ...
        if (pw == null) {
            throw new WebClientResponseException("Missing the required parameter 'pw' when calling authenticateUser",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/Users/{userId}/Authenticate", HttpMethod.POST, pathParams, queryParams, postBody,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<AuthenticationResult> authenticateUser(UUID userId, String pw, String password)
            throws WebClientResponseException {
        ParameterizedTypeReference<AuthenticationResult> localVarReturnType = new ParameterizedTypeReference<AuthenticationResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<AuthenticationResult>> authenticateUserWithHttpInfo(UUID userId, String pw,
            String password) throws WebClientResponseException {
        ParameterizedTypeReference<AuthenticationResult> localVarReturnType = new ParameterizedTypeReference<AuthenticationResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec authenticateUserWithResponseSpec(UUID userId, String pw, String password)
            throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec authenticateUserByNameRequestCreation(AuthenticateUserByName authenticateUserByName)
            throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Users/AuthenticateByName", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<AuthenticationResult> authenticateUserByName(AuthenticateUserByName authenticateUserByName)
            throws WebClientResponseException {
        ParameterizedTypeReference<AuthenticationResult> localVarReturnType = new ParameterizedTypeReference<AuthenticationResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<AuthenticationResult>> authenticateUserByNameWithHttpInfo(
            AuthenticateUserByName authenticateUserByName) throws WebClientResponseException {
        ParameterizedTypeReference<AuthenticationResult> localVarReturnType = new ParameterizedTypeReference<AuthenticationResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec authenticateUserByNameWithResponseSpec(AuthenticateUserByName authenticateUserByName)
            throws WebClientResponseException {
     ...
     * <b>200</b> - User authenticated.
     * <p>
     * <b>400</b> - Missing token.
     * 
     * @param quickConnectDto The Jellyfin.Api.Models.UserDtos.QuickConnectDto request.
     * @return AuthenticationResult
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec authenticateWithQuickConnectRequestCreation(QuickConnectDto quickConnectDto)
            throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Users/AuthenticateWithQuickConnect", HttpMethod.POST, pathParams, queryParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<AuthenticationResult> authenticateWithQuickConnect(QuickConnectDto quickConnectDto)
            throws WebClientResponseException {
        ParameterizedTypeReference<AuthenticationResult> localVarReturnType = new ParameterizedTypeReference<AuthenticationResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<AuthenticationResult>> authenticateWithQuickConnectWithHttpInfo(
            QuickConnectDto quickConnectDto) throws WebClientResponseException {
        ParameterizedTypeReference<AuthenticationResult> localVarReturnType = new ParameterizedTypeReference<AuthenticationResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec authenticateWithQuickConnectWithResponseSpec(QuickConnectDto quickConnectDto)
            throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec createUserByNameRequestCreation(CreateUserByName createUserByName)
            throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Users/New", HttpMethod.POST, pathParams, queryParams, postBody, headerParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<UserDto>> createUserByNameWithHttpInfo(CreateUserByName createUserByName)
            throws WebClientResponseException {
        ParameterizedTypeReference<UserDto> localVarReturnType = new ParameterizedTypeReference<UserDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec createUserByNameWithResponseSpec(CreateUserByName createUserByName)
            throws WebClientResponseException {
    ...
    private ResponseSpec deleteUserRequestCreation(UUID userId) throws WebClientResponseException {
        ...
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException("Missing the required parameter 'userId' when calling deleteUser",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Users/{userId}", HttpMethod.DELETE, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * 
     * <p>
     * <b>200</b> - Password reset process started.
     * 
     * @param forgotPasswordDto The forgot password request containing the entered username.
     * @return ForgotPasswordResult
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec forgotPasswordRequestCreation(ForgotPasswordDto forgotPasswordDto)
            throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Users/ForgotPassword", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ForgotPasswordResult> forgotPassword(ForgotPasswordDto forgotPasswordDto)
            throws WebClientResponseException {
        ParameterizedTypeReference<ForgotPasswordResult> localVarReturnType = new ParameterizedTypeReference<ForgotPasswordResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<ForgotPasswordResult>> forgotPasswordWithHttpInfo(ForgotPasswordDto forgotPasswordDto)
            throws WebClientResponseException {
        ParameterizedTypeReference<ForgotPasswordResult> localVarReturnType = new ParameterizedTypeReference<ForgotPasswordResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec forgotPasswordWithResponseSpec(ForgotPasswordDto forgotPasswordDto)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>200</b> - Pin reset process started.
     * 
     * @param forgotPasswordPinDto The forgot password pin request containing the entered pin.
     * @return PinRedeemResult
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec forgotPasswordPinRequestCreation(ForgotPasswordPinDto forgotPasswordPinDto)
            throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Users/ForgotPassword/Pin", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<PinRedeemResult> forgotPasswordPin(ForgotPasswordPinDto forgotPasswordPinDto)
            throws WebClientResponseException {
        ParameterizedTypeReference<PinRedeemResult> localVarReturnType = new ParameterizedTypeReference<PinRedeemResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<PinRedeemResult>> forgotPasswordPinWithHttpInfo(
            ForgotPasswordPinDto forgotPasswordPinDto) throws WebClientResponseException {
        ParameterizedTypeReference<PinRedeemResult> localVarReturnType = new ParameterizedTypeReference<PinRedeemResult>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec forgotPasswordPinWithResponseSpec(ForgotPasswordPinDto forgotPasswordPinDto)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>200</b> - User returned.
     * <p>
     * <b>400</b> - Token is not owned by a user.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
    ...
    private ResponseSpec getCurrentUserRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Users/Me", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    ...
    private ResponseSpec getPublicUsersRequestCreation() throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Users/Public", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
    ...
    private ResponseSpec getUserByIdRequestCreation(UUID userId) throws WebClientResponseException {
        ...
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException("Missing the required parameter 'userId' when calling getUserById",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Users/{userId}", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getUsersRequestCreation(Boolean isHidden, Boolean isDisabled)
            throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Users", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<List<UserDto>>> getUsersWithHttpInfo(Boolean isHidden, Boolean isDisabled)
            throws WebClientResponseException {
        ParameterizedTypeReference<UserDto> localVarReturnType = new ParameterizedTypeReference<UserDto>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getUsersWithResponseSpec(Boolean isHidden, Boolean isDisabled)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>204</b> - User updated.
     * <p>
     * <b>400</b> - User information was not supplied.
     * <p>
     * <b>403</b> - User update forbidden.
     * <p>
     * <b>401</b> - Unauthorized
     * 
     * @param userId The user id.
    ...
    private ResponseSpec updateUserRequestCreation(UUID userId, UserDto userDto) throws WebClientResponseException {
        ...
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException("Missing the required parameter 'userId' when calling updateUser",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'userDto' is set
        if (userDto == null) {
            throw new WebClientResponseException("Missing the required parameter 'userDto' when calling updateUser",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Users/{userId}", HttpMethod.POST, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> updateUserWithHttpInfo(UUID userId, UserDto userDto)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * 
     * <p>
     * <b>204</b> - User configuration updated.
     * <p>
     * <b>403</b> - User configuration update forbidden.
     * <p>
     * <b>401</b> - Unauthorized
     * 
     * @param userId The user id.
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec updateUserConfigurationRequestCreation(UUID userId, UserConfiguration userConfiguration)
            throws WebClientResponseException {
        Object postBody = userConfiguration;
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userId' when calling updateUserConfiguration",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/Users/{userId}/Configuration", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> updateUserConfiguration(UUID userId, UserConfiguration userConfiguration)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> updateUserConfigurationWithHttpInfo(UUID userId,
            UserConfiguration userConfiguration) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec updateUserConfigurationWithResponseSpec(UUID userId, UserConfiguration userConfiguration)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>204</b> - Password successfully reset.
     * <p>
     * <b>403</b> - User is not allowed to update the password.
     * <p>
     * <b>404</b> - User not found.
     * <p>
     * <b>401</b> - Unauthorized
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec updateUserEasyPasswordRequestCreation(UUID userId,
            UpdateUserEasyPassword updateUserEasyPassword) throws WebClientResponseException {
        Object postBody = updateUserEasyPassword;
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userId' when calling updateUserEasyPassword",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/Users/{userId}/EasyPassword", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> updateUserEasyPassword(UUID userId, UpdateUserEasyPassword updateUserEasyPassword)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> updateUserEasyPasswordWithHttpInfo(UUID userId,
            UpdateUserEasyPassword updateUserEasyPassword) throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec updateUserEasyPasswordWithResponseSpec(UUID userId,
            UpdateUserEasyPassword updateUserEasyPassword) throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec updateUserPasswordRequestCreation(UUID userId, UpdateUserPassword updateUserPassword)
            throws WebClientResponseException {
        Object postBody = updateUserPassword;
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userId' when calling updateUserPassword",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        ...
        return apiClient.invokeAPI("/Users/{userId}/Password", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<Void> updateUserPassword(UUID userId, UpdateUserPassword updateUserPassword)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> updateUserPasswordWithHttpInfo(UUID userId, UpdateUserPassword updateUserPassword)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec updateUserPasswordWithResponseSpec(UUID userId, UpdateUserPassword updateUserPassword)
            throws WebClientResponseException {
     ...
     * 
     * <p>
     * <b>204</b> - User policy updated.
     * <p>
     * <b>400</b> - User policy was not supplied.
     * <p>
     * <b>403</b> - User policy update forbidden.
     * <p>
     * <b>401</b> - Unauthorized
     * 
     * @param userId The user id.
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec updateUserPolicyRequestCreation(UUID userId, UserPolicy userPolicy)
            throws WebClientResponseException {
        Object postBody = userPolicy;
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userId' when calling updateUserPolicy",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // verify the required parameter 'userPolicy' is set
        if (userPolicy == null) {
            throw new WebClientResponseException(
                    "Missing the required parameter 'userPolicy' when calling updateUserPolicy",
                    HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST.getReasonPhrase(), null, null, null);
        }
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Users/{userId}/Policy", HttpMethod.POST, pathParams, queryParams, postBody,
                headerParams, cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames,
                localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<Void>> updateUserPolicyWithHttpInfo(UUID userId, UserPolicy userPolicy)
            throws WebClientResponseException {
        ParameterizedTypeReference<Void> localVarReturnType = new ParameterizedTypeReference<Void>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec updateUserPolicyWithResponseSpec(UUID userId, UserPolicy userPolicy)
            throws WebClientResponseException {
