...
public class MediaEncoderPathDto {
    ...
    public MediaEncoderPathDto path(@org.eclipse.jdt.annotation.Nullable String path) {
        this.path = path;
        return this;
    }
    ...
    public MediaEncoderPathDto pathType(@org.eclipse.jdt.annotation.Nullable String pathType) {
    ...
    @JsonProperty(JSON_PROPERTY_PATH_TYPE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setPathType(@org.eclipse.jdt.annotation.Nullable String pathType) {
        this.pathType = pathType;
    }
