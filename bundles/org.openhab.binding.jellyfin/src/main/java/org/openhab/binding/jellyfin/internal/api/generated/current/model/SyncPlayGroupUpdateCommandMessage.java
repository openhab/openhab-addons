...
public class SyncPlayGroupUpdateCommandMessage {
    ...
    public SyncPlayGroupUpdateCommandMessage data(@org.eclipse.jdt.annotation.Nullable GroupUpdate data) {
        this.data = data;
        return this;
    }
    ...
    public SyncPlayGroupUpdateCommandMessage messageId(@org.eclipse.jdt.annotation.Nullable UUID messageId) {
