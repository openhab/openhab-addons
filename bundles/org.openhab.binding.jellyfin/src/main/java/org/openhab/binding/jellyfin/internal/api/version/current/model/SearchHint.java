  ...
  */
  public SearchHint.Builder toBuilder() {
    return new SearchHint.Builder()
      ...
      .id(getId())
      .name(getName())
      .matchedTerm(getMatchedTerm())
      .indexNumber(getIndexNumber())
      .productionYear(getProductionYear())
      .parentIndexNumber(getParentIndexNumber())
      .primaryImageTag(getPrimaryImageTag())
      .thumbImageTag(getThumbImageTag())
      .thumbImageItemId(getThumbImageItemId())
      .backdropImageTag(getBackdropImageTag())
      .backdropImageItemId(getBackdropImageItemId())
      .type(getType())
