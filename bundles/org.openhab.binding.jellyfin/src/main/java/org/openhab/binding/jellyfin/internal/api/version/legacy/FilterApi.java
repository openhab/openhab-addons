...
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.QueryFilters;
import org.openhab.binding.jellyfin.internal.api.version.legacy.model.QueryFiltersLegacy;
...
public class FilterApi {
     ...
     */
    private ResponseSpec getQueryFiltersRequestCreation(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes,
            Boolean isAiring, Boolean isMovie, Boolean isSports, Boolean isKids, Boolean isNews, Boolean isSeries,
            Boolean recursive) throws WebClientResponseException {
        ...
        return apiClient.invokeAPI("/Items/Filters2", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<QueryFilters> getQueryFilters(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes,
            Boolean isAiring, Boolean isMovie, Boolean isSports, Boolean isKids, Boolean isNews, Boolean isSeries,
            Boolean recursive) throws WebClientResponseException {
        ParameterizedTypeReference<QueryFilters> localVarReturnType = new ParameterizedTypeReference<QueryFilters>() {
        };
        return getQueryFiltersRequestCreation(userId, parentId, includeItemTypes, isAiring, isMovie, isSports, isKids,
                isNews, isSeries, recursive).bodyToMono(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<QueryFilters>> getQueryFiltersWithHttpInfo(UUID userId, UUID parentId,
            List<BaseItemKind> includeItemTypes, Boolean isAiring, Boolean isMovie, Boolean isSports, Boolean isKids,
            Boolean isNews, Boolean isSeries, Boolean recursive) throws WebClientResponseException {
        ParameterizedTypeReference<QueryFilters> localVarReturnType = new ParameterizedTypeReference<QueryFilters>() {
        };
        return getQueryFiltersRequestCreation(userId, parentId, includeItemTypes, isAiring, isMovie, isSports, isKids,
                isNews, isSeries, recursive).toEntity(localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getQueryFiltersWithResponseSpec(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes,
            Boolean isAiring, Boolean isMovie, Boolean isSports, Boolean isKids, Boolean isNews, Boolean isSeries,
            Boolean recursive) throws WebClientResponseException {
        return getQueryFiltersRequestCreation(userId, parentId, includeItemTypes, isAiring, isMovie, isSports, isKids,
                isNews, isSeries, recursive);
    }
     ...
     * 
     * <p>
     * <b>200</b> - Legacy filters retrieved.
     * <p>
     * <b>401</b> - Unauthorized
     * <p>
     * <b>403</b> - Forbidden
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getQueryFiltersLegacyRequestCreation(UUID userId, UUID parentId,
            List<BaseItemKind> includeItemTypes, List<String> mediaTypes) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
        ...
        return apiClient.invokeAPI("/Items/Filters", HttpMethod.GET, pathParams, queryParams, postBody, headerParams,
                cookieParams, formParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    }
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<QueryFiltersLegacy> getQueryFiltersLegacy(UUID userId, UUID parentId,
            List<BaseItemKind> includeItemTypes, List<String> mediaTypes) throws WebClientResponseException {
        ParameterizedTypeReference<QueryFiltersLegacy> localVarReturnType = new ParameterizedTypeReference<QueryFiltersLegacy>() {
        };
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<QueryFiltersLegacy>> getQueryFiltersLegacyWithHttpInfo(UUID userId, UUID parentId,
            List<BaseItemKind> includeItemTypes, List<String> mediaTypes) throws WebClientResponseException {
        ParameterizedTypeReference<QueryFiltersLegacy> localVarReturnType = new ParameterizedTypeReference<QueryFiltersLegacy>() {
        };
        return getQueryFiltersLegacyRequestCreation(userId, parentId, includeItemTypes, mediaTypes)
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getQueryFiltersLegacyWithResponseSpec(UUID userId, UUID parentId,
            List<BaseItemKind> includeItemTypes, List<String> mediaTypes) throws WebClientResponseException {
        return getQueryFiltersLegacyRequestCreation(userId, parentId, includeItemTypes, mediaTypes);
    }
}
