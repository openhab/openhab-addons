...
public class FilterApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getQueryFiltersLegacyRequestCreation(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes, List<String> mediaTypes) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<QueryFiltersLegacy> getQueryFiltersLegacy(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes, List<String> mediaTypes) throws WebClientResponseException {
        ParameterizedTypeReference<QueryFiltersLegacy> localVarReturnType = new ParameterizedTypeReference<QueryFiltersLegacy>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<QueryFiltersLegacy>> getQueryFiltersLegacyWithHttpInfo(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes, List<String> mediaTypes) throws WebClientResponseException {
        ParameterizedTypeReference<QueryFiltersLegacy> localVarReturnType = new ParameterizedTypeReference<QueryFiltersLegacy>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getQueryFiltersLegacyWithResponseSpec(UUID userId, UUID parentId, List<BaseItemKind> includeItemTypes, List<String> mediaTypes) throws WebClientResponseException {
