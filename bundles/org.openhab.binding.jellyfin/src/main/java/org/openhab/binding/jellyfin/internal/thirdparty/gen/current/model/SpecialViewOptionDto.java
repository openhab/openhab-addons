...
public class SpecialViewOptionDto {
    ...
    public SpecialViewOptionDto name(@org.eclipse.jdt.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public SpecialViewOptionDto id(@org.eclipse.jdt.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
