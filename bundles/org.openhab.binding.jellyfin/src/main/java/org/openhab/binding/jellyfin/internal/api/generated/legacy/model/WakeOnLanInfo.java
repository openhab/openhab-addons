...
public class WakeOnLanInfo {
    ...
    public WakeOnLanInfo macAddress(@org.eclipse.jdt.annotation.Nullable String macAddress) {
    ...
    @JsonProperty(JSON_PROPERTY_MAC_ADDRESS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setMacAddress(@org.eclipse.jdt.annotation.Nullable String macAddress) {
        this.macAddress = macAddress;
    }

    public WakeOnLanInfo port(@org.eclipse.jdt.annotation.Nullable Integer port) {
        this.port = port;
        return this;
    }
    ...
    @JsonProperty(JSON_PROPERTY_PORT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setPort(@org.eclipse.jdt.annotation.Nullable Integer port) {
        this.port = port;
    }
