...
public class PublicSystemInfo {
    ...
    public PublicSystemInfo localAddress(@org.eclipse.jdt.annotation.Nullable String localAddress) {
    ...
    public PublicSystemInfo serverName(@org.eclipse.jdt.annotation.Nullable String serverName) {
    ...
    public PublicSystemInfo version(@org.eclipse.jdt.annotation.Nullable String version) {
    ...
    public PublicSystemInfo productName(@org.eclipse.jdt.annotation.Nullable String productName) {
    ...
    public PublicSystemInfo operatingSystem(@org.eclipse.jdt.annotation.Nullable String operatingSystem) {
    ...
    public PublicSystemInfo id(@org.eclipse.jdt.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public PublicSystemInfo startupWizardCompleted(
            @org.eclipse.jdt.annotation.Nullable Boolean startupWizardCompleted) {
