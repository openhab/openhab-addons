...
import org.openhab.binding.jellyfin.internal.api.version.current.model.DeinterlaceMethod;
import org.openhab.binding.jellyfin.internal.api.version.current.model.DownMixStereoAlgorithms;
import org.openhab.binding.jellyfin.internal.api.version.current.model.EncoderPreset;
import org.openhab.binding.jellyfin.internal.api.version.current.model.HardwareAccelerationType;
import org.openhab.binding.jellyfin.internal.api.version.current.model.TonemappingAlgorithm;
import org.openhab.binding.jellyfin.internal.api.version.current.model.TonemappingMode;
import org.openhab.binding.jellyfin.internal.api.version.current.model.TonemappingRange;
...
public class EncodingOptions {
  ...
  public static class Builder {
    ...
    public EncodingOptions.Builder qsvDevice(String qsvDevice) {
      this.instance.qsvDevice = JsonNullable.<String>of(qsvDevice);
      return this;
    }
    public EncodingOptions.Builder qsvDevice(JsonNullable<String> qsvDevice) {
    ...
    public EncodingOptions.Builder encoderPreset(EncoderPreset encoderPreset) {
      this.instance.encoderPreset = JsonNullable.<EncoderPreset>of(encoderPreset);
      return this;
    }
    public EncodingOptions.Builder encoderPreset(JsonNullable<EncoderPreset> encoderPreset) {
    ...
    public EncodingOptions.Builder allowOnDemandMetadataBasedKeyframeExtractionForExtensions(List<String> allowOnDemandMetadataBasedKeyframeExtractionForExtensions) {
      this.instance.allowOnDemandMetadataBasedKeyframeExtractionForExtensions = JsonNullable.<List<String>>of(allowOnDemandMetadataBasedKeyframeExtractionForExtensions);
      return this;
    }
    public EncodingOptions.Builder allowOnDemandMetadataBasedKeyframeExtractionForExtensions(JsonNullable<List<String>> allowOnDemandMetadataBasedKeyframeExtractionForExtensions) {
