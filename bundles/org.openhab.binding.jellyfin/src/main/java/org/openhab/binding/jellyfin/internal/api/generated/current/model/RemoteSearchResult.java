...
public class RemoteSearchResult {
    ...
    public RemoteSearchResult name(@org.eclipse.jdt.annotation.NonNull String name) {
        this.name = name;
        return this;
    }
    ...
    public RemoteSearchResult providerIds(@org.eclipse.jdt.annotation.NonNull Map<String, String> providerIds) {
    ...
    public RemoteSearchResult productionYear(@org.eclipse.jdt.annotation.NonNull Integer productionYear) {
    ...
    public RemoteSearchResult indexNumber(@org.eclipse.jdt.annotation.NonNull Integer indexNumber) {
    ...
    public RemoteSearchResult indexNumberEnd(@org.eclipse.jdt.annotation.NonNull Integer indexNumberEnd) {
    ...
    public RemoteSearchResult parentIndexNumber(@org.eclipse.jdt.annotation.NonNull Integer parentIndexNumber) {
    ...
    public RemoteSearchResult premiereDate(@org.eclipse.jdt.annotation.NonNull OffsetDateTime premiereDate) {
    ...
    public RemoteSearchResult imageUrl(@org.eclipse.jdt.annotation.NonNull String imageUrl) {
    ...
    public RemoteSearchResult searchProviderName(@org.eclipse.jdt.annotation.NonNull String searchProviderName) {
    ...
    public RemoteSearchResult overview(@org.eclipse.jdt.annotation.NonNull String overview) {
    ...
    public RemoteSearchResult albumArtist(@org.eclipse.jdt.annotation.NonNull RemoteSearchResult albumArtist) {
    ...
    public RemoteSearchResult artists(@org.eclipse.jdt.annotation.NonNull List<RemoteSearchResult> artists) {
