...
public class PlaystateMessage {
    ...
    public PlaystateMessage data(@org.eclipse.jdt.annotation.Nullable PlaystateRequest data) {
        this.data = data;
        return this;
    }
    ...
    @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setData(@org.eclipse.jdt.annotation.Nullable PlaystateRequest data) {
        this.data = data;
    }

    public PlaystateMessage messageId(@org.eclipse.jdt.annotation.Nullable UUID messageId) {
    ...
    /**
     * Return true if this PlaystateMessage object is equal to o.
     */
    @Override
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.data, playstateMessage.data)
