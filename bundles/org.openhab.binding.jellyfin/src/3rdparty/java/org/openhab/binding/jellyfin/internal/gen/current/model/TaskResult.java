...
import org.openhab.binding.jellyfin.internal.gen.current.model.TaskCompletionStatus;
...
public class TaskResult {
  ...
  public TaskResult startTimeUtc(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime startTimeUtc) {
  ...
  public TaskResult endTimeUtc(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime endTimeUtc) {
  ...
  public TaskResult status(@org.eclipse.jdt.annotation.Nullable
 ...
 TaskCompletionStatus status) {
  ...
  public TaskResult name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public TaskResult key(@org.eclipse.jdt.annotation.Nullable
 String key) {
    this.key = key;
    return this;
  }
 ...
 String key) {
  ...
  public TaskResult id(@org.eclipse.jdt.annotation.Nullable
 String id) {
    this.id = id;
    return this;
  }
 ...
 String id) {
  ...
  public TaskResult errorMessage(@org.eclipse.jdt.annotation.Nullable
 String errorMessage) {
 ...
 String errorMessage) {
  ...
  public TaskResult longErrorMessage(@org.eclipse.jdt.annotation.Nullable
 ...
 String longErrorMessage) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getStartTimeUtc() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sStartTimeUtc%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getStartTimeUtc()))));
    }

    // add `EndTimeUtc` to the URL query string
    if (getEndTimeUtc() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEndTimeUtc%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEndTimeUtc()))));
    }
    ...
    if (getLongErrorMessage() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLongErrorMessage%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLongErrorMessage()))));
    }
