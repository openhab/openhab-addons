...
import org.openhab.binding.jellyfin.internal.gen.current.model.TaskTriggerInfoType;
...
public class TaskTriggerInfo {
  ...
  public TaskTriggerInfo type(@org.eclipse.jdt.annotation.Nullable
 ...
 TaskTriggerInfoType type) {
  ...
  public TaskTriggerInfo timeOfDayTicks(@org.eclipse.jdt.annotation.Nullable
 Long timeOfDayTicks) {
 ...
 Long timeOfDayTicks) {
  ...
  public TaskTriggerInfo intervalTicks(@org.eclipse.jdt.annotation.Nullable
 Long intervalTicks) {
 ...
 Long intervalTicks) {
  ...
  public TaskTriggerInfo dayOfWeek(@org.eclipse.jdt.annotation.Nullable
 DayOfWeek dayOfWeek) {
 ...
 DayOfWeek dayOfWeek) {
  ...
  public TaskTriggerInfo maxRuntimeTicks(@org.eclipse.jdt.annotation.Nullable
 ...
 Long maxRuntimeTicks) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTimeOfDayTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTimeOfDayTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTimeOfDayTicks()))));
    }

    // add `IntervalTicks` to the URL query string
    if (getIntervalTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIntervalTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIntervalTicks()))));
    }
    ...
    if (getMaxRuntimeTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxRuntimeTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxRuntimeTicks()))));
    }
