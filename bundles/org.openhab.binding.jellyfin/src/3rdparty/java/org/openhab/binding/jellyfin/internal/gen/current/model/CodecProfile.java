...
import org.openhab.binding.jellyfin.internal.gen.current.model.CodecType;
import org.openhab.binding.jellyfin.internal.gen.current.model.ProfileCondition;
...
public class CodecProfile {
  ...
  public CodecProfile type(@org.eclipse.jdt.annotation.Nullable
 CodecType type) {
    this.type = type;
    return this;
  }
 ...
 CodecType type) {
  ...
  public CodecProfile conditions(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ProfileCondition> conditions) {
  ...
  public CodecProfile applyConditions(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ProfileCondition> applyConditions) {
  ...
  public CodecProfile codec(@org.eclipse.jdt.annotation.Nullable
 String codec) {
    this.codec = codec;
    return this;
  }
 ...
 String codec) {
  ...
  public CodecProfile container(@org.eclipse.jdt.annotation.Nullable
 String container) {
 ...
 String container) {
  ...
  public CodecProfile subContainer(@org.eclipse.jdt.annotation.Nullable
 String subContainer) {
 ...
 String subContainer) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getApplyConditions() != null) {
      for (int i = 0; i < getApplyConditions().size(); i++) {
        if (getApplyConditions().get(i) != null) {
          joiner.add(getApplyConditions().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sApplyConditions%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getSubContainer() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSubContainer%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSubContainer()))));
    }
