...
public class ImageInfo {
  ...
  public ImageInfo imageType(@org.eclipse.jdt.annotation.Nullable
 ImageType imageType) {
 ...
 ImageType imageType) {
  ...
  public ImageInfo imageIndex(@org.eclipse.jdt.annotation.Nullable
 Integer imageIndex) {
 ...
 Integer imageIndex) {
  ...
  public ImageInfo imageTag(@org.eclipse.jdt.annotation.Nullable
 String imageTag) {
 ...
 String imageTag) {
  ...
  public ImageInfo path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public ImageInfo blurHash(@org.eclipse.jdt.annotation.Nullable
 String blurHash) {
 ...
 String blurHash) {
  ...
  public ImageInfo height(@org.eclipse.jdt.annotation.Nullable
 Integer height) {
    this.height = height;
    return this;
  }
 ...
 Integer height) {
  ...
  public ImageInfo width(@org.eclipse.jdt.annotation.Nullable
 Integer width) {
    this.width = width;
    return this;
  }
 ...
 Integer width) {
  ...
  public ImageInfo size(@org.eclipse.jdt.annotation.Nullable
 Long size) {
    this.size = size;
    return this;
  }
 ...
 Long size) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getImageType() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sImageType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getImageType()))));
    }

    // add `ImageIndex` to the URL query string
    if (getImageIndex() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sImageIndex%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getImageIndex()))));
    }

    // add `ImageTag` to the URL query string
    if (getImageTag() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sImageTag%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getImageTag()))));
    }
    ...
    if (getBlurHash() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBlurHash%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBlurHash()))));
    }
