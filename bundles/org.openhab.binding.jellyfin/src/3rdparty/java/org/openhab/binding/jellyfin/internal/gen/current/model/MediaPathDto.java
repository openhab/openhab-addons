...
public class MediaPathDto {
  ...
  public MediaPathDto name(@org.eclipse.jdt.annotation.NonNull
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public MediaPathDto path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public MediaPathDto pathInfo(@org.eclipse.jdt.annotation.Nullable
