...
import org.openhab.binding.jellyfin.internal.gen.current.model.BackupManifestDto;
import org.openhab.binding.jellyfin.internal.gen.current.model.BackupOptionsDto;
import org.openhab.binding.jellyfin.internal.gen.current.model.BackupRestoreRequestDto;
...
public class BackupApi {
   ...
   */
  public BackupManifestDto createBackup(@org.eclipse.jdt.annotation.Nullable
 BackupOptionsDto backupOptionsDto) throws ApiException {
   ...
   */
  public BackupManifestDto createBackup(@org.eclipse.jdt.annotation.Nullable
 BackupOptionsDto backupOptionsDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BackupManifestDto> createBackupWithHttpInfo(@org.eclipse.jdt.annotation.Nullable
 BackupOptionsDto backupOptionsDto) throws ApiException {
 ...
 BackupOptionsDto backupOptionsDto, Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        if (localVarResponseBody == null) {
          return new ApiResponse<BackupManifestDto>(
        ...
        BackupManifestDto responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<BackupManifestDto>() {});
  ...
  private HttpRequest.Builder createBackupRequestBuilder(@org.eclipse.jdt.annotation.Nullable
 BackupOptionsDto backupOptionsDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BackupManifestDto getBackup(@org.eclipse.jdt.annotation.NonNull
 String path) throws ApiException {
   ...
   */
  public BackupManifestDto getBackup(@org.eclipse.jdt.annotation.NonNull
 String path, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BackupManifestDto> getBackupWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String path) throws ApiException {
 ...
 String path, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder getBackupRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String path, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<BackupManifestDto>> listBackupsWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<List<BackupManifestDto>>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        List<BackupManifestDto> responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<BackupManifestDto>>() {});
   ...
   * @throws ApiException if fails to make API call
   */
  public void startRestoreBackup(@org.eclipse.jdt.annotation.NonNull
 BackupRestoreRequestDto backupRestoreRequestDto) throws ApiException {
   ...
   */
  public void startRestoreBackup(@org.eclipse.jdt.annotation.NonNull
 BackupRestoreRequestDto backupRestoreRequestDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> startRestoreBackupWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 BackupRestoreRequestDto backupRestoreRequestDto) throws ApiException {
 ...
 BackupRestoreRequestDto backupRestoreRequestDto, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder startRestoreBackupRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 BackupRestoreRequestDto backupRestoreRequestDto, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'backupRestoreRequestDto' is set
    if (backupRestoreRequestDto == null) {
      throw new ApiException(400, "Missing the required parameter 'backupRestoreRequestDto' when calling startRestoreBackup");
    }
