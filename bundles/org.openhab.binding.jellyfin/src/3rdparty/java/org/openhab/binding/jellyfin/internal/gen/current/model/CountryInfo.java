...
public class CountryInfo {
  ...
  public CountryInfo name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public CountryInfo displayName(@org.eclipse.jdt.annotation.Nullable
 String displayName) {
 ...
 String displayName) {
  ...
  public CountryInfo twoLetterISORegionName(@org.eclipse.jdt.annotation.Nullable
 ...
 String twoLetterISORegionName) {
  ...
  public CountryInfo threeLetterISORegionName(@org.eclipse.jdt.annotation.Nullable
 ...
 String threeLetterISORegionName) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTwoLetterISORegionName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTwoLetterISORegionName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTwoLetterISORegionName()))));
    }

    // add `ThreeLetterISORegionName` to the URL query string
    if (getThreeLetterISORegionName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sThreeLetterISORegionName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getThreeLetterISORegionName()))));
    }
