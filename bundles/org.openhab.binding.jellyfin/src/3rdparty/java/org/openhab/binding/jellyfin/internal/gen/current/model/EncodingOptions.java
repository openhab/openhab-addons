...
import org.openhab.binding.jellyfin.internal.gen.current.model.DeinterlaceMethod;
import org.openhab.binding.jellyfin.internal.gen.current.model.DownMixStereoAlgorithms;
import org.openhab.binding.jellyfin.internal.gen.current.model.EncoderPreset;
import org.openhab.binding.jellyfin.internal.gen.current.model.HardwareAccelerationType;
import org.openhab.binding.jellyfin.internal.gen.current.model.TonemappingAlgorithm;
import org.openhab.binding.jellyfin.internal.gen.current.model.TonemappingMode;
import org.openhab.binding.jellyfin.internal.gen.current.model.TonemappingRange;
...
public class EncodingOptions {
  ...
  public EncodingOptions encodingThreadCount(@org.eclipse.jdt.annotation.Nullable
 Integer encodingThreadCount) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENCODING_THREAD_COUNT)
  public void setEncodingThreadCount(@org.eclipse.jdt.annotation.Nullable
 Integer encodingThreadCount) {
    this.encodingThreadCount = encodingThreadCount;
  }


  public EncodingOptions transcodingTempPath(@org.eclipse.jdt.annotation.Nullable
 ...
 String transcodingTempPath) {
  ...
  public EncodingOptions fallbackFontPath(@org.eclipse.jdt.annotation.Nullable
 String fallbackFontPath) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FALLBACK_FONT_PATH)
  public void setFallbackFontPath(@org.eclipse.jdt.annotation.Nullable
 String fallbackFontPath) {
    this.fallbackFontPath = fallbackFontPath;
  }


  public EncodingOptions enableFallbackFont(@org.eclipse.jdt.annotation.Nullable
 Boolean enableFallbackFont) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_FALLBACK_FONT)
  public void setEnableFallbackFont(@org.eclipse.jdt.annotation.Nullable
 Boolean enableFallbackFont) {
    this.enableFallbackFont = enableFallbackFont;
  }


  public EncodingOptions enableAudioVbr(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAudioVbr) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_AUDIO_VBR)
  public void setEnableAudioVbr(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAudioVbr) {
    this.enableAudioVbr = enableAudioVbr;
  }


  public EncodingOptions downMixAudioBoost(@org.eclipse.jdt.annotation.Nullable
 Double downMixAudioBoost) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DOWN_MIX_AUDIO_BOOST)
  public void setDownMixAudioBoost(@org.eclipse.jdt.annotation.Nullable
 Double downMixAudioBoost) {
    this.downMixAudioBoost = downMixAudioBoost;
  }


  public EncodingOptions downMixStereoAlgorithm(@org.eclipse.jdt.annotation.Nullable
 DownMixStereoAlgorithms downMixStereoAlgorithm) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DOWN_MIX_STEREO_ALGORITHM)
  public void setDownMixStereoAlgorithm(@org.eclipse.jdt.annotation.Nullable
 DownMixStereoAlgorithms downMixStereoAlgorithm) {
    this.downMixStereoAlgorithm = downMixStereoAlgorithm;
  }


  public EncodingOptions maxMuxingQueueSize(@org.eclipse.jdt.annotation.Nullable
 Integer maxMuxingQueueSize) {
  ...
  @JsonProperty(value = JSON_PROPERTY_MAX_MUXING_QUEUE_SIZE)
  public void setMaxMuxingQueueSize(@org.eclipse.jdt.annotation.Nullable
 Integer maxMuxingQueueSize) {
    this.maxMuxingQueueSize = maxMuxingQueueSize;
  }


  public EncodingOptions enableThrottling(@org.eclipse.jdt.annotation.Nullable
 Boolean enableThrottling) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_THROTTLING)
  public void setEnableThrottling(@org.eclipse.jdt.annotation.Nullable
 Boolean enableThrottling) {
    this.enableThrottling = enableThrottling;
  }


  public EncodingOptions throttleDelaySeconds(@org.eclipse.jdt.annotation.Nullable
 Integer throttleDelaySeconds) {
  ...
  @JsonProperty(value = JSON_PROPERTY_THROTTLE_DELAY_SECONDS)
  public void setThrottleDelaySeconds(@org.eclipse.jdt.annotation.Nullable
 Integer throttleDelaySeconds) {
    this.throttleDelaySeconds = throttleDelaySeconds;
  }


  public EncodingOptions enableSegmentDeletion(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSegmentDeletion) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_SEGMENT_DELETION)
  public void setEnableSegmentDeletion(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSegmentDeletion) {
    this.enableSegmentDeletion = enableSegmentDeletion;
  }


  public EncodingOptions segmentKeepSeconds(@org.eclipse.jdt.annotation.Nullable
 Integer segmentKeepSeconds) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SEGMENT_KEEP_SECONDS)
  public void setSegmentKeepSeconds(@org.eclipse.jdt.annotation.Nullable
 Integer segmentKeepSeconds) {
    this.segmentKeepSeconds = segmentKeepSeconds;
  }


  public EncodingOptions hardwareAccelerationType(@org.eclipse.jdt.annotation.Nullable
 ...
 HardwareAccelerationType hardwareAccelerationType) {
  ...
  public EncodingOptions encoderAppPath(@org.eclipse.jdt.annotation.Nullable
 String encoderAppPath) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENCODER_APP_PATH)
  public void setEncoderAppPath(@org.eclipse.jdt.annotation.Nullable
 String encoderAppPath) {
    this.encoderAppPath = encoderAppPath;
  }


  public EncodingOptions encoderAppPathDisplay(@org.eclipse.jdt.annotation.Nullable
 String encoderAppPathDisplay) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENCODER_APP_PATH_DISPLAY)
  public void setEncoderAppPathDisplay(@org.eclipse.jdt.annotation.Nullable
 String encoderAppPathDisplay) {
    this.encoderAppPathDisplay = encoderAppPathDisplay;
  }


  public EncodingOptions vaapiDevice(@org.eclipse.jdt.annotation.Nullable
 String vaapiDevice) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VAAPI_DEVICE)
  public void setVaapiDevice(@org.eclipse.jdt.annotation.Nullable
 String vaapiDevice) {
    this.vaapiDevice = vaapiDevice;
  }


  public EncodingOptions qsvDevice(@org.eclipse.jdt.annotation.Nullable
 String qsvDevice) {
  ...
  @JsonProperty(value = JSON_PROPERTY_QSV_DEVICE)
  public void setQsvDevice(@org.eclipse.jdt.annotation.Nullable
 String qsvDevice) {
    this.qsvDevice = qsvDevice;
  }


  public EncodingOptions enableTonemapping(@org.eclipse.jdt.annotation.Nullable
 Boolean enableTonemapping) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_TONEMAPPING)
  public void setEnableTonemapping(@org.eclipse.jdt.annotation.Nullable
 Boolean enableTonemapping) {
    this.enableTonemapping = enableTonemapping;
  }


  public EncodingOptions enableVppTonemapping(@org.eclipse.jdt.annotation.Nullable
 Boolean enableVppTonemapping) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_VPP_TONEMAPPING)
  public void setEnableVppTonemapping(@org.eclipse.jdt.annotation.Nullable
 Boolean enableVppTonemapping) {
    this.enableVppTonemapping = enableVppTonemapping;
  }


  public EncodingOptions enableVideoToolboxTonemapping(@org.eclipse.jdt.annotation.Nullable
 Boolean enableVideoToolboxTonemapping) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_VIDEO_TOOLBOX_TONEMAPPING)
  public void setEnableVideoToolboxTonemapping(@org.eclipse.jdt.annotation.Nullable
 Boolean enableVideoToolboxTonemapping) {
    this.enableVideoToolboxTonemapping = enableVideoToolboxTonemapping;
  }


  public EncodingOptions tonemappingAlgorithm(@org.eclipse.jdt.annotation.Nullable
 TonemappingAlgorithm tonemappingAlgorithm) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TONEMAPPING_ALGORITHM)
  public void setTonemappingAlgorithm(@org.eclipse.jdt.annotation.Nullable
 TonemappingAlgorithm tonemappingAlgorithm) {
    this.tonemappingAlgorithm = tonemappingAlgorithm;
  }


  public EncodingOptions tonemappingMode(@org.eclipse.jdt.annotation.Nullable
 TonemappingMode tonemappingMode) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TONEMAPPING_MODE)
  public void setTonemappingMode(@org.eclipse.jdt.annotation.Nullable
 TonemappingMode tonemappingMode) {
    this.tonemappingMode = tonemappingMode;
  }


  public EncodingOptions tonemappingRange(@org.eclipse.jdt.annotation.Nullable
 TonemappingRange tonemappingRange) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TONEMAPPING_RANGE)
  public void setTonemappingRange(@org.eclipse.jdt.annotation.Nullable
 TonemappingRange tonemappingRange) {
    this.tonemappingRange = tonemappingRange;
  }


  public EncodingOptions tonemappingDesat(@org.eclipse.jdt.annotation.Nullable
 Double tonemappingDesat) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TONEMAPPING_DESAT)
  public void setTonemappingDesat(@org.eclipse.jdt.annotation.Nullable
 Double tonemappingDesat) {
    this.tonemappingDesat = tonemappingDesat;
  }


  public EncodingOptions tonemappingPeak(@org.eclipse.jdt.annotation.Nullable
 Double tonemappingPeak) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TONEMAPPING_PEAK)
  public void setTonemappingPeak(@org.eclipse.jdt.annotation.Nullable
 Double tonemappingPeak) {
    this.tonemappingPeak = tonemappingPeak;
  }


  public EncodingOptions tonemappingParam(@org.eclipse.jdt.annotation.Nullable
 Double tonemappingParam) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TONEMAPPING_PARAM)
  public void setTonemappingParam(@org.eclipse.jdt.annotation.Nullable
 Double tonemappingParam) {
    this.tonemappingParam = tonemappingParam;
  }


  public EncodingOptions vppTonemappingBrightness(@org.eclipse.jdt.annotation.Nullable
 Double vppTonemappingBrightness) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VPP_TONEMAPPING_BRIGHTNESS)
  public void setVppTonemappingBrightness(@org.eclipse.jdt.annotation.Nullable
 Double vppTonemappingBrightness) {
    this.vppTonemappingBrightness = vppTonemappingBrightness;
  }


  public EncodingOptions vppTonemappingContrast(@org.eclipse.jdt.annotation.Nullable
 Double vppTonemappingContrast) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VPP_TONEMAPPING_CONTRAST)
  public void setVppTonemappingContrast(@org.eclipse.jdt.annotation.Nullable
 Double vppTonemappingContrast) {
    this.vppTonemappingContrast = vppTonemappingContrast;
  }


  public EncodingOptions h264Crf(@org.eclipse.jdt.annotation.Nullable
 Integer h264Crf) {
  ...
  @JsonProperty(value = JSON_PROPERTY_H264_CRF)
  public void setH264Crf(@org.eclipse.jdt.annotation.Nullable
 Integer h264Crf) {
    this.h264Crf = h264Crf;
  }


  public EncodingOptions h265Crf(@org.eclipse.jdt.annotation.Nullable
 Integer h265Crf) {
  ...
  @JsonProperty(value = JSON_PROPERTY_H265_CRF)
  public void setH265Crf(@org.eclipse.jdt.annotation.Nullable
 Integer h265Crf) {
    this.h265Crf = h265Crf;
  }


  public EncodingOptions encoderPreset(@org.eclipse.jdt.annotation.Nullable
 EncoderPreset encoderPreset) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENCODER_PRESET)
  public void setEncoderPreset(@org.eclipse.jdt.annotation.Nullable
 EncoderPreset encoderPreset) {
    this.encoderPreset = encoderPreset;
  }


  public EncodingOptions deinterlaceDoubleRate(@org.eclipse.jdt.annotation.Nullable
 Boolean deinterlaceDoubleRate) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DEINTERLACE_DOUBLE_RATE)
  public void setDeinterlaceDoubleRate(@org.eclipse.jdt.annotation.Nullable
 Boolean deinterlaceDoubleRate) {
    this.deinterlaceDoubleRate = deinterlaceDoubleRate;
  }


  public EncodingOptions deinterlaceMethod(@org.eclipse.jdt.annotation.Nullable
 DeinterlaceMethod deinterlaceMethod) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DEINTERLACE_METHOD)
  public void setDeinterlaceMethod(@org.eclipse.jdt.annotation.Nullable
 DeinterlaceMethod deinterlaceMethod) {
    this.deinterlaceMethod = deinterlaceMethod;
  }


  public EncodingOptions enableDecodingColorDepth10Hevc(@org.eclipse.jdt.annotation.Nullable
 Boolean enableDecodingColorDepth10Hevc) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_DECODING_COLOR_DEPTH10_HEVC)
  public void setEnableDecodingColorDepth10Hevc(@org.eclipse.jdt.annotation.Nullable
 Boolean enableDecodingColorDepth10Hevc) {
    this.enableDecodingColorDepth10Hevc = enableDecodingColorDepth10Hevc;
  }


  public EncodingOptions enableDecodingColorDepth10Vp9(@org.eclipse.jdt.annotation.Nullable
 Boolean enableDecodingColorDepth10Vp9) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_DECODING_COLOR_DEPTH10_VP9)
  public void setEnableDecodingColorDepth10Vp9(@org.eclipse.jdt.annotation.Nullable
 Boolean enableDecodingColorDepth10Vp9) {
    this.enableDecodingColorDepth10Vp9 = enableDecodingColorDepth10Vp9;
  }


  public EncodingOptions enableDecodingColorDepth10HevcRext(@org.eclipse.jdt.annotation.Nullable
 Boolean enableDecodingColorDepth10HevcRext) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_DECODING_COLOR_DEPTH10_HEVC_REXT)
  public void setEnableDecodingColorDepth10HevcRext(@org.eclipse.jdt.annotation.Nullable
 Boolean enableDecodingColorDepth10HevcRext) {
    this.enableDecodingColorDepth10HevcRext = enableDecodingColorDepth10HevcRext;
  }


  public EncodingOptions enableDecodingColorDepth12HevcRext(@org.eclipse.jdt.annotation.Nullable
 Boolean enableDecodingColorDepth12HevcRext) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_DECODING_COLOR_DEPTH12_HEVC_REXT)
  public void setEnableDecodingColorDepth12HevcRext(@org.eclipse.jdt.annotation.Nullable
 Boolean enableDecodingColorDepth12HevcRext) {
    this.enableDecodingColorDepth12HevcRext = enableDecodingColorDepth12HevcRext;
  }


  public EncodingOptions enableEnhancedNvdecDecoder(@org.eclipse.jdt.annotation.Nullable
 Boolean enableEnhancedNvdecDecoder) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_ENHANCED_NVDEC_DECODER)
  public void setEnableEnhancedNvdecDecoder(@org.eclipse.jdt.annotation.Nullable
 Boolean enableEnhancedNvdecDecoder) {
    this.enableEnhancedNvdecDecoder = enableEnhancedNvdecDecoder;
  }


  public EncodingOptions preferSystemNativeHwDecoder(@org.eclipse.jdt.annotation.Nullable
 Boolean preferSystemNativeHwDecoder) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PREFER_SYSTEM_NATIVE_HW_DECODER)
  public void setPreferSystemNativeHwDecoder(@org.eclipse.jdt.annotation.Nullable
 Boolean preferSystemNativeHwDecoder) {
    this.preferSystemNativeHwDecoder = preferSystemNativeHwDecoder;
  }


  public EncodingOptions enableIntelLowPowerH264HwEncoder(@org.eclipse.jdt.annotation.Nullable
 Boolean enableIntelLowPowerH264HwEncoder) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_INTEL_LOW_POWER_H264_HW_ENCODER)
  public void setEnableIntelLowPowerH264HwEncoder(@org.eclipse.jdt.annotation.Nullable
 Boolean enableIntelLowPowerH264HwEncoder) {
    this.enableIntelLowPowerH264HwEncoder = enableIntelLowPowerH264HwEncoder;
  }


  public EncodingOptions enableIntelLowPowerHevcHwEncoder(@org.eclipse.jdt.annotation.Nullable
 Boolean enableIntelLowPowerHevcHwEncoder) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_INTEL_LOW_POWER_HEVC_HW_ENCODER)
  public void setEnableIntelLowPowerHevcHwEncoder(@org.eclipse.jdt.annotation.Nullable
 Boolean enableIntelLowPowerHevcHwEncoder) {
    this.enableIntelLowPowerHevcHwEncoder = enableIntelLowPowerHevcHwEncoder;
  }


  public EncodingOptions enableHardwareEncoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableHardwareEncoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_HARDWARE_ENCODING)
  public void setEnableHardwareEncoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableHardwareEncoding) {
    this.enableHardwareEncoding = enableHardwareEncoding;
  }


  public EncodingOptions allowHevcEncoding(@org.eclipse.jdt.annotation.Nullable
 Boolean allowHevcEncoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOW_HEVC_ENCODING)
  public void setAllowHevcEncoding(@org.eclipse.jdt.annotation.Nullable
 Boolean allowHevcEncoding) {
    this.allowHevcEncoding = allowHevcEncoding;
  }


  public EncodingOptions allowAv1Encoding(@org.eclipse.jdt.annotation.Nullable
 Boolean allowAv1Encoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOW_AV1_ENCODING)
  public void setAllowAv1Encoding(@org.eclipse.jdt.annotation.Nullable
 Boolean allowAv1Encoding) {
    this.allowAv1Encoding = allowAv1Encoding;
  }


  public EncodingOptions enableSubtitleExtraction(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSubtitleExtraction) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_SUBTITLE_EXTRACTION)
  public void setEnableSubtitleExtraction(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSubtitleExtraction) {
    this.enableSubtitleExtraction = enableSubtitleExtraction;
  }


  public EncodingOptions hardwareDecodingCodecs(@org.eclipse.jdt.annotation.Nullable
 List<String> hardwareDecodingCodecs) {
  ...
  @JsonProperty(value = JSON_PROPERTY_HARDWARE_DECODING_CODECS)
  public void setHardwareDecodingCodecs(@org.eclipse.jdt.annotation.Nullable
 List<String> hardwareDecodingCodecs) {
    this.hardwareDecodingCodecs = hardwareDecodingCodecs;
  }


  public EncodingOptions allowOnDemandMetadataBasedKeyframeExtractionForExtensions(@org.eclipse.jdt.annotation.Nullable
 List<String> allowOnDemandMetadataBasedKeyframeExtractionForExtensions) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOW_ON_DEMAND_METADATA_BASED_KEYFRAME_EXTRACTION_FOR_EXTENSIONS)
  public void setAllowOnDemandMetadataBasedKeyframeExtractionForExtensions(@org.eclipse.jdt.annotation.Nullable
 List<String> allowOnDemandMetadataBasedKeyframeExtractionForExtensions) {
    this.allowOnDemandMetadataBasedKeyframeExtractionForExtensions = allowOnDemandMetadataBasedKeyframeExtractionForExtensions;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEncodingThreadCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEncodingThreadCount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEncodingThreadCount()))));
    }

    // add `TranscodingTempPath` to the URL query string
    if (getTranscodingTempPath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTranscodingTempPath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTranscodingTempPath()))));
    }

    // add `FallbackFontPath` to the URL query string
    if (getFallbackFontPath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sFallbackFontPath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getFallbackFontPath()))));
    }

    // add `EnableFallbackFont` to the URL query string
    if (getEnableFallbackFont() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableFallbackFont%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableFallbackFont()))));
    }

    // add `EnableAudioVbr` to the URL query string
    if (getEnableAudioVbr() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableAudioVbr%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableAudioVbr()))));
    }

    // add `DownMixAudioBoost` to the URL query string
    if (getDownMixAudioBoost() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDownMixAudioBoost%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDownMixAudioBoost()))));
    }

    // add `DownMixStereoAlgorithm` to the URL query string
    if (getDownMixStereoAlgorithm() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDownMixStereoAlgorithm%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDownMixStereoAlgorithm()))));
    }

    // add `MaxMuxingQueueSize` to the URL query string
    if (getMaxMuxingQueueSize() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxMuxingQueueSize%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxMuxingQueueSize()))));
    }

    // add `EnableThrottling` to the URL query string
    if (getEnableThrottling() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableThrottling%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableThrottling()))));
    }

    // add `ThrottleDelaySeconds` to the URL query string
    if (getThrottleDelaySeconds() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sThrottleDelaySeconds%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getThrottleDelaySeconds()))));
    }

    // add `EnableSegmentDeletion` to the URL query string
    if (getEnableSegmentDeletion() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableSegmentDeletion%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableSegmentDeletion()))));
    }

    // add `SegmentKeepSeconds` to the URL query string
    if (getSegmentKeepSeconds() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSegmentKeepSeconds%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSegmentKeepSeconds()))));
    }

    // add `HardwareAccelerationType` to the URL query string
    if (getHardwareAccelerationType() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sHardwareAccelerationType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getHardwareAccelerationType()))));
    }

    // add `EncoderAppPath` to the URL query string
    if (getEncoderAppPath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEncoderAppPath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEncoderAppPath()))));
    }

    // add `EncoderAppPathDisplay` to the URL query string
    if (getEncoderAppPathDisplay() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEncoderAppPathDisplay%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEncoderAppPathDisplay()))));
    }

    // add `VaapiDevice` to the URL query string
    if (getVaapiDevice() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sVaapiDevice%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVaapiDevice()))));
    }

    // add `QsvDevice` to the URL query string
    if (getQsvDevice() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sQsvDevice%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getQsvDevice()))));
    }

    // add `EnableTonemapping` to the URL query string
    if (getEnableTonemapping() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableTonemapping%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableTonemapping()))));
    }

    // add `EnableVppTonemapping` to the URL query string
    if (getEnableVppTonemapping() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableVppTonemapping%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableVppTonemapping()))));
    }

    // add `EnableVideoToolboxTonemapping` to the URL query string
    if (getEnableVideoToolboxTonemapping() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableVideoToolboxTonemapping%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableVideoToolboxTonemapping()))));
    }

    // add `TonemappingAlgorithm` to the URL query string
    if (getTonemappingAlgorithm() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTonemappingAlgorithm%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTonemappingAlgorithm()))));
    }

    // add `TonemappingMode` to the URL query string
    if (getTonemappingMode() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTonemappingMode%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTonemappingMode()))));
    }

    // add `TonemappingRange` to the URL query string
    if (getTonemappingRange() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTonemappingRange%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTonemappingRange()))));
    }

    // add `TonemappingDesat` to the URL query string
    if (getTonemappingDesat() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTonemappingDesat%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTonemappingDesat()))));
    }

    // add `TonemappingPeak` to the URL query string
    if (getTonemappingPeak() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTonemappingPeak%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTonemappingPeak()))));
    }

    // add `TonemappingParam` to the URL query string
    if (getTonemappingParam() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTonemappingParam%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTonemappingParam()))));
    }

    // add `VppTonemappingBrightness` to the URL query string
    if (getVppTonemappingBrightness() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sVppTonemappingBrightness%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVppTonemappingBrightness()))));
    }

    // add `VppTonemappingContrast` to the URL query string
    if (getVppTonemappingContrast() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sVppTonemappingContrast%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVppTonemappingContrast()))));
    }

    // add `H264Crf` to the URL query string
    if (getH264Crf() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sH264Crf%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getH264Crf()))));
    }

    // add `H265Crf` to the URL query string
    if (getH265Crf() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sH265Crf%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getH265Crf()))));
    }

    // add `EncoderPreset` to the URL query string
    if (getEncoderPreset() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEncoderPreset%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEncoderPreset()))));
    }

    // add `DeinterlaceDoubleRate` to the URL query string
    if (getDeinterlaceDoubleRate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDeinterlaceDoubleRate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDeinterlaceDoubleRate()))));
    }

    // add `DeinterlaceMethod` to the URL query string
    if (getDeinterlaceMethod() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDeinterlaceMethod%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDeinterlaceMethod()))));
    }

    // add `EnableDecodingColorDepth10Hevc` to the URL query string
    if (getEnableDecodingColorDepth10Hevc() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableDecodingColorDepth10Hevc%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableDecodingColorDepth10Hevc()))));
    }

    // add `EnableDecodingColorDepth10Vp9` to the URL query string
    if (getEnableDecodingColorDepth10Vp9() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableDecodingColorDepth10Vp9%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableDecodingColorDepth10Vp9()))));
    }

    // add `EnableDecodingColorDepth10HevcRext` to the URL query string
    if (getEnableDecodingColorDepth10HevcRext() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableDecodingColorDepth10HevcRext%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableDecodingColorDepth10HevcRext()))));
    }

    // add `EnableDecodingColorDepth12HevcRext` to the URL query string
    if (getEnableDecodingColorDepth12HevcRext() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableDecodingColorDepth12HevcRext%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableDecodingColorDepth12HevcRext()))));
    }

    // add `EnableEnhancedNvdecDecoder` to the URL query string
    if (getEnableEnhancedNvdecDecoder() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableEnhancedNvdecDecoder%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableEnhancedNvdecDecoder()))));
    }

    // add `PreferSystemNativeHwDecoder` to the URL query string
    if (getPreferSystemNativeHwDecoder() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPreferSystemNativeHwDecoder%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPreferSystemNativeHwDecoder()))));
    }

    // add `EnableIntelLowPowerH264HwEncoder` to the URL query string
    if (getEnableIntelLowPowerH264HwEncoder() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableIntelLowPowerH264HwEncoder%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableIntelLowPowerH264HwEncoder()))));
    }

    // add `EnableIntelLowPowerHevcHwEncoder` to the URL query string
    if (getEnableIntelLowPowerHevcHwEncoder() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableIntelLowPowerHevcHwEncoder%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableIntelLowPowerHevcHwEncoder()))));
    }

    // add `EnableHardwareEncoding` to the URL query string
    if (getEnableHardwareEncoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableHardwareEncoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableHardwareEncoding()))));
    }

    // add `AllowHevcEncoding` to the URL query string
    if (getAllowHevcEncoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAllowHevcEncoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAllowHevcEncoding()))));
    }

    // add `AllowAv1Encoding` to the URL query string
    if (getAllowAv1Encoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAllowAv1Encoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAllowAv1Encoding()))));
    }

    // add `EnableSubtitleExtraction` to the URL query string
    if (getEnableSubtitleExtraction() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableSubtitleExtraction%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableSubtitleExtraction()))));
    }
    ...
    if (getAllowOnDemandMetadataBasedKeyframeExtractionForExtensions() != null) {
      for (int i = 0; i < getAllowOnDemandMetadataBasedKeyframeExtractionForExtensions().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%sAllowOnDemandMetadataBasedKeyframeExtractionForExtensions%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
    ...
    public EncodingOptions.Builder allowOnDemandMetadataBasedKeyframeExtractionForExtensions(List<String> allowOnDemandMetadataBasedKeyframeExtractionForExtensions) {
  ...
  */
  public EncodingOptions.Builder toBuilder() {
    return new EncodingOptions.Builder()
      .encodingThreadCount(getEncodingThreadCount())
      .transcodingTempPath(getTranscodingTempPath())
      .fallbackFontPath(getFallbackFontPath())
      .enableFallbackFont(getEnableFallbackFont())
      .enableAudioVbr(getEnableAudioVbr())
      .downMixAudioBoost(getDownMixAudioBoost())
      .downMixStereoAlgorithm(getDownMixStereoAlgorithm())
      .maxMuxingQueueSize(getMaxMuxingQueueSize())
      .enableThrottling(getEnableThrottling())
      .throttleDelaySeconds(getThrottleDelaySeconds())
      .enableSegmentDeletion(getEnableSegmentDeletion())
      .segmentKeepSeconds(getSegmentKeepSeconds())
      .hardwareAccelerationType(getHardwareAccelerationType())
      .encoderAppPath(getEncoderAppPath())
      .encoderAppPathDisplay(getEncoderAppPathDisplay())
      .vaapiDevice(getVaapiDevice())
      .qsvDevice(getQsvDevice())
      .enableTonemapping(getEnableTonemapping())
      .enableVppTonemapping(getEnableVppTonemapping())
      .enableVideoToolboxTonemapping(getEnableVideoToolboxTonemapping())
      .tonemappingAlgorithm(getTonemappingAlgorithm())
      .tonemappingMode(getTonemappingMode())
      .tonemappingRange(getTonemappingRange())
      .tonemappingDesat(getTonemappingDesat())
      .tonemappingPeak(getTonemappingPeak())
      .tonemappingParam(getTonemappingParam())
      .vppTonemappingBrightness(getVppTonemappingBrightness())
      .vppTonemappingContrast(getVppTonemappingContrast())
      .h264Crf(getH264Crf())
      .h265Crf(getH265Crf())
      .encoderPreset(getEncoderPreset())
      .deinterlaceDoubleRate(getDeinterlaceDoubleRate())
      ...
      .enableHardwareEncoding(getEnableHardwareEncoding())
      .allowHevcEncoding(getAllowHevcEncoding())
      .allowAv1Encoding(getAllowAv1Encoding())
      .enableSubtitleExtraction(getEnableSubtitleExtraction())
      .hardwareDecodingCodecs(getHardwareDecodingCodecs())
      .allowOnDemandMetadataBasedKeyframeExtractionForExtensions(getAllowOnDemandMetadataBasedKeyframeExtractionForExtensions());
  }
