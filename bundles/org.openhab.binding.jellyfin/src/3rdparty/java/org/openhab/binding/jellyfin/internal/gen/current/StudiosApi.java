...
public class StudiosApi {
   ...
   */
  public BaseItemDto getStudio(@org.eclipse.jdt.annotation.NonNull
 ...
 UUID userId, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BaseItemDto> getStudioWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String name, @org.eclipse.jdt.annotation.Nullable
 UUID userId) throws ApiException {
 ...
 UUID userId, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder getStudioRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String name, @org.eclipse.jdt.annotation.Nullable
 UUID userId, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BaseItemDtoQueryResult getStudios(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableTotalRecordCount) throws ApiException {
    return getStudios(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, enableUserData, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount, null);
  }
 ...
 Boolean enableTotalRecordCount, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BaseItemDtoQueryResult> getStudiosWithHttpInfo(@org.eclipse.jdt.annotation.Nullable
 Integer startIndex, @org.eclipse.jdt.annotation.Nullable
 Integer limit, @org.eclipse.jdt.annotation.Nullable
 String searchTerm, @org.eclipse.jdt.annotation.Nullable
 UUID parentId, @org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableImages, @org.eclipse.jdt.annotation.Nullable
 Boolean enableTotalRecordCount) throws ApiException {
    return getStudiosWithHttpInfo(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, enableUserData, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount, null);
  }
 ...
 Boolean enableImages, @org.eclipse.jdt.annotation.Nullable
 Boolean enableTotalRecordCount, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getStudiosRequestBuilder(startIndex, limit, searchTerm, parentId, fields, excludeItemTypes, includeItemTypes, isFavorite, enableUserData, imageTypeLimit, enableImageTypes, userId, nameStartsWithOrGreater, nameStartsWith, nameLessThan, enableImages, enableTotalRecordCount, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getStudiosRequestBuilder(@org.eclipse.jdt.annotation.Nullable
 Integer startIndex, @org.eclipse.jdt.annotation.Nullable
 Integer limit, @org.eclipse.jdt.annotation.Nullable
 String searchTerm, @org.eclipse.jdt.annotation.Nullable
 UUID parentId, @org.eclipse.jdt.annotation.Nullable
