...
import org.openhab.binding.jellyfin.internal.gen.current.model.LibraryOptionInfoDto;
import org.openhab.binding.jellyfin.internal.gen.current.model.LibraryTypeOptionsDto;
...
public class LibraryOptionsResultDto {
  ...
  public LibraryOptionsResultDto metadataSavers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LibraryOptionInfoDto> metadataSavers) {
  ...
  public LibraryOptionsResultDto metadataReaders(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LibraryOptionInfoDto> metadataReaders) {
  ...
  public LibraryOptionsResultDto subtitleFetchers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LibraryOptionInfoDto> subtitleFetchers) {
  ...
  public LibraryOptionsResultDto lyricFetchers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LibraryOptionInfoDto> lyricFetchers) {
  ...
  public LibraryOptionsResultDto mediaSegmentProviders(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LibraryOptionInfoDto> mediaSegmentProviders) {
  ...
  public LibraryOptionsResultDto typeOptions(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LibraryTypeOptionsDto> typeOptions) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadataSavers, metadataReaders, subtitleFetchers, lyricFetchers, mediaSegmentProviders, typeOptions);
  }
    ...
    if (getMetadataSavers() != null) {
      for (int i = 0; i < getMetadataSavers().size(); i++) {
        if (getMetadataSavers().get(i) != null) {
          joiner.add(getMetadataSavers().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sMetadataSavers%s%s", prefix, suffix,
    ...
    if (getMetadataReaders() != null) {
      for (int i = 0; i < getMetadataReaders().size(); i++) {
        if (getMetadataReaders().get(i) != null) {
          joiner.add(getMetadataReaders().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sMetadataReaders%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getSubtitleFetchers() != null) {
      for (int i = 0; i < getSubtitleFetchers().size(); i++) {
        if (getSubtitleFetchers().get(i) != null) {
          joiner.add(getSubtitleFetchers().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sSubtitleFetchers%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getLyricFetchers() != null) {
      for (int i = 0; i < getLyricFetchers().size(); i++) {
        if (getLyricFetchers().get(i) != null) {
          joiner.add(getLyricFetchers().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sLyricFetchers%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getMediaSegmentProviders() != null) {
      for (int i = 0; i < getMediaSegmentProviders().size(); i++) {
        if (getMediaSegmentProviders().get(i) != null) {
          joiner.add(getMediaSegmentProviders().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sMediaSegmentProviders%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
  ...
  */
  public LibraryOptionsResultDto.Builder toBuilder() {
    return new LibraryOptionsResultDto.Builder()
      ...
      .mediaSegmentProviders(getMediaSegmentProviders())
