...
public class MovePlaylistItemRequestDto {
  ...
  public MovePlaylistItemRequestDto playlistItemId(@org.eclipse.jdt.annotation.Nullable
 UUID playlistItemId) {
 ...
 UUID playlistItemId) {
  ...
  public MovePlaylistItemRequestDto newIndex(@org.eclipse.jdt.annotation.Nullable
 Integer newIndex) {
 ...
 Integer newIndex) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNewIndex() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sNewIndex%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNewIndex()))));
    }
