 ...
 */
@JsonPropertyOrder({
  SeriesTimerCreatedMessage.JSON_PROPERTY_DATA,
  SeriesTimerCreatedMessage.JSON_PROPERTY_MESSAGE_ID,
...
public class SeriesTimerCreatedMessage {
  ...
  public SeriesTimerCreatedMessage data(@org.eclipse.jdt.annotation.Nullable
 TimerEventInfo data) {
    this.data = data;
    return this;
  }
 ...
 TimerEventInfo data) {
  ...
  public SeriesTimerCreatedMessage messageId(@org.eclipse.jdt.annotation.Nullable
 UUID messageId) {
