...
public class RefreshProgressMessage {
    ...
    public RefreshProgressMessage data(@org.eclipse.jdt.annotation.Nullable Map<String, String> data) {
        this.data = data;
        return this;
    }
    ...
    public RefreshProgressMessage messageId(@org.eclipse.jdt.annotation.Nullable UUID messageId) {
