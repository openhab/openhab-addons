...
import org.openhab.binding.jellyfin.internal.gen.current.model.NameIdPair;
import org.openhab.binding.jellyfin.internal.gen.current.model.NameValuePair;
import org.openhab.binding.jellyfin.internal.gen.current.model.TunerChannelMapping;
...
public class ChannelMappingOptionsDto {
  ...
  public ChannelMappingOptionsDto tunerChannels(@org.eclipse.jdt.annotation.Nullable
 ...
 List<TunerChannelMapping> tunerChannels) {
  ...
  public ChannelMappingOptionsDto providerChannels(@org.eclipse.jdt.annotation.Nullable
 ...
 List<NameIdPair> providerChannels) {
  ...
  public ChannelMappingOptionsDto mappings(@org.eclipse.jdt.annotation.Nullable
 ...
 List<NameValuePair> mappings) {
  ...
  public ChannelMappingOptionsDto providerName(@org.eclipse.jdt.annotation.Nullable
 String providerName) {
    ...
    if (getTunerChannels() != null) {
      for (int i = 0; i < getTunerChannels().size(); i++) {
        if (getTunerChannels().get(i) != null) {
          joiner.add(getTunerChannels().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sTunerChannels%s%s", prefix, suffix,
    ...
    if (getProviderChannels() != null) {
      for (int i = 0; i < getProviderChannels().size(); i++) {
        if (getProviderChannels().get(i) != null) {
          joiner.add(getProviderChannels().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sProviderChannels%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
