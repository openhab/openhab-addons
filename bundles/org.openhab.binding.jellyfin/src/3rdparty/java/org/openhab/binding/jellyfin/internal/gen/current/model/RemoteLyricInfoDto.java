...
public class RemoteLyricInfoDto {
  ...
  public RemoteLyricInfoDto id(@org.eclipse.jdt.annotation.Nullable
 String id) {
    this.id = id;
    return this;
  }
 ...
 String id) {
  ...
  public RemoteLyricInfoDto providerName(@org.eclipse.jdt.annotation.Nullable
 String providerName) {
 ...
 String providerName) {
  ...
  public RemoteLyricInfoDto lyrics(@org.eclipse.jdt.annotation.Nullable
 LyricDto lyrics) {
    this.lyrics = lyrics;
    return this;
  }
