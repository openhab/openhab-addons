...
import org.openhab.binding.jellyfin.internal.gen.current.model.EmbeddedSubtitleOptions;
import org.openhab.binding.jellyfin.internal.gen.current.model.MediaPathInfo;
import org.openhab.binding.jellyfin.internal.gen.current.model.TypeOptions;
...
public class LibraryOptions {
  ...
  public LibraryOptions enabled(@org.eclipse.jdt.annotation.Nullable
 Boolean enabled) {
 ...
 Boolean enabled) {
  ...
  public LibraryOptions enablePhotos(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enablePhotos) {
  ...
  public LibraryOptions enableRealtimeMonitor(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableRealtimeMonitor) {
  ...
  public LibraryOptions enableLUFSScan(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableLUFSScan) {
  ...
  public LibraryOptions enableChapterImageExtraction(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableChapterImageExtraction) {
  ...
  public LibraryOptions extractChapterImagesDuringLibraryScan(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean extractChapterImagesDuringLibraryScan) {
  ...
  public LibraryOptions enableTrickplayImageExtraction(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableTrickplayImageExtraction) {
  ...
  public LibraryOptions extractTrickplayImagesDuringLibraryScan(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean extractTrickplayImagesDuringLibraryScan) {
  ...
  public LibraryOptions pathInfos(@org.eclipse.jdt.annotation.Nullable
 ...
 List<MediaPathInfo> pathInfos) {
  ...
  public LibraryOptions saveLocalMetadata(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean saveLocalMetadata) {
  ...
  public LibraryOptions enableInternetProviders(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableInternetProviders) {
  ...
  public LibraryOptions enableAutomaticSeriesGrouping(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableAutomaticSeriesGrouping) {
  ...
  public LibraryOptions enableEmbeddedTitles(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableEmbeddedTitles) {
  ...
  public LibraryOptions enableEmbeddedExtrasTitles(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableEmbeddedExtrasTitles) {
  ...
  public LibraryOptions enableEmbeddedEpisodeInfos(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableEmbeddedEpisodeInfos) {
  ...
  public LibraryOptions automaticRefreshIntervalDays(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer automaticRefreshIntervalDays) {
  ...
  public LibraryOptions preferredMetadataLanguage(@org.eclipse.jdt.annotation.Nullable
 ...
 String preferredMetadataLanguage) {
  ...
  public LibraryOptions metadataCountryCode(@org.eclipse.jdt.annotation.Nullable
 ...
 String metadataCountryCode) {
  ...
  public LibraryOptions seasonZeroDisplayName(@org.eclipse.jdt.annotation.Nullable
 ...
 String seasonZeroDisplayName) {
  ...
  public LibraryOptions metadataSavers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> metadataSavers) {
  ...
  public LibraryOptions disabledLocalMetadataReaders(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> disabledLocalMetadataReaders) {
  ...
  public LibraryOptions localMetadataReaderOrder(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> localMetadataReaderOrder) {
  ...
  public LibraryOptions disabledSubtitleFetchers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> disabledSubtitleFetchers) {
  ...
  public LibraryOptions subtitleFetcherOrder(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> subtitleFetcherOrder) {
  ...
  public LibraryOptions disabledMediaSegmentProviders(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> disabledMediaSegmentProviders) {
  ...
  public LibraryOptions mediaSegmentProviderOrder(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> mediaSegmentProviderOrder) {
  ...
  public LibraryOptions skipSubtitlesIfEmbeddedSubtitlesPresent(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean skipSubtitlesIfEmbeddedSubtitlesPresent) {
  ...
  public LibraryOptions skipSubtitlesIfAudioTrackMatches(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean skipSubtitlesIfAudioTrackMatches) {
  ...
  public LibraryOptions subtitleDownloadLanguages(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> subtitleDownloadLanguages) {
  ...
  public LibraryOptions requirePerfectSubtitleMatch(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean requirePerfectSubtitleMatch) {
  ...
  public LibraryOptions saveSubtitlesWithMedia(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean saveSubtitlesWithMedia) {
  ...
  public LibraryOptions saveLyricsWithMedia(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean saveLyricsWithMedia) {
  ...
  public LibraryOptions saveTrickplayWithMedia(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean saveTrickplayWithMedia) {
  ...
  public LibraryOptions disabledLyricFetchers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> disabledLyricFetchers) {
  ...
  public LibraryOptions lyricFetcherOrder(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> lyricFetcherOrder) {
  ...
  public LibraryOptions preferNonstandardArtistsTag(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean preferNonstandardArtistsTag) {
  ...
  public LibraryOptions useCustomTagDelimiters(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean useCustomTagDelimiters) {
  ...
  public LibraryOptions customTagDelimiters(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> customTagDelimiters) {
  ...
  public LibraryOptions delimiterWhitelist(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> delimiterWhitelist) {
  ...
  public LibraryOptions automaticallyAddToCollection(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean automaticallyAddToCollection) {
  ...
  public LibraryOptions allowEmbeddedSubtitles(@org.eclipse.jdt.annotation.Nullable
 ...
 EmbeddedSubtitleOptions allowEmbeddedSubtitles) {
  ...
  public LibraryOptions typeOptions(@org.eclipse.jdt.annotation.Nullable
 ...
 List<TypeOptions> typeOptions) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enabled, enablePhotos, enableRealtimeMonitor, enableLUFSScan, enableChapterImageExtraction, extractChapterImagesDuringLibraryScan, enableTrickplayImageExtraction, extractTrickplayImagesDuringLibraryScan, pathInfos, saveLocalMetadata, enableInternetProviders, enableAutomaticSeriesGrouping, enableEmbeddedTitles, enableEmbeddedExtrasTitles, enableEmbeddedEpisodeInfos, automaticRefreshIntervalDays, preferredMetadataLanguage, metadataCountryCode, seasonZeroDisplayName, metadataSavers, disabledLocalMetadataReaders, localMetadataReaderOrder, disabledSubtitleFetchers, subtitleFetcherOrder, disabledMediaSegmentProviders, mediaSegmentProviderOrder, skipSubtitlesIfEmbeddedSubtitlesPresent, skipSubtitlesIfAudioTrackMatches, subtitleDownloadLanguages, requirePerfectSubtitleMatch, saveSubtitlesWithMedia, saveLyricsWithMedia, saveTrickplayWithMedia, disabledLyricFetchers, lyricFetcherOrder, preferNonstandardArtistsTag, useCustomTagDelimiters, customTagDelimiters, delimiterWhitelist, automaticallyAddToCollection, allowEmbeddedSubtitles, typeOptions);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEnablePhotos() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnablePhotos%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnablePhotos()))));
    }

    // add `EnableRealtimeMonitor` to the URL query string
    if (getEnableRealtimeMonitor() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableRealtimeMonitor%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableRealtimeMonitor()))));
    }

    // add `EnableLUFSScan` to the URL query string
    if (getEnableLUFSScan() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableLUFSScan%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableLUFSScan()))));
    }

    // add `EnableChapterImageExtraction` to the URL query string
    if (getEnableChapterImageExtraction() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableChapterImageExtraction%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableChapterImageExtraction()))));
    }

    // add `ExtractChapterImagesDuringLibraryScan` to the URL query string
    if (getExtractChapterImagesDuringLibraryScan() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sExtractChapterImagesDuringLibraryScan%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getExtractChapterImagesDuringLibraryScan()))));
    }

    // add `EnableTrickplayImageExtraction` to the URL query string
    if (getEnableTrickplayImageExtraction() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableTrickplayImageExtraction%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableTrickplayImageExtraction()))));
    }

    // add `ExtractTrickplayImagesDuringLibraryScan` to the URL query string
    if (getExtractTrickplayImagesDuringLibraryScan() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sExtractTrickplayImagesDuringLibraryScan%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getExtractTrickplayImagesDuringLibraryScan()))));
    }
    ...
    if (getPathInfos() != null) {
      for (int i = 0; i < getPathInfos().size(); i++) {
        if (getPathInfos().get(i) != null) {
          joiner.add(getPathInfos().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sPathInfos%s%s", prefix, suffix,
    ...
    if (getSaveLocalMetadata() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSaveLocalMetadata%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSaveLocalMetadata()))));
    }

    // add `EnableInternetProviders` to the URL query string
    if (getEnableInternetProviders() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableInternetProviders%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableInternetProviders()))));
    }

    // add `EnableAutomaticSeriesGrouping` to the URL query string
    if (getEnableAutomaticSeriesGrouping() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableAutomaticSeriesGrouping%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableAutomaticSeriesGrouping()))));
    }

    // add `EnableEmbeddedTitles` to the URL query string
    if (getEnableEmbeddedTitles() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableEmbeddedTitles%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableEmbeddedTitles()))));
    }

    // add `EnableEmbeddedExtrasTitles` to the URL query string
    if (getEnableEmbeddedExtrasTitles() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableEmbeddedExtrasTitles%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableEmbeddedExtrasTitles()))));
    }

    // add `EnableEmbeddedEpisodeInfos` to the URL query string
    if (getEnableEmbeddedEpisodeInfos() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableEmbeddedEpisodeInfos%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableEmbeddedEpisodeInfos()))));
    }

    // add `AutomaticRefreshIntervalDays` to the URL query string
    if (getAutomaticRefreshIntervalDays() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAutomaticRefreshIntervalDays%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAutomaticRefreshIntervalDays()))));
    }
    ...
    if (getSeasonZeroDisplayName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSeasonZeroDisplayName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSeasonZeroDisplayName()))));
    }
    ...
    if (getDisabledMediaSegmentProviders() != null) {
      for (int i = 0; i < getDisabledMediaSegmentProviders().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%sDisabledMediaSegmentProviders%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
    ...
    if (getSkipSubtitlesIfEmbeddedSubtitlesPresent() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSkipSubtitlesIfEmbeddedSubtitlesPresent%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSkipSubtitlesIfEmbeddedSubtitlesPresent()))));
    }

    // add `SkipSubtitlesIfAudioTrackMatches` to the URL query string
    if (getSkipSubtitlesIfAudioTrackMatches() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSkipSubtitlesIfAudioTrackMatches%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSkipSubtitlesIfAudioTrackMatches()))));
    }
    ...
    if (getRequirePerfectSubtitleMatch() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRequirePerfectSubtitleMatch%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRequirePerfectSubtitleMatch()))));
    }

    // add `SaveSubtitlesWithMedia` to the URL query string
    if (getSaveSubtitlesWithMedia() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSaveSubtitlesWithMedia%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSaveSubtitlesWithMedia()))));
    }

    // add `SaveLyricsWithMedia` to the URL query string
    if (getSaveLyricsWithMedia() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSaveLyricsWithMedia%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSaveLyricsWithMedia()))));
    }

    // add `SaveTrickplayWithMedia` to the URL query string
    if (getSaveTrickplayWithMedia() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSaveTrickplayWithMedia%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSaveTrickplayWithMedia()))));
    }
    ...
    if (getPreferNonstandardArtistsTag() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPreferNonstandardArtistsTag%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPreferNonstandardArtistsTag()))));
    }

    // add `UseCustomTagDelimiters` to the URL query string
    if (getUseCustomTagDelimiters() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sUseCustomTagDelimiters%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUseCustomTagDelimiters()))));
    }
    ...
    if (getAutomaticallyAddToCollection() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAutomaticallyAddToCollection%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAutomaticallyAddToCollection()))));
    }

    // add `AllowEmbeddedSubtitles` to the URL query string
    if (getAllowEmbeddedSubtitles() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAllowEmbeddedSubtitles%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAllowEmbeddedSubtitles()))));
    }
    ...
    if (getTypeOptions() != null) {
      for (int i = 0; i < getTypeOptions().size(); i++) {
        if (getTypeOptions().get(i) != null) {
          joiner.add(getTypeOptions().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sTypeOptions%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    public LibraryOptions.Builder extractChapterImagesDuringLibraryScan(Boolean extractChapterImagesDuringLibraryScan) {
    ...
    public LibraryOptions.Builder extractTrickplayImagesDuringLibraryScan(Boolean extractTrickplayImagesDuringLibraryScan) {
    ...
    public LibraryOptions.Builder skipSubtitlesIfEmbeddedSubtitlesPresent(Boolean skipSubtitlesIfEmbeddedSubtitlesPresent) {
  ...
  */
  public LibraryOptions.Builder toBuilder() {
    return new LibraryOptions.Builder()
      .enabled(getEnabled())
      .enablePhotos(getEnablePhotos())
      .enableRealtimeMonitor(getEnableRealtimeMonitor())
      .enableLUFSScan(getEnableLUFSScan())
      ...
      .pathInfos(getPathInfos())
      .saveLocalMetadata(getSaveLocalMetadata())
      ...
      .seasonZeroDisplayName(getSeasonZeroDisplayName())
      ...
      .disabledSubtitleFetchers(getDisabledSubtitleFetchers())
      .subtitleFetcherOrder(getSubtitleFetcherOrder())
      ...
      .saveLyricsWithMedia(getSaveLyricsWithMedia())
      .saveTrickplayWithMedia(getSaveTrickplayWithMedia())
      .disabledLyricFetchers(getDisabledLyricFetchers())
      .lyricFetcherOrder(getLyricFetcherOrder())
      .preferNonstandardArtistsTag(getPreferNonstandardArtistsTag())
      .useCustomTagDelimiters(getUseCustomTagDelimiters())
      .customTagDelimiters(getCustomTagDelimiters())
      .delimiterWhitelist(getDelimiterWhitelist())
      .automaticallyAddToCollection(getAutomaticallyAddToCollection())
      .allowEmbeddedSubtitles(getAllowEmbeddedSubtitles())
