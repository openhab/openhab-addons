...
public class SpecialViewOptionDto {
  ...
  public SpecialViewOptionDto name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public SpecialViewOptionDto id(@org.eclipse.jdt.annotation.Nullable
 String id) {
    this.id = id;
    return this;
  }
 ...
 String id) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, specialViewOptionDto.name) &&
        Objects.equals(this.id, specialViewOptionDto.id);
  }
