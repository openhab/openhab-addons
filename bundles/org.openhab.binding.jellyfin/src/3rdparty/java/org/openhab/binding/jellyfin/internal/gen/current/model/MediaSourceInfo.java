...
import org.openhab.binding.jellyfin.internal.gen.current.model.MediaAttachment;
import org.openhab.binding.jellyfin.internal.gen.current.model.MediaProtocol;
import org.openhab.binding.jellyfin.internal.gen.current.model.MediaSourceType;
...
import org.openhab.binding.jellyfin.internal.gen.current.model.TransportStreamTimestamp;
...
public class MediaSourceInfo {
  ...
  public MediaSourceInfo protocol(@org.eclipse.jdt.annotation.Nullable
 ...
 MediaProtocol protocol) {
  ...
  public MediaSourceInfo id(@org.eclipse.jdt.annotation.Nullable
 String id) {
    this.id = id;
    return this;
  }
 ...
 String id) {
  ...
  public MediaSourceInfo path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public MediaSourceInfo encoderPath(@org.eclipse.jdt.annotation.Nullable
 String encoderPath) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENCODER_PATH)
  public void setEncoderPath(@org.eclipse.jdt.annotation.Nullable
 String encoderPath) {
    this.encoderPath = encoderPath;
  }


  public MediaSourceInfo encoderProtocol(@org.eclipse.jdt.annotation.Nullable
 MediaProtocol encoderProtocol) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENCODER_PROTOCOL)
  public void setEncoderProtocol(@org.eclipse.jdt.annotation.Nullable
 MediaProtocol encoderProtocol) {
    this.encoderProtocol = encoderProtocol;
  }


  public MediaSourceInfo type(@org.eclipse.jdt.annotation.Nullable
 ...
 MediaSourceType type) {
  ...
  public MediaSourceInfo container(@org.eclipse.jdt.annotation.Nullable
 String container) {
 ...
 String container) {
  ...
  public MediaSourceInfo size(@org.eclipse.jdt.annotation.Nullable
 Long size) {
    this.size = size;
    return this;
  }
 ...
 Long size) {
  ...
  public MediaSourceInfo name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public MediaSourceInfo isRemote(@org.eclipse.jdt.annotation.Nullable
 Boolean isRemote) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_REMOTE)
  public void setIsRemote(@org.eclipse.jdt.annotation.Nullable
 Boolean isRemote) {
    this.isRemote = isRemote;
  }


  public MediaSourceInfo etag(@org.eclipse.jdt.annotation.Nullable
 String etag) {
    this.etag = etag;
    return this;
  }
 ...
 String etag) {
  ...
  public MediaSourceInfo runTimeTicks(@org.eclipse.jdt.annotation.Nullable
 Long runTimeTicks) {
 ...
 Long runTimeTicks) {
  ...
  public MediaSourceInfo readAtNativeFramerate(@org.eclipse.jdt.annotation.Nullable
 Boolean readAtNativeFramerate) {
  ...
  @JsonProperty(value = JSON_PROPERTY_READ_AT_NATIVE_FRAMERATE)
  public void setReadAtNativeFramerate(@org.eclipse.jdt.annotation.Nullable
 Boolean readAtNativeFramerate) {
    this.readAtNativeFramerate = readAtNativeFramerate;
  }


  public MediaSourceInfo ignoreDts(@org.eclipse.jdt.annotation.Nullable
 Boolean ignoreDts) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IGNORE_DTS)
  public void setIgnoreDts(@org.eclipse.jdt.annotation.Nullable
 Boolean ignoreDts) {
    this.ignoreDts = ignoreDts;
  }


  public MediaSourceInfo ignoreIndex(@org.eclipse.jdt.annotation.Nullable
 Boolean ignoreIndex) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IGNORE_INDEX)
  public void setIgnoreIndex(@org.eclipse.jdt.annotation.Nullable
 Boolean ignoreIndex) {
    this.ignoreIndex = ignoreIndex;
  }


  public MediaSourceInfo genPtsInput(@org.eclipse.jdt.annotation.Nullable
 Boolean genPtsInput) {
  ...
  @JsonProperty(value = JSON_PROPERTY_GEN_PTS_INPUT)
  public void setGenPtsInput(@org.eclipse.jdt.annotation.Nullable
 Boolean genPtsInput) {
    this.genPtsInput = genPtsInput;
  }


  public MediaSourceInfo supportsTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean supportsTranscoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SUPPORTS_TRANSCODING)
  public void setSupportsTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean supportsTranscoding) {
    this.supportsTranscoding = supportsTranscoding;
  }


  public MediaSourceInfo supportsDirectStream(@org.eclipse.jdt.annotation.Nullable
 Boolean supportsDirectStream) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SUPPORTS_DIRECT_STREAM)
  public void setSupportsDirectStream(@org.eclipse.jdt.annotation.Nullable
 Boolean supportsDirectStream) {
    this.supportsDirectStream = supportsDirectStream;
  }


  public MediaSourceInfo supportsDirectPlay(@org.eclipse.jdt.annotation.Nullable
 Boolean supportsDirectPlay) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SUPPORTS_DIRECT_PLAY)
  public void setSupportsDirectPlay(@org.eclipse.jdt.annotation.Nullable
 Boolean supportsDirectPlay) {
    this.supportsDirectPlay = supportsDirectPlay;
  }


  public MediaSourceInfo isInfiniteStream(@org.eclipse.jdt.annotation.Nullable
 Boolean isInfiniteStream) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_INFINITE_STREAM)
  public void setIsInfiniteStream(@org.eclipse.jdt.annotation.Nullable
 Boolean isInfiniteStream) {
    this.isInfiniteStream = isInfiniteStream;
  }


  public MediaSourceInfo useMostCompatibleTranscodingProfile(@org.eclipse.jdt.annotation.Nullable
 Boolean useMostCompatibleTranscodingProfile) {
  ...
  @JsonProperty(value = JSON_PROPERTY_USE_MOST_COMPATIBLE_TRANSCODING_PROFILE)
  public void setUseMostCompatibleTranscodingProfile(@org.eclipse.jdt.annotation.Nullable
 Boolean useMostCompatibleTranscodingProfile) {
    this.useMostCompatibleTranscodingProfile = useMostCompatibleTranscodingProfile;
  }


  public MediaSourceInfo requiresOpening(@org.eclipse.jdt.annotation.Nullable
 Boolean requiresOpening) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REQUIRES_OPENING)
  public void setRequiresOpening(@org.eclipse.jdt.annotation.Nullable
 Boolean requiresOpening) {
    this.requiresOpening = requiresOpening;
  }


  public MediaSourceInfo openToken(@org.eclipse.jdt.annotation.Nullable
 String openToken) {
 ...
 String openToken) {
  ...
  public MediaSourceInfo requiresClosing(@org.eclipse.jdt.annotation.Nullable
 Boolean requiresClosing) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REQUIRES_CLOSING)
  public void setRequiresClosing(@org.eclipse.jdt.annotation.Nullable
 Boolean requiresClosing) {
    this.requiresClosing = requiresClosing;
  }


  public MediaSourceInfo liveStreamId(@org.eclipse.jdt.annotation.Nullable
 String liveStreamId) {
 ...
 String liveStreamId) {
  ...
  public MediaSourceInfo bufferMs(@org.eclipse.jdt.annotation.Nullable
 Integer bufferMs) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BUFFER_MS)
  public void setBufferMs(@org.eclipse.jdt.annotation.Nullable
 Integer bufferMs) {
    this.bufferMs = bufferMs;
  }


  public MediaSourceInfo requiresLooping(@org.eclipse.jdt.annotation.Nullable
 Boolean requiresLooping) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REQUIRES_LOOPING)
  public void setRequiresLooping(@org.eclipse.jdt.annotation.Nullable
 Boolean requiresLooping) {
    this.requiresLooping = requiresLooping;
  }


  public MediaSourceInfo supportsProbing(@org.eclipse.jdt.annotation.Nullable
 Boolean supportsProbing) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SUPPORTS_PROBING)
  public void setSupportsProbing(@org.eclipse.jdt.annotation.Nullable
 Boolean supportsProbing) {
    this.supportsProbing = supportsProbing;
  }


  public MediaSourceInfo videoType(@org.eclipse.jdt.annotation.Nullable
 VideoType videoType) {
 ...
 VideoType videoType) {
  ...
  public MediaSourceInfo isoType(@org.eclipse.jdt.annotation.Nullable
 IsoType isoType) {
 ...
 IsoType isoType) {
  ...
  public MediaSourceInfo video3DFormat(@org.eclipse.jdt.annotation.Nullable
 ...
 Video3DFormat video3DFormat) {
  ...
  public MediaSourceInfo mediaStreams(@org.eclipse.jdt.annotation.Nullable
 ...
 List<MediaStream> mediaStreams) {
  ...
  public MediaSourceInfo mediaAttachments(@org.eclipse.jdt.annotation.Nullable
 List<MediaAttachment> mediaAttachments) {
  ...
  @JsonProperty(value = JSON_PROPERTY_MEDIA_ATTACHMENTS)
  public void setMediaAttachments(@org.eclipse.jdt.annotation.Nullable
 List<MediaAttachment> mediaAttachments) {
    this.mediaAttachments = mediaAttachments;
  }


  public MediaSourceInfo formats(@org.eclipse.jdt.annotation.Nullable
 List<String> formats) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FORMATS)
  public void setFormats(@org.eclipse.jdt.annotation.Nullable
 List<String> formats) {
    this.formats = formats;
  }


  public MediaSourceInfo bitrate(@org.eclipse.jdt.annotation.Nullable
 Integer bitrate) {
 ...
 Integer bitrate) {
  ...
  public MediaSourceInfo fallbackMaxStreamingBitrate(@org.eclipse.jdt.annotation.Nullable
 Integer fallbackMaxStreamingBitrate) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FALLBACK_MAX_STREAMING_BITRATE)
  public void setFallbackMaxStreamingBitrate(@org.eclipse.jdt.annotation.Nullable
 Integer fallbackMaxStreamingBitrate) {
    this.fallbackMaxStreamingBitrate = fallbackMaxStreamingBitrate;
  }


  public MediaSourceInfo timestamp(@org.eclipse.jdt.annotation.Nullable
 ...
 TransportStreamTimestamp timestamp) {
  ...
  public MediaSourceInfo requiredHttpHeaders(@org.eclipse.jdt.annotation.Nullable
 Map<String, String> requiredHttpHeaders) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REQUIRED_HTTP_HEADERS)
  @JsonInclude(content = JsonInclude.Include.ALWAYS, value = JsonInclude.Include.USE_DEFAULTS)
  public void setRequiredHttpHeaders(@org.eclipse.jdt.annotation.Nullable
 Map<String, String> requiredHttpHeaders) {
    this.requiredHttpHeaders = requiredHttpHeaders;
  }


  public MediaSourceInfo transcodingUrl(@org.eclipse.jdt.annotation.Nullable
 String transcodingUrl) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TRANSCODING_URL)
  public void setTranscodingUrl(@org.eclipse.jdt.annotation.Nullable
 String transcodingUrl) {
    this.transcodingUrl = transcodingUrl;
  }


  public MediaSourceInfo transcodingSubProtocol(@org.eclipse.jdt.annotation.Nullable
 MediaStreamProtocol transcodingSubProtocol) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TRANSCODING_SUB_PROTOCOL)
  public void setTranscodingSubProtocol(@org.eclipse.jdt.annotation.Nullable
 MediaStreamProtocol transcodingSubProtocol) {
    this.transcodingSubProtocol = transcodingSubProtocol;
  }


  public MediaSourceInfo transcodingContainer(@org.eclipse.jdt.annotation.Nullable
 String transcodingContainer) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TRANSCODING_CONTAINER)
  public void setTranscodingContainer(@org.eclipse.jdt.annotation.Nullable
 String transcodingContainer) {
    this.transcodingContainer = transcodingContainer;
  }


  public MediaSourceInfo analyzeDurationMs(@org.eclipse.jdt.annotation.Nullable
 Integer analyzeDurationMs) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ANALYZE_DURATION_MS)
  public void setAnalyzeDurationMs(@org.eclipse.jdt.annotation.Nullable
 Integer analyzeDurationMs) {
    this.analyzeDurationMs = analyzeDurationMs;
  }


  public MediaSourceInfo defaultAudioStreamIndex(@org.eclipse.jdt.annotation.Nullable
 Integer defaultAudioStreamIndex) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DEFAULT_AUDIO_STREAM_INDEX)
  public void setDefaultAudioStreamIndex(@org.eclipse.jdt.annotation.Nullable
 Integer defaultAudioStreamIndex) {
    this.defaultAudioStreamIndex = defaultAudioStreamIndex;
  }


  public MediaSourceInfo defaultSubtitleStreamIndex(@org.eclipse.jdt.annotation.Nullable
 Integer defaultSubtitleStreamIndex) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DEFAULT_SUBTITLE_STREAM_INDEX)
  public void setDefaultSubtitleStreamIndex(@org.eclipse.jdt.annotation.Nullable
 Integer defaultSubtitleStreamIndex) {
    this.defaultSubtitleStreamIndex = defaultSubtitleStreamIndex;
  }


  public MediaSourceInfo hasSegments(@org.eclipse.jdt.annotation.Nullable
 Boolean hasSegments) {
  ...
  @JsonProperty(value = JSON_PROPERTY_HAS_SEGMENTS)
  public void setHasSegments(@org.eclipse.jdt.annotation.Nullable
 Boolean hasSegments) {
    this.hasSegments = hasSegments;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEncoderPath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEncoderPath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEncoderPath()))));
    }

    // add `EncoderProtocol` to the URL query string
    if (getEncoderProtocol() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEncoderProtocol%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEncoderProtocol()))));
    }
    ...
    if (getIsRemote() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsRemote%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsRemote()))));
    }
    ...
    if (getReadAtNativeFramerate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sReadAtNativeFramerate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getReadAtNativeFramerate()))));
    }

    // add `IgnoreDts` to the URL query string
    if (getIgnoreDts() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIgnoreDts%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIgnoreDts()))));
    }

    // add `IgnoreIndex` to the URL query string
    if (getIgnoreIndex() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIgnoreIndex%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIgnoreIndex()))));
    }

    // add `GenPtsInput` to the URL query string
    if (getGenPtsInput() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sGenPtsInput%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getGenPtsInput()))));
    }

    // add `SupportsTranscoding` to the URL query string
    if (getSupportsTranscoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSupportsTranscoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSupportsTranscoding()))));
    }

    // add `SupportsDirectStream` to the URL query string
    if (getSupportsDirectStream() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSupportsDirectStream%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSupportsDirectStream()))));
    }

    // add `SupportsDirectPlay` to the URL query string
    if (getSupportsDirectPlay() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSupportsDirectPlay%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSupportsDirectPlay()))));
    }

    // add `IsInfiniteStream` to the URL query string
    if (getIsInfiniteStream() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsInfiniteStream%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsInfiniteStream()))));
    }

    // add `UseMostCompatibleTranscodingProfile` to the URL query string
    if (getUseMostCompatibleTranscodingProfile() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sUseMostCompatibleTranscodingProfile%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUseMostCompatibleTranscodingProfile()))));
    }

    // add `RequiresOpening` to the URL query string
    if (getRequiresOpening() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRequiresOpening%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRequiresOpening()))));
    }

    // add `OpenToken` to the URL query string
    if (getOpenToken() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sOpenToken%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getOpenToken()))));
    }

    // add `RequiresClosing` to the URL query string
    if (getRequiresClosing() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRequiresClosing%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRequiresClosing()))));
    }
    ...
    if (getBufferMs() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBufferMs%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBufferMs()))));
    }

    // add `RequiresLooping` to the URL query string
    if (getRequiresLooping() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRequiresLooping%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRequiresLooping()))));
    }

    // add `SupportsProbing` to the URL query string
    if (getSupportsProbing() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSupportsProbing%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSupportsProbing()))));
    }
    ...
    if (getMediaAttachments() != null) {
      for (int i = 0; i < getMediaAttachments().size(); i++) {
        if (getMediaAttachments().get(i) != null) {
          joiner.add(getMediaAttachments().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sMediaAttachments%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getFallbackMaxStreamingBitrate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sFallbackMaxStreamingBitrate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getFallbackMaxStreamingBitrate()))));
    }
    ...
    if (getTranscodingUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTranscodingUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTranscodingUrl()))));
    }

    // add `TranscodingSubProtocol` to the URL query string
    if (getTranscodingSubProtocol() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTranscodingSubProtocol%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTranscodingSubProtocol()))));
    }

    // add `TranscodingContainer` to the URL query string
    if (getTranscodingContainer() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTranscodingContainer%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTranscodingContainer()))));
    }

    // add `AnalyzeDurationMs` to the URL query string
    if (getAnalyzeDurationMs() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAnalyzeDurationMs%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAnalyzeDurationMs()))));
    }

    // add `DefaultAudioStreamIndex` to the URL query string
    if (getDefaultAudioStreamIndex() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDefaultAudioStreamIndex%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDefaultAudioStreamIndex()))));
    }

    // add `DefaultSubtitleStreamIndex` to the URL query string
    if (getDefaultSubtitleStreamIndex() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDefaultSubtitleStreamIndex%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDefaultSubtitleStreamIndex()))));
    }

    // add `HasSegments` to the URL query string
    if (getHasSegments() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sHasSegments%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getHasSegments()))));
    }
