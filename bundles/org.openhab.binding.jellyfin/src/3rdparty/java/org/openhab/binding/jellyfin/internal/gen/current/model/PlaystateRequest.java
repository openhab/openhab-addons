...
public class PlaystateRequest {
  ...
  public PlaystateRequest command(@org.eclipse.jdt.annotation.Nullable
 ...
 PlaystateCommand command) {
  ...
  public PlaystateRequest seekPositionTicks(@org.eclipse.jdt.annotation.Nullable
 ...
 Long seekPositionTicks) {
  ...
  public PlaystateRequest controllingUserId(@org.eclipse.jdt.annotation.Nullable
 ...
 String controllingUserId) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSeekPositionTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSeekPositionTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSeekPositionTicks()))));
    }
