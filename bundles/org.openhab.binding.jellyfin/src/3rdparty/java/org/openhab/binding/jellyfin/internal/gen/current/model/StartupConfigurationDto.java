 ...
 */
@JsonPropertyOrder({
  StartupConfigurationDto.JSON_PROPERTY_SERVER_NAME,
...
public class StartupConfigurationDto {
  ...
  public StartupConfigurationDto serverName(@org.eclipse.jdt.annotation.Nullable
 String serverName) {
 ...
 String serverName) {
  ...
  public StartupConfigurationDto uiCulture(@org.eclipse.jdt.annotation.Nullable
 String uiCulture) {
 ...
 String uiCulture) {
  ...
  public StartupConfigurationDto metadataCountryCode(@org.eclipse.jdt.annotation.Nullable
 ...
 String metadataCountryCode) {
  ...
  public StartupConfigurationDto preferredMetadataLanguage(@org.eclipse.jdt.annotation.Nullable
