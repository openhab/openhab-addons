...
public class BufferRequestDto {
  ...
  public BufferRequestDto when(@org.eclipse.jdt.annotation.Nullable
 OffsetDateTime when) {
    this.when = when;
    return this;
  }
 ...
 OffsetDateTime when) {
  ...
  public BufferRequestDto positionTicks(@org.eclipse.jdt.annotation.Nullable
 Long positionTicks) {
 ...
 Long positionTicks) {
  ...
  public BufferRequestDto isPlaying(@org.eclipse.jdt.annotation.Nullable
 Boolean isPlaying) {
 ...
 Boolean isPlaying) {
  ...
  public BufferRequestDto playlistItemId(@org.eclipse.jdt.annotation.Nullable
 UUID playlistItemId) {
