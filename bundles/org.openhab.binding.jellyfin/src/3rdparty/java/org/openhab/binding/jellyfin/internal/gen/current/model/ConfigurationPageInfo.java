...
public class ConfigurationPageInfo {
  ...
  public ConfigurationPageInfo name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public ConfigurationPageInfo enableInMainMenu(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableInMainMenu) {
  ...
  public ConfigurationPageInfo menuSection(@org.eclipse.jdt.annotation.Nullable
 String menuSection) {
 ...
 String menuSection) {
  ...
  public ConfigurationPageInfo menuIcon(@org.eclipse.jdt.annotation.Nullable
 String menuIcon) {
 ...
 String menuIcon) {
  ...
  public ConfigurationPageInfo displayName(@org.eclipse.jdt.annotation.Nullable
 String displayName) {
 ...
 String displayName) {
  ...
  public ConfigurationPageInfo pluginId(@org.eclipse.jdt.annotation.Nullable
 UUID pluginId) {
 ...
 UUID pluginId) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEnableInMainMenu() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableInMainMenu%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableInMainMenu()))));
    }

    // add `MenuSection` to the URL query string
    if (getMenuSection() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMenuSection%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMenuSection()))));
    }

    // add `MenuIcon` to the URL query string
    if (getMenuIcon() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMenuIcon%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMenuIcon()))));
    }
