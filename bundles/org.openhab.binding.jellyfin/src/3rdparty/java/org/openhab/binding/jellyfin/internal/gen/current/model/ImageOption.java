...
public class ImageOption {
  ...
  public ImageOption type(@org.eclipse.jdt.annotation.Nullable
 ImageType type) {
    this.type = type;
    return this;
  }
 ...
 ImageType type) {
  ...
  public ImageOption limit(@org.eclipse.jdt.annotation.Nullable
 Integer limit) {
    this.limit = limit;
    return this;
  }
 ...
 Integer limit) {
  ...
  public ImageOption minWidth(@org.eclipse.jdt.annotation.Nullable
 Integer minWidth) {
 ...
 Integer minWidth) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMinWidth() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMinWidth%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMinWidth()))));
    }
