...
import org.openhab.binding.jellyfin.internal.gen.current.model.TranscodeSeekInfo;
...
public class TranscodingProfile {
  ...
  public TranscodingProfile container(@org.eclipse.jdt.annotation.Nullable
 String container) {
 ...
 String container) {
  ...
  public TranscodingProfile type(@org.eclipse.jdt.annotation.Nullable
 ...
 DlnaProfileType type) {
  ...
  public TranscodingProfile videoCodec(@org.eclipse.jdt.annotation.Nullable
 String videoCodec) {
 ...
 String videoCodec) {
  ...
  public TranscodingProfile audioCodec(@org.eclipse.jdt.annotation.Nullable
 String audioCodec) {
 ...
 String audioCodec) {
  ...
  public TranscodingProfile protocol(@org.eclipse.jdt.annotation.Nullable
 ...
 MediaStreamProtocol protocol) {
  ...
  public TranscodingProfile estimateContentLength(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean estimateContentLength) {
  ...
  public TranscodingProfile enableMpegtsM2TsMode(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableMpegtsM2TsMode) {
  ...
  public TranscodingProfile transcodeSeekInfo(@org.eclipse.jdt.annotation.Nullable
 ...
 TranscodeSeekInfo transcodeSeekInfo) {
  ...
  public TranscodingProfile copyTimestamps(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean copyTimestamps) {
  ...
  public TranscodingProfile context(@org.eclipse.jdt.annotation.Nullable
 ...
 EncodingContext context) {
  ...
  public TranscodingProfile enableSubtitlesInManifest(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableSubtitlesInManifest) {
  ...
  public TranscodingProfile maxAudioChannels(@org.eclipse.jdt.annotation.Nullable
 ...
 String maxAudioChannels) {
  ...
  public TranscodingProfile minSegments(@org.eclipse.jdt.annotation.Nullable
 Integer minSegments) {
 ...
 Integer minSegments) {
  ...
  public TranscodingProfile segmentLength(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer segmentLength) {
  ...
  public TranscodingProfile breakOnNonKeyFrames(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean breakOnNonKeyFrames) {
  ...
  public TranscodingProfile conditions(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ProfileCondition> conditions) {
  ...
  public TranscodingProfile enableAudioVbrEncoding(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableAudioVbrEncoding) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEstimateContentLength() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEstimateContentLength%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEstimateContentLength()))));
    }

    // add `EnableMpegtsM2TsMode` to the URL query string
    if (getEnableMpegtsM2TsMode() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableMpegtsM2TsMode%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableMpegtsM2TsMode()))));
    }

    // add `TranscodeSeekInfo` to the URL query string
    if (getTranscodeSeekInfo() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTranscodeSeekInfo%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTranscodeSeekInfo()))));
    }

    // add `CopyTimestamps` to the URL query string
    if (getCopyTimestamps() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCopyTimestamps%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCopyTimestamps()))));
    }
    ...
    if (getEnableSubtitlesInManifest() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableSubtitlesInManifest%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableSubtitlesInManifest()))));
    }
    ...
    if (getMinSegments() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMinSegments%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMinSegments()))));
    }

    // add `SegmentLength` to the URL query string
    if (getSegmentLength() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSegmentLength%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSegmentLength()))));
    }

    // add `BreakOnNonKeyFrames` to the URL query string
    if (getBreakOnNonKeyFrames() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBreakOnNonKeyFrames%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBreakOnNonKeyFrames()))));
    }
    ...
    if (getEnableAudioVbrEncoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableAudioVbrEncoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableAudioVbrEncoding()))));
    }
  ...
  */
  public TranscodingProfile.Builder toBuilder() {
    return new TranscodingProfile.Builder()
      ...
      .estimateContentLength(getEstimateContentLength())
      .enableMpegtsM2TsMode(getEnableMpegtsM2TsMode())
      .transcodeSeekInfo(getTranscodeSeekInfo())
      .copyTimestamps(getCopyTimestamps())
      .context(getContext())
      .enableSubtitlesInManifest(getEnableSubtitlesInManifest())
      .maxAudioChannels(getMaxAudioChannels())
      .minSegments(getMinSegments())
      .segmentLength(getSegmentLength())
      .breakOnNonKeyFrames(getBreakOnNonKeyFrames())
