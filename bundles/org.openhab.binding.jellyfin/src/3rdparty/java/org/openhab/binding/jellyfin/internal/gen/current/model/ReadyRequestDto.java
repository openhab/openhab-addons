...
public class ReadyRequestDto {
  ...
  public ReadyRequestDto when(@org.eclipse.jdt.annotation.Nullable
 OffsetDateTime when) {
    this.when = when;
    return this;
  }
 ...
 OffsetDateTime when) {
  ...
  public ReadyRequestDto positionTicks(@org.eclipse.jdt.annotation.Nullable
 Long positionTicks) {
 ...
 Long positionTicks) {
  ...
  public ReadyRequestDto isPlaying(@org.eclipse.jdt.annotation.Nullable
 Boolean isPlaying) {
 ...
 Boolean isPlaying) {
  ...
  public ReadyRequestDto playlistItemId(@org.eclipse.jdt.annotation.Nullable
 UUID playlistItemId) {
