 ...
 */
@JsonPropertyOrder({
  BrandingOptionsDto.JSON_PROPERTY_LOGIN_DISCLAIMER,
  BrandingOptionsDto.JSON_PROPERTY_CUSTOM_CSS,
...
public class BrandingOptionsDto {
  ...
  public BrandingOptionsDto loginDisclaimer(@org.eclipse.jdt.annotation.Nullable
 ...
 String loginDisclaimer) {
  ...
  public BrandingOptionsDto customCss(@org.eclipse.jdt.annotation.Nullable
 String customCss) {
 ...
 String customCss) {
  ...
  public BrandingOptionsDto splashscreenEnabled(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean splashscreenEnabled) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLoginDisclaimer() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLoginDisclaimer%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLoginDisclaimer()))));
    }
    ...
    if (getSplashscreenEnabled() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSplashscreenEnabled%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSplashscreenEnabled()))));
    }
