...
import org.openhab.binding.jellyfin.internal.gen.current.model.CustomDatabaseOptions;
import org.openhab.binding.jellyfin.internal.gen.current.model.DatabaseLockingBehaviorTypes;
 ...
 */
@JsonPropertyOrder({
  DatabaseConfigurationOptions.JSON_PROPERTY_DATABASE_TYPE,
...
public class DatabaseConfigurationOptions {
  ...
  public DatabaseConfigurationOptions databaseType(@org.eclipse.jdt.annotation.Nullable
 String databaseType) {
 ...
 String databaseType) {
  ...
  public DatabaseConfigurationOptions customProviderOptions(@org.eclipse.jdt.annotation.Nullable
 ...
 CustomDatabaseOptions customProviderOptions) {
  ...
  public DatabaseConfigurationOptions lockingBehavior(@org.eclipse.jdt.annotation.Nullable
 ...
 DatabaseLockingBehaviorTypes lockingBehavior) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDatabaseType() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDatabaseType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDatabaseType()))));
    }
    ...
    if (getLockingBehavior() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLockingBehavior%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLockingBehavior()))));
    }
  ...
  */
  public DatabaseConfigurationOptions.Builder toBuilder() {
    return new DatabaseConfigurationOptions.Builder()
      ...
      .lockingBehavior(getLockingBehavior());
  }
