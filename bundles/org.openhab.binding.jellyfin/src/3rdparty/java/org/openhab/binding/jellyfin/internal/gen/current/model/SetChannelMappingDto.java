...
public class SetChannelMappingDto {
  ...
  public SetChannelMappingDto providerId(@org.eclipse.jdt.annotation.NonNull
 String providerId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_ID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderId(@org.eclipse.jdt.annotation.NonNull
 String providerId) {
    this.providerId = providerId;
  }


  public SetChannelMappingDto tunerChannelId(@org.eclipse.jdt.annotation.NonNull
 String tunerChannelId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TUNER_CHANNEL_ID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTunerChannelId(@org.eclipse.jdt.annotation.NonNull
 String tunerChannelId) {
    this.tunerChannelId = tunerChannelId;
  }


  public SetChannelMappingDto providerChannelId(@org.eclipse.jdt.annotation.NonNull
 String providerChannelId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PROVIDER_CHANNEL_ID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setProviderChannelId(@org.eclipse.jdt.annotation.NonNull
 String providerChannelId) {
    this.providerChannelId = providerChannelId;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTunerChannelId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTunerChannelId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTunerChannelId()))));
    }

    // add `ProviderChannelId` to the URL query string
    if (getProviderChannelId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sProviderChannelId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getProviderChannelId()))));
    }
