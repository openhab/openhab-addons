...
import org.openhab.binding.jellyfin.internal.gen.current.model.LocalizationOption;
...
public class LocalizationApi {
  ...
  public ApiResponse<List<CountryInfo>> getCountriesWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        List<CountryInfo> responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<CountryInfo>>() {});
  ...
  public ApiResponse<List<CultureDto>> getCulturesWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        List<CultureDto> responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<CultureDto>>() {});
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<LocalizationOption>> getLocalizationOptionsWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        List<LocalizationOption> responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<LocalizationOption>>() {});
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<ParentalRating>> getParentalRatingsWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        List<ParentalRating> responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<ParentalRating>>() {});
