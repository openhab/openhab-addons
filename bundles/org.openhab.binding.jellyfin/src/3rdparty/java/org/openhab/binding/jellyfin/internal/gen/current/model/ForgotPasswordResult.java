...
import org.openhab.binding.jellyfin.internal.gen.current.model.ForgotPasswordAction;
...
public class ForgotPasswordResult {
  ...
  public ForgotPasswordResult action(@org.eclipse.jdt.annotation.Nullable
 ...
 ForgotPasswordAction action) {
  ...
  public ForgotPasswordResult pinFile(@org.eclipse.jdt.annotation.Nullable
 String pinFile) {
 ...
 String pinFile) {
  ...
  public ForgotPasswordResult pinExpirationDate(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime pinExpirationDate) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPinFile() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPinFile%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPinFile()))));
    }

    // add `PinExpirationDate` to the URL query string
    if (getPinExpirationDate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPinExpirationDate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPinExpirationDate()))));
    }
