...
public class StartupRemoteAccessDto {
  ...
  public StartupRemoteAccessDto enableRemoteAccess(@org.eclipse.jdt.annotation.NonNull
 Boolean enableRemoteAccess) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_REMOTE_ACCESS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEnableRemoteAccess(@org.eclipse.jdt.annotation.NonNull
 Boolean enableRemoteAccess) {
    this.enableRemoteAccess = enableRemoteAccess;
  }


  public StartupRemoteAccessDto enableAutomaticPortMapping(@org.eclipse.jdt.annotation.NonNull
 Boolean enableAutomaticPortMapping) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_AUTOMATIC_PORT_MAPPING, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEnableAutomaticPortMapping(@org.eclipse.jdt.annotation.NonNull
 Boolean enableAutomaticPortMapping) {
    this.enableAutomaticPortMapping = enableAutomaticPortMapping;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEnableAutomaticPortMapping() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableAutomaticPortMapping%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableAutomaticPortMapping()))));
    }
