...
public class MetadataConfiguration {
  ...
  public MetadataConfiguration useFileCreationTimeForDateAdded(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean useFileCreationTimeForDateAdded) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getUseFileCreationTimeForDateAdded() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sUseFileCreationTimeForDateAdded%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUseFileCreationTimeForDateAdded()))));
    }
