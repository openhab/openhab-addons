...
public class ValidatePathDto {
  ...
  public ValidatePathDto validateWritable(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean validateWritable) {
  ...
  public ValidatePathDto path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public ValidatePathDto isFile(@org.eclipse.jdt.annotation.Nullable
 Boolean isFile) {
    this.isFile = isFile;
    return this;
  }
 ...
 Boolean isFile) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getValidateWritable() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sValidateWritable%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getValidateWritable()))));
    }
    ...
    if (getIsFile() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsFile%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsFile()))));
    }
