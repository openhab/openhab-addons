 ...
 */
@JsonPropertyOrder({
  ParentalRatingScore.JSON_PROPERTY_SCORE,
  ParentalRatingScore.JSON_PROPERTY_SUB_SCORE
})
...
public class ParentalRatingScore {
  ...
  public ParentalRatingScore score(@org.eclipse.jdt.annotation.Nullable
 Integer score) {
    this.score = score;
    return this;
  }
 ...
 Integer score) {
  ...
  public ParentalRatingScore subScore(@org.eclipse.jdt.annotation.Nullable
 Integer subScore) {
 ...
 Integer subScore) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSubScore() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%ssubScore%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSubScore()))));
    }
