...
import org.openhab.binding.jellyfin.internal.gen.current.model.ProcessPriorityClass;
import org.openhab.binding.jellyfin.internal.gen.current.model.TrickplayScanBehavior;
...
public class TrickplayOptions {
  ...
  public TrickplayOptions enableHwAcceleration(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableHwAcceleration) {
  ...
  public TrickplayOptions enableHwEncoding(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableHwEncoding) {
  ...
  public TrickplayOptions enableKeyFrameOnlyExtraction(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableKeyFrameOnlyExtraction) {
  ...
  public TrickplayOptions scanBehavior(@org.eclipse.jdt.annotation.Nullable
 ...
 TrickplayScanBehavior scanBehavior) {
  ...
  public TrickplayOptions processPriority(@org.eclipse.jdt.annotation.Nullable
 ...
 ProcessPriorityClass processPriority) {
  ...
  public TrickplayOptions interval(@org.eclipse.jdt.annotation.Nullable
 Integer interval) {
 ...
 Integer interval) {
  ...
  public TrickplayOptions widthResolutions(@org.eclipse.jdt.annotation.Nullable
 ...
 List<Integer> widthResolutions) {
  ...
  public TrickplayOptions tileWidth(@org.eclipse.jdt.annotation.Nullable
 Integer tileWidth) {
 ...
 Integer tileWidth) {
  ...
  public TrickplayOptions tileHeight(@org.eclipse.jdt.annotation.Nullable
 Integer tileHeight) {
 ...
 Integer tileHeight) {
  ...
  public TrickplayOptions qscale(@org.eclipse.jdt.annotation.Nullable
 Integer qscale) {
    this.qscale = qscale;
    return this;
  }
 ...
 Integer qscale) {
  ...
  public TrickplayOptions jpegQuality(@org.eclipse.jdt.annotation.Nullable
 Integer jpegQuality) {
 ...
 Integer jpegQuality) {
  ...
  public TrickplayOptions processThreads(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer processThreads) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEnableHwAcceleration() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableHwAcceleration%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableHwAcceleration()))));
    }

    // add `EnableHwEncoding` to the URL query string
    if (getEnableHwEncoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableHwEncoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableHwEncoding()))));
    }

    // add `EnableKeyFrameOnlyExtraction` to the URL query string
    if (getEnableKeyFrameOnlyExtraction() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableKeyFrameOnlyExtraction%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableKeyFrameOnlyExtraction()))));
    }

    // add `ScanBehavior` to the URL query string
    if (getScanBehavior() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sScanBehavior%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getScanBehavior()))));
    }

    // add `ProcessPriority` to the URL query string
    if (getProcessPriority() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sProcessPriority%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getProcessPriority()))));
    }
    ...
    if (getTileWidth() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTileWidth%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTileWidth()))));
    }

    // add `TileHeight` to the URL query string
    if (getTileHeight() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTileHeight%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTileHeight()))));
    }

    // add `Qscale` to the URL query string
    if (getQscale() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sQscale%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getQscale()))));
    }

    // add `JpegQuality` to the URL query string
    if (getJpegQuality() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sJpegQuality%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getJpegQuality()))));
    }

    // add `ProcessThreads` to the URL query string
    if (getProcessThreads() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sProcessThreads%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getProcessThreads()))));
    }
