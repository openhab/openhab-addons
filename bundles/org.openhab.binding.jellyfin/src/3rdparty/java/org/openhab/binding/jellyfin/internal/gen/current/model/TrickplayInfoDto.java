 ...
 */
@JsonPropertyOrder({
  TrickplayInfoDto.JSON_PROPERTY_WIDTH,
  TrickplayInfoDto.JSON_PROPERTY_HEIGHT,
  TrickplayInfoDto.JSON_PROPERTY_TILE_WIDTH,
  TrickplayInfoDto.JSON_PROPERTY_TILE_HEIGHT,
  TrickplayInfoDto.JSON_PROPERTY_THUMBNAIL_COUNT,
  TrickplayInfoDto.JSON_PROPERTY_INTERVAL,
...
public class TrickplayInfoDto {
  ...
  public TrickplayInfoDto width(@org.eclipse.jdt.annotation.Nullable
 Integer width) {
    this.width = width;
    return this;
  }
 ...
 Integer width) {
  ...
  public TrickplayInfoDto height(@org.eclipse.jdt.annotation.Nullable
 Integer height) {
    this.height = height;
    return this;
  }
 ...
 Integer height) {
  ...
  public TrickplayInfoDto tileWidth(@org.eclipse.jdt.annotation.Nullable
 Integer tileWidth) {
 ...
 Integer tileWidth) {
  ...
  public TrickplayInfoDto tileHeight(@org.eclipse.jdt.annotation.Nullable
 Integer tileHeight) {
 ...
 Integer tileHeight) {
  ...
  public TrickplayInfoDto thumbnailCount(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer thumbnailCount) {
  ...
  public TrickplayInfoDto interval(@org.eclipse.jdt.annotation.Nullable
 Integer interval) {
 ...
 Integer interval) {
  ...
  public TrickplayInfoDto bandwidth(@org.eclipse.jdt.annotation.Nullable
 Integer bandwidth) {
 ...
 Integer bandwidth) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getThumbnailCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sThumbnailCount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getThumbnailCount()))));
    }
    ...
    if (getBandwidth() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBandwidth%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBandwidth()))));
    }
