...
import org.openhab.binding.jellyfin.internal.gen.current.model.TimerEventInfo;
 ...
 */
@JsonPropertyOrder({
  TimerCreatedMessage.JSON_PROPERTY_DATA,
  TimerCreatedMessage.JSON_PROPERTY_MESSAGE_ID,
...
public class TimerCreatedMessage {
  ...
  public TimerCreatedMessage data(@org.eclipse.jdt.annotation.Nullable
 TimerEventInfo data) {
    this.data = data;
    return this;
  }
 ...
 TimerEventInfo data) {
  ...
  public TimerCreatedMessage messageId(@org.eclipse.jdt.annotation.Nullable
 UUID messageId) {
