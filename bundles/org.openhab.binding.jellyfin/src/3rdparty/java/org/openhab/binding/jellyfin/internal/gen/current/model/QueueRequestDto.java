...
import org.openhab.binding.jellyfin.internal.gen.current.model.GroupQueueMode;
...
public class QueueRequestDto {
  ...
  public QueueRequestDto itemIds(@org.eclipse.jdt.annotation.Nullable
 List<UUID> itemIds) {
 ...
 List<UUID> itemIds) {
  ...
  public QueueRequestDto mode(@org.eclipse.jdt.annotation.Nullable
 GroupQueueMode mode) {
    this.mode = mode;
    return this;
  }
