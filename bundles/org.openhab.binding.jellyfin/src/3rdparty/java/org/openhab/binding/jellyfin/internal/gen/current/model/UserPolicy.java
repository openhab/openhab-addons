...
import org.openhab.binding.jellyfin.internal.gen.current.model.AccessSchedule;
import org.openhab.binding.jellyfin.internal.gen.current.model.SyncPlayUserAccessType;
import org.openhab.binding.jellyfin.internal.gen.current.model.UnratedItem;
...
@JsonPropertyOrder({
  ...
  UserPolicy.JSON_PROPERTY_MAX_PARENTAL_SUB_RATING,
...
public class UserPolicy {
  ...
  public UserPolicy isAdministrator(@org.eclipse.jdt.annotation.Nullable
 Boolean isAdministrator) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_ADMINISTRATOR)
  public void setIsAdministrator(@org.eclipse.jdt.annotation.Nullable
 Boolean isAdministrator) {
    this.isAdministrator = isAdministrator;
  }


  public UserPolicy isHidden(@org.eclipse.jdt.annotation.Nullable
 Boolean isHidden) {
 ...
 Boolean isHidden) {
  ...
  public UserPolicy enableCollectionManagement(@org.eclipse.jdt.annotation.Nullable
 Boolean enableCollectionManagement) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_COLLECTION_MANAGEMENT)
  public void setEnableCollectionManagement(@org.eclipse.jdt.annotation.Nullable
 Boolean enableCollectionManagement) {
    this.enableCollectionManagement = enableCollectionManagement;
  }


  public UserPolicy enableSubtitleManagement(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSubtitleManagement) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_SUBTITLE_MANAGEMENT)
  public void setEnableSubtitleManagement(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSubtitleManagement) {
    this.enableSubtitleManagement = enableSubtitleManagement;
  }


  public UserPolicy enableLyricManagement(@org.eclipse.jdt.annotation.Nullable
 Boolean enableLyricManagement) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_LYRIC_MANAGEMENT)
  public void setEnableLyricManagement(@org.eclipse.jdt.annotation.Nullable
 Boolean enableLyricManagement) {
    this.enableLyricManagement = enableLyricManagement;
  }


  public UserPolicy isDisabled(@org.eclipse.jdt.annotation.Nullable
 Boolean isDisabled) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_DISABLED)
  public void setIsDisabled(@org.eclipse.jdt.annotation.Nullable
 Boolean isDisabled) {
    this.isDisabled = isDisabled;
  }


  public UserPolicy maxParentalRating(@org.eclipse.jdt.annotation.Nullable
 Integer maxParentalRating) {
  ...
  @JsonProperty(value = JSON_PROPERTY_MAX_PARENTAL_RATING)
  public void setMaxParentalRating(@org.eclipse.jdt.annotation.Nullable
 Integer maxParentalRating) {
    this.maxParentalRating = maxParentalRating;
  }


  public UserPolicy maxParentalSubRating(@org.eclipse.jdt.annotation.Nullable
 Integer maxParentalSubRating) {
  ...
  @JsonProperty(value = JSON_PROPERTY_MAX_PARENTAL_SUB_RATING)
  public void setMaxParentalSubRating(@org.eclipse.jdt.annotation.Nullable
 Integer maxParentalSubRating) {
    this.maxParentalSubRating = maxParentalSubRating;
  }


  public UserPolicy blockedTags(@org.eclipse.jdt.annotation.Nullable
 List<String> blockedTags) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BLOCKED_TAGS)
  public void setBlockedTags(@org.eclipse.jdt.annotation.Nullable
 List<String> blockedTags) {
    this.blockedTags = blockedTags;
  }


  public UserPolicy allowedTags(@org.eclipse.jdt.annotation.Nullable
 List<String> allowedTags) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOWED_TAGS)
  public void setAllowedTags(@org.eclipse.jdt.annotation.Nullable
 List<String> allowedTags) {
    this.allowedTags = allowedTags;
  }


  public UserPolicy enableUserPreferenceAccess(@org.eclipse.jdt.annotation.Nullable
 Boolean enableUserPreferenceAccess) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_USER_PREFERENCE_ACCESS)
  public void setEnableUserPreferenceAccess(@org.eclipse.jdt.annotation.Nullable
 Boolean enableUserPreferenceAccess) {
    this.enableUserPreferenceAccess = enableUserPreferenceAccess;
  }


  public UserPolicy accessSchedules(@org.eclipse.jdt.annotation.Nullable
 List<AccessSchedule> accessSchedules) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ACCESS_SCHEDULES)
  public void setAccessSchedules(@org.eclipse.jdt.annotation.Nullable
 List<AccessSchedule> accessSchedules) {
    this.accessSchedules = accessSchedules;
  }


  public UserPolicy blockUnratedItems(@org.eclipse.jdt.annotation.Nullable
 List<UnratedItem> blockUnratedItems) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BLOCK_UNRATED_ITEMS)
  public void setBlockUnratedItems(@org.eclipse.jdt.annotation.Nullable
 List<UnratedItem> blockUnratedItems) {
    this.blockUnratedItems = blockUnratedItems;
  }


  public UserPolicy enableRemoteControlOfOtherUsers(@org.eclipse.jdt.annotation.Nullable
 Boolean enableRemoteControlOfOtherUsers) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_REMOTE_CONTROL_OF_OTHER_USERS)
  public void setEnableRemoteControlOfOtherUsers(@org.eclipse.jdt.annotation.Nullable
 Boolean enableRemoteControlOfOtherUsers) {
    this.enableRemoteControlOfOtherUsers = enableRemoteControlOfOtherUsers;
  }


  public UserPolicy enableSharedDeviceControl(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSharedDeviceControl) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_SHARED_DEVICE_CONTROL)
  public void setEnableSharedDeviceControl(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSharedDeviceControl) {
    this.enableSharedDeviceControl = enableSharedDeviceControl;
  }


  public UserPolicy enableRemoteAccess(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableRemoteAccess) {
  ...
  public UserPolicy enableLiveTvManagement(@org.eclipse.jdt.annotation.Nullable
 Boolean enableLiveTvManagement) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_LIVE_TV_MANAGEMENT)
  public void setEnableLiveTvManagement(@org.eclipse.jdt.annotation.Nullable
 Boolean enableLiveTvManagement) {
    this.enableLiveTvManagement = enableLiveTvManagement;
  }


  public UserPolicy enableLiveTvAccess(@org.eclipse.jdt.annotation.Nullable
 Boolean enableLiveTvAccess) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_LIVE_TV_ACCESS)
  public void setEnableLiveTvAccess(@org.eclipse.jdt.annotation.Nullable
 Boolean enableLiveTvAccess) {
    this.enableLiveTvAccess = enableLiveTvAccess;
  }


  public UserPolicy enableMediaPlayback(@org.eclipse.jdt.annotation.Nullable
 Boolean enableMediaPlayback) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_MEDIA_PLAYBACK)
  public void setEnableMediaPlayback(@org.eclipse.jdt.annotation.Nullable
 Boolean enableMediaPlayback) {
    this.enableMediaPlayback = enableMediaPlayback;
  }


  public UserPolicy enableAudioPlaybackTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAudioPlaybackTranscoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_AUDIO_PLAYBACK_TRANSCODING)
  public void setEnableAudioPlaybackTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAudioPlaybackTranscoding) {
    this.enableAudioPlaybackTranscoding = enableAudioPlaybackTranscoding;
  }


  public UserPolicy enableVideoPlaybackTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableVideoPlaybackTranscoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_VIDEO_PLAYBACK_TRANSCODING)
  public void setEnableVideoPlaybackTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableVideoPlaybackTranscoding) {
    this.enableVideoPlaybackTranscoding = enableVideoPlaybackTranscoding;
  }


  public UserPolicy enablePlaybackRemuxing(@org.eclipse.jdt.annotation.Nullable
 Boolean enablePlaybackRemuxing) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_PLAYBACK_REMUXING)
  public void setEnablePlaybackRemuxing(@org.eclipse.jdt.annotation.Nullable
 Boolean enablePlaybackRemuxing) {
    this.enablePlaybackRemuxing = enablePlaybackRemuxing;
  }


  public UserPolicy forceRemoteSourceTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean forceRemoteSourceTranscoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FORCE_REMOTE_SOURCE_TRANSCODING)
  public void setForceRemoteSourceTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean forceRemoteSourceTranscoding) {
    this.forceRemoteSourceTranscoding = forceRemoteSourceTranscoding;
  }


  public UserPolicy enableContentDeletion(@org.eclipse.jdt.annotation.Nullable
 Boolean enableContentDeletion) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_CONTENT_DELETION)
  public void setEnableContentDeletion(@org.eclipse.jdt.annotation.Nullable
 Boolean enableContentDeletion) {
    this.enableContentDeletion = enableContentDeletion;
  }


  public UserPolicy enableContentDeletionFromFolders(@org.eclipse.jdt.annotation.Nullable
 List<String> enableContentDeletionFromFolders) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_CONTENT_DELETION_FROM_FOLDERS)
  public void setEnableContentDeletionFromFolders(@org.eclipse.jdt.annotation.Nullable
 List<String> enableContentDeletionFromFolders) {
    this.enableContentDeletionFromFolders = enableContentDeletionFromFolders;
  }


  public UserPolicy enableContentDownloading(@org.eclipse.jdt.annotation.Nullable
 Boolean enableContentDownloading) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_CONTENT_DOWNLOADING)
  public void setEnableContentDownloading(@org.eclipse.jdt.annotation.Nullable
 Boolean enableContentDownloading) {
    this.enableContentDownloading = enableContentDownloading;
  }


  public UserPolicy enableSyncTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSyncTranscoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_SYNC_TRANSCODING)
  public void setEnableSyncTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableSyncTranscoding) {
    this.enableSyncTranscoding = enableSyncTranscoding;
  }


  public UserPolicy enableMediaConversion(@org.eclipse.jdt.annotation.Nullable
 Boolean enableMediaConversion) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_MEDIA_CONVERSION)
  public void setEnableMediaConversion(@org.eclipse.jdt.annotation.Nullable
 Boolean enableMediaConversion) {
    this.enableMediaConversion = enableMediaConversion;
  }


  public UserPolicy enabledDevices(@org.eclipse.jdt.annotation.Nullable
 List<String> enabledDevices) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLED_DEVICES)
  public void setEnabledDevices(@org.eclipse.jdt.annotation.Nullable
 List<String> enabledDevices) {
    this.enabledDevices = enabledDevices;
  }


  public UserPolicy enableAllDevices(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAllDevices) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_ALL_DEVICES)
  public void setEnableAllDevices(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAllDevices) {
    this.enableAllDevices = enableAllDevices;
  }


  public UserPolicy enabledChannels(@org.eclipse.jdt.annotation.Nullable
 List<UUID> enabledChannels) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLED_CHANNELS)
  public void setEnabledChannels(@org.eclipse.jdt.annotation.Nullable
 List<UUID> enabledChannels) {
    this.enabledChannels = enabledChannels;
  }


  public UserPolicy enableAllChannels(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAllChannels) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_ALL_CHANNELS)
  public void setEnableAllChannels(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAllChannels) {
    this.enableAllChannels = enableAllChannels;
  }


  public UserPolicy enabledFolders(@org.eclipse.jdt.annotation.Nullable
 List<UUID> enabledFolders) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLED_FOLDERS)
  public void setEnabledFolders(@org.eclipse.jdt.annotation.Nullable
 List<UUID> enabledFolders) {
    this.enabledFolders = enabledFolders;
  }


  public UserPolicy enableAllFolders(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAllFolders) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_ALL_FOLDERS)
  public void setEnableAllFolders(@org.eclipse.jdt.annotation.Nullable
 Boolean enableAllFolders) {
    this.enableAllFolders = enableAllFolders;
  }


  public UserPolicy invalidLoginAttemptCount(@org.eclipse.jdt.annotation.Nullable
 Integer invalidLoginAttemptCount) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INVALID_LOGIN_ATTEMPT_COUNT)
  public void setInvalidLoginAttemptCount(@org.eclipse.jdt.annotation.Nullable
 Integer invalidLoginAttemptCount) {
    this.invalidLoginAttemptCount = invalidLoginAttemptCount;
  }


  public UserPolicy loginAttemptsBeforeLockout(@org.eclipse.jdt.annotation.Nullable
 Integer loginAttemptsBeforeLockout) {
  ...
  @JsonProperty(value = JSON_PROPERTY_LOGIN_ATTEMPTS_BEFORE_LOCKOUT)
  public void setLoginAttemptsBeforeLockout(@org.eclipse.jdt.annotation.Nullable
 Integer loginAttemptsBeforeLockout) {
    this.loginAttemptsBeforeLockout = loginAttemptsBeforeLockout;
  }


  public UserPolicy maxActiveSessions(@org.eclipse.jdt.annotation.Nullable
 Integer maxActiveSessions) {
  ...
  @JsonProperty(value = JSON_PROPERTY_MAX_ACTIVE_SESSIONS)
  public void setMaxActiveSessions(@org.eclipse.jdt.annotation.Nullable
 Integer maxActiveSessions) {
    this.maxActiveSessions = maxActiveSessions;
  }


  public UserPolicy enablePublicSharing(@org.eclipse.jdt.annotation.Nullable
 Boolean enablePublicSharing) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_PUBLIC_SHARING)
  public void setEnablePublicSharing(@org.eclipse.jdt.annotation.Nullable
 Boolean enablePublicSharing) {
    this.enablePublicSharing = enablePublicSharing;
  }


  public UserPolicy blockedMediaFolders(@org.eclipse.jdt.annotation.Nullable
 List<UUID> blockedMediaFolders) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BLOCKED_MEDIA_FOLDERS)
  public void setBlockedMediaFolders(@org.eclipse.jdt.annotation.Nullable
 List<UUID> blockedMediaFolders) {
    this.blockedMediaFolders = blockedMediaFolders;
  }


  public UserPolicy blockedChannels(@org.eclipse.jdt.annotation.Nullable
 List<UUID> blockedChannels) {
  ...
  @JsonProperty(value = JSON_PROPERTY_BLOCKED_CHANNELS)
  public void setBlockedChannels(@org.eclipse.jdt.annotation.Nullable
 List<UUID> blockedChannels) {
    this.blockedChannels = blockedChannels;
  }


  public UserPolicy remoteClientBitrateLimit(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer remoteClientBitrateLimit) {
  ...
  public UserPolicy authenticationProviderId(@org.eclipse.jdt.annotation.NonNull
 String authenticationProviderId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_AUTHENTICATION_PROVIDER_ID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAuthenticationProviderId(@org.eclipse.jdt.annotation.NonNull
 String authenticationProviderId) {
    this.authenticationProviderId = authenticationProviderId;
  }


  public UserPolicy passwordResetProviderId(@org.eclipse.jdt.annotation.NonNull
 String passwordResetProviderId) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PASSWORD_RESET_PROVIDER_ID, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPasswordResetProviderId(@org.eclipse.jdt.annotation.NonNull
 String passwordResetProviderId) {
    this.passwordResetProviderId = passwordResetProviderId;
  }


  public UserPolicy syncPlayAccess(@org.eclipse.jdt.annotation.Nullable
 SyncPlayUserAccessType syncPlayAccess) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SYNC_PLAY_ACCESS)
  public void setSyncPlayAccess(@org.eclipse.jdt.annotation.Nullable
 SyncPlayUserAccessType syncPlayAccess) {
    this.syncPlayAccess = syncPlayAccess;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsAdministrator() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsAdministrator%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsAdministrator()))));
    }
    ...
    if (getEnableCollectionManagement() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableCollectionManagement%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableCollectionManagement()))));
    }

    // add `EnableSubtitleManagement` to the URL query string
    if (getEnableSubtitleManagement() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableSubtitleManagement%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableSubtitleManagement()))));
    }

    // add `EnableLyricManagement` to the URL query string
    if (getEnableLyricManagement() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableLyricManagement%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableLyricManagement()))));
    }

    // add `IsDisabled` to the URL query string
    if (getIsDisabled() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsDisabled%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsDisabled()))));
    }

    // add `MaxParentalRating` to the URL query string
    if (getMaxParentalRating() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxParentalRating%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxParentalRating()))));
    }

    // add `MaxParentalSubRating` to the URL query string
    if (getMaxParentalSubRating() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxParentalSubRating%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxParentalSubRating()))));
    }
    ...
    if (getEnableUserPreferenceAccess() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableUserPreferenceAccess%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableUserPreferenceAccess()))));
    }
    ...
    if (getAccessSchedules() != null) {
      for (int i = 0; i < getAccessSchedules().size(); i++) {
        if (getAccessSchedules().get(i) != null) {
          joiner.add(getAccessSchedules().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sAccessSchedules%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getEnableRemoteControlOfOtherUsers() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableRemoteControlOfOtherUsers%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableRemoteControlOfOtherUsers()))));
    }

    // add `EnableSharedDeviceControl` to the URL query string
    if (getEnableSharedDeviceControl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableSharedDeviceControl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableSharedDeviceControl()))));
    }
    ...
    if (getEnableLiveTvManagement() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableLiveTvManagement%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableLiveTvManagement()))));
    }

    // add `EnableLiveTvAccess` to the URL query string
    if (getEnableLiveTvAccess() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableLiveTvAccess%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableLiveTvAccess()))));
    }

    // add `EnableMediaPlayback` to the URL query string
    if (getEnableMediaPlayback() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableMediaPlayback%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableMediaPlayback()))));
    }

    // add `EnableAudioPlaybackTranscoding` to the URL query string
    if (getEnableAudioPlaybackTranscoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableAudioPlaybackTranscoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableAudioPlaybackTranscoding()))));
    }

    // add `EnableVideoPlaybackTranscoding` to the URL query string
    if (getEnableVideoPlaybackTranscoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableVideoPlaybackTranscoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableVideoPlaybackTranscoding()))));
    }

    // add `EnablePlaybackRemuxing` to the URL query string
    if (getEnablePlaybackRemuxing() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnablePlaybackRemuxing%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnablePlaybackRemuxing()))));
    }

    // add `ForceRemoteSourceTranscoding` to the URL query string
    if (getForceRemoteSourceTranscoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sForceRemoteSourceTranscoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getForceRemoteSourceTranscoding()))));
    }

    // add `EnableContentDeletion` to the URL query string
    if (getEnableContentDeletion() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableContentDeletion%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableContentDeletion()))));
    }
    ...
    if (getEnableContentDeletionFromFolders() != null) {
      for (int i = 0; i < getEnableContentDeletionFromFolders().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%sEnableContentDeletionFromFolders%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
    ...
    if (getEnableContentDownloading() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableContentDownloading%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableContentDownloading()))));
    }

    // add `EnableSyncTranscoding` to the URL query string
    if (getEnableSyncTranscoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableSyncTranscoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableSyncTranscoding()))));
    }

    // add `EnableMediaConversion` to the URL query string
    if (getEnableMediaConversion() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableMediaConversion%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableMediaConversion()))));
    }
    ...
    if (getEnableAllDevices() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableAllDevices%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableAllDevices()))));
    }
    ...
    if (getEnableAllChannels() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableAllChannels%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableAllChannels()))));
    }
    ...
    if (getEnableAllFolders() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableAllFolders%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableAllFolders()))));
    }

    // add `InvalidLoginAttemptCount` to the URL query string
    if (getInvalidLoginAttemptCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sInvalidLoginAttemptCount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getInvalidLoginAttemptCount()))));
    }

    // add `LoginAttemptsBeforeLockout` to the URL query string
    if (getLoginAttemptsBeforeLockout() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLoginAttemptsBeforeLockout%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLoginAttemptsBeforeLockout()))));
    }

    // add `MaxActiveSessions` to the URL query string
    if (getMaxActiveSessions() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxActiveSessions%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxActiveSessions()))));
    }

    // add `EnablePublicSharing` to the URL query string
    if (getEnablePublicSharing() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnablePublicSharing%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnablePublicSharing()))));
    }
    ...
    if (getAuthenticationProviderId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAuthenticationProviderId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAuthenticationProviderId()))));
    }

    // add `PasswordResetProviderId` to the URL query string
    if (getPasswordResetProviderId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPasswordResetProviderId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPasswordResetProviderId()))));
    }

    // add `SyncPlayAccess` to the URL query string
    if (getSyncPlayAccess() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSyncPlayAccess%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSyncPlayAccess()))));
    }
  ...
  */
  public UserPolicy.Builder toBuilder() {
    return new UserPolicy.Builder()
      ...
      .enableLyricManagement(getEnableLyricManagement())
      .isDisabled(getIsDisabled())
      .maxParentalRating(getMaxParentalRating())
      .maxParentalSubRating(getMaxParentalSubRating())
      .blockedTags(getBlockedTags())
      .allowedTags(getAllowedTags())
      .enableUserPreferenceAccess(getEnableUserPreferenceAccess())
      .accessSchedules(getAccessSchedules())
      .blockUnratedItems(getBlockUnratedItems())
      .enableRemoteControlOfOtherUsers(getEnableRemoteControlOfOtherUsers())
      .enableSharedDeviceControl(getEnableSharedDeviceControl())
      .enableRemoteAccess(getEnableRemoteAccess())
      .enableLiveTvManagement(getEnableLiveTvManagement())
      .enableLiveTvAccess(getEnableLiveTvAccess())
      ...
      .enableSyncTranscoding(getEnableSyncTranscoding())
      .enableMediaConversion(getEnableMediaConversion())
      .enabledDevices(getEnabledDevices())
      .enableAllDevices(getEnableAllDevices())
      .enabledChannels(getEnabledChannels())
      .enableAllChannels(getEnableAllChannels())
      .enabledFolders(getEnabledFolders())
      .enableAllFolders(getEnableAllFolders())
      .invalidLoginAttemptCount(getInvalidLoginAttemptCount())
      .loginAttemptsBeforeLockout(getLoginAttemptsBeforeLockout())
      .maxActiveSessions(getMaxActiveSessions())
      .enablePublicSharing(getEnablePublicSharing())
      .blockedMediaFolders(getBlockedMediaFolders())
      ...
      .passwordResetProviderId(getPasswordResetProviderId())
      .syncPlayAccess(getSyncPlayAccess());
  }
