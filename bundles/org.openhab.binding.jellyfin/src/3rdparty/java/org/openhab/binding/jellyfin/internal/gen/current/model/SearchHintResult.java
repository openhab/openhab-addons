...
import org.openhab.binding.jellyfin.internal.gen.current.model.SearchHint;
...
public class SearchHintResult {
  ...
  public SearchHintResult searchHints(@org.eclipse.jdt.annotation.Nullable
 ...
 List<SearchHint> searchHints) {
  ...
  public SearchHintResult totalRecordCount(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer totalRecordCount) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSearchHints() != null) {
      for (int i = 0; i < getSearchHints().size(); i++) {
        if (getSearchHints().get(i) != null) {
          joiner.add(getSearchHints().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sSearchHints%s%s", prefix, suffix,
    ...
    if (getTotalRecordCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTotalRecordCount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTotalRecordCount()))));
    }
