...
public class LibraryTypeOptionsDto {
  ...
  public LibraryTypeOptionsDto type(@org.eclipse.jdt.annotation.Nullable
 String type) {
    this.type = type;
    return this;
  }
 ...
 String type) {
  ...
  public LibraryTypeOptionsDto metadataFetchers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LibraryOptionInfoDto> metadataFetchers) {
  ...
  public LibraryTypeOptionsDto imageFetchers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LibraryOptionInfoDto> imageFetchers) {
  ...
  public LibraryTypeOptionsDto supportedImageTypes(@org.eclipse.jdt.annotation.Nullable
 List<ImageType> supportedImageTypes) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SUPPORTED_IMAGE_TYPES, required = false)
  public void setSupportedImageTypes(@org.eclipse.jdt.annotation.Nullable
 List<ImageType> supportedImageTypes) {
    this.supportedImageTypes = supportedImageTypes;
  }


  public LibraryTypeOptionsDto defaultImageOptions(@org.eclipse.jdt.annotation.Nullable
 List<ImageOption> defaultImageOptions) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DEFAULT_IMAGE_OPTIONS, required = false)
  public void setDefaultImageOptions(@org.eclipse.jdt.annotation.Nullable
 List<ImageOption> defaultImageOptions) {
    this.defaultImageOptions = defaultImageOptions;
  }
    ...
    if (getMetadataFetchers() != null) {
      for (int i = 0; i < getMetadataFetchers().size(); i++) {
        if (getMetadataFetchers().get(i) != null) {
          joiner.add(getMetadataFetchers().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sMetadataFetchers%s%s", prefix, suffix,
    ...
    if (getImageFetchers() != null) {
      for (int i = 0; i < getImageFetchers().size(); i++) {
        if (getImageFetchers().get(i) != null) {
          joiner.add(getImageFetchers().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sImageFetchers%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getDefaultImageOptions() != null) {
      for (int i = 0; i < getDefaultImageOptions().size(); i++) {
        if (getDefaultImageOptions().get(i) != null) {
          joiner.add(getDefaultImageOptions().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sDefaultImageOptions%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
