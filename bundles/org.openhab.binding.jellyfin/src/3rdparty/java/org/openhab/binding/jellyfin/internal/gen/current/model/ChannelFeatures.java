...
import org.openhab.binding.jellyfin.internal.gen.current.model.ChannelItemSortField;
import org.openhab.binding.jellyfin.internal.gen.current.model.ChannelMediaContentType;
import org.openhab.binding.jellyfin.internal.gen.current.model.ChannelMediaType;
...
public class ChannelFeatures {
  ...
  public ChannelFeatures name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public ChannelFeatures id(@org.eclipse.jdt.annotation.Nullable
 UUID id) {
    this.id = id;
    return this;
  }
 ...
 UUID id) {
  ...
  public ChannelFeatures canSearch(@org.eclipse.jdt.annotation.Nullable
 Boolean canSearch) {
 ...
 Boolean canSearch) {
  ...
  public ChannelFeatures mediaTypes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ChannelMediaType> mediaTypes) {
  ...
  public ChannelFeatures contentTypes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ChannelMediaContentType> contentTypes) {
  ...
  public ChannelFeatures maxPageSize(@org.eclipse.jdt.annotation.Nullable
 Integer maxPageSize) {
 ...
 Integer maxPageSize) {
  ...
  public ChannelFeatures autoRefreshLevels(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer autoRefreshLevels) {
  ...
  public ChannelFeatures defaultSortFields(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ChannelItemSortField> defaultSortFields) {
  ...
  public ChannelFeatures supportsSortOrderToggle(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean supportsSortOrderToggle) {
  ...
  public ChannelFeatures supportsLatestMedia(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean supportsLatestMedia) {
  ...
  public ChannelFeatures canFilter(@org.eclipse.jdt.annotation.Nullable
 Boolean canFilter) {
 ...
 Boolean canFilter) {
  ...
  public ChannelFeatures supportsContentDownloading(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean supportsContentDownloading) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCanSearch() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCanSearch%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCanSearch()))));
    }
    ...
    if (getMaxPageSize() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxPageSize%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxPageSize()))));
    }

    // add `AutoRefreshLevels` to the URL query string
    if (getAutoRefreshLevels() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAutoRefreshLevels%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAutoRefreshLevels()))));
    }
    ...
    if (getSupportsSortOrderToggle() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSupportsSortOrderToggle%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSupportsSortOrderToggle()))));
    }

    // add `SupportsLatestMedia` to the URL query string
    if (getSupportsLatestMedia() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSupportsLatestMedia%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSupportsLatestMedia()))));
    }

    // add `CanFilter` to the URL query string
    if (getCanFilter() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCanFilter%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCanFilter()))));
    }

    // add `SupportsContentDownloading` to the URL query string
    if (getSupportsContentDownloading() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSupportsContentDownloading%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSupportsContentDownloading()))));
    }
