...
import org.openhab.binding.jellyfin.internal.gen.current.model.BrandingOptionsDto;
import java.io.File;
import org.openhab.binding.jellyfin.internal.gen.current.model.MetadataOptions;
import org.openhab.binding.jellyfin.internal.gen.current.model.ServerConfiguration;
...
public class ConfigurationApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ServerConfiguration> getConfigurationWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        ServerConfiguration responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<ServerConfiguration>() {});
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<MetadataOptions> getDefaultMetadataOptionsWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        MetadataOptions responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<MetadataOptions>() {});
  ...
  private HttpRequest.Builder getDefaultMetadataOptionsRequestBuilder(Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public File getNamedConfiguration(@org.eclipse.jdt.annotation.NonNull
 ...
 String key, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> getNamedConfigurationWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String key) throws ApiException {
 ...
 String key, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder getNamedConfigurationRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String key, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateBrandingConfiguration(@org.eclipse.jdt.annotation.NonNull
 BrandingOptionsDto brandingOptionsDto) throws ApiException {
   ...
   */
  public void updateBrandingConfiguration(@org.eclipse.jdt.annotation.NonNull
 BrandingOptionsDto brandingOptionsDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> updateBrandingConfigurationWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 BrandingOptionsDto brandingOptionsDto) throws ApiException {
  ...
  public ApiResponse<Void> updateBrandingConfigurationWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 BrandingOptionsDto brandingOptionsDto, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = updateBrandingConfigurationRequestBuilder(brandingOptionsDto, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder updateBrandingConfigurationRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 BrandingOptionsDto brandingOptionsDto, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'brandingOptionsDto' is set
    if (brandingOptionsDto == null) {
      throw new ApiException(400, "Missing the required parameter 'brandingOptionsDto' when calling updateBrandingConfiguration");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateConfiguration(@org.eclipse.jdt.annotation.NonNull
 ServerConfiguration serverConfiguration) throws ApiException {
   ...
   */
  public void updateConfiguration(@org.eclipse.jdt.annotation.NonNull
 ServerConfiguration serverConfiguration, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> updateConfigurationWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 ServerConfiguration serverConfiguration) throws ApiException {
 ...
 ServerConfiguration serverConfiguration, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder updateConfigurationRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 ServerConfiguration serverConfiguration, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateNamedConfiguration(@org.eclipse.jdt.annotation.NonNull
 String key, @org.eclipse.jdt.annotation.Nullable
 Object body) throws ApiException {
  ...
  public void updateNamedConfiguration(@org.eclipse.jdt.annotation.NonNull
 String key, @org.eclipse.jdt.annotation.Nullable
 Object body, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> updateNamedConfigurationWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String key, @org.eclipse.jdt.annotation.Nullable
 Object body) throws ApiException {
 ...
 Object body, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder updateNamedConfigurationRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String key, @org.eclipse.jdt.annotation.Nullable
 Object body, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'key' is set
    if (key == null) {
