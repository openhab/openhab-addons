...
import org.openhab.binding.jellyfin.internal.gen.current.model.TaskInfo;
...
public class ScheduledTasksInfoMessage {
  ...
  public ScheduledTasksInfoMessage data(@org.eclipse.jdt.annotation.Nullable
 List<TaskInfo> data) {
    this.data = data;
    return this;
  }
 ...
 List<TaskInfo> data) {
  ...
  public ScheduledTasksInfoMessage messageId(@org.eclipse.jdt.annotation.Nullable
 UUID messageId) {
