...
import org.openhab.binding.jellyfin.internal.gen.current.model.EndPointInfo;
import java.io.File;
import org.openhab.binding.jellyfin.internal.gen.current.model.LogFile;
import org.openhab.binding.jellyfin.internal.gen.current.model.ProblemDetails;
import org.openhab.binding.jellyfin.internal.gen.current.model.PublicSystemInfo;
import org.openhab.binding.jellyfin.internal.gen.current.model.SystemInfo;
import org.openhab.binding.jellyfin.internal.gen.current.model.SystemStorageDto;
...
public class SystemApi {
  ...
  public ApiResponse<EndPointInfo> getEndpointInfoWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        EndPointInfo responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<EndPointInfo>() {});
   ...
   * @throws ApiException if fails to make API call
   */
  public File getLogFile(@org.eclipse.jdt.annotation.NonNull
 ...
 String name, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> getLogFileWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String name) throws ApiException {
 ...
 String name, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder getLogFileRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String name, Map<String, String> headers) throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "text/plain, application/json, application/json; profile=CamelCase, application/json; profile=PascalCase, text/html");
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicSystemInfo> getPublicSystemInfoWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        PublicSystemInfo responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<PublicSystemInfo>() {});
  ...
  public ApiResponse<List<LogFile>> getServerLogsWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        List<LogFile> responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<LogFile>>() {});
  ...
  public ApiResponse<SystemInfo> getSystemInfoWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        SystemInfo responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<SystemInfo>() {});
  ...
  public ApiResponse<SystemStorageDto> getSystemStorageWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<SystemStorageDto>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        SystemStorageDto responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<SystemStorageDto>() {});
