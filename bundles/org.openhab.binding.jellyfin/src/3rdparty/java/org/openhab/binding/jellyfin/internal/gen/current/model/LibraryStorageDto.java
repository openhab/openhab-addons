 ...
 */
@JsonPropertyOrder({
  LibraryStorageDto.JSON_PROPERTY_ID,
  LibraryStorageDto.JSON_PROPERTY_NAME,
...
public class LibraryStorageDto {
  ...
  public LibraryStorageDto id(@org.eclipse.jdt.annotation.Nullable
 UUID id) {
    this.id = id;
    return this;
  }
 ...
 UUID id) {
  ...
  public LibraryStorageDto name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public LibraryStorageDto folders(@org.eclipse.jdt.annotation.Nullable
 ...
 List<FolderStorageDto> folders) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, libraryStorageDto.id) &&
        Objects.equals(this.name, libraryStorageDto.name) &&
