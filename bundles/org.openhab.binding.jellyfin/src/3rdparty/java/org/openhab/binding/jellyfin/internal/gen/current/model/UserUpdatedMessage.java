 ...
 */
@JsonPropertyOrder({
  UserUpdatedMessage.JSON_PROPERTY_DATA,
  UserUpdatedMessage.JSON_PROPERTY_MESSAGE_ID,
...
public class UserUpdatedMessage {
  ...
  public UserUpdatedMessage data(@org.eclipse.jdt.annotation.Nullable
 UserDto data) {
    this.data = data;
    return this;
  }
 ...
 UserDto data) {
  ...
  public UserUpdatedMessage messageId(@org.eclipse.jdt.annotation.Nullable
 UUID messageId) {
