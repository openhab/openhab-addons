 ...
 */
@JsonPropertyOrder({
  NameValuePair.JSON_PROPERTY_NAME,
  NameValuePair.JSON_PROPERTY_VALUE
})
...
public class NameValuePair {
  ...
  public NameValuePair name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public NameValuePair value(@org.eclipse.jdt.annotation.Nullable
 String value) {
    this.value = value;
    return this;
  }
