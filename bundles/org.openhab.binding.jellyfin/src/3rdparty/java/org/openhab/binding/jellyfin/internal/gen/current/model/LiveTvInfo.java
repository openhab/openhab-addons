...
import org.openhab.binding.jellyfin.internal.gen.current.model.LiveTvServiceInfo;
...
public class LiveTvInfo {
  ...
  public LiveTvInfo services(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LiveTvServiceInfo> services) {
  ...
  public LiveTvInfo isEnabled(@org.eclipse.jdt.annotation.Nullable
 Boolean isEnabled) {
 ...
 Boolean isEnabled) {
  ...
  public LiveTvInfo enabledUsers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> enabledUsers) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsEnabled() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsEnabled%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsEnabled()))));
    }
