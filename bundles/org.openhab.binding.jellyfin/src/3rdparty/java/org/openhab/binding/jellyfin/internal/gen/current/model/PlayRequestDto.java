...
public class PlayRequestDto {
  ...
  public PlayRequestDto playingQueue(@org.eclipse.jdt.annotation.Nullable
 ...
 List<UUID> playingQueue) {
  ...
  public PlayRequestDto playingItemPosition(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer playingItemPosition) {
  ...
  public PlayRequestDto startPositionTicks(@org.eclipse.jdt.annotation.Nullable
 ...
 Long startPositionTicks) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPlayingItemPosition() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlayingItemPosition%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlayingItemPosition()))));
    }
