...
public class TunerHostInfo {
  ...
  public TunerHostInfo id(@org.eclipse.jdt.annotation.Nullable
 String id) {
    this.id = id;
    return this;
  }
 ...
 String id) {
  ...
  public TunerHostInfo url(@org.eclipse.jdt.annotation.Nullable
 String url) {
    this.url = url;
    return this;
  }
 ...
 String url) {
  ...
  public TunerHostInfo type(@org.eclipse.jdt.annotation.Nullable
 String type) {
    this.type = type;
    return this;
  }
 ...
 String type) {
  ...
  public TunerHostInfo deviceId(@org.eclipse.jdt.annotation.Nullable
 String deviceId) {
 ...
 String deviceId) {
  ...
  public TunerHostInfo friendlyName(@org.eclipse.jdt.annotation.Nullable
 String friendlyName) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FRIENDLY_NAME, required = false)
  public void setFriendlyName(@org.eclipse.jdt.annotation.Nullable
 String friendlyName) {
    this.friendlyName = friendlyName;
  }


  public TunerHostInfo importFavoritesOnly(@org.eclipse.jdt.annotation.Nullable
 Boolean importFavoritesOnly) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IMPORT_FAVORITES_ONLY, required = false)
  public void setImportFavoritesOnly(@org.eclipse.jdt.annotation.Nullable
 Boolean importFavoritesOnly) {
    this.importFavoritesOnly = importFavoritesOnly;
  }


  public TunerHostInfo allowHWTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean allowHWTranscoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOW_H_W_TRANSCODING, required = false)
  public void setAllowHWTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean allowHWTranscoding) {
    this.allowHWTranscoding = allowHWTranscoding;
  }


  public TunerHostInfo allowFmp4TranscodingContainer(@org.eclipse.jdt.annotation.Nullable
 Boolean allowFmp4TranscodingContainer) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOW_FMP4_TRANSCODING_CONTAINER, required = false)
  public void setAllowFmp4TranscodingContainer(@org.eclipse.jdt.annotation.Nullable
 Boolean allowFmp4TranscodingContainer) {
    this.allowFmp4TranscodingContainer = allowFmp4TranscodingContainer;
  }


  public TunerHostInfo allowStreamSharing(@org.eclipse.jdt.annotation.Nullable
 Boolean allowStreamSharing) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOW_STREAM_SHARING, required = false)
  public void setAllowStreamSharing(@org.eclipse.jdt.annotation.Nullable
 Boolean allowStreamSharing) {
    this.allowStreamSharing = allowStreamSharing;
  }


  public TunerHostInfo fallbackMaxStreamingBitrate(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer fallbackMaxStreamingBitrate) {
  ...
  public TunerHostInfo enableStreamLooping(@org.eclipse.jdt.annotation.Nullable
 Boolean enableStreamLooping) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_STREAM_LOOPING, required = false)
  public void setEnableStreamLooping(@org.eclipse.jdt.annotation.Nullable
 Boolean enableStreamLooping) {
    this.enableStreamLooping = enableStreamLooping;
  }


  public TunerHostInfo source(@org.eclipse.jdt.annotation.Nullable
 String source) {
    this.source = source;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SOURCE, required = false)
  public void setSource(@org.eclipse.jdt.annotation.Nullable
 String source) {
    this.source = source;
  }


  public TunerHostInfo tunerCount(@org.eclipse.jdt.annotation.Nullable
 Integer tunerCount) {
  ...
  @JsonProperty(value = JSON_PROPERTY_TUNER_COUNT, required = false)
  public void setTunerCount(@org.eclipse.jdt.annotation.Nullable
 Integer tunerCount) {
    this.tunerCount = tunerCount;
  }


  public TunerHostInfo userAgent(@org.eclipse.jdt.annotation.Nullable
 String userAgent) {
 ...
 String userAgent) {
  ...
  public TunerHostInfo ignoreDts(@org.eclipse.jdt.annotation.Nullable
 Boolean ignoreDts) {
 ...
 Boolean ignoreDts) {
  ...
  public TunerHostInfo readAtNativeFramerate(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean readAtNativeFramerate) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, type, deviceId, friendlyName, importFavoritesOnly, allowHWTranscoding, allowFmp4TranscodingContainer, allowStreamSharing, fallbackMaxStreamingBitrate, enableStreamLooping, source, tunerCount, userAgent, ignoreDts, readAtNativeFramerate);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getFriendlyName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sFriendlyName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getFriendlyName()))));
    }

    // add `ImportFavoritesOnly` to the URL query string
    if (getImportFavoritesOnly() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sImportFavoritesOnly%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getImportFavoritesOnly()))));
    }

    // add `AllowHWTranscoding` to the URL query string
    if (getAllowHWTranscoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAllowHWTranscoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAllowHWTranscoding()))));
    }

    // add `AllowFmp4TranscodingContainer` to the URL query string
    if (getAllowFmp4TranscodingContainer() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAllowFmp4TranscodingContainer%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAllowFmp4TranscodingContainer()))));
    }

    // add `AllowStreamSharing` to the URL query string
    if (getAllowStreamSharing() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAllowStreamSharing%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAllowStreamSharing()))));
    }
    ...
    if (getEnableStreamLooping() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableStreamLooping%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableStreamLooping()))));
    }
    ...
    if (getTunerCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTunerCount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTunerCount()))));
    }
