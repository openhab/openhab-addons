 ...
 */
@JsonPropertyOrder({
  BackupOptionsDto.JSON_PROPERTY_METADATA,
  BackupOptionsDto.JSON_PROPERTY_TRICKPLAY,
  BackupOptionsDto.JSON_PROPERTY_SUBTITLES,
  BackupOptionsDto.JSON_PROPERTY_DATABASE
})
...
public class BackupOptionsDto {
  ...
  public BackupOptionsDto metadata(@org.eclipse.jdt.annotation.Nullable
 Boolean metadata) {
 ...
 Boolean metadata) {
  ...
  public BackupOptionsDto trickplay(@org.eclipse.jdt.annotation.Nullable
 Boolean trickplay) {
 ...
 Boolean trickplay) {
  ...
  public BackupOptionsDto subtitles(@org.eclipse.jdt.annotation.Nullable
 Boolean subtitles) {
 ...
 Boolean subtitles) {
  ...
  public BackupOptionsDto database(@org.eclipse.jdt.annotation.Nullable
 Boolean database) {
 ...
 Boolean database) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTrickplay() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTrickplay%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTrickplay()))));
    }

    // add `Subtitles` to the URL query string
    if (getSubtitles() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSubtitles%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSubtitles()))));
    }
