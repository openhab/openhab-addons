...
import org.openhab.binding.jellyfin.internal.gen.current.model.SubtitlePlaybackMode;
...
public class UserConfiguration {
  ...
  public UserConfiguration audioLanguagePreference(@org.eclipse.jdt.annotation.Nullable
 ...
 String audioLanguagePreference) {
  ...
  public UserConfiguration playDefaultAudioTrack(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean playDefaultAudioTrack) {
  ...
  public UserConfiguration subtitleLanguagePreference(@org.eclipse.jdt.annotation.Nullable
 ...
 String subtitleLanguagePreference) {
  ...
  public UserConfiguration displayMissingEpisodes(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean displayMissingEpisodes) {
  ...
  public UserConfiguration groupedFolders(@org.eclipse.jdt.annotation.Nullable
 ...
 List<UUID> groupedFolders) {
  ...
  public UserConfiguration subtitleMode(@org.eclipse.jdt.annotation.Nullable
 ...
 SubtitlePlaybackMode subtitleMode) {
  ...
  public UserConfiguration displayCollectionsView(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean displayCollectionsView) {
  ...
  public UserConfiguration enableLocalPassword(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableLocalPassword) {
  ...
  public UserConfiguration orderedViews(@org.eclipse.jdt.annotation.Nullable
 ...
 List<UUID> orderedViews) {
  ...
  public UserConfiguration latestItemsExcludes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<UUID> latestItemsExcludes) {
  ...
  public UserConfiguration myMediaExcludes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<UUID> myMediaExcludes) {
  ...
  public UserConfiguration hidePlayedInLatest(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean hidePlayedInLatest) {
  ...
  public UserConfiguration rememberAudioSelections(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean rememberAudioSelections) {
  ...
  public UserConfiguration rememberSubtitleSelections(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean rememberSubtitleSelections) {
  ...
  public UserConfiguration enableNextEpisodeAutoPlay(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableNextEpisodeAutoPlay) {
  ...
  public UserConfiguration castReceiverId(@org.eclipse.jdt.annotation.Nullable
 ...
 String castReceiverId) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAudioLanguagePreference() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAudioLanguagePreference%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAudioLanguagePreference()))));
    }

    // add `PlayDefaultAudioTrack` to the URL query string
    if (getPlayDefaultAudioTrack() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlayDefaultAudioTrack%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlayDefaultAudioTrack()))));
    }

    // add `SubtitleLanguagePreference` to the URL query string
    if (getSubtitleLanguagePreference() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSubtitleLanguagePreference%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSubtitleLanguagePreference()))));
    }

    // add `DisplayMissingEpisodes` to the URL query string
    if (getDisplayMissingEpisodes() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDisplayMissingEpisodes%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDisplayMissingEpisodes()))));
    }
    ...
    if (getSubtitleMode() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSubtitleMode%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSubtitleMode()))));
    }

    // add `DisplayCollectionsView` to the URL query string
    if (getDisplayCollectionsView() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDisplayCollectionsView%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDisplayCollectionsView()))));
    }

    // add `EnableLocalPassword` to the URL query string
    if (getEnableLocalPassword() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableLocalPassword%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableLocalPassword()))));
    }
    ...
    if (getHidePlayedInLatest() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sHidePlayedInLatest%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getHidePlayedInLatest()))));
    }

    // add `RememberAudioSelections` to the URL query string
    if (getRememberAudioSelections() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRememberAudioSelections%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRememberAudioSelections()))));
    }

    // add `RememberSubtitleSelections` to the URL query string
    if (getRememberSubtitleSelections() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRememberSubtitleSelections%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRememberSubtitleSelections()))));
    }

    // add `EnableNextEpisodeAutoPlay` to the URL query string
    if (getEnableNextEpisodeAutoPlay() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableNextEpisodeAutoPlay%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableNextEpisodeAutoPlay()))));
    }

    // add `CastReceiverId` to the URL query string
    if (getCastReceiverId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCastReceiverId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCastReceiverId()))));
    }
