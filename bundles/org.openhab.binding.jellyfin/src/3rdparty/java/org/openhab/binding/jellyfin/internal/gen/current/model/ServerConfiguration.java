...
import org.openhab.binding.jellyfin.internal.gen.current.model.CastReceiverApplication;
import org.openhab.binding.jellyfin.internal.gen.current.model.ImageResolution;
import org.openhab.binding.jellyfin.internal.gen.current.model.ImageSavingConvention;
import org.openhab.binding.jellyfin.internal.gen.current.model.MetadataOptions;
import org.openhab.binding.jellyfin.internal.gen.current.model.NameValuePair;
import org.openhab.binding.jellyfin.internal.gen.current.model.PathSubstitution;
import org.openhab.binding.jellyfin.internal.gen.current.model.RepositoryInfo;
import org.openhab.binding.jellyfin.internal.gen.current.model.TrickplayOptions;
...
@JsonPropertyOrder({
  ...
  ServerConfiguration.JSON_PROPERTY_LIBRARY_UPDATE_DURATION,
  ServerConfiguration.JSON_PROPERTY_CACHE_SIZE,
...
public class ServerConfiguration {
  ...
  public ServerConfiguration logFileRetentionDays(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer logFileRetentionDays) {
  ...
  public ServerConfiguration isStartupWizardCompleted(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean isStartupWizardCompleted) {
  ...
  public ServerConfiguration cachePath(@org.eclipse.jdt.annotation.Nullable
 String cachePath) {
 ...
 String cachePath) {
  ...
  public ServerConfiguration previousVersion(@org.eclipse.jdt.annotation.Nullable
 ...
 String previousVersion) {
  ...
  public ServerConfiguration previousVersionStr(@org.eclipse.jdt.annotation.Nullable
 ...
 String previousVersionStr) {
  ...
  public ServerConfiguration enableMetrics(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableMetrics) {
  ...
  public ServerConfiguration enableNormalizedItemByNameIds(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableNormalizedItemByNameIds) {
  ...
  public ServerConfiguration isPortAuthorized(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean isPortAuthorized) {
  ...
  public ServerConfiguration quickConnectAvailable(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean quickConnectAvailable) {
  ...
  public ServerConfiguration enableCaseSensitiveItemIds(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableCaseSensitiveItemIds) {
  ...
  public ServerConfiguration disableLiveTvChannelUserDataName(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean disableLiveTvChannelUserDataName) {
  ...
  public ServerConfiguration metadataPath(@org.eclipse.jdt.annotation.Nullable
 String metadataPath) {
 ...
 String metadataPath) {
  ...
  public ServerConfiguration preferredMetadataLanguage(@org.eclipse.jdt.annotation.Nullable
 ...
 String preferredMetadataLanguage) {
  ...
  public ServerConfiguration metadataCountryCode(@org.eclipse.jdt.annotation.Nullable
 ...
 String metadataCountryCode) {
  ...
  public ServerConfiguration sortReplaceCharacters(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> sortReplaceCharacters) {
  ...
  public ServerConfiguration sortRemoveCharacters(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> sortRemoveCharacters) {
  ...
  public ServerConfiguration sortRemoveWords(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> sortRemoveWords) {
  ...
  public ServerConfiguration minResumePct(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer minResumePct) {
  ...
  public ServerConfiguration maxResumePct(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer maxResumePct) {
  ...
  public ServerConfiguration minResumeDurationSeconds(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer minResumeDurationSeconds) {
  ...
  public ServerConfiguration minAudiobookResume(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer minAudiobookResume) {
  ...
  public ServerConfiguration maxAudiobookResume(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer maxAudiobookResume) {
  ...
  public ServerConfiguration inactiveSessionThreshold(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer inactiveSessionThreshold) {
  ...
  public ServerConfiguration libraryMonitorDelay(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer libraryMonitorDelay) {
  ...
  public ServerConfiguration libraryUpdateDuration(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer libraryUpdateDuration) {
  ...
  public ServerConfiguration cacheSize(@org.eclipse.jdt.annotation.Nullable
 Integer cacheSize) {
 ...
 Integer cacheSize) {
  ...
  public ServerConfiguration imageSavingConvention(@org.eclipse.jdt.annotation.Nullable
 ...
 ImageSavingConvention imageSavingConvention) {
  ...
  public ServerConfiguration metadataOptions(@org.eclipse.jdt.annotation.Nullable
 ...
 List<MetadataOptions> metadataOptions) {
  ...
  public ServerConfiguration skipDeserializationForBasicTypes(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean skipDeserializationForBasicTypes) {
  ...
  public ServerConfiguration serverName(@org.eclipse.jdt.annotation.Nullable
 String serverName) {
 ...
 String serverName) {
  ...
  public ServerConfiguration uiCulture(@org.eclipse.jdt.annotation.Nullable
 String uiCulture) {
 ...
 String uiCulture) {
  ...
  public ServerConfiguration saveMetadataHidden(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean saveMetadataHidden) {
  ...
  public ServerConfiguration contentTypes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<NameValuePair> contentTypes) {
  ...
  public ServerConfiguration remoteClientBitrateLimit(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer remoteClientBitrateLimit) {
  ...
  public ServerConfiguration enableFolderView(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableFolderView) {
  ...
  public ServerConfiguration enableGroupingMoviesIntoCollections(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableGroupingMoviesIntoCollections) {
  ...
  public ServerConfiguration enableGroupingShowsIntoCollections(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableGroupingShowsIntoCollections) {
  ...
  public ServerConfiguration displaySpecialsWithinSeasons(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean displaySpecialsWithinSeasons) {
  ...
  public ServerConfiguration codecsUsed(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> codecsUsed) {
  ...
  public ServerConfiguration pluginRepositories(@org.eclipse.jdt.annotation.Nullable
 ...
 List<RepositoryInfo> pluginRepositories) {
  ...
  public ServerConfiguration enableExternalContentInSuggestions(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableExternalContentInSuggestions) {
  ...
  public ServerConfiguration imageExtractionTimeoutMs(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer imageExtractionTimeoutMs) {
  ...
  public ServerConfiguration pathSubstitutions(@org.eclipse.jdt.annotation.Nullable
 ...
 List<PathSubstitution> pathSubstitutions) {
  ...
  public ServerConfiguration enableSlowResponseWarning(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableSlowResponseWarning) {
  ...
  public ServerConfiguration slowResponseThresholdMs(@org.eclipse.jdt.annotation.Nullable
 ...
 Long slowResponseThresholdMs) {
  ...
  public ServerConfiguration corsHosts(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> corsHosts) {
  ...
  public ServerConfiguration activityLogRetentionDays(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer activityLogRetentionDays) {
  ...
  public ServerConfiguration libraryScanFanoutConcurrency(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer libraryScanFanoutConcurrency) {
  ...
  public ServerConfiguration libraryMetadataRefreshConcurrency(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer libraryMetadataRefreshConcurrency) {
  ...
  public ServerConfiguration allowClientLogUpload(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean allowClientLogUpload) {
  ...
  public ServerConfiguration dummyChapterDuration(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer dummyChapterDuration) {
  ...
  public ServerConfiguration chapterImageResolution(@org.eclipse.jdt.annotation.Nullable
 ...
 ImageResolution chapterImageResolution) {
  ...
  public ServerConfiguration parallelImageEncodingLimit(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer parallelImageEncodingLimit) {
  ...
  public ServerConfiguration castReceiverApplications(@org.eclipse.jdt.annotation.Nullable
 ...
 List<CastReceiverApplication> castReceiverApplications) {
  ...
  public ServerConfiguration trickplayOptions(@org.eclipse.jdt.annotation.Nullable
 ...
 TrickplayOptions trickplayOptions) {
  ...
  public ServerConfiguration enableLegacyAuthorization(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableLegacyAuthorization) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logFileRetentionDays, serverConfiguration.logFileRetentionDays) &&
        ...
        Objects.equals(this.enableGroupingMoviesIntoCollections, serverConfiguration.enableGroupingMoviesIntoCollections) &&
        Objects.equals(this.enableGroupingShowsIntoCollections, serverConfiguration.enableGroupingShowsIntoCollections) &&
  ...
  public String toString() {
    ...
    sb.append("    enableGroupingMoviesIntoCollections: ").append(toIndentedString(enableGroupingMoviesIntoCollections)).append("\n");
    sb.append("    enableGroupingShowsIntoCollections: ").append(toIndentedString(enableGroupingShowsIntoCollections)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLogFileRetentionDays() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLogFileRetentionDays%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLogFileRetentionDays()))));
    }

    // add `IsStartupWizardCompleted` to the URL query string
    if (getIsStartupWizardCompleted() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsStartupWizardCompleted%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsStartupWizardCompleted()))));
    }

    // add `CachePath` to the URL query string
    if (getCachePath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCachePath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCachePath()))));
    }

    // add `PreviousVersion` to the URL query string
    if (getPreviousVersion() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPreviousVersion%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPreviousVersion()))));
    }

    // add `PreviousVersionStr` to the URL query string
    if (getPreviousVersionStr() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPreviousVersionStr%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPreviousVersionStr()))));
    }

    // add `EnableMetrics` to the URL query string
    if (getEnableMetrics() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableMetrics%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableMetrics()))));
    }

    // add `EnableNormalizedItemByNameIds` to the URL query string
    if (getEnableNormalizedItemByNameIds() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableNormalizedItemByNameIds%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableNormalizedItemByNameIds()))));
    }

    // add `IsPortAuthorized` to the URL query string
    if (getIsPortAuthorized() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsPortAuthorized%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsPortAuthorized()))));
    }

    // add `QuickConnectAvailable` to the URL query string
    if (getQuickConnectAvailable() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sQuickConnectAvailable%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getQuickConnectAvailable()))));
    }

    // add `EnableCaseSensitiveItemIds` to the URL query string
    if (getEnableCaseSensitiveItemIds() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableCaseSensitiveItemIds%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableCaseSensitiveItemIds()))));
    }

    // add `DisableLiveTvChannelUserDataName` to the URL query string
    if (getDisableLiveTvChannelUserDataName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDisableLiveTvChannelUserDataName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDisableLiveTvChannelUserDataName()))));
    }

    // add `MetadataPath` to the URL query string
    if (getMetadataPath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMetadataPath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMetadataPath()))));
    }
    ...
    if (getMetadataCountryCode() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMetadataCountryCode%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMetadataCountryCode()))));
    }
    ...
    if (getMinResumePct() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMinResumePct%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMinResumePct()))));
    }

    // add `MaxResumePct` to the URL query string
    if (getMaxResumePct() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxResumePct%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxResumePct()))));
    }

    // add `MinResumeDurationSeconds` to the URL query string
    if (getMinResumeDurationSeconds() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMinResumeDurationSeconds%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMinResumeDurationSeconds()))));
    }

    // add `MinAudiobookResume` to the URL query string
    if (getMinAudiobookResume() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMinAudiobookResume%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMinAudiobookResume()))));
    }

    // add `MaxAudiobookResume` to the URL query string
    if (getMaxAudiobookResume() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxAudiobookResume%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxAudiobookResume()))));
    }

    // add `InactiveSessionThreshold` to the URL query string
    if (getInactiveSessionThreshold() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sInactiveSessionThreshold%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getInactiveSessionThreshold()))));
    }

    // add `LibraryMonitorDelay` to the URL query string
    if (getLibraryMonitorDelay() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLibraryMonitorDelay%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLibraryMonitorDelay()))));
    }

    // add `LibraryUpdateDuration` to the URL query string
    if (getLibraryUpdateDuration() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLibraryUpdateDuration%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLibraryUpdateDuration()))));
    }

    // add `CacheSize` to the URL query string
    if (getCacheSize() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCacheSize%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCacheSize()))));
    }

    // add `ImageSavingConvention` to the URL query string
    if (getImageSavingConvention() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sImageSavingConvention%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getImageSavingConvention()))));
    }
    ...
    if (getMetadataOptions() != null) {
      for (int i = 0; i < getMetadataOptions().size(); i++) {
        if (getMetadataOptions().get(i) != null) {
          joiner.add(getMetadataOptions().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sMetadataOptions%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getSkipDeserializationForBasicTypes() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSkipDeserializationForBasicTypes%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSkipDeserializationForBasicTypes()))));
    }
    ...
    if (getUiCulture() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sUICulture%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUiCulture()))));
    }

    // add `SaveMetadataHidden` to the URL query string
    if (getSaveMetadataHidden() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSaveMetadataHidden%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSaveMetadataHidden()))));
    }
    ...
    if (getContentTypes() != null) {
      for (int i = 0; i < getContentTypes().size(); i++) {
        if (getContentTypes().get(i) != null) {
          joiner.add(getContentTypes().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sContentTypes%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getRemoteClientBitrateLimit() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRemoteClientBitrateLimit%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRemoteClientBitrateLimit()))));
    }

    // add `EnableFolderView` to the URL query string
    if (getEnableFolderView() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableFolderView%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableFolderView()))));
    }

    // add `EnableGroupingMoviesIntoCollections` to the URL query string
    if (getEnableGroupingMoviesIntoCollections() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableGroupingMoviesIntoCollections%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableGroupingMoviesIntoCollections()))));
    }

    // add `EnableGroupingShowsIntoCollections` to the URL query string
    if (getEnableGroupingShowsIntoCollections() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableGroupingShowsIntoCollections%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableGroupingShowsIntoCollections()))));
    }

    // add `DisplaySpecialsWithinSeasons` to the URL query string
    if (getDisplaySpecialsWithinSeasons() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDisplaySpecialsWithinSeasons%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDisplaySpecialsWithinSeasons()))));
    }
    ...
    if (getPluginRepositories() != null) {
      for (int i = 0; i < getPluginRepositories().size(); i++) {
        if (getPluginRepositories().get(i) != null) {
          joiner.add(getPluginRepositories().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sPluginRepositories%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getEnableExternalContentInSuggestions() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableExternalContentInSuggestions%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableExternalContentInSuggestions()))));
    }

    // add `ImageExtractionTimeoutMs` to the URL query string
    if (getImageExtractionTimeoutMs() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sImageExtractionTimeoutMs%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getImageExtractionTimeoutMs()))));
    }
    ...
    if (getPathSubstitutions() != null) {
      for (int i = 0; i < getPathSubstitutions().size(); i++) {
        if (getPathSubstitutions().get(i) != null) {
          joiner.add(getPathSubstitutions().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sPathSubstitutions%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getEnableSlowResponseWarning() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableSlowResponseWarning%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableSlowResponseWarning()))));
    }

    // add `SlowResponseThresholdMs` to the URL query string
    if (getSlowResponseThresholdMs() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSlowResponseThresholdMs%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSlowResponseThresholdMs()))));
    }
    ...
    if (getActivityLogRetentionDays() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sActivityLogRetentionDays%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getActivityLogRetentionDays()))));
    }

    // add `LibraryScanFanoutConcurrency` to the URL query string
    if (getLibraryScanFanoutConcurrency() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLibraryScanFanoutConcurrency%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLibraryScanFanoutConcurrency()))));
    }

    // add `LibraryMetadataRefreshConcurrency` to the URL query string
    if (getLibraryMetadataRefreshConcurrency() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLibraryMetadataRefreshConcurrency%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLibraryMetadataRefreshConcurrency()))));
    }

    // add `AllowClientLogUpload` to the URL query string
    if (getAllowClientLogUpload() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAllowClientLogUpload%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAllowClientLogUpload()))));
    }

    // add `DummyChapterDuration` to the URL query string
    if (getDummyChapterDuration() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDummyChapterDuration%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDummyChapterDuration()))));
    }

    // add `ChapterImageResolution` to the URL query string
    if (getChapterImageResolution() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sChapterImageResolution%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getChapterImageResolution()))));
    }

    // add `ParallelImageEncodingLimit` to the URL query string
    if (getParallelImageEncodingLimit() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sParallelImageEncodingLimit%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getParallelImageEncodingLimit()))));
    }
    ...
    if (getCastReceiverApplications() != null) {
      for (int i = 0; i < getCastReceiverApplications().size(); i++) {
        if (getCastReceiverApplications().get(i) != null) {
          joiner.add(getCastReceiverApplications().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sCastReceiverApplications%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getEnableLegacyAuthorization() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableLegacyAuthorization%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableLegacyAuthorization()))));
    }
    ...
    public ServerConfiguration.Builder enableGroupingMoviesIntoCollections(Boolean enableGroupingMoviesIntoCollections) {
      this.instance.enableGroupingMoviesIntoCollections = enableGroupingMoviesIntoCollections;
      return this;
    }
    public ServerConfiguration.Builder enableGroupingShowsIntoCollections(Boolean enableGroupingShowsIntoCollections) {
    ...
    public ServerConfiguration.Builder castReceiverApplications(List<CastReceiverApplication> castReceiverApplications) {
  ...
  */
  public ServerConfiguration.Builder toBuilder() {
    return new ServerConfiguration.Builder()
      ...
      .inactiveSessionThreshold(getInactiveSessionThreshold())
      .libraryMonitorDelay(getLibraryMonitorDelay())
      .libraryUpdateDuration(getLibraryUpdateDuration())
      ...
      .dummyChapterDuration(getDummyChapterDuration())
      ...
      .trickplayOptions(getTrickplayOptions())
