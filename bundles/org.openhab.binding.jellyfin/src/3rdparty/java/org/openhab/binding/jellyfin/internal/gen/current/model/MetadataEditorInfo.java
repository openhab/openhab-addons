...
import org.openhab.binding.jellyfin.internal.gen.current.model.CountryInfo;
import org.openhab.binding.jellyfin.internal.gen.current.model.CultureDto;
import org.openhab.binding.jellyfin.internal.gen.current.model.ExternalIdInfo;
import org.openhab.binding.jellyfin.internal.gen.current.model.NameValuePair;
import org.openhab.binding.jellyfin.internal.gen.current.model.ParentalRating;
...
public class MetadataEditorInfo {
  ...
  public MetadataEditorInfo parentalRatingOptions(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ParentalRating> parentalRatingOptions) {
  ...
  public MetadataEditorInfo countries(@org.eclipse.jdt.annotation.Nullable
 ...
 List<CountryInfo> countries) {
  ...
  public MetadataEditorInfo cultures(@org.eclipse.jdt.annotation.Nullable
 ...
 List<CultureDto> cultures) {
  ...
  public MetadataEditorInfo externalIdInfos(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ExternalIdInfo> externalIdInfos) {
  ...
  public MetadataEditorInfo contentType(@org.eclipse.jdt.annotation.Nullable
 ...
 CollectionType contentType) {
  ...
  public MetadataEditorInfo contentTypeOptions(@org.eclipse.jdt.annotation.Nullable
    ...
    if (getParentalRatingOptions() != null) {
      for (int i = 0; i < getParentalRatingOptions().size(); i++) {
        if (getParentalRatingOptions().get(i) != null) {
          joiner.add(getParentalRatingOptions().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sParentalRatingOptions%s%s", prefix, suffix,
    ...
    if (getCultures() != null) {
      for (int i = 0; i < getCultures().size(); i++) {
        if (getCultures().get(i) != null) {
          joiner.add(getCultures().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sCultures%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getExternalIdInfos() != null) {
      for (int i = 0; i < getExternalIdInfos().size(); i++) {
        if (getExternalIdInfos().get(i) != null) {
          joiner.add(getExternalIdInfos().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sExternalIdInfos%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getContentTypeOptions() != null) {
      for (int i = 0; i < getContentTypeOptions().size(); i++) {
        if (getContentTypeOptions().get(i) != null) {
          joiner.add(getContentTypeOptions().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sContentTypeOptions%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
