...
public class LibraryUpdateInfo {
  ...
  public LibraryUpdateInfo foldersAddedTo(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> foldersAddedTo) {
  ...
  public LibraryUpdateInfo foldersRemovedFrom(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> foldersRemovedFrom) {
  ...
  public LibraryUpdateInfo itemsAdded(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> itemsAdded) {
  ...
  public LibraryUpdateInfo itemsRemoved(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> itemsRemoved) {
  ...
  public LibraryUpdateInfo itemsUpdated(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> itemsUpdated) {
  ...
  public LibraryUpdateInfo collectionFolders(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> collectionFolders) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsEmpty() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsEmpty%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsEmpty()))));
    }
