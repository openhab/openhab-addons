 ...
 */
@JsonPropertyOrder({
  BackupManifestDto.JSON_PROPERTY_SERVER_VERSION,
  BackupManifestDto.JSON_PROPERTY_BACKUP_ENGINE_VERSION,
  BackupManifestDto.JSON_PROPERTY_DATE_CREATED,
  BackupManifestDto.JSON_PROPERTY_PATH,
  BackupManifestDto.JSON_PROPERTY_OPTIONS
})
...
public class BackupManifestDto {
  ...
  public BackupManifestDto serverVersion(@org.eclipse.jdt.annotation.Nullable
 ...
 String serverVersion) {
  ...
  public BackupManifestDto backupEngineVersion(@org.eclipse.jdt.annotation.Nullable
 ...
 String backupEngineVersion) {
  ...
  public BackupManifestDto dateCreated(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime dateCreated) {
  ...
  public BackupManifestDto path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public BackupManifestDto options(@org.eclipse.jdt.annotation.Nullable
 ...
 BackupOptionsDto options) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBackupEngineVersion() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBackupEngineVersion%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBackupEngineVersion()))));
    }
  ...
  */
  public BackupManifestDto.Builder toBuilder() {
    return new BackupManifestDto.Builder()
      ...
      .backupEngineVersion(getBackupEngineVersion())
