...
public class ForgotPasswordDto {
  ...
  public ForgotPasswordDto enteredUsername(@org.eclipse.jdt.annotation.NonNull
 String enteredUsername) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENTERED_USERNAME, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEnteredUsername(@org.eclipse.jdt.annotation.NonNull
 String enteredUsername) {
    this.enteredUsername = enteredUsername;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEnteredUsername() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnteredUsername%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnteredUsername()))));
    }
