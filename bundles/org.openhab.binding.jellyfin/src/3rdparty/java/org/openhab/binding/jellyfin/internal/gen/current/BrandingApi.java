...
public class BrandingApi {
  ...
  private HttpRequest.Builder getBrandingCssRequestBuilder(Map<String, String> headers) throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "text/css, application/json, application/json; profile=CamelCase, application/json; profile=PascalCase, text/html");
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BrandingOptionsDto> getBrandingOptionsWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<BrandingOptionsDto>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        BrandingOptionsDto responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<BrandingOptionsDto>() {});
