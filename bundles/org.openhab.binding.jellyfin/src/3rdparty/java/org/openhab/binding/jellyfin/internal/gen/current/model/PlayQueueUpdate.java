...
import org.openhab.binding.jellyfin.internal.gen.current.model.GroupRepeatMode;
import org.openhab.binding.jellyfin.internal.gen.current.model.GroupShuffleMode;
import org.openhab.binding.jellyfin.internal.gen.current.model.PlayQueueUpdateReason;
import org.openhab.binding.jellyfin.internal.gen.current.model.SyncPlayQueueItem;
...
public class PlayQueueUpdate {
  ...
  public PlayQueueUpdate reason(@org.eclipse.jdt.annotation.Nullable
 ...
 PlayQueueUpdateReason reason) {
  ...
  public PlayQueueUpdate lastUpdate(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime lastUpdate) {
  ...
  public PlayQueueUpdate playlist(@org.eclipse.jdt.annotation.Nullable
 ...
 List<SyncPlayQueueItem> playlist) {
  ...
  public PlayQueueUpdate playingItemIndex(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer playingItemIndex) {
  ...
  public PlayQueueUpdate startPositionTicks(@org.eclipse.jdt.annotation.Nullable
 ...
 Long startPositionTicks) {
  ...
  public PlayQueueUpdate isPlaying(@org.eclipse.jdt.annotation.Nullable
 Boolean isPlaying) {
 ...
 Boolean isPlaying) {
  ...
  public PlayQueueUpdate shuffleMode(@org.eclipse.jdt.annotation.Nullable
 ...
 GroupShuffleMode shuffleMode) {
  ...
  public PlayQueueUpdate repeatMode(@org.eclipse.jdt.annotation.Nullable
 ...
 GroupRepeatMode repeatMode) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLastUpdate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLastUpdate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLastUpdate()))));
    }
    ...
    if (getPlaylist() != null) {
      for (int i = 0; i < getPlaylist().size(); i++) {
        if (getPlaylist().get(i) != null) {
          joiner.add(getPlaylist().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sPlaylist%s%s", prefix, suffix,
    ...
    if (getPlayingItemIndex() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlayingItemIndex%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlayingItemIndex()))));
    }

    // add `StartPositionTicks` to the URL query string
    if (getStartPositionTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sStartPositionTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getStartPositionTicks()))));
    }

    // add `IsPlaying` to the URL query string
    if (getIsPlaying() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsPlaying%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsPlaying()))));
    }

    // add `ShuffleMode` to the URL query string
    if (getShuffleMode() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sShuffleMode%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getShuffleMode()))));
    }
  ...
  */
  public PlayQueueUpdate.Builder toBuilder() {
    return new PlayQueueUpdate.Builder()
      ...
      .playingItemIndex(getPlayingItemIndex())
