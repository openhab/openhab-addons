...
import org.openhab.binding.jellyfin.internal.gen.current.model.SendCommand;
...
public class SyncPlayCommandMessage {
  ...
  public SyncPlayCommandMessage data(@org.eclipse.jdt.annotation.Nullable
 SendCommand data) {
    this.data = data;
    return this;
  }
 ...
 SendCommand data) {
  ...
  public SyncPlayCommandMessage messageId(@org.eclipse.jdt.annotation.Nullable
 UUID messageId) {
