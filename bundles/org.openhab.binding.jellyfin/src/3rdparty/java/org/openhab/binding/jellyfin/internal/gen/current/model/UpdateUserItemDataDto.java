...
public class UpdateUserItemDataDto {
  ...
  public UpdateUserItemDataDto rating(@org.eclipse.jdt.annotation.Nullable
 Double rating) {
    this.rating = rating;
    return this;
  }
 ...
 Double rating) {
  ...
  public UpdateUserItemDataDto playedPercentage(@org.eclipse.jdt.annotation.Nullable
 ...
 Double playedPercentage) {
  ...
  public UpdateUserItemDataDto unplayedItemCount(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer unplayedItemCount) {
  ...
  public UpdateUserItemDataDto playbackPositionTicks(@org.eclipse.jdt.annotation.Nullable
 ...
 Long playbackPositionTicks) {
  ...
  public UpdateUserItemDataDto playCount(@org.eclipse.jdt.annotation.Nullable
 Integer playCount) {
 ...
 Integer playCount) {
  ...
  public UpdateUserItemDataDto isFavorite(@org.eclipse.jdt.annotation.Nullable
 Boolean isFavorite) {
 ...
 Boolean isFavorite) {
  ...
  public UpdateUserItemDataDto likes(@org.eclipse.jdt.annotation.Nullable
 Boolean likes) {
    this.likes = likes;
    return this;
  }
 ...
 Boolean likes) {
  ...
  public UpdateUserItemDataDto lastPlayedDate(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime lastPlayedDate) {
  ...
  public UpdateUserItemDataDto played(@org.eclipse.jdt.annotation.Nullable
 Boolean played) {
    this.played = played;
    return this;
  }
 ...
 Boolean played) {
  ...
  public UpdateUserItemDataDto key(@org.eclipse.jdt.annotation.Nullable
 String key) {
    this.key = key;
    return this;
  }
 ...
 String key) {
  ...
  public UpdateUserItemDataDto itemId(@org.eclipse.jdt.annotation.Nullable
 String itemId) {
    this.itemId = itemId;
    return this;
  }
 ...
 String itemId) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPlayedPercentage() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlayedPercentage%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlayedPercentage()))));
    }

    // add `UnplayedItemCount` to the URL query string
    if (getUnplayedItemCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sUnplayedItemCount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUnplayedItemCount()))));
    }

    // add `PlaybackPositionTicks` to the URL query string
    if (getPlaybackPositionTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlaybackPositionTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlaybackPositionTicks()))));
    }

    // add `PlayCount` to the URL query string
    if (getPlayCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlayCount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlayCount()))));
    }

    // add `IsFavorite` to the URL query string
    if (getIsFavorite() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsFavorite%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsFavorite()))));
    }
    ...
    if (getLastPlayedDate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLastPlayedDate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLastPlayedDate()))));
    }

    // add `Played` to the URL query string
    if (getPlayed() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlayed%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlayed()))));
    }
