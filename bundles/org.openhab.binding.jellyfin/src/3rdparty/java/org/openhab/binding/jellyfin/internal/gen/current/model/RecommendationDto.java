...
import org.openhab.binding.jellyfin.internal.gen.current.model.RecommendationType;
...
public class RecommendationDto {
  ...
  public RecommendationDto items(@org.eclipse.jdt.annotation.Nullable
 ...
 List<BaseItemDto> items) {
  ...
  public RecommendationDto recommendationType(@org.eclipse.jdt.annotation.Nullable
 ...
 RecommendationType recommendationType) {
  ...
  public RecommendationDto baselineItemName(@org.eclipse.jdt.annotation.Nullable
 ...
 String baselineItemName) {
  ...
  public RecommendationDto categoryId(@org.eclipse.jdt.annotation.Nullable
 UUID categoryId) {
 ...
 UUID categoryId) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBaselineItemName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBaselineItemName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBaselineItemName()))));
    }
