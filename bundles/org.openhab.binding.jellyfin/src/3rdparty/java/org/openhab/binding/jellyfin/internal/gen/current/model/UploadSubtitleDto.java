...
public class UploadSubtitleDto {
  ...
  public UploadSubtitleDto language(@org.eclipse.jdt.annotation.NonNull
 String language) {
  ...
  @JsonProperty(value = JSON_PROPERTY_LANGUAGE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLanguage(@org.eclipse.jdt.annotation.NonNull
 String language) {
    this.language = language;
  }


  public UploadSubtitleDto format(@org.eclipse.jdt.annotation.NonNull
 String format) {
    this.format = format;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_FORMAT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFormat(@org.eclipse.jdt.annotation.NonNull
 String format) {
    this.format = format;
  }


  public UploadSubtitleDto isForced(@org.eclipse.jdt.annotation.NonNull
 Boolean isForced) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_FORCED, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIsForced(@org.eclipse.jdt.annotation.NonNull
 Boolean isForced) {
    this.isForced = isForced;
  }


  public UploadSubtitleDto isHearingImpaired(@org.eclipse.jdt.annotation.NonNull
 Boolean isHearingImpaired) {
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_HEARING_IMPAIRED, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIsHearingImpaired(@org.eclipse.jdt.annotation.NonNull
 Boolean isHearingImpaired) {
    this.isHearingImpaired = isHearingImpaired;
  }


  public UploadSubtitleDto data(@org.eclipse.jdt.annotation.NonNull
 String data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setData(@org.eclipse.jdt.annotation.NonNull
 String data) {
    this.data = data;
  }
