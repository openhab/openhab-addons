...
public class UpdateLibraryOptionsDto {
  ...
  public UpdateLibraryOptionsDto id(@org.eclipse.jdt.annotation.Nullable
 UUID id) {
    this.id = id;
    return this;
  }
 ...
 UUID id) {
  ...
  public UpdateLibraryOptionsDto libraryOptions(@org.eclipse.jdt.annotation.Nullable
