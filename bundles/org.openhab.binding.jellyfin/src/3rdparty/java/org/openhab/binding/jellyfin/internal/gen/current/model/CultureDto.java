...
public class CultureDto {
  ...
  public CultureDto name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public CultureDto displayName(@org.eclipse.jdt.annotation.Nullable
 String displayName) {
 ...
 String displayName) {
  ...
  public CultureDto twoLetterISOLanguageName(@org.eclipse.jdt.annotation.Nullable
 ...
 String twoLetterISOLanguageName) {
  ...
  public CultureDto threeLetterISOLanguageNames(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> threeLetterISOLanguageNames) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTwoLetterISOLanguageName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTwoLetterISOLanguageName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTwoLetterISOLanguageName()))));
    }
