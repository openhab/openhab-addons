...
import org.openhab.binding.jellyfin.internal.gen.current.model.FolderStorageDto;
import org.openhab.binding.jellyfin.internal.gen.current.model.LibraryStorageDto;
 ...
 */
@JsonPropertyOrder({
  SystemStorageDto.JSON_PROPERTY_PROGRAM_DATA_FOLDER,
  SystemStorageDto.JSON_PROPERTY_WEB_FOLDER,
  SystemStorageDto.JSON_PROPERTY_IMAGE_CACHE_FOLDER,
  SystemStorageDto.JSON_PROPERTY_CACHE_FOLDER,
  SystemStorageDto.JSON_PROPERTY_LOG_FOLDER,
  SystemStorageDto.JSON_PROPERTY_INTERNAL_METADATA_FOLDER,
  SystemStorageDto.JSON_PROPERTY_TRANSCODING_TEMP_FOLDER,
  SystemStorageDto.JSON_PROPERTY_LIBRARIES
})
...
public class SystemStorageDto {
  ...
  public SystemStorageDto programDataFolder(@org.eclipse.jdt.annotation.Nullable
 ...
 FolderStorageDto programDataFolder) {
  ...
  public SystemStorageDto webFolder(@org.eclipse.jdt.annotation.Nullable
 ...
 FolderStorageDto webFolder) {
  ...
  public SystemStorageDto imageCacheFolder(@org.eclipse.jdt.annotation.Nullable
 ...
 FolderStorageDto imageCacheFolder) {
  ...
  public SystemStorageDto cacheFolder(@org.eclipse.jdt.annotation.Nullable
 ...
 FolderStorageDto cacheFolder) {
  ...
  public SystemStorageDto logFolder(@org.eclipse.jdt.annotation.Nullable
 ...
 FolderStorageDto logFolder) {
  ...
  public SystemStorageDto internalMetadataFolder(@org.eclipse.jdt.annotation.Nullable
 ...
 FolderStorageDto internalMetadataFolder) {
  ...
  public SystemStorageDto transcodingTempFolder(@org.eclipse.jdt.annotation.Nullable
 ...
 FolderStorageDto transcodingTempFolder) {
  ...
  public SystemStorageDto libraries(@org.eclipse.jdt.annotation.Nullable
 ...
 List<LibraryStorageDto> libraries) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(programDataFolder, webFolder, imageCacheFolder, cacheFolder, logFolder, internalMetadataFolder, transcodingTempFolder, libraries);
  }
    ...
    if (getLibraries() != null) {
      for (int i = 0; i < getLibraries().size(); i++) {
        if (getLibraries().get(i) != null) {
          joiner.add(getLibraries().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sLibraries%s%s", prefix, suffix,
  ...
  */
  public SystemStorageDto.Builder toBuilder() {
    return new SystemStorageDto.Builder()
      .programDataFolder(getProgramDataFolder())
      .webFolder(getWebFolder())
      .imageCacheFolder(getImageCacheFolder())
      .cacheFolder(getCacheFolder())
      .logFolder(getLogFolder())
      .internalMetadataFolder(getInternalMetadataFolder())
      .transcodingTempFolder(getTranscodingTempFolder())
