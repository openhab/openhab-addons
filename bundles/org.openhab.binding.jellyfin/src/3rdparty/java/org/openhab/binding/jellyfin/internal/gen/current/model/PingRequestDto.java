...
public class PingRequestDto {
  ...
  public PingRequestDto ping(@org.eclipse.jdt.annotation.Nullable
 Long ping) {
    this.ping = ping;
    return this;
  }
 ...
 Long ping) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPing() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPing%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPing()))));
    }
