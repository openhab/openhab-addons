...
public class LibraryOptionInfoDto {
  ...
  public LibraryOptionInfoDto name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public LibraryOptionInfoDto defaultEnabled(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean defaultEnabled) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDefaultEnabled() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDefaultEnabled%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDefaultEnabled()))));
    }
