...
public class XbmcMetadataOptions {
  ...
  public XbmcMetadataOptions userId(@org.eclipse.jdt.annotation.Nullable
 String userId) {
    this.userId = userId;
    return this;
  }
 ...
 String userId) {
  ...
  public XbmcMetadataOptions releaseDateFormat(@org.eclipse.jdt.annotation.Nullable
 ...
 String releaseDateFormat) {
  ...
  public XbmcMetadataOptions saveImagePathsInNfo(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean saveImagePathsInNfo) {
  ...
  public XbmcMetadataOptions enablePathSubstitution(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enablePathSubstitution) {
  ...
  public XbmcMetadataOptions enableExtraThumbsDuplication(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableExtraThumbsDuplication) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getReleaseDateFormat() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sReleaseDateFormat%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getReleaseDateFormat()))));
    }

    // add `SaveImagePathsInNfo` to the URL query string
    if (getSaveImagePathsInNfo() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSaveImagePathsInNfo%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSaveImagePathsInNfo()))));
    }

    // add `EnablePathSubstitution` to the URL query string
    if (getEnablePathSubstitution() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnablePathSubstitution%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnablePathSubstitution()))));
    }

    // add `EnableExtraThumbsDuplication` to the URL query string
    if (getEnableExtraThumbsDuplication() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableExtraThumbsDuplication%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableExtraThumbsDuplication()))));
    }
