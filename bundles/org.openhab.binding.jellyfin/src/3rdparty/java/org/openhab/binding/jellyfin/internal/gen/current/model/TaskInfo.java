...
import org.openhab.binding.jellyfin.internal.gen.current.model.TaskState;
...
public class TaskInfo {
  ...
  public TaskInfo name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public TaskInfo state(@org.eclipse.jdt.annotation.Nullable
 TaskState state) {
    this.state = state;
    return this;
  }
 ...
 TaskState state) {
  ...
  public TaskInfo currentProgressPercentage(@org.eclipse.jdt.annotation.Nullable
 ...
 Double currentProgressPercentage) {
  ...
  public TaskInfo id(@org.eclipse.jdt.annotation.Nullable
 String id) {
    this.id = id;
    return this;
  }
 ...
 String id) {
  ...
  public TaskInfo lastExecutionResult(@org.eclipse.jdt.annotation.Nullable
 ...
 TaskResult lastExecutionResult) {
  ...
  public TaskInfo triggers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<TaskTriggerInfo> triggers) {
  ...
  public TaskInfo description(@org.eclipse.jdt.annotation.Nullable
 String description) {
 ...
 String description) {
  ...
  public TaskInfo category(@org.eclipse.jdt.annotation.Nullable
 String category) {
 ...
 String category) {
  ...
  public TaskInfo isHidden(@org.eclipse.jdt.annotation.Nullable
 Boolean isHidden) {
 ...
 Boolean isHidden) {
  ...
  public TaskInfo key(@org.eclipse.jdt.annotation.Nullable
 String key) {
    this.key = key;
    return this;
  }
 ...
 String key) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCurrentProgressPercentage() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCurrentProgressPercentage%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCurrentProgressPercentage()))));
    }
    ...
    if (getTriggers() != null) {
      for (int i = 0; i < getTriggers().size(); i++) {
        if (getTriggers().get(i) != null) {
          joiner.add(getTriggers().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sTriggers%s%s", prefix, suffix,
