...
import org.openhab.binding.jellyfin.internal.gen.current.model.InboundWebSocketMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.OutboundWebSocketMessage;
...
public class WebSocketMessage extends AbstractOpenApiSchema {
    ...
    public static class WebSocketMessageDeserializer extends StdDeserializer<WebSocketMessage> {
        ...
        public WebSocketMessage deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for WebSocketMessage: %d classes match result, expected 1", match));
        }
