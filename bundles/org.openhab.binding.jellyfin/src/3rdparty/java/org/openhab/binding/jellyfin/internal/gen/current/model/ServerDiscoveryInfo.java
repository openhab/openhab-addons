...
public class ServerDiscoveryInfo {
  ...
  public ServerDiscoveryInfo address(@org.eclipse.jdt.annotation.Nullable
 String address) {
 ...
 String address) {
  ...
  public ServerDiscoveryInfo id(@org.eclipse.jdt.annotation.Nullable
 String id) {
    this.id = id;
    return this;
  }
 ...
 String id) {
  ...
  public ServerDiscoveryInfo name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public ServerDiscoveryInfo endpointAddress(@org.eclipse.jdt.annotation.Nullable
 ...
 String endpointAddress) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEndpointAddress() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEndpointAddress%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEndpointAddress()))));
    }
