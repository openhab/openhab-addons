...
import org.openhab.binding.jellyfin.internal.gen.current.model.ProfileConditionType;
import org.openhab.binding.jellyfin.internal.gen.current.model.ProfileConditionValue;
...
public class ProfileCondition {
  ...
  public ProfileCondition condition(@org.eclipse.jdt.annotation.Nullable
 ...
 ProfileConditionType condition) {
  ...
  public ProfileCondition property(@org.eclipse.jdt.annotation.Nullable
 ...
 ProfileConditionValue property) {
  ...
  public ProfileCondition value(@org.eclipse.jdt.annotation.Nullable
 String value) {
    this.value = value;
    return this;
  }
 ...
 String value) {
  ...
  public ProfileCondition isRequired(@org.eclipse.jdt.annotation.Nullable
 Boolean isRequired) {
 ...
 Boolean isRequired) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsRequired() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsRequired%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsRequired()))));
    }
