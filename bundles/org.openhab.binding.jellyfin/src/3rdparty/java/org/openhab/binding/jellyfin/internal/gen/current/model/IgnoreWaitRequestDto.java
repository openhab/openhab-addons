...
public class IgnoreWaitRequestDto {
  ...
  public IgnoreWaitRequestDto ignoreWait(@org.eclipse.jdt.annotation.Nullable
 Boolean ignoreWait) {
 ...
 Boolean ignoreWait) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIgnoreWait() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIgnoreWait%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIgnoreWait()))));
    }
