...
import org.openhab.binding.jellyfin.internal.gen.current.model.CustomDatabaseOption;
 ...
 */
@JsonPropertyOrder({
  CustomDatabaseOptions.JSON_PROPERTY_PLUGIN_NAME,
  CustomDatabaseOptions.JSON_PROPERTY_PLUGIN_ASSEMBLY,
  CustomDatabaseOptions.JSON_PROPERTY_CONNECTION_STRING,
...
public class CustomDatabaseOptions {
  ...
  public CustomDatabaseOptions pluginName(@org.eclipse.jdt.annotation.Nullable
 String pluginName) {
 ...
 String pluginName) {
  ...
  public CustomDatabaseOptions pluginAssembly(@org.eclipse.jdt.annotation.Nullable
 ...
 String pluginAssembly) {
  ...
  public CustomDatabaseOptions connectionString(@org.eclipse.jdt.annotation.Nullable
 ...
 String connectionString) {
  ...
  public CustomDatabaseOptions options(@org.eclipse.jdt.annotation.Nullable
 ...
 List<CustomDatabaseOption> options) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPluginName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPluginName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPluginName()))));
    }

    // add `PluginAssembly` to the URL query string
    if (getPluginAssembly() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPluginAssembly%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPluginAssembly()))));
    }

    // add `ConnectionString` to the URL query string
    if (getConnectionString() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sConnectionString%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getConnectionString()))));
    }
  ...
  */
  public CustomDatabaseOptions.Builder toBuilder() {
    return new CustomDatabaseOptions.Builder()
      ...
      .pluginAssembly(getPluginAssembly())
