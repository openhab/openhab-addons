...
public class NetworkConfiguration {
  ...
  public NetworkConfiguration baseUrl(@org.eclipse.jdt.annotation.Nullable
 String baseUrl) {
 ...
 String baseUrl) {
  ...
  public NetworkConfiguration enableHttps(@org.eclipse.jdt.annotation.Nullable
 Boolean enableHttps) {
 ...
 Boolean enableHttps) {
  ...
  public NetworkConfiguration requireHttps(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean requireHttps) {
  ...
  public NetworkConfiguration certificatePath(@org.eclipse.jdt.annotation.Nullable
 ...
 String certificatePath) {
  ...
  public NetworkConfiguration certificatePassword(@org.eclipse.jdt.annotation.Nullable
 ...
 String certificatePassword) {
  ...
  public NetworkConfiguration internalHttpPort(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer internalHttpPort) {
  ...
  public NetworkConfiguration internalHttpsPort(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer internalHttpsPort) {
  ...
  public NetworkConfiguration publicHttpPort(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer publicHttpPort) {
  ...
  public NetworkConfiguration publicHttpsPort(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer publicHttpsPort) {
  ...
  public NetworkConfiguration autoDiscovery(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean autoDiscovery) {
  ...
  public NetworkConfiguration enableUPnP(@org.eclipse.jdt.annotation.Nullable
 Boolean enableUPnP) {
 ...
 Boolean enableUPnP) {
  ...
  public NetworkConfiguration enableIPv4(@org.eclipse.jdt.annotation.Nullable
 Boolean enableIPv4) {
 ...
 Boolean enableIPv4) {
  ...
  public NetworkConfiguration enableIPv6(@org.eclipse.jdt.annotation.Nullable
 Boolean enableIPv6) {
 ...
 Boolean enableIPv6) {
  ...
  public NetworkConfiguration enableRemoteAccess(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableRemoteAccess) {
  ...
  public NetworkConfiguration localNetworkSubnets(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> localNetworkSubnets) {
  ...
  public NetworkConfiguration localNetworkAddresses(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> localNetworkAddresses) {
  ...
  public NetworkConfiguration knownProxies(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> knownProxies) {
  ...
  public NetworkConfiguration ignoreVirtualInterfaces(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean ignoreVirtualInterfaces) {
  ...
  public NetworkConfiguration virtualInterfaceNames(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> virtualInterfaceNames) {
  ...
  public NetworkConfiguration enablePublishedServerUriByRequest(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enablePublishedServerUriByRequest) {
  ...
  public NetworkConfiguration publishedServerUriBySubnet(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> publishedServerUriBySubnet) {
  ...
  public NetworkConfiguration remoteIPFilter(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> remoteIPFilter) {
  ...
  public NetworkConfiguration isRemoteIPFilterBlacklist(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean isRemoteIPFilterBlacklist) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEnableHttps() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableHttps%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableHttps()))));
    }

    // add `RequireHttps` to the URL query string
    if (getRequireHttps() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRequireHttps%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRequireHttps()))));
    }

    // add `CertificatePath` to the URL query string
    if (getCertificatePath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCertificatePath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCertificatePath()))));
    }

    // add `CertificatePassword` to the URL query string
    if (getCertificatePassword() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCertificatePassword%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCertificatePassword()))));
    }

    // add `InternalHttpPort` to the URL query string
    if (getInternalHttpPort() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sInternalHttpPort%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getInternalHttpPort()))));
    }

    // add `InternalHttpsPort` to the URL query string
    if (getInternalHttpsPort() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sInternalHttpsPort%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getInternalHttpsPort()))));
    }

    // add `PublicHttpPort` to the URL query string
    if (getPublicHttpPort() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPublicHttpPort%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPublicHttpPort()))));
    }

    // add `PublicHttpsPort` to the URL query string
    if (getPublicHttpsPort() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPublicHttpsPort%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPublicHttpsPort()))));
    }

    // add `AutoDiscovery` to the URL query string
    if (getAutoDiscovery() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAutoDiscovery%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAutoDiscovery()))));
    }

    // add `EnableUPnP` to the URL query string
    if (getEnableUPnP() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableUPnP%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableUPnP()))));
    }

    // add `EnableIPv4` to the URL query string
    if (getEnableIPv4() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableIPv4%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableIPv4()))));
    }

    // add `EnableIPv6` to the URL query string
    if (getEnableIPv6() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableIPv6%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableIPv6()))));
    }

    // add `EnableRemoteAccess` to the URL query string
    if (getEnableRemoteAccess() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableRemoteAccess%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableRemoteAccess()))));
    }
    ...
    if (getIgnoreVirtualInterfaces() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIgnoreVirtualInterfaces%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIgnoreVirtualInterfaces()))));
    }
    ...
    if (getEnablePublishedServerUriByRequest() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnablePublishedServerUriByRequest%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnablePublishedServerUriByRequest()))));
    }
    ...
    if (getIsRemoteIPFilterBlacklist() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsRemoteIPFilterBlacklist%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsRemoteIPFilterBlacklist()))));
    }
    ...
    public NetworkConfiguration.Builder enablePublishedServerUriByRequest(Boolean enablePublishedServerUriByRequest) {
  ...
  */
  public NetworkConfiguration.Builder toBuilder() {
    return new NetworkConfiguration.Builder()
      ...
      .requireHttps(getRequireHttps())
      .certificatePath(getCertificatePath())
      .certificatePassword(getCertificatePassword())
      .internalHttpPort(getInternalHttpPort())
      .internalHttpsPort(getInternalHttpsPort())
      .publicHttpPort(getPublicHttpPort())
      .publicHttpsPort(getPublicHttpsPort())
      .autoDiscovery(getAutoDiscovery())
      .enableUPnP(getEnableUPnP())
      .enableIPv4(getEnableIPv4())
      .enableIPv6(getEnableIPv6())
      .enableRemoteAccess(getEnableRemoteAccess())
      .localNetworkSubnets(getLocalNetworkSubnets())
      .localNetworkAddresses(getLocalNetworkAddresses())
      .knownProxies(getKnownProxies())
      ...
      .publishedServerUriBySubnet(getPublishedServerUriBySubnet())
      .remoteIPFilter(getRemoteIPFilter())
