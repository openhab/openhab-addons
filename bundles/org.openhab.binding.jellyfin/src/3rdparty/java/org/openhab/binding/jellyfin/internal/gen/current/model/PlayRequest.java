...
import org.openhab.binding.jellyfin.internal.gen.current.model.PlayCommand;
...
public class PlayRequest {
  ...
  public PlayRequest itemIds(@org.eclipse.jdt.annotation.Nullable
 List<UUID> itemIds) {
 ...
 List<UUID> itemIds) {
  ...
  public PlayRequest startPositionTicks(@org.eclipse.jdt.annotation.Nullable
 ...
 Long startPositionTicks) {
  ...
  public PlayRequest playCommand(@org.eclipse.jdt.annotation.Nullable
 ...
 PlayCommand playCommand) {
  ...
  public PlayRequest controllingUserId(@org.eclipse.jdt.annotation.Nullable
 ...
 UUID controllingUserId) {
  ...
  public PlayRequest subtitleStreamIndex(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer subtitleStreamIndex) {
  ...
  public PlayRequest audioStreamIndex(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer audioStreamIndex) {
  ...
  public PlayRequest mediaSourceId(@org.eclipse.jdt.annotation.Nullable
 ...
 String mediaSourceId) {
  ...
  public PlayRequest startIndex(@org.eclipse.jdt.annotation.Nullable
 Integer startIndex) {
 ...
 Integer startIndex) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPlayCommand() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlayCommand%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlayCommand()))));
    }

    // add `ControllingUserId` to the URL query string
    if (getControllingUserId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sControllingUserId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getControllingUserId()))));
    }
