...
import org.openhab.binding.jellyfin.internal.gen.current.model.ActivityLogEntryMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.ForceKeepAliveMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.GeneralCommandMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.GroupUpdate;
import org.openhab.binding.jellyfin.internal.gen.current.model.LibraryChangedMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.OutboundKeepAliveMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.PlayMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.PlaystateMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.PluginInstallationCancelledMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.PluginInstallationCompletedMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.PluginInstallationFailedMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.PluginInstallingMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.PluginUninstalledMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.RefreshProgressMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.RestartRequiredMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.ScheduledTaskEndedMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.ScheduledTasksInfoMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.SeriesTimerCancelledMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.SeriesTimerCreatedMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.ServerRestartingMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.ServerShuttingDownMessage;
...
import org.openhab.binding.jellyfin.internal.gen.current.model.SyncPlayCommandMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.SyncPlayGroupUpdateMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.TimerCancelledMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.TimerCreatedMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.UserDataChangedMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.UserDeletedMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.UserUpdatedMessage;
...
import org.openhab.binding.jellyfin.internal.gen.JSON;
...
public class OutboundWebSocketMessage extends AbstractOpenApiSchema {
    ...
    public static class OutboundWebSocketMessageDeserializer extends StdDeserializer<OutboundWebSocketMessage> {
        ...
        public OutboundWebSocketMessage deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (SyncPlayGroupUpdateMessage.class.equals(Integer.class) || SyncPlayGroupUpdateMessage.class.equals(Long.class) || SyncPlayGroupUpdateMessage.class.equals(Float.class) || SyncPlayGroupUpdateMessage.class.equals(Double.class) || SyncPlayGroupUpdateMessage.class.equals(Boolean.class) || SyncPlayGroupUpdateMessage.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((SyncPlayGroupUpdateMessage.class.equals(Integer.class) || SyncPlayGroupUpdateMessage.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SyncPlayGroupUpdateMessage.class.equals(Float.class) || SyncPlayGroupUpdateMessage.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
                        attemptParsing |= (SyncPlayGroupUpdateMessage.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SyncPlayGroupUpdateMessage.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for OutboundWebSocketMessage: %d classes match result, expected 1", match));
        }
    ...
    /**
     * Get the actual instance of `SyncPlayGroupUpdateMessage`. If the actual instance is not `SyncPlayGroupUpdateMessage`,
     * the ClassCastException will be thrown.
     *
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof TimerCancelledMessage) {
        if (getActualInstance() != null) {
          joiner.add(((TimerCancelledMessage)getActualInstance()).toUrlQueryString(prefix + "one_of_22" + suffix));
        }
        return joiner.toString();
    }
    ...
    if (getActualInstance() instanceof UserDataChangedMessage) {
        if (getActualInstance() != null) {
          joiner.add(((UserDataChangedMessage)getActualInstance()).toUrlQueryString(prefix + "one_of_24" + suffix));
        }
        return joiner.toString();
    }
    ...
    if (getActualInstance() instanceof SyncPlayGroupUpdateMessage) {
        if (getActualInstance() != null) {
          joiner.add(((SyncPlayGroupUpdateMessage)getActualInstance()).toUrlQueryString(prefix + "one_of_27" + suffix));
        }
        return joiner.toString();
    }
    return null;
