...
import org.openhab.binding.jellyfin.internal.gen.current.model.LiveTvServiceStatus;
...
public class LiveTvServiceInfo {
  ...
  public LiveTvServiceInfo name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public LiveTvServiceInfo homePageUrl(@org.eclipse.jdt.annotation.Nullable
 String homePageUrl) {
 ...
 String homePageUrl) {
  ...
  public LiveTvServiceInfo status(@org.eclipse.jdt.annotation.Nullable
 ...
 LiveTvServiceStatus status) {
  ...
  public LiveTvServiceInfo statusMessage(@org.eclipse.jdt.annotation.Nullable
 ...
 String statusMessage) {
  ...
  public LiveTvServiceInfo version(@org.eclipse.jdt.annotation.Nullable
 String version) {
 ...
 String version) {
  ...
  public LiveTvServiceInfo hasUpdateAvailable(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean hasUpdateAvailable) {
  ...
  public LiveTvServiceInfo isVisible(@org.eclipse.jdt.annotation.Nullable
 Boolean isVisible) {
 ...
 Boolean isVisible) {
  ...
  public LiveTvServiceInfo tuners(@org.eclipse.jdt.annotation.Nullable
 List<String> tuners) {
    this.tuners = tuners;
    return this;
  }
 ...
 List<String> tuners) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getHomePageUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sHomePageUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getHomePageUrl()))));
    }
    ...
    if (getIsVisible() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsVisible%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsVisible()))));
    }
