...
import org.openhab.binding.jellyfin.internal.gen.current.model.LyricLine;
import org.openhab.binding.jellyfin.internal.gen.current.model.LyricMetadata;
...
public class LyricDto {
  ...
  public LyricDto metadata(@org.eclipse.jdt.annotation.Nullable
 ...
 LyricMetadata metadata) {
  ...
  public LyricDto lyrics(@org.eclipse.jdt.annotation.Nullable
    ...
    if (getLyrics() != null) {
      for (int i = 0; i < getLyrics().size(); i++) {
        if (getLyrics().get(i) != null) {
          joiner.add(getLyrics().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sLyrics%s%s", prefix, suffix,
