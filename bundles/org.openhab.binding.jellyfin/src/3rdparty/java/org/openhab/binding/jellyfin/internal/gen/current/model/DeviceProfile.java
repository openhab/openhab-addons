...
import org.openhab.binding.jellyfin.internal.gen.current.model.CodecProfile;
import org.openhab.binding.jellyfin.internal.gen.current.model.ContainerProfile;
import org.openhab.binding.jellyfin.internal.gen.current.model.DirectPlayProfile;
import org.openhab.binding.jellyfin.internal.gen.current.model.SubtitleProfile;
import org.openhab.binding.jellyfin.internal.gen.current.model.TranscodingProfile;
...
public class DeviceProfile {
  ...
  public DeviceProfile name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public DeviceProfile id(@org.eclipse.jdt.annotation.Nullable
 UUID id) {
    this.id = id;
    return this;
  }
 ...
 UUID id) {
  ...
  public DeviceProfile maxStreamingBitrate(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer maxStreamingBitrate) {
  ...
  public DeviceProfile maxStaticBitrate(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer maxStaticBitrate) {
  ...
  public DeviceProfile musicStreamingTranscodingBitrate(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer musicStreamingTranscodingBitrate) {
  ...
  public DeviceProfile maxStaticMusicBitrate(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer maxStaticMusicBitrate) {
  ...
  public DeviceProfile directPlayProfiles(@org.eclipse.jdt.annotation.Nullable
 ...
 List<DirectPlayProfile> directPlayProfiles) {
  ...
  public DeviceProfile transcodingProfiles(@org.eclipse.jdt.annotation.Nullable
 ...
 List<TranscodingProfile> transcodingProfiles) {
  ...
  public DeviceProfile containerProfiles(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ContainerProfile> containerProfiles) {
  ...
  public DeviceProfile codecProfiles(@org.eclipse.jdt.annotation.Nullable
 ...
 List<CodecProfile> codecProfiles) {
  ...
  public DeviceProfile subtitleProfiles(@org.eclipse.jdt.annotation.Nullable
 ...
 List<SubtitleProfile> subtitleProfiles) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMaxStaticBitrate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxStaticBitrate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxStaticBitrate()))));
    }

    // add `MusicStreamingTranscodingBitrate` to the URL query string
    if (getMusicStreamingTranscodingBitrate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMusicStreamingTranscodingBitrate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMusicStreamingTranscodingBitrate()))));
    }

    // add `MaxStaticMusicBitrate` to the URL query string
    if (getMaxStaticMusicBitrate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxStaticMusicBitrate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxStaticMusicBitrate()))));
    }
    ...
    if (getDirectPlayProfiles() != null) {
      for (int i = 0; i < getDirectPlayProfiles().size(); i++) {
        if (getDirectPlayProfiles().get(i) != null) {
          joiner.add(getDirectPlayProfiles().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sDirectPlayProfiles%s%s", prefix, suffix,
    ...
    if (getTranscodingProfiles() != null) {
      for (int i = 0; i < getTranscodingProfiles().size(); i++) {
        if (getTranscodingProfiles().get(i) != null) {
          joiner.add(getTranscodingProfiles().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sTranscodingProfiles%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getContainerProfiles() != null) {
      for (int i = 0; i < getContainerProfiles().size(); i++) {
        if (getContainerProfiles().get(i) != null) {
          joiner.add(getContainerProfiles().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sContainerProfiles%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getCodecProfiles() != null) {
      for (int i = 0; i < getCodecProfiles().size(); i++) {
        if (getCodecProfiles().get(i) != null) {
          joiner.add(getCodecProfiles().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sCodecProfiles%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getSubtitleProfiles() != null) {
      for (int i = 0; i < getSubtitleProfiles().size(); i++) {
        if (getSubtitleProfiles().get(i) != null) {
          joiner.add(getSubtitleProfiles().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sSubtitleProfiles%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
