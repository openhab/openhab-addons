...
public class SubtitleOptions {
  ...
  public SubtitleOptions skipIfEmbeddedSubtitlesPresent(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean skipIfEmbeddedSubtitlesPresent) {
  ...
  public SubtitleOptions skipIfAudioTrackMatches(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean skipIfAudioTrackMatches) {
  ...
  public SubtitleOptions downloadLanguages(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> downloadLanguages) {
  ...
  public SubtitleOptions downloadMovieSubtitles(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean downloadMovieSubtitles) {
  ...
  public SubtitleOptions downloadEpisodeSubtitles(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean downloadEpisodeSubtitles) {
  ...
  public SubtitleOptions openSubtitlesUsername(@org.eclipse.jdt.annotation.Nullable
 ...
 String openSubtitlesUsername) {
  ...
  public SubtitleOptions openSubtitlesPasswordHash(@org.eclipse.jdt.annotation.Nullable
 ...
 String openSubtitlesPasswordHash) {
  ...
  public SubtitleOptions isOpenSubtitleVipAccount(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean isOpenSubtitleVipAccount) {
  ...
  public SubtitleOptions requirePerfectMatch(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean requirePerfectMatch) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSkipIfEmbeddedSubtitlesPresent() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSkipIfEmbeddedSubtitlesPresent%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSkipIfEmbeddedSubtitlesPresent()))));
    }

    // add `SkipIfAudioTrackMatches` to the URL query string
    if (getSkipIfAudioTrackMatches() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSkipIfAudioTrackMatches%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSkipIfAudioTrackMatches()))));
    }
    ...
    if (getDownloadMovieSubtitles() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDownloadMovieSubtitles%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDownloadMovieSubtitles()))));
    }

    // add `DownloadEpisodeSubtitles` to the URL query string
    if (getDownloadEpisodeSubtitles() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDownloadEpisodeSubtitles%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDownloadEpisodeSubtitles()))));
    }

    // add `OpenSubtitlesUsername` to the URL query string
    if (getOpenSubtitlesUsername() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sOpenSubtitlesUsername%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getOpenSubtitlesUsername()))));
    }

    // add `OpenSubtitlesPasswordHash` to the URL query string
    if (getOpenSubtitlesPasswordHash() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sOpenSubtitlesPasswordHash%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getOpenSubtitlesPasswordHash()))));
    }

    // add `IsOpenSubtitleVipAccount` to the URL query string
    if (getIsOpenSubtitleVipAccount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsOpenSubtitleVipAccount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsOpenSubtitleVipAccount()))));
    }

    // add `RequirePerfectMatch` to the URL query string
    if (getRequirePerfectMatch() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRequirePerfectMatch%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRequirePerfectMatch()))));
    }
