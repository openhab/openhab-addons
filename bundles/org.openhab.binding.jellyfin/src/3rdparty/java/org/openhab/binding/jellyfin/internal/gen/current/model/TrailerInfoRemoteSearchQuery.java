...
import org.openhab.binding.jellyfin.internal.gen.current.model.TrailerInfo;
 ...
 */
@JsonPropertyOrder({
  TrailerInfoRemoteSearchQuery.JSON_PROPERTY_SEARCH_INFO,
...
public class TrailerInfoRemoteSearchQuery {
  ...
  public TrailerInfoRemoteSearchQuery searchInfo(@org.eclipse.jdt.annotation.Nullable
 ...
 TrailerInfo searchInfo) {
  ...
  public TrailerInfoRemoteSearchQuery itemId(@org.eclipse.jdt.annotation.Nullable
 UUID itemId) {
    this.itemId = itemId;
    return this;
  }
 ...
 UUID itemId) {
  ...
  public TrailerInfoRemoteSearchQuery searchProviderName(@org.eclipse.jdt.annotation.Nullable
 ...
 String searchProviderName) {
  ...
  public TrailerInfoRemoteSearchQuery includeDisabledProviders(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean includeDisabledProviders) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSearchProviderName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSearchProviderName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSearchProviderName()))));
    }

    // add `IncludeDisabledProviders` to the URL query string
    if (getIncludeDisabledProviders() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIncludeDisabledProviders%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIncludeDisabledProviders()))));
    }
