...
public class UpdateMediaPathRequestDto {
  ...
  public UpdateMediaPathRequestDto name(@org.eclipse.jdt.annotation.NonNull
 String name) {
    this.name = name;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_NAME, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setName(@org.eclipse.jdt.annotation.NonNull
 String name) {
    this.name = name;
  }


  public UpdateMediaPathRequestDto pathInfo(@org.eclipse.jdt.annotation.NonNull
 MediaPathInfo pathInfo) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PATH_INFO, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPathInfo(@org.eclipse.jdt.annotation.NonNull
 MediaPathInfo pathInfo) {
    this.pathInfo = pathInfo;
  }
