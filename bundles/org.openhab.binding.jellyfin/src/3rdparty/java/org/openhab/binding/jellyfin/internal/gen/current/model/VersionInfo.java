...
public class VersionInfo {
  ...
  public VersionInfo version(@org.eclipse.jdt.annotation.Nullable
 String version) {
 ...
 String version) {
  ...
  public VersionInfo changelog(@org.eclipse.jdt.annotation.Nullable
 String changelog) {
 ...
 String changelog) {
  ...
  public VersionInfo targetAbi(@org.eclipse.jdt.annotation.Nullable
 String targetAbi) {
 ...
 String targetAbi) {
  ...
  public VersionInfo sourceUrl(@org.eclipse.jdt.annotation.Nullable
 String sourceUrl) {
 ...
 String sourceUrl) {
  ...
  public VersionInfo checksum(@org.eclipse.jdt.annotation.Nullable
 String checksum) {
 ...
 String checksum) {
  ...
  public VersionInfo timestamp(@org.eclipse.jdt.annotation.Nullable
 String timestamp) {
 ...
 String timestamp) {
  ...
  public VersionInfo repositoryName(@org.eclipse.jdt.annotation.Nullable
 ...
 String repositoryName) {
  ...
  public VersionInfo repositoryUrl(@org.eclipse.jdt.annotation.Nullable
 ...
 String repositoryUrl) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getVersionNumber() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sVersionNumber%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVersionNumber()))));
    }

    // add `changelog` to the URL query string
    if (getChangelog() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%schangelog%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getChangelog()))));
    }

    // add `targetAbi` to the URL query string
    if (getTargetAbi() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%stargetAbi%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTargetAbi()))));
    }
    ...
    if (getRepositoryName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%srepositoryName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRepositoryName()))));
    }

    // add `repositoryUrl` to the URL query string
    if (getRepositoryUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%srepositoryUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRepositoryUrl()))));
    }
