...
public class EndPointInfo {
  ...
  public EndPointInfo isLocal(@org.eclipse.jdt.annotation.Nullable
 Boolean isLocal) {
 ...
 Boolean isLocal) {
  ...
  public EndPointInfo isInNetwork(@org.eclipse.jdt.annotation.Nullable
 Boolean isInNetwork) {
 ...
 Boolean isInNetwork) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIsLocal() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsLocal%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsLocal()))));
    }

    // add `IsInNetwork` to the URL query string
    if (getIsInNetwork() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsInNetwork%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsInNetwork()))));
    }
