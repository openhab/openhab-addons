...
public class MediaUpdateInfoPathDto {
  ...
  public MediaUpdateInfoPathDto path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public MediaUpdateInfoPathDto updateType(@org.eclipse.jdt.annotation.Nullable
 String updateType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_UPDATE_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUpdateType(@org.eclipse.jdt.annotation.Nullable
 String updateType) {
    this.updateType = updateType;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getUpdateType() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sUpdateType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUpdateType()))));
    }
