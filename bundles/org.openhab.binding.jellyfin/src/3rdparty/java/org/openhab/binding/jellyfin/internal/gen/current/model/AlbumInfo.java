...
import java.util.Map;
import org.openhab.binding.jellyfin.internal.gen.current.model.SongInfo;
 ...
 */
@JsonPropertyOrder({
  AlbumInfo.JSON_PROPERTY_NAME,
  AlbumInfo.JSON_PROPERTY_ORIGINAL_TITLE,
  AlbumInfo.JSON_PROPERTY_PATH,
  AlbumInfo.JSON_PROPERTY_METADATA_LANGUAGE,
  AlbumInfo.JSON_PROPERTY_METADATA_COUNTRY_CODE,
  AlbumInfo.JSON_PROPERTY_PROVIDER_IDS,
  AlbumInfo.JSON_PROPERTY_YEAR,
  AlbumInfo.JSON_PROPERTY_INDEX_NUMBER,
  AlbumInfo.JSON_PROPERTY_PARENT_INDEX_NUMBER,
  AlbumInfo.JSON_PROPERTY_PREMIERE_DATE,
  AlbumInfo.JSON_PROPERTY_IS_AUTOMATED,
  AlbumInfo.JSON_PROPERTY_ALBUM_ARTISTS,
...
public class AlbumInfo {
  ...
  public AlbumInfo name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public AlbumInfo originalTitle(@org.eclipse.jdt.annotation.Nullable
 ...
 String originalTitle) {
  ...
  public AlbumInfo path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public AlbumInfo metadataLanguage(@org.eclipse.jdt.annotation.Nullable
 ...
 String metadataLanguage) {
  ...
  public AlbumInfo metadataCountryCode(@org.eclipse.jdt.annotation.Nullable
 ...
 String metadataCountryCode) {
  ...
  public AlbumInfo providerIds(@org.eclipse.jdt.annotation.Nullable
 ...
 Map<String, String> providerIds) {
  ...
  public AlbumInfo year(@org.eclipse.jdt.annotation.Nullable
 Integer year) {
    this.year = year;
    return this;
  }
 ...
 Integer year) {
  ...
  public AlbumInfo indexNumber(@org.eclipse.jdt.annotation.Nullable
 Integer indexNumber) {
 ...
 Integer indexNumber) {
  ...
  public AlbumInfo parentIndexNumber(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer parentIndexNumber) {
  ...
  public AlbumInfo premiereDate(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime premiereDate) {
  ...
  public AlbumInfo isAutomated(@org.eclipse.jdt.annotation.Nullable
 Boolean isAutomated) {
 ...
 Boolean isAutomated) {
  ...
  public AlbumInfo albumArtists(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> albumArtists) {
  ...
  public AlbumInfo artistProviderIds(@org.eclipse.jdt.annotation.Nullable
 Map<String, String> artistProviderIds) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ARTIST_PROVIDER_IDS)
  @JsonInclude(content = JsonInclude.Include.ALWAYS, value = JsonInclude.Include.USE_DEFAULTS)
  public void setArtistProviderIds(@org.eclipse.jdt.annotation.Nullable
 Map<String, String> artistProviderIds) {
    this.artistProviderIds = artistProviderIds;
  }


  public AlbumInfo songInfos(@org.eclipse.jdt.annotation.Nullable
 List<SongInfo> songInfos) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SONG_INFOS)
  public void setSongInfos(@org.eclipse.jdt.annotation.Nullable
 List<SongInfo> songInfos) {
    this.songInfos = songInfos;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, albumInfo.name) &&
        Objects.equals(this.originalTitle, albumInfo.originalTitle) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, originalTitle, path, metadataLanguage, metadataCountryCode, providerIds, year, indexNumber, parentIndexNumber, premiereDate, isAutomated, albumArtists, artistProviderIds, songInfos);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMetadataLanguage() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMetadataLanguage%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMetadataLanguage()))));
    }
    ...
    if (getIsAutomated() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsAutomated%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsAutomated()))));
    }
    ...
    if (getArtistProviderIds() != null) {
      for (String _key : getArtistProviderIds().keySet()) {
        joiner.add(String.format(java.util.Locale.ROOT, "%sArtistProviderIds%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, _key, containerSuffix),
            getArtistProviderIds().get(_key), ApiClient.urlEncode(ApiClient.valueToString(getArtistProviderIds().get(_key)))));
      }
    }
    ...
    if (getSongInfos() != null) {
      for (int i = 0; i < getSongInfos().size(); i++) {
        if (getSongInfos().get(i) != null) {
          joiner.add(getSongInfos().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sSongInfos%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
  ...
  */
  public AlbumInfo.Builder toBuilder() {
    return new AlbumInfo.Builder()
      ...
      .artistProviderIds(getArtistProviderIds())
