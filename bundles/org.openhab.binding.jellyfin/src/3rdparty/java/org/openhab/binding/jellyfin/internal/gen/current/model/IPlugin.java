...
public class IPlugin {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAssemblyFilePath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAssemblyFilePath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAssemblyFilePath()))));
    }
    ...
    if (getDataFolderPath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDataFolderPath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDataFolderPath()))));
    }
