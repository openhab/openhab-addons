...
import org.openhab.binding.jellyfin.internal.gen.current.model.GroupStateType;
...
public class GroupInfoDto {
  ...
  public GroupInfoDto groupId(@org.eclipse.jdt.annotation.Nullable
 UUID groupId) {
 ...
 UUID groupId) {
  ...
  public GroupInfoDto groupName(@org.eclipse.jdt.annotation.Nullable
 String groupName) {
 ...
 String groupName) {
  ...
  public GroupInfoDto state(@org.eclipse.jdt.annotation.Nullable
 ...
 GroupStateType state) {
  ...
  public GroupInfoDto participants(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> participants) {
  ...
  public GroupInfoDto lastUpdatedAt(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime lastUpdatedAt) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getLastUpdatedAt() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLastUpdatedAt%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLastUpdatedAt()))));
    }
