...
public class RemoteSearchResult {
  ...
  public RemoteSearchResult name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public RemoteSearchResult providerIds(@org.eclipse.jdt.annotation.Nullable
 ...
 Map<String, String> providerIds) {
  ...
  public RemoteSearchResult productionYear(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer productionYear) {
  ...
  public RemoteSearchResult indexNumber(@org.eclipse.jdt.annotation.Nullable
 Integer indexNumber) {
 ...
 Integer indexNumber) {
  ...
  public RemoteSearchResult indexNumberEnd(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer indexNumberEnd) {
  ...
  public RemoteSearchResult parentIndexNumber(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer parentIndexNumber) {
  ...
  public RemoteSearchResult premiereDate(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime premiereDate) {
  ...
  public RemoteSearchResult imageUrl(@org.eclipse.jdt.annotation.Nullable
 String imageUrl) {
 ...
 String imageUrl) {
  ...
  public RemoteSearchResult searchProviderName(@org.eclipse.jdt.annotation.Nullable
 ...
 String searchProviderName) {
  ...
  public RemoteSearchResult overview(@org.eclipse.jdt.annotation.Nullable
 String overview) {
 ...
 String overview) {
  ...
  public RemoteSearchResult albumArtist(@org.eclipse.jdt.annotation.Nullable
 ...
 RemoteSearchResult albumArtist) {
  ...
  public RemoteSearchResult artists(@org.eclipse.jdt.annotation.Nullable
    ...
    if (getArtists() != null) {
      for (int i = 0; i < getArtists().size(); i++) {
        if (getArtists().get(i) != null) {
          joiner.add(getArtists().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sArtists%s%s", prefix, suffix,
