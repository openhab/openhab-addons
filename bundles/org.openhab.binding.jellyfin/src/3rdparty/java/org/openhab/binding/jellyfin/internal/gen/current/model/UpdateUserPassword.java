...
public class UpdateUserPassword {
  ...
  public UpdateUserPassword currentPassword(@org.eclipse.jdt.annotation.Nullable
 ...
 String currentPassword) {
  ...
  public UpdateUserPassword currentPw(@org.eclipse.jdt.annotation.Nullable
 String currentPw) {
 ...
 String currentPw) {
  ...
  public UpdateUserPassword newPw(@org.eclipse.jdt.annotation.Nullable
 String newPw) {
    this.newPw = newPw;
    return this;
  }
 ...
 String newPw) {
  ...
  public UpdateUserPassword resetPassword(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean resetPassword) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCurrentPw() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCurrentPw%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCurrentPw()))));
    }

    // add `NewPw` to the URL query string
    if (getNewPw() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sNewPw%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNewPw()))));
    }

    // add `ResetPassword` to the URL query string
    if (getResetPassword() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sResetPassword%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getResetPassword()))));
    }
