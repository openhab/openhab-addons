...
import org.openhab.binding.jellyfin.internal.gen.current.model.AudioSpatialFormat;
import org.openhab.binding.jellyfin.internal.gen.current.model.MediaStreamType;
import org.openhab.binding.jellyfin.internal.gen.current.model.SubtitleDeliveryMethod;
import org.openhab.binding.jellyfin.internal.gen.current.model.VideoRange;
import org.openhab.binding.jellyfin.internal.gen.current.model.VideoRangeType;
...
@JsonPropertyOrder({
  ...
  MediaStream.JSON_PROPERTY_ROTATION,
  ...
  MediaStream.JSON_PROPERTY_HDR10_PLUS_PRESENT_FLAG,
  ...
  MediaStream.JSON_PROPERTY_AUDIO_SPATIAL_FORMAT,
  ...
  MediaStream.JSON_PROPERTY_LOCALIZED_HEARING_IMPAIRED,
  ...
  MediaStream.JSON_PROPERTY_IS_HEARING_IMPAIRED,
  ...
  MediaStream.JSON_PROPERTY_REFERENCE_FRAME_RATE,
...
public class MediaStream {
  ...
  @JsonCreator
  public MediaStream(
    @JsonProperty(JSON_PROPERTY_VIDEO_RANGE) VideoRange videoRange, 
  ...
  public MediaStream codec(@org.eclipse.jdt.annotation.Nullable
 String codec) {
    this.codec = codec;
    return this;
  }
 ...
 String codec) {
  ...
  public MediaStream codecTag(@org.eclipse.jdt.annotation.Nullable
 String codecTag) {
 ...
 String codecTag) {
  ...
  public MediaStream language(@org.eclipse.jdt.annotation.Nullable
 String language) {
 ...
 String language) {
  ...
  public MediaStream colorRange(@org.eclipse.jdt.annotation.Nullable
 String colorRange) {
 ...
 String colorRange) {
  ...
  public MediaStream colorSpace(@org.eclipse.jdt.annotation.Nullable
 String colorSpace) {
 ...
 String colorSpace) {
  ...
  public MediaStream colorTransfer(@org.eclipse.jdt.annotation.Nullable
 ...
 String colorTransfer) {
  ...
  public MediaStream colorPrimaries(@org.eclipse.jdt.annotation.Nullable
 ...
 String colorPrimaries) {
  ...
  public MediaStream dvVersionMajor(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer dvVersionMajor) {
  ...
  public MediaStream dvVersionMinor(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer dvVersionMinor) {
  ...
  public MediaStream dvProfile(@org.eclipse.jdt.annotation.Nullable
 Integer dvProfile) {
 ...
 Integer dvProfile) {
  ...
  public MediaStream dvLevel(@org.eclipse.jdt.annotation.Nullable
 Integer dvLevel) {
 ...
 Integer dvLevel) {
  ...
  public MediaStream rpuPresentFlag(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer rpuPresentFlag) {
  ...
  public MediaStream elPresentFlag(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer elPresentFlag) {
  ...
  public MediaStream blPresentFlag(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer blPresentFlag) {
  ...
  public MediaStream dvBlSignalCompatibilityId(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer dvBlSignalCompatibilityId) {
  ...
  public MediaStream rotation(@org.eclipse.jdt.annotation.Nullable
 Integer rotation) {
 ...
 Integer rotation) {
  ...
  public MediaStream comment(@org.eclipse.jdt.annotation.Nullable
 String comment) {
 ...
 String comment) {
  ...
  public MediaStream timeBase(@org.eclipse.jdt.annotation.Nullable
 String timeBase) {
 ...
 String timeBase) {
  ...
  public MediaStream codecTimeBase(@org.eclipse.jdt.annotation.Nullable
 ...
 String codecTimeBase) {
  ...
  public MediaStream title(@org.eclipse.jdt.annotation.Nullable
 String title) {
    this.title = title;
    return this;
  }
 ...
 String title) {
  ...
  public MediaStream hdr10PlusPresentFlag(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean hdr10PlusPresentFlag) {
  ...
  public MediaStream localizedUndefined(@org.eclipse.jdt.annotation.Nullable
 ...
 String localizedUndefined) {
  ...
  public MediaStream localizedDefault(@org.eclipse.jdt.annotation.Nullable
 ...
 String localizedDefault) {
  ...
  public MediaStream localizedForced(@org.eclipse.jdt.annotation.Nullable
 ...
 String localizedForced) {
  ...
  public MediaStream localizedExternal(@org.eclipse.jdt.annotation.Nullable
 ...
 String localizedExternal) {
  ...
  public MediaStream localizedHearingImpaired(@org.eclipse.jdt.annotation.Nullable
 ...
 String localizedHearingImpaired) {
  ...
  public MediaStream nalLengthSize(@org.eclipse.jdt.annotation.Nullable
 ...
 String nalLengthSize) {
  ...
  public MediaStream isInterlaced(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean isInterlaced) {
  ...
  public MediaStream isAVC(@org.eclipse.jdt.annotation.Nullable
 Boolean isAVC) {
    this.isAVC = isAVC;
    return this;
  }
 ...
 Boolean isAVC) {
  ...
  public MediaStream channelLayout(@org.eclipse.jdt.annotation.Nullable
 ...
 String channelLayout) {
  ...
  public MediaStream bitRate(@org.eclipse.jdt.annotation.Nullable
 Integer bitRate) {
 ...
 Integer bitRate) {
  ...
  public MediaStream bitDepth(@org.eclipse.jdt.annotation.Nullable
 Integer bitDepth) {
 ...
 Integer bitDepth) {
  ...
  public MediaStream refFrames(@org.eclipse.jdt.annotation.Nullable
 Integer refFrames) {
 ...
 Integer refFrames) {
  ...
  public MediaStream packetLength(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer packetLength) {
  ...
  public MediaStream channels(@org.eclipse.jdt.annotation.Nullable
 Integer channels) {
 ...
 Integer channels) {
  ...
  public MediaStream sampleRate(@org.eclipse.jdt.annotation.Nullable
 Integer sampleRate) {
 ...
 Integer sampleRate) {
  ...
  public MediaStream isDefault(@org.eclipse.jdt.annotation.Nullable
 Boolean isDefault) {
 ...
 Boolean isDefault) {
  ...
  public MediaStream isForced(@org.eclipse.jdt.annotation.Nullable
 Boolean isForced) {
 ...
 Boolean isForced) {
  ...
  public MediaStream isHearingImpaired(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean isHearingImpaired) {
  ...
  public MediaStream height(@org.eclipse.jdt.annotation.Nullable
 Integer height) {
    this.height = height;
    return this;
  }
 ...
 Integer height) {
  ...
  public MediaStream width(@org.eclipse.jdt.annotation.Nullable
 Integer width) {
    this.width = width;
    return this;
  }
 ...
 Integer width) {
  ...
  public MediaStream averageFrameRate(@org.eclipse.jdt.annotation.Nullable
 ...
 Float averageFrameRate) {
  ...
  public MediaStream realFrameRate(@org.eclipse.jdt.annotation.Nullable
 Float realFrameRate) {
 ...
 Float realFrameRate) {
  ...
  public MediaStream profile(@org.eclipse.jdt.annotation.Nullable
 String profile) {
 ...
 String profile) {
  ...
  public MediaStream type(@org.eclipse.jdt.annotation.Nullable
 ...
 MediaStreamType type) {
  ...
  public MediaStream aspectRatio(@org.eclipse.jdt.annotation.Nullable
 String aspectRatio) {
 ...
 String aspectRatio) {
  ...
  public MediaStream index(@org.eclipse.jdt.annotation.Nullable
 Integer index) {
    this.index = index;
    return this;
  }
 ...
 Integer index) {
  ...
  public MediaStream score(@org.eclipse.jdt.annotation.Nullable
 Integer score) {
    this.score = score;
    return this;
  }
 ...
 Integer score) {
  ...
  public MediaStream isExternal(@org.eclipse.jdt.annotation.Nullable
 Boolean isExternal) {
 ...
 Boolean isExternal) {
  ...
  public MediaStream deliveryMethod(@org.eclipse.jdt.annotation.Nullable
 ...
 SubtitleDeliveryMethod deliveryMethod) {
  ...
  public MediaStream deliveryUrl(@org.eclipse.jdt.annotation.Nullable
 String deliveryUrl) {
 ...
 String deliveryUrl) {
  ...
  public MediaStream isExternalUrl(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean isExternalUrl) {
  ...
  public MediaStream supportsExternalStream(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean supportsExternalStream) {
  ...
  public MediaStream path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public MediaStream pixelFormat(@org.eclipse.jdt.annotation.Nullable
 String pixelFormat) {
 ...
 String pixelFormat) {
  ...
  public MediaStream level(@org.eclipse.jdt.annotation.Nullable
 Double level) {
    this.level = level;
    return this;
  }
 ...
 Double level) {
  ...
  public MediaStream isAnamorphic(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean isAnamorphic) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCodec() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCodec%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCodec()))));
    }

    // add `CodecTag` to the URL query string
    if (getCodecTag() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCodecTag%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCodecTag()))));
    }
    ...
    if (getColorRange() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sColorRange%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getColorRange()))));
    }

    // add `ColorSpace` to the URL query string
    if (getColorSpace() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sColorSpace%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getColorSpace()))));
    }

    // add `ColorTransfer` to the URL query string
    if (getColorTransfer() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sColorTransfer%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getColorTransfer()))));
    }

    // add `ColorPrimaries` to the URL query string
    if (getColorPrimaries() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sColorPrimaries%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getColorPrimaries()))));
    }

    // add `DvVersionMajor` to the URL query string
    if (getDvVersionMajor() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDvVersionMajor%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDvVersionMajor()))));
    }

    // add `DvVersionMinor` to the URL query string
    if (getDvVersionMinor() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDvVersionMinor%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDvVersionMinor()))));
    }

    // add `DvProfile` to the URL query string
    if (getDvProfile() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDvProfile%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDvProfile()))));
    }

    // add `DvLevel` to the URL query string
    if (getDvLevel() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDvLevel%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDvLevel()))));
    }

    // add `RpuPresentFlag` to the URL query string
    if (getRpuPresentFlag() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRpuPresentFlag%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRpuPresentFlag()))));
    }

    // add `ElPresentFlag` to the URL query string
    if (getElPresentFlag() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sElPresentFlag%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getElPresentFlag()))));
    }

    // add `BlPresentFlag` to the URL query string
    if (getBlPresentFlag() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBlPresentFlag%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBlPresentFlag()))));
    }

    // add `DvBlSignalCompatibilityId` to the URL query string
    if (getDvBlSignalCompatibilityId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDvBlSignalCompatibilityId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDvBlSignalCompatibilityId()))));
    }
    ...
    if (getTimeBase() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sTimeBase%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getTimeBase()))));
    }

    // add `CodecTimeBase` to the URL query string
    if (getCodecTimeBase() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCodecTimeBase%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCodecTimeBase()))));
    }
    ...
    if (getHdr10PlusPresentFlag() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sHdr10PlusPresentFlag%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getHdr10PlusPresentFlag()))));
    }

    // add `VideoRange` to the URL query string
    if (getVideoRange() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sVideoRange%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVideoRange()))));
    }

    // add `VideoRangeType` to the URL query string
    if (getVideoRangeType() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sVideoRangeType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVideoRangeType()))));
    }

    // add `VideoDoViTitle` to the URL query string
    if (getVideoDoViTitle() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sVideoDoViTitle%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVideoDoViTitle()))));
    }

    // add `AudioSpatialFormat` to the URL query string
    if (getAudioSpatialFormat() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAudioSpatialFormat%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAudioSpatialFormat()))));
    }

    // add `LocalizedUndefined` to the URL query string
    if (getLocalizedUndefined() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLocalizedUndefined%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLocalizedUndefined()))));
    }

    // add `LocalizedDefault` to the URL query string
    if (getLocalizedDefault() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLocalizedDefault%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLocalizedDefault()))));
    }

    // add `LocalizedForced` to the URL query string
    if (getLocalizedForced() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLocalizedForced%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLocalizedForced()))));
    }

    // add `LocalizedExternal` to the URL query string
    if (getLocalizedExternal() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLocalizedExternal%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLocalizedExternal()))));
    }

    // add `LocalizedHearingImpaired` to the URL query string
    if (getLocalizedHearingImpaired() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLocalizedHearingImpaired%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLocalizedHearingImpaired()))));
    }

    // add `DisplayTitle` to the URL query string
    if (getDisplayTitle() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDisplayTitle%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDisplayTitle()))));
    }

    // add `NalLengthSize` to the URL query string
    if (getNalLengthSize() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sNalLengthSize%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNalLengthSize()))));
    }

    // add `IsInterlaced` to the URL query string
    if (getIsInterlaced() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsInterlaced%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsInterlaced()))));
    }

    // add `IsAVC` to the URL query string
    if (getIsAVC() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsAVC%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsAVC()))));
    }

    // add `ChannelLayout` to the URL query string
    if (getChannelLayout() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sChannelLayout%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getChannelLayout()))));
    }

    // add `BitRate` to the URL query string
    if (getBitRate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBitRate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBitRate()))));
    }

    // add `BitDepth` to the URL query string
    if (getBitDepth() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBitDepth%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBitDepth()))));
    }

    // add `RefFrames` to the URL query string
    if (getRefFrames() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRefFrames%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRefFrames()))));
    }

    // add `PacketLength` to the URL query string
    if (getPacketLength() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPacketLength%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPacketLength()))));
    }
    ...
    if (getIsForced() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsForced%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsForced()))));
    }

    // add `IsHearingImpaired` to the URL query string
    if (getIsHearingImpaired() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsHearingImpaired%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsHearingImpaired()))));
    }
    ...
    if (getAverageFrameRate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAverageFrameRate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAverageFrameRate()))));
    }

    // add `RealFrameRate` to the URL query string
    if (getRealFrameRate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRealFrameRate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRealFrameRate()))));
    }

    // add `ReferenceFrameRate` to the URL query string
    if (getReferenceFrameRate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sReferenceFrameRate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getReferenceFrameRate()))));
    }

    // add `Profile` to the URL query string
    if (getProfile() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sProfile%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getProfile()))));
    }
    ...
    if (getDeliveryUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sDeliveryUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDeliveryUrl()))));
    }

    // add `IsExternalUrl` to the URL query string
    if (getIsExternalUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsExternalUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsExternalUrl()))));
    }

    // add `IsTextSubtitleStream` to the URL query string
    if (getIsTextSubtitleStream() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsTextSubtitleStream%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsTextSubtitleStream()))));
    }

    // add `SupportsExternalStream` to the URL query string
    if (getSupportsExternalStream() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSupportsExternalStream%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSupportsExternalStream()))));
    }
    ...
    if (getPixelFormat() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPixelFormat%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPixelFormat()))));
    }
    ...
    if (getIsAnamorphic() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsAnamorphic%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsAnamorphic()))));
    }
  ...
  */
  public MediaStream.Builder toBuilder() {
    return new MediaStream.Builder()
      ...
      .colorTransfer(getColorTransfer())
      .colorPrimaries(getColorPrimaries())
      .dvVersionMajor(getDvVersionMajor())
      .dvVersionMinor(getDvVersionMinor())
      .dvProfile(getDvProfile())
      .dvLevel(getDvLevel())
      .rpuPresentFlag(getRpuPresentFlag())
      .elPresentFlag(getElPresentFlag())
      .blPresentFlag(getBlPresentFlag())
      .dvBlSignalCompatibilityId(getDvBlSignalCompatibilityId())
      .rotation(getRotation())
      .comment(getComment())
      .timeBase(getTimeBase())
      .codecTimeBase(getCodecTimeBase())
      .title(getTitle())
      .hdr10PlusPresentFlag(getHdr10PlusPresentFlag())
      .videoRange(getVideoRange())
      .videoRangeType(getVideoRangeType())
      .videoDoViTitle(getVideoDoViTitle())
      .audioSpatialFormat(getAudioSpatialFormat())
      .localizedUndefined(getLocalizedUndefined())
      .localizedDefault(getLocalizedDefault())
      .localizedForced(getLocalizedForced())
      .localizedExternal(getLocalizedExternal())
      .localizedHearingImpaired(getLocalizedHearingImpaired())
      .displayTitle(getDisplayTitle())
      .nalLengthSize(getNalLengthSize())
      .isInterlaced(getIsInterlaced())
      .isAVC(getIsAVC())
      .channelLayout(getChannelLayout())
      .bitRate(getBitRate())
      .bitDepth(getBitDepth())
      .refFrames(getRefFrames())
      ...
      .realFrameRate(getRealFrameRate())
      .referenceFrameRate(getReferenceFrameRate())
      .profile(getProfile())
      .type(getType())
      ...
      .isExternalUrl(getIsExternalUrl())
      .isTextSubtitleStream(getIsTextSubtitleStream())
      .supportsExternalStream(getSupportsExternalStream())
      .path(getPath())
      .pixelFormat(getPixelFormat())
      .level(getLevel())
      .isAnamorphic(getIsAnamorphic());
  }
