...
import org.openhab.binding.jellyfin.internal.gen.current.model.PlaylistUserPermissions;
...
public class PlaylistDto {
  ...
  public PlaylistDto openAccess(@org.eclipse.jdt.annotation.Nullable
 Boolean openAccess) {
 ...
 Boolean openAccess) {
  ...
  public PlaylistDto shares(@org.eclipse.jdt.annotation.Nullable
 ...
 List<PlaylistUserPermissions> shares) {
  ...
  public PlaylistDto itemIds(@org.eclipse.jdt.annotation.Nullable
 List<UUID> itemIds) {
 ...
 List<UUID> itemIds) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getOpenAccess() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sOpenAccess%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getOpenAccess()))));
    }
