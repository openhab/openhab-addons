...
import org.openhab.binding.jellyfin.internal.gen.current.model.ActivityLogEntryStartMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.ActivityLogEntryStopMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.InboundKeepAliveMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.ScheduledTasksInfoStartMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.ScheduledTasksInfoStopMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.SessionMessageType;
import org.openhab.binding.jellyfin.internal.gen.current.model.SessionsStartMessage;
import org.openhab.binding.jellyfin.internal.gen.current.model.SessionsStopMessage;
...
public class InboundWebSocketMessage extends AbstractOpenApiSchema {
    ...
    public static class InboundWebSocketMessageDeserializer extends StdDeserializer<InboundWebSocketMessage> {
        ...
        public InboundWebSocketMessage deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for InboundWebSocketMessage: %d classes match result, expected 1", match));
        }
