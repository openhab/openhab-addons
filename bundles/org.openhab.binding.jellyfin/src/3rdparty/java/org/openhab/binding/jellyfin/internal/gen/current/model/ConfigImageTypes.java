...
public class ConfigImageTypes {
  ...
  public ConfigImageTypes backdropSizes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> backdropSizes) {
  ...
  public ConfigImageTypes baseUrl(@org.eclipse.jdt.annotation.Nullable
 String baseUrl) {
 ...
 String baseUrl) {
  ...
  public ConfigImageTypes logoSizes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> logoSizes) {
  ...
  public ConfigImageTypes posterSizes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> posterSizes) {
  ...
  public ConfigImageTypes profileSizes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> profileSizes) {
  ...
  public ConfigImageTypes secureBaseUrl(@org.eclipse.jdt.annotation.Nullable
 ...
 String secureBaseUrl) {
  ...
  public ConfigImageTypes stillSizes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> stillSizes) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSecureBaseUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSecureBaseUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSecureBaseUrl()))));
    }
