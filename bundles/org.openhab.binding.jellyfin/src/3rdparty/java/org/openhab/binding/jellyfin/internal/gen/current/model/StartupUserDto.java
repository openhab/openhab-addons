...
public class StartupUserDto {
  ...
  public StartupUserDto name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public StartupUserDto password(@org.eclipse.jdt.annotation.Nullable
 String password) {
 ...
 String password) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, startupUserDto.name) &&
        Objects.equals(this.password, startupUserDto.password);
  }
