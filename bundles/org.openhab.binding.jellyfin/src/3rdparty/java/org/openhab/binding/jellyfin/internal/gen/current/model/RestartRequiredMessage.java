...
public class RestartRequiredMessage {
    ...
    private @org.eclipse.jdt.annotation.Nullable SessionMessageType messageType = SessionMessageType.RESTART_REQUIRED;
     ...
     */
    @JsonCreator
    public RestartRequiredMessage(@JsonProperty(value = JSON_PROPERTY_MESSAGE_TYPE) SessionMessageType messageType) {
        this();
        this.messageType = messageType;
    }

    public RestartRequiredMessage messageId(@org.eclipse.jdt.annotation.Nullable UUID messageId) {
