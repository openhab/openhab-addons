...
public class ChapterInfo {
  ...
  public ChapterInfo startPositionTicks(@org.eclipse.jdt.annotation.Nullable
 ...
 Long startPositionTicks) {
  ...
  public ChapterInfo name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public ChapterInfo imagePath(@org.eclipse.jdt.annotation.Nullable
 String imagePath) {
 ...
 String imagePath) {
  ...
  public ChapterInfo imageDateModified(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime imageDateModified) {
  ...
  public ChapterInfo imageTag(@org.eclipse.jdt.annotation.Nullable
 String imageTag) {
 ...
 String imageTag) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getImagePath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sImagePath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getImagePath()))));
    }

    // add `ImageDateModified` to the URL query string
    if (getImageDateModified() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sImageDateModified%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getImageDateModified()))));
    }
