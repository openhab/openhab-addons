...
public class RemoveFromPlaylistRequestDto {
  ...
  public RemoveFromPlaylistRequestDto playlistItemIds(@org.eclipse.jdt.annotation.Nullable
 ...
 List<UUID> playlistItemIds) {
  ...
  public RemoveFromPlaylistRequestDto clearPlaylist(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean clearPlaylist) {
  ...
  public RemoveFromPlaylistRequestDto clearPlayingItem(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean clearPlayingItem) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getClearPlaylist() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sClearPlaylist%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getClearPlaylist()))));
    }

    // add `ClearPlayingItem` to the URL query string
    if (getClearPlayingItem() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sClearPlayingItem%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getClearPlayingItem()))));
    }
