 ...
 */
@JsonPropertyOrder({
  BackupRestoreRequestDto.JSON_PROPERTY_ARCHIVE_FILE_NAME
})
...
public class BackupRestoreRequestDto {
  ...
  public BackupRestoreRequestDto archiveFileName(@org.eclipse.jdt.annotation.Nullable
 ...
 String archiveFileName) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getArchiveFileName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sArchiveFileName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getArchiveFileName()))));
    }
