...
import org.openhab.binding.jellyfin.internal.gen.current.model.SendCommandType;
...
public class SendCommand {
  ...
  public SendCommand groupId(@org.eclipse.jdt.annotation.Nullable
 UUID groupId) {
 ...
 UUID groupId) {
  ...
  public SendCommand playlistItemId(@org.eclipse.jdt.annotation.Nullable
 UUID playlistItemId) {
 ...
 UUID playlistItemId) {
  ...
  public SendCommand when(@org.eclipse.jdt.annotation.Nullable
 OffsetDateTime when) {
    this.when = when;
    return this;
  }
 ...
 OffsetDateTime when) {
  ...
  public SendCommand positionTicks(@org.eclipse.jdt.annotation.Nullable
 Long positionTicks) {
 ...
 Long positionTicks) {
  ...
  public SendCommand command(@org.eclipse.jdt.annotation.Nullable
 ...
 SendCommandType command) {
  ...
  public SendCommand emittedAt(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime emittedAt) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEmittedAt() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEmittedAt%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEmittedAt()))));
    }
