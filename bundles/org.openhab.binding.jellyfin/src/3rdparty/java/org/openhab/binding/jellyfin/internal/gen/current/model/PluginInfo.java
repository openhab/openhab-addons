...
import org.openhab.binding.jellyfin.internal.gen.current.model.PluginStatus;
...
public class PluginInfo {
  ...
  public PluginInfo name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public PluginInfo version(@org.eclipse.jdt.annotation.Nullable
 String version) {
 ...
 String version) {
  ...
  public PluginInfo configurationFileName(@org.eclipse.jdt.annotation.Nullable
 ...
 String configurationFileName) {
  ...
  public PluginInfo description(@org.eclipse.jdt.annotation.Nullable
 String description) {
 ...
 String description) {
  ...
  public PluginInfo id(@org.eclipse.jdt.annotation.Nullable
 UUID id) {
    this.id = id;
    return this;
  }
 ...
 UUID id) {
  ...
  public PluginInfo canUninstall(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean canUninstall) {
  ...
  public PluginInfo hasImage(@org.eclipse.jdt.annotation.Nullable
 Boolean hasImage) {
 ...
 Boolean hasImage) {
  ...
  public PluginInfo status(@org.eclipse.jdt.annotation.Nullable
 PluginStatus status) {
    this.status = status;
    return this;
  }
 ...
 PluginStatus status) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getConfigurationFileName() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sConfigurationFileName%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getConfigurationFileName()))));
    }
    ...
    if (getCanUninstall() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCanUninstall%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCanUninstall()))));
    }

    // add `HasImage` to the URL query string
    if (getHasImage() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sHasImage%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getHasImage()))));
    }
