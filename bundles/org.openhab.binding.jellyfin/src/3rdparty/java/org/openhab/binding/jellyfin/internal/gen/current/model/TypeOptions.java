...
import org.openhab.binding.jellyfin.internal.gen.current.model.ImageOption;
...
public class TypeOptions {
  ...
  public TypeOptions type(@org.eclipse.jdt.annotation.Nullable
 String type) {
    this.type = type;
    return this;
  }
 ...
 String type) {
  ...
  public TypeOptions metadataFetchers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> metadataFetchers) {
  ...
  public TypeOptions metadataFetcherOrder(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> metadataFetcherOrder) {
  ...
  public TypeOptions imageFetchers(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> imageFetchers) {
  ...
  public TypeOptions imageFetcherOrder(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> imageFetcherOrder) {
  ...
  public TypeOptions imageOptions(@org.eclipse.jdt.annotation.Nullable
    ...
    if (getImageOptions() != null) {
      for (int i = 0; i < getImageOptions().size(); i++) {
        if (getImageOptions().get(i) != null) {
          joiner.add(getImageOptions().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sImageOptions%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
