...
public class ListingsProviderInfo {
  ...
  public ListingsProviderInfo id(@org.eclipse.jdt.annotation.Nullable
 String id) {
    this.id = id;
    return this;
  }
 ...
 String id) {
  ...
  public ListingsProviderInfo type(@org.eclipse.jdt.annotation.Nullable
 String type) {
    this.type = type;
    return this;
  }
 ...
 String type) {
  ...
  public ListingsProviderInfo username(@org.eclipse.jdt.annotation.Nullable
 String username) {
 ...
 String username) {
  ...
  public ListingsProviderInfo password(@org.eclipse.jdt.annotation.Nullable
 String password) {
 ...
 String password) {
  ...
  public ListingsProviderInfo listingsId(@org.eclipse.jdt.annotation.Nullable
 String listingsId) {
 ...
 String listingsId) {
  ...
  public ListingsProviderInfo zipCode(@org.eclipse.jdt.annotation.Nullable
 String zipCode) {
 ...
 String zipCode) {
  ...
  public ListingsProviderInfo country(@org.eclipse.jdt.annotation.Nullable
 String country) {
 ...
 String country) {
  ...
  public ListingsProviderInfo path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public ListingsProviderInfo enabledTuners(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> enabledTuners) {
  ...
  public ListingsProviderInfo enableAllTuners(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableAllTuners) {
  ...
  public ListingsProviderInfo newsCategories(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> newsCategories) {
  ...
  public ListingsProviderInfo sportsCategories(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> sportsCategories) {
  ...
  public ListingsProviderInfo kidsCategories(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> kidsCategories) {
  ...
  public ListingsProviderInfo movieCategories(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> movieCategories) {
  ...
  public ListingsProviderInfo channelMappings(@org.eclipse.jdt.annotation.Nullable
 ...
 List<NameValuePair> channelMappings) {
  ...
  public ListingsProviderInfo moviePrefix(@org.eclipse.jdt.annotation.Nullable
 String moviePrefix) {
 ...
 String moviePrefix) {
  ...
  public ListingsProviderInfo preferredLanguage(@org.eclipse.jdt.annotation.Nullable
 ...
 String preferredLanguage) {
  ...
  public ListingsProviderInfo userAgent(@org.eclipse.jdt.annotation.Nullable
 String userAgent) {
 ...
 String userAgent) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getListingsId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sListingsId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getListingsId()))));
    }
    ...
    if (getEnableAllTuners() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableAllTuners%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableAllTuners()))));
    }
    ...
    if (getChannelMappings() != null) {
      for (int i = 0; i < getChannelMappings().size(); i++) {
        if (getChannelMappings().get(i) != null) {
          joiner.add(getChannelMappings().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sChannelMappings%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getMoviePrefix() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMoviePrefix%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMoviePrefix()))));
    }

    // add `PreferredLanguage` to the URL query string
    if (getPreferredLanguage() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPreferredLanguage%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPreferredLanguage()))));
    }
