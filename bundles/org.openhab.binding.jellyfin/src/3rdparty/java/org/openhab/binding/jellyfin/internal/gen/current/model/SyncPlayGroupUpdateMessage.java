 ...
 */
@JsonPropertyOrder({
  SyncPlayGroupUpdateMessage.JSON_PROPERTY_DATA,
  SyncPlayGroupUpdateMessage.JSON_PROPERTY_MESSAGE_ID,
...
public class SyncPlayGroupUpdateMessage {
  ...
  public SyncPlayGroupUpdateMessage data(@org.eclipse.jdt.annotation.Nullable
 GroupUpdate data) {
    this.data = data;
    return this;
  }
 ...
 GroupUpdate data) {
  ...
  public SyncPlayGroupUpdateMessage messageId(@org.eclipse.jdt.annotation.Nullable
 UUID messageId) {
