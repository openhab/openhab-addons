...
import org.openhab.binding.jellyfin.internal.gen.current.model.TaskTriggerInfo;
...
public class ScheduledTasksApi {
   ...
   */
  public TaskInfo getTask(@org.eclipse.jdt.annotation.NonNull
 String taskId) throws ApiException {
   ...
   */
  public TaskInfo getTask(@org.eclipse.jdt.annotation.NonNull
 String taskId, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<TaskInfo> getTaskWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String taskId) throws ApiException {
 ...
 String taskId, Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        TaskInfo responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<TaskInfo>() {});
  ...
  private HttpRequest.Builder getTaskRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String taskId, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<TaskInfo> getTasks(@org.eclipse.jdt.annotation.Nullable
 Boolean isHidden, @org.eclipse.jdt.annotation.Nullable
 Boolean isEnabled) throws ApiException {
  ...
  public List<TaskInfo> getTasks(@org.eclipse.jdt.annotation.Nullable
 Boolean isHidden, @org.eclipse.jdt.annotation.Nullable
 Boolean isEnabled, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<TaskInfo>> getTasksWithHttpInfo(@org.eclipse.jdt.annotation.Nullable
 Boolean isHidden, @org.eclipse.jdt.annotation.Nullable
 Boolean isEnabled) throws ApiException {
 ...
 Boolean isEnabled, Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        List<TaskInfo> responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<TaskInfo>>() {});
  ...
  private HttpRequest.Builder getTasksRequestBuilder(@org.eclipse.jdt.annotation.Nullable
 Boolean isHidden, @org.eclipse.jdt.annotation.Nullable
 Boolean isEnabled, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void startTask(@org.eclipse.jdt.annotation.NonNull
 String taskId) throws ApiException {
 ...
 String taskId, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> startTaskWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String taskId) throws ApiException {
 ...
 String taskId, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder startTaskRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String taskId, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'taskId' is set
    if (taskId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void stopTask(@org.eclipse.jdt.annotation.NonNull
 String taskId) throws ApiException {
 ...
 String taskId, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> stopTaskWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String taskId) throws ApiException {
 ...
 String taskId, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder stopTaskRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String taskId, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'taskId' is set
    if (taskId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateTask(@org.eclipse.jdt.annotation.NonNull
 String taskId, @org.eclipse.jdt.annotation.NonNull
 List<TaskTriggerInfo> taskTriggerInfo) throws ApiException {
  ...
  public void updateTask(@org.eclipse.jdt.annotation.NonNull
 String taskId, @org.eclipse.jdt.annotation.NonNull
 List<TaskTriggerInfo> taskTriggerInfo, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> updateTaskWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String taskId, @org.eclipse.jdt.annotation.NonNull
 List<TaskTriggerInfo> taskTriggerInfo) throws ApiException {
 ...
 List<TaskTriggerInfo> taskTriggerInfo, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder updateTaskRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String taskId, @org.eclipse.jdt.annotation.NonNull
 List<TaskTriggerInfo> taskTriggerInfo, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'taskId' is set
    if (taskId == null) {
