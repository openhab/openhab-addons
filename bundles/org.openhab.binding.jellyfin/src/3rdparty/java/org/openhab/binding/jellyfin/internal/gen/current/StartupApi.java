...
import org.openhab.binding.jellyfin.internal.gen.current.model.StartupConfigurationDto;
import org.openhab.binding.jellyfin.internal.gen.current.model.StartupRemoteAccessDto;
import org.openhab.binding.jellyfin.internal.gen.current.model.StartupUserDto;
...
public class StartupApi {
  ...
  public ApiResponse<StartupUserDto> getFirstUserWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        StartupUserDto responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<StartupUserDto>() {});
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<StartupConfigurationDto> getStartupConfigurationWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        StartupConfigurationDto responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<StartupConfigurationDto>() {});
   ...
   * @throws ApiException if fails to make API call
   */
  public void setRemoteAccess(@org.eclipse.jdt.annotation.NonNull
 StartupRemoteAccessDto startupRemoteAccessDto) throws ApiException {
   ...
   */
  public void setRemoteAccess(@org.eclipse.jdt.annotation.NonNull
 StartupRemoteAccessDto startupRemoteAccessDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> setRemoteAccessWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 StartupRemoteAccessDto startupRemoteAccessDto) throws ApiException {
 ...
 StartupRemoteAccessDto startupRemoteAccessDto, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder setRemoteAccessRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 StartupRemoteAccessDto startupRemoteAccessDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateInitialConfiguration(@org.eclipse.jdt.annotation.NonNull
 StartupConfigurationDto startupConfigurationDto) throws ApiException {
   ...
   */
  public void updateInitialConfiguration(@org.eclipse.jdt.annotation.NonNull
 StartupConfigurationDto startupConfigurationDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> updateInitialConfigurationWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 StartupConfigurationDto startupConfigurationDto) throws ApiException {
  ...
  public ApiResponse<Void> updateInitialConfigurationWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 StartupConfigurationDto startupConfigurationDto, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = updateInitialConfigurationRequestBuilder(startupConfigurationDto, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder updateInitialConfigurationRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 StartupConfigurationDto startupConfigurationDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateStartupUser(@org.eclipse.jdt.annotation.Nullable
 StartupUserDto startupUserDto) throws ApiException {
   ...
   */
  public void updateStartupUser(@org.eclipse.jdt.annotation.Nullable
 StartupUserDto startupUserDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> updateStartupUserWithHttpInfo(@org.eclipse.jdt.annotation.Nullable
 StartupUserDto startupUserDto) throws ApiException {
 ...
 StartupUserDto startupUserDto, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder updateStartupUserRequestBuilder(@org.eclipse.jdt.annotation.Nullable
 StartupUserDto startupUserDto, Map<String, String> headers) throws ApiException {
