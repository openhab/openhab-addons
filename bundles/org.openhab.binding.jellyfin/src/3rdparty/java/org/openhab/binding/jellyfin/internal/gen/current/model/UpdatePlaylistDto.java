...
public class UpdatePlaylistDto {
  ...
  public UpdatePlaylistDto name(@org.eclipse.jdt.annotation.Nullable
 String name) {
    this.name = name;
    return this;
  }
 ...
 String name) {
  ...
  public UpdatePlaylistDto ids(@org.eclipse.jdt.annotation.Nullable
 List<UUID> ids) {
    this.ids = ids;
    return this;
  }
 ...
 List<UUID> ids) {
  ...
  public UpdatePlaylistDto users(@org.eclipse.jdt.annotation.Nullable
 ...
 List<PlaylistUserPermissions> users) {
  ...
  public UpdatePlaylistDto isPublic(@org.eclipse.jdt.annotation.Nullable
 Boolean isPublic) {
