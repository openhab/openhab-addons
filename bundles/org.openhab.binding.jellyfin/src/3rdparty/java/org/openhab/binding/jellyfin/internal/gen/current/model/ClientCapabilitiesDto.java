...
public class ClientCapabilitiesDto {
  ...
  public ClientCapabilitiesDto playableMediaTypes(@org.eclipse.jdt.annotation.Nullable
 ...
 List<MediaType> playableMediaTypes) {
  ...
  public ClientCapabilitiesDto supportedCommands(@org.eclipse.jdt.annotation.Nullable
 ...
 List<GeneralCommandType> supportedCommands) {
  ...
  public ClientCapabilitiesDto supportsMediaControl(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean supportsMediaControl) {
  ...
  public ClientCapabilitiesDto supportsPersistentIdentifier(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean supportsPersistentIdentifier) {
  ...
  public ClientCapabilitiesDto deviceProfile(@org.eclipse.jdt.annotation.Nullable
 ...
 DeviceProfile deviceProfile) {
  ...
  public ClientCapabilitiesDto appStoreUrl(@org.eclipse.jdt.annotation.Nullable
 String appStoreUrl) {
 ...
 String appStoreUrl) {
  ...
  public ClientCapabilitiesDto iconUrl(@org.eclipse.jdt.annotation.Nullable
 String iconUrl) {
 ...
 String iconUrl) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSupportsPersistentIdentifier() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSupportsPersistentIdentifier%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSupportsPersistentIdentifier()))));
    }
    ...
    if (getAppStoreUrl() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAppStoreUrl%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAppStoreUrl()))));
    }
