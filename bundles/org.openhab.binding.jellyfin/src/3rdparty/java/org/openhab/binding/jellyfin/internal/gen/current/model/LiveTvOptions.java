...
import org.openhab.binding.jellyfin.internal.gen.current.model.ListingsProviderInfo;
import org.openhab.binding.jellyfin.internal.gen.current.model.TunerHostInfo;
...
public class LiveTvOptions {
  ...
  public LiveTvOptions guideDays(@org.eclipse.jdt.annotation.Nullable
 Integer guideDays) {
 ...
 Integer guideDays) {
  ...
  public LiveTvOptions recordingPath(@org.eclipse.jdt.annotation.Nullable
 ...
 String recordingPath) {
  ...
  public LiveTvOptions movieRecordingPath(@org.eclipse.jdt.annotation.Nullable
 ...
 String movieRecordingPath) {
  ...
  public LiveTvOptions seriesRecordingPath(@org.eclipse.jdt.annotation.Nullable
 ...
 String seriesRecordingPath) {
  ...
  public LiveTvOptions enableRecordingSubfolders(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableRecordingSubfolders) {
  ...
  public LiveTvOptions enableOriginalAudioWithEncodedRecordings(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableOriginalAudioWithEncodedRecordings) {
  ...
  public LiveTvOptions tunerHosts(@org.eclipse.jdt.annotation.Nullable
 ...
 List<TunerHostInfo> tunerHosts) {
  ...
  public LiveTvOptions listingProviders(@org.eclipse.jdt.annotation.Nullable
 ...
 List<ListingsProviderInfo> listingProviders) {
  ...
  public LiveTvOptions prePaddingSeconds(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer prePaddingSeconds) {
  ...
  public LiveTvOptions postPaddingSeconds(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer postPaddingSeconds) {
  ...
  public LiveTvOptions mediaLocationsCreated(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> mediaLocationsCreated) {
  ...
  public LiveTvOptions recordingPostProcessor(@org.eclipse.jdt.annotation.Nullable
 ...
 String recordingPostProcessor) {
  ...
  public LiveTvOptions recordingPostProcessorArguments(@org.eclipse.jdt.annotation.Nullable
 ...
 String recordingPostProcessorArguments) {
  ...
  public LiveTvOptions saveRecordingNFO(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean saveRecordingNFO) {
  ...
  public LiveTvOptions saveRecordingImages(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean saveRecordingImages) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getGuideDays() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sGuideDays%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getGuideDays()))));
    }

    // add `RecordingPath` to the URL query string
    if (getRecordingPath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRecordingPath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRecordingPath()))));
    }

    // add `MovieRecordingPath` to the URL query string
    if (getMovieRecordingPath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMovieRecordingPath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMovieRecordingPath()))));
    }

    // add `SeriesRecordingPath` to the URL query string
    if (getSeriesRecordingPath() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSeriesRecordingPath%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSeriesRecordingPath()))));
    }

    // add `EnableRecordingSubfolders` to the URL query string
    if (getEnableRecordingSubfolders() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableRecordingSubfolders%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableRecordingSubfolders()))));
    }

    // add `EnableOriginalAudioWithEncodedRecordings` to the URL query string
    if (getEnableOriginalAudioWithEncodedRecordings() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableOriginalAudioWithEncodedRecordings%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableOriginalAudioWithEncodedRecordings()))));
    }
    ...
    if (getTunerHosts() != null) {
      for (int i = 0; i < getTunerHosts().size(); i++) {
        if (getTunerHosts().get(i) != null) {
          joiner.add(getTunerHosts().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sTunerHosts%s%s", prefix, suffix,
    ...
    if (getListingProviders() != null) {
      for (int i = 0; i < getListingProviders().size(); i++) {
        if (getListingProviders().get(i) != null) {
          joiner.add(getListingProviders().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sListingProviders%s%s", prefix, suffix,
          "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix))));
        }
      }
    }
    ...
    if (getRecordingPostProcessor() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRecordingPostProcessor%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRecordingPostProcessor()))));
    }

    // add `RecordingPostProcessorArguments` to the URL query string
    if (getRecordingPostProcessorArguments() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRecordingPostProcessorArguments%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRecordingPostProcessorArguments()))));
    }

    // add `SaveRecordingNFO` to the URL query string
    if (getSaveRecordingNFO() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSaveRecordingNFO%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSaveRecordingNFO()))));
    }

    // add `SaveRecordingImages` to the URL query string
    if (getSaveRecordingImages() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSaveRecordingImages%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSaveRecordingImages()))));
    }
