...
import org.openhab.binding.jellyfin.internal.gen.current.model.DeviceProfile;
...
public class PlaybackInfoDto {
  ...
  public PlaybackInfoDto userId(@org.eclipse.jdt.annotation.Nullable
 UUID userId) {
    this.userId = userId;
    return this;
  }
 ...
 UUID userId) {
  ...
  public PlaybackInfoDto maxStreamingBitrate(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer maxStreamingBitrate) {
  ...
  public PlaybackInfoDto startTimeTicks(@org.eclipse.jdt.annotation.Nullable
 Long startTimeTicks) {
 ...
 Long startTimeTicks) {
  ...
  public PlaybackInfoDto audioStreamIndex(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer audioStreamIndex) {
  ...
  public PlaybackInfoDto subtitleStreamIndex(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer subtitleStreamIndex) {
  ...
  public PlaybackInfoDto maxAudioChannels(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer maxAudioChannels) {
  ...
  public PlaybackInfoDto mediaSourceId(@org.eclipse.jdt.annotation.Nullable
 ...
 String mediaSourceId) {
  ...
  public PlaybackInfoDto liveStreamId(@org.eclipse.jdt.annotation.Nullable
 String liveStreamId) {
 ...
 String liveStreamId) {
  ...
  public PlaybackInfoDto deviceProfile(@org.eclipse.jdt.annotation.Nullable
 ...
 DeviceProfile deviceProfile) {
  ...
  public PlaybackInfoDto enableDirectPlay(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableDirectPlay) {
  ...
  public PlaybackInfoDto enableDirectStream(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean enableDirectStream) {
  ...
  public PlaybackInfoDto enableTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableTranscoding) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ENABLE_TRANSCODING, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEnableTranscoding(@org.eclipse.jdt.annotation.Nullable
 Boolean enableTranscoding) {
    this.enableTranscoding = enableTranscoding;
  }


  public PlaybackInfoDto allowVideoStreamCopy(@org.eclipse.jdt.annotation.Nullable
 Boolean allowVideoStreamCopy) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOW_VIDEO_STREAM_COPY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAllowVideoStreamCopy(@org.eclipse.jdt.annotation.Nullable
 Boolean allowVideoStreamCopy) {
    this.allowVideoStreamCopy = allowVideoStreamCopy;
  }


  public PlaybackInfoDto allowAudioStreamCopy(@org.eclipse.jdt.annotation.Nullable
 Boolean allowAudioStreamCopy) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ALLOW_AUDIO_STREAM_COPY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAllowAudioStreamCopy(@org.eclipse.jdt.annotation.Nullable
 Boolean allowAudioStreamCopy) {
    this.allowAudioStreamCopy = allowAudioStreamCopy;
  }


  public PlaybackInfoDto autoOpenLiveStream(@org.eclipse.jdt.annotation.Nullable
 Boolean autoOpenLiveStream) {
  ...
  @JsonProperty(value = JSON_PROPERTY_AUTO_OPEN_LIVE_STREAM, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAutoOpenLiveStream(@org.eclipse.jdt.annotation.Nullable
 Boolean autoOpenLiveStream) {
    this.autoOpenLiveStream = autoOpenLiveStream;
  }


  public PlaybackInfoDto alwaysBurnInSubtitleWhenTranscoding(@org.eclipse.jdt.annotation.Nullable
 ...
 Boolean alwaysBurnInSubtitleWhenTranscoding) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMaxStreamingBitrate() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxStreamingBitrate%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxStreamingBitrate()))));
    }

    // add `StartTimeTicks` to the URL query string
    if (getStartTimeTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sStartTimeTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getStartTimeTicks()))));
    }
    ...
    if (getMaxAudioChannels() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMaxAudioChannels%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMaxAudioChannels()))));
    }
    ...
    if (getEnableDirectPlay() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableDirectPlay%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableDirectPlay()))));
    }

    // add `EnableDirectStream` to the URL query string
    if (getEnableDirectStream() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableDirectStream%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableDirectStream()))));
    }

    // add `EnableTranscoding` to the URL query string
    if (getEnableTranscoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEnableTranscoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEnableTranscoding()))));
    }

    // add `AllowVideoStreamCopy` to the URL query string
    if (getAllowVideoStreamCopy() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAllowVideoStreamCopy%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAllowVideoStreamCopy()))));
    }

    // add `AllowAudioStreamCopy` to the URL query string
    if (getAllowAudioStreamCopy() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAllowAudioStreamCopy%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAllowAudioStreamCopy()))));
    }

    // add `AutoOpenLiveStream` to the URL query string
    if (getAutoOpenLiveStream() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAutoOpenLiveStream%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAutoOpenLiveStream()))));
    }

    // add `AlwaysBurnInSubtitleWhenTranscoding` to the URL query string
    if (getAlwaysBurnInSubtitleWhenTranscoding() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAlwaysBurnInSubtitleWhenTranscoding%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAlwaysBurnInSubtitleWhenTranscoding()))));
    }
