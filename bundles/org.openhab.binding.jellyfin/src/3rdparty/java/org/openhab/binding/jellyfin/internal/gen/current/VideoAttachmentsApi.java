...
public class VideoAttachmentsApi {
   ...
   */
  public File getAttachment(@org.eclipse.jdt.annotation.NonNull
 UUID videoId, @org.eclipse.jdt.annotation.NonNull
 String mediaSourceId, @org.eclipse.jdt.annotation.NonNull
 Integer index) throws ApiException {
 ...
 UUID videoId, @org.eclipse.jdt.annotation.NonNull
 String mediaSourceId, @org.eclipse.jdt.annotation.NonNull
 Integer index, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> getAttachmentWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 UUID videoId, @org.eclipse.jdt.annotation.NonNull
 String mediaSourceId, @org.eclipse.jdt.annotation.NonNull
 Integer index) throws ApiException {
 ...
 String mediaSourceId, @org.eclipse.jdt.annotation.NonNull
 Integer index, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getAttachmentRequestBuilder(videoId, mediaSourceId, index, headers);
    try {
  ...
  private HttpRequest.Builder getAttachmentRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 UUID videoId, @org.eclipse.jdt.annotation.NonNull
 String mediaSourceId, @org.eclipse.jdt.annotation.NonNull
 Integer index, Map<String, String> headers) throws ApiException {
    ...
    localVarRequestBuilder.header("Accept", "application/octet-stream, application/json, application/json; profile=CamelCase, application/json; profile=PascalCase, text/html");
