...
public class MediaSegmentDto {
  ...
  public MediaSegmentDto id(@org.eclipse.jdt.annotation.Nullable
 UUID id) {
    this.id = id;
    return this;
  }
 ...
 UUID id) {
  ...
  public MediaSegmentDto itemId(@org.eclipse.jdt.annotation.Nullable
 UUID itemId) {
    this.itemId = itemId;
    return this;
  }
 ...
 UUID itemId) {
  ...
  public MediaSegmentDto type(@org.eclipse.jdt.annotation.Nullable
 ...
 MediaSegmentType type) {
  ...
  public MediaSegmentDto startTicks(@org.eclipse.jdt.annotation.Nullable
 Long startTicks) {
 ...
 Long startTicks) {
  ...
  public MediaSegmentDto endTicks(@org.eclipse.jdt.annotation.Nullable
 Long endTicks) {
 ...
 Long endTicks) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getStartTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sStartTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getStartTicks()))));
    }

    // add `EndTicks` to the URL query string
    if (getEndTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEndTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEndTicks()))));
    }
