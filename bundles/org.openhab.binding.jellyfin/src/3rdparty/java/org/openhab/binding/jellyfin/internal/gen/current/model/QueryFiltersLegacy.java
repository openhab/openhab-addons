...
public class QueryFiltersLegacy {
  ...
  public QueryFiltersLegacy genres(@org.eclipse.jdt.annotation.Nullable
 List<String> genres) {
    this.genres = genres;
    return this;
  }
 ...
 List<String> genres) {
  ...
  public QueryFiltersLegacy tags(@org.eclipse.jdt.annotation.Nullable
 List<String> tags) {
    this.tags = tags;
    return this;
  }
 ...
 List<String> tags) {
  ...
  public QueryFiltersLegacy officialRatings(@org.eclipse.jdt.annotation.Nullable
 ...
 List<String> officialRatings) {
  ...
  public QueryFiltersLegacy years(@org.eclipse.jdt.annotation.Nullable
 List<Integer> years) {
    this.years = years;
    return this;
  }
  ...
  */
  public QueryFiltersLegacy.Builder toBuilder() {
    return new QueryFiltersLegacy.Builder()
      .genres(getGenres())
      .tags(getTags())
      .officialRatings(getOfficialRatings())
      .years(getYears());
  }
