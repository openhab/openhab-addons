 ...
 */
@JsonPropertyOrder({
  LyricLineCue.JSON_PROPERTY_POSITION,
  LyricLineCue.JSON_PROPERTY_END_POSITION,
  LyricLineCue.JSON_PROPERTY_START,
  LyricLineCue.JSON_PROPERTY_END
})
...
public class LyricLineCue {
  ...
  public LyricLineCue position(@org.eclipse.jdt.annotation.Nullable
 Integer position) {
 ...
 Integer position) {
  ...
  public LyricLineCue endPosition(@org.eclipse.jdt.annotation.Nullable
 Integer endPosition) {
 ...
 Integer endPosition) {
  ...
  public LyricLineCue start(@org.eclipse.jdt.annotation.Nullable
 Long start) {
    this.start = start;
    return this;
  }
 ...
 Long start) {
  ...
  public LyricLineCue end(@org.eclipse.jdt.annotation.Nullable
 Long end) {
    this.end = end;
    return this;
  }
 ...
 Long end) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.position, lyricLineCue.position) &&
        ...
        Objects.equals(this.start, lyricLineCue.start) &&
        Objects.equals(this.end, lyricLineCue.end);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEndPosition() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sEndPosition%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getEndPosition()))));
    }
