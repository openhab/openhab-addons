 ...
 */
@JsonPropertyOrder({
  PluginInstallationCancelledMessage.JSON_PROPERTY_DATA,
...
public class PluginInstallationCancelledMessage {
  ...
  public PluginInstallationCancelledMessage data(@org.eclipse.jdt.annotation.Nullable
 ...
 InstallationInfo data) {
  ...
  public PluginInstallationCancelledMessage messageId(@org.eclipse.jdt.annotation.Nullable
 UUID messageId) {
 ...
 UUID messageId) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    private PluginInstallationCancelledMessage instance;

    public Builder() {
      this(new PluginInstallationCancelledMessage());
    }

    protected Builder(PluginInstallationCancelledMessage instance) {
    ...
    public PluginInstallationCancelledMessage.Builder messageId(UUID messageId) {
      this.instance.messageId = messageId;
      return this;
    }
    public PluginInstallationCancelledMessage.Builder messageType(SessionMessageType messageType) {
    ...
    /**
    * returns a built PluginInstallationCancelledMessage instance.
    *
    * The builder is not reusable.
    */
    public PluginInstallationCancelledMessage build() {
      try {
  ...
  */
  public static PluginInstallationCancelledMessage.Builder builder() {
    return new PluginInstallationCancelledMessage.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public PluginInstallationCancelledMessage.Builder toBuilder() {
    return new PluginInstallationCancelledMessage.Builder()
      .data(getData())
