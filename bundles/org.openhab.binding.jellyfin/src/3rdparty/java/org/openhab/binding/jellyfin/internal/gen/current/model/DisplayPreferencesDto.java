...
import java.util.HashMap;
import java.util.Map;
import org.openhab.binding.jellyfin.internal.gen.current.model.ScrollDirection;
...
public class DisplayPreferencesDto {
  ...
  public DisplayPreferencesDto id(@org.eclipse.jdt.annotation.Nullable
 String id) {
    this.id = id;
    return this;
  }
 ...
 String id) {
  ...
  public DisplayPreferencesDto viewType(@org.eclipse.jdt.annotation.Nullable
 String viewType) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VIEW_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setViewType(@org.eclipse.jdt.annotation.Nullable
 String viewType) {
    this.viewType = viewType;
  }


  public DisplayPreferencesDto sortBy(@org.eclipse.jdt.annotation.Nullable
 String sortBy) {
    this.sortBy = sortBy;
    return this;
  }
 ...
 String sortBy) {
  ...
  public DisplayPreferencesDto indexBy(@org.eclipse.jdt.annotation.Nullable
 String indexBy) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INDEX_BY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIndexBy(@org.eclipse.jdt.annotation.Nullable
 String indexBy) {
    this.indexBy = indexBy;
  }


  public DisplayPreferencesDto rememberIndexing(@org.eclipse.jdt.annotation.Nullable
 Boolean rememberIndexing) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REMEMBER_INDEXING, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRememberIndexing(@org.eclipse.jdt.annotation.Nullable
 Boolean rememberIndexing) {
    this.rememberIndexing = rememberIndexing;
  }


  public DisplayPreferencesDto primaryImageHeight(@org.eclipse.jdt.annotation.Nullable
 Integer primaryImageHeight) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PRIMARY_IMAGE_HEIGHT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPrimaryImageHeight(@org.eclipse.jdt.annotation.Nullable
 Integer primaryImageHeight) {
    this.primaryImageHeight = primaryImageHeight;
  }


  public DisplayPreferencesDto primaryImageWidth(@org.eclipse.jdt.annotation.Nullable
 Integer primaryImageWidth) {
  ...
  @JsonProperty(value = JSON_PROPERTY_PRIMARY_IMAGE_WIDTH, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPrimaryImageWidth(@org.eclipse.jdt.annotation.Nullable
 Integer primaryImageWidth) {
    this.primaryImageWidth = primaryImageWidth;
  }


  public DisplayPreferencesDto customPrefs(@org.eclipse.jdt.annotation.Nullable
 Map<String, String> customPrefs) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CUSTOM_PREFS, required = false)
  @JsonInclude(content = JsonInclude.Include.ALWAYS, value = JsonInclude.Include.USE_DEFAULTS)
  public void setCustomPrefs(@org.eclipse.jdt.annotation.Nullable
 Map<String, String> customPrefs) {
    this.customPrefs = customPrefs;
  }


  public DisplayPreferencesDto scrollDirection(@org.eclipse.jdt.annotation.Nullable
 ScrollDirection scrollDirection) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SCROLL_DIRECTION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setScrollDirection(@org.eclipse.jdt.annotation.Nullable
 ScrollDirection scrollDirection) {
    this.scrollDirection = scrollDirection;
  }


  public DisplayPreferencesDto showBackdrop(@org.eclipse.jdt.annotation.Nullable
 Boolean showBackdrop) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SHOW_BACKDROP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setShowBackdrop(@org.eclipse.jdt.annotation.Nullable
 Boolean showBackdrop) {
    this.showBackdrop = showBackdrop;
  }


  public DisplayPreferencesDto rememberSorting(@org.eclipse.jdt.annotation.Nullable
 Boolean rememberSorting) {
  ...
  @JsonProperty(value = JSON_PROPERTY_REMEMBER_SORTING, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRememberSorting(@org.eclipse.jdt.annotation.Nullable
 Boolean rememberSorting) {
    this.rememberSorting = rememberSorting;
  }


  public DisplayPreferencesDto sortOrder(@org.eclipse.jdt.annotation.Nullable
 SortOrder sortOrder) {
 ...
 SortOrder sortOrder) {
  ...
  public DisplayPreferencesDto showSidebar(@org.eclipse.jdt.annotation.Nullable
 Boolean showSidebar) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SHOW_SIDEBAR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setShowSidebar(@org.eclipse.jdt.annotation.Nullable
 Boolean showSidebar) {
    this.showSidebar = showSidebar;
  }


  public DisplayPreferencesDto client(@org.eclipse.jdt.annotation.Nullable
 String client) {
    this.client = client;
    return this;
  }
 ...
 String client) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getViewType() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sViewType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getViewType()))));
    }
    ...
    if (getIndexBy() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIndexBy%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIndexBy()))));
    }

    // add `RememberIndexing` to the URL query string
    if (getRememberIndexing() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRememberIndexing%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRememberIndexing()))));
    }

    // add `PrimaryImageHeight` to the URL query string
    if (getPrimaryImageHeight() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPrimaryImageHeight%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPrimaryImageHeight()))));
    }

    // add `PrimaryImageWidth` to the URL query string
    if (getPrimaryImageWidth() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPrimaryImageWidth%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPrimaryImageWidth()))));
    }
    ...
    if (getScrollDirection() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sScrollDirection%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getScrollDirection()))));
    }

    // add `ShowBackdrop` to the URL query string
    if (getShowBackdrop() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sShowBackdrop%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getShowBackdrop()))));
    }

    // add `RememberSorting` to the URL query string
    if (getRememberSorting() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRememberSorting%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRememberSorting()))));
    }
    ...
    if (getShowSidebar() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sShowSidebar%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getShowSidebar()))));
    }
