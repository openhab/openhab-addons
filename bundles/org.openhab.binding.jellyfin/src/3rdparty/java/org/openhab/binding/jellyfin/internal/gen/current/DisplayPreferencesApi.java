...
import org.openhab.binding.jellyfin.internal.gen.current.model.DisplayPreferencesDto;
...
public class DisplayPreferencesApi {
   ...
   */
  public DisplayPreferencesDto getDisplayPreferences(@org.eclipse.jdt.annotation.NonNull
 String displayPreferencesId, @org.eclipse.jdt.annotation.NonNull
 String client, @org.eclipse.jdt.annotation.Nullable
 ...
 UUID userId, Map<String, String> headers) throws ApiException {
    ApiResponse<DisplayPreferencesDto> localVarResponse = getDisplayPreferencesWithHttpInfo(displayPreferencesId, client, userId, headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DisplayPreferencesDto> getDisplayPreferencesWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String displayPreferencesId, @org.eclipse.jdt.annotation.NonNull
 String client, @org.eclipse.jdt.annotation.Nullable
 UUID userId) throws ApiException {
 ...
 String client, @org.eclipse.jdt.annotation.Nullable
 UUID userId, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getDisplayPreferencesRequestBuilder(displayPreferencesId, client, userId, headers);
    try {
      ...
      try {
        ...
        DisplayPreferencesDto responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<DisplayPreferencesDto>() {});
  ...
  private HttpRequest.Builder getDisplayPreferencesRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String displayPreferencesId, @org.eclipse.jdt.annotation.NonNull
 String client, @org.eclipse.jdt.annotation.Nullable
 UUID userId, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateDisplayPreferences(@org.eclipse.jdt.annotation.NonNull
 String displayPreferencesId, @org.eclipse.jdt.annotation.NonNull
 String client, @org.eclipse.jdt.annotation.NonNull
 DisplayPreferencesDto displayPreferencesDto, @org.eclipse.jdt.annotation.Nullable
 UUID userId) throws ApiException {
 ...
 UUID userId, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> updateDisplayPreferencesWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String displayPreferencesId, @org.eclipse.jdt.annotation.NonNull
 String client, @org.eclipse.jdt.annotation.NonNull
 DisplayPreferencesDto displayPreferencesDto, @org.eclipse.jdt.annotation.Nullable
 UUID userId) throws ApiException {
 ...
 DisplayPreferencesDto displayPreferencesDto, @org.eclipse.jdt.annotation.Nullable
 UUID userId, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = updateDisplayPreferencesRequestBuilder(displayPreferencesId, client, displayPreferencesDto, userId, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder updateDisplayPreferencesRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String displayPreferencesId, @org.eclipse.jdt.annotation.NonNull
 String client, @org.eclipse.jdt.annotation.NonNull
 DisplayPreferencesDto displayPreferencesDto, @org.eclipse.jdt.annotation.Nullable
 UUID userId, Map<String, String> headers) throws ApiException {
