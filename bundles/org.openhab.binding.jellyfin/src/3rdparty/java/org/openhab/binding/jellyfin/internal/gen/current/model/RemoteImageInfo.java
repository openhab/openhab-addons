...
import org.openhab.binding.jellyfin.internal.gen.current.model.RatingType;
...
public class RemoteImageInfo {
  ...
  public RemoteImageInfo providerName(@org.eclipse.jdt.annotation.Nullable
 String providerName) {
 ...
 String providerName) {
  ...
  public RemoteImageInfo url(@org.eclipse.jdt.annotation.Nullable
 String url) {
    this.url = url;
    return this;
  }
 ...
 String url) {
  ...
  public RemoteImageInfo thumbnailUrl(@org.eclipse.jdt.annotation.Nullable
 String thumbnailUrl) {
 ...
 String thumbnailUrl) {
  ...
  public RemoteImageInfo height(@org.eclipse.jdt.annotation.Nullable
 Integer height) {
    this.height = height;
    return this;
  }
 ...
 Integer height) {
  ...
  public RemoteImageInfo width(@org.eclipse.jdt.annotation.Nullable
 Integer width) {
    this.width = width;
    return this;
  }
 ...
 Integer width) {
  ...
  public RemoteImageInfo communityRating(@org.eclipse.jdt.annotation.Nullable
 ...
 Double communityRating) {
  ...
  public RemoteImageInfo voteCount(@org.eclipse.jdt.annotation.Nullable
 Integer voteCount) {
 ...
 Integer voteCount) {
  ...
  public RemoteImageInfo language(@org.eclipse.jdt.annotation.Nullable
 String language) {
 ...
 String language) {
  ...
  public RemoteImageInfo type(@org.eclipse.jdt.annotation.Nullable
 ImageType type) {
    this.type = type;
    return this;
  }
 ...
 ImageType type) {
  ...
  public RemoteImageInfo ratingType(@org.eclipse.jdt.annotation.Nullable
 ...
 RatingType ratingType) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getVoteCount() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sVoteCount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVoteCount()))));
    }
    ...
    if (getRatingType() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRatingType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRatingType()))));
    }
