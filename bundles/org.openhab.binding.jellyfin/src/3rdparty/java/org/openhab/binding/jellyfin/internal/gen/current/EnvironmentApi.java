...
import org.openhab.binding.jellyfin.internal.gen.current.model.DefaultDirectoryBrowserInfoDto;
import org.openhab.binding.jellyfin.internal.gen.current.model.FileSystemEntryInfo;
import org.openhab.binding.jellyfin.internal.gen.current.model.ProblemDetails;
import org.openhab.binding.jellyfin.internal.gen.current.model.ValidatePathDto;
...
public class EnvironmentApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DefaultDirectoryBrowserInfoDto> getDefaultDirectoryBrowserWithHttpInfo(Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        DefaultDirectoryBrowserInfoDto responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<DefaultDirectoryBrowserInfoDto>() {});
  ...
  private HttpRequest.Builder getDefaultDirectoryBrowserRequestBuilder(Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<FileSystemEntryInfo> getDirectoryContents(@org.eclipse.jdt.annotation.NonNull
 String path, @org.eclipse.jdt.annotation.Nullable
 Boolean includeFiles, @org.eclipse.jdt.annotation.Nullable
 Boolean includeDirectories) throws ApiException {
 ...
 String path, @org.eclipse.jdt.annotation.Nullable
 Boolean includeFiles, @org.eclipse.jdt.annotation.Nullable
 Boolean includeDirectories, Map<String, String> headers) throws ApiException {
    ApiResponse<List<FileSystemEntryInfo>> localVarResponse = getDirectoryContentsWithHttpInfo(path, includeFiles, includeDirectories, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<FileSystemEntryInfo>> getDirectoryContentsWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String path, @org.eclipse.jdt.annotation.Nullable
 Boolean includeFiles, @org.eclipse.jdt.annotation.Nullable
 Boolean includeDirectories) throws ApiException {
 ...
 Boolean includeFiles, @org.eclipse.jdt.annotation.Nullable
 Boolean includeDirectories, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getDirectoryContentsRequestBuilder(path, includeFiles, includeDirectories, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        List<FileSystemEntryInfo> responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<FileSystemEntryInfo>>() {});
  ...
  private HttpRequest.Builder getDirectoryContentsRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String path, @org.eclipse.jdt.annotation.Nullable
 Boolean includeFiles, @org.eclipse.jdt.annotation.Nullable
 Boolean includeDirectories, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<FileSystemEntryInfo>> getDrivesWithHttpInfo(Map<String, String> headers) throws ApiException {
   ...
   */
  @Deprecated
  public ApiResponse<List<FileSystemEntryInfo>> getNetworkSharesWithHttpInfo(Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public String getParentPath(@org.eclipse.jdt.annotation.NonNull
 ...
 String path, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<String> getParentPathWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 String path) throws ApiException {
 ...
 String path, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder getParentPathRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 String path, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'path' is set
    if (path == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void validatePath(@org.eclipse.jdt.annotation.NonNull
 ValidatePathDto validatePathDto) throws ApiException {
   ...
   */
  public void validatePath(@org.eclipse.jdt.annotation.NonNull
 ValidatePathDto validatePathDto, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> validatePathWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 ValidatePathDto validatePathDto) throws ApiException {
 ...
 ValidatePathDto validatePathDto, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder validatePathRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 ValidatePathDto validatePathDto, Map<String, String> headers) throws ApiException {
