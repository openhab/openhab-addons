...
public class MessageCommand {
  ...
  public MessageCommand header(@org.eclipse.jdt.annotation.Nullable
 String header) {
    this.header = header;
    return this;
  }
 ...
 String header) {
  ...
  public MessageCommand text(@org.eclipse.jdt.annotation.NonNull
 String text) {
    this.text = text;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_TEXT, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setText(@org.eclipse.jdt.annotation.NonNull
 String text) {
    this.text = text;
  }


  public MessageCommand timeoutMs(@org.eclipse.jdt.annotation.Nullable
 Long timeoutMs) {
