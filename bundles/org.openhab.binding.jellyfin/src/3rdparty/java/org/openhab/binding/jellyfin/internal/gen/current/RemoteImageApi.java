...
import org.openhab.binding.jellyfin.internal.gen.current.model.ImageProviderInfo;
...
import org.openhab.binding.jellyfin.internal.gen.current.model.RemoteImageResult;
...
public class RemoteImageApi {
   ...
   */
  public void downloadRemoteImage(@org.eclipse.jdt.annotation.NonNull
 UUID itemId, @org.eclipse.jdt.annotation.NonNull
 ImageType type, @org.eclipse.jdt.annotation.Nullable
 String imageUrl) throws ApiException {
 ...
 UUID itemId, @org.eclipse.jdt.annotation.NonNull
 ImageType type, @org.eclipse.jdt.annotation.Nullable
 String imageUrl, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> downloadRemoteImageWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 UUID itemId, @org.eclipse.jdt.annotation.NonNull
 ImageType type, @org.eclipse.jdt.annotation.Nullable
 String imageUrl) throws ApiException {
 ...
 String imageUrl, Map<String, String> headers) throws ApiException {
  ...
  private HttpRequest.Builder downloadRemoteImageRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 UUID itemId, @org.eclipse.jdt.annotation.NonNull
 ImageType type, @org.eclipse.jdt.annotation.Nullable
 String imageUrl, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<ImageProviderInfo> getRemoteImageProviders(@org.eclipse.jdt.annotation.NonNull
 ...
 UUID itemId, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<ImageProviderInfo>> getRemoteImageProvidersWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 UUID itemId) throws ApiException {
 ...
 UUID itemId, Map<String, String> headers) throws ApiException {
    ...
    try {
      ...
      try {
        ...
        List<ImageProviderInfo> responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<List<ImageProviderInfo>>() {});
  ...
  private HttpRequest.Builder getRemoteImageProvidersRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 UUID itemId, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'itemId' is set
    if (itemId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public RemoteImageResult getRemoteImages(@org.eclipse.jdt.annotation.NonNull
 ...
 String providerName, @org.eclipse.jdt.annotation.Nullable
 Boolean includeAllLanguages) throws ApiException {
 ...
 Integer limit, @org.eclipse.jdt.annotation.Nullable
 String providerName, @org.eclipse.jdt.annotation.Nullable
 Boolean includeAllLanguages, Map<String, String> headers) throws ApiException {
    ApiResponse<RemoteImageResult> localVarResponse = getRemoteImagesWithHttpInfo(itemId, type, startIndex, limit, providerName, includeAllLanguages, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RemoteImageResult> getRemoteImagesWithHttpInfo(@org.eclipse.jdt.annotation.NonNull
 UUID itemId, @org.eclipse.jdt.annotation.Nullable
 ImageType type, @org.eclipse.jdt.annotation.Nullable
 Integer startIndex, @org.eclipse.jdt.annotation.Nullable
 Integer limit, @org.eclipse.jdt.annotation.Nullable
 ...
 String providerName, @org.eclipse.jdt.annotation.Nullable
 Boolean includeAllLanguages, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getRemoteImagesRequestBuilder(itemId, type, startIndex, limit, providerName, includeAllLanguages, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        RemoteImageResult responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<RemoteImageResult>() {});
  ...
  private HttpRequest.Builder getRemoteImagesRequestBuilder(@org.eclipse.jdt.annotation.NonNull
 UUID itemId, @org.eclipse.jdt.annotation.Nullable
 ImageType type, @org.eclipse.jdt.annotation.Nullable
 Integer startIndex, @org.eclipse.jdt.annotation.Nullable
 Integer limit, @org.eclipse.jdt.annotation.Nullable
