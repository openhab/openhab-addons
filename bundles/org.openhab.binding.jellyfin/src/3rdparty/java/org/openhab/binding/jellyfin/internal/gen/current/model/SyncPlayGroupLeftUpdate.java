...
public class SyncPlayGroupLeftUpdate {
    ...
    private @org.eclipse.jdt.annotation.Nullable GroupUpdateType type = GroupUpdateType.GROUP_LEFT;
     ...
     */
    @JsonCreator
    public SyncPlayGroupLeftUpdate(@JsonProperty(value = JSON_PROPERTY_GROUP_ID) UUID groupId,
