...
public class AuthenticateUserByName {
  ...
  public AuthenticateUserByName username(@org.eclipse.jdt.annotation.Nullable
 String username) {
 ...
 String username) {
  ...
  public AuthenticateUserByName pw(@org.eclipse.jdt.annotation.Nullable
 String pw) {
    this.pw = pw;
    return this;
  }
 ...
 String pw) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getPw() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPw%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPw()))));
    }
