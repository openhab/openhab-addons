...
public class UtcTimeResponse {
  ...
  public UtcTimeResponse requestReceptionTime(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime requestReceptionTime) {
  ...
  public UtcTimeResponse responseTransmissionTime(@org.eclipse.jdt.annotation.Nullable
 ...
 OffsetDateTime responseTransmissionTime) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getRequestReceptionTime() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRequestReceptionTime%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRequestReceptionTime()))));
    }

    // add `ResponseTransmissionTime` to the URL query string
    if (getResponseTransmissionTime() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sResponseTransmissionTime%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getResponseTransmissionTime()))));
    }
