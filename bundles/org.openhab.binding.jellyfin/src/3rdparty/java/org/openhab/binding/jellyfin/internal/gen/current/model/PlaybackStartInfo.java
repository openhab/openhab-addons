...
import org.openhab.binding.jellyfin.internal.gen.current.model.PlaybackOrder;
import org.openhab.binding.jellyfin.internal.gen.current.model.QueueItem;
...
public class PlaybackStartInfo {
  ...
  public PlaybackStartInfo canSeek(@org.eclipse.jdt.annotation.Nullable
 Boolean canSeek) {
 ...
 Boolean canSeek) {
  ...
  public PlaybackStartInfo item(@org.eclipse.jdt.annotation.Nullable
 BaseItemDto item) {
    this.item = item;
    return this;
  }
 ...
 BaseItemDto item) {
  ...
  public PlaybackStartInfo itemId(@org.eclipse.jdt.annotation.Nullable
 UUID itemId) {
    this.itemId = itemId;
    return this;
  }
 ...
 UUID itemId) {
  ...
  public PlaybackStartInfo sessionId(@org.eclipse.jdt.annotation.Nullable
 String sessionId) {
 ...
 String sessionId) {
  ...
  public PlaybackStartInfo mediaSourceId(@org.eclipse.jdt.annotation.Nullable
 ...
 String mediaSourceId) {
  ...
  public PlaybackStartInfo audioStreamIndex(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer audioStreamIndex) {
  ...
  public PlaybackStartInfo subtitleStreamIndex(@org.eclipse.jdt.annotation.Nullable
 ...
 Integer subtitleStreamIndex) {
  ...
  public PlaybackStartInfo isPaused(@org.eclipse.jdt.annotation.Nullable
 Boolean isPaused) {
 ...
 Boolean isPaused) {
  ...
  public PlaybackStartInfo isMuted(@org.eclipse.jdt.annotation.Nullable
 Boolean isMuted) {
 ...
 Boolean isMuted) {
  ...
  public PlaybackStartInfo positionTicks(@org.eclipse.jdt.annotation.Nullable
 Long positionTicks) {
 ...
 Long positionTicks) {
  ...
  public PlaybackStartInfo playbackStartTimeTicks(@org.eclipse.jdt.annotation.Nullable
 ...
 Long playbackStartTimeTicks) {
  ...
  public PlaybackStartInfo volumeLevel(@org.eclipse.jdt.annotation.Nullable
 Integer volumeLevel) {
 ...
 Integer volumeLevel) {
  ...
  public PlaybackStartInfo brightness(@org.eclipse.jdt.annotation.Nullable
 Integer brightness) {
 ...
 Integer brightness) {
  ...
  public PlaybackStartInfo aspectRatio(@org.eclipse.jdt.annotation.Nullable
 String aspectRatio) {
 ...
 String aspectRatio) {
  ...
  public PlaybackStartInfo playMethod(@org.eclipse.jdt.annotation.Nullable
 ...
 PlayMethod playMethod) {
  ...
  public PlaybackStartInfo liveStreamId(@org.eclipse.jdt.annotation.Nullable
 String liveStreamId) {
 ...
 String liveStreamId) {
  ...
  public PlaybackStartInfo playSessionId(@org.eclipse.jdt.annotation.Nullable
 ...
 String playSessionId) {
  ...
  public PlaybackStartInfo repeatMode(@org.eclipse.jdt.annotation.Nullable
 ...
 RepeatMode repeatMode) {
  ...
  public PlaybackStartInfo playbackOrder(@org.eclipse.jdt.annotation.Nullable
 ...
 PlaybackOrder playbackOrder) {
  ...
  public PlaybackStartInfo nowPlayingQueue(@org.eclipse.jdt.annotation.Nullable
 ...
 List<QueueItem> nowPlayingQueue) {
  ...
  public PlaybackStartInfo playlistItemId(@org.eclipse.jdt.annotation.Nullable
 ...
 String playlistItemId) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCanSeek() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sCanSeek%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCanSeek()))));
    }
    ...
    if (getMediaSourceId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sMediaSourceId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMediaSourceId()))));
    }

    // add `AudioStreamIndex` to the URL query string
    if (getAudioStreamIndex() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sAudioStreamIndex%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAudioStreamIndex()))));
    }

    // add `SubtitleStreamIndex` to the URL query string
    if (getSubtitleStreamIndex() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sSubtitleStreamIndex%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getSubtitleStreamIndex()))));
    }

    // add `IsPaused` to the URL query string
    if (getIsPaused() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsPaused%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsPaused()))));
    }

    // add `IsMuted` to the URL query string
    if (getIsMuted() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sIsMuted%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsMuted()))));
    }

    // add `PositionTicks` to the URL query string
    if (getPositionTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPositionTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPositionTicks()))));
    }

    // add `PlaybackStartTimeTicks` to the URL query string
    if (getPlaybackStartTimeTicks() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlaybackStartTimeTicks%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlaybackStartTimeTicks()))));
    }

    // add `VolumeLevel` to the URL query string
    if (getVolumeLevel() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sVolumeLevel%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getVolumeLevel()))));
    }

    // add `Brightness` to the URL query string
    if (getBrightness() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sBrightness%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getBrightness()))));
    }
    ...
    if (getPlayMethod() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlayMethod%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlayMethod()))));
    }

    // add `LiveStreamId` to the URL query string
    if (getLiveStreamId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sLiveStreamId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getLiveStreamId()))));
    }

    // add `PlaySessionId` to the URL query string
    if (getPlaySessionId() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlaySessionId%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlaySessionId()))));
    }

    // add `RepeatMode` to the URL query string
    if (getRepeatMode() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sRepeatMode%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getRepeatMode()))));
    }

    // add `PlaybackOrder` to the URL query string
    if (getPlaybackOrder() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sPlaybackOrder%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlaybackOrder()))));
    }
    ...
    if (getNowPlayingQueue() != null) {
      for (int i = 0; i < getNowPlayingQueue().size(); i++) {
        if (getNowPlayingQueue().get(i) != null) {
          joiner.add(getNowPlayingQueue().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%sNowPlayingQueue%s%s", prefix, suffix,
