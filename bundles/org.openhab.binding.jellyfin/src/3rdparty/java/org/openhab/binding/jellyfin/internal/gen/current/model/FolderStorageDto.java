 ...
 */
@JsonPropertyOrder({
  FolderStorageDto.JSON_PROPERTY_PATH,
  FolderStorageDto.JSON_PROPERTY_FREE_SPACE,
  FolderStorageDto.JSON_PROPERTY_USED_SPACE,
  FolderStorageDto.JSON_PROPERTY_STORAGE_TYPE,
...
public class FolderStorageDto {
  ...
  public FolderStorageDto path(@org.eclipse.jdt.annotation.Nullable
 String path) {
    this.path = path;
    return this;
  }
 ...
 String path) {
  ...
  public FolderStorageDto freeSpace(@org.eclipse.jdt.annotation.Nullable
 Long freeSpace) {
 ...
 Long freeSpace) {
  ...
  public FolderStorageDto usedSpace(@org.eclipse.jdt.annotation.Nullable
 Long usedSpace) {
 ...
 Long usedSpace) {
  ...
  public FolderStorageDto storageType(@org.eclipse.jdt.annotation.Nullable
 String storageType) {
 ...
 String storageType) {
  ...
  public FolderStorageDto deviceId(@org.eclipse.jdt.annotation.Nullable
 String deviceId) {
 ...
 String deviceId) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getFreeSpace() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sFreeSpace%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getFreeSpace()))));
    }

    // add `UsedSpace` to the URL query string
    if (getUsedSpace() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sUsedSpace%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getUsedSpace()))));
    }

    // add `StorageType` to the URL query string
    if (getStorageType() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sStorageType%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getStorageType()))));
    }
