...
/**
 * The {@link ConnectionStatusResponse} is the Java class used to map the
 * response of the connection API
 * https://dev.freebox.fr/sdk/os/connection/#
 *
 * @author Laurent Garnier - Initial contribution
 */
@RelativePath(relativeUrl = "connection/", retryAuth = true)
public class ConnectionStatusResponse extends FreeboxResponse<ConnectionStatus> {
    @Override
