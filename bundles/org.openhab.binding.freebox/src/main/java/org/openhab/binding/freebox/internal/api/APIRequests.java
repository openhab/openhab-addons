...
public class APIRequests {
    ...
    public static class VirtualMachine extends APIAction {
        public VirtualMachine(String vmId) {
            super(vmId);
        }
    }
    ...
    @RequestAnnotation(relativeUrl = "login/authorize/", responseClass = AuthorizationStatusResponse.class, maxRetries = 0, endWithSlash = false)
