...
/**
 * The {@link LanConfigResponse} is the Java class used to map the
 * response of the LAN configuration API
 * https://dev.freebox.fr/sdk/os/lan/#
 *
 * @author Laurent Garnier - Initial contribution
 */
@RequestAnnotation(relativeUrl = "lan/config/", retryAuth = true)
public class LanConfigResponse extends FreeboxResponse<LanConfig> {
    @Override
