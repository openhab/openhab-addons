...
public enum RotelCommand {
    ...
    POWER("Request current power status", (byte) 0, (byte) 0, "get_current_power", "power?"),
    ZONE_SELECT("Zone Select", RotelConnector.PRIMARY_CMD, (byte) 0x23, null, null),
    MAIN_ZONE_POWER_TOGGLE("Main Zone Power Toggle", RotelConnector.MAIN_ZONE_CMD, (byte) 0x0A, null, null),
    MAIN_ZONE_POWER_OFF("Main Zone Power Off", RotelConnector.MAIN_ZONE_CMD, (byte) 0x4A, null, null),
    MAIN_ZONE_POWER_ON("Main Zone Power On", RotelConnector.MAIN_ZONE_CMD, (byte) 0x4B, null, null),
    ZONE2_POWER_TOGGLE("Zone 2 Power Toggle", RotelConnector.ZONE2_CMD, (byte) 0x0A, null, null),
    ZONE2_POWER_OFF("Zone 2 Power Off", RotelConnector.ZONE2_CMD, (byte) 0x4A, null, null),
    ZONE2_POWER_ON("Zone 2 Power On", RotelConnector.ZONE2_CMD, (byte) 0x4B, null, null),
    ZONE3_POWER_TOGGLE("Zone 3 Power Toggle", RotelConnector.ZONE3_CMD, (byte) 0x0A, null, null),
    ZONE3_POWER_OFF("Zone 3 Power Off", RotelConnector.ZONE3_CMD, (byte) 0x4A, null, null),
    ZONE3_POWER_ON("Zone 3 Power On", RotelConnector.ZONE3_CMD, (byte) 0x4B, null, null),
    ZONE4_POWER_TOGGLE("Zone 4 Power Toggle", RotelConnector.ZONE4_CMD, (byte) 0x0A, null, null),
    ZONE4_POWER_OFF("Zone 4 Power Off", RotelConnector.ZONE4_CMD, (byte) 0x4A, null, null),
    ZONE4_POWER_ON("Zone 4 Power On", RotelConnector.ZONE4_CMD, (byte) 0x4B, null, null),
    ...
    VOLUME_GET("Request current volume level", (byte) 0, (byte) 0, "get_volume", "volume?"),
    VOLUME_GET_MIN("Request Min volume level", (byte) 0, (byte) 0, "get_volume_min", null),
    VOLUME_GET_MAX("Request Max volume level", (byte) 0, (byte) 0, "get_volume_max", null),
    MUTE_TOGGLE("Mute Toggle", RotelConnector.PRIMARY_CMD, (byte) 0x1E, "mute", "mute"),
    MUTE_ON("Mute On", (byte) 0, (byte) 0, "mute_on", "mute_on"),
    MUTE_OFF("Mute Off", (byte) 0, (byte) 0, "mute_off", "mute_off"),
    MUTE("Request current mute status", (byte) 0, (byte) 0, "get_mute_status", "mute?"),
    MAIN_ZONE_VOLUME_UP("Main Zone Volume Up", RotelConnector.MAIN_ZONE_CMD, (byte) 0, null, null),
    MAIN_ZONE_VOLUME_DOWN("Main Zone Volume Down", RotelConnector.MAIN_ZONE_CMD, (byte) 1, null, null),
    MAIN_ZONE_MUTE_TOGGLE("Main Zone Mute Toggle", RotelConnector.MAIN_ZONE_CMD, (byte) 0x1E, null, null),
    MAIN_ZONE_MUTE_ON("Main Zone Mute On", RotelConnector.MAIN_ZONE_CMD, (byte) 0x6C, null, null),
    MAIN_ZONE_MUTE_OFF("Main Zone Mute Off", RotelConnector.MAIN_ZONE_CMD, (byte) 0x6D, null, null),
    ZONE2_VOLUME_UP("Zone 2 Volume Up", RotelConnector.ZONE2_CMD, (byte) 0, null, null),
    ZONE2_VOLUME_DOWN("Zone 2 Volume Down", RotelConnector.ZONE2_CMD, (byte) 1, null, null),
    ZONE2_VOLUME_SET("Set Zone 2 Volume to level", RotelConnector.ZONE2_VOLUME_CMD, (byte) 0, null, null),
    ZONE2_MUTE_TOGGLE("Zone 2 Mute Toggle", RotelConnector.ZONE2_CMD, (byte) 0x1E, null, null),
    ZONE2_MUTE_ON("Zone 2 Mute On", RotelConnector.ZONE2_CMD, (byte) 0x6C, null, null),
    ZONE2_MUTE_OFF("Zone 2 Mute Off", RotelConnector.ZONE2_CMD, (byte) 0x6D, null, null),
    ZONE3_VOLUME_UP("Zone 3 Volume Up", RotelConnector.ZONE3_CMD, (byte) 0, null, null),
    ZONE3_VOLUME_DOWN("Zone 3 Volume Down", RotelConnector.ZONE3_CMD, (byte) 1, null, null),
    ZONE3_VOLUME_SET("Set Zone 3 Volume to level", RotelConnector.ZONE3_VOLUME_CMD, (byte) 0, null, null),
    ZONE3_MUTE_TOGGLE("Zone 3 Mute Toggle", RotelConnector.ZONE3_CMD, (byte) 0x1E, null, null),
    ZONE3_MUTE_ON("Zone 3 Mute On", RotelConnector.ZONE3_CMD, (byte) 0x6C, null, null),
    ZONE3_MUTE_OFF("Zone 3 Mute Off", RotelConnector.ZONE3_CMD, (byte) 0x6D, null, null),
    ZONE4_VOLUME_UP("Zone 4 Volume Up", RotelConnector.ZONE4_CMD, (byte) 0, null, null),
    ZONE4_VOLUME_DOWN("Zone 4 Volume Down", RotelConnector.ZONE4_CMD, (byte) 1, null, null),
    ZONE4_VOLUME_SET("Set Zone 4 Volume to level", RotelConnector.ZONE4_VOLUME_CMD, (byte) 0, null, null),
    ZONE4_MUTE_TOGGLE("Zone 4 Mute Toggle", RotelConnector.ZONE4_CMD, (byte) 0x1E, null, null),
    ZONE4_MUTE_ON("Zone 4 Mute On", RotelConnector.ZONE4_CMD, (byte) 0x6C, null, null),
    ZONE4_MUTE_OFF("Zone 4 Mute Off", RotelConnector.ZONE4_CMD, (byte) 0x6D, null, null),
    ...
    SOURCE_VIDEO7("Source Video 7", (byte) 0, (byte) 0, "video7", "video7"),
    SOURCE_VIDEO8("Source Video 8", (byte) 0, (byte) 0, "video8", "video8"),
    ...
    SOURCE_PCUSB("Source PC USB", (byte) 0, (byte) 0, "pc_usb", "pc_usb"),
    SOURCE_MULTI_INPUT("Source Multi Input", RotelConnector.PRIMARY_CMD, (byte) 0x15, "multi_input", "multi_input"),
    SOURCE_AUX("Source Aux", (byte) 0, (byte) 0, "aux", "aux"),
    SOURCE_AUX1("Source Aux 1", (byte) 0, (byte) 0, "aux1", "aux1"),
    SOURCE_AUX2("Source Aux 2", (byte) 0, (byte) 0, "aux2", "aux2"),
    SOURCE_AUX1_COAX("Source Aux 1 Coax", (byte) 0, (byte) 0, "aux1_coax", "aux1_coax"),
    SOURCE_AUX1_OPT("Source Aux 1 Optical", (byte) 0, (byte) 0, "aux1_opt", "aux1_opt"),
    SOURCE_COAX1("Source Coax 1", (byte) 0, (byte) 0, "coax1", "coax1"),
    SOURCE_COAX2("Source Coax 2", (byte) 0, (byte) 0, "coax2", "coax2"),
    SOURCE_COAX3("Source Coax 3", (byte) 0, (byte) 0, "coax3", "coax3"),
    SOURCE_OPT1("Source Optical 1", (byte) 0, (byte) 0, "opt1", "opt1"),
    SOURCE_OPT2("Source Optical 2", (byte) 0, (byte) 0, "opt2", "opt2"),
    SOURCE_OPT3("Source Optical 3", (byte) 0, (byte) 0, "opt3", "opt3"),
    SOURCE_BLUETOOTH("Source Bluetooth", (byte) 0, (byte) 0, "bluetooth", "bluetooth"),
    SOURCE_ROTEL_CD("Source Rotel CD", (byte) 0, (byte) 0, "rcd", null),
    SOURCE_XLR("Source XLR", (byte) 0, (byte) 0, "bal_xlr", "bal_xlr"),
    SOURCE_FM("Source FM", (byte) 0, (byte) 0, "fm", "fm"),
    SOURCE_DAB("Source DAB", (byte) 0, (byte) 0, "dab", "dab"),
    SOURCE_PLAYFI("Source PlayFi", (byte) 0, (byte) 0, "playfi", "playfi"),
    SOURCE_IRADIO("Source iRadio", (byte) 0, (byte) 0, "iradio", "iradio"),
    SOURCE_NETWORK("Source Network", (byte) 0, (byte) 0, "network", "network"),
    SOURCE("Request current source", (byte) 0, (byte) 0, "get_current_source", "source?"),
    ...
    STEREO9("9 Channel Stereo", (byte) 0, (byte) 0, "9channel", "9channel"),
    STEREO11("11 Channel Stereo", (byte) 0, (byte) 0, "11channel", "11channel"),
    DSP1("DSP 1", RotelConnector.PRIMARY_CMD, (byte) 0x57, null, null),
    DSP2("DSP 2", RotelConnector.PRIMARY_CMD, (byte) 0x58, null, null),
    DSP3("DSP 3", RotelConnector.PRIMARY_CMD, (byte) 0x59, null, null),
    DSP4("DSP 4", RotelConnector.PRIMARY_CMD, (byte) 0x5A, null, null),
    PROLOGIC("Dolby Pro Logic", RotelConnector.PRIMARY_CMD, (byte) 0x5F, null, null),
    ...
    ATMOS("Dolby Atmos", (byte) 0, (byte) 0, "dolby_atmos", "dolby_atmos"),
    NEURAL_X("dts Neural:X", (byte) 0, (byte) 0, "dts_neural", "dts_neural"),
    BYPASS("Analog Bypass", RotelConnector.PRIMARY_CMD, (byte) 0x11, "bypass", "bypass"),
    DSP_MODE("Request current DSP mode", (byte) 0, (byte) 0, "get_dsp_mode", "dsp_mode"),
    TONE_MAX("Request Max tone level", (byte) 0, (byte) 0, "get_tone_max", null),
    TONE_CONTROL_SELECT("Tone Control Select", RotelConnector.PRIMARY_CMD, (byte) 0x67, null, null),
    ...
    TREBLE_SET("Set Treble to level", (byte) 0, (byte) 0, "treble_", "treble_"),
    TREBLE("Request current treble level", (byte) 0, (byte) 0, "get_treble", "treble?"),
    ...
    BASS_SET("Set Bass to level", (byte) 0, (byte) 0, "bass_", "bass_"),
    BASS("Request current bass level", (byte) 0, (byte) 0, "get_bass", "bass?"),
    RECORD_FONCTION_SELECT("Record Function Select", RotelConnector.PRIMARY_CMD, (byte) 0x17, null, null),
    ...
    CD_PLAY_STATUS("Request CD play status", (byte) 0, (byte) 0, "get_cd_play_status", null),
    PLAY_STATUS("Request source play status", (byte) 0, (byte) 0, "get_play_status", "status"),
    ...
    TRACK("Request current CD track number", (byte) 0, (byte) 0, null, "track"),
    DISPLAY_REFRESH("Display Refresh", RotelConnector.PRIMARY_CMD, (byte) 0xFF, null, null),
    UPDATE_AUTO("Set Update to Auto", (byte) 0, (byte) 0, "display_update_auto", "rs232_update_on"),
    UPDATE_MANUAL("Set Update to Manual", (byte) 0, (byte) 0, "display_update_manual", "rs232_update_off");
