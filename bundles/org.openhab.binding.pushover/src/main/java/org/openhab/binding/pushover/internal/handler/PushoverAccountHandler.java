...
public class PushoverAccountHandler extends BaseThingHandler implements ConfigOptionProvider {
    ...
    private static final Collection<Class<? extends ThingHandlerService>> SUPPORTED_THING_ACTIONS = Collections
            .singleton(PushoverThingActions.class);
    ...
    public PushoverMessageBuilder getDefaultPushoverMessageBuilder(String message) {
        ...
        if (!DEFAULT.equals(config.sound)) {
    ...
    public @Nullable Collection<ParameterOption> getParameterOptions(URI uri, String param, @Nullable String context,
        ...
        String URI_STR = "thing-type:pushover:pushover-account";
