...
public class VisualCrossingApi {
     ...
     * @see <a href="https://www.visualcrossing.com/resources/documentation/weather-api/timeline-weather-api/">Timeline Weather API</a>
     */
    public WeatherResponse timeline(String location, @Nullable UnitGroup unitGroup, @Nullable String lang, @Nullable String dateFrom, @Nullable String dateTo) throws VisualCrossingApiException, VisualCrossingAuthException, VisualCrossingRateException {
        if (unitGroup == null) {
            unitGroup = METRIC;
        }
    ...
    /**
     * @see <a href="https://www.visualcrossing.com/resources/documentation/weather-api/unit-groups-and-measurement-units/">Unit groups and measurement units</a>
     */
    public enum UnitGroup {
        METRIC("metric"), US("us"), UK("uk");
