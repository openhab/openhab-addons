...
public class JdbcConfiguration {
    ...
    private boolean updateConfig() {
        ...
        if (dq != null && !dq.isBlank()) {
            dBDAO.tableDoubleQuotedTableNames = Boolean.parseBoolean(dq);
        } else {
            ...
            dBDAO.tableDoubleQuotedTableNames = Arrays.stream(postgresLike).anyMatch(dbShortcut::equals);
        }

        logger.debug("JDBC::updateConfig: tableDoubleQuotedTableNames={}", dBDAO.tableDoubleQuotedTableNames);
