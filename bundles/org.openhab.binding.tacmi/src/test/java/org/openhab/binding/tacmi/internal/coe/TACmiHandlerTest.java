...
public class TACmiHandlerTest {
	...
	public Object[][] provideOutputIndices() {
		return new Object[][] {{1, true, 0}, {2, true, 1}, {3, true, 2}, {4, true, 3}, {5, true, 0}, {32, true, 3},
			{1, false, 0}, {2, false, 1}, {16, false, 15}, {17, false, 0}, {32, false, 15}};
	}
	...
	{
		return new Object[][] {{MessageType.ANALOG, 1, (byte)1 },
			{MessageType.ANALOG, 2, (byte)1 },
			{MessageType.ANALOG, 3, (byte)1 },
			{MessageType.ANALOG, 4, (byte)1 },
			{MessageType.ANALOG, 5, (byte)2 },
			{MessageType.ANALOG, 32, (byte)8 },
			{MessageType.DIGITAL, 1, (byte)0 },
			{MessageType.DIGITAL, 16, (byte)0 },
			{MessageType.DIGITAL, 17, (byte)9 },
			{MessageType.DIGITAL, 32, (byte)9 }};
	}
