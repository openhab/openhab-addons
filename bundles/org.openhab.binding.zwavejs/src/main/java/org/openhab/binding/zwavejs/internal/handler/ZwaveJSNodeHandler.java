...
public class ZwaveJSNodeHandler extends BaseThingHandler implements ZwaveNodeListener {
    ...
    private boolean isSetupCurrent(long generation) {
        return generation < 0 || isNodeDefinitionUpdateCurrent(generation);
    }
