...
public class SagerWeatherCaster {
    ...
    private final static Map<String, String> sageForecaster = new HashMap<String, String>() {
        private static final long serialVersionUID = -61976442568570278L;
        {
            put("A111", "CU8");
            put("A112", "CU8");
            put("A113", "CU8");
    ...
    private String[] usedDirections = null;
    ...
    public String getWindDirection() {
        if (prevision != null) {
            return String.valueOf(prevision.zWindDirection);
        } else {
            return "-";
        }
    }
    ...
    public String getWindDirection2() {
        if (prevision != null) {
            return String.valueOf(prevision.zWindDirection2);
        } else {
            return "-";
        }
    }
