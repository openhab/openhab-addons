...
public class SurePetcareDeviceTest {
    ...
    public void testJsonDeserializeHub() throws ParseException {
        ...
        assertEquals(Integer.valueOf(296464), response.getId());
        assertEquals(Integer.valueOf(1), response.getProductId());
        assertEquals(Integer.valueOf(48712), response.getHouseholdId());
        ...
        assertEquals(Integer.valueOf(4), response.getControl().getLedModeId());
        assertEquals(Integer.valueOf(0), response.getControl().getPairingModeId());
        assertEquals(Integer.valueOf(4), response.getStatus().getLedModeId());
        assertEquals(Integer.valueOf(0), response.getStatus().getPairingModeId());
    ...
    public void testJsonDeserializeCatFlap() throws ParseException {
        ...
        assertEquals(Integer.valueOf(318966), response.getId());
        assertEquals(Integer.valueOf(6), response.getProductId());
        assertEquals(Integer.valueOf(48712), response.getHouseholdId());
        ...
        assertEquals(Integer.valueOf(0), response.getStatus().getLocking().modeId);
    }
