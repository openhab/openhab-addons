...
public class EnoceanBleDiscoveryParticipant implements BluetoothDiscoveryParticipant {
    private final Logger logger = LoggerFactory.getLogger(BluetoothDiscoveryParticipant.class);
    ...
    public ThingUID getThingUID(BluetoothDevice device) {
        ...
        logger.warn("Discovered device {} with manufacturerId {} and name {}", device.getAddress(), manufacturerId, device.getName());
