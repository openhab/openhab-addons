...
public class EnoceanBleRockerHandler extends BeaconBluetoothHandler {
    ...
    public void onScanRecordReceived(BluetoothScanNotification scanNotification) {
        ...
        logger.debug("Received new scan notification for {}: {}", device.getAddress(),
                manufacturerData);
        try {
    ...
    protected String resolveChannel(EnoceanBlePtm215Event event) {
        ...
        throw new IllegalStateException("PTM215B event cannot be resolved correctly to a channel, probably received message is invalid");
    }
    ...
    protected String resolveTriggerEvent(EnoceanBlePtm215Event event) {
        ...
        throw new IllegalStateException("PTM215B event cannot be resolved correctly to an openHAB event, probably received message is invalid");
    }
}
