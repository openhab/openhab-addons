...
/**
 * The {@link KostalInverterPikoNewGenerationBindingConstants} class defines common constants, which are
 * used across the whole binding.
 *
 * @author Örjan Backsell - Initial contribution
 */
@NonNullByDefault
public class KostalInverterPikoNewGenerationBindingConstants {
