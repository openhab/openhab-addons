...
public class HomieImplementationTest extends MqttOSGiTest {
    ...
    public void retrieveAttributes() throws Exception {
        ...
        Node node = new Node(DEVICE_TOPIC, "testnode", ThingChannelConstants.TEST_HOMIE_THING, callback,
                new NodeAttributes());
    ...
    public void parseHomieTree() throws Exception {
        ...
        Device device = spy(
                new Device(ThingChannelConstants.TEST_HOMIE_THING, callback, new DeviceAttributes(), nodeMap));
