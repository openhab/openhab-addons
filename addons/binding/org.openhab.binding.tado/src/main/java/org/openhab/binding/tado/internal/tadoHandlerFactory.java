...
import static org.openhab.binding.tado.tadoBindingConstants.THING_TYPE_THERMOSTAT;
...
import org.openhab.binding.tado.handler.tadoThermostatHandler;
...
public class tadoHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(THING_TYPE_THERMOSTAT)) {
            return new tadoThermostatHandler(thing);
        }
