...
public class RioZoneHandler extends AbstractBridgeHandler<RioZoneProtocol> {
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        ...
        if (id.equals(RioConstants.CHANNEL_ZONEBASS)) {
            ...
            if (command instanceof DecimalType) {
                ...
                logger.error("Received a ZONE SLEEP TIME REMAINING channel command with a non DecimalType: " + command);
            }
    ...
    public void initialize() {
        ...
        setProtocolHandler(new RioZoneProtocol(_zone, _controller, socketSession, new RioHandlerCallback() {
            @Override
