...
import static org.openhab.binding.nikohomecontrol.NikoHomeControlBindingConstants.BINDING_ID;
...
public class NikoHomeControlBridgeDiscoveryService extends AbstractDiscoveryService {
    ...
    public NikoHomeControlBridgeDiscoveryService() {
        super(NikoHomeControlBindingConstants.BRIDGE_THING_TYPES_UIDS, TIMEOUT, false);
