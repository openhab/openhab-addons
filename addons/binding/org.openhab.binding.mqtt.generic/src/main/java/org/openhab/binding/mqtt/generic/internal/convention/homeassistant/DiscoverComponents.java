...
public class DiscoverComponents implements MqttMessageSubscriber {
    ...
    public static interface ComponentDiscovered {
        void componentDiscovered(HaID homeAssistantTopicID, HomeAssistentGroup component);
    }
    ...
    public void processMessage(String topic, byte[] payload) {
        ...
        HomeAssistentGroup component = CFactory.createComponent(thingUID, haID, config, updateListener, gson,
