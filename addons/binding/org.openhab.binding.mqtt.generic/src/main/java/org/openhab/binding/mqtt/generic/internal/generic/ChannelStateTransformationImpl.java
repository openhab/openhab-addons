 ...
 */
@NonNullByDefault
public class ChannelStateTransformationImpl implements ChannelStateTransformation {
    private final Logger logger = LoggerFactory.getLogger(ChannelStateTransformationImpl.class);
     ...
     */
    public ChannelStateTransformationImpl(String pattern, TransformationServiceProvider provider) {
