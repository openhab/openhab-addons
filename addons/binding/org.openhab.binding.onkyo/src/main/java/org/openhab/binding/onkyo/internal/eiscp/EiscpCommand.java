...
public enum EiscpCommand {
    ...
    SOURCE("SLI", EiscpCommandRef.SOURCE_SET),
    ...
    LISTEN_MODE_SET("LMD%02X", EiscpCommandRef.LISTEN_MODE_SET),
    LISTEN_MODE("LMD", EiscpCommandRef.LISTEN_MODE_SET),
    ...
    NETUSB_SONG_ARTIST("NAT", EiscpCommandRef.NETUSB_SONG_ARTIST_QUERY),
    NETUSB_SONG_ALBUM_QUERY("NALQSTN", EiscpCommandRef.NETUSB_SONG_ALBUM_QUERY),
    NETUSB_SONG_ALBUM("NAL", EiscpCommandRef.NETUSB_SONG_ALBUM_QUERY),
    NETUSB_SONG_TITLE_QUERY("NTIQSTN", EiscpCommandRef.NETUSB_SONG_TITLE_QUERY),
    NETUSB_SONG_TITLE("NTI", EiscpCommandRef.NETUSB_SONG_TITLE_QUERY),
    NETUSB_SONG_ELAPSEDTIME_QUERY("NTMQSTN", EiscpCommandRef.NETUSB_SONG_ELAPSEDTIME_QUERY),
    NETUSB_SONG_ELAPSEDTIME("NTM", EiscpCommandRef.NETUSB_SONG_ELAPSEDTIME_QUERY),
    NETUSB_SONG_TRACK_QUERY("NTRQSTN", EiscpCommandRef.NETUSB_SONG_TRACK_QUERY),
    NETUSB_SONG_TRACK("NTR", EiscpCommandRef.NETUSB_SONG_TRACK_QUERY),
    ...
    */
    ...
    ZONE3_SOURCE_INTERNETRADIO("SL328", EiscpCommandRef.ZONE3_SOURCE_INTERNETRADIO),
