...
| netmenu#selection              | Number       | Number of the currently selected USB/Net menu entry (0-9) |
| netmenu#item0                  | String       | Text of the USB/Net menu entry 0 |
| netmenu#item1                  | String       | Text of the USB/Net menu entry 1 |
| netmenu#item2                  | String       | Text of the USB/Net menu entry 2 |
| netmenu#item3                  | String       | Text of the USB/Net menu entry 3 |
| netmenu#item4                  | String       | Text of the USB/Net menu entry 4 |
| netmenu#item5                  | String       | Text of the USB/Net menu entry 5 |
| netmenu#item6                  | String       | Text of the USB/Net menu entry 6 |
| netmenu#item7                  | String       | Text of the USB/Net menu entry 7 |
| netmenu#item8                  | String       | Text of the USB/Net menu entry 8 |
| netmenu#item9                  | String       | Text of the USB/Net menu entry 9 |
