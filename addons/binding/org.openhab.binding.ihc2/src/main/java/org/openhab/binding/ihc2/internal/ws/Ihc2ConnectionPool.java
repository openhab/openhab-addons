 ...
 * @since 1.7.0
 */
public class Ihc2ConnectionPool {

    private final Logger logger = LoggerFactory.getLogger(Ihc2ConnectionPool.class);

    private static Ihc2ConnectionPool instance = null;
    ...
    private static class InstanceHolder {
        static final Ihc2ConnectionPool INSTANCE = new Ihc2ConnectionPool();
    }

    protected Ihc2ConnectionPool() {
        init();
    }

    public static Ihc2ConnectionPool getInstance() {
        return InstanceHolder.INSTANCE;
        //
        // if (instance == null) {
        // synchronized (Ihc2ConnectionPool.class) {
        // if (instance == null) {
        // instance = new Ihc2ConnectionPool();
        // }
        // }
        // }
        // return instance;
