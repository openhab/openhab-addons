 ...
 * @since 1.5.0
 */
public class Ihc2ResourceInteractionService extends Ihc2HttpsClient {

    private final Logger logger = LoggerFactory.getLogger(Ihc2ResourceInteractionService.class);

    private String url;
    private int timeout;

    Ihc2ResourceInteractionService(String host, int timeout) {
        ...
        try {
            ...
            if (nodeList.getLength() == 1) {
                ...
                if (val.getResourceID() == resoureId) {
                    ...
                    throw new Ihc2Execption("No resource id found");
                }

            } else {
                throw new Ihc2Execption("No resource value found");
            }
    ...
    private WSResourceValue parseResourceValue(Node n, int index) throws XPathExpressionException {
        ...
        if (StringUtils.isNotBlank(resourceId)) {
            ...
            logger.error("Unsupported value type for node: {}, index {}", n, index);
    ...
    public boolean resourceUpdate(WSResourceValue value) throws Ihc2Execption {
        ...
        if (value instanceof WSFloatingPointValue) {
            ...
            throw new Ihc2Execption("Unsupported value type " + value.getClass().toString());
        }

        return retval;
    }

    public boolean resourceUpdate(WSBooleanValue value) throws Ihc2Execption {
        final String soapQuery = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
    ...
    public boolean resourceUpdate(WSFloatingPointValue value) throws Ihc2Execption {
        final String soapQuery = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                + "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                + "<soap:Body>" + " <setResourceValue1 xmlns=\"utcs\">"
    ...
    public boolean resourceUpdate(WSIntegerValue value) throws Ihc2Execption {
        final String soapQuery = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                + "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                + "<soap:Body>" + " <setResourceValue1 xmlns=\"utcs\">"
    ...
    public boolean resourceUpdate(WSTimerValue value) throws Ihc2Execption {
        final String soapQuery = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                + "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                + "<soap:Body>" + " <setResourceValue1 xmlns=\"utcs\">"
    ...
    public boolean resourceUpdate(WSWeekdayValue value) throws Ihc2Execption {
        final String soapQuery = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                + "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                + "<soap:Body>" + " <setResourceValue1 xmlns=\"utcs\">"
    ...
    public boolean resourceUpdate(WSEnumValue value) throws Ihc2Execption {
        final String soapQuery = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                + "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                + "<soap:Body>" + " <setResourceValue1 xmlns=\"utcs\">"
    ...
    public boolean resourceUpdate(WSTimeValue value) throws Ihc2Execption {
        final String soapQuery = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                + "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                + "<soap:Body>" + " <setResourceValue1 xmlns=\"utcs\">"
    ...
    public boolean resourceUpdate(WSDateValue value) throws Ihc2Execption {
        final String soapQuery = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                + "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
                + "<soap:Body>" + " <setResourceValue1 xmlns=\"utcs\">"
    ...
    private boolean doResourceUpdate(String query) throws Ihc2Execption {
        openConnection(url);
        String response = sendQuery(query, timeout);
        closeConnection();
     ...
     */
    public void enableRuntimeValueNotifications(HashSet<? extends Integer> resourceIdList) throws Ihc2Execption {
