...
import org.openhab.binding.ihc2.internal.ws.datatypes.WSBaseDataType;
 ...
 * @since 1.5.0
 */
public class Ihc2ControllerService extends Ihc2HttpsClient {
    private final Logger logger = LoggerFactory.getLogger(Ihc2ControllerService.class);
    ...
    Ihc2ControllerService(String host, int timeout) {
        logger.info("Ihc2ControllerService(): host {}", host);
     ...
     */
    public synchronized int getProjectNumberOfSegments() throws Ihc2Execption {
        logger.debug("getProjectNumberOfSegments()");
        openConnection(url);
     ...
     */
    public synchronized int getProjectSegmentationSize() throws Ihc2Execption {
        logger.debug("getProjectSegmentationSize()");
        openConnection(url);
    ...
    public synchronized WSFile getProjectSegment(int index, int major, int minor) throws Ihc2Execption {
     ...
     */
    public synchronized WSControllerState getControllerState() throws Ihc2Execption {
        logger.debug("getControllerState()");
        openConnection(url);
    ...
    public synchronized WSControllerState waitStateChangeNotifications(WSControllerState previousState,
            int timeoutInSeconds) throws Ihc2Execption {
        logger.debug("waitStateChangeNotifications()");
        final String soapQuery = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
