...
public class WSDate {
    ...
    public boolean equals(WSDate obj) {
        return (this.hours == obj.hours && this.minutes == obj.minutes && this.seconds == obj.seconds
                && this.year == obj.year && this.day == obj.day
                && this.monthWithJanuaryAsOne == obj.monthWithJanuaryAsOne);
    }

    @Override
    public String toString() {
        return String.format("%04d-%02d-%02d %02d:%02d", year, monthWithJanuaryAsOne, day, hours, minutes);
    }
