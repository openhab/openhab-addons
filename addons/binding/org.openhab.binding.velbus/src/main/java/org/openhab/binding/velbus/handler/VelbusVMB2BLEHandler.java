...
/**
 * The {@link VelbusVMB2BLEHandler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author Cedric Boon - Initial contribution
 */
public class VelbusVMB2BLEHandler extends VelbusThingHandler {
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES = new HashSet<>(Arrays.asList(THING_TYPE_VMB2BLE));

    public VelbusVMB2BLEHandler(Thing thing) {
        super(thing, 2, 0, "Rollershutter");
    }
