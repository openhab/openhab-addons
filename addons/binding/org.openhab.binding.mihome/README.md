...
*   Install the binding
*   Power on new gateway or setup existing gateway to be discoverable
    ...
    2.  Create a Mi Home account or login using your existing account and set your region to Mainland China under Settings -> Locale (seems to be required)
    3.  Add your gateway if you havn't added it yet and update gateway to the latest firmware if asked (note that update window may pop up sequentially)
    4.  Enable developer mode:
        ...
        6.  Tap the toggle switch to enable WiFi functions. Note down the password (something like: 91bg8zfkf9vd6uw7)
