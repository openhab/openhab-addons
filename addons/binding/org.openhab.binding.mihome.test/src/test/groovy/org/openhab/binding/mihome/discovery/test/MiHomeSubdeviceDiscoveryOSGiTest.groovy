 ...
 */
package org.openhab.binding.mihome.discovery.test
...
class MiHomeSubdeviceDiscoveryTest extends AbstractMiHomeOSGiTest{
    ...
    public void 'create result for subdevice without a Thing'(){
        ...
        waitForAssert{
            MiHomeSubdevicesHandler handler = getThingHandler(MiHomeSubdevicesHandler)
            ...
            // This thing will be removed after the test
            subdeviceThing =  handler.getThing()
        }
