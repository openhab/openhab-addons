...
public class MagentaTVNetwork {
    ...
    private NetworkInterface localInterface = null;
     ...
     * @return
     */
    public boolean initLocalNet(NetworkAddressService networkAddressService) {
        try {
     ...
     * @throws Exception
     */
    public void sendWakeOnLAN(String ipAddr, String macAddress) throws Exception {
