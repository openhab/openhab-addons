...
public class MagentaTVPoweroffListener extends Thread {
    ...
    protected NetworkInterface networkInterface = null;
    protected byte[] buf = new byte[256];

    public MagentaTVPoweroffListener(MagentaTVHandlerFactory handlerFactory, NetworkInterface networkInterface) {
