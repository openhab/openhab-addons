 ...
 */
public class PowerMeterKwhUpdateHandler extends MessageHandler {
    private static final Logger logger = LoggerFactory.getLogger(PowerMeterKwhUpdateHandler.class);
    private String wattsChannel;

    PowerMeterKwhUpdateHandler(DeviceFeature p) {
        super(p);
    }
