...
public class HDanywhereBindingConstants {
	...
	public final static ThingTypeUID THING_TYPE_MATRIX = new ThingTypeUID(
			BINDING_ID, "matrix");

	// List of all Channel ids
	public enum Port {
		ONE(1, "port1"), TWO(2, "port2"), THREE(3, "port3"), FOUR(4, "port4"), FIVE(
				5, "port5"), SIX(6, "port6"), SEVEN(7, "port7"), EIGHT(8,
				"port8");
		...
		public static Port get(int valueSelectorNumber)
		...
		public static Port get(String valueSelectorText)
				throws IllegalArgumentException {
