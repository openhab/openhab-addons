...
```
Dimmer  E2R1LD01        "Roof lights [%d %%]"                                             (2E_R1_Bedroom)        {channel="hdl:MDT0601_233:Setup:1023:DimChannel6"}
Number  E2R1DLP01       "Temperature [%.1f °C]"                  <temperature>   (2E_R1_Bedroom,gTemp)  {channel="hdl:MPL8_48_FH:Setup:1082:temperature"}
Switch  E2R1ST01        "Sockets in room"                                             (2E_R1_Bedroom)        {channel="hdl:MR1216_233:Setup:1032:RelayCh12"}
Dimmer  E2R2LD01        "Roof lights [%d %%]"                                             (2E_R2_Bed1)         {channel="hdl:MDT0601_233:Setup:1024:DimChannel1"}
Switch  E2R2ST01        "Sockets in room"                                             (2E_R2_Bed1)         {channel="hdl:MR1216_233:Setup:1034:RelayCh5"}
Dimmer  E2R3LD01        "Roof lights [%d %%]"                                             (2E_R3_Bed2)        {channel="hdl:MDT0601_233:Setup:1024:DimChannel2"}
Switch  E2R3ST01        "Sockets in room"                                             (2E_R3_Bed2)        {channel="hdl:MR1216_233:Setup:1034:RelayCh6"}
```
