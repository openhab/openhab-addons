...
public class HeosPlayerAudioSink implements AudioSink {
    ...
    public HeosPlayerAudioSink(HeosPlayerHandler handler, AudioHTTPServer audioHTTPServer, String callbackUrl) {
