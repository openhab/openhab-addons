...
public enum VVM320Channels implements Channel {
    ...
    CH_43437("43437", "Supply Pump Speed EP14", ChannelType.SENSOR, ChannelGroup.GENERAL, Double.class),
    ...
    CH_40782("40782", "EB101 Cpr Frequency Desired F2040", ChannelType.SENSOR, ChannelGroup.COMPRESSOR, Double.class),
    ...
    CH_44700("44700", "EB101-EP14 Low Pressure Sensor Outdoor Unit", ChannelType.SENSOR, ChannelGroup.COMPRESSOR,
            Double.class),
    CH_44457("44457", "EB101-EP14 Compressor State", ChannelType.SENSOR, ChannelGroup.COMPRESSOR, Double.class),
    // Airsupply
