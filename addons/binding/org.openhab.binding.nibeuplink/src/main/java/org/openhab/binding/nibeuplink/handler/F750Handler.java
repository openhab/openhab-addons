...
/**
 * F750 specific implementation part of handler logic
 *
 * @author Alexander Friese - initial contribution
 *
 */
@NonNullByDefault
public class F750Handler extends UplinkBaseHandler {

    public F750Handler(Thing thing, HttpClient httpClient) {
    ...
    protected List<Channel> getAllSpecificChannels(String id) {
        ...
        Channel channel = F750Channels.fromId(id);
        if (channel != null) {
    ...
    public List<Channel> getChannels() {
        return getChannels(F750Channels.values());
    }
