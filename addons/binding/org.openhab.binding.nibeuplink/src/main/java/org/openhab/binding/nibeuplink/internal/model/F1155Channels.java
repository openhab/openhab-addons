...
public enum F1155Channels implements Channel {
     ...
     * @param writeApiUrl
     */
    F1155Channels(String id, String name, ChannelGroup channelGroup, Class<?> javaType, String writeApiUrl) {
        this.id = id;
        this.name = name;
     ...
     * @param javaType
     */
    F1155Channels(String id, String name, ChannelGroup channelGroup, Class<?> javaType) {
