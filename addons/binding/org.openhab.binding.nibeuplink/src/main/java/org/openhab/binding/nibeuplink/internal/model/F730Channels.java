...
public final class F730Channels extends BaseChannels {
    ...
    public static final Channel CH_43123 = INSTANCE.addChannel(new Channel("43123", "Compr. current max.freq.",
            ChannelGroup.COMPRESSOR, MetricPrefix.DECI(SmartHomeUnits.HERTZ)));
    public static final Channel CH_43066 = INSTANCE
            .addChannel(new Channel("43066", "Defrosting time", ChannelGroup.COMPRESSOR, SmartHomeUnits.SECOND));

    // Airsupply
    public static final Channel CH_10001 = INSTANCE
            .addChannel(new Channel("10001", "Fan speed current", ChannelGroup.AIRSUPPLY, SmartHomeUnits.PERCENT));
    ...
    public static final Channel CH_40919 = INSTANCE
            .addChannel(new Channel("40919", "Air mix", ChannelGroup.AIRSUPPLY, MetricPrefix.DECI(SIUnits.CELSIUS)));
    public static final Channel CH_40101 = INSTANCE.addChannel(
            new Channel("40101", "BT28 Air mix Temp", ChannelGroup.AIRSUPPLY, MetricPrefix.DECI(SmartHomeUnits.ONE)));
