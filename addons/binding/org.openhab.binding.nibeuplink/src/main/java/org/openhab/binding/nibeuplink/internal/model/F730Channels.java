...
public enum F730Channels implements Channel {
    ...
    // Compressor
    CH_43181("43181", "Chargepump speed", ChannelType.SENSOR, ChannelGroup.COMPRESSOR, Double.class),
    ...
    CH_40020("40020", "EB100-EP14-BT16 Evaporator", ChannelType.SENSOR, ChannelGroup.COMPRESSOR, Double.class),
