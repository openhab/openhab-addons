...
import static org.openhab.binding.nibeuplink.NibeUplinkBindingConstants.THING_TYPE_WEBIF;
...
=======
import org.openhab.binding.nibeuplink.handler.UplinkHandler;
>>>>>>> .r378
...
public class NibeUplinkHandlerFactory extends BaseThingHandlerFactory {
    ...
    private static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(THING_TYPE_WEBIF);
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(THING_TYPE_WEBIF)) {
            return new UplinkHandler(thing);
        }
