...
public final class VVM310Channels extends BaseChannels {
    ...
    public static final Channel CH_44270 = INSTANCE.addChannel(new QuantityChannel("44270", "Calc. Cooling Supply S1",
            ChannelGroup.GENERAL, MetricPrefix.DECI(SIUnits.CELSIUS)));
    ...
    public static final Channel CH_44302 = INSTANCE.addChannel(new QuantityChannel("44302",
            "Heat Meter - Cooling Cpr EP14", ChannelGroup.GENERAL, MetricPrefix.HECTO(SmartHomeUnits.WATT_HOUR)));
    ...
    public static final Channel CH_44362 = INSTANCE.addChannel(new QuantityChannel("44362",
            "EB101-EP14-BT28 Outdoor Temp", ChannelGroup.COMPRESSOR, MetricPrefix.DECI(SIUnits.CELSIUS)));
    ...
    public static final Channel CH_44060 = INSTANCE.addChannel(new QuantityChannel("44060",
            "EB101-EP14-BT15 Liquid Line", ChannelGroup.COMPRESSOR, MetricPrefix.DECI(SIUnits.CELSIUS)));
    public static final Channel CH_44059 = INSTANCE.addChannel(new QuantityChannel("44059",
            "EB101-EP14-BT14 Hot Gas Temp", ChannelGroup.COMPRESSOR, MetricPrefix.DECI(SIUnits.CELSIUS)));
    public static final Channel CH_44058 = INSTANCE.addChannel(new QuantityChannel("44058",
            "EB101-EP14-BT12 Condensor Out", ChannelGroup.COMPRESSOR, MetricPrefix.DECI(SIUnits.CELSIUS)));
    public static final Channel CH_44055 = INSTANCE.addChannel(new QuantityChannel("44055",
            "EB101-EP14-BT3 Return Temp.", ChannelGroup.COMPRESSOR, MetricPrefix.DECI(SIUnits.CELSIUS)));
    ...
    public static final Channel CH_40183 = INSTANCE.addChannel(new QuantityChannel("40183",
            "AZ30-BT23 Outdoor temp. ERS", ChannelGroup.AIRSUPPLY, MetricPrefix.DECI(SIUnits.CELSIUS)));
