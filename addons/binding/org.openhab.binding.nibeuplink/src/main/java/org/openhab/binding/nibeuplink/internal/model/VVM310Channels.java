...
public enum VVM310Channels implements Channel {
     ...
     */
    VVM310Channels(String id, String name, ChannelGroup channelGroup, ValueType valueType, String writeApiUrl,
     ...
     * @param javaType
     */
    VVM310Channels(String id, String name, ChannelGroup channelGroup, ValueType valueType) {
