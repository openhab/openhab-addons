 ...
 *
 */
public class ZoneMinderMonitorDiscoveryService__ extends AbstractDiscoveryService {

    private final Logger logger = LoggerFactory.getLogger(ZoneMinderMonitorDiscoveryService__.class);
     ...
     */
    public ZoneMinderMonitorDiscoveryService__(ZoneMinderServerBridgeHandler zoneMinderServerHandler) {
