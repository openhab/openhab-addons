 ...
 */
public class ZoneMinderServerDiscoveryService__ extends AbstractDiscoveryService {

    /** The logger. */
    private final Logger logger = LoggerFactory.getLogger(ZoneMinderServerDiscoveryService__.class);
     ...
     */
    public ZoneMinderServerDiscoveryService__() throws IllegalArgumentException {
