...
The optional advanced parameter "reconnect" can be used to set the connection retry interval, in minutes. It defaults to 5.
...
Each cco thing creates one switch channel.
