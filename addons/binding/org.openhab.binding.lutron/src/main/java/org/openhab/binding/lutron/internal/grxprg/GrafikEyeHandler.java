...
public class GrafikEyeHandler extends BaseThingHandler {
    ...
    /**
     * Does nothing - intialization is handled by the {@link #bridgeStatusChanged(ThingStatusInfo)} method
     */
    @Override
    public void initialize() {
        // do nothing on initialize - it's handled in bridestatuschanged
    }
    ...
    private PrgProtocolHandler getProtocolHandler() {
        ...
        final PrgProtocolHandler handler = (PrgProtocolHandler) bridge.getHandler();
        if (handler == null) {
