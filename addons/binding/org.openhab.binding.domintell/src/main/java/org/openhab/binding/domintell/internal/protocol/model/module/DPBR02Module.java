...
/**
 * The {@link DPBR02Module} class is handling physical push button module DPBR02
 *
 * @author Gabor Bicskei - Initial contribution
 */
public class DPBR02Module extends PushButtonModule {
    /**
     * Constructor
     *
     ...
     */
    public DPBR02Module(DomintellConnection connection, SerialNumber serialNumber) {
        super(connection, ModuleType.BR2, serialNumber, 2);
    }
}
