...
/**
 * The {@link DPBL02Module} class is handling physical push button module DPBL02
 *
 * @author Gabor Bicskei - Initial contribution
 */
public class DPBL02Module extends PushButtonModule {
    /**
     * Constructor
     *
     ...
     */
    public DPBL02Module(DomintellConnection connection, SerialNumber serialNumber) {
        super(connection, ModuleType.B84, serialNumber, 2);
    }
}
