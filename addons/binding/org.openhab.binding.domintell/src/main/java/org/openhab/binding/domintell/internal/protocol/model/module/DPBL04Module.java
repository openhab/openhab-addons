...
/**
 * The {@link DPBL04Module} class is handling physical push button module DPBL04
 *
 * @author Gabor Bicskei - Initial contribution
 */
public class DPBL04Module extends PushButtonModule {
    /**
     * Constructor
     *
     ...
     */
    public DPBL04Module(DomintellConnection connection, SerialNumber serialNumber) {
        super(connection, ModuleType.B84, serialNumber, 4);
    }
}
