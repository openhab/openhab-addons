 ...
 *
 */
public class LxControlTracker extends LxControl {
     ...
     */
    private static final String TYPE_NAME = "tracker";
    ...
    private State getState() {
        String value = getStateTextValue(STATE_ENTRIES);
        if (value != null) {
