...
public class DeviceModel {
    public static final int THERMOSTAT_BIT = 64;
    ...
    private ThermostatModel hkrModel;
    ...
    public boolean isDectThermostat() {
        return (bitmask & DeviceModel.THERMOSTAT_BIT) > 0;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).append("ain", this.getIdentifier()).append("bitmask", this.bitmask)
                ...
                .append("isThermostat", this.isDectThermostat()).append("id", this.deviceId)
    ...
    public ThermostatModel getHkr() {
        return hkrModel;
    }

    public void setHkr(ThermostatModel hkrModel) {
        this.hkrModel = hkrModel;
    }
