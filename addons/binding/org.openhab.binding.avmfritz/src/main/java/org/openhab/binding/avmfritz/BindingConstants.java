...
public class BindingConstants {
    ...
    public static final String SET_TEMPERATURE_CELSIUS = "setTempCelsius";

    // List of main device types
    public static final String DEVICE_DECT210 = "FRITZ_DECT_210";
    public static final String DEVICE_DECT200 = "FRITZ_DECT_200";
    public static final String DEVICE_COMET_DECT = "Comet_DECT";
    ...
    public final static ThingTypeUID COMETDECT_THING_TYPE = new ThingTypeUID(BINDING_ID, DEVICE_COMET_DECT);
    ...
    public final static String CHANNEL_SET_TEMP = "set_temperature";
    public final static String CHANNEL_SWITCH_THERMOSTAT = "switch_thermostat";

    public final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = ImmutableSet.of(DECT100_THING_TYPE,
            DECT200_THING_TYPE, DECT210_THING_TYPE, COMETDECT_THING_TYPE, PL546E_THING_TYPE, BRIDGE_THING_TYPE,
    ...
    public final static Set<ThingTypeUID> SUPPORTED_DEVICE_THING_TYPES_UIDS = ImmutableSet.of(DECT100_THING_TYPE,
            DECT200_THING_TYPE, DECT210_THING_TYPE, COMETDECT_THING_TYPE, PL546E_THING_TYPE);
