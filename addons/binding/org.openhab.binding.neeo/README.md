...
All data used by the binding is stored under the "userdata/neeo" directory (please note that this directory is shared with the NEEO transport).
...
There is one file being stored by the binding:

1.  neeothingtypes.json will contain all the rooms/devices that you have added to your system and allows the binding to recreate your thing types on a restart.
