 ...
 *
 */
@XStreamAlias("thermostatSetbackCommandClass")
public class ZWaveThermostatSetbackCommandClass extends ZWaveCommandClass {
    ...
    public CommandClass getCommandClass() {
        return CommandClass.THERMOSTAT_SETBACK;
    }
    ...
    public void handleApplicationCommandRequest(SerialMessage serialMessage, int offset, int endpoint)
            throws ZWaveSerialMessageException {
        logger.debug("NODE {}: Received THERMOSTAT_SETBACK command V{}", getNode().getNodeId(), getVersion());
