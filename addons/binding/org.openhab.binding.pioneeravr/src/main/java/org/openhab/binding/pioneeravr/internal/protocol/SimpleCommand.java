...
public class SimpleCommand implements AvrCommand {
	...
	public enum SimpleCommandType implements AvrCommand.CommandType {
		...
		POWER_ON("PO"), POWER_OFF("PF"), POWER_QUERY("?P"), VOLUME_UP("VU"), VOLUME_DOWN(
				"VD"), VOLUME_QUERY("?V"), MUTE_ON("MO"), MUTE_OFF("MF"), MUTE_QUERY(
				"?M"), INPUT_CHANGE_CYCLIC("FU"), INPUT_CHANGE_REVERSE("FD"), INPUT_QUERY(
				"?F");
