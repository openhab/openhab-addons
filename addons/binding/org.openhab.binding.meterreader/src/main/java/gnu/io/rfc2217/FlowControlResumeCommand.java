...
public class FlowControlResumeCommand extends ComPortCommand {
     ...
     *            IllegalArgumentException if {@code bytes[1]} is not {@link RFC2217#FLOWCONTROL_RESUME} (client or
     *            server)
     */
    ...
    public FlowControlResumeCommand(boolean client) {
        this(new int[] { COM_PORT_OPTION, client ? FLOWCONTROL_RESUME : FLOWCONTROL_RESUME + SERVER_OFFSET, });
    }
