 ...
 */
@NonNullByDefault
public class SupervisorOn extends Response {

    @SuppressWarnings("null")
    private final Logger logger = LoggerFactory.getLogger(SupervisorOn.class);

    @Override
    public boolean check(String message) {
        return message.matches("\\*13\\*66\\*[0-9]+#9##");
    }
