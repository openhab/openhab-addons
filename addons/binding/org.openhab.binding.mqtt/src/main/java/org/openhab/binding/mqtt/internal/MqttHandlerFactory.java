...
import static org.openhab.binding.mqtt.MqttBindingConstants.THING_TYPE_MQTT;
...
public class MqttHandlerFactory extends BaseThingHandlerFactory {
    ...
    private final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(THING_TYPE_MQTT);
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(THING_TYPE_MQTT)) {
