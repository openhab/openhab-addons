...
public class JSONRootObject {
    ...
    private ArrayList<ICloudDeviceInformation> content;
    ...
    public ArrayList<ICloudDeviceInformation> getContent() {
        return this.content;
    }
    ...
    public void setContent(ArrayList<ICloudDeviceInformation> content) {
