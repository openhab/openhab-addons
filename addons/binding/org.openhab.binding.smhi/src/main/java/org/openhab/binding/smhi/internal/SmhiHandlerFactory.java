...
import static org.openhab.binding.smhi.internal.SmhiBindingConstants.THING_TYPE_WEATHER_AND_FORECAST;
...
public class SmhiHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_WEATHER_AND_FORECAST.equals(thingTypeUID)) {
            return new SmhiHandler(thing);
        }
