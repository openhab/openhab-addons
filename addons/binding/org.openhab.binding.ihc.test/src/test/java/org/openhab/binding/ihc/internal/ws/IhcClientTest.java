...
public class IhcClientTest {
    ...
    public void setUp() throws IhcExecption, SocketTimeoutException {
        ...
        final String segment0 = ResourceFileUtils.getFileContent("src/test/resources/Segment0.base64");
        final String segment1 = ResourceFileUtils.getFileContent("src/test/resources/Segment1.base64");
