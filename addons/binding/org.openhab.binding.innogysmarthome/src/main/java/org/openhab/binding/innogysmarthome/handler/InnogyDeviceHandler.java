        ...
        for (Capability c : device.getCapabilityMap().values()) {
            ...
            switch (c.getType()) {
                ...
                case Capability.TYPE_HUMIDITYSENSOR:
                    ...
                    // mold warning
                    Boolean humiditySensorMoldWarningState = c.getCapabilityState().getHumiditySensorMoldWarningState();
                ...
                case Capability.TYPE_TWOWAYMETERENERGYCONSUMPTIONSENSOR:
                    updateStateForEnergyChannel(CHANNEL_ENERGY_MONTH_KWH,
                            c.getCapabilityState().getTwoWayMeterEnergyConsumptionSensorEnergyPerMonthInKWhState(), c);
                    ...
                    updateStateForEnergyChannel(CHANNEL_ENERGY_MONTH_EURO,
                            c.getCapabilityState().getTwoWayMeterEnergyConsumptionSensorEnergyPerMonthInEuroState(), c);
                    updateStateForEnergyChannel(CHANNEL_ENERGY_DAY_KWH,
                            c.getCapabilityState().getTwoWayMeterEnergyConsumptionSensorEnergyPerDayInKWhState(), c);
                    break;
        ...
        if (event.isLinkedtoCapability()) {
            ...
            for (Property p : event.getPropertyList()) {
                ...
                logger.trace("Loaded Capability {}, {} with id {}, device {} from device id {}", capability.getType(),
                        capability.getName(), capability.getId(), capability.getDeviceLink().get(0).getValue(),
                        device.getId());
                ...
                if (capability.isTypeVariableActuator()) {
                    ...
                    if (p.getName().equals(
                        ...
                        capabilityState.setEnergyConsumptionSensorEnergyConsumptionMonthKWhState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName()
                            .equals(CapabilityState.STATE_NAME_ENERGY_CONSUMPTION_SENSOR_ABSOLUTE_ENERGY_CONSUMPTION)) {
                        capabilityState.setEnergyConsumptionSensorAbsoluteEnergyConsumptionState((double) p.getValue());
                        deviceChanged = true;
                        ...
                        deviceChanged = true;
                            ...
                            .equals(CapabilityState.STATE_NAME_ENERGY_CONSUMPTION_SENSOR_ENERGY_CONSUMPTION_DAY_EURO)) {
                        capabilityState.setEnergyConsumptionSensorEnergyConsumptionDayEuroState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName()
                            .equals(CapabilityState.STATE_NAME_ENERGY_CONSUMPTION_SENSOR_ENERGY_CONSUMPTION_DAY_KWH)) {
                        capabilityState.setEnergyConsumptionSensorEnergyConsumptionDayKWhState((double) p.getValue());
                        deviceChanged = true;
                    }
                    ...
                    if (p.getName().equals(
                        ...
                        capabilityState.setGenerationMeterEnergySensorEnergyPerMonthInEuroState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName()
                            .equals(CapabilityState.STATE_NAME_GENERATION_METER_ENERGY_SENSOR_ENERGY_PER_DAY_IN_EURO)) {
                        capabilityState.setGenerationMeterEnergySensorEnergyPerDayInEuroState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName()
                            .equals(CapabilityState.STATE_NAME_GENERATION_METER_ENERGY_SENSOR_ENERGY_PER_DAY_IN_KWH)) {
                    ...
                    if (p.getName().equals(
                        ...
                        capabilityState
                                .setTwoWayMeterEnergyConsumptionSensorEnergyPerMonthInKWhState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName()
                            .equals(CapabilityState.STATE_NAME_TWO_WAY_METER_ENERGY_CONSUMPTION_SENSOR_TOTAL_ENERGY)) {
                        capabilityState.setTwoWayMeterEnergyConsumptionSensorTotalEnergyState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName().equals(
                            CapabilityState.STATE_NAME_TWO_WAY_METER_ENERGY_CONSUMPTION_SENSOR_ENERGY_PER_MONTH_IN_EURO)) {
                        capabilityState
                                .setTwoWayMeterEnergyConsumptionSensorEnergyPerMonthInEuroState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName().equals(
                            CapabilityState.STATE_NAME_TWO_WAY_METER_ENERGY_CONSUMPTION_SENSOR_ENERGY_PER_DAY_IN_EURO)) {
                        capabilityState
                                .setTwoWayMeterEnergyConsumptionSensorEnergyPerDayInEuroState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName().equals(
                    ...
                    if (p.getName().equals(
                        ...
                        capabilityState.setTwoWayMeterEnergyFeedSensorEnergyPerMonthInKWhState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName()
                        ...
                        capabilityState.setTwoWayMeterEnergyFeedSensorEnergyPerDayInEuroState((double) p.getValue());
                        deviceChanged = true;
                    } else if (p.getName().equals(
                    ...
                    if (p.getName()
                            .equals(CapabilityState.STATE_NAME_TWO_WAY_METER_POWER_CONSUMPTION_SENSOR_POWER_IN_WATT)) {
