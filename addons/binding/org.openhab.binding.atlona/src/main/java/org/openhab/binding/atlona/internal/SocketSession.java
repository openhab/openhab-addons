...
/**
 * Represents a restartable socket connection to the underlying telnet session with an Atlona product. Commands can be
 * sent via {@link #sendCommand(String)} and responses will be received on the
 * {@link org.openhab.binding.atlona.internal.SocketSessionCallback}
 *
 * @author Tim Roberts
 * @version $Id: $Id
 */
public class SocketSession {
    ...
    /**
     * Set's the {@link org.openhab.binding.atlona.internal.SocketSessionCallback} to use when calling back the
     * responses that have been received.
     *
     * @param callback a non-null {@link org.openhab.binding.atlona.internal.SocketSessionCallback} to use
     */
