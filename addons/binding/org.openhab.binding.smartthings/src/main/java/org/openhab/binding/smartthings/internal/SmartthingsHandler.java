...
import org.openhab.binding.smartthings.internal.SmartthingsConfiguration;
...
public class SmartthingsHandler extends BaseThingHandler {
    ...
    private final Logger logger = LoggerFactory.getLogger(SmartthingsHandler.class);

    @Nullable
    private SmartthingsConfiguration config;
    ...
    public void initialize() {
        ...
        config = getConfigAs(SmartthingsConfiguration.class);
