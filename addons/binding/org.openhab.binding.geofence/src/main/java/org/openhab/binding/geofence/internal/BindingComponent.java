...
import org.openhab.binding.geofence.internal.handler.TrackerDeviceHandler;
import org.openhab.binding.geofence.internal.message.NotificationBroker;
import org.openhab.binding.geofence.internal.provider.gpslogger.GPSLoggerCallbackServlet;
import org.openhab.binding.geofence.internal.provider.owntracks.OwnTracksCallbackServlet;
...
import static org.openhab.binding.geofence.internal.BindingConstants.CONFIG_PID;
...
public class BindingComponent extends BaseThingHandlerFactory implements ManagedService {
    ...
    /**
     * Creates new handler for device.
     *
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (BindingConstants.THING_TYPE_DEVICE.equals(thingTypeUID)) {
            ...
            discoveryService.removeTracker(id);
            return new TrackerDeviceHandler(thing, this.config, notificationBroker);
        } else {
            return null;
        }
    }
    ...
    /**
     * Activate the binding. It starts the device discovery service and the HTTP callback endpoint.
     *
    ...
    /**
     * Deactivate the binding. It stops the HTTP callback endpoint and stops the device discovery service.
     *
     * @param componentContext Component context.
     */
    protected void deactivate(ComponentContext componentContext) {
        logger.info("Deactivating Geofence Binding");
