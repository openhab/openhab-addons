...
import org.openhab.binding.netatmo.config.NetatmoWelcomeEventConfiguration;
 ...
 *
 */
public class NAWelcomeEventHandler extends NetatmoWelcomeHandler<NetatmoWelcomeEventConfiguration> {

    protected NAWelcomeEvents event;

    public NAWelcomeEventHandler(Thing thing) {
        super(thing, NetatmoWelcomeEventConfiguration.class);
    }
