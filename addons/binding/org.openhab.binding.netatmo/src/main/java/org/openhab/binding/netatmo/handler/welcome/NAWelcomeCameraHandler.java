...
import org.openhab.binding.netatmo.config.NetatmoWelcomeCameraConfiguration;
 ...
 *
 */
public class NAWelcomeCameraHandler extends NetatmoWelcomeHandler<NetatmoWelcomeCameraConfiguration> {

    protected NAWelcomeCameras camera;

    public NAWelcomeCameraHandler(Thing thing) {
        super(thing, NetatmoWelcomeCameraConfiguration.class);
    }
