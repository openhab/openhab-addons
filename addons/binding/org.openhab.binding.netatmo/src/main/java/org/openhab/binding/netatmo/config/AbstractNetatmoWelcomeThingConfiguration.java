...
/**
 * The {@link AbstractNetatmoWelcomeThingConfiguration} is responsible for holding configuration
 * informations needed to access a Netatmo Welcome Camera
 *
 * @author Ing. Peter Weiss - Initial contribution
 */
public abstract class AbstractNetatmoWelcomeThingConfiguration extends AbstractNetatmoThingConfiguration {
