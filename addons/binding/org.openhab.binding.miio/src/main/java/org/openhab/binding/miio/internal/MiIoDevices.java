...
public enum MiIoDevices {
    ...
    ZHIMI_AIRPURIFIER_MB1("zhimi.airpurifier.mb1", "Mi Air Purifier mb1", THING_TYPE_UNSUPPORTED),
    ZHIMI_AIRPURIFIER_MC1("zhimi.airpurifier.mc1", "Mi Air Purifier mc1", THING_TYPE_UNSUPPORTED),
