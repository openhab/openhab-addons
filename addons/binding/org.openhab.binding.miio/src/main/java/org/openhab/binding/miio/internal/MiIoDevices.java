...
public enum MiIoDevices {
    ...
    PHILIPS_MOON("philips.light.moonlight", "Xiaomi Philips ZhiRui bedside lamp",
            MiIoBindingConstants.THING_TYPE_BASIC),
    PHILIPS_LIGHT_CANDLE2("philips.light.candle2", "philips.light.candle2", MiIoBindingConstants.THING_TYPE_BASIC),
    PHILIPS_LIGHT_MONO1("philips.light.mono1", "philips.light.mono1", MiIoBindingConstants.THING_TYPE_BASIC),
    PHILIPS_LIGHT_VIRTUAL("philips.light.virtual", "philips.light.virtual", MiIoBindingConstants.THING_TYPE_BASIC),
    PHILIPS_LIGHT_ZYSREAD("philips.light.zysread", "philips.light.zysread", MiIoBindingConstants.THING_TYPE_BASIC),
    PHILIPS_LIGHT_ZYSTRIP("philips.light.zystrip", "philips.light.zystrip", MiIoBindingConstants.THING_TYPE_BASIC),
    ...
    ROBOROCK_VACUUM_C1("roborock.vacuum.c1", "roborock.vacuum.c1", MiIoBindingConstants.THING_TYPE_UNSUPPORTED),
    ...
    YEELIGHT_BSLAMP("yeelink.light.bslamp1", "Yeelight Lamp", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_BSLAMP2("yeelink.light.bslamp2", "Yeelight Lamp", MiIoBindingConstants.THING_TYPE_BASIC),
    ...
    YEELIGHT_CEIL4A("yeelink.light.ceiling4.ambi", "Yeelight LED Ceiling Lamp v4",
            MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_CEIL5("yeelink.light.ceiling5", "Yeelight LED Ceiling Lamp v5", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_CEIL6("yeelink.light.ceiling6", "Yeelight LED Ceiling Lamp v6", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_CEIL7("yeelink.light.ceiling7", "Yeelight LED Ceiling Lamp v7", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_CEIL8("yeelink.light.ceiling8", "Yeelight LED Ceiling Lamp v8", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_CT2("yeelink.light.ct2", "Yeelight ct2", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_DOLPHIN("yeelink.light.mono1", "Yeelight White Bulb", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_DOLPHIN2("yeelink.light.mono2", "Yeelight White Bulb v2", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_DONUT("yeelink.wifispeaker.v1", "Yeelight Wifi Speaker", MiIoBindingConstants.THING_TYPE_UNSUPPORTED),
    YEELIGHT_MANGO("yeelink.light.lamp1", "Yeelight", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_MANGO2("yeelink.light.lamp2", "Yeelight", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_MANGO3("yeelink.light.lamp3", "Yeelight", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_STRIP("yeelink.light.strip1", "Yeelight Strip", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_STRIP2("yeelink.light.strip2", "Yeelight Strip", MiIoBindingConstants.THING_TYPE_BASIC),
    YEELIGHT_VIRT("yeelink.light.virtual", "Yeelight", MiIoBindingConstants.THING_TYPE_BASIC),
    ...
    YEELIGHT_WONDER("yeelink.light.color3", "Yeelight Color Bulb", MiIoBindingConstants.THING_TYPE_BASIC),
