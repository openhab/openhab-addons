 ...
 *       &lt;sequence>
 *         &lt;element name="PublicKeys" type="{http://knx.org/xml/project/14}PublicKeys" minOccurs="0"/>
 *       &lt;/sequence>
...
public class ManufacturerMaster {
    ...
    @XmlElementRef(name = "PublicKeys", namespace = "http://knx.org/xml/project/14", type = JAXBElement.class, required = false)
    @XmlMixed
