...
/**
 * <p>
 * Java class for MaskVersion complex type.
 *
 * <p>
 ...
 *       &lt;sequence>
 *         &lt;element name="DownwardCompatibleMasks" type="{http://knx.org/xml/project/14}DownwardCompatibleMasks" minOccurs="0"/>
 *         &lt;element name="MaskEntries" type="{http://knx.org/xml/project/14}MaskEntries" minOccurs="0"/>
 *         &lt;element name="HawkConfigurationData" type="{http://knx.org/xml/project/14}HawkConfigurationData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "MaskVersion", propOrder = { "content" })
public class MaskVersion {

    @XmlElementRefs({
            @XmlElementRef(name = "HawkConfigurationData", namespace = "http://knx.org/xml/project/14", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "MaskEntries", namespace = "http://knx.org/xml/project/14", type = JAXBElement.class, required = false),
            @XmlElementRef(name = "DownwardCompatibleMasks", namespace = "http://knx.org/xml/project/14", type = JAXBElement.class, required = false) })
    @XmlMixed
