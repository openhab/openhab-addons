...
/**
 * <p>
 * Java class for MasterData complex type.
 *
 * <p>
 ...
 *       &lt;sequence>
 *         &lt;element name="DatapointTypes" type="{http://knx.org/xml/project/14}DatapointTypes"/>
 *         &lt;element name="InterfaceObjectTypes" type="{http://knx.org/xml/project/14}InterfaceObjectTypes"/>
 *         &lt;element name="InterfaceObjectProperties" type="{http://knx.org/xml/project/14}InterfaceObjectProperties"/>
 *         &lt;element name="PropertyDataTypes" type="{http://knx.org/xml/project/14}PropertyDataTypes"/>
 *         &lt;element name="MediumTypes" type="{http://knx.org/xml/project/14}MediumTypes"/>
 *         &lt;element name="MaskVersions" type="{http://knx.org/xml/project/14}MaskVersions"/>
 *         &lt;element name="FunctionalBlocks" type="{http://knx.org/xml/project/14}FunctionalBlocks"/>
 *         &lt;element name="ProductLanguages" type="{http://knx.org/xml/project/14}ProductLanguages"/>
 *         &lt;element name="Manufacturers" type="{http://knx.org/xml/project/14}Manufacturers"/>
 *         &lt;element name="Languages" type="{http://knx.org/xml/project/14}Languages"/>
 *       &lt;/sequence>
...
@XmlType(name = "MasterData", propOrder = { "datapointTypes", "interfaceObjectTypes", "interfaceObjectProperties",
        "propertyDataTypes", "mediumTypes", "maskVersions", "functionalBlocks", "productLanguages", "manufacturers",
        "languages" })
