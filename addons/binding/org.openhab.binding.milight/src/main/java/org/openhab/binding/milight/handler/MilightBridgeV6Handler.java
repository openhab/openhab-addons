...
public class MilightBridgeV6Handler extends AbstractMilightBridgeHandler implements ISessionState {
    ...
    protected void startConnectAndKeepAlive(InetAddress addr) {
        ...
        try {
            ...
            updateStatus(ThingStatus.ONLINE, ThingStatusDetail.CONFIGURATION_PENDING, "Waiting for session");
    ...
    public void sessionStateChanged(SessionState state) {
        switch (state) {
            ...
            case SESSION_INVALID:
                ...
                break;
            default:
                updateStatus(ThingStatus.ONLINE, ThingStatusDetail.CONFIGURATION_PENDING, state.name());
                break;
        }
    }
}
