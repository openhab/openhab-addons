...
public class MilightV6SessionManager implements Runnable {
    ...
    // The sequence number is 16 bits, we use 8 only and a fixed value
    ...
    private void send_establish_session() {
        ...
        sendQueue.queue(AbstractBulbInterface.CAT_SESSION,
                new byte[] { (byte) 0x20, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x16, (byte) 0x02, (byte) 0x62,
                        (byte) 0x3A, (byte) 0xD5, (byte) 0xED, (byte) 0xA3, (byte) 0x01, (byte) 0xAE, (byte) 0x08,
                        (byte) 0x2D, (byte) 0x46, (byte) 0x61, (byte) 0x41, (byte) 0xA7, (byte) 0xF6, (byte) 0xDC,
                        (byte) 0xAF, client_sid1, client_sid2, (byte) 0x00, (byte) 0x00, unknown });
    }
    ...
    void send_pre_registration() {
        sendQueue.queue(AbstractBulbInterface.CAT_SESSION, new byte[] { 0x30, 0, 0, 0, 3, sid1, sid2, 1, 0 });
    }
    ...
    void send_registration() {
        ...
        sendQueue.queue(AbstractBulbInterface.CAT_SESSION, t);
    }
    ...
    public void keep_alive(int periodic_interval_ms) {
        ...
        if (sessionState == SessionState.SESSION_INVALID) {
            ...
            sendQueue.queue(AbstractBulbInterface.CAT_KEEP_ALIVE,
                    new byte[] { (byte) 0xD0, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x02, sid1, sid2 });
        }
    }
