 ...
 */
package org.openhab.binding.feed.transform.test;
...
import org.openhab.binding.feed.transform.FeedTransformationService;
...
public class FeedTransformationServiceTest {
     ...
     */
    private final String MOCK_CONTENT_DEFAULT = "rss_2.0";

    /**
     * This file contains only XML declaration and empty RSS tag
     */
    private final String MOCK_CONTENT_EMPTY = "rss_2.0_empty";

    /**
     * This is invalid XML 1.0 file, because the {@literal <br>
     * } tag is not closed
     */
    private final String MOCK_CONTENT_INVALID_XML = "rss_2.0_invalid";

    /**
     * This file does not contain {@literal <xml>} declaration
     */
    private final String MOCK_CONTENT_MISSING_XML_DECLARATION = "rss_2.0_missing_xml_declaration";

    /**
     * Name of the test resources output folder
     */
    private final String TEST_OUTPUT_FOLDER = "output";

    /**
     * Name of the test resources input folder
     */
    private final String TEST_INPUT_FOLDER = "input";
