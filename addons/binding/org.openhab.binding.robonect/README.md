...
| `started`                    | Switch    | Switches the mower ON (analog to start button on mower) or OFF (analog to stop button on mower).                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `offlineTrigger`             | Trigger   | Is triggered if the mower is longer than the configured offlineTriggerTimeout offline. This might help if the mower is somewhere in error state but does not have a signal                                                                                                                                                                                                                                                                                                                                                              |
| `job-remote-start`           | String    | Sets the remote start type for a JOB. Possible values are <ul><li>STANDARD : use the remote start option defined in the mower settings</li><li>REMOTE_1 : start from remote 1</li><li>REMOTE_2 : start from remote 2</li></ul>                                                                                                                                                                                                                                                                                                          |
| `job-after-mode`             | String    | Sets the mode the mower should be put in after a mowing Job. (See JOB on channel `mode`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |
