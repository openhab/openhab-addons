...
public enum RFXComValueSelector {
    ...
    CHANNEL_1_AMPS(RFXComBindingConstants.CHANNEL_CHANNEL_1_AMPS, NumberItem.class),
    CHANNEL_2_AMPS(RFXComBindingConstants.CHANNEL_CHANNEL_2_AMPS, NumberItem.class),
    CHANNEL_3_AMPS(RFXComBindingConstants.CHANNEL_CHANNEL_2_AMPS, NumberItem.class),
