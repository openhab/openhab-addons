...
/**
 * The {@link DanfossHRVHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
 * @author Ralf Duckstein - Initial contribution
 */
@Component(service = ThingHandlerFactory.class, immediate = true, configurationPid = "binding.danfosshrv")
@NonNullByDefault
