 ...
 */
@Component(service = { DynamicStateDescriptionProvider.class, NadSourcesOptionProvider.class })
@NonNullByDefault
public class NadSourcesOptionProvider implements DynamicStateDescriptionProvider {
