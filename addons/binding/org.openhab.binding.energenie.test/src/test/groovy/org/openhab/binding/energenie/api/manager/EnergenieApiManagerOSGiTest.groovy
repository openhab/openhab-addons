...
class EnergenieApiManagerOSGiTest extends OSGiTest {
    ...
    /** Determines if the request is expected to be successful */
    ...
    private static final String TEST_DEVICE_TYPE = "motion"
    ...
    public static Collection getParams() {
        ...
        cases[2][1] = JsonOutput.toJson([device_id: TEST_DEVICE_ID, device_type: TEST_DEVICE_TYPE])
