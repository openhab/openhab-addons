...
/**
 * The {@link KostalPlenticorePlus85WithoutBatteryHandler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author René Stakemeier - Initial contribution
 */
@NonNullByDefault
public class KostalPlenticorePlus85WithoutBatteryHandler extends KostalPikoIqPlenticoreHandlerBase {

    public KostalPlenticorePlus85WithoutBatteryHandler(Thing thing) {
        super(thing);
    }

    @Override
    protected KostalPikoIqPlenticoreInverterTypes getInverterType() {
        return KostalPikoIqPlenticoreInverterTypes.PlenticorePlus85WithoutBattery;
    }
