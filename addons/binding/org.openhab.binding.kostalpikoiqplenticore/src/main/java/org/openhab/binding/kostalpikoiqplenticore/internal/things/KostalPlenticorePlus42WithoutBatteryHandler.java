...
/**
 * The {@link KostalPlenticorePlus42WithoutBatteryHandler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author René Stakemeier - Initial contribution
 */
@NonNullByDefault
public class KostalPlenticorePlus42WithoutBatteryHandler extends KostalPikoIqPlenticoreHandlerBase {

    public KostalPlenticorePlus42WithoutBatteryHandler(Thing thing) {
        super(thing);
    }

    @Override
    protected KostalPikoIqPlenticoreInverterTypes getInverterType() {
        return KostalPikoIqPlenticoreInverterTypes.PlenticorePlus42WithoutBattery;
    }
