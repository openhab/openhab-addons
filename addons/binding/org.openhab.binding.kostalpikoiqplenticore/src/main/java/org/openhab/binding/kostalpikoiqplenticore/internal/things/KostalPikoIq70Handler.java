...
/**
 * The {@link KostalPikoIq70Handler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author René Stakemeier - Initial contribution
 */
@NonNullByDefault
public class KostalPikoIq70Handler extends KostalPikoIqPlenticoreHandlerBase {

    public KostalPikoIq70Handler(Thing thing) {
        super(thing);
    }

    @Override
    protected KostalPikoIqPlenticoreInverterTypes getInverterType() {
        return KostalPikoIqPlenticoreInverterTypes.PikoIq70;
    }
