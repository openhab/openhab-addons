...
/**
 * The {@link KostalPlenticorePlus100WithoutBatteryHandler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author René Stakemeier - Initial contribution
 */
@NonNullByDefault
public class KostalPlenticorePlus100WithoutBatteryHandler extends KostalPikoIqPlenticoreHandlerBase {

    public KostalPlenticorePlus100WithoutBatteryHandler(Thing thing) {
        super(thing);
    }

    @Override
    protected KostalPikoIqPlenticoreInverterTypes getInverterType() {
        return KostalPikoIqPlenticoreInverterTypes.PlenticorePlus100WithoutBattery;
    }
