...
/**
 * The {@link KostalPikoIq100Handler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author René Stakemeier - Initial contribution
 */
@NonNullByDefault
public class KostalPikoIq100Handler extends KostalPikoIqPlenticoreHandlerBase {

    public KostalPikoIq100Handler(Thing thing) {
        super(thing);
    }

    @Override
    protected KostalPikoIqPlenticoreInverterTypes getInverterType() {
        return KostalPikoIqPlenticoreInverterTypes.PikoIq100;
    }
