...
/**
 * The {@link KostalPlenticorePlus85WithBatteryHandler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author René Stakemeier - Initial contribution
 */
@NonNullByDefault
public class KostalPlenticorePlus85WithBatteryHandler extends KostalPikoIqPlenticoreHandlerBase {

    public KostalPlenticorePlus85WithBatteryHandler(Thing thing) {
        super(thing);
    }

    @Override
    protected KostalPikoIqPlenticoreInverterTypes getInverterType() {
        return KostalPikoIqPlenticoreInverterTypes.PlenticorePlus85WithBattery;
    }
