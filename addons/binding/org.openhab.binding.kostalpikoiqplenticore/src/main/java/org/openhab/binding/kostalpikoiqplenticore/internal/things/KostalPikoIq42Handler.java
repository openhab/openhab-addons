...
/**
 * The {@link KostalPikoIq42Handler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author René Stakemeier - Initial contribution
 */
@NonNullByDefault
public class KostalPikoIq42Handler extends KostalPikoIqPlenticoreHandlerBase {

    public KostalPikoIq42Handler(Thing thing) {
        super(thing);
    }

    @Override
    protected KostalPikoIqPlenticoreInverterTypes getInverterType() {
        return KostalPikoIqPlenticoreInverterTypes.PikoIq42;
    }
