...
/**
 * The {@link KostalPikoIq55Handler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author René Stakemeier - Initial contribution
 */
@NonNullByDefault
public class KostalPikoIq55Handler extends KostalPikoIqPlenticoreHandlerBase {

    public KostalPikoIq55Handler(Thing thing) {
        super(thing);
    }

    @Override
    protected KostalPikoIqPlenticoreInverterTypes getInverterType() {
        return KostalPikoIqPlenticoreInverterTypes.PikoIq55;
    }
