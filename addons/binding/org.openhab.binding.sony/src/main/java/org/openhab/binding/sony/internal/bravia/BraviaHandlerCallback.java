...
/**
 *
 * This interface is used to provide a callback mechanism between {@link BraviaProtocol} and the associated
 * {@link BraviaHandler}. This is necessary since the status and state of a thing is private and the protocol handler
 ...
 *
 */
interface BraviaHandlerCallback {
    /**
     ...
     */
    void stateChanged(String channelId, State newState);
}
