...
public enum DSCAlarmCode {
    ...
    PartitionArmControlZeroEntryDelay("032", "Partition Arm Control - Zero Entry Delay", "032: Arm the partition with zero entry delay."),
    PartitionArmControlWithUserCode("033", "Partition Arm Control - With User Code", "033: Arm the partition with user code."),
    ...
    TimeDateBroadcastControl("056", "Time/Date Broadcast Control", "056: Periodically transmit system time broadcasts."),
    TemperatureBroadcastControl("057", "Temperature Broadcast Control", "057: Periodically transmit the interior and exterior temperatures."),
    VirtualKeypadControl("058", "Virtual Keypad Control", "058: Enable/Disable the virtual keypad command."),
    TriggerPanicAlarm("060", "Trigger Panic Alarm", "060: Emulates the FAP (Fire, Ambulance, Police) panic keys on a DSC keypad."),
    ...
    EnterUserCodeProgramming("072", "Enter User Code Programming", "072: Cause the partition to enter user code (*5) programming."),
    EnterUserProgramming("073", "Enter User Programming", "073: Cause the partition to enter user code (*6) programming."),
    ...
    LoginResponse("505", "Login Interaction", "505: Login response (failed=0, success=1, time out=2, password request=3)."),
    KeypadLEDState("510", "Keypad LED State - Partition 1 Only", "510: A change of state in the Partition 1 keypad LEDs."),
    KeypadLEDFlashState("511", "Keypad LED Flash State - Partition 1 Only", "511: A change of state in the Partition 1 keypad LEDs as to whether to flash or not."),
    ...
    IndoorTemperatureBroadcast("561", "Indoor Temperature Broadcast", "561: The interior temperature and the thermostat number."),
    OutdoorTemperatureBroadcast("562", "Outdoor Temperature Broadcast", "562: The exterior temperature and the thermostat number."),
    ThermostatSetPoints("563", "Thermostat Set Points", "563: Cooling and heating set points and the thermostat number."),
    ...
    EnvisalinkZoneTimerDump("615", "Envisalink Zone Timer Dump", "615: The raw zone timers used inside the Envisalink."),
    ...
    AuxiliaryInputAlarmRestored("632", "2-Wire Smoke/Aux Alarm Restore", "632: A 2-wire smoke/Auxiliary alarm has been restored."),
    ...
    PartitionReadyForceArming("653", "Partition Ready - Force Arming Enabled", "653: Partition can now be armed (Force Arming Enabled)."),
    ...
    SystemArmingInProgress("674", "System Arming in Progress", "674: This system is auto-arming and is in arm warning delay."),
    ...
    SpecialClosing("701", "Special Closing", "701: A partition has been armed by one of the following methods: Quick Arm, Auto Arm, Keyswitch, DLS software, Wireless Key."),
    PartialClosing("702", "Partial Closing", "702: A partition has been armed but one or more zones have been bypassed."),
    UserOpening("750", "User Opening", "750: A partition has been disarmed by a user."),
    SpecialOpening("751", "Special Opening", "751: A partition has been disarmed by one of the following methods: Quick Arm, Auto Arm, Keyswitch, DLS software, Wireless Key."),

    PanelBatteryTrouble("800", "Panel Battery Trouble", "800: The panel has a low battery."),
    PanelBatteryTroubleRestore("801", "Panel Battery Trouble Restore", "801: The panel low battery trouble has been restored."),
    ...
    SystemBellTrouble("806", "System Bell Trouble", "806: An open circuit has been detected across the bell terminals."),
    ...
    TLMLine1TroubleRestore("811", "TML Line 1 Trouble Restore", "811: The phone line trouble condition has been restored."),
    TLMLine2Trouble("812", "TML Line 2 Trouble", "812: The phone line is a open or shorted condition."),
    TLMLine2TroubleRestore("813", "TML Line 2 Trouble Restore", "813: The phone line trouble condition has been restored."),
    FTCTrouble("814", "FTC Trouble", "814: The panel has failed to communicate successfully to the monitoring station."),
    BufferNearFull("816", "Buffer Near Full", "816: The panel event buffer is 75% full from when it was last uploaded to DLS."),
    GeneralDeviceLowBattery("821", "General Device Low Battery", "821: A wireless zone has a low battery."),
    GeneralDeviceLowBatteryRestore("822", "General Device Low Battery Restore", "822: A wireless zone has a low battery."),
    WirelessKeyLowBatteryTrouble("825", "Wireless Key Low Battery Trouble", "825: A wireless key has a low battery."),
    WirelessKeyLowBatteryTroubleRestore("826", "Wireless Key Low Battery Trouble Restore", "826: A wireless key low battery condition has been restored."),
    HandheldKeypadLowBatteryTrouble("827", "Handheld Keypad Low Battery Trouble", "827: A handhekd keypad has a low battery."),
    HandheldKeypadLowBatteryTroubleRestore("828", "Handheld Keypad Low Battery Trouble Restore", "828: A handhekd keypad low battery condition has been restored."),
    GeneralSystemTamper("829", "General System Tamper", "829: A tamper has occurred with a system module."),
    GeneralSystemTamperRestore("830", "General System Tamper Restore", "830: A general system Tamper has been restored."),
    HomeAutomationTrouble("831", "Home Automation Trouble", "831: Escort 5580 module trouble."),
    HomeAutomationTroubleRestore("832", "Home Automation Trouble Restore", "832: Escort 5580 module trouble has been restored."),
    ...
    VerboseTroubleStatus("849", "Verbose Trouble Status", "849: a trouble appears on the system and roughly every 5 minutes until the trouble is cleared."),
    ...
    private static void initMapping() {
        codeToDSCAlarmCodeValue = new HashMap<String, DSCAlarmCode>();
