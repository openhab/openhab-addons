...
public class DSCAlarmMessage {
	...
	public enum DSCAlarmMessageType {
		PANEL_EVENT, PARTITION_EVENT, ZONE_EVENT, KEYPAD_EVENT;
	}

	public enum DSCAlarmMessageInfoType {
		MESSAGE, NAME, DESCRIPTION, CODE, TIME_STAMP, PARTITION, ZONE, DATA, MODE, USER, ERROR;
	}
	...
	static {
		...
		dscAlarmMessageParameters.put(DSCAlarmCode.LCDUpdate, new MessageParameters(DSCAlarmMessageType.KEYPAD_EVENT, false, false));
		dscAlarmMessageParameters.put(DSCAlarmCode.LCDCursor, new MessageParameters(DSCAlarmMessageType.KEYPAD_EVENT, false, false));
		dscAlarmMessageParameters.put(DSCAlarmCode.LEDStatus, new MessageParameters(DSCAlarmMessageType.KEYPAD_EVENT, false, false));
