        ...
        if (command instanceof RefreshType) {
            ...
            if (ValloxMVBindingConstants.CHANNEL_STATE.equals(channelUID.getId())) {
                ...
                if (OnOffType.ON.equals(command)) {
                    ...
                    || ValloxMVBindingConstants.CHANNEL_SUPP_FAN_BALANCE_BASE.equals(channelUID.getId())
                    || ValloxMVBindingConstants.CHANNEL_HOME_SPEED_SETTING.equals(channelUID.getId())
                    || ValloxMVBindingConstants.CHANNEL_AWAY_SPEED_SETTING.equals(channelUID.getId())
                    || ValloxMVBindingConstants.CHANNEL_BOOST_SPEED_SETTING.equals(channelUID.getId())) {
                if (command instanceof QuantityType) {
                    ...
                    || ValloxMVBindingConstants.CHANNEL_AWAY_AIR_TEMP_TARGET.equals(channelUID.getId())
                    || ValloxMVBindingConstants.CHANNEL_BOOST_AIR_TEMP_TARGET.equals(channelUID.getId())) {
                if (command instanceof QuantityType) {
