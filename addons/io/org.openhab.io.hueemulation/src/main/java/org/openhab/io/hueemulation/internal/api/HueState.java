...
public class HueState {
    ...
    public static short convertBri(int percentBrightness) {
    ...
    public HueState(HSBType hsb) {
        ...
        this.bri = hsb.intValue() > 0 ? convertBri(hsb.intValue()) : -1;
    }
    ...
    public boolean isOn() {
      // thelight is on if bolean is passed or we have a brightness
