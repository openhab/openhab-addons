...
public class CloudClient {
    ...
    public void connect() {
        try {
            ...
            logger.debug("Error creating Socket.IO: {}", e.getMessage());
        } catch (MalformedURLException e) {
            logger.debug("Error parsing baseURL to get protocol, assuming https. Error: {}", e.getMessage());
        }
    ...
    public void onConnect() {
        ...
        if (jettyClient != null) {
            try {
                ...
                logger.debug("Could not start Jetty client: {}", e.getMessage());
            }
        }
    }
    ...
    public void onDisconnect() {
        ...
        if (jettyClient != null) {
            try {
                ...
                logger.debug("Could not stop Jetty client: {}", e.getMessage());
            }
        }
    ...
    public void onEvent(String event, JSONObject data) {
        ...
        if (remoteAccessEnabled) {
            if ("request".equals(event)) {
                ...
                logger.debug("Unsupported event from openHAB Cloud: {}", event);
            }
        }
    }
    ...
    private void setRequestHeaders(Request request, JSONObject requestHeadersJson) {
        ...
        while (headersIterator.hasNext()) {
            ...
            try {
                ...
                logger.debug("Error processing request headers: {}", e.getMessage());
            }
        }
    }
    ...
    private void handleCommandEvent(JSONObject data) {
        ...
        if (exposedItems.contains(itemName)) {
            ...
            logger.debug("Received command from openHAB Cloud for item '{}', which is not exposed.", itemName);
        }
    }
    ...
    public void shutdown() {
        logger.debug("Shutting down openHAB Cloud service connection");
        try {
            jettyClient.stop();
        } catch (Exception e) {
            logger.debug("{}", e.getMessage());
    ...
    private class ResponseListener
        ...
        private JSONObject getJSONHeaders(HttpFields httpFields) {
            ...
            try {
                ...
                logger.debug("Error forming response headers: {}", e.getMessage());
            }
            return headersJSON;
        }
        ...
        public void onComplete(Result result) {
            ...
            if ((result != null && result.isFailed())
                ...
                if (result.getFailure() != null) {
                    logger.debug("Jetty request {} failed: {}", mRequestId, result.getFailure().getMessage());
                }
