...
public interface BrainDiscovery extends AutoCloseable {
    ...
    /**
     * Removes any discovered information associated with the system info (allowing rediscovery)
     *
     * @param sysInfo a non-null system info
     * @return true if removed, false otherwise
     */
    boolean removeDiscovered(NeeoSystemInfo sysInfo);
